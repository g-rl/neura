...
init()
{
    ...
    setsaveddvar( "_encstr_8C1710C7CF3EF17350FBF27A7148BB2A187D", 0 );
}
...
{
    if ( gettime() - var_1 > 190 && !scripts\mp\utility\player::isusingremote() && getdvar( "_encstr_AF870F78FFBBA717C1C8738690B9F8BDC0" ) == "_encstr_B40101" )
    {
    ...
    if ( weaponclass( var_2 ) == "_encstr_850707F7E5833355B8" )
        scripts\mp\battlechatter_mp::trysaylocalsound( self, "_encstr_8FF010F221D7301FBECF0F558B4B9EACE351", undefined, 0.2 );
...
whizbyblurshoweffect( var_0 )
{
    if ( getdvarint( "_encstr_8C1710C7CF3EF17350FBF27A7148BB2A187D", 1 ) == 1 )
    {
        ...
        if ( var_1 hasattachment( "_encstr_972E0C369637950BE4C493B0DAAC", 1 ) && !scripts\mp\utility\weapon::iskillstreakweapon( var_1 ) && !scripts\mp\utility\perk::_hasperk( "_encstr_8CCF166E38CAB15A588D1D97FA1363C2DC1DCD1AA5568D19" ) )
        {
