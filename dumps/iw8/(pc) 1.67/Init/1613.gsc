...
createsquad()
{
    ...
    setdvarifuninitialized( "_encstr_8C1617C7CF3EF161B01E32BA73D8AC49197F4B17CF65DB4808", "_encstr_934C0218" );
...
squadmerge( var_0, var_1 )
{
    ...
    {
        var_3.squadnumber = -1;
        var_3 notify( "_encstr_A6BD0E4EB3FD70B25FC3075D405B2930" );
...
{
    self endon( "_encstr_A6BD0E4EB3FD70B25FC3075D405B2930" );
