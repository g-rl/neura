...
maintacopsinit()
{
    level.tacopssublevel = "_encstr_B460076B5097BE8391";
    level.currentmode = "_encstr_B460076B5097BE8391";
...
maintacopspostinit()
{
    ...
    {
        scripts\mp\utility\game::registerroundswitchdvar( "_encstr_B460076B5097BE8391", 0, 0, 9 );
        scripts\mp\utility\game::registertimelimitdvar( "_encstr_B460076B5097BE8391", 10 );
        scripts\mp\utility\game::registerscorelimitdvar( "_encstr_B460076B5097BE8391", 65 );
        scripts\mp\utility\game::registerroundlimitdvar( "_encstr_B460076B5097BE8391", 1 );
        scripts\mp\utility\game::registerwinlimitdvar( "_encstr_B460076B5097BE8391", 1 );
        scripts\mp\utility\game::registernumlivesdvar( "_encstr_B460076B5097BE8391", 0 );
        scripts\mp\utility\game::registerhalftimedvar( "_encstr_B460076B5097BE8391", 0 );
        scripts\mp\utility\game::registerdogtagsenableddvar( "_encstr_B460076B5097BE8391", 0 );
...
{
    scripts\mp\utility\game::setcommonrulesfrommatchrulesdata();
    setdynamicdvar( "_encstr_836C1CC36750591198E7A5E225E737D07B221AD73F90AF8B1D192F49E3F1", 5 );
    setdynamicdvar( "_encstr_971E20AB7383477BB78F62845767CB3ECBCDD03588789847205B60038283DF76D0BB", 10 );
...
initspawns()
{
    ...
    scripts\mp\spawnlogic::addspawnpoints( "_encstr_9A8507BA4040188D08", "_encstr_8709167DF759ECCD098032B04E8876AF2B66C0519CB903FB", 1 );
    scripts\mp\spawnlogic::addspawnpoints( "_encstr_8E8405EA382B2A", "_encstr_8A23146B83F58E7B313423D7B9075877CD7DC21EA59B", 1 );
    var_0.to_bhd_spawns = [];
    var_0.to_bhd_spawns["_encstr_9A8507BA4040188D08"] = scripts\mp\spawnlogic::getspawnpointarray( "_encstr_8709167DF759ECCD098032B04E8876AF2B66C0519CB903FB" );
    var_0.to_bhd_spawns["_encstr_8E8405EA382B2A"] = scripts\mp\spawnlogic::getspawnpointarray( "_encstr_8A23146B83F58E7B313423D7B9075877CD7DC21EA59B" );

    if ( var_0.to_bhd_spawns["_encstr_9A8507BA4040188D08"].size <= 0 )
    {
        scripts\mp\spawnlogic::addspawnpoints( "_encstr_9A8507BA4040188D08", "_encstr_839D1687D1804A5A58D00BD96B789193E0773F1B41332213" );
        var_0.to_bhd_spawns["_encstr_9A8507BA4040188D08"] = scripts\mp\spawnlogic::getspawnpointarray( "_encstr_839D1687D1804A5A58D00BD96B789193E0773F1B41332213" );
    }

    if ( var_0.to_bhd_spawns["_encstr_8E8405EA382B2A"].size <= 0 )
    {
        scripts\mp\spawnlogic::addspawnpoints( "_encstr_8E8405EA382B2A", "_encstr_9B3B1429826955DBFF332081BF1871BFA2E1972B5CC3" );
        var_0.to_bhd_spawns["_encstr_8E8405EA382B2A"] = scripts\mp\spawnlogic::getspawnpointarray( "_encstr_9B3B1429826955DBFF332081BF1871BFA2E1972B5CC3" );
    }
}
...
activatespawns()
{
    ...
    scripts\mp\tac_ops_map::setactivemapconfig( "_encstr_B460076B5097BE8391", "_encstr_9A8507BA4040188D08" );
    scripts\mp\tac_ops_map::setactivemapconfig( "_encstr_B460076B5097BE8391", "_encstr_8E8405EA382B2A" );
