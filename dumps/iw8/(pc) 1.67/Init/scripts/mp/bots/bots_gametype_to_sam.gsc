...
setup_callbacks()
{
    level.bot_funcs["_encstr_A7610FD916DACA47CB832BF547432DDC6D"] = ::bot_sam_think;
}
...
bot_sam_think()
{
    self notify( "_encstr_85C50E19A283E0D01E2D87D9404460B2" );
    self endon( "_encstr_85C50E19A283E0D01E2D87D9404460B2" );
