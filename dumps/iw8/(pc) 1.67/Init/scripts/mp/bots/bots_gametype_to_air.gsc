...
setup_callbacks()
{
    level.bot_funcs["_encstr_A7610FD916DACA47CB832BF547432DDC6D"] = ::bot_air_think;
}
...
bot_air_think()
{
    self notify( "_encstr_8E2C0E2A70E1D187D0CEAF9CEBF87364" );
    self endon( "_encstr_8E2C0E2A70E1D187D0CEAF9CEBF87364" );
