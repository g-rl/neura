...
setup_callbacks()
{
    level.bot_funcs["_encstr_A7610FD916DACA47CB832BF547432DDC6D"] = ::bot_blitz_think;
}
...
bot_blitz_think()
{
    self notify( "_encstr_863A108DF70BE0403404EB22A1F4C823421F" );
    self endon( "_encstr_863A108DF70BE0403404EB22A1F4C823421F" );
