...
managelightbarstack()
{
    self notify( "_encstr_86AE1480FA7533196F4CB3BC70F365FBDA61C078B24C" );
    self endon( "_encstr_86AE1480FA7533196F4CB3BC70F365FBDA61C078B24C" );
    ...
    for (;;)
    {
        ...
        if ( !var_3 )
        {
            ...
            if ( var_4 <= 0 )
            {
                self.lightbarstructs[0] notify( "_encstr_A2BD0839CAB6B7CE5919" );
        ...
        if ( var_3 )
        {
            if ( var_2.endondeath )
            {
                var_2 notify( "_encstr_81100ACA58534E470333EE1F" );
                var_2.executing = 1;
...
{
    self notify( "_encstr_829B16CFDF103138B82F99F891E370BEABBFA899319C2072" );
    self endon( "_encstr_829B16CFDF103138B82F99F891E370BEABBFA899319C2072" );
    set_lightbar_pulse_time( var_1 );
    set_lightbar_color( var_0 );
    set_lightbar_on();
    wait( var_2 );
...
{
    self notify( "_encstr_A7650DDC56E8BEC64B3B4347260B4E" );
    self endon( "_encstr_A7650DDC56E8BEC64B3B4347260B4E" );
    set_lightbar_pulse_time( var_1 );
    set_lightbar_color( var_0 );
    set_lightbar_on();
}
...
{
    self notify( "_encstr_95A922DC59D1BE8D4B76D0D14C0B4EAF337BC9AF1D96D62B7D95B923B7737D8C952C1DD0" );
    self endon( "_encstr_95A922DC59D1BE8D4B76D0D14C0B4EAF337BC9AF1D96D62B7D95B923B7737D8C952C1DD0" );
    set_lightbar_pulse_time( var_1 );
    set_lightbar_color( var_0 );
    set_lightbar_on();
    thread turn_off_light_bar_on_death();
...
{
    self notify( "_encstr_86F719CD9547D763A53B43D13158E4FA56E623DEDC7D19950B3A43" );
    self endon( "_encstr_86F719CD9547D763A53B43D13158E4FA56E623DEDC7D19950B3A43" );
    set_lightbar_pulse_time( var_1 );
    set_lightbar_color( var_0 );
    set_lightbar_on();
    thread turn_off_light_bar_on_death();
...
{
    self notify( "_encstr_A2911E56B9C8923758D8A32D675925E66ED1E4571BD14B7B9BD337442B2CA386" );
    self endon( "_encstr_A2911E56B9C8923758D8A32D675925E66ED1E4571BD14B7B9BD337442B2CA386" );
    var_0 endon( "_encstr_81100ACA58534E470333EE1F" );
...
{
    var_1 endon( "_encstr_A2BD0839CAB6B7CE5919" );
...
{
    self notify( "_encstr_A68A1CE85D39CDBEE9CCCCD762A5EC343AF5482C93FAF4B9AF11CA2C47D0" );
    self endon( "_encstr_A68A1CE85D39CDBEE9CCCCD762A5EC343AF5482C93FAF4B9AF11CA2C47D0" );
    self waittill( "_encstr_AD75063D571AE108" );
...
set_lightbar_color( var_0 )
{
    self setclientomnvar( "_encstr_934609C2D61F8A1DB80D9A", var_0 );
}
...
{
    self setclientomnvar( "_encstr_A1B50E326346D31838FBF0EFA3CBA39F", var_0 );
}
