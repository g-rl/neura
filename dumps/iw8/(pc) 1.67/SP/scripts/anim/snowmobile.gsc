...
snowmobile_loop_passenger()
{
    self endon( "death" );
    self endon( "killanimscript" );
    self setanimknoball( scripts\anim\utility.gsc::animarray( "hide" ), %body, 1, 0 );
    self setanimknob( scripts\anim\utility.gsc::animarray( "drive" ), 1, 0 );
    ...
    for (;;)
    {
        ...
        if ( var_0 >= 0 )
            self setanimknoblimited( scripts\anim\utility.gsc::animarray( "lean_right" ), 1, 0.05 );
        else
            self setanimknoblimited( scripts\anim\utility.gsc::animarray( "lean_left" ), 1, 0.05 );
...
snowmobile_loop_passenger_shooting()
{
    ...
    for (;;)
    {
        ...
        var_3 = max( 0, 0 - var_1 );
        var_4 = max( 0, var_1 );
        self setanimlimited( scripts\anim\utility.gsc::animarray( "straight_level_center" ), var_2, var_0 );
        self setanimlimited( scripts\anim\utility.gsc::animarray( "straight_level_left" ), var_3, var_0 );
        self setanimlimited( scripts\anim\utility.gsc::animarray( "straight_level_right" ), var_4, var_0 );
        snowmobile_start_shooting();
        self setanimlimited( scripts\anim\utility.gsc::animarray( "aim_left_center" ), var_2, var_0 );
        self setanimlimited( scripts\anim\utility.gsc::animarray( "aim_left_left" ), var_3, var_0 );
        self setanimlimited( scripts\anim\utility.gsc::animarray( "aim_left_right" ), var_4, var_0 );
        self setanimlimited( scripts\anim\utility.gsc::animarray( "aim_right_center" ), var_2, var_0 );
        self setanimlimited( scripts\anim\utility.gsc::animarray( "aim_right_left" ), var_3, var_0 );
        self setanimlimited( scripts\anim\utility.gsc::animarray( "aim_right_right" ), var_4, var_0 );
        self setanimlimited( scripts\anim\utility.gsc::animarray( "add_aim_backleft_center" ), var_2, var_0 );
        self setanimlimited( scripts\anim\utility.gsc::animarray( "add_aim_backleft_left" ), var_3, var_0 );
        self setanimlimited( scripts\anim\utility.gsc::animarray( "add_aim_backleft_right" ), var_4, var_0 );
        self setanimlimited( scripts\anim\utility.gsc::animarray( "add_aim_backright_center" ), var_2, var_0 );
        self setanimlimited( scripts\anim\utility.gsc::animarray( "add_aim_backright_left" ), var_3, var_0 );
        self setanimlimited( scripts\anim\utility.gsc::animarray( "add_aim_backright_right" ), var_4, var_0 );
...
snowmobile_do_event( var_0 )
{
    ...
    scripts\anim\notetracks.gsc::donotetracks( "snowmobile_event", ::snowmobile_waitfor_start_lean );
    ...
    for (;;)
    {
        ...
        if ( var_1.event["bump"][var_0] )
        {
            ...
            if ( self.current_event != "bump_big" )
                thread snowmobile_do_event( scripts\anim\utility.gsc::animarray( "event_bump" ) );
        }
        ...
        if ( var_1.event["bump_big"][var_0] )
        {
            ...
            thread snowmobile_do_event( scripts\anim\utility.gsc::animarray( "event_bump_big" ) );
        }
        ...
        if ( var_1.event["sway_left"][var_0] )
        {
            ...
            if ( self.current_event != "bump_big" )
                thread snowmobile_do_event( scripts\anim\utility.gsc::animarray( "event_sway" )["left"] );
        }
        ...
        if ( var_1.event["sway_right"][var_0] )
        {
            ...
            if ( self.current_event != "bump_big" )
                thread snowmobile_do_event( scripts\anim\utility.gsc::animarray( "event_sway" )["right"] );
        }
...
snowmobile_reload_internal()
{
    ...
    scripts\anim\notetracks.gsc::donotetracks( "gun_up", ::snowmobile_waitfor_start_aim );
    ...
    if ( isdefined( self.gun_up_for_reload ) )
    {
        ...
        scripts\anim\notetracks.gsc::donotetracks( "gun_up", ::snowmobile_waitfor_end );
...
snowmobile_setanim_common( var_0 )
{
    ...
    self.a.array["single"] = scripts\anim\utility.gsc::array( level.scr_anim["snowmobile"][var_0]["single"] );
