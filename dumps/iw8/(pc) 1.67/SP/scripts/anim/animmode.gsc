...
main()
{
    ...
    var_9 = scripts\asm\asm::asm_getfacialknob();

    if ( isdefined( var_9 ) )
        self setanim( var_9, 1, 0.3, 1 );

    self orientmode( "face angle", var_5[1] );
    self animmode( "zonly_physics", 1 );
    var_10 = "custom_animmode";
    self setflaggedanimrestart( var_10, var_3, 1, var_8, 1 );
    self._tag_entity thread scripts\common\notetrack::start_notetrack_wait( self, var_10, var_1, self._animname, var_3 );
    self._tag_entity thread scripts\sp\anim::animscriptdonotetracksthread( self, var_10, var_1 );
    var_11 = self._tag_entity;
    ...
    for (;;)
    {
        self waittillmatch( var_10, var_12 );

        if ( var_0 )
        {
            var_3 = level.scr_anim[self._animname][var_1][randomint( var_2 )];
            self setflaggedanimknoblimitedrestart( var_10, var_3, 1, 0.2, 1 );

            if ( isdefined( var_11 ) )
            {
                var_11 thread scripts\common\notetrack::start_notetrack_wait( self, var_10, var_1, self._animname, var_3 );
                var_11 thread scripts\sp\anim::animscriptdonotetracksthread( self, var_10, var_1 );
            }
