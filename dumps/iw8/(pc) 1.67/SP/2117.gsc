...
strafereverse_cleanup( var_0, var_1, var_2 )
{
    self getpartyid( 0 );
}

playanim_strafereverse_donotetracks( var_0, var_1 )
{
    for (;;)
        scripts\asm\asm::asm_donotetracks( var_0, var_1, undefined, undefined, undefined, 0 );
}
