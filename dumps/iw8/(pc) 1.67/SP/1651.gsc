...
getoutrig_model_new( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_12 = scripts\engine\trace::ray_trace( var_11, var_11 - ( 0, 0, 1000 ), self, scripts\engine\trace::create_world_contents() );
    var_13 = var_11[2] - 400;

    if ( isdefined( var_12["position"] ) )
        var_13 = var_12["position"][2];

    var_14 = ( var_6[0], var_6[1], var_13 );

    if ( istrue( level.vehicle.templates.attachedmodels[var_5][var_0.fastroperig].dropusestraceorigin ) )
        var_14 = ( var_11[0], var_11[1], var_13 );

    thread getoutrig_abort( var_1, undefined, var_3, var_14 );
...
wait_for_open_door( var_0, var_1 )
{
    ...
    var_2 = var_1.vehicle_getoutanim;
    var_3 = var_1.vehicle_getoutanim_clear;
    ...
    if ( isdefined( var_0.requestopendoorparams ) )
    {
        ...
        {
            var_2 = var_1.vehicle_getoutanim_combat_run;
            var_3 = var_1.vehicle_getoutanim_combat_run_clear;
        }
        else if ( var_0.requestopendoorparams == "combat" && isdefined( var_1.vehicle_getoutanim_combat ) )
        {
            var_2 = var_1.vehicle_getoutanim_combat;
            var_3 = var_1.vehicle_getoutanim_combat_clear;
        }
    }

    vehicle_play_exit_anim( var_1, var_2, var_3 );
}
...
guy_setup_rope( var_0, var_1 )
{
    ...
    {
        vehicle_play_exit_anim( var_1 );

        if ( !isdefined( self.fastroperig[var_1.fastroperig] ) )
        {
            var_2 = getanimatemodel();
            var_3 = getout_rigspawn( var_2, var_1, 1 );
        }
...
guy_unload( var_0, var_1 )
{
    ...
    if ( !var_5 )
    {
        ...
        if ( !istrue( self.vehiclesetuprope ) && isdefined( var_3.fastroperig ) )
        {
            if ( getdvarint( "enable_vehicle_ai_using_BT" ) )
                vehicle_play_exit_anim( var_3 );
        ...
        else
        {
            ...
            {
                if ( !isdefined( var_3.fastroperig ) || !scripts\common\utility::issp() )
