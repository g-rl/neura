...
main()
{
    ...
    self.weapon = scripts\code\ai::create_weapon_in_script( [ "iw8_ar_akilo47", "iw8_sm_augolf" ] );
    character\character_spetsnaz_cqc_nvg::main();
}
...
precache( var_0 )
{
    character\character_spetsnaz_cqc_nvg::precache();
