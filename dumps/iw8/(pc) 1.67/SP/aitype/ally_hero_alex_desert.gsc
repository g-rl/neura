...
main()
{
    ...
    self.weapon = scripts\code\ai::create_weapon_in_script( [ "iw8_sn_mike14" ] );
    character\character_hero_alex_desert::main();
}
...
precache( var_0 )
{
    character\character_hero_alex_desert::precache();
