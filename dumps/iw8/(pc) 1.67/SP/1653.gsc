            ...
            for ( var_7 = 0; var_7 < level.vehicle.templates.aianims[get_vehicle_classname()].size; var_7++ )
            {
                ...
                if ( istrue( var_8.setuprope ) )
                {
                    ...
                    if ( var_9 )
                    {
                        ...
                        scripts\common\vehicle_aianim::guy_setup_rope( var_14, var_8 );
                    }
                }
            }

            if ( isdefined( self.getout_rig_delay ) && self.getout_rig_delay > gettime() )
                wait( ( self.getout_rig_delay - gettime() ) / 1000 );
        }
    ...
    while ( self.health > 0 )
    {
        ...
        else
        {
            if ( scripts\common\utility::issp() && isdefined( var_6 ) )
            {
                ...
                if ( var_15 )
                    self.health = self.health - int( var_15 );
            }
...
{
    if ( isdefined( level.vehicle.templates.vehicle_rocket_death_fx[self.classname] ) )
    {
        var_0 = get_vehicle_classname();
