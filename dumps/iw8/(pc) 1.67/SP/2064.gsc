...
heli_goal_think( var_0 )
{
    ...
    for (;;)
    {
        ...
        else
        {
            var_15 = [];
            var_15[0] = var_14;
            var_8 = scripts\engine\utility::get_array_of_closest( var_7, var_8, var_15, 2 );
        ...
        scripts\engine\utility::waittill_notify_or_timeout( "damage_by_player", var_17 );
    }
}
...
boneyard_fire_at_targets( var_0, var_1 )
{
    ...
    for ( var_4 = 0; var_4 < var_1.size; var_4++ )
    {
        ...
        var_5 scripts\engine\utility::delaycall( 1, ::missile_cleartarget );
