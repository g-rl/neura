...
setupwait( var_0 )
{
    ...
    self.bt.instancedata[var_0]["_encstr_A2E70E5B019BE3E298833A24F12835EF"] = gettime();
}

dowait( var_0, var_1 )
{
    var_2 = self.bt.instancedata[var_0]["_encstr_A2E70E5B019BE3E298833A24F12835EF"];
...
updateeveryframe_magicdoorchecks()
{
    ...
    var_1 = self getmodifierlocationonpath( "_encstr_B16705D9AFE22E", var_0 );
