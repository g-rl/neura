...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "_encstr_B8BA05F06B9785", "_encstr_BE821247C860E55251B8FB74054B2ABC0DF8B787", ::_id_11EF3 );
}
...
_id_11EEC( var_0 )
{
    ...
    else
    {
        ...
        var_0 thread scripts\cp\cp_damage::finishplayerdamagewrapper( level.nuke_inflictor, level.nukeinfo.player, 999999, 0, "_encstr_B45C0E2DFF41B17F437FB870E733FBFF", var_1, var_0.origin, var_2, "_encstr_8BBA05185F8B99", 0, 0, undefined, undefined );
    }
}
