...
bomber_init( var_0 )
{
    ...
    if ( self tagexists( "_encstr_85590E23373E42E90899B97A70E0277B" ) )
        var_1 = "_encstr_85590E23373E42E90899B97A70E0277B";
    else
        var_1 = "_encstr_AABA0D53A18E8733D70D55C3E3F713";

    self attach( "_encstr_B2B91318EA24141E3EE9B9EB27218EDD718E622B5B", "_encstr_B2AE148D118849F9F696852B6A0702D239A5810FEBC5" );
    ...
    {
        playfxontag( scripts\engine\utility::getfx( "_encstr_B6261D375D5AD8961956D74C7B6B3156E4BE8D1B2D365BB29C7D99D8B09B1A" ), self, var_1 );

        if ( level.gameskill < 2 )
            self.health = 300;
    }
    else if ( scripts\common\utility::iscp() )
        scripts\engine\utility::delaythread( 0.2, ::compound_objective, var_1 );
...
{
    playfxontag( scripts\engine\utility::getfx( "_encstr_B6261D375D5AD8961956D74C7B6B3156E4BE8D1B2D365BB29C7D99D8B09B1A" ), self, var_0 );
}
...
expl_dmg_monitor()
{
    ...
    for (;;)
    {
        self waittill( "_encstr_B2BE0788BAF573592F", var_1, var_2, var_3, var_3, var_4, var_3, var_3, var_3, var_3, var_5, var_3, var_3, var_3, var_6 );
...
{
    self endon( "_encstr_AD75063D571AE108" );
    var_0 = "_encstr_96C51AB2304F73574870B9A15F563B7D43982A4BA1936E9B83CE8197";
    var_1 = 10;
    var_2 = 1.7;
    ...
    {
        var_3 = var_0 + var_1;
        self thread [[ anim.callbacks["_encstr_B2A216D049519FA2AFC0821A59A1AB9789AC409D533963B3"] ]]( var_3, "_encstr_BAF00BCDED5D9B19AFC8EDE656" );
        self waittill( "_encstr_BAF00BCDED5D9B19AFC8EDE656" );
        var_1 = var_1 + 10;
...
bomber_updateeveryframe( var_0 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        if ( isplayer( var_1 ) && !istrue( self.bomberplayerseesme ) )
        {
            ...
            if ( self cansee( var_1, 10000 ) && var_2 < squared( 900 ) && abs( self.origin[2] - var_1.origin[2] ) < self.createvisualsinfo )
...
bomber_checktarget( var_0 )
{
    ...
    if ( lengthsquared( var_1 ) < self.bomberexplodedistance * self.bomberexplodedistance )
    {
        ...
        {
            if ( abs( var_1[2] ) < self.createvisualsinfo )
            {
        ...
        else if ( abs( var_1[2] ) < self.createvisualsinfo )
        {
