...
handlenotetrack_vsplayer( var_0, var_1, var_2 )
{
    switch ( var_2 )
    {
        ...
        case "_encstr_88780599B4E495":
                ...
                if ( isplayer( var_3 ) )
                {
                    ...
                    if ( var_6 <= var_7 )
                    {
                        ...
                        if ( var_14 )
                        {
                            ...
                            var_12 = 0.7;
                            var_13 = 0.5;
                            setsaveddvar( "_encstr_856F0B9A4D92D4A0A272A2B428", 0.05 );
                        }

                        if ( isdefined( self.playerenemypool ) )
                            var_15 = self [[ self.playerenemypool ]]( var_3 );
                        else
                            var_15 = self melee( undefined, var_8, sqrt( var_7 ), var_9, var_10 );

                        if ( isdefined( var_15 ) )
                        {
                            if ( var_14 && ( self.unittype == "_encstr_958C08CDDBD8325A959C" || self.unittype == "_encstr_8BFC0BC2CBD4F737E0A5E1FD79" ) )
                                self playsound( "_encstr_A95D1358B4EBADCAC62B59D767CDBE6E86A52B6332" );
                        ...
                        if ( var_14 )
                            setsaveddvar( "_encstr_856F0B9A4D92D4A0A272A2B428", level.playermeleedamagemultiplier_dvar );
                    }
                    else
                    {
                        self.nextmeleechecktime = gettime() + randomintrange( 3000, 5000 );
            ...
            break;
        default:
            _encstr_953E1CDC6CC94B07E89BCB169BD2B65EDC7B3A953A4E168DB56E17CE378D::handlenotetrack( var_2, var_1 );
    }
}
...
melee_shouldabort( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( self.melee.babort ) )
    {
        if ( isdefined( self.melee.bwaituntilstop ) )
        {
            ...
            {
                var_4 = scripts\asm\asm::asm_eventfired( var_0, "_encstr_8CF30BF00FF4395B795A45C072" );
        ...
        {
            var_5 = scripts\asm\asm::asm_eventfired( var_0, "_encstr_8CF30BF00FF4395B795A45C072" );
...
evaluatesyncedmelee( var_0, var_1, var_2, var_3 )
{
    ...
    if ( weaponclass( self.weapon ) == "_encstr_8D940738966ED1DB8D" || weaponclass( var_4.weapon ) == "_encstr_8D940738966ED1DB8D" )
        return 0;
    ...
    var_8 = [ "_encstr_994C023A" ];

    if ( var_7 == "_encstr_864C02F9" )
    {
        var_8 = [ "_encstr_994C023A", "_encstr_8B4C024C", "_encstr_834C02D8" ];
        var_9 = 3;
...
waitforpartnerdelete( var_0, var_1 )
{
    ...
    var_1 waittill( "_encstr_8A490E5973475A8EE546CA63B23ACA46" );
    self notify( "_encstr_9B3F0BB5951BB22BEB2B0F96D1" );
}
...
playmeleeanim_synced_waitforpartnerexit( var_0, var_1 )
{
    ...
    self waittill( "_encstr_9B3F0BB5951BB22BEB2B0F96D1" );
    self unlink();
    var_2 = scripts\asm\asm::asm_eventfired( var_0, "_encstr_B8160F4DD56822790FB84BF1F3C8DF6F23" );

    if ( isdefined( self.melee.interacttimes ) && !var_2 )
        self.melee.survive = 1;
    else if ( var_2 && !scripts\asm\asm::asm_eventfired( var_0, "_encstr_A2420CB695B12BB2F5C8ACB03A1A" ) )
    {
        if ( isdefined( self.melee.interactendtimes ) )
            self.melee.survive = !scripts\asm\asm::asm_eventfired( var_0, "_encstr_84660547ED28E0" );
        else
    ...
    if ( !self.melee.winner )
    {
        ...
        else if ( scripts\asm\asm::asm_eventfired( var_0, "_encstr_8C4C120A71E977BF112D975FED38C6970CE973F3" ) )
            self.melee.ballowfinish = 1;
        else if ( scripts\asm\asm::asm_eventfired( var_0, "_encstr_8CF30BF00FF4395B795A45C072" ) )
            self kill();
        else if ( isdefined( self.melee.stoptimes ) )
            self.melee.babort = 1;
        else
    ...
    else if ( scripts\asm\asm::asm_eventfired( var_0, "_encstr_88780599B4E495" ) )
        self.melee.ballowfinish = 1;
...
{
    if ( issubstr( var_0, "_encstr_A31904E09BD7" ) )
    {
    ...
    switch ( var_0 )
    {
        case "_encstr_851905B3AB386F":
            if ( !isdefined( self.melee.babort ) )
            {
                if ( isdefined( self.melee.target ) )
                {
                    if ( isalive( self.melee.target ) )
                        self linktoblendtotag( self.melee.target, "_encstr_83A709A316CEAF6ECB731B", 1, 1 );
                }
                else if ( isdefined( self.melee.bvictimlinkstoattacker ) && isdefined( self.melee.partner ) )
                {
                    if ( isalive( self.melee.partner ) )
                        self linktoblendtotag( self.melee.partner, "_encstr_83A709A316CEAF6ECB731B", 1, 1 );
                }
            }

            break;
        case "_encstr_823D07034A671BD046":
            ...
            break;
        case "_encstr_B8160F4DD56822790FB84BF1F3C8DF6F23":
            self.melee.surviveanimallowed = 1;
            break;
        case "_encstr_A2420CB695B12BB2F5C8ACB03A1A":
            return var_0;
        case "_encstr_84FC0D1199D02EF74B6E3A72B09427":
            self attach( "_encstr_9AE61A90BF492BFFFAC134B129222336A37F28B817F2868FA274244D", "_encstr_8BC20B34E359B14F487C686005", 1 );
            self.melee.hasknife = 1;
            break;
        case "_encstr_BE9F0DC5AFB33381809F80A06FA619":
            self detach( "_encstr_9AE61A90BF492BFFFAC134B129222336A37F28B817F2868FA274244D", "_encstr_8BC20B34E359B14F487C686005", 1 );
            self.melee.hasknife = undefined;
            break;
        case "_encstr_881905373AB031":
            self playsound( "_encstr_A7F115576D449B4FB98F2B5C071FA6784BA3698D90796B" );
            playfxontag( level._effect["_encstr_95450F78420DD3B15F43188326DFBEA334"], self, "_encstr_B6FE0D8A501DD75A939491A2BE8C0B" );
            break;
        case "_encstr_8CF30BF00FF4395B795A45C072":
            break;
    }
}
...
playmeleeanim_synced_cleanup( var_0, var_1, var_2 )
{
    if ( isdefined( self.melee ) && isdefined( self.melee.partner ) )
        self.melee.partner notify( "_encstr_9B3F0BB5951BB22BEB2B0F96D1" );
...
melee_droppedweaponrestore()
{
    ...
    _encstr_842518E6D8395A38A3B9BC0B73B4AD5EB9862CE4AC8CE23BDC1B::forceuseweapon( self.melee.weapon, self.melee.weaponslot );
...
playmeleeanim_synced_victim( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self.melee.startyaw ) )
        self orientmode( "_encstr_A34A0B518A172592D6E64FA115", self.melee.startyaw );
    else if ( isdefined( self.melee.startangles ) )
        self orientmode( "_encstr_A34A0B518A172592D6E64FA115", self.melee.startangles[1] );
    else
    ...
    self aisetanim( var_1, var_3 );
    scripts\asm\asm::asm_playfacialanim( var_0, var_1, var_4 );
    var_5 = getnotetracktimes( var_4, "_encstr_8CF30BF00FF4395B795A45C072" );

    if ( var_5.size > 0 )
        self.melee.stoptimes = var_5;

    var_6 = getnotetracktimes( var_4, "_encstr_B8160F4DD56822790FB84BF1F3C8DF6F23" );

    if ( var_6.size > 0 )
        self.melee.interacttimes = var_6;

    var_7 = getnotetracktimes( var_4, "_encstr_84660547ED28E0" );
    ...
    if ( ( var_8 == "_encstr_A2420CB695B12BB2F5C8ACB03A1A" || !self.melee.winner ) && !isdefined( self.melee.survive ) )
    {
        self.a.nodeath = 0;
...
melee_synced_setup( var_0, var_1 )
{
    ...
    self.melee.weaponslot = _encstr_8814195F88DBF19B491E65EE881B02CF4358AFAB60B32986B7367E::getcurrentweaponslotname();
...
melee_unlink()
{
    ...
    {
        self.melee.partner animmode( "_encstr_A1370EF3FA638AFB695A587B03B42E57" );
        self.melee.partner orientmode( "_encstr_A34A0B518A172592D6E64FA115", self.melee.partner.angles[1] );
    }
...
playmeleeanim_vsplayer( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_3 ) )
        ...
        self orientmode( "_encstr_978B0B4A20EF7FA213A07966C5", var_3.origin );

    var_4 = scripts\asm\asm::asm_getanim( var_0, var_1 );
    scripts\asm\asm::asm_fireephemeralevent( "_encstr_AA060DADB26359CAAF0B8E47168DAD", "_encstr_845E066177577837" );
...
playmeleeattacksound()
{
    ...
    if ( isdefined( self.enemy ) && isplayer( self.enemy ) || randomint( 3 ) == 0 )
    {
        ...
        {
            _encstr_B282169B8DE496C13ACDE52C9BB4B6F29958D8595C3B6E1B::saygenericdialogue( "_encstr_A9110CDAAC36B259163AD10B8DAD" );
...
playmeleechargesound()
{
    ...
    if ( isdefined( self.enemy ) && isplayer( self.enemy ) || randomint( 3 ) == 0 )
    {
        ...
        {
            _encstr_B282169B8DE496C13ACDE52C9BB4B6F29958D8595C3B6E1B::saygenericdialogue( "_encstr_BE5E0C6135D5F7729EC9B2ED6F08" );
...
playmeleeanim_synced( var_0, var_1, var_2 )
{
    ...
    var_6 = getnotetracktimes( var_5, "_encstr_8CF30BF00FF4395B795A45C072" );

    if ( var_6.size > 0 )
        self.melee.stoptimes = var_6;

    var_7 = getnotetracktimes( var_5, "_encstr_B8160F4DD56822790FB84BF1F3C8DF6F23" );

    if ( var_7.size > 0 )
        self.melee.interacttimes = var_7;

    thread melee_waitfordroppedweapon( var_1 );
    var_3 scripts\asm\asm::asm_setstate( var_1 + "_encstr_BE8E08A9AC5A2EE13228" );
    self animmode( "_encstr_A1370EF3FA638AFB695A587B03B42E57" );
    self orientmode( "_encstr_A34A0B518A172592D6E64FA115", self.melee.startangles[1] );
    ...
    if ( ( var_8 == "_encstr_A2420CB695B12BB2F5C8ACB03A1A" || !self.melee.winner ) && !istrue( self.melee.survive ) )
    {
        self.a.nodeath = 0;
