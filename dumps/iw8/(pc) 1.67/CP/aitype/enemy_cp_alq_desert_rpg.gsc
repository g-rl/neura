...
setup_model( var_0 )
{
    character\character_iw8_cp_al_qatala_urban_bombvest::main_mp();
}

precache()
{
    var_0 = "_encstr_88CC1E33F6A127C3F7ED20D505CB490991AF4FBDA33FB1C78B33C53B89DD57D0";
    ...
    if ( !isdefined( level.agent_definition[var_0] ) )
    {
        ...
        character\character_iw8_cp_al_qatala_urban_bombvest::precache_mp( var_0 );
    }
