...
main()
{
    ...
    self.accuracy = 0.2;
    self.weapon = scripts\cp\cp_weapon::buildweapon( "_encstr_AA511062DBBA97C9E8DF996A9791D207C0F2", [ "_encstr_9BF00C3BF8BBD7FA7FFF148CE937" ], "_encstr_8BBA05185F8B99", "_encstr_8BBA05185F8B99" );
...
setup_model( var_0 )
{
    character\character_spetsnaz_lmg_cp::main_mp();
}

precache()
{
    var_0 = "_encstr_8ADB1E0B8D3AEDE4AF569BACB62F7DC683F54EBAE6AF2395CD59E4E87DD8B5CE";
    ...
    if ( !isdefined( level.agent_definition[var_0] ) )
    {
        ...
        character\character_spetsnaz_lmg_cp::precache_mp( var_0 );
    }
