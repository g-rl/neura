...
{
    self endon( "_encstr_AB4B0F079838DDEA7FF4944D6B0F726581" );
    self waittill( "_encstr_B2F1150BDFFAE03B721F4963CFAA732994F4B3A14654D8" );
...
initmeleeaction( var_0 )
{
    ...
    if ( var_1 != "_encstr_921D09D9D9C0090D7275B4" )
        self reacquireclear();
}
...
domeleeaction( var_0 )
{
    ...
    if ( scripts\asm\asm::asm_ephemeraleventfired( "_encstr_AA060DADB26359CAAF0B8E47168DAD", "_encstr_961804BD954A" ) )
        return anim.success;

    if ( scripts\asm\asm::asm_ephemeraleventfired( "_encstr_AA060DADB26359CAAF0B8E47168DAD", "_encstr_845E066177577837", 0 ) )
    {
...
meleecharge_shouldabort()
{
    ...
    if ( scripts\asm\asm::asm_ephemeraleventfired( "_encstr_8FAA13CDE06C37B027FF8C3743BCCDF02A83406550", "_encstr_961804BD954A" ) )
        return 1;
...
meleecharge_update( var_0 )
{
    ...
    if ( var_5 <= var_9 )
    {
        ...
        if ( isdefined( self.stairsstate ) && self.stairsstate != "_encstr_8BBA05185F8B99" && isplayer( var_4 ) )
            var_11 = 32;
...
gettargetchargepos( var_0 )
{
    ...
    var_5 = var_4["_encstr_A53009A25003666B9818C6"];
...
{
    if ( isdefined( self.ent_flag ) && isdefined( self.ent_flag["_encstr_99C811BEB98EB2B08D8E867DB29B0B891BCAC8"] ) && self.ent_flag["_encstr_99C811BEB98EB2B08D8E867DB29B0B891BCAC8"] )
    {
        if ( isdefined( self.ent_flag["_encstr_953010BEE61D9558638E0DFAB0E83AB06CD6"] ) && !self.ent_flag["_encstr_953010BEE61D9558638E0DFAB0E83AB06CD6"] )
            return 0;
    }
...
ismeleevalid( var_0, var_1 )
{
    ...
    if ( var_1 )
    {
        if ( isdefined( self.a.onback ) || self.currentpose == "_encstr_922406F1A6FD5E05" )
            return 0;
    ...
    if ( var_6 )
    {
        ...
        if ( self.stairsstate != "_encstr_8BBA05185F8B99" || var_0.stairsstate != "_encstr_8BBA05185F8B99" )
            return 0;

        if ( var_0.unittype != "_encstr_958C08CDDBD8325A959C" && var_0.unittype != "_encstr_83E8094727E333E8F9CE50" && var_0.unittype != "_encstr_8BFC0BC2CBD4F737E0A5E1FD79" )
            return 0;
    }
    ...
    if ( !isdefined( self.meleeignoreplayerstance ) || !self.meleeignoreplayerstance || !isplayer( var_0 ) )
    {
        ...
        if ( var_7 != "_encstr_A5AD069B231F0BAF" && var_7 != "_encstr_B13D076BED70539F23" )
            return 0;
    }
