...
playanim_exit( var_0, var_1, var_2 )
{
    ...
    {
        var_4 = issubstr( var_1, "_encstr_B68E06D8F6B3CA27" );
    ...
    if ( !isdefined( var_3 ) )
    {
        ...
        scripts\asm\asm::asm_fireevent( var_0, "_encstr_B4BA07CC5ADCB4CDD0" );
        return;
    }
...
getstartanim( var_0, var_1, var_2, var_3 )
{
    ...
    {
        if ( var_3 < 0 )
            var_6 = var_5 + "_encstr_844C029C" + var_1;
        else
            var_6 = var_5 + "_encstr_A54C0259" + var_1;
    }
    else
        var_6 = var_5 + var_1;
...
getstartmindist()
{
    ...
    if ( var_0 == "_encstr_914B078DB09BAB0BB1" || var_0 == "_encstr_8AEE0B360BE6578563AFCEBACD" || self aigetdesiredspeed() <= 60 )
        return 75.0;
...
determinestartanim( var_0, var_1, var_2 )
{
    ...
    var_5 = _encstr_8C9B1B371B39961CA337CBC2DC2D5BCBCAC34BE8BEDC7B46CA5CECDCD8::getexitnode();
    ...
    if ( !isdefined( self.asm.customdata.exitstate ) )
    {
        var_21 = issubstr( var_0, "_encstr_B68E06D8F6B3CA27" );
        var_22 = var_10;
        ...
        if ( var_21 && isdefined( var_5 ) )
        {
            ...
            if ( issubstr( var_0, "_encstr_A5AD056A019C63" ) && var_19 == 4 )
                var_24 = var_24 * -1;
...
playstartanim( var_0, var_1, var_2, var_3 )
{
    ...
    var_8 = getnotetracktimes( var_7, "_encstr_B6B30A278FC7F078673A0B11" );
    var_9 = getnotetracktimes( var_7, "_encstr_ACDA0736BDC9CD5693" );
    var_10 = getnotetracktimes( var_7, "_encstr_B1DA10D7CB3E035FD0FAB4FB3648BCAA9649" );
    var_11 = getnotetracktimes( var_7, "_encstr_A20B0E0CD973B37F9F4B987811B72589" );
    var_12 = 1;
    ...
    else if ( var_9.size > 0 )
    {
        ...
        if ( var_10.size > 0 && var_10[0] > 0 && var_10[0] < var_9[0] )
        {
            ...
            var_21.endnote = "_encstr_ACDA0736BDC9CD5693";

            if ( var_11.size > 0 && var_11[0] < var_9[0] )
                var_21.duration = int( ( var_11[0] - var_10[0] ) * getanimlength( var_7 ) * 1000 / var_14 );
        }
        else
            scripts\engine\utility::motionwarpwithnotetracks( var_7, var_24, ( 0, var_27, 0 ), undefined, "_encstr_ACDA0736BDC9CD5693", undefined, 0 );
    }
    else if ( var_10.size == 0 || var_10[0] == 0 )
    {
        ...
        scripts\engine\utility::motionwarpwithnotetracks( var_7, var_17, ( 0, var_19, 0 ), undefined, "_encstr_B6B30A278FC7F078673A0B11", var_28, 0 );
    }
    ...
    if ( !isdefined( var_21.posalongpath ) )
    {
        ...
        var_21.endnote = "_encstr_B6B30A278FC7F078673A0B11";
    ...
    if ( var_3 )
    {
        self animmode( "_encstr_820E07FAE8780B3A4C", 0 );
...
handlewarpexitstart( var_0, var_1 )
{
    ...
    if ( var_0 == "_encstr_B1DA10D7CB3E035FD0FAB4FB3648BCAA9649" && !isdefined( self.asm.customdata.ignoreexitwarp ) )
    {
        var_4 = var_1.endnote;

        if ( !isdefined( var_4 ) )
            var_4 = "_encstr_A20B0E0CD973B37F9F4B987811B72589";
        ...
        scripts\engine\utility::motionwarpwithnotetracks( var_1.xanim, var_2, ( 0, var_3, 0 ), "_encstr_B1DA10D7CB3E035FD0FAB4FB3648BCAA9649", var_4, var_5, 0 );
    }

    if ( var_0 == "_encstr_B6B30A278FC7F078673A0B11" || var_0 == "_encstr_ACDA0736BDC9CD5693" )
        self.isexiting = 0;
}
...
checktransitionpreconditions()
{
    ...
    if ( scripts\asm\asm::asm_getdemeanor() == "_encstr_914B078DB09BAB0BB1" || scripts\asm\asm::asm_getdemeanor() == "_encstr_8AEE0B360BE6578563AFCEBACD" || self aigetdesiredspeed() <= 60 )
    {
        var_0 = 50;
...
shoulddosharpturn( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_9 && self pathdisttogoal() > 90 || lengthsquared( self.velocity ) > var_11 )
    {
        ...
        if ( scripts\asm\shared\utility::demeanorhasblendspace() && scripts\asm\shared\utility::isentnotabomber() )
        {
            ...
            if ( !isdefined( var_15 ) )
                var_15 = "_encstr_99F605EE16B1DA";

            if ( var_15 == "_encstr_92100762872552A643" )
                var_15 = "_encstr_B4190493D573";
...
handlecornernotetrack( var_0, var_1 )
{
    if ( var_0 == "_encstr_ACDA0736BDC9CD5693" )
    {
        ...
        var_3 = var_1;
        var_4 = getnotetracktimes( var_3, "_encstr_ACDA0736BDC9CD5693" );
        var_5 = getnotetracktimes( var_3, "_encstr_B6B30A278FC7F078673A0B11" );
        var_6 = 1;
...
playsharpturnanim( var_0, var_1, var_2 )
{
    ...
    self motionwarpcancel();
    self orientmode( "_encstr_9138152067674D985235278BA027889D3A3702A3B22F80" );
    self animmode( "_encstr_820E07FAE8780B3A4C", 0 );

    if ( var_9 == "_encstr_B6B30A278FC7F078673A0B11" )
    {
        thread scripts\asm\shared\utility::waitforcoverapproach( var_0, var_1 );
        thread scripts\asm\shared\utility::waitforsharpturn( var_0, var_1 );
        var_10 = getnotetracktimes( var_4, "_encstr_B4BA07CC5ADCB4CDD0" );
...
sharpturn_setupmotionwarp( var_0, var_1 )
{
    ...
    {
        var_2 = getnotetracktimes( var_0, "_encstr_ACDA0736BDC9CD5693" );
...
playmoveloop_codeblend( var_0, var_1, var_2 )
{
    ...
    self aisetspeedscalemode( "_encstr_928A060723B255C8" );
    updatestumble();
...
playmovestrafeloop_codeblend( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\asm\asm::asm_lookupanimfromalias( var_1, "_encstr_AFAB063620A0C612" );
    self aisetanim( var_1, var_3 );
    self aisetspeedscalemode( "_encstr_B1D807C7E13E1266D0" );
...
{
    self aisetspeedscalemode( "_encstr_8BBA05185F8B99" );
}
...
shouldstrafeaimchange( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\asm\shared\utility::isentasoldier() && scripts\asm\shared\utility::demeanorhasblendspace() )
    {
        ...
        if ( var_19 == "_encstr_88BF08EBB84B751CA8C1" || var_19 == "_encstr_99F605EE16B1DA" )
            var_19 = "_encstr_99F605EE16B1DA";
        else if ( var_19 != "_encstr_8F7905C4AEC319" )
            var_19 = "_encstr_8F7905C4AEC319";
...
{
    if ( scripts\asm\asm::asm_eventfired( var_0, "_encstr_B6B30A278FC7F078673A0B11" ) && shouldstrafeaimchange( var_0, var_1, var_2, var_3 ) )
        return 1;
...
{
    self endon( "_encstr_847516CAE646BEC2B45BAF8D4358B9B3ACAFF69C4B2BDCD1" );
    ...
    while ( isdefined( self ) && isalive( self ) )
    {
        ...
        self orientmode( "_encstr_A34A0B518A172592D6E64FA115", var_15 );
...
playanim_strafeaimchange( var_0, var_1, var_2 )
{
    ...
    self aisetanim( var_1, var_3, var_5 );
    scripts\asm\asm::asm_playfacialanim( var_0, var_1, var_4 );
    var_8 = getnotetracktimes( var_4, "_encstr_B6B30A278FC7F078673A0B11" );
    var_9 = getnotetracktimes( var_4, "_encstr_B4BA07CC5ADCB4CDD0" );
    var_10 = 1;
    ...
    self notify( "_encstr_847516CAE646BEC2B45BAF8D4358B9B3ACAFF69C4B2BDCD1" );
    ...
    if ( var_21 == "_encstr_B6B30A278FC7F078673A0B11" )
    {
        if ( isdefined( var_14 ) )
            self orientmode( "_encstr_978B0B4A20EF7FA213A07966C5", var_14 );
        else
...
handlestrafenotetracks( var_0 )
{
    switch ( var_0 )
    {
        case "_encstr_87AF1AB852EC635603A77665C01EF1CD574A88C10B85BF294BD875E6":
            self.asm.strafe_foot = "_encstr_84610E4E9589F3C9F1687A525821BF13";
            self.asm.strafe_foot_time = gettime();
            break;
        case "_encstr_8437178E1898BD39FF1F7727E90196EE50C1439911A87923D5":
            self.asm.strafe_foot = "_encstr_B6760B643DCFD3DF3E6B78E8C3";
            self.asm.strafe_foot_time = gettime();
            break;
        case "_encstr_B85D1B58735AAD7DC1ED9B56107A0833BDDE3AEB1BEB997B93DDB04EC8":
            self.asm.strafe_foot = "_encstr_96880F99B7BDA3EBB1FACCDE27BB2C2791";
            self.asm.strafe_foot_time = gettime();
            break;
        case "_encstr_8A3B1B7F88D06DF1E9B8CA47374B3E2EB818A3FF934EDE3A054C56BA0D":
            self.asm.strafe_foot = "_encstr_AF2B0F6B0F4F4BA7F3A6ED7F0634EF826D";
            self.asm.strafe_foot_time = gettime();
            break;
    }
}
...
shouldstrafearrive( var_0, var_1, var_2, var_3 )
{
    ...
    var_13 = "_encstr_8F7905C4AEC319";
    var_14 = getanimspeedthreshold( var_11, "_encstr_88BF08EBB84B751CA8C1" );
    var_15 = getanimspeedthreshold( var_11, "_encstr_8F7905C4AEC319" );

    if ( !var_14 && !var_15 )
        var_13 = "_encstr_99F605EE16B1DA";
    else if ( var_14 && var_12 < getcoveranglelimits( var_11, "_encstr_88BF08EBB84B751CA8C1", "_encstr_99F605EE16B1DA", 0.2 ) )
        var_13 = "_encstr_88BF08EBB84B751CA8C1";
    else if ( var_15 )
    {
        if ( var_12 < getcoveranglelimits( var_11, "_encstr_99F605EE16B1DA", "_encstr_8F7905C4AEC319", 0.2 ) )
            var_13 = "_encstr_99F605EE16B1DA";
        else
            var_13 = "_encstr_8F7905C4AEC319";
    }
...
choosewalkandtalkanims( var_0, var_1, var_2 )
{
    var_3 = spawnstruct();
    var_4 = [];
    var_4[0] = scripts\asm\asm::asm_lookupanimfromalias( var_1, "_encstr_934C0218" );
    var_4[1] = scripts\asm\asm::asm_lookupanimfromalias( var_1, "_encstr_A34C02BB" );
    var_4[2] = scripts\asm\asm::asm_lookupanimfromalias( var_1, "_encstr_A74C0222" );
    var_3.anims = var_4;
    var_3.forwardanim = scripts\asm\asm::asm_lookupanimfromalias( var_1, "_encstr_B42E085325A82CB3F221" );
    return var_3;
}
...
movewalkandtalk( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        var_9 = scripts\asm\asm::asm_eventfired( var_0, "_encstr_A78D0F6CBDCE2B9CF5580E07C9F6168D0D" );
...
anglediffwalkandtalk()
{
    ...
    if ( isdefined( self.walk_and_talk_hemisphere ) )
    {
        ...
        if ( self.walk_and_talk_hemisphere == "_encstr_8253060E2B5FE330" )
        {
            if ( var_8 <= -1 )
                return -180;
...
movestartbattlechatter( var_0 )
{
    ...
    if ( var_1 == "_encstr_965108334E0B373A961B" || var_1 == "_encstr_AA7C07466F9DA30713" || var_1 == "_encstr_92100762872552A643" )
        _encstr_88C92737B1934B831DDC5E0BE6A5ADCB980B1D1DC6CAB1A12CD1A3AC937DBB9CC2071C59278B3BB9C6::evaluatemoveevent( var_0 );
}
...
{
    var_3 = "_encstr_AF4D07932B1BDE5846";
    var_4 = scripts\asm\shared\utility::getbasearchetype();

    if ( scripts\asm\shared\utility::isspeedwithincqbrange( var_4, self aigetdesiredspeed() ) )
        var_3 = "_encstr_AA930A6CB8C49C2B8DB7C291";
...
{
    if ( !scripts\asm\asm::asm_eventfired( var_0, "_encstr_834A0C9CACD87BC22308327B9BAC" ) )
...
isonanystairs()
{
    return isdefined( self.pathgoalpos ) && self.stairsstate != "_encstr_8BBA05185F8B99";
}
...
getstairsexitdist()
{
    ...
    switch ( var_0 )
    {
        ...
        case "_encstr_8AEE0B360BE6578563AFCEBACD":
            return 10;
        case "_encstr_965108334E0B373A961B":
...
{
    return self.stairsstate != "_encstr_8BBA05185F8B99" && shouldexitstairsstate( var_0, var_1, var_2, var_3 );
}
...
shouldexitstairsstate( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_3 ) && var_3 == "_encstr_87070365F7" )
...
{
    if ( self.asm.footsteps.foot == "_encstr_A5AD056A019C63" )
    ...
    if ( scripts\asm\shared\utility::isspeedwithincqbrange( var_4, self aigetdesiredspeed() ) )
    {
        var_5 = "_encstr_931904C66102" + var_3;
...
slopeupdate( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self.useslopes ) && self.useslopes == 1 )
    {
        ...
        var_5 = ( 0, 0, 1 );
        self endon( var_1 + "_encstr_A3DB0AF5332DDCD237D0AC8C" );
        var_6 = scripts\asm\asm::asm_lookupanimfromalias( var_1, var_1 + "_encstr_AB9E06461A1310B0" );
        var_7 = scripts\asm\asm::asm_getxanim( var_1, var_6 );
        var_8 = scripts\asm\asm::asm_lookupanimfromalias( var_1, var_1 + "_encstr_B16E0CA913600A235ED7E7E383F1" );
        ...
        for (;;)
        {
            ...
            var_11 = var_10["_encstr_820E07FAE8780B3A4C"];
            ...
            self setcustomnodegameparameter( "_encstr_938417CD8DBD8356B97D6E6CC95D4CEB914BC9951BD196DECD", var_3 );
            waitframe();
        }
    }
}
...
slopecleanup( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\asm\asm::asm_lookupanimfromalias( var_1, var_1 + "_encstr_AB9E06461A1310B0" );
    self clearanim( scripts\asm\asm::asm_getxanim( var_1, var_3 ), 0.1, "_encstr_AFFE10E781C09987B4B0270303C930E0823A" );
}

shouldstumble( var_0, var_1, var_2 )
{
    var_3 = scripts\asm\shared\utility::findoverridearchetype( "_encstr_8B1608EC43B8D647A113" );

    if ( var_3 != "_encstr_8DF306282FDA1969" || !isalive( self.enemy ) )
        return 0;
    ...
    var_4 = getnearestspeedthresholdname( var_3, "_encstr_B4190453BD3B" );
...
stumblechooseanim( var_0, var_1, var_2 )
{
    ...
    var_4 = getnearestspeedthresholdname( var_3, "_encstr_B4190493D573" );
    var_5 = getnearestspeedthresholdname( var_3, "_encstr_92100762872552A643" );
    var_6 = length( self.velocity );
    var_7 = "_encstr_8B780C06337F0D1559C7FF28182A";

    if ( var_6 > var_5 )
        var_7 = "_encstr_BAD10FFF6C4B783EBB52169BEB2B63B8A3";

    if ( var_6 > var_4 )
        var_7 = "_encstr_8F780C4EEBA32BA1847721401FAE";
