...
cargo_truck_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12C7B( "cargo_truck", "single", [ "driver" ] );
}

delete_name_fx()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_12D33( "cargo_truck", 1 );
    var_0.id = 8;
...
delete_me()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C4B( "cargo_truck", 3500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "cargo_truck" );
    var_0.class = "heavy";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C1F( "cargo_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C57( "cargo_truck", 20 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C50( "cargo_truck", ::cargo_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C5A( "cargo_truck_mp", 5 );
}

delete_light()
{
    var_0 = _accessreaderscriptableused::_id_12BF1( "cargo_truck", 1 );
    var_0.br_onvehicledeath = 2;
    var_0.get_random_station_names_on_track = 0.75;
    var_0.gate_closes = 350;
    var_0.gate_flares_think = 525;
    var_0.gasvfxstructs = 875;
    var_0.gcd = 5;
    var_0.generate_achievementid = 20;
    var_0.gatherstadiumlocs = 40;
...
cargo_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12C1A( var_2, "cargo_truck", var_0 );
