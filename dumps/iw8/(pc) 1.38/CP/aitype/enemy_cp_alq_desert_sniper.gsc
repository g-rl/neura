...
{
    var_1 = undefined;
    var_2 = [ "character_cp_al_qatala_desert_dmr" ];

    switch ( scripts\code\character::get_random_character( 1, var_1, var_2, "actor_enemy_cp_alq_desert_sniper" ) )
    {
        case 0:
...
precache()
{
    var_0 = "actor_enemy_cp_alq_desert_sniper";
