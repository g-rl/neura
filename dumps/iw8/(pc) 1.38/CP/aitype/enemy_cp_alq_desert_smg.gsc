...
main()
{
    ...
    self.accuracy = 0.2;
    self.weapon = scripts\cp\cp_weapon::buildweapon( "iw8_sm_uzulu_mp", [ "none", "none", "none", "none", "none", "none" ], "none", "none" );
...
setup_model( var_0 )
{
    ...
    switch ( scripts\code\character::get_random_character( 6, var_1, var_2, "actor_enemy_cp_alq_desert_smg" ) )
    {
        case 0:
...
precache()
{
    var_0 = "actor_enemy_cp_alq_desert_smg";
