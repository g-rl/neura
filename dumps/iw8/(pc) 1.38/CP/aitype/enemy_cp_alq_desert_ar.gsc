...
{
    var_1 = undefined;
    var_2 = [ "character_cp_al_qatala_desert_ar", "character_cp_al_qatala_desert_ar_2", "character_cp_al_qatala_desert_ar_3", "character_cp_al_qatala_desert_ar_4" ];

    switch ( scripts\code\character::get_random_character( 4, var_1, var_2, "actor_enemy_cp_alq_desert_ar" ) )
    {
        case 0:
...
precache()
{
    var_0 = "actor_enemy_cp_alq_desert_ar";
