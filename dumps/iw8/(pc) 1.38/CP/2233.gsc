...
init()
{
    ...
    level thread scripts\mp\trials\trial_race::init();
    playerzombiejumpcleanup();
...
playerzombiejumpcleanup()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_12D2E( "killstreak", 1 );
    var_0._id_12EB9["missileLocking"] = 2;
}
