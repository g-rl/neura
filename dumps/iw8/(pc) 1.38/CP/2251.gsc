...
clearlockedon( var_0 )
{
    ...
    {
        if ( isdefined( var_0.play_intro_getin_anim ) )
            var_0 thread [[ var_0.play_intro_getin_anim ]]();
    }

    var_0.hasincoming = undefined;
    var_0.play_intel_collect_vo = undefined;
    var_0.play_intro_getin_anim = undefined;
}
...
ammobox_clearbufferedattachmentweapon( var_0 )
{
    ...
    {
        if ( isdefined( var_0.play_intel_collect_vo ) )
            var_0 thread [[ var_0.play_intel_collect_vo ]]();
    }
...
_id_11EB3( var_0, var_1 )
{
    var_0.play_intel_collect_vo = var_1;
}

_id_11EB4( var_0, var_1 )
{
    var_0.play_intro_getin_anim = var_1;
}
...
watchtargetlockedontobyprojectile( var_0, var_1 )
{
    ...
    addlockedon( var_0 );
    ammobox_clearbufferedattachmentweapon( var_0 );
    var_1 scripts\engine\utility::_id_12E3F( "death", "clearTargetLockedOntoByProjectile" );
...
prohibited_weapon_list_from_vehicle( var_0 )
{
