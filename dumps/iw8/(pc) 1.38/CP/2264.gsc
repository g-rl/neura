...
train_attach_brushes_to_models()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_12D33( "pickup_truck", 1 );
    var_0.id = 7;
...
train_associate_models_with_brushes()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C4B( "pickup_truck", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "pickup_truck" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C1F( "pickup_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C57( "pickup_truck", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C50( "pickup_truck", ::pickup_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C5A( "pickup_truck_mp", 3 );
}
...
pickup_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12C1A( var_2, "pickup_truck", var_0 );
