...
tryusetomastrikefromstruct( var_0 )
{
    ...
    else if ( var_1 == 5 && isdefined( self.removedeathicon ) )
    {
    ...
    {
        var_3 = scripts\cp_mp\killstreaks\killstreakdeploy::streakdeploy_doweaponfireddeploy( var_0, getcompleteweaponname( "iw8_green_beam_mp" ), "weapon_fired", ::weapongiventomastrike, ::weaponswitchendedtomastrike, ::weaponfiredtomastrike );
...
{
    var_2 = scripts\cp_mp\utility\killstreak_utility::mark_danger_timeout();
    var_3 = ( 0, 0, 0 );
...
tomastrike_watchowner()
{
    self endon( "death" );
    level endon( "game_ended" );
    self.owner scripts\engine\utility::_id_12E40( "disconnect", "joined_team", "joined_spectators" );
    self notify( "death" );
}
...
tomastrike_watchcameraswitch( var_0, var_1 )
{
    ...
    for (;;)
    {
        var_6 = scripts\engine\utility::_id_12E47( "switch_camera_left", "switch_camera_right" );
...
tomastrike_getownerlookat( var_0 )
{
    ...
    var_5 = var_0 scripts\cp_mp\utility\killstreak_utility::updateachievementhangtime();
...
tomastrike_attacktarget( var_0, var_1, var_2, var_3 )
{
    ...
    else
    {
        ...
        if ( !istrue( var_3.regroup_points ) )
    ...
    {
        if ( var_0 == 5 && isdefined( var_3._id_12666 ) )
            var_6 = var_3._id_12666;
        else
            var_6 = tomastrike_getownerlookat( self );

        if ( !istrue( var_3.spawnregions ) )
        {
    ...
    if ( var_0 == 5 )
    {
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "br", "challengeEvaluator" ) )
        {
            ...
            var_9._id_1266B = var_6;
            self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "br", "challengeEvaluator" ) ]]( "br_mastery_pointBlank_tomahawk", var_9 );
        }

        var_7 = 6;

        if ( isdefined( var_3.start_death_from_above_sequence ) )
            var_7 = var_3.start_death_from_above_sequence;
    ...
    if ( var_0 == 0 || var_0 == 2 )
    {
        ...
        var_10 = var_6;
        var_11 = spawnstruct();
        var_11.sourcepos = var_4;
        var_11.goalpos = var_10;
        var_11.initvelocity = var_11.goalpos - var_11.sourcepos;
        thread tomastrike_firestrike( var_11, var_3, var_1 );
    }
    else if ( var_0 == 1 || var_0 == 3 || var_0 == 4 || var_0 == 5 )
    {
        ...
        var_15 = anglestoright( self.angles );
        scripts\cp_mp\hostmigration::hostmigration_waitlongdurationwithpause( var_12 );
        ...
        for ( var_17 = 0; var_17 < var_7; var_17++ )
        {
            ...
            var_11 = findunobstructedfiringinfo( var_6, var_8, var_13, var_14, var_15, var_18 );
            thread tomastrike_firestrike( var_11, var_3 );
...
findunobstructedfiringinfo( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5 ) )
        ...
        var_7 = _id_12775( var_0, var_2, var_3, var_4 );

    var_8 = vectornormalize( var_0 - ( var_7[0], var_7[1], 0 ) );
    var_9 = _id_12776( var_0, var_1, var_8 );
    ...
    var_6.infinite_chopper = var_9.infinite_chopper;
    var_6.ingame = var_9.ingame;
...
delayscriptablechangethread( var_0 )
{
    self.owner endon( "disconnect" );
    self endon( "death" );
    self.owner scripts\engine\utility::_id_12E53( var_0, "stop_marker_guide" );
...
_id_12776( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( level._id_12773 ) )
        var_9 = level._id_12773;
    ...
    if ( isdefined( var_12["entity"] ) )
    {
        ...
        var_10.infinite_chopper = var_13;

        if ( _id_12778( var_13 ) || _id_12777( var_13 ) )
            var_10.ingame = "flying";
    }
...
tomastrike_firestrike( var_0, var_1, var_2 )
{
    ...
    var_3 thread _id_12774();
    var_3 thread toma_strike_watch_airexplosion( var_0.preexplpos, var_0.infinite_chopper, var_0.ingame );
...
{
    self endon( "disconnect" );
    scripts\engine\utility::_id_12E53( 10, "death" );
...
toma_strike_watch_airexplosion( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_1 ) && isdefined( var_2 ) && var_2 == "flying" )
        var_1 dodamage( 500, var_0, self.owner, self, "MOD_EXPLOSIVE", getcompleteweaponname( "toma_proj_mp" ) );
}
...
_id_12775( var_0, var_1, var_2, var_3 )
{
