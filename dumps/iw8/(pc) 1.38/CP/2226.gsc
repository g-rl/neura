...
startchoppergunnerintro( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\cp_mp\utility\killstreak_utility::mark_danger_timeout();
    var_4 = ( 0, 0, 0 );
    ...
    else if ( istrue( var_0.playbattlechattersound ) && level.script == "cp_so_aniyah" )
    {
        ...
        while ( level.start_swivelroom_obj.size == 0 )
            waitframe();

        var_20 = scripts\engine\utility::getclosest( var_19, level.start_swivelroom_obj );
    ...
    if ( istrue( var_0.playbattlechattersound ) && level.script == "cp_so_aniyah" )
    ...
    var_24.playbattlechattersound = istrue( var_0.playbattlechattersound );
    var_24 setvehicleteam( var_24.team );
    var_24 thread dropangles( "disconnect", var_1 );
    var_24 thread dropangles( "joined_team", var_1 );
    var_24 thread dropangles( "joined_spectator", var_1 );
    var_27 = 2000;
    ...
    var_29 = var_24 dropaccesscard( 4.25 );
...
choppergunner_startremotecontrol( var_0 )
{
    ...
    thread dropbrammoboxes( "disconnect" );
    thread dropbrammoboxes( "joined_team" );
    thread dropbrammoboxes( "joined_spectator" );
    thread dropbrammoboxes( "team_kill_punish" );
    thread choppergunner_watchkills();
    thread choppergunner_handledestroyed( var_0 );
    thread choppergunner_notifyonkillstreakover();

    if ( !self.playbattlechattersound )
    {
...
choppergunner_updatetargetmarkergroups( var_0 )
{
    ...
    if ( istrue( level.give_random_munition ) )
        return;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_12E40( "leaving", "death", "explode" );
...
choppergunner_watchendstrobefx( var_0 )
{
    self endon( "death" );
    level endon( "game_ended" );
    var_0 scripts\engine\utility::_id_12E3F( "death", "leaving" );
    self delete();
}
...
choppergunner_handlemissilefire( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( self.playbattlechattersound && self.missilesleft == 8 )
            childthread drop_weapon_scripted();
        ...
        var_17 thread dropallunusableitems( self.owner, 2, 300, 300 );
...
choppergunner_watchturretfire( var_0 )
{
    ...
    for (;;)
    {
        ...
        self.streakinfo.shots_fired++;
        var_1 thread dropallunusableitems( self.owner, 0.5, 256, 200 );
    }
}
...
choppergunner_returnplayer( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( !istrue( var_1 ) )
        {
            ...
            level thread scripts\cp_mp\utility\killstreak_utility::_id_11ABD( var_2 );
            var_2 setclientomnvar( "ui_apache_screens_state", 0 );
            var_2 painvisionon();
            var_2 scripts\cp_mp\utility\killstreak_utility::killstreak_restorenvgstate();
...
{
    thread scripts\cp_mp\emp_debuff::trial_targs( self.owner, 5 );
    choppergunner_updatetargetmarkergroups();
}
...
dropallunusableitems( var_0, var_1, var_2, var_3 )
{
    level endon( "game_ended" );
