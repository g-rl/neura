...
missilelauncherusage()
{
    ...
    if ( self.missilelauncherstage == 1 )
    {
        ...
        if ( !var_0 && ( self.missilelaunchertarget scripts\cp_mp\vehicles\vehicle::isvehicle() && scripts\cp_mp\vehicles\vehicle::_id_12C95( self.missilelaunchertarget, self ) ) )
        {
            resetmissilelauncherlocking();
            return;
        }
...
stingtargstruct_getoffsets()
{
    ...
    else if ( scripts\cp\utility\entity::processsplashpriorityqueue( self.target ) )
    {
        self.offsets[self.offsets.size] = ( 0, 0, -50 );
        self.useoldlosverification = 0;
    }
