...
players_not_in_laststand( var_0 )
{
    if ( !isdefined( level.forcejumpnearobjective ) )
        level.forcejumpnearobjective = [];
}

forcestuckdamage( var_0 )
{
    self endon( "death_or_disconnect" );
    self endon( "faux_spawn" );
    self endon( "end_launcher" );
    var_1 = make_control_station_interaction( var_0 );
    var_2 = make_each_objective_scramble_radar( var_1 );
    thread forceotlogictorun( var_0, var_1, var_2 );
}
...
forceotlogictorun( var_0, var_1, var_2 )
{
    self notify( "cleanupImpactWatcher" );
    ...
    for (;;)
    {
        ...
        var_11 = _id_1229C( var_9, var_8, var_1, var_7 );
...
play_found_leads_counting( var_0, var_1, var_2, var_3, var_4 )
{

}

play_found_leads_counting_building_one( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    thread init_timed_laser_trap_trigger( var_0, var_5 );
}

play_found_leads_counting_building_three( var_0, var_1, var_2, var_3, var_4 )
{
    var_0 setscriptablepartstate( "effects", "impact" );
    thread _id_126E8( var_0, var_1, var_2, var_3 );
    thread _id_126E7( var_0, var_1 );
    thread _id_126E6( var_0 );
}

play_freefall_sequence( var_0, var_1, var_2, var_3, var_4 )
{
    if ( _id_1254D( var_1, var_4 ) )
    {
        ...
        thread _id_1254C( var_0 );
    }
    else
        var_0 setscriptablepartstate( "impact", "dud" );
}

init_timed_laser_trap_trigger( var_0, var_1 )
{
    self endon( "disconnect" );
...
_id_126E8( var_0, var_1, var_2, var_3 )
{
    self endon( "disconnect" );
    var_0 endon( "entitydeleted" );
    ...
    if ( isdefined( var_0.stuckenemyentity ) && isalive( var_0.stuckenemyentity ) )
    {
        ...
        {
            var_1 scripts\cp_mp\utility\damage_utility::isteameliminated();
            var_1 dodamage( 5, var_0.origin, self, var_0, "MOD_FIRE", var_4, var_3 );
            var_1 scripts\cp_mp\utility\damage_utility::isteamextracted();
            var_6--;
            wait( var_5 );
        }
    }
...
_id_126E7( var_0, var_1 )
{
    ...
    var_3.teamclearextractplunder = var_0.weapon;
    var_0._id_126EB = var_3.basename;

    while ( var_2 > 0 )
    {
        if ( isdefined( var_0.stuckenemyentity ) && isalive( var_0.stuckenemyentity ) )
            var_0.stuckenemyentity scripts\cp_mp\utility\damage_utility::adddamagemodifier( "thermiteBoltStuck", 0, 0, ::_id_126E0 );
...
_id_126E0( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( !isdefined( var_0._id_126EB ) || var_0._id_126EB != "thermite_bolt_radius_mp" )
        return 1;
...
_id_1229C( var_0, var_1, var_2, var_3 )
{
    var_4 = lootidtoindex( var_2 );
...
logevent_servermatchstart( var_0 )
{
    ...
    {
        if ( var_2 hasattachment( "ammo_crossbow" ) && self.blockdrive == "bolt_default" )
            return var_2;

        if ( var_2 hasattachment( "mag_sn_t9crossbow" ) && self.blockdrive == "bolt_default" )
            return var_2;

        if ( var_2 hasattachment( "boltstun_crossbow" ) && self.blockdrive == "bolt_stun" )
            return var_2;
    }
...
set_heli_crash_override( var_0 )
{
    ...
    foreach ( var_3 in level.forcejumpnearobjective )
    {
        if ( !isdefined( var_3 ) )
            continue;
    ...
    level.forcejumpnearobjective = var_1;
}

make_control_station_interaction( var_0 )
{
    var_1 = "";
...
make_each_objective_scramble_radar( var_0 )
{
    switch ( var_0 )
    {
        case "bolt_carbon":
            return ::play_found_leads_counting;
        case "bolt_explo":
            return ::play_found_leads_counting_building_one;
        case "bolt_fire":
            return ::play_found_leads_counting_building_three;
        case "bolt_stun":
            return ::play_freefall_sequence;
        default:
            return;
    }
}
...
_id_12019( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_1.blockdrive == "bolt_explo" )
        return 0;
...
linktoent( var_0, var_1, var_2 )
{
    ...
    if ( isplayer( var_1 ) && var_0.blockdrive != "bolt_stun" )
    {
...
_id_12BBB()
{
    if ( isdefined( self ) && istrue( self.propcleanup ) )
        return 1;
    else
    {
