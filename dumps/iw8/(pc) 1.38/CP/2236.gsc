...
manualturret_delayplacementinstructions( var_0 )
{
    ...
    thread set_player_munition_currency( "death" );
    thread set_player_munition_currency( "turret_placement_finished" );
}
...
manualturret_create( var_0, var_1 )
{
    ...
    var_3.escape_if_player_is_in_hangar.moverdoesnotkill = 1;
    var_3.escape_if_player_is_in_hangar._id_129D7 = var_3;
    return var_3;
}
...
manualturret_setplaced( var_0, var_1 )
{
    ...
    if ( !var_6 )
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "createObjective" ) )
            var_0.minimapid = var_0.escape_if_player_is_in_hangar [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "createObjective" ) ]]( var_7, var_0.team, undefined, 1, 1 );
    }
    ...
    var_0 thread set_relic_damage_from_above();
...
manualturret_setcarried( var_0 )
{
    ...
    if ( istrue( self.inuse ) )
    {
        ...
        var_0 set_relic_bang_and_boom( 1 );
    }

    if ( isdefined( self.moving_platform ) )
    {
        self.moving_platform = undefined;
        self.spawn_fake_digit_pool = undefined;
        self.spawn_exfil_techo = undefined;
        self unlink();
    }
    ...
    var_0 scripts\cp_mp\utility\weapon_utility::_id_11C5C();
...
manualturret_switchbacklastweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\cp_mp\utility\weapon_utility::_id_11ABE( self.lastdroppableweaponobj );
...
manualturret_watchuse( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        self.inuse = 1;
        var_3 set_relic_bang_and_boom( 0 );
            ...
            if ( var_5 >= 0.25 )
            {
                ...
                if ( isdefined( var_3 ) )
                {
                    ...
                    if ( var_3 scripts\cp_mp\utility\player_utility::_isalive() )
                        var_3 set_relic_bang_and_boom( 1 );
                }
        ...
        self.vehicle_collision_init = var_3;
        manualturret_makealltriggersusable( 0 );
        var_3 scripts\cp_mp\utility\weapon_utility::_id_11C5C();
        ...
        {
            var_7 = set_recent_spawn_time_threshold_override( var_3, var_3.useweapon );
        ...
        {
            self.inuse = undefined;
            self.vehicle_collision_init = undefined;
            ...
            if ( isdefined( var_3 ) )
            {
                ...
                {
                    var_3 set_relic_bang_and_boom( 1 );
                    var_8 = var_3 scripts\cp_mp\utility\weapon_utility::_id_11ABE( var_3.lastdroppableweaponobj );
        ...
        if ( scripts\cp_mp\utility\game_utility::isnightmap() )
            var_3 scripts\common\utility::binoculars_cansee( 0 );

        manualturret_applyoverlay( var_3 );
        thread manualturret_disablefire( var_3, 0.5, 1 );
        thread manualturret_watchammotracker( var_3 );
        thread set_relic_aggressive_melee( var_3 );
        thread set_relic_aggressive_melee_params( var_3 );
...
set_recent_spawn_time_threshold_override( var_0, var_1 )
{
    self endon( "kill_turret" );
    self endon( "turret_switch_weapon_timeout" );
    var_0 endon( "death_or_disconnect" );
    level endon( "game_ended" );
    thread set_relic_dfa( 1.0 );
...
manualturret_endplayeruse( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        ...
        var_0.vehicle_collision_init = undefined;
    ...
    if ( isdefined( self ) )
    {
        ...
        thread set_pressure_stability_reading();
...
manualturret_endturretonplayer( var_0 )
{
    var_0 endon( "end_turret_use" );
    level endon( "game_ended" );
    var_0 scripts\engine\utility::_id_12E3F( "death_or_disconnect", "last_stand_start" );
    var_0 manualturret_endplayeruse( self );
}
...
manualturret_watchdeath( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_0 scripts\cp_mp\utility\killstreak_utility::x1loadout( self.streakinfo );
    }

    if ( isdefined( self.vehicle_collision_init ) )
        self.vehicle_collision_init manualturret_endplayeruse( self );
...
manualturret_watchtimeout( var_0 )
{
    ...
    while ( self.timeelapsed < var_1 )
    {
        ...
        if ( isdefined( self.vehicle_collision_init ) )
            self.vehicle_collision_init setclientomnvar( "ui_killstreak_countdown", int( var_2 ) );

        self.timeelapsed = self.timeelapsed + level.framedurationseconds;

        if ( self.timeelapsed >= var_1 - 1.5 && !istrue( self._id_12503 ) )
            self._id_12503 = 1;
