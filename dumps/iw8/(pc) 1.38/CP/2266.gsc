...
technical_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12C7B( "technical", "single", [ "driver", "fl_rear", "fr_rear", "bl_rear", "br_rear" ] );
}

_id_126AA()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_12D33( "technical", 1 );
    var_0.id = 0;
...
_id_126A8()
{
    var_0 = _accessreaderscriptableused::_id_12BF1( "technical", 1 );
    var_0.br_onvehicledeath = 1.16666;
    var_0.get_random_station_names_on_track = 0.95833;
    var_0.gate_closes = 350;
    var_0.gate_flares_think = 525;
    var_0.gasvfxstructs = 875;
    var_0.gcd = 11.25;
    var_0.generate_achievementid = 45;
    var_0.gatherstadiumlocs = 90;
...
_id_126A9()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C4B( "technical", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "technical" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C1F( "technical" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C57( "technical", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C50( "technical", ::technical_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C5A( "technical_mp", 3 );
}
...
technical_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12C1A( var_2, "technical", var_0 );
...
technical_enterstart( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_3 ) && isplayer( var_3 ) && isdefined( var_3.russianletter ) )
        var_3.russianletter hide();
}
