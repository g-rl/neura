    ...
    for (;;)
    {
        ...
        if ( self.unresolved_collision_count >= var_2 )
        {
            if ( isdefined( var_0 ) )
            {
                ...
                {
                    if ( !scripts\cp_mp\vehicles\vehicle::_id_12C69( var_0, self ) )
...
unresolved_collision_nearest_node( var_0, var_1 )
{
    ...
    if ( scripts\cp_mp\utility\game_utility::islargemap() || scripts\cp\utility::prematchintiallandingcomplete() )
    {
        var_1 = 1;
