...
patched_collision()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_12D33( "hoopty", 1 );
    var_0.id = 9;
...
patchable_collision()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C4B( "hoopty", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "hoopty" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C1F( "hoopty" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C57( "hoopty", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C50( "hoopty", ::hoopty_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C5A( "hoopty_mp", 3 );
}
...
hoopty_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12C1A( var_2, "hoopty", var_0 );
