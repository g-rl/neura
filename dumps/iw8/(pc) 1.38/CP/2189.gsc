...
init_visionsetnight()
{
    if ( isdefined( level.start_escape_silo ) && isstring( level.start_escape_silo ) )
        visionsetnight( level.start_escape_silo );
    else
...
showminimap()
{
    if ( scripts\cp\utility::postspawn_trucks() )
        return;
