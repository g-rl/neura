...
apc_rus_initoccupancy()
{
    ...
    var_4._id_129D5 = getcompleteweaponname( "tur_apc_rus_mp" );
...
apc_rus_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12C7B( "apc_russian", "single", [ "driver", "front_right", "back_right", "back", "back_left", "front_left" ] );
}

bomber_damage_thread()
{
    var_0 = _accessreaderscriptableused::_id_12BF1( "apc_russian", 1 );
    var_0.br_onvehicledeath = 2.33333;
    var_0.get_random_station_names_on_track = 0.66666;
    var_0.gate_closes = 350;
    var_0.gate_flares_think = 525;
    var_0.gasvfxstructs = 875;
    var_0.gcd = 2.5;
    var_0.generate_achievementid = 10;
    var_0.gatherstadiumlocs = 20;
...
bomber_death_watcher()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_12D33( "apc_russian", 1 );
    var_0.id = 15;
    ...
    var_0.blockade_barbwires["driverTurret"] = 0;
    var_0._id_11B87["chassis"] = 0;
    var_0._id_11B87["turret"] = 1;
    var_0._id_11B88["driver"]["apc_rus_mp"] = "chassis";
    var_0._id_11B88["driver"]["tur_apc_rus_mp"] = "turret";
    var_0._id_11B88["front_left"]["apc_rus_mp"] = "chassis";
    var_0._id_11B88["front_left"]["tur_apc_rus_mp"] = "turret";
    var_0._id_11B88["front_right"]["apc_rus_mp"] = "chassis";
    var_0._id_11B88["front_right"]["tur_apc_rus_mp"] = "turret";
    var_0._id_11B88["back_right"]["apc_rus_mp"] = "chassis";
    var_0._id_11B88["back_right"]["tur_apc_rus_mp"] = "turret";
    var_0._id_11B88["back_left"]["apc_rus_mp"] = "chassis";
    var_0._id_11B88["back_left"]["tur_apc_rus_mp"] = "turret";
    var_0._id_11B88["back"]["apc_rus_mp"] = "chassis";
    var_0._id_11B88["back"]["tur_apc_rus_mp"] = "turret";
}

bomber_death_thread()
{
    var_0 = getdvarint( "scr_gw_apc_health_override", 4000 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C4B( "apc_russian", var_0 );
    var_1 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "apc_russian" );
    var_1.class = "super_heavy";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C1F( "apc_russian" );
    var_2 = getdvarint( "scr_gw_apc_hits_override", 18 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C57( "apc_russian", var_2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C55( "apc_russian", ::apc_rus_premoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C54( "apc_russian", ::bomber_radiusdamage );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C50( "apc_russian", ::apc_rus_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C5A( "tur_apc_rus_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C5A( "apc_rus_mp", 5 );
}
...
apc_rus_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12CDB( var_2, var_3, getcompleteweaponname( "tur_apc_rus_mp" ), 1 );
    scripts\cp_mp\vehicles\vehicle::_id_12C1A( var_2, "apc_russian", var_0 );
    ...
    var_4.getjuggmazebutton = "kill_apc_rus";
    var_4.getjuggmazespawnpoint = 1;
    ...
    var_2 thread bomber_delay_thread();
...
apc_rus_premoddamagecallback( var_0 )
{
    ...
    if ( vectordot( var_5, var_6 ) < var_8 )
        var_0.radar_sweeps = bomb_wires_to_cut( var_0 );

    return 1;
}

bomber_radiusdamage( var_0 )
{
...
apc_rus_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_1 == "driver" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::_id_12C70( var_0, "tur_apc_rus_mp" );
    ...
    if ( var_1 == "driver" )
        var_0 thread bomber_disable_movement_for_time( var_3 );
}
...
bomber_shouldusetraversals( var_0 )
{
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::_id_12C70( self, "tur_apc_rus_mp" );
    var_0 endon( "death" );
    var_0.shotsleft = 14;
...
{
    self endon( "death" );
    var_1 = scripts\cp_mp\vehicles\vehicle::_id_12C70( self, "tur_apc_rus_mp" );
...
{
    if ( var_2 == "driver" )
        var_0 bomber_spawn_origin_array_init();
}
