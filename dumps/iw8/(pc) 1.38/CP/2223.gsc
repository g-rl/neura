...
initcratedata()
{
    ...
    level.cratedata._id_12A5E = pow( getdvarfloat( "scr_crateUnresolvedCollisionToleranceSqr", 2 ), 2 );
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "registerPlayerFrameUpdateCallback" ) )
        [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "registerPlayerFrameUpdateCallback" ) ]]( ::_id_127D3 );
...
getemptyleveldata()
{
    ...
    var_0.nextplayertospectate = 27.5;
...
createcrate( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( level.gametype == "infect" )
        var_11.reaper_waitformissilereloadfinish = 1;
...
capturecrate( var_0 )
{
    ...
    if ( isdefined( self.owner ) && istrue( self.owner.propsize ) )
        self.owner.propsize = 0;
...
destroycrate( var_0 )
{
    ...
    if ( !isdefined( var_0 ) )
    {
        ...
        {
            if ( !istrue( self.track_is_operational ) )
            {
                self.destroyonactivate = 1;
                return;
            }
    ...
    if ( !istrue( var_0 ) )
    {
        ...
        if ( !istrue( self.physicsactivated ) || !istrue( self.track_is_operational ) )
        {
...
initcratedropdata()
{
    var_0 = spawnstruct();
    var_0.helis = [];
    var_1 = scripts\cp_mp\utility\killstreak_utility::mark_danger_timeout();
...
initscriptedhelidropanims()
{
    ...
    playerpowersupdateongamepadchange();
}
...
watchdropcratefrommanualheliinternal()
{
    ...
    {
        self.heli scripts\engine\utility::_id_12E3F( "death", "goal" );
...
watchcrateuse( var_0, var_1 )
{
    ...
    if ( isdefined( var_3._id_12B9F ) )
        var_3.usetime = var_3._id_12B9F;
    ...
    for (;;)
    {
        ...
        {
            if ( istrue( var_4.isjuggernaut ) && !var_4 register_vehicle_spawn_override( self.cratetype ) )
            {
...
ballowexecutions()
{
    ...
    thread bankplunderextractinstantly( var_0 );
...
bankplunderextractinstantly( var_0 )
{
    ...
    else
    {
        ...
        {
            var_1 = scripts\cp_mp\utility\weapon_utility::_id_11ABE( self.lastdroppableweaponobj );
...
_id_12F0B()
{
    for (;;)
    {
        foreach ( var_1 in level.cratedata.usablecrates )
        {
            ...
            var_1 makeusable();
            var_1 disableplayeruseforallplayers();

            if ( isdefined( var_1.useobject ) )
            {
                var_1.useobject makeusable();
                var_1.useobject disableplayeruseforallplayers();
            }
...
final_switch_think( var_0, var_1 )
{
    var_2 = getleveldata( self.cratetype );

    if ( isdefined( var_2.final_wave ) )
        self thread [[ var_2.final_wave ]]();
    ...
    createdangerzone();
    thread skipignoredamage();
    thread skipuavupdate();
    thread slide_airlock();
}
...
skipignoredamage()
{
    ...
    var_0 = 0.1;
    thread skipfriendlyfire( var_0, 8 );
    var_1 = 0;
    var_2 = 0;
    self.propsizetext = 1;
    var_3 = undefined;
    ...
    for (;;)
    {
        var_5 = lootchopper_isnearbyoccupiedspawns();
        var_6 = lootchopper_initspawninfo();
        ...
        if ( isdefined( var_5 ) && isdefined( var_6 ) )
        {
            if ( var_5 <= 5.0 && var_6 <= 1.0 )
            {
                ...
                if ( var_1 == 6 )
                {
                    self.track_is_operational = 1;
                    var_3 = self.origin;
                    thread activatecrate( self.propsizetext );
                    ...
                    var_0 = 0.1;
                    thread skipfriendlyfire( var_0, 3, 3 );
                    getkeypadcodelengthfromomnvar();
                }
            }
            else
...
skipfriendlyfire( var_0, var_1, var_2 )
{
    end_wave_spawn_ahead_of_completion();
    self endon( "death" );
    self endon( "clear_average_velocities" );
    self.safehouse_regroup = [];
    self.blueprintextract_cleanupwhennoavailablelocales = [];
    self._id_12D3F = 0;
    self._id_12D3A = 0;
    self._id_12D3C = var_1;
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        if ( var_2 > 0 )
        {
            ...
            {
                self.safehouse_regroup[self._id_12D3F + var_3] = 0;
                self.blueprintextract_cleanupwhennoavailablelocales[self._id_12D3F + var_3] = 0;
            }
        }
    }
    ...
    for (;;)
    {
        ...
        self.safehouse_regroup[self._id_12D3A] = length( var_5 );
        self.blueprintextract_cleanupwhennoavailablelocales[self._id_12D3A] = length( var_6 );
        self._id_12D3A++;
        var_7 = self._id_12D3A - self._id_12D3F;
        ...
        if ( var_7 > var_1 )
        {
            ...
            {
                self.safehouse_regroup[self._id_12D3F + var_3] = undefined;
                self.blueprintextract_cleanupwhennoavailablelocales[self._id_12D3F + var_3] = undefined;
            }

            self._id_12D3F = self._id_12D3F + var_8;
        }

        self.brevent3 = undefined;
        self.brevent2 = undefined;
        wait( var_0 );
    }
}

lootchopper_isnearbyoccupiedspawns()
{
    if ( isdefined( self.brevent3 ) )
        return self.brevent3;

    if ( !isdefined( self.safehouse_regroup ) )
        return undefined;

    if ( self._id_12D3A - self._id_12D3F < self._id_12D3C )
        return undefined;
...
{
    if ( isdefined( self.brevent2 ) )
        return self.brevent2;

    if ( !isdefined( self.blueprintextract_cleanupwhennoavailablelocales ) )
        return undefined;
...
damageskipburndown()
{
    ...
    for ( var_2 = self._id_12D3F; var_2 < self._id_12D3A; var_2++ )
    {
        var_0 = var_0 + self.safehouse_regroup[var_2];
        var_1 = var_1 + self.blueprintextract_cleanupwhennoavailablelocales[var_2];
    }

    self.brevent3 = var_0 / self._id_12D3C;
    self.brevent2 = var_1 / self._id_12D3C;
}

end_wave_spawn_ahead_of_completion()
{
    self notify( "clear_average_velocities" );
    self.safehouse_regroup = undefined;
    self.blueprintextract_cleanupwhennoavailablelocales = undefined;
    self._id_12D3C = undefined;
    self._id_12D3F = undefined;
    self._id_12D3A = undefined;
    self.brevent3 = undefined;
    self.brevent2 = undefined;
}
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_9 ) )
        {
            if ( isdefined( var_9.classname ) && var_9.classname == "scriptable_iw8_chicken_01" )
                thread balloons( var_9 );

            display_hint_for_player_single( var_9 );
        }

        if ( isdefined( var_9 ) && play_fulton_evac_on_player( var_9 ) )
        {
            if ( var_9 scripts\cp_mp\killstreaks\helper_drone::propwatchdeath() )
        ...
        if ( gettime() - var_1 >= 200 )
        {
            ...
            vehicle_damage_registerdefaultvisuals( var_6, var_7, var_8, var_11 );
        }
    }
}
...
display_hint_for_player_single( var_0 )
{
    ...
    {
        if ( isdefined( self._id_12848 ) )
        {
            if ( self._id_12848 == var_0 )
                return;
            else
                defenderflag_bflagstart();
        }

        self._id_12848 = var_0;
        self._id_12847 = 4;
        thread display_hint_forced( var_0 );
    }
}
...
display_hint_forced( var_0 )
{
    ...
    while ( self._id_1284D < 5 )
    {
        var_7 = self.origin + anglestoup( self.angles ) * var_1.nextplayertospectate;
        var_8 = var_7 + ( 0, 0, -200 );
        var_9 = scripts\engine\trace::ray_trace( var_7, var_8, var_3, var_2 );

        if ( var_9.size > 0 && isdefined( var_9["entity"] ) && var_9["entity"] == self._id_12848 )
        {
            var_10 = combineangles( invertangles( var_0.angles ), var_0.origin - var_9["position"] );

            if ( !isdefined( self._id_1284E ) )
            {

            }
            else if ( distancesquared( var_10, self._id_1284E ) > 25 )
            {
                self._id_1284D++;
                self._id_1284F = 0;
            }
            else if ( vectordot( var_10, self._id_1284E ) < 0.997 )
            {
                self._id_1284D++;
                self._id_1284F = 0;
            }
            else
            {
                ...
                {
                    self linkto( var_0 );
                    activatecrate( self.propsizetext );
                    thread final_radius_think();
                    break;
                }
            }

            self._id_1284E = var_10;
        }
        else
            break;
...
defenderflag_bflagstart()
{
    ...
    self._id_12848 = undefined;
    self._id_1284E = undefined;
    self._id_1284D = undefined;
    self._id_1284F = undefined;
}
...
skipweapondropondeath()
{
    if ( !istrue( self.skydiveontacinsertplacement ) )
        return;

    self notify( "monitorImpactEnd" );
    self.skydiveontacinsertplacement = undefined;
    self stoploopsound( "mp_care_package_drop_lp" );
    self physics_unregisterforcollisioncallback();
}

play_fulton_evac_on_player( var_0 )
{
    if ( !istrue( self.track_is_operational ) )
    {
        if ( isdefined( var_0.classname ) )
        {
            ...
            {
                if ( var_0 scripts\cp_mp\killstreaks\helper_drone::propwatchdeath() )
                {
                    var_1 = getleveldata( self.cratetype );
                    var_2 = self.origin + anglestoup( self.angles ) * var_1.nextplayertospectate;
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_2 ) && ( isplayer( var_2 ) || isagent( var_2 ) ) && var_2 scripts\cp_mp\utility\player_utility::_isalive() )
        {
            ...
            if ( var_2 tagexists( "j_mainroot" ) )
            {
                ...
                var_8 = self.origin + anglestoup( self.angles ) * var_7.nextplayertospectate;
...
vehicle_damage_registerdefaultvisuals( var_0, var_1, var_2, var_3 )
{
...
{
    if ( level.cratedata._id_12A5E > 0 )
    {
        if ( lengthsquared( var_1 ) <= level.cratedata._id_12A5E )
            return;
    }

    var_2 = self.objweapon;

    if ( isdefined( self.finalthreeuav ) )
...
_id_127D3()
{
    if ( !isdefined( self.init_airdrop_anims ) )
    {
        if ( self ismantling() )
        {
            ...
            {
                self.init_ai_spawns = var_0;
                self.init_ai_weapons = var_0.crate;
            }

            self.init_airdrop_anims = gettime() + 1000;
        }
    }
    else if ( gettime() >= self.init_airdrop_anims )
    {
        self.init_ai_spawns = undefined;
        self.init_ai_weapons = undefined;
        self.init_airdrop_anims = undefined;
    }
    else
    {
        foreach ( var_2 in level.cratedata.crates )
        {
            if ( isdefined( var_2 ) && istrue( var_2.physicsactivated ) && !istrue( var_2.track_is_operational ) )
            {
                if ( isdefined( self.init_ai_spawns ) )
                {
                    if ( isdefined( var_2.mountmantlemodel ) )
                    {
                        if ( self.init_ai_spawns != var_2.mountmantlemodel )
                        {
...
dropkillstreakcratefromscriptedheli( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_0 thread baloon_deposit_death_check( var_7 );
...
baloon_deposit_death_check( var_0, var_1 )
{
...
airdrop_watchplayerweapon( var_0 )
{
    ...
    var_1 = scripts\engine\utility::_id_12E47( "cancel_deploy", "weapon_switch_started" );
...
airdropmarkeractivate( var_0, var_1, var_2 )
{
    ...
    var_5 scripts\cp_mp\utility\killstreak_utility::x1loadout( var_2 );
}
...
initbattleroyaleloadoutcratedata()
{
    ...
    var_0.destroycallback = ::cloudorigin;
...
playerpowershud()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.activatecallback = ::claymore_crate_use;
    var_0.capturecallback = ::claymore_forceclampangles;
    var_0.destroycallback = ::claymore_load_spawning;
    var_0.final_wave = ::claymore_stunned;
    var_0.destroyoncapture = 1;
}

claymore_crate_use( var_0 )
{
...
heli_convertforplayerfunc( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = 250;
    var_8 = level.cyber_bot_pickup_emp;
    var_9 = 1000;
    var_10 = 10500;
    var_11 = 7500;
    var_12 = 3000;
    ...
    if ( isdefined( var_15 ) )
    {
        ...
        if ( !var_5 && var_13[2] < var_0[2] )
        {
            ...
            if ( isdefined( var_16 ) )
            {
                ...
                var_15 thread _id_12F16();
                var_20 thread _id_12F17( var_19 );
            }
            else
                var_15 final_switch_think();
        }
        else
            var_15 final_switch_think();
        ...
        var_15._id_120E7 = spawn( "script_model", var_1 );
        var_15._id_120E7 setmodel( "ks_airdrop_crate_br" );

        if ( !istrue( var_6 ) )
            var_15._id_120E7 setscriptablepartstate( "smoke_signal", "on", 0 );

        var_23 = getleveldata( var_14 );

        if ( isdefined( var_23.velstartid ) )
            var_15 thread [[ var_23.velstartid ]]();
    }
...
playerpowerssetupkeybindings()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.activatecallback = ::codecorrectlyenteredbyanyone;
    var_0.capturecallback = ::codeentered;
    var_0.destroycallback = ::codeloc;
    var_0.destroyoncapture = 1;
}
...
heli_flyloop( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2._id_120E7 = spawn( "script_model", var_1 );
        var_2._id_120E7 setmodel( "ks_airdrop_crate_br" );
        var_2._id_120E7 setscriptablepartstate( "smoke_signal", "on", 0 );
    }

    return var_2;
}

heli_go_to_exfil_point( var_0, var_1 )
{
    var_2 = dropcrate( undefined, undefined, "battle_royale_chopper_loot", var_0, ( 0, randomfloat( 360 ), 0 ), var_1 );
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2._id_120E7 = spawn( "script_model", var_1 );
        var_2._id_120E7 setmodel( "ks_airdrop_crate_br" );
        var_2._id_120E7 setscriptablepartstate( "smoke_signal", "pe_chopper_on", 0 );
    }
...
playerpowersmonitorinput()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.capturecallback = ::clearsoundsubmixmpbrinfilac130;
    var_0.destroycallback = ::clearsoundsubmixmpbrinfilanim;
    var_0.activatecallback = ::clearsoundsubmixfadetoblackamb;
    var_0.final_wave = ::clearspaceforscriptableinstance;
    var_0.velstartid = ::clearsplashqueue;
    var_0.destroyoncapture = 1;
}

clearsoundsubmixfadetoblackamb( var_0 )
{
...
clearsoundsubmixmpbrinfilac130( var_0 )
{
    self setscriptablepartstate( "objective_map", "inactive", 0 );
...
clearsoundsubmixmpbrinfilanim( var_0 )
{
    self setscriptablepartstate( "objective_map", "inactive", 0 );
...
heli_starts_restrict_to( var_0, var_1, var_2 )
{
...
_id_122D1( var_0, var_1 )
{
    ...
    if ( istrue( self.propdeductflash ) )
        var_2 = 10000;

    var_3 = heli_starts_restrict_to( self.team, var_0 + ( 0, 0, var_2 ), var_0 + ( 0, 0, 512 ) );
    var_3 endon( "death" );
    hostdefensefactormod( var_3 );
    dontclose( var_3 );
    var_4 = [];
...
register_vehicle_spawn_override( var_0 )
{
    var_1 = 1;
...
playerpowerstartcooldown()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.capturecallback = ::copycirclearraystartingat;
    var_0.activatecallback = ::copy_wave_settings_from_module;
    var_0.destroycallback = ::copyplayerplundereventdata;
    var_0.final_wave = ::corner0to2dist;
    var_0.destroyoncapture = 1;
}
...
helihint_activate_vo( var_0 )
{
    ...
    var_3 = var_0 + ( 0, 0, 512 );
    level._id_11ADD.killstreak_createobjective_engineer = spawnfx( level._effect["smoke_tactical_device"], level._id_11ADD.getoverridedvarexceptmatchrulesvalues - ( 0, 0, 60 ) );
    triggerfx( level._id_11ADD.killstreak_createobjective_engineer );
    var_4 = dropcrate( undefined, undefined, "battle_royale_tactical_device", var_2, ( 0, randomfloat( 360 ), 0 ), var_3 );
    var_4.skipminimapicon = 1;
    corner3to0dist( var_4 );
}

copy_wave_settings_from_module( var_0 )
{
