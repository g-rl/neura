...
{
    if ( isdefined( var_1 ) && istrue( var_1.isequipment ) )
    {
        var_6 = scripts\mp\utility\weapon::isthrowingknife( var_4 );
...
{
    if ( !level.potgenabled || !( isdefined( self.petwatch ) && self.petwatch.tower_ground_mortar == "pet_turbo" ) )
        return;
            ...
            if ( distancesquared( self.lastkillvictimpos, self.origin ) < 40000 )
            {
                ...
                if ( var_3 < 750 )
                {
                    ...
                    if ( !isdefined( var_1.lastteabagtime ) || var_2 - var_1.lastteabagtime > 5000 )
                    {
                        ...
                        self.pers["teaBags"]++;
                        scripts\cp_mp\pet_watch::anglesoffset();
                    }
