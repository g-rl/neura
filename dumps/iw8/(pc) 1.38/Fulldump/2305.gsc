...
stoppingpower_onkill( var_0, var_1 )
{
    ...
    foreach ( var_3 in level.mines )
    {
        ...
        if ( distancesquared( var_1, var_3.origin ) < 262144 )
            var_3 thread scripts\mp\equipment\claymore::eggs( var_0 );
    }
}
...
applyconcussion( var_0, var_1 )
{
    ...
    if ( istrue( self.extactioncomplete ) )
        return;
    ...
    var_1 scripts\cp\helicopter\chopper_boss::supersupplydropbeginuse( "equip_concussion" );
