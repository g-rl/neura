...
init_battlechatter()
{
    ...
    anim._id_126FB = 120000;
    bcs_setup_countryids();
    level.claymore_blockdamageuntilframeend = 1;
}
...
{
    return istrue( level.claymore_blockdamageuntilframeend );
}
...
allow_cp_munitions( var_0 )
{
    ...
    var_0 setnpcid();
    thread _id_11A00( var_0 );
    var_0 thread spawnboardroom_auav();
}
...
{
    level._battlechatter.revive_icon_color_keep = var_0;
    level._battlechatter.revive_or_disconnect_monitor = gettime();
}

callouttypewillrepeat( var_0 )
{
    if ( !isdefined( level._battlechatter.revive_icon_color_keep ) )
        return 0;

    if ( !isdefined( level._battlechatter.revive_or_disconnect_monitor ) )
        return 0;

    var_1 = level._battlechatter.revive_icon_color_keep;
    var_2 = level._battlechatter.revive_or_disconnect_monitor;
    var_3 = anim._id_126FB;
...
playorderevent( var_0, var_1, var_2 )
{
    ...
    switch ( var_0 )
    {
        case "action":
            ...
            tac_cover_give_new( var_1, var_2 );
            break;
        case "move":
            tac_cover_give_new( var_1, var_2 );
            break;
        case "displace":
            tac_cover_give_new( var_1 );
            break;
    }
...
playphrase( var_0, var_1, var_2 )
{
    ...
    var_1 thread _id_11EB5( var_1.curevent.eventaction, var_1.curevent.eventtype );
...
_id_11EB5( var_0, var_1 )
{
    self.battlechatter.isspeaking = 1;
    scripts\engine\utility::_id_12E3F( "playPhrase_done", "death" );
