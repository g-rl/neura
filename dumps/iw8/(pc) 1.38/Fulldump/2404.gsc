...
addtoactivekillstreaklist( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        {
            addtouavlist( var_7 );
            thread removefromuavlistondeath( var_7 );
        }
...
removefromuavlistondeath( var_0 )
{
    self waittill( "death" );
...
{
    scripts\engine\utility::_id_12E3F( "death", "carried" );
...
killshouldaddtokillstreak( var_0 )
{
    ...
    return !scripts\mp\utility\weapon::iskillstreakweapon( var_0.basename ) && !scripts\mp\utility\points::quarry_mortar_guys( var_0 );
}
