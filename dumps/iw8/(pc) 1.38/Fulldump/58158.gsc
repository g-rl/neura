...
descendpos( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( self getcurrentweapon() == var_0.destroyscoreevent._id_12FF0 && !self attackbuttonpressed() )
        {
            ...
            thread scripts\mp\gametypes\br_public::updatelocationbesttimehud( "iw8_ges_plyr_gas_can_ignite", var_1 );
            wait( var_1 );
        ...
        foreach ( var_8 in var_3 )
        {
            ...
            else
            {
                ...
                if ( var_8 scripts\mp\gametypes\br_public::hasarmor() )
                    var_8 scripts\mp\gametypes\br_public::damagearmor( var_1 );

                var_8 scripts\mp\gametypes\br_circle::_id_12972();
            }
