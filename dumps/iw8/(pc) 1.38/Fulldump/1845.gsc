...
dopotgkillcamforplayer()
{
    ...
    var_1 = scripts\engine\utility::_id_12E4E( "begin_killcam", "killcam_ended" );
...
dofinalkillcam()
{
    ...
    level thread scripts\cp\helicopter\chopper_boss::processfinalkillchallenges( var_2, var_3 );
...
skipkillcamduringdeathtimer( var_0 )
{
    ...
    if ( !isai( self ) )
    {
        ...
        var_1 = scripts\engine\utility::_id_12E47( "killcam_death_done_waiting", "killcam_death_button_cancel" );
