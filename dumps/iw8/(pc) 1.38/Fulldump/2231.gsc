...
gunship_startuse( var_0, var_1 )
{
    ...
    var_9 thread nakeddrophandleloadout( var_0 );
    var_9 thread namehud( var_0, "disconnect" );
    var_9 thread namehud( var_0, "joined_team" );
    var_9 thread namehud( var_0, "joined_spectators" );
    var_9 thread namehud( var_0, "team_kill_punish" );
...
gunship_playintro( var_0, var_1, var_2, var_3 )
{
    ...
    if ( gunship_islargemap() )
    {
        ...
        else if ( isdefined( level.nag_radius ) )
            level.gunship.origin = level.nag_radius;
        else
    ...
    level.gunship_intromodel thread name_fx( "disconnect", var_1 );
    level.gunship_intromodel thread name_fx( "joined_team", var_1 );
    level.gunship_intromodel thread name_fx( "joined_spectators", var_1 );
    waitframe();
...
name_fx( var_0, var_1 )
{
    ...
    nag_get_in_heli( var_2, var_1 );
}

nag_get_in_heli( var_0, var_1 )
{
    var_2 = 0;
