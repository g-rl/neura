...
jugg_watchfordoors()
{
    var_0 = scripts\mp\gametypes\br_plunder::vehicle_occupancy_instanceisregistered( "equip_mp_fulton", 1 );
    var_0.type = 0;
...
{
    var_1 = scripts\mp\gametypes\br_plunder::vehicle_occupancy_instanceisregistered( "equip_mp_fulton" );
    thread scripts\mp\gametypes\br::_id_1269B( "br_fulton_balloon_shot_down", self.owner, self.team );
    scripts\mp\gametypes\br_plunder::init_ai_spawners( var_1.dropplunder );
...
jugg_protect_jammer()
{
    ...
    scripts\mp\gametypes\br_plunder::vehicle_occupancy_getreserving( self );
...
jugg_watchmanualreload()
{
    ...
    thread scripts\mp\gametypes\br::_id_1269B( "br_fulton_device_placed", self.owner, self.team );
    var_0 = scripts\mp\utility\teams::getfriendlyplayers( self.team );
    scripts\mp\gametypes\br_plunder::vehicle_occupancy_monitorgameended( self, "equip_mp_fulton" );
    thread scripts\mp\gametypes\br_plunder::vehicle_on_last_pathing_array( self, var_0 );
    scripts\mp\gametypes\br_plunder::vehicle_preventplayercollisiondamagefortimeafterexitinternal( self, var_0 );
    ...
    var_2 = scripts\mp\gametypes\br_plunder::vehicle_occupancy_instanceisregistered( "equip_mp_fulton", 1 );
...
{
    var_3 = scripts\mp\gametypes\br_plunder::vehicle_occupancy_instanceisregistered( "equip_mp_fulton" );
    var_1 thread scripts\mp\gametypes\br_plunder::updateondamagepredamagemodrelicsfunc( var_2, var_3._id_12B7B, var_0 );
}
...
juggerbear( var_0, var_1 )
{
    ...
    scripts\mp\gametypes\br_plunder::vehicle_occupancy_mp_showcashbag( var_0 );
}
...
juggernaut_damage_override( var_0 )
{
    ...
    var_2 = scripts\mp\gametypes\br_plunder::init_ai_kill_params_for_events();
    thread scripts\mp\gametypes\br::_id_1269B( "br_fulton_balloon_successfully_away", self.owner, self.team );
...
{
    thread scripts\mp\gametypes\br::_id_1269B( "br_fulton_balloon_full", var_0.owner, var_0.team );
}
