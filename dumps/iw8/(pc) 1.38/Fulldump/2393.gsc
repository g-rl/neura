...
leaderdialogonplayer_internal( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( level.gametype == "br" )
        var_5 = scripts\mp\gametypes\br_public::clear_and_give_killstreak_loadout_support( self );
...
playkillstreakusedialog( var_0 )
{
    ...
    if ( level.gametype == "br" )
        var_3 = scripts\mp\gametypes\br_public::clear_and_give_killstreak_loadout_support( self );
