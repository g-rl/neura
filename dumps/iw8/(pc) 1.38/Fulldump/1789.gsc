...
init( var_0, var_1 )
{
    ...
    if ( var_2 )
        var_3 = matchdata_logattackerkillevent( var_1 );
    else
        var_3 = 180;

    if ( !isdefined( level.killthrowingknifefire ) )
    {
        if ( var_2 )
            level.killthrowingknifefire = getdvarfloat( "scr_br_gasMask_resist", 0 );
        else
            level.killthrowingknifefire = 0.2;
    }

    self.gasmaskhealth = var_3;
    self.kingslayerdeaths = var_3;
    self.kioskreviveplayer = var_1;
    var_4 = 2;

    if ( proplockunlock( var_1 ) )
        var_4 = 3;
    ...
    if ( var_2 )
        level.kingslayer = self.gasmaskhealth / 6;

    level.kingslayerdeaths = var_3;
...
processdamage( var_0 )
{
    ...
    var_2 = self.gasmaskhealth / self.kingslayerdeaths;
    self.gasmaskhealth = self.gasmaskhealth - var_0;
    self.gasmaskhealth = max( 0, self.gasmaskhealth );

    if ( var_1 )
        var_3 = ( self.gasmaskhealth + 1 ) / self.kingslayerdeaths;
    else
        var_3 = self.gasmaskhealth / self.kingslayerdeaths;
    ...
    self.gasdamagebuffer = self.gasdamagebuffer + var_0 * level.killthrowingknifefire;
...
getquickdropammotype( var_0, var_1 )
{
    var_2 = scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) && [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "getGameType" ) ]]() == "br";
    ...
    if ( !isdefined( self.kingslayerdeaths ) )
        self.kingslayerdeaths = matchdata_logattackerkillevent( self.kioskreviveplayer );

    var_3 = var_0 / self.kingslayerdeaths;
    var_4 = var_1 / self.kingslayerdeaths;
    var_5 = floor( var_3 * 6 + 0.5 );
...
equipgasmask()
{
    ...
    if ( istrue( self.operatorcustomization.outputfunc ) )
