...
_id_11CE4( var_0 )
{
    ...
    {
        var_1 = "bash_left_90";
        var_2 = self.enemy_push_players_logic + ( 0, 90, 0 );
    }
    else
    {
        var_1 = "bash_right_90";
...
_id_11CE6( var_0 )
{
    ...
    var_1 = self.enemy_respawn_manager;
    var_2 = var_0.enemy_respawn_manager;
...
handlesoloexclusionils( var_0, var_1 )
{
    var_2 = !var_0;
