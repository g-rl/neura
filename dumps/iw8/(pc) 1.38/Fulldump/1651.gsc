...
guy_runtovehicle_loaded( var_0, var_1 )
{
    ...
    if ( !getdvarint( "enable_vehicle_ai_using_BT" ) )
    {
        var_2 = var_0 scripts\engine\utility::_id_12E48( "long_death", "death", "enteredvehicle" );
...
{
    scripts\engine\utility::_id_12E3F( "unload", "death" );
...
guy_unload_que( var_0 )
{
    ...
    var_0 scripts\engine\utility::_id_12E3F( "death", "jumpedout" );
    ...
    if ( !self.unloadque.size )
    {
        ...
        self.has_current_combat_action = undefined;
    }
}
...
{
    if ( isdefined( self.has_current_combat_action ) )
        return;

    self.has_current_combat_action = [];
    ...
    for ( var_0 = 0; var_0 < level.vehicle.templates.aianims[scripts\common\vehicle_code::get_vehicle_classname()].size; var_0++ )
    {
        ...
        if ( isdefined( var_1.vehicle_getoutanim ) )
        {
            ...
            self.has_current_combat_action[var_2] = spawnstruct();
            self.has_current_combat_action[var_2].open = 0;
            self.has_current_combat_action[var_2].table_getrole = 0;
        }
    }
}
...
wait_for_open_door( var_0, var_1 )
{
    ...
    if ( isdefined( var_1.vehicle_getoutanim ) )
    {
        ...
        if ( !self.has_current_combat_action[var_2].open )
        {
            ...
            self.has_current_combat_action[var_2].open = 1;
        }
