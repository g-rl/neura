...
createspawnweaponatpos( var_0, var_1, var_2 )
{
    ...
    var_5 = scripts\mp\gametypes\br_pickups::maphint_computerscriptableused( var_0, var_1 );
...
createspawnweaponatposfromname( var_0, var_1 )
{
    ...
    var_4 = scripts\mp\gametypes\br_pickups::maphint_computerscriptableused( var_0, ( 0, 0, 90 ) );
...
playerdropweaponfrominventory( var_0 )
{
    ...
    if ( isdefined( var_8 ) )
    {
        ...
        var_14 = scripts\mp\gametypes\br_pickups::playersetattractiontime();
...
takeweaponpickup( var_0 )
{
    ...
    if ( !isdefined( var_0.weapon ) )
    {
        ...
        {
            var_3 = scripts\mp\gametypes\br_pickups::makepickup( var_0 );
    ...
    if ( var_7 )
    {
        ...
        if ( var_8.basename != "none" )
        {
            ...
            var_21 = !scripts\mp\gametypes\br_extract_quest::initbrmechanics( var_8 );

            if ( var_21 )
            {
                var_22 = scripts\mp\gametypes\br_pickups::maphint_computerscriptableused( var_0.origin, ( 0, var_20, 0 ) );
                ...
                if ( isdefined( var_29 ) )
                {
                    scripts\mp\gametypes\br_pickups::select_back_two_spawners( var_29, var_13, var_14, var_15 );
                    var_30 = 1;
                    scripts\mp\gametypes\br_analytics::branalytics_lootdrop( self, var_8.basename, var_30, var_13 );
                }
            }
...
{
    if ( scripts\mp\gametypes\br_gametypes::propsetclonesleft( "weapons" ) )
        return;
...
{
    if ( istrue( level.checkforarenaloadoutoverride ) && !scripts\mp\gametypes\br_public::prophasclonesleft() )
        return 1;
}
