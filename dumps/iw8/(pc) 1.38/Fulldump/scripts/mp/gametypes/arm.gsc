    ...
    if ( istrue( level.useobjectives ) )
    {
        ...
        foreach ( var_2 in level.allfobs )
        {
            ...
            if ( istrue( level.keypad_increase_failnum ) )
                var_2._id_1231E = scripts\mp\gametypes\obj_dom::_id_1231F;
...
createc130( var_0, var_1 )
{
    ...
    var_2 thread scripts\mp\gametypes\br_c130::gunship_spawnvfx();
    return var_2;
}
...
listenkick( var_0, var_1 )
{
    ...
    var_2 = var_0 scripts\mp\gametypes\br_helicopters::calctrailpoint();
...
c130_pickrandomflightpath()
{
    ...
    level.c130pathstruct_a = scripts\mp\gametypes\br_c130::makepathstruct( var_3 );
    var_3.randomangle = var_3.randomangle + 180;
    level.c130pathstruct_b = scripts\mp\gametypes\br_c130::makepathstruct( var_3 );
    var_4 = 0.2;
    var_5 = 0;
    var_6 = 0;
