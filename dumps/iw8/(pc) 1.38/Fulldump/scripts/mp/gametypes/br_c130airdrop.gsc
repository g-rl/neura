    ...
    for (;;)
    {
        ...
        if ( var_7 < var_3 )
        {
            ...
            for ( var_12 = 0; var_12 < var_10; var_12++ )
            {
                ...
                if ( var_12 == 0 )
                    scripts\mp\gametypes\br_gametype_dmz::_id_1205D( "br_c130airdrop_incoming" );
...
custom_putongroundfunc( var_0, var_1, var_2 )
{
    if ( isdefined( level.br_level.br_mapcenter ) && isdefined( level.br_level.br_mapsize ) )
        ...
        var_3 = scripts\mp\gametypes\br_c130::spawnc130pathstruct( var_1 );
...
custom_shouldtakedamage( var_0, var_1, var_2 )
{
    ...
    var_5 = scripts\mp\gametypes\br_c130::method_for_calling_reinforcemen();
    ...
    var_3 = scripts\mp\gametypes\br_c130::_id_12290( var_4, var_6 );
    return var_3;
}
...
customturret( var_0, var_1 )
{
    ...
    {
        var_7 = scripts\mp\gametypes\br_c130::ispointinbounds( var_2, 1, 0 ) && !cyberteamspawnsetids( var_2 );
...
cypher_current_string( var_0 )
{
    ...
    if ( !scripts\mp\gametypes\br_public::prophasclonesleft() && getdvarint( "scr_dmz_airdrop_drop_tablet", 0 ) == 1 )
    {
    ...
    var_6 = scripts\mp\gametypes\br_pickups::playersetattractiontime();
    var_6.heli_lookat_monitor = self.itemsdropped;
    var_3 = scripts\mp\gametypes\br_plunder::dropplunderbyrarity( var_5, var_6 );
    var_2 = scripts\engine\utility::array_combine( var_2, var_3 );
