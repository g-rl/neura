...
init()
{
    ...
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "endGame", ::init_create_script_for_level );
    ...
    scripts\mp\gametypes\br_gametypes::zombienumhitsheli( "dropBagDelay", 180 );
    ...
    scripts\mp\gametypes\br_gametype_rebirth::control_station();
    var_0 = 30;
    ...
    level.keypad_playerinteractwithkeypadloop["mayConsiderPlayerDead"] = scripts\mp\gametypes\br_gametype_rebirth::completedmounttut;
    level.keypad_playerinteractwithkeypadloop["triggerRespawnOverlay"] = scripts\mp\gametypes\br_gametype_rebirth::controls_unlink_safe;
    level.keypad_playerinteractwithkeypadloop["playerNakedDropLoadout"] = scripts\mp\gametypes\br_gametype_rebirth::confirm_good_pickup_location;
    level.keypad_playeridlewatch["mayConsiderPlayerDead"] = scripts\mp\gametypes\br::codephonescodeenteredringingfrenzy;
    level.keypad_playeridlewatch["triggerRespawnOverlay"] = scripts\mp\gametypes\br_gulag::_id_1292E;
    level.keypad_playeridlewatch["playerNakedDropLoadout"] = scripts\mp\gametypes\br::spawn_remote_tank_thermite;
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "mayConsiderPlayerDead", ::_start_spawn_modules );
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "triggerRespawnOverlay", ::_stop_spawn_modules );
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "playerNakedDropLoadout", ::_startragdollwithvehiclefeature );
...
activate_destructible_cinderblock( var_0 )
{
    foreach ( var_2 in scripts\mp\utility\teams::getteamdata( var_0.team, "players" ) )
    {
        ...
        if ( var_2 != var_0 && var_3 )
        {
            ...
            var_2 scripts\mp\gametypes\br_gametype_rebirth::connected_search_node();
        }
    }
}
...
init_cp_vehicle( var_0 )
{
    ...
    {
        if ( !var_2 scripts\mp\gametypes\br_public::questtypes() )
...
init_death_animations()
{
    ...
    var_3 = scripts\mp\gametypes\br_quest_util::is_point_in_cylinder( "escape", var_2 );
    var_4 = undefined;
    var_5 = "none";
    ...
    else
    {
        ...
        var_4 = scripts\mp\gametypes\br_circle::mine_caves_vo( var_0, var_1, var_6, var_7, var_8, var_9, var_10, var_11 );
...
init_fan_blades( var_0 )
{
    ...
    foreach ( var_4 in level.players )
    {
        if ( var_4.team == var_0.team )
        {
            ...
            {
                if ( !var_4 scripts\mp\gametypes\br_public::questtypes() )
                    var_4 thread activate_track_timer( "escape_chopper_comms_online", 4 );
                ...
                var_5 = scripts\mp\gametypes\br_vip_quest::_id_12D6C( var_4, var_0, "exfil_respawn" );
...
activate_trap_from_interaction( var_0, var_1, var_2 )
{
    ...
    scripts\mp\gametypes\br_public::cloud_cover( var_0, var_3, var_2 );
}
...
heli_rpg_enemy_think( var_0 )
{
    ...
    level.init_cp_execution.radio = scripts\mp\gametypes\br_pickups::spawnpickup( "brloot_escape_radio", var_7, 0, 1 );
    ...
    {
        if ( !var_1 scripts\mp\gametypes\br_public::questtypes() )
...
active_cs_files( var_0 )
{
    foreach ( var_0 in scripts\mp\utility\teams::getteamdata( var_0.team, "players" ) )
    {
        ...
        var_0 scripts\mp\gametypes\br_gametype_rebirth::computer_animation_off();
...
activeclosingpool( var_0, var_1 )
{
    ...
    else if ( var_0 == "on_ground" )
    {
        ...
        if ( var_3 != -1 )
        {
            ...
            {
                if ( !var_5 scripts\mp\gametypes\br_public::questtypes() )
...
activate_server_for_interact( var_0 )
{
    ...
    var_1 scripts\mp\gametypes\br_quest_util::force_ai_to_drop_thermites( 4, 8, 4, var_2 );
    var_1 scripts\mp\gametypes\br_quest_util::_id_11EBE( var_0 );

    foreach ( var_4 in level.players )
        var_1 scripts\mp\gametypes\br_quest_util::_id_12056( var_4 );
}
...
activate_seq_button()
{
    ...
    foreach ( var_2 in level.players )
        var_0 scripts\mp\gametypes\br_quest_util::overrideviewkickscaledmr( var_2 );
}
...
activatemeleeblood( var_0 )
{
    ...
    if ( !isdefined( level._id_1269E ) || !isdefined( level._id_1269E[var_0.team] ) || level._id_1269E[var_0.team] == 0 )
        scripts\mp\gametypes\br_quest_util::watch_for_near_objective_point( var_0.team );
...
activate_switch_cooldown( var_0 )
{
    ...
    for ( var_7 = 0; var_7 < var_6.size; var_7++ )
    {
        var_4 = var_6[var_7];
        var_8 = var_7 + 1;
        thread scripts\mp\gametypes\br::supplydropprice( var_4, var_8, 0, 1 );
    }
...
addspecialistbonuspickup( var_0, var_1, var_2 )
{
    ...
    if ( var_4 != -1 )
    {
        ...
        {
            if ( !var_8 scripts\mp\gametypes\br_public::questtypes() )
    ...
    if ( var_10 != -1 )
    {
        ...
        {
            if ( var_8 scripts\mp\gametypes\br_public::questtypes() || var_8.team == var_0.team )
...
activate_stealth_settings( var_0 )
{
    ...
    foreach ( var_3 in level.players )
    {
        if ( !var_3 scripts\mp\gametypes\br_public::questtypes() )
        {
            if ( var_0 )
            {
