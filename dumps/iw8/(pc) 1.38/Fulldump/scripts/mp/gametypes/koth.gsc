...
hardpointmainloop()
{
    ...
    if ( level.firstzoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture::scriptable_callback( level.firstzoneactivationdelay, level.zone.curorigin + level.zone.offset3d );
...
getfirstzone()
{
    ...
    var_0 thread scripts\mp\gametypes\obj_zonecapture::_id_12F4B();
    level.juggernauts_spawned thread scripts\mp\gametypes\obj_zonecapture::_id_12F4B();
    return var_0;
}
...
hqactivatenextzone( var_0, var_1 )
{
    ...
    else if ( level.zoneactivationdelay )
    {
        ...
        level._id_13159 = 1;
        level thread scripts\mp\hud_message::updatematchstatushintforallplayers( undefined, 36, 36 );
        level.zone thread scripts\mp\gametypes\obj_zonecapture::scriptable_callback( level.zoneactivationdelay, level.zone.curorigin + level.zone.offset3d );
