...
main()
{
    ...
    level.propwaitminigamerun = 0;
    var_0 = getdvarint( "LTSNLQNRKO" ) && !getdvarint( "LSTLQTSSRM" );

    if ( var_0 )
        level.propwaitminigamerun = getdvarint( "scr_siege_groundwarSiege", 0 );

    level.binoculars_istargetinbroadfov = [];

    if ( level.propwaitminigamerun )
        level.binoculars_istargetinbroadfov[level.binoculars_istargetinbroadfov.size] = "arm";
    ...
    if ( istrue( level.propwaitminigamerun ) )
    ...
    if ( level.propwaitminigamerun )
    {
        ...
        level.maxhqtanks = 0;
        level.start_coop_escape = getdvarint( "scr_siege_numNonRallyVehicles", 25 );
        level._id_120B5 = 1;
...
onstartgametype()
{
    ...
    if ( level.propwaitminigamerun )
    {
        ...
        scripts\mp\gametypes\arm::_id_11F6F();
        scripts\mp\gametypes\arm::calculatehqmidpoint();
        level.start_coop_escort_protect_hvi = getdvarint( "scr_siege_flagcount", 3 );
        setomnvar( "ui_num_dom_flags", level.start_coop_escort_protect_hvi );
        scripts\mp\gametypes\arm::setupobjectives();
        level thread runobjectives();
        thread scripts\mp\gametypes\arm::init_groundwarvehicles();
        thread playimpactfx();
        scripts\mp\gametypes\arm::highesttraceindex();
    }
    else
    {
        initspawns();
...
modify_plunder_itemsinworld( var_0, var_1 )
{
    ...
    level.br_toggle_armor_allows = var_4;
    level.br_tacmap_icon = var_5;
...
updategametypedvars()
{
    ...
    level.patch_far_wait = scripts\mp\utility\dvars::dvarfloatvalue( "holdAllTimer", 7.5, 0, 60 );
}
...
getspawnpoint()
{
    ...
    else
    {
        ...
        else
        {
            ...
            var_8 = scripts\mp\gametypes\dom::getpreferreddompoints( var_5, var_7, var_0, var_3 );
            var_9 = [];
...
onplayerconnect( var_0 )
{
    ...
    if ( level.propwaitminigamerun && isdefined( game["roundsPlayed"] ) && game["roundsPlayed"] != 0 && !scripts\mp\flags::gameflag( "prematch_done" ) )
...
domflags()
{
    ...
    level.start_coop_escort_protect_hvi = 3;
    setomnvar( "ui_num_dom_flags", level.start_coop_escort_protect_hvi );

    if ( level.start_coop_escort_protect_hvi == 3 )
    {
    ...
    foreach ( var_24 in level.objectives )
    {
        ...
        var_24._id_124D9 = ::superselectonset;
...
watchflagenduse( var_0 )
{
    ...
    if ( var_1 == level.start_coop_escort_protect_hvi )
        setwinner( "allies", "siege_allflags_win", "siege_allflags_loss" );
    else if ( var_2 == level.start_coop_escort_protect_hvi )
...
onuse( var_0 )
{
    ...
    if ( var_2 == "neutral" )
    {
        ...
        {
            if ( var_4 == 2 && level.start_coop_escort_protect_hvi == 3 )
            {
...
{
    if ( isdefined( self._id_12EC9 ) )
        self._id_12EC9 = undefined;
...
checkendgame()
{
    ...
    if ( var_0 == level.start_coop_escort_protect_hvi )
        setwinner( "allies", "siege_allflags_win", "siege_allflags_loss" );
    else if ( var_1 == level.start_coop_escort_protect_hvi )
        setwinner( "axis", "siege_allflags_win", "siege_allflags_loss" );
}
...
runobjectives( var_0 )
{
    ...
    foreach ( var_2 in level.allfobs )
    {
        ...
        var_2.trigger.gameobject._id_124D9 = ::superselectonset;
    ...
    if ( level.precappoints )
        scripts\mp\gametypes\obj_dom::precap( level.start_coop_escort_protect_hvi == 5 );

    scripts\mp\gametypes\dom::flagsetup();
    level thread objective_manageobjectivesintrovisibility();
    level thread scripts\mp\gametypes\arm::binoculars_iswithinprojectiondistance_compute();
}
...
_id_119DC( var_0 )
{
    if ( level.mapname == "mp_downtown_gw" )
    {
        if ( var_0.objkey == "_b" && !isdefined( var_0.stealth_broken_music ) )
        {
            var_0.stealth_broken_music = "_a";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_c" && !isdefined( var_0.stealth_broken_music ) )
        {
            var_0.stealth_broken_music = "_c";
            var_0.objkey = "_b";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_d" && !isdefined( var_0.stealth_broken_music ) )
        {
            var_0.stealth_broken_music = "_d";
            var_0.objkey = "_c";
            var_0.script_label = var_0.objkey;
        }
    }
    ...
    {
        if ( var_0.objkey == "_a" && !isdefined( var_0.stealth_broken_music ) )
        {
            var_0.stealth_broken_music = "_a";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        ...
        else if ( var_0.objkey == "_e" && !isdefined( var_0.stealth_broken_music ) )
        {
            var_0.stealth_broken_music = "_e";
            var_0.objkey = "_c";
            var_0.script_label = var_0.objkey;
        }
    }
    ...
    else if ( var_0.objkey == "_b" && !isdefined( var_0.stealth_broken_music ) )
    {
        var_0.stealth_broken_music = "_b";
        var_0.objkey = "_a";
        var_0.script_label = var_0.objkey;
