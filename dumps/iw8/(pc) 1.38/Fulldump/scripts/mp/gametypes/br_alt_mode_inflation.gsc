...
init()
{
    ...
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "postPlunder", ::vfx_height );
...
playerdropplunderondeath( var_0, var_1 )
{
    ...
    var_2 = var_2 - var_3;
    scripts\mp\gametypes\br_plunder::playersetplundercount( var_2, minigun_manager() );

    if ( level.checkforlaststandfinish.healthpool >= 0 )
        var_3 = int( min( level.checkforlaststandfinish.healthpool, var_3 ) );

    scripts\mp\gametypes\br_plunder::heli_leaving_monitor( var_3, var_0 );
    return 1;
}
...
circletimer( var_0 )
{
    ...
    if ( !level.checkforlaststandfinish.disabled && var_0 >= var_1 )
    {
        ...
        foreach ( var_3 in level.players )
        {
            ...
            var_3 _id_12B20();
            scripts\mp\gametypes\br_killstreaks::get_actual_grenade_name( var_3, "cash_deploy_closed", undefined, 2 );
        }
    }
