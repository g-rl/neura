...
init()
{
    ...
    scripts\mp\gametypes\br_quest_util::getquestdata( "x2_stash" )._id_11D1C = getdvarint( "scr_br_x2_stash_searchCircleSize", 3000 );
    scripts\mp\gametypes\br_quest_util::getquestdata( "x2_stash" ).should_do_vo_call = getdvarint( "scr_br_x2_stash_missionTimeBase", 240 );
    scripts\mp\gametypes\br_quest_util::registerremovequestinstance( "x2_stash", ::_id_130A7 );
    scripts\mp\gametypes\br_quest_util::_id_1194E( "x2_stash", ::_id_130A6 );
    scripts\mp\gametypes\br_quest_util::registerquestthink( "x2_stash", ::_id_130A2, 0.1 );
    scripts\mp\gametypes\br_quest_util::zvelscale( "x2_stash", ::_id_130A3 );
    scripts\mp\gametypes\br_quest_util::_id_11950( "x2_stash", ::_id_130A8 );
    scripts\mp\gametypes\br_quest_util::watch_for_player_going_belowmap_or_oob( "x2_stash", 0 );
    scripts\mp\gametypes\br_quest_util::_id_11951( "x2_stash", ::_id_130A5 );
}
...
_id_130A3( var_0 )
{
    ...
    scripts\mp\gametypes\br_quest_util::overrideviewkickscaledmr( var_0 );
}
...
{
    var_5 = scripts\mp\gametypes\br_gametype_x2::create_vault_assault_loadout_selection( "x2_stash", var_0, var_1, var_4 );
    ...
    var_5._id_11A51 = scripts\mp\gametypes\br_quest_util::is_point_in_cylinder( "x2_stash", var_7 );
    var_5 _id_1230D( var_5._id_11A51.origin, var_5._id_11A51.angles );
    var_5 scripts\mp\gametypes\br_quest_util::force_bleedout_all_downed_players( "ui_mp_br_mapmenu_icon_x2_01_objective", "current", var_5._id_11A51.origin );
    var_5 _id_12B3E();
    scripts\mp\gametypes\br_quest_util::uiobjectiveshowtoteam( "x2_stash", self.team );
    var_5 scripts\mp\gametypes\br_quest_util::watch_for_player_in_gulag( scripts\mp\gametypes\br_quest_util::getquestdata( "x2_stash" ).should_do_vo_call, 4 );
    scripts\mp\gametypes\br_quest_util::addquestinstance( "x2_stash", var_5 );
    scripts\mp\gametypes\br_quest_util::_id_124A9( "x2_stash", self, self.team );
    var_8 = spawnstruct();
    var_8.vehicleoutline = scripts\mp\gametypes\br_quest_util::min_z( "x2_stash", scripts\mp\gametypes\br_quest_util::mine_caves_cell_support_internal( self.team ) );
...
bonus_target_score()
{
    return scripts\mp\gametypes\br_gametype_x2::cp_smuggler_sound_load( "x2_stash", ::monitor_player_near_truck );
}
...
{
    var_0 = ( self.damagedisabledfeedback.origin[0], self.damagedisabledfeedback.origin[1], scripts\mp\gametypes\br_quest_util::getquestdata( "x2_stash" )._id_11D1C );
    var_0 = var_0 + scripts\engine\math::random_vector_2d() * randomfloatrange( 500, 2000 );
    scripts\mp\gametypes\br_quest_util::spawn_elevators( var_0 );
}
...
_id_130A4( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_2 == "x1_stash_closed" && isdefined( var_0.entity ) )
    {
        ...
        var_5 scripts\mp\gametypes\br_quest_util::monitor_player_opens_box_backup( "x2stash", var_3.team, var_0.origin, var_0.angles, var_5._id_11B23 );
...
_id_13096( var_0 )
{
    var_1 = scripts\mp\gametypes\br_gametype_x2::create_ambient_vehicle( "x2_stash", var_0 );
    var_2 = self.angles;

    if ( !isdefined( self.angles ) )
        var_2 = var_1._id_11B1E;

    var_1 scripts\mp\gametypes\br_quest_util::monitor_player_opens_box_backup( "x2stash_end", var_0.team, self.origin, var_2, self._id_11B23 );
    scripts\mp\gametypes\br_quest_util::global_stealth_broken_func( var_0.team, var_0, 8, scripts\mp\gametypes\br_quest_util::getquestindex( "x2_stash" ) );
...
expiredbydeath( var_0 )
{
    ...
    var_4 = scripts\mp\gametypes\br_quest_util::mine_caves_ambush( scripts\mp\gametypes\br_quest_util::mine_cave_turrets( "x2_stash" ) );
    ...
    if ( getdvarint( "scr_br_x2_contractKillcamFix", 1 ) )
    {
        ...
        scripts\mp\gametypes\br_quest_util::global_relic_landlocked_func( var_5, "br_x2_stash_quest_complete", var_1 );
    }
    else
