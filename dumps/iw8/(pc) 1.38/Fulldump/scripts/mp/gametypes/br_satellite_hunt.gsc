...
init()
{
    ...
    level thread scripts\mp\gametypes\br_gametype_truckwar::_id_12956();
...
{
    level thread scripts\mp\gametypes\br_public::cloudanimfx( "harp_friendly_use", var_0.team, 1 );
}

num_of_frame_frozen( var_0 )
{
    level thread scripts\mp\gametypes\br_public::cloudanimfx( level.uavsettings["harp"].votimeout, var_0.team, 1 );
}
...
heavystatehealthadd( var_0, var_1, var_2, var_3 )
{
    ...
    level thread scripts\mp\gametypes\br_public::cloudanimfx( "satellite_located", var_0, 1 );
...
_id_12248( var_0 )
{
    ...
    var_4 = var_2 scripts\mp\gametypes\br_lootcache::selfrevivethink( var_1, 1, undefined );
    _id_127C4( var_4 );
    return 1;
}
...
domflag_onuse( var_0 )
{
    ...
    level thread scripts\mp\gametypes\br_public::cloudanimfx( "uplink_secured", var_1, 1 );
    self.flagmodel playsound( "br_sat_uplink_connect" );
    self.flagmodel setscriptablepartstate( "model", "open" );
    scripts\mp\gameobjects::disableobject();

    foreach ( var_3 in scripts\mp\utility\teams::getfriendlyplayers( var_1 ) )
    {
        if ( !var_3 scripts\mp\gametypes\br_public::isplayeringulag() && var_3 scripts\cp_mp\utility\player_utility::_isalive() )
        {
            var_3 scripts\mp\gametypes\br_plunder::updateprestreamrespawn( 25 );
            var_3 thread scripts\mp\hud_message::showsplash( "br_satlink_satellite_incoming" );
        }
    }
