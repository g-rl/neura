...
init()
{
    ...
    scripts\mp\gametypes\br_quest_util::_id_11957( "assassination_all" );
    scripts\mp\gametypes\br_quest_util::_id_11957( "assassination_all_timed" );
    level.br_leaderbystreak = getdvarint( "scr_br_leader_by_streak", 0 ) != 0;
    scripts\mp\gametypes\br_quest_util::getquestdata( "assassination" ).watch_for_heli_getting_killed_directly = getdvarint( "scr_br_AQ_questTimeBase", 180 );
    scripts\mp\gametypes\br_quest_util::getquestdata( "assassination" ).watch_for_helis_killed = getdvarint( "scr_br_AQ_questTimeBonus", 60 );
    scripts\mp\gametypes\br_quest_util::getquestdata( "assassination" )._id_11A85 = getdvarint( "scr_br_AQ_resetTimerOnKill", 1 );
    scripts\mp\gametypes\br_quest_util::registerquestthink( "assassination", ::aq_questthink_circleposition, 10 );
    ...
    scripts\mp\gametypes\br_quest_util::_id_1194E( "assassination", ::bonuskillstreakcharge );
    ...
    if ( getdvarint( "scr_br_alt_mode_zxp", 0 ) )
        var_1 = scripts\engine\utility::array_add( var_1, scripts\mp\gametypes\br_quest_util::is_cs_scriptable );

    scripts\mp\gametypes\br_quest_util::registerplayerfilter( "assassination", var_1, 0 );
    scripts\mp\gametypes\br_quest_util::watch_for_player_going_belowmap_or_oob( "assassination", 1 );
    scripts\mp\gametypes\br_quest_util::_id_11952( "assassination", ::bonuskillscharge );
    scripts\mp\gametypes\br_quest_util::_id_11951( "assassination", ::bonusdeathplunderot );
...
monitor_special_spawns( var_0 )
{
    ...
    scripts\mp\gametypes\br_quest_util::displayteamsplash( self.targetteam, "br_assassination_quest_start_target_team", var_1 );
    ...
    if ( !scripts\mp\gametypes\br_public::prophasclonesleft() )
        level thread scripts\mp\gametypes\br_public::cloudanimfx( "mission_ass_hunted", self.targetteam, 1 );

    var_1.vehicleoutline = scripts\mp\gametypes\br_quest_util::minarmordropondeath( scripts\mp\gametypes\br_quest_util::mine_caves_cell_support_internal( self.hunterteam ) );
    scripts\mp\gametypes\br_quest_util::displayteamsplash( self.hunterteam, "br_assassination_quest_start_hunter_team", var_1 );

    if ( !scripts\mp\gametypes\br_public::prophasclonesleft() )
        level thread scripts\mp\gametypes\br_public::cloudanimfx( "mission_ass_accept", self.hunterteam, 1 );

    if ( isdefined( var_0 ) )
    {
        scripts\mp\gametypes\br_quest_util::displayplayersplash( var_0, "br_assassination_quest_start_tablet_finder", var_1 );
        scripts\mp\gametypes\br_quest_util::global_stealth_broken_func( self.hunterteam, var_0, 6, scripts\mp\gametypes\br_quest_util::getquestindex( "assassination" ) );
    }
}

monitor_player_near_truck( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = scripts\mp\gametypes\br_quest_util::createquestinstance( "assassination", var_0, var_2, var_5, var_3.squadindex );
    var_7.modifier = var_4;

    if ( !isdefined( var_7.modifier ) )
        var_7.modifier = "";

    var_7 scripts\mp\gametypes\br_quest_util::registerteamonquest( var_0, var_3 );
    ...
    if ( isdefined( var_1 ) )
        var_7._id_1266D = var_7 scripts\mp\gametypes\br_quest_util::getvalidplayersinteam( var_1 ).size;
    ...
    if ( var_7.modifier != "_all" )
        var_7 scripts\mp\gametypes\br_quest_util::watch_for_player_in_gulag( scripts\mp\gametypes\br_quest_util::getquestdata( "assassination" ).watch_for_heli_getting_killed_directly, 4 );

    var_7 scripts\mp\gametypes\br_quest_util::force_ai_to_drop_thermites( 4, 3 );
    ...
    scripts\mp\gametypes\br_quest_util::addquestinstance( "assassination", var_7 );
    scripts\mp\gametypes\br_quest_util::_id_124A9( "assassination", var_3, var_0 );
    return var_7;
}
...
defenderflag_starts( var_0 )
{
    if ( isdefined( var_0.mapcircle ) )
        var_0 scripts\mp\gametypes\br_quest_util::getclosestplayerforreward();
...
determinetargetteam( var_0 )
{
    ...
    var_5 = scripts\mp\gametypes\br_public::minshotstostage3acc( var_1, self.squadindex );
    ...
    while ( !isdefined( var_2 ) )
    {
        ...
        foreach ( var_14 in var_11 )
            var_12[var_14.team] = scripts\mp\gametypes\br_quest_util::getvalidplayersinteam( var_14.team, var_8 ).size;
        ...
        foreach ( var_25, var_19 in var_12 )
        {
            ...
            {
                var_20 = scripts\mp\gametypes\br_gametype_dmz::mlghitlocrequiresclamp( var_2 );
                var_21 = scripts\mp\gametypes\br_gametype_dmz::mlghitlocrequiresclamp( var_25 );
    ...
    if ( isdefined( var_2 ) )
        scripts\mp\gametypes\br_quest_util::getquestdata( "assassination" ).alltrackedplayers = scripts\engine\utility::array_combine( scripts\mp\gametypes\br_quest_util::getquestdata( "assassination" ).alltrackedplayers, scripts\mp\gametypes\br_public::minshotstostage3acc( var_2, self.squadindex ) );
...
determinetargetplayer( var_0, var_1 )
{
    ...
    foreach ( var_7 in scripts\mp\gametypes\br_public::minshotstostage3acc( var_0, self.squadindex ) )
    {
        if ( !scripts\mp\gametypes\br_quest_util::isplayervalid( var_7, make_usb_model_usable( self.modifier ) ) )
            continue;
...
determinetrackingcircleposition( var_0 )
{
    ...
    scripts\mp\gametypes\br_quest_util::spawn_elevators( var_1 );
}
...
getnearestbombsiteteam()
{
    if ( scripts\mp\gametypes\br_public::prophasclonesleft() )
    {
        scripts\mp\gametypes\br_quest_util::_id_11EBE( level.select_players_not_in_killzone_only );
        self._id_126F5 = 2;
    }
    else
    {
        if ( getdvarint( "scr_br_alt_mode_zxp", 0 ) )
            var_0 = scripts\mp\gametypes\br_quest_util::getvalidplayersinteam( self.hunterteam, level.questinfo.defaultfilter );
        else
            var_0 = scripts\mp\gametypes\br_quest_util::getvalidplayersinteam( self.hunterteam );

        if ( var_0.size == 0 )
        {
            scripts\mp\gametypes\br_quest_util::_id_11EBE( 3500 );
            self._id_126F5 = 0;
        }
        else
        {
            ...
            if ( var_1 > 2500 )
            {
                scripts\mp\gametypes\br_quest_util::_id_11EBE( 2000 );
                self._id_126F5 = 1;
                return;
            }

            scripts\mp\gametypes\br_quest_util::_id_11EBE( 1500 );
            self._id_126F5 = 2;
        }
    }
}
...
determineobjectivevisibility()
{
    foreach ( var_1 in scripts\mp\gametypes\br_public::minshotstostage3acc( self.hunterteam, self.squadindex ) )
    {
    ...
    foreach ( var_1 in scripts\mp\gametypes\br_public::minshotstostage3acc( self.targetteam, var_5 ) )
    {
        var_2 = var_1 scripts\mp\gametypes\br_public::isplayeringulag();
...
bonuskillscharge()
{
    foreach ( var_1 in scripts\mp\gametypes\br_public::minshotstostage3acc( self.targetteam, self.squadindex ) )
...
bonusdeathplunderot()
{
    ...
    else
    {
        ...
        var_0 = scripts\mp\gametypes\br_quest_util::mine_caves_cell_support_internal( self.targetteam );
        var_1 = scripts\mp\gametypes\br_quest_util::min_z( "assassination", var_0 );
        self._id_11B20 = "_averted";
        var_2 = spawnstruct();
        var_3 = scripts\mp\gametypes\br_quest_util::getquestindex( "assassination" );
        var_4 = scripts\mp\gametypes\br_quest_util::mine_caves_ambush( scripts\mp\gametypes\br_quest_util::mine_cave_turrets( "assassination", self._id_11B20, self.modifier ) );
        var_2.target_show_damage_damage_watch = scripts\mp\gametypes\br_quest_util::target_wavespawning_to_jammer5( var_3, var_0, var_4 );
        scripts\mp\gametypes\br_quest_util::displayteamsplash( self.targetteam, "br_assassination_timer_expire_targets_win", var_2 );
        level thread scripts\mp\gametypes\br_public::cloudanimfx( "mission_ass_fail", self.hunterteam, 1 );
        level thread scripts\mp\gametypes\br_public::cloudanimfx( "mission_ass_hunted_timed_out", self.targetteam, 1 );

        if ( getdvar( "scr_br_gametype", "" ) != "dmz" && getdvar( "scr_br_gametype", "" ) != "risk" )
            scripts\mp\gametypes\br_quest_util::monitor_player_plundercount( self.targetteam, self.targetplayer.origin, self.targetplayer.angles, self._id_11B23 );
    }
}
...
bonusobjectivescorecharge( var_0, var_1 )
{
    ...
    if ( var_0.team == self.targetteam )
    {
        if ( var_0 == self.targetplayer )
        {
            ...
            wait 0.75;
            var_3 = spawnstruct();
            var_4 = scripts\mp\gametypes\br_quest_util::mine_caves_cell_support_internal( self.hunterteam );
            ...
            if ( isdefined( var_1 ) && isdefined( var_1.team ) && var_1.team == self.hunterteam )
            {
                ...
                scripts\mp\gametypes\br_quest_util::global_stealth_broken_func( self.hunterteam, var_1, 8, scripts\mp\gametypes\br_quest_util::getquestindex( "assassination" ) );

                foreach ( var_8 in scripts\mp\gametypes\br_public::minshotstostage3acc( self.hunterteam, self.squadindex ) )
            ...
            var_10 = scripts\mp\gametypes\br_quest_util::mine_caves_ambush( scripts\mp\gametypes\br_quest_util::mine_cave_turrets( "assassination", self._id_11B20, self.modifier ) );
            var_3.target_show_damage_damage_watch = scripts\mp\gametypes\br_quest_util::target_wavespawning_to_jammer5( var_5, var_4, var_10 );
            scripts\mp\gametypes\br_quest_util::displayteamsplash( self.hunterteam, var_6, var_3 );

            if ( !scripts\mp\gametypes\br_public::prophasclonesleft() )
                level thread scripts\mp\gametypes\br_public::cloudanimfx( "mission_ass_success", self.hunterteam, 1 );
            ...
            if ( isdefined( var_2 ) )
            {
                foreach ( var_12 in var_2 )
                {
                    if ( isdefined( var_12.team ) && var_12.team == self.hunterteam )
                        scripts\mp\gametypes\br_quest_util::zombiepingtime( var_12 );
                }
            }
            ...
            if ( !isdefined( level.gulag ) || isdefined( level.gulag ) && !istrue( level.gulag.shutdown ) )
            {
                foreach ( var_8 in scripts\mp\gametypes\br_public::minshotstostage3acc( self.hunterteam, self.squadindex ) )
                {
                    ...
                    if ( !isalive( var_8 ) )
                    {
                        ...
                        var_8 thread scripts\mp\gametypes\br_gulag::playergulagautowin();
                    }
                }
            }
        }
    ...
    {
        if ( !scripts\mp\gametypes\br_quest_util::isteamvalid( self.hunterteam, make_usb_model_usable( self.modifier ) ) )
        {
            if ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "risk" )
            {
                self.result = "fail";
            ...
            {
                self._id_11B20 = "_averted";
                var_16 = scripts\mp\gametypes\br_quest_util::monitor_player_plundercount( self.targetteam, var_0.origin, var_0.angles, self._id_11B23 );
                var_3 = spawnstruct();
                var_3.vehicleoutline = scripts\mp\gametypes\br::get_int_or_0( var_16["plunder"] );
                scripts\mp\gametypes\br_quest_util::displayteamsplash( self.targetteam, "br_assassination_complete_targets_win", var_3 );
                self.result = "fail";
                scripts\mp\gametypes\br_quest_util::removequestinstance();
            }
        }
...
showassassinationhud( var_0 )
{
    ...
    var_0 scripts\mp\gametypes\br_quest_util::_id_12056( self );
}
...
hideassassinationhud( var_0 )
{
    ...
    var_0 scripts\mp\gametypes\br_quest_util::overrideviewkickscaledmr( self );
}
...
_id_12AE4( var_0 )
{
    foreach ( var_2 in scripts\mp\gametypes\br_public::minshotstostage3acc( self.targetteam, self.squadindex ) )
...
bot_shotguns()
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        wait( var_4 );
        var_5 = int( var_2 / 60 );
        var_6 = scripts\mp\gametypes\br_quest_util::getvalidplayersinarray( scripts\mp\gametypes\br_public::minshotstostage3acc( self.hunterteam, self.squadindex ), make_usb_model_usable( self.modifier ) );
...
bbeingelectrocuted()
{
    ...
    foreach ( var_4 in var_1 )
    {
        ...
        foreach ( var_8 in var_6 )
        {
            ...
            if ( var_8 scripts\mp\gametypes\br_public::questrewarduav() )
            {
                var_5 = var_8;
                break;
            }
...
bearsred()
{
    ...
    foreach ( var_5, var_3 in level.teamdata )
    {
        ...
        if ( !scripts\mp\gametypes\br_quest_util::isteamvalid( var_5, make_usb_model_usable( self.modifier ) ) )
            continue;
...
begin_spectate()
{
    ...
    foreach ( var_3, var_2 in self._id_12686 )
    {
        if ( !scripts\mp\gametypes\br_quest_util::isteamvalid( var_3, make_usb_model_usable( self.modifier ) ) )
        {
            if ( var_7 > 0 )
            {
                var_7--;
...
bearwatch( var_0 )
{
    ...
    level thread scripts\mp\gametypes\br_public::cloudanimfx( "mission_ass_fail", var_0, 1 );
}
...
give_respawn_flare()
{
    scripts\mp\gametypes\br_quest_util::getquestdata( "assassination" ).give_reward_based_on_task = 1;
}

give_operator_based_on_task()
{
    scripts\mp\gametypes\br_quest_util::getquestdata( "assassination" ).give_periodic_jugg_pulses = 1;
}

display_fx_names_after_plane_spawns()
{
    return isdefined( scripts\mp\gametypes\br_quest_util::getquestdata( "assassination" ).give_reward_based_on_task ) && scripts\mp\gametypes\br_quest_util::getquestdata( "assassination" ).give_reward_based_on_task;
}

display_dont_have_weapon_message()
{
    return isdefined( scripts\mp\gametypes\br_quest_util::getquestdata( "assassination" ).give_periodic_jugg_pulses ) && scripts\mp\gametypes\br_quest_util::getquestdata( "assassination" ).give_periodic_jugg_pulses;
}

mine_caves_retreat()
{
    var_0 = scripts\mp\gametypes\br_quest_util::getquestdata( "assassination" ).watch_for_heli_getting_killed_directly;
...
{
    var_0 = 0;
    var_1 = scripts\mp\gametypes\br_gametypes::_id_11BE4( "overrideQuestSearchParams", "assassination" );
