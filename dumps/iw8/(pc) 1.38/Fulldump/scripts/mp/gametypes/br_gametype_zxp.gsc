...
init()
{
    ...
    if ( getdvarint( "scr_br_zxp_disableHeli", 1 ) != 0 )
        scripts\mp\gametypes\br_gametypes::give_fists( "littleBirdSpawns" );
    ...
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "circleTimerNext", ::droppoint );
    ...
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "onInfilSequenceEnd", ::_id_130C7 );
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "onLeaveAC130", ::streamtimeout );
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "onJuggCrateUse", ::_id_1315F );
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "gulagWinnerRespawn", ::gulagwinnerrespawn );
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "remainingPlayersAliveOnTeam", scripts\mp\gametypes\br_alt_mode_zxp::_id_119D9 );
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "spawnHandled", scripts\mp\gametypes\br_alt_mode_zxp::_id_122C5 );
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "mayConsiderPlayerDead", scripts\mp\gametypes\br_alt_mode_zxp::setincomingcallback );
...
vehicle_compass_mp_init( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_public::update_timer_for_bomb_vest_detonator_holder() || istrue( self._id_12ECE );
    ...
    if ( level.cleanupswaploadoutflags.pickclassbr )
    {
        ...
        scripts\mp\gametypes\br_alt_mode_zxp::vandalize_spotlight_speed( var_3, var_4, var_2 );
    }
    else
    {
        if ( !var_5 )
    ...
    {
        var_8 = scripts\mp\gametypes\br::clear_and_give_killstreak_loadout_recon();
        scripts\mp\gametypes\br::monitor_traversal_watcher( var_8, 0 );
    }
    ...
    if ( var_1 )
    {
        ...
        {
            if ( self != var_10 )
                scripts\mp\gametypes\br_public::cloud_cover( "zmb_teammate_back_human", var_10 );
        }
    }
}
