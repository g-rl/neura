...
create_juggernaut_spawner()
{
    ...
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "onInfilSequenceEnd", ::create_debug_model_for_spawnpoint );
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "playerNakedDropLoadout", ::create_silencer_pick_up );
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "getDefaultLoadout", ::cratephysicson );
    ...
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "modifyPlayerDamage", ::create_name_fx );
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "getFinalCircleCenter", ::crateusefunc );
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "mapCenterFinalCircle", ::crateusefunc );
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "startUICloseTimer", ::createprematchloadout );
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "playerWelcomeSplashes", ::create_seatids_override );
    waittillframeend;
...
validatefunc( var_0 )
{
    ...
    if ( var_0 )
    {
        ...
        if ( isdefined( var_6 ) )
        {
            ...
            var_8 = scripts\mp\gametypes\br_gulag::unset_relic_headbullets( 0, undefined );
            var_9 = [];
        ...
        if ( isdefined( var_4 ) )
        {
            var_15 = scripts\mp\gametypes\br_gulag::minigameinfo( var_4 + var_3, var_2, undefined );

            if ( isdefined( var_15 ) )
            {
                var_16 = spawn( "script_model", var_15 );
                var_16.playerspawnpos = var_15;
                var_16.playerspawnangles = scripts\mp\gametypes\br_gulag::loot_getitemcountlefthand( var_15, var_6 );
                var_16.notti = 1;
                self.setspawnpoint = var_16;
            }
        }
        else
            var_17 = scripts\mp\gametypes\br_gulag::unset_relic_headbullets( 0, undefined );

        self.wait_display_pavelow_boss_health_bar = scripts\mp\gametypes\br_gulag::unsetreduceregendelayonkills( 0, undefined, var_1 );
    ...
    else
    {
        ...
        var_3 = ( 0, 0, var_1 );
        self.wait_display_pavelow_boss_health_bar.origin = scripts\mp\gametypes\br::getoffsetspawnorigin( var_18, var_3 );
    }
...
create_vault_assault_loadout_selection( var_0, var_1, var_2, var_3 )
{
    ...
    var_4 scripts\mp\gametypes\br_quest_util::zombiepingtime( self );
...
create_name_fx_base()
{
    ...
    var_0 scripts\mp\gametypes\br_movingtrain::_id_1280E( 2, 2 );
...
cp_landlord_sound_load( var_0 )
{
    ...
    if ( var_0._id_12038 )
    {
        if ( var_0.obj_a_post_behavior )
        {
            ...
            scripts\mp\gametypes\br_x2_bomb_quest::_id_1229E( var_0.position );
        }
        else
    ...
    if ( var_0.pristinestatehealthadd )
        var_1 scripts\mp\gametypes\br_movingtrain::_id_1280E( 2, 2 );
    ...
    if ( var_0.pristinestatehealthadd )
    {
        ...
        var_1 scripts\mp\gametypes\br_movingtrain_armored::cp_raid_complex_behavior();
        scripts\mp\gametypes\br_x2_bomb_quest::enable_super_when_leaving_turret();
    ...
    else
    {
        ...
        wait 2;
        scripts\mp\gametypes\br_movingtrain_armored::cruise_predator_direction_override();
        scripts\mp\gametypes\br_movingtrain_armored::cruisepredator_watchgameend();
        var_1 scripts\mp\gametypes\br_movingtrain_armored::_id_129B6();
        scripts\mp\flags::gameflagset( "x2_ambush" + var_0.binoculars_updatetargetmarker + "_completed" );
        wait 6;
    }
...
createstreakinfo_ai_turret( var_0 )
{
    ...
    foreach ( var_2 in level.players )
    {
        ...
        scripts\mp\gametypes\br_killstreaks::get_actual_grenade_name( var_2, "x2_train_attack", undefined, 2 );
    }

    wait 3.5;
    thread createscreeneffectext();
    wait 3;
    thread scripts\mp\gametypes\br_movingtrain_armored::br_pelletmaxdamage();
}
...
createteamdefenderflag( var_0 )
{
    ...
    if ( var_0 )
    {
        ...
        {
            var_1 scripts\mp\gametypes\br_movingtrain::_id_1280E( 0.95, 0.05 );
            thread createrectangularzonebasedonent( "accelFromIdle" );
        }

        scripts\mp\gametypes\br_movingtrain_armored::_id_11F07();
    }
    else if ( !level._id_1303C.raise_airlock )
        level thread scripts\mp\gametypes\br_movingtrain_armored::_id_1284C();
}
...
createpropspecatehud( var_0, var_1 )
{
    ...
    var_2 scripts\mp\gametypes\br_movingtrain::_id_12817( var_0 );
...
create_vehicle_interact()
{
    ...
    for ( var_0 = 0; var_0 < level.binoculars_updateheadiconvisibilityforplayer.size; var_0++ )
    {
        if ( var_0 != 0 )
        {
            ...
            create_weapon_pick_up( scripts\mp\gametypes\br_x2_map_quest::bonus_target_score );
            wait 2;
        ...
        create_weapon_pick_up( scripts\mp\gametypes\br_x2_bomb_quest::bonus_target_score );
        wait 2;

        if ( !scripts\mp\flags::gameflag( "x2_ambush" + ( var_0 + 1 ) + "_starting" ) && !scripts\mp\flags::gameflag( "x2_train_one_cart_left" ) )
        {
            create_weapon_pick_up( scripts\mp\gametypes\br_x2_amb1_quest::bonus_target_score );
            wait 2;
        }
    }
...
_id_12E1C()
{
    while ( self.players.size != 0 )
    {
        ...
        {
            if ( isalive( var_1 ) && !istrue( var_1.inlaststand ) && !var_1 scripts\mp\gametypes\br_public::questtypes() )
                return var_1;
        }
...
_id_12B5F( var_0 )
{
    ...
    for (;;)
    {
        ...
        level thread scripts\mp\gametypes\br_quest_util::_id_12BAA( self.origin, "exfil", 30 );
...
fly_to_node( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_16 = scripts\mp\gametypes\obj_dom::setupobjective( var_15, undefined, undefined, 1, 0 );
    ...
    var_16.onenduse = scripts\mp\gametypes\obj_dom::dompoint_onuseend;
    var_16.oncontested = scripts\mp\gametypes\obj_dom::dompoint_oncontested;
    var_16.onuncontested = scripts\mp\gametypes\obj_dom::dompoint_onuncontested;
    var_16.onunoccupied = scripts\mp\gametypes\obj_dom::dompoint_onunoccupied;
    var_16.onpinnedstate = scripts\mp\gametypes\obj_dom::dompoint_onpinnedstate;
    var_16.onunpinnedstate = scripts\mp\gametypes\obj_dom::dompoint_onunpinnedstate;
}
...
create_ammo_crate_objectives( var_0, var_1 )
{
    ...
    if ( var_0.size > 0 )
        var_3 = scripts\mp\gametypes\br_ending::get_center_of_array( var_0 );
    else
        var_3 = var_2;

    var_4 = scripts\mp\gametypes\br_ending::lb_impulse_dmg_factor_mid_low( var_0, var_2 );
    var_5 = 100000;
    var_6 = var_4[0];
...
create_model_at( var_0, var_1 )
{
    ...
    if ( var_1 >= 3 )
    {
        scripts\mp\gametypes\br::monitor_game_end_on_front_truck_death( var_0 );
        var_0._id_13082 = 0;
        var_4 = 9999;
    }
...
creategulagloadoutarry()
{
    ...
    var_1 = scripts\mp\gametypes\br_lootcache::selfrevivethink( var_0, 0 );
}
...
create_rocket_death_fx( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) && var_2 == 1 )
        scripts\mp\gametypes\br_public::cloud_cover( var_0, self, 0 );
    else
    {
...
createapcturret()
{
    if ( isdefined( level._id_1303C ) && isdefined( level._id_1303C._id_12810 ) )
    {
        ...
        level thread scripts\mp\gametypes\br_quest_util::_id_12BAA( var_2, "attack", 20 );
    }
}
