...
playerpowerscleanupkeybindings()
{
    ...
    if ( isplayer( self ) )
    {
        ...
        scripts\mp\equipment\armor_plate::checkifteamrewardsareenabled( 0 );
    }
}
...
getoldarmorent( var_0 )
{
    ...
    if ( scripts\mp\gametypes\br_public::ishelmet( var_0.scriptablename ) )
    {

    }
    else if ( scripts\mp\gametypes\br_pickups::isgasmask( var_0.scriptablename ) )
...
monitor_truck( var_0 )
{
    ...
    var_2 = getdvarint( "scr_br_armor_overrideStartingValue", -1 );

    if ( var_2 >= 0 )
        var_1 = var_2;

    monitor_bush_trig( var_1 );
}

monitor_bush_trig( var_0 )
{
...
popoffhelmet( var_0, var_1, var_2 )
{
    ...
    for ( var_12 = 0; var_12 < var_9; var_12++ )
    {
        ...
        {
            var_14 = scripts\mp\gametypes\br_pickups::maphint_computerscriptableused( var_4.origin, var_4.angles );
            var_4 delete();
