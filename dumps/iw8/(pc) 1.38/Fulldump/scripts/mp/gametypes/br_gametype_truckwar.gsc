...
countdowntimer()
{
    ...
    scripts\mp\gametypes\br_gametypes::give_fists( "c130PlaneLine" );
    scripts\mp\gametypes\br_gametypes::hostdamagepercentmedium( "tabletReplace" );
}

countlefthand()
{
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "playerWelcomeSplashes", ::covertransitionrate );
    ...
    scripts\mp\gametypes\br_gametypes::zombienumhitshuman( "isTeamEliminated", ::readytoleave );
...
onstartgametype()
{
    ...
    level.checklinktotrain[level.checklinktotrain.size] = scripts\mp\gametypes\br_circle::fntrapdeactivation( ( -32000, 53750, 2266 ), 16000 );
    initspawns();
...
covertransitionrate( var_0 )
{
    ...
    scripts\mp\gametypes\br_public::cloud_cover( "mode_intro", self, 0 );
...
br_armor_plate_broken_remove()
{
    ...
    scripts\mp\gametypes\br_vehicles::_id_12967( level.vehiclespawnlocs );
...
playerrespawn( var_0, var_1, var_2 )
{
    ...
    {
        thread scripts\mp\gametypes\br_spectate::_id_12926();
        return;
    }
    ...
    if ( scripts\engine\utility::ent_flag_exist( "respawn_vehicle_death" ) && scripts\engine\utility::ent_flag( "respawn_vehicle_death" ) )
        thread scripts\mp\gametypes\br_spectate::_id_11E8C();
    ...
    var_9 = getspawnpoint();
    var_10 = scripts\mp\gametypes\br_gulag::updatex1stashhud( var_9 );
    ...
    level thread scripts\mp\gametypes\br_quest_util::_id_12BAA( var_11, "revive" );
    scripts\mp\trials\trial_target_utility::_id_11E8D( "ui_br_transition_type", 0 );
    _id_12B39( self.team );
}
...
half_size( var_0 )
{
    ...
    foreach ( var_2 in level.players )
    {
        ...
        if ( istrue( var_2.checkpointstruct ) )
            scripts\mp\gametypes\br::_id_12A58( var_2 );
...
binoculars_processtargetlos()
{
    ...
    scripts\mp\gametypes\br_circle::init_unlock_silo( var_3, var_4, var_5, var_6 );
}
...
cover_guys_debug( var_0 )
{
    ...
    var_3 = scripts\mp\gametypes\br_circle::mine_caves_vo( var_1, var_2, 0.8, 1.0, 1, 0, 1 );
    var_4 = vectornormalize( var_3 - var_1 ) * var_2;
    var_5 = var_1 + var_4;
    var_6 = getdvarint( "scr_truckwar_circle_padding", 10000 );

    for ( var_7 = vectornormalize( level.br_level.br_mapcenter - var_5 ); !scripts\mp\gametypes\br_circle::rear_spotlight_model( var_5, 1 ); var_5 = var_5 + var_7 * var_6 )
    {
