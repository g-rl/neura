...
initspawns()
{
    ...
    var_0.to_sam_spawns = [];
    var_0.to_sam_spawns["allies"] = scripts\mp\spawnlogic::getspawnpointarray( "mp_tosam_spawn_allies" );
    var_0.to_sam_spawns["axis"] = scripts\mp\spawnlogic::getspawnpointarray( "mp_tosam_spawn_axis" );

    if ( var_0.to_sam_spawns["allies"].size <= 0 )
    {
        scripts\mp\spawnlogic::addspawnpoints( "allies", "mp_front_spawn_allies" );
        var_0.to_sam_spawns["allies"] = scripts\mp\spawnlogic::getspawnpointarray( "mp_front_spawn_allies" );
    }

    if ( var_0.to_sam_spawns["axis"].size <= 0 )
    {
        scripts\mp\spawnlogic::addspawnpoints( "axis", "mp_front_spawn_axis" );
        var_0.to_sam_spawns["axis"] = scripts\mp\spawnlogic::getspawnpointarray( "mp_front_spawn_axis" );
    }
}
