...
get_actual_grenade_name( var_0, var_1, var_2, var_3 )
{
    ...
    {
        var_4 = scripts\mp\gametypes\br_public::clear_and_give_killstreak_loadout_support( self );
    ...
    var_0 scripts\mp\gametypes\br_gametypes::_id_11BE4( "onKillstreakDanger", var_6 );
}
