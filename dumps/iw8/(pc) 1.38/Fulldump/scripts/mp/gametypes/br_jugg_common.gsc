...
{
    var_0 = scripts\mp\gametypes\br_pickups::playersetattractiontime();
    scripts\mp\gametypes\br_pickups::heli_check_player_below_starts( var_0 );
    scripts\mp\gametypes\br_pickups::heli_gunner_logic( var_0 );
    scripts\mp\gametypes\br_pickups::heli_delayedpadstateupdate( var_0 );
    scripts\mp\gametypes\br_pickups::heli_extraction( var_0 );
    scripts\mp\gametypes\br_pickups::heli_fire_at_players( var_0 );
    scripts\mp\gametypes\br_pickups::heli_intro( var_0 );
    scripts\mp\gametypes\br_pickups::heli_group_nextspawntime( var_0 );
    scripts\mp\gametypes\br_pickups::heli_deposit_instruct( var_0 );
    scripts\mp\gametypes\br_pickups::heli_hover_between_points( var_0 );
    scripts\mp\gametypes\br_pickups::heliextractwait( var_0 );
}
...
fob( var_0 )
{
    ...
    else
    {
        ...
        {
            var_3 = scripts\mp\gametypes\br_circle::mine_caves_waittill_entered();
...
_id_1203F( var_0, var_1 )
{
    ...
    for ( var_4 = 0; var_4 < var_0; var_4++ )
    {
        ...
        var_5 scripts\mp\gametypes\br_quest_util::force_ai_to_drop_thermites( 11, 6, 2, var_5.origin );
        var_5 scripts\mp\gametypes\br_quest_util::_id_11EBE( 5000 );
        var_5 scripts\mp\gametypes\br_quest_util::_id_12055();
...
{
    level endon( "game_ended" );
    scripts\mp\gametypes\br_gametype_dmz::_id_1205D( "br_juggdrop_incoming" );
...
heli_rpg_enemy_run_away( var_0, var_1 )
{
    ...
    var_7 scripts\mp\gametypes\br_c130airdrop::cypher_id_pool( 1, "battle_royale_juggernaut", "jugg_world", var_0 );
}
...
{
    scripts\mp\gametypes\br_gametypes::_id_11BE4( "onJuggDropOnDeath", var_0 );
    level.start_area_fx--;
}
...
{
    scripts\mp\gametypes\br_gametypes::_id_11BE4( "onJuggCrateActivate", var_0 );
...
stop_turbulence_just_before_the_end( var_0 )
{
    ...
    scripts\mp\gametypes\br_gametypes::_id_11BE4( "onJuggCrateUse", var_0 );
    spectatekey( var_0 );
...
{
    scripts\mp\gametypes\br_gametypes::_id_11BE4( "onJuggCrateDestroy", var_0 );
    level.start_area_fx--;
    filtervehiclespawnstructsfunc();
}
...
filtervehiclespawnstructsfunc()
{
    if ( isdefined( self.heli_landing_volumes ) )
    {
        ...
        if ( isdefined( self.heli_landing_volumes.mapcircle ) )
            self.heli_landing_volumes scripts\mp\gametypes\br_quest_util::getclosestplayerforreward();
