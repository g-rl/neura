...
bombzone_onbombplanted( var_0, var_1 )
{
    ...
    if ( !level.multibomb )
    {
        ...
        var_3 = matchdata_buildweaponrootlist();
    ...
    if ( scripts\mp\utility\game::getgametype() != "cmd" )
        var_8 thread canstartusingbomb( var_2, "waypoint_bomb_defend", "waypoint_defuse" );
    ...
    if ( scripts\mp\utility\game::getgametype() == "dd" || scripts\mp\utility\game::getgametype() == "to_dd" || scripts\mp\utility\game::getgametype() == "cmd" || scripts\mp\utility\game::getgametype() == "btm" )
    {
        ...
        var_11 = scripts\mp\gametypes\dd::bombhandler;
...
canstartusingbomb( var_0, var_1, var_2 )
{
...
getbombmodel( var_0 )
{
    if ( istrue( level.ninetypercent_music ) && istrue( var_0 ) )
...
onpickup( var_0, var_1, var_2 )
{
    ...
    if ( !level.bombdefused )
    {
        ...
        if ( istrue( self.firstpickup ) )
        {
            ...
            if ( istrue( level.ninetypercent_music ) )
            {
                ...
                playfx( level.pindia_headlights["vanish_hw_fr"], self.trigger.origin + ( 0, 0, -9970 ) );
            }
        }
        else
            var_3 = "bomb_pickup";
    ...
    scripts\mp\utility\game::scriptable_token_scriptable_touched_callback( var_0, undefined, "Bomb Picked Up", var_0.origin );
