...
spawnc130pathstructnew( var_0, var_1 )
{
    ...
    if ( !scripts\mp\gametypes\br_gametypes::propsetclonesleft( "randomizeCircleCenter" ) )
        var_2 = var_2 + var_5;
    ...
    if ( scripts\mp\gametypes\br_gametypes::propsetflashesleft( "planeConstrainedFromMapCenter" ) )
    ...
    if ( scripts\mp\gametypes\br_gametypes::propsetflashesleft( "planeUseCircleRadius" ) )
        var_12 = var_11;
...
_id_12290( var_0, var_1, var_2 )
{
    ...
    if ( !scripts\mp\gametypes\br_gametypes::propsetclonesleft( "planeSnapToOOB" ) )
    {
...
updatec130pathomnvars( var_0 )
{
    ...
    if ( scripts\mp\gametypes\br_gametypes::propsetclonesleft( "c130PlaneLine" ) )
        return;
...
createtestc130path( var_0, var_1 )
{
    ...
    if ( isdefined( level.br_level.br_mapcenter ) && isdefined( level.br_level.br_mapsize ) )
    {
        ...
        level thread scripts\mp\gametypes\br_analytics::chosen_airlock_door( var_2.centerpt, var_2.angle[1], var_2._id_124A1, var_2.hvt_delayed_cig );
    }
    else
...
spawnplayertoc130()
{
    ...
    scripts\mp\gametypes\br_infils::hvt_death_player_vo();
    ...
    if ( istrue( self.progression_main ) && getdvar( "scr_br_gametype", "" ) != "dmz" && getdvar( "scr_br_gametype", "" ) != "risk" && getdvar( "scr_br_gametype", "" ) != "bodycount" )
        level scripts\mp\gametypes\br_public::cloud_cover( "deploy_squad_leader", self, 1, 0 );
}
...
orbitcam( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_infils::manualturret_toggleallowplacementactions( self );
...
ispointinbounds( var_0, var_1, var_2 )
{
    ...
    var_4 = scripts\mp\gametypes\br_public::prophaschangesleft() || scripts\mp\gametypes\br_public::processvoqueue();
...
killaftertime( var_0, var_1 )
{
    ...
    self stoploopsound();
    scripts\mp\gametypes\br_infils::play_usb_anims_single( self );
    wait 0.1;
    ...
    if ( isdefined( self.animstruct ) )
    {
        ...
        scripts\mp\gametypes\br_infils::eliminate_drone_minigun_speed( self.animstruct );
    }
    else
    {
        if ( isdefined( self.innards ) )
...
listenjump( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        var_5 = scripts\mp\gametypes\br_public::minshotstostage3acc( self.team, self.squadindex );
        ...
        var_6 = scripts\mp\gametypes\br_public::questrewarduav() || isdefined( self.pers["squadMemberIndex"] ) && self.pers["squadMemberIndex"] == 0;
...
leaveplane( var_0, var_1, var_2, var_3 )
{
    ...
    thread scripts\mp\gametypes\br_gametypes::_id_11BE4( "onLeaveAC130" );
...
{
    var_3 = scripts\engine\utility::ter_op( var_0 scripts\mp\gametypes\br_public::questrewarduav(), 2, var_2 );
