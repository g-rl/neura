...
onstartgametype()
{
    ...
    if ( isdefined( level.playerzombiemonitorinput ) )
        [[ level.playerzombiemonitorinput ]]();
    else
        initspawns();
...
skipsplash()
{
    ...
    level.pavelow_boss_hit_by_emp = 0;
    var_0 = 0;
    ...
    for (;;)
    {
        ...
        {
            if ( !isdefined( var_2.pbexploitstarttime ) )
            {
                var_2.payload = 0;
                var_2.pbexploitstarttime = var_2.origin;
                var_2.ai_hold_debug = var_2.origin;
            }

            var_2.payload = var_2.payload + distancesquared( var_2.pbexploitstarttime, var_2.origin );
            var_2.pbexploitstarttime = var_2.origin;
        }
        ...
        if ( var_0 > 3.0 )
        {
            if ( level.pavelow_boss_hit_by_emp >= 2 )
            {
                level.pavelow_boss_hit_by_emp = 0;

                foreach ( var_2 in level.players )
                {
                    if ( !isdefined( var_2.ai_hold_debug ) )
                        var_2.ai_hold_debug = var_2.origin;

                    var_2.isrevivepickup = distancesquared( var_2.ai_hold_debug, var_2.origin ) < 4225;
                    var_2.ai_hold_debug = var_2.origin;
                }
            }
            ...
            foreach ( var_2 in level.players )
            {
                ...
                if ( isalive( var_2 ) && ( istrue( var_2.isrevivepickup ) || var_2.payload < 4225 && !istrue( var_2.pe_chopper_zones ) ) )
                {
                    var_2.isrevivepickup = 0;
        ...
        level.pavelow_boss_hit_by_emp++;
        waitframe();
    }
}

strafe( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
