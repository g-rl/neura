...
init()
{
    ...
    scripts\mp\gametypes\br_publicevents::_id_11955( 3, ::_id_12BBF, var_0, ::_id_12E1D, ::all_gas_trap_structs );
...
_id_12BBF()
{
    var_0 = !scripts\mp\gametypes\br_gametypes::propsetclonesleft( "oneLife" );
...
all_gas_trap_structs()
{
    ...
    test_bag_pickup( 1 );
    _id_12E0D();
    scripts\mp\gametypes\br_publicevents::_id_1205D( "br_pe_jailbreak_incoming" );
    ...
    scripts\mp\gametypes\br_publicevents::_id_1205D( "br_pe_jailbreak_active" );
...
{
    scripts\mp\gametypes\br_gulag::test_br_ending( var_0 );
}
...
_id_12E0D()
{
    ...
    for (;;)
    {
        if ( !scripts\mp\gametypes\br_gulag::bot_allowed_to_try_last_loadout() )
            break;
...
cur_vision( var_0 )
{
    ...
    foreach ( var_4 in level.teamnamelist )
    {
        ...
        if ( var_5 )
        {
            ...
            {
                var_8 = var_2 && var_7 scripts\mp\gametypes\br_public::questtypes();
...
_id_11AAA()
{
    var_0 = isalive( self ) && isdefined( level.gulag ) && !istrue( level.gulag.shutdown ) && scripts\mp\gametypes\br_public::questtypes();

    if ( var_0 )
        thread scripts\mp\gametypes\br_gulag::record_finished_area();
    else
...
vehicle_damage_updatestate( var_0 )
{
    ...
    foreach ( var_7 in level.teamnamelist )
    {
        ...
        if ( var_8 )
        {
            ...
            {
                var_11 = var_4 && var_10 scripts\mp\gametypes\br_public::questtypes();
