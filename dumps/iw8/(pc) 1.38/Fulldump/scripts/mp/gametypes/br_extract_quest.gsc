...
init()
{
    ...
    scripts\mp\gametypes\br_quest_util::_id_1195C( "blueprintextract", ::initializerocketfuelreadings );
    scripts\mp\gametypes\br_quest_util::registerremovequestinstance( "blueprintextract", ::initialize_registered_create_script_files );
    scripts\mp\gametypes\br_quest_util::registerquestlocale( "blueprintextract_locale" );
    scripts\mp\gametypes\br_quest_util::registercreatequestlocale( "blueprintextract_locale", ::initevents );
    scripts\mp\gametypes\br_quest_util::registercheckiflocaleisavailable( "blueprintextract_locale", ::initdroplocations );
    scripts\mp\gametypes\br_quest_util::registerremovequestinstance( "blueprintextract_locale", ::inithelipropanims );
    scripts\mp\gametypes\br_quest_util::registerquestcircletick( "blueprintextract_locale", ::initendcameralocations );
    scripts\mp\gametypes\br_quest_util::zvelscale( "blueprintextract_locale", ::initheadlessoperatorcustomization );
    scripts\mp\gametypes\br_quest_util::_id_11950( "blueprintextract_locale", ::initheliextractanims );
    scripts\mp\gametypes\br_quest_util::getquestdata( "blueprintextract_locale" ).nextid = 0;
    scripts\mp\gametypes\br_quest_util::watch_for_player_going_belowmap_or_oob( "blueprintextract", 1 );
    scripts\mp\gametypes\br_quest_util::_id_11951( "blueprintextract", ::initbunker );

    if ( !istrue( level.br_plunder_enabled ) )
    {
        scripts\mp\gametypes\br_plunder::playersetomnvarkeypad();
        scripts\mp\gametypes\br_plunder::playersetplunderomnvar();
        level._effect["vfx_extract_smoke"] = loadfx( "vfx/iw8_br/gameplay/vfx_br_adv_supply_drop_marker" );
        scripts\mp\gametypes\br_plunder::vehicle_occupancy_isenemytoplayer();
        scripts\mp\gametypes\br_plunder::playersetwasingulag();
    }

    if ( !scripts\mp\gametypes\br_plunder::quickdropremoveplunderfrominventory() )
...
initializerocketfuelreadings()
{
    ...
    var_1 = scripts\mp\gametypes\br_quest_util::is_point_in_cylinder( "blueprintextract", var_0 );
...
initevents( var_0 )
{
    ...
    var_1 scripts\mp\gametypes\br_quest_util::force_bleedout_all_downed_players( "ui_mp_br_mapmenu_icon_extraction_objective", "current", var_0.origin );
...
initextractionlocations( var_0 )
{
    var_1 = spawnstruct();
    var_1.origin = var_0;
    var_2 = minigun_attack_max_cooldown( var_1 );
    var_3 = scripts\mp\gametypes\br_quest_util::is_point_in_cylinder( "blueprintextract", var_2 );
...
initindividualgastrap( var_0, var_1 )
{
    ...
    foreach ( var_5 in scripts\mp\utility\teams::getteamdata( self.team, "players" ) )
    {
        ...
        var_5 scripts\mp\gametypes\br_quest_util::_id_12A39( var_3 );
...
takequestitem( var_0 )
{
    var_1 = scripts\mp\gametypes\br_quest_util::looping_path( self.team );

    if ( isdefined( var_1 ) && var_1.size > 0 )
    {
        foreach ( var_3 in var_1 )
            var_3.playoverwatch_dialogue scripts\mp\gametypes\br_quest_util::removequestinstance();
    }
    ...
    var_5 scripts\mp\gametypes\br_quest_util::watch_for_player_in_gulag( var_6, 4 );
    ...
    scripts\mp\gametypes\br_quest_util::_id_124A9( "blueprintextract", self, self.team );
    ...
    var_12.vehicleoutline = scripts\mp\gametypes\br_quest_util::min_z( "blueprintextract", scripts\mp\gametypes\br_quest_util::mine_caves_cell_support_internal( self.team ) );
    ...
    scripts\mp\gametypes\br_quest_util::global_stealth_broken_func( var_5.team, self, 6, scripts\mp\gametypes\br_quest_util::getquestindex( "blueprintextract" ) );
    level thread scripts\mp\gametypes\br_public::cloudanimfx( "mission_extract_accept", var_5.team, 1 );
...
_id_12F71( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0 ) && !var_0 hasweapon( self.weapon ) )
        {
            ...
            level thread scripts\mp\gametypes\br_public::cloudanimfx( "br_blueprint_extract_quest_failure", var_0.team, 1, 1 );
...
_id_12F70( var_0 )
{
    ...
    for (;;)
    {
        ...
        level thread scripts\mp\gametypes\br_public::cloudanimfx( "br_blueprint_extract_quest_failure", var_1, 1, 1 );
...
_id_12F2D( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( var_0.respawn_state_hidden == self._id_12550.open_selected_doors.index )
        {
            ...
            var_2 = scripts\mp\gametypes\br_quest_util::mine_caves_runner( self.initialwinningteam );
            ...
            scripts\mp\gametypes\br_quest_util::global_stealth_broken_func( self.team, var_0, 8, var_6 );
            level thread scripts\mp\gametypes\br_public::cloudanimfx( "mission_extract_success", self.team, 1, 1 );
...
glintfx( var_0 )
{
    ...
    var_1 = self.team;
    var_2 = spawnstruct();
    var_3 = scripts\mp\gametypes\br_quest_util::mine_caves_cell_support_internal( var_0.team );
    var_4 = scripts\mp\gametypes\br_quest_util::getquestindex( "blueprintextract" );
    var_5 = scripts\mp\gametypes\br_quest_util::mine_caves_ambush( scripts\mp\gametypes\br_quest_util::mine_cave_turrets( "blueprintextract" ) );
    var_6 = scripts\mp\gametypes\br_quest_util::mine_caves_runner( self.initialwinningteam );
    var_2.target_show_damage_damage_watch = scripts\mp\gametypes\br_quest_util::target_wavespawning_to_jammer5( var_4, var_3, var_5, var_6 );
    waitframe();
