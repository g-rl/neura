...
init()
{
    ...
    scripts\mp\gametypes\br_dev::zombiesdamagezombies( ::notifyteamonvehicledeath );
...
_id_11BFD( var_0, var_1 )
{
    ...
    var_2.active = 1;
    scripts\mp\gametypes\br_analytics::circleposattime( var_0 );

    if ( isdefined( var_2.all_gas_trap_structs ) )
        var_2 [[ var_2.all_gas_trap_structs ]]();

    var_2.active = 0;
    scripts\mp\gametypes\br_analytics::circlepeeks( var_0 );
}
