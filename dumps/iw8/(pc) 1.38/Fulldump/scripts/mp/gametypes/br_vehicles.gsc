...
{
    if ( scripts\mp\gametypes\br_gametypes::propsetclonesleft( "vehicleSpawns" ) )
        return;

    if ( ( var_0 == "little_bird" || var_0 == "little_bird_mg" ) && scripts\mp\gametypes\br_gametypes::propsetclonesleft( "littleBirdSpawns" ) )
        return;
...
spawnavehicle( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_6 ) )
        scripts\mp\gametypes\br_analytics::civilians_killed_stat_row( var_6, var_0 );
...
waitforvehiclestodeletethenspawninitial()
{
    ...
    if ( scripts\mp\gametypes\br_gametypes::progress_obj( "spawnInitialVehicles" ) )
        scripts\mp\gametypes\br_gametypes::_id_11BE4( "spawnInitialVehicles" );
    else
        spawninitialvehicles();
}
