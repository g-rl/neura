...
playerzombiedelayturnonfx()
{
    ...
    thread _id_11F7D();
    thread scripts\mp\gametypes\br_lootchopper::select_hostage_room_three_spawners();
    thread scripts\mp\gametypes\br_c130airdrop::cycle_thrust_fx();
    ...
    for ( var_0 = 0; var_0 < level.select_patrol_two_spawners; var_0++ )
    {
        ...
        var_3 = spawnstruct();
        var_3.modifier = "";
        var_3 scripts\mp\gametypes\br_quest_util::force_ai_to_drop_thermites( var_1, var_2 );
        var_3 scripts\mp\gametypes\br_quest_util::_id_11EBE( level.select_players_not_in_killzone_only );
        level.select_players_in_killzone_only[var_0] = var_3;
        var_3 = spawnstruct();
        var_3.modifier = "";
        var_3 scripts\mp\gametypes\br_quest_util::force_ai_to_drop_thermites( var_1, var_2, 2 );
        var_3 scripts\mp\gametypes\br_quest_util::_id_11EBE( level.select_players_not_in_killzone_only );
    ...
    thread _id_12E03();
    level thread scripts\mp\gametypes\br_analytics::playerrespawncleanup();
    cleanupents();
...
vehicle_compass_deregisterinstance( var_0 )
{
    ...
    if ( soundexists( "dx_bra_uktl_bm_tut_earn_cash" ) )
        level scripts\mp\gametypes\br_public::cloud_cover( "bm_tut_earn_cash", self );
...
playerrespawn()
{
    ...
    if ( istrue( self._id_1238B ) || var_0 == 1 )
    {
        var_5 = scripts\mp\gametypes\br_gulag::unsetreduceregendelayonkills();
    ...
    {
        thread scripts\mp\gametypes\br_gulag::_id_1292D( 4 );
        self._id_1276E = 1;
...
_id_12B1D()
{
    ...
    for (;;)
    {
        if ( scripts\engine\utility::ent_flag( "playerRespawn_intermission_spawned" ) )
        {
            ...
            {
                var_0 = scripts\mp\gametypes\br_gulag::unsetreduceregendelayonkills( 1 );
...
initusage( var_0, var_1 )
{
    ...
    if ( getdvarint( "scr_bmo_use_spawn_intermission_fix", 1 ) == 1 )
    {
        ...
        var_3 = scripts\mp\gametypes\br_gulag::unsetreduceregendelayonkills();
...
make_solution_struct()
{
    ...
    var_5 = scripts\mp\gametypes\br_c130::_id_120ED( var_1, var_5 );
...
_id_11F7E()
{
    ...
    {
        var_3 scripts\mp\gametypes\br_quest_util::_id_11EEB( var_1 );
            ...
            if ( !level.deadgray && isdefined( var_18 ) )
            {
                ...
                if ( !scripts\mp\gametypes\br_public::prophasclonesleft() )
                {
                    if ( !level.give_launchers_xmags )
                    {
                        ...
                        level thread scripts\mp\gametypes\br_public::cloudanimfx( "gamestate_90_perc_first", var_18, 1, undefined, "bm" );

                        foreach ( var_50 in level.teamnamelist )
                        {
                            if ( var_50 != var_18 )
                                level thread scripts\mp\gametypes\br_public::cloudanimfx( "gamestate_90_perc_enemy", var_50, 1, undefined, "bm" );
                        }
                    }
                }
            }
            else if ( !level.deadblue && isdefined( var_19 ) )
            {
                ...
                if ( !scripts\mp\gametypes\br_public::prophasclonesleft() )
                {
                    if ( !level.give_launchers_xmags )
                    {
                        ...
                        level thread scripts\mp\gametypes\br_public::cloudanimfx( "gamestate_75_perc_first", var_19, 1, undefined, "bm" );

                        foreach ( var_50 in level.teamnamelist )
                        {
                            if ( var_50 != var_19 )
                                level thread scripts\mp\gametypes\br_public::cloudanimfx( "gamestate_75_perc_enemy", var_50, 1, undefined, "bm" );
                        }
                    }
                }
            }
            else if ( !level.dead_target_count && isdefined( var_20 ) )
            {
                ...
                if ( !scripts\mp\gametypes\br_public::prophasclonesleft() )
                {
                    if ( !level.give_launchers_xmags )
                    {
                        ...
                        level thread scripts\mp\gametypes\br_public::cloudanimfx( "gamestate_50_perc_first", var_20, 1, undefined, "bm" );

                        foreach ( var_50 in level.teamnamelist )
                        {
                            if ( var_50 != var_20 )
                                level thread scripts\mp\gametypes\br_public::cloudanimfx( "gamestate_50_perc_enemy", var_50, 1, undefined, "bm" );
                        }
                    }
                }
            }
...
branalytics_plunder_placed_into_extraction( var_0 )
{
    ...
    var_2 = scripts\mp\gametypes\br_plunder::fogenabled();
    var_2.triggereliminatedoverlay = 0;

    foreach ( var_4 in var_1 )
    {
        if ( isdefined( var_4.plundercount ) && var_4.plundercount > 0 )
            var_4 scripts\mp\gametypes\br_plunder::updatelootleadermarks( var_4.plundercount, undefined, var_2 );
    }
...
{
    level thread scripts\mp\gametypes\br_plunder::wait_unload_chopper( level.tank_watchpiggybackexploit );
}
...
playerdropplunderondeath( var_0, var_1 )
{
    ...
    if ( var_3 > 0 )
        scripts\mp\gametypes\br_plunder::updateondamagepredamagemodrelics( var_3 );
    ...
    if ( scripts\mp\gametypes\br_public::prophasclonesleft() && istrue( self.detonation_time ) )
    ...
    scripts\mp\gametypes\br_analytics::_id_127D1( self, "combat", var_3 * -1 );
...
dropplunderbyrarity( var_0, var_1 )
{
    ...
    for ( var_6 = level.br_plunder.warp_player_debug.size - 1; var_6 >= 0; var_6-- )
    {
        ...
        for ( var_7 = 0; var_7 < var_3[var_6]; var_7++ )
        {
            ...
            var_9 = scripts\mp\gametypes\br_pickups::spawnpickup( level.br_plunder.names[var_6], var_8, level.br_plunder.warp_player_debug[var_6], 1 );
            scripts\mp\gametypes\br_plunder::showassassinationtargethud( level.br_plunder.names[var_6], 1 );
...
_id_12694( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        {
            var_3 scripts\mp\gametypes\br_plunder::updateprestreamrespawn( var_3.vehicle_spawn_initdev );
            var_3.vehicle_spawn_initdev = 0;
...
onplayerconnectrisk()
{
    ...
    scripts\mp\gametypes\br_analytics::cinderblock_damage_monitor( self.plunder.size, var_0, "little_bird", var_1, self.endpoint );
    level.br_plunder.initcprooftopcrate = level.br_plunder.initcprooftopcrate + var_0;
    level.br_plunder.initcpammoarmorcrate++;
    scripts\mp\gametypes\br_plunder::init_ai_kill_params_for_events();
}
...
onstun( var_0 )
{
    ...
    self notify( "explode" );
    wait 0.35;
    level thread scripts\mp\gametypes\br::_id_1269B( "br_gametype_extract_heli_shot_down", self.owner, self.owner.team );
...
branalytics_plunder_extraction_failure( var_0 )
{
    ...
    foreach ( var_10, var_8 in var_1 )
    {
        ...
        {
            var_0 scripts\mp\gametypes\br_quest_util::_id_12624( var_8 );
            return;
        }
    ...
    if ( isdefined( var_5 ) )
        var_0 scripts\mp\gametypes\br_quest_util::_id_12624( var_5 );
}
...
_id_12B08( var_0, var_1, var_2, var_3 )
{
    ...
    for ( var_7 = 0; var_7 < level.select_patrol_two_spawners; var_7++ )
    {
        ...
        if ( isdefined( level.select_top_roof_spawners[var_7] ) )
        {
            ...
            var_18 scripts\mp\gametypes\br_quest_util::spawn_elevators( var_19 );
            ...
            foreach ( var_11 in var_21 )
                var_18 scripts\mp\gametypes\br_quest_util::_id_12056( var_11 );

            var_24 = scripts\mp\utility\teams::getfriendlyplayers( var_18.targetplayer.team, 0 );

            foreach ( var_11 in var_24 )
                var_18 scripts\mp\gametypes\br_quest_util::overrideviewkickscaledmr( var_11 );
...
_id_11A2F( var_0 )
{
    ...
    {
        foreach ( var_2 in level.players )
            var_0.select_patrol_three_spawners scripts\mp\gametypes\br_quest_util::overrideviewkickscaledmr( var_2 );
...
ammobox_tryuseinternal( var_0, var_1 )
{
    ...
    if ( isdefined( var_1 ) )
        var_2 scripts\mp\gametypes\br_quest_util::spawn_elevators( var_1 );
    else
    {
        ...
        var_2 scripts\mp\gametypes\br_quest_util::spawn_elevators( var_9 );
    }
    ...
    foreach ( var_4 in var_10 )
        var_2 scripts\mp\gametypes\br_quest_util::_id_12056( var_4 );

    var_13 = scripts\mp\utility\teams::getfriendlyplayers( var_2.targetplayer.team, 0 );

    foreach ( var_4 in var_13 )
        var_2 scripts\mp\gametypes\br_quest_util::overrideviewkickscaledmr( var_4 );
...
_id_11A2E( var_0 )
{
    ...
    foreach ( var_3 in level.players )
        var_0 scripts\mp\gametypes\br_quest_util::overrideviewkickscaledmr( var_3 );
...
_id_12B07( var_0 )
{
    ...
    var_0 scripts\mp\gametypes\br_quest_util::_id_11EBE( var_5 );
}
...
{
    var_1 = add_outline( scripts\mp\gametypes\br_plunder::loopsound_origin(), level.setdragonsbreathcorpseflare );
...
_id_11BED()
{
    ...
    level.br_plunder_sites = add_collision_to_hack_point( scripts\mp\gametypes\br_plunder::loopsound_origin(), level.setdragonsbreathcorpseflare );
...
_id_12042( var_0 )
{
    foreach ( var_2 in level.teamnamelist )
        scripts\mp\gametypes\br_public::cloudanimfx( "plunder_extract_requested", var_2 );
...
initial_angles()
{
    ...
    foreach ( var_6 in level.teamnamelist )
        level thread scripts\mp\gametypes\br_public::cloudanimfx( "plunder_extract_chopper_arrive", var_6, 1 );

    open_any_random_airlock_door();
    helicleanupextract();

    foreach ( var_6 in level.teamnamelist )
        level thread scripts\mp\gametypes\br_public::cloudanimfx( "plunder_extract_chopper_leave", var_6, 1 );
...
_id_1292A( var_0, var_1, var_2 )
{
    ...
    scripts\mp\gametypes\br_publicevents::defenderflagbases();
    ...
    if ( isdefined( var_0 ) && ( level.give_secondary_attachments_only || !level.give_killstreak_sentry ) )
    {
        ...
        level thread scripts\mp\gametypes\br_public::cloudanimfx( "bm_gamestate_overtime", var_0 );

        foreach ( var_5 in level.teamnamelist )
        {
            if ( var_5 != var_0 )
                level thread scripts\mp\gametypes\br_public::cloudanimfx( "bm_gamestate_overtime_enemy", var_5 );
        }
    }
    else
    ...
    for (;;)
    {
        foreach ( var_15, var_2 in level.allassassin_update_timed )
        {
            ...
            foreach ( var_6 in var_3 )
            {
                ...
                var_12 = scripts\mp\gametypes\br_public::clear_and_give_killstreak_loadout_support( var_6 );
