...
_id_122AB( var_0, var_1 )
{
    ...
    {
        if ( isdefined( var_7 ) && !var_7 scripts\mp\gametypes\br_public::isplayeringulag() )
        {
    ...
    if ( !scripts\mp\gametypes\br_public::rear_minigun_model() )
        scripts\mp\gametypes\br_public::cloudanimfx( "dropbag_incoming", self.team, 1 );

    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        scripts\mp\gametypes\br_analytics::chopperexif_fx_init( self, var_0, var_1, var_4 );
...
_id_122AC( var_0 )
{
    foreach ( var_2 in var_0 )
    {
        ...
        if ( isdefined( level.br_circle ) && isdefined( level.br_circle.safecircleent ) )
        {
            ...
            {
                var_4 = scripts\mp\gametypes\br_circle::getsafecircleorigin();
                var_7 = scripts\mp\gametypes\br_c130::_id_120ED( var_4, var_3 );
...
binoculars_ongive()
{
    if ( scripts\mp\gametypes\br_gametypes::propsetclonesleft( "dropbag" ) )
        return;
