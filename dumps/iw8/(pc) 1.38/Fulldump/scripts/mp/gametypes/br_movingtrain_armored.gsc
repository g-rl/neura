...
initmarker()
{
    ...
    var_0 scripts\mp\gametypes\br_quest_util::force_bleedout_all_downed_players( "ui_mp_br_ping_icon_x2_t", "current", var_0.origin + ( 0, 0, 300 ) );
...
_id_12B0C()
{
    ...
    while ( !scripts\mp\flags::gameflag( "x2_train_destroyed" ) )
    {
        ...
        scripts\mp\gametypes\br_quest_util::spawn_ending_individual_guys_death( var_0 + ( 0, 0, 300 ) );
        waitframe();
    }
}
    ...
    for (;;)
    {
        ...
        if ( var_12 > 0 )
        {
            ...
            if ( scripts\mp\utility\game::missions_clearinappropriaterewards() == "x2" )
                scripts\mp\gametypes\br_gametype_x2::create_cursor_hint_forced( var_1, var_0 );
        }
...
nuke_vault_runner( var_0 )
{
    ...
    var_2 = scripts\mp\gametypes\br_movingtrain::nopropsspectate( var_1 );
...
_id_12AF0( var_0, var_1 )
{
    ...
    if ( level._id_1237B[var_0.team][var_0.squadindex]._id_1278A <= 50000 )
        scripts\mp\gametypes\br_gametype_x2::createteamdefenderflagbase( var_0 );
...
explosion()
{
    ...
    if ( !scripts\mp\flags::gameflag( "x2_train_one_cart_left" ) )
        scripts\mp\gametypes\br_gametype_x2::createpropspecatehud( 3, 0 );
    ...
    foreach ( var_3 in var_1 )
        var_3 scripts\mp\gametypes\br_gametype_x2::createpropspeclist( 4 );

    scripts\mp\gametypes\br_gametype_x2::createstreakinfo_ai_turret( 1 );
    wait 1;
    scripts\mp\gametypes\br_gametype_x2::createteamdefenderflag( 1 );
}
...
_id_12B37( var_0, var_1 )
{
    ...
    var_2 = 3;
    var_3 = ( var_0 - 1 ) * var_2;
    scripts\mp\gametypes\br_gametype_x2::createalldestinationvfx( var_3, var_2, var_1 );
}
...
_id_129BE()
{
    ...
    while ( self.health > 0 )
    {
        ...
        if ( var_7 > 0 )
        {
            ...
            if ( scripts\mp\utility\game::missions_clearinappropriaterewards() == "x2" )
                scripts\mp\gametypes\br_gametype_x2::create_cypher_piece( var_0, var_2 );
        }
    }
...
_id_129D0()
{
    ...
    if ( self.battle_tracks_stoptogglethink == 0 )
    {
        thread scripts\mp\gametypes\br_gametype_x2::createpropspecatehud( 3, 0 );
        wait 6;
        scripts\mp\gametypes\br_gametype_x2::createteamdefenderflag( 1 );
    }
}
