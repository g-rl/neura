...
init()
{
    ...
    scripts\mp\gametypes\br_pickups::_id_11953( "brloot_blueprintextract_tablet", ::calloutmarkerping_squadleaderbeaconcreate );
    scripts\mp\gametypes\br_pickups::_id_11953( "brloot_blueprintextract_tablet_easterevent", ::calloutmarkerping_sendmayday );
}
...
calloutmarkerping_squadleaderbeaconplayerfirstlanded( var_0 )
{
    ...
    if ( !scripts\mp\gametypes\br_extract_quest::initextractionlocations( var_0 ) )
        return 0;
...
{
    var_1 = scripts\mp\gametypes\br_quest_util::mine_caves_turret_op_internal( var_0 );
...
{
    var_1 = scripts\mp\gametypes\br_quest_util::mine_caves_runner( var_0 );
    scripts\mp\gametypes\br_pickups::select_back_two_spawners( self, var_1 );
...
calloutmarkerping_removevehiclecalloutonspecialconditions()
{
    ...
    {
        if ( !scripts\mp\gametypes\br_extract_quest::initextractionlocations( self.origin ) )
        {
            scripts\mp\gametypes\br_pickups::getcoremapdropzones();
            return;
        }
