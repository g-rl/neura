...
_id_1313B( var_0 )
{
    ...
    if ( var_2 > 0 )
    {
        ...
        scripts\mp\gametypes\br_plunder::heli_leaving_monitor( var_2, var_8 );
    }
    ...
    if ( isalive( var_0 ) && isplayer( var_0 ) && randomfloat( 1.0 ) < level._id_130BD._id_130DB )
    {
        ...
        var_1 scripts\mp\gametypes\br_pickups::heli_check_player_below_starts( var_8 );
    }
    ...
    if ( isalive( var_0 ) && isplayer( var_0 ) && randomfloat( 1.0 ) < level._id_130BD._id_130DD )
    {
        ...
        scripts\mp\gametypes\br_pickups::spawnpickup( "brloot_armor_plate", var_14, level._id_130BD._id_130DC, 1 );
    }
}
...
{
    var_1 = var_0 scripts\mp\gametypes\br_public::obj_a_behavior( "brloot_access_card_green" );
...
{
    if ( !var_3 scripts\mp\gametypes\br_public::obj_a_behavior( "brloot_access_card_green" ) )
    {
...
_id_130E1( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( getdvarint( "scr_bombardment_killswitch", 0 ) == 0 )
        var_0 scripts\mp\gametypes\br::set_customizable_values( "brloot_access_card_purple" );
