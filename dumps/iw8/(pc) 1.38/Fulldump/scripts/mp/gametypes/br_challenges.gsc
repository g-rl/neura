...
isattachmentselectfire( var_0, var_1 )
{
    ...
    if ( scripts\mp\gametypes\br::get_int_or_0( self.collbrush ) < 5 )
        return;
    ...
    foreach ( var_4 in level.teamdata[self.team]["players"] )
    {
        ...
        if ( var_2 && var_4 scripts\mp\gametypes\br_public::questtypes() )
            return;
    }
...
_id_12876( var_0, var_1 )
{
    ...
    var_5 = 0;
    var_6 = var_3 scripts\mp\gametypes\br_callouts::markingcoldblooded( var_3 );

    if ( var_6 != var_2 )
        var_5 = var_5 | 1 << var_6;

    var_6 = var_4 scripts\mp\gametypes\br_callouts::markingcoldblooded( var_4 );
