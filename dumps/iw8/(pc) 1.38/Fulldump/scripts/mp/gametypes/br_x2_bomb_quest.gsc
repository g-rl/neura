...
init()
{
    ...
    scripts\mp\gametypes\br_quest_util::getquestdata( "x2_bomb" ).should_do_vo_call = getdvarint( "scr_br_x2_bomb_missionTimeBase", 240 );
    scripts\mp\gametypes\br_quest_util::registerremovequestinstance( "x2_bomb", ::_id_13091 );
    scripts\mp\gametypes\br_quest_util::_id_1194E( "x2_bomb", ::_id_1308F );
    scripts\mp\gametypes\br_quest_util::_id_11950( "x2_bomb", ::_id_13092 );
    scripts\mp\gametypes\br_quest_util::registerquestthink( "x2_bomb", ::_id_13094, 0.05 );
    scripts\mp\gametypes\br_quest_util::watch_for_player_going_belowmap_or_oob( "x2_bomb", 0 );
    scripts\mp\gametypes\br_quest_util::_id_11951( "x2_bomb", ::_id_1308E );
    level.cleanupswaploadoutflags._id_13095 = 0;
    flash_crate_use();
    level._id_13090 = "bomb";
    level._id_13093 = 0;
    scripts\mp\gametypes\br_quest_util::_id_11957( "x2_signal" );
...
flash_crate_use()
{
    ...
    {
        scripts\mp\gametypes\br_quest_util::getquestdata( "x2_bomb" ).getinfectedairdropposition[var_6] = [];

        foreach ( var_5, var_4 in var_2 )
            scripts\mp\gametypes\br_quest_util::getquestdata( "x2_bomb" ).getinfectedairdropposition[var_6][var_5] = flashtheprops( getdvarvector( "scr_br_x2_bomb_set" + var_6 + "_" + var_5, var_4 ) );
    }
}
...
{
    return scripts\mp\gametypes\br_gametype_x2::create_usb_anim_rig( var_0 );
}

monitor_player_near_truck( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = scripts\mp\gametypes\br_gametype_x2::create_vault_assault_loadout_selection( "x2_bomb", var_0, var_1, var_4 );
    var_6 = undefined;
    var_7 = undefined;
    var_8 = undefined;
    ...
    var_5 scripts\mp\gametypes\br_quest_util::force_bleedout_all_downed_players( var_8, "current", ( 0, 0, 0 ) );
    var_5 _id_11E87();

    foreach ( var_2 in var_5.playerlist )
    {
        var_5 scripts\mp\gametypes\br_quest_util::_id_12058( var_2 );
    ...
    var_5 scripts\mp\gametypes\br_quest_util::watch_for_player_in_gulag( scripts\mp\gametypes\br_quest_util::getquestdata( "x2_bomb" ).should_do_vo_call, 4 );
    scripts\mp\gametypes\br_quest_util::addquestinstance( "x2_bomb", var_5 );
    scripts\mp\gametypes\br_quest_util::_id_124A9( "x2_bomb", self, self.team );
    var_11 = spawnstruct();
    var_11.vehicleoutline = scripts\mp\gametypes\br_quest_util::min_z( "x2_bomb", scripts\mp\gametypes\br_quest_util::mine_caves_cell_support_internal( self.team ) );
...
bonus_target_score()
{
    return scripts\mp\gametypes\br_gametype_x2::cp_smuggler_sound_load( "x2_bomb", ::monitor_player_near_truck );
}

flashtheprops( var_0 )
{
    var_1 = spawnstruct();
    var_1.origin = scripts\mp\gametypes\br_public::helihint_deposit( var_0, 0, -200 ) + ( 0, 0, 20 );
...
_id_12B6B( var_0 )
{
    var_1 = scripts\mp\gametypes\br_gametype_x2::create_ambient_vehicle( "x2_bomb", self );
    ...
    level._id_13081 = level._id_13081 + scripts\mp\gametypes\br_public::minshotstostage3acc( self.team, self.squadindex ).size;
    level._id_13093++;
    scripts\mp\gametypes\br_gametype_x2::createvisualsinfo();
...
_id_11E87()
{
    ...
    self.fulton_repositoryusecallback = scripts\mp\gametypes\br_quest_util::getquestdata( "x2_bomb" ).getinfectedairdropposition[self.fulton_interactions_disabled][level.cleanupswaploadoutflags._id_13095];

    if ( !isdefined( self.fulton_repositoryusecallback ) )
        return;

    level.cleanupswaploadoutflags._id_13095++;
    scripts\mp\gametypes\br_quest_util::spawn_ending_individual_guys_death( self.fulton_repositoryusecallback.origin + ( 0, 0, 38 ) );
...
_id_13094()
{
    if ( isdefined( self.fulton_repositoryusecallback ) && isdefined( self.fulton_repositoryusecallback.gameobject ) )
        scripts\mp\gametypes\br_quest_util::spawn_ending_individual_guys_death( self.fulton_repositoryusecallback.gameobject.origin );
...
_id_1308C()
{
    ...
    var_3 = scripts\mp\gametypes\br_quest_util::mine_caves_ambush( scripts\mp\gametypes\br_quest_util::mine_cave_turrets( "x2_bomb" ) );
    ...
    {
        var_5 = scripts\mp\gametypes\br_gametype_x2::crate_objectives( self.playerlist );
        scripts\mp\gametypes\br_quest_util::global_relic_landlocked_func( var_5, var_4, var_0 );
    ...
    self.result = "success";
    self.spawntvfix = 1;
    scripts\mp\gametypes\br_gametype_x2::create_vehicle_omnvars_data( self );
    scripts\mp\gametypes\br_quest_util::removequestinstance();
}
...
_id_1229E( var_0 )
{
    var_1 = scripts\mp\gametypes\br_public::helihint_deposit( var_0, 100, -200 );
