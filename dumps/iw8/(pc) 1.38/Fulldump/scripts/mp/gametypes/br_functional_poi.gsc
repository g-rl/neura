...
_spawnpois()
{
    ...
    var_7 = scripts\mp\gametypes\br_armory_kiosk::loot_chopper_spawns();
    ...
    if ( isdefined( var_7 ) && var_7.size > 0 )
    {
        ...
        if ( isdefined( var_7 ) && var_7.size > 0 )
            scripts\mp\gametypes\br_armory_kiosk::_id_11EF9( var_7 );
    }

    var_8 = scripts\mp\gametypes\br_plunder::loopsound_origin();
    ...
    if ( isdefined( var_8 ) && var_8.size > 0 )
    {
        ...
        if ( isdefined( var_8 ) && var_8.size > 0 )
            scripts\mp\gametypes\br_plunder::_id_11EA2( var_8 );
    }
...
add_client_back_to_mask_after_delay( var_0, var_1, var_2 )
{
    ...
    if ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "risk" )
        return scripts\mp\gametypes\br_gametype_dmz::add_collision_to_hack_point( var_0, var_1, var_2 );
    ...
    for ( var_5 = 0; var_5 < var_0.size; var_5++ )
    {
        ...
        var_6.score = scripts\mp\gametypes\br_circle::lower_door_coll( var_6.origin ) + var_7;
    }
