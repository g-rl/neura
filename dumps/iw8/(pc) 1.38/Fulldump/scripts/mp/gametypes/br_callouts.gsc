...
init()
{
    level.calloutglobals.spawn_script_model_driver_and_passengers = [];
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            level.calloutglobals.spawn_script_model_driver_and_passengers[var_11] = var_12;
        }
...
markingendtime( var_0 )
{
    var_1 = "";

    foreach ( var_4, var_3 in level.calloutglobals.spawn_script_model_driver_and_passengers )
    {
...
markingcoldblooded( var_0 )
{
    ...
    foreach ( var_11, var_9 in level.calloutglobals.spawn_script_model_driver_and_passengers )
    {
