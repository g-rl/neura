...
trophy_used( var_0 )
{
    ...
    var_0.usedcount = 0;
    var_0.getggweapontablelootvariants = self;
...
trophy_deploy()
{
    ...
    thread trophy_watchprotection( 45, 105625, ::_id_12939, ::trophy_protectionsuccessful );
    thread _id_1293C();
...
trophy_delete( var_0, var_1, var_2 )
{
    ...
    self.owner scripts\cp\helicopter\chopper_boss::stoppingpower_onweaponcreated( "super_trophy", self.usedcount, var_0, var_2 );
    ...
    while ( [[ var_2 ]]() )
    {
        ...
        foreach ( var_9 in var_7 )
        {
            ...
            if ( var_11 )
            {
                ...
                if ( var_12 scripts\cp_mp\vehicles\vehicle::isvehicle() && isdefined( var_12._id_12954 ) && isdefined( var_10.team ) && var_12._id_12954 == var_10.team )
                    continue;
            }
            else if ( var_9 == self )
                continue;
...
trophy_protectionsuccessful( var_0 )
{
    ...
    self.owner scripts\mp\supers::eventcallback( "super_trophy" );
    self.usedcount++;
    var_1 = var_0.origin;
    search( var_0 );
    _id_12935( var_0 );
...
_id_12935( var_0 )
{
    ...
    var_0.exploding = 1;
    var_0 stopsounds();
    scripts\cp\helicopter\chopper_boss::ondestroyedbytrophy();
    trophy_notifytrophytargetowner( var_0, "trophy_mp", self.owner );
    _id_1293A( var_0, var_0.owner, self.owner );
...
_id_1293A( var_0, var_1, var_2 )
{
    ...
    var_3 = var_2;
    var_4 = var_1.origin;
    var_5 = scripts\mp\equipment\snapshot_grenade::_id_120F2( var_3, var_4 );
    scripts\mp\equipment\snapshot_grenade::_id_120F1( var_1, var_2, var_5 );
}
...
search( var_0 )
{
    ...
    if ( !isdefined( self.getggweapontablelootvariants ) )
        return;

    getentitylessscriptablearray( "dlog_event_trophy_successful", [ "deploying_player", self.getggweapontablelootvariants, "grenade_owner", var_0.owner, "negated_target", var_0.weapon_name ] );
}
