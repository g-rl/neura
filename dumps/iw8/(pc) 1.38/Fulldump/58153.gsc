...
ammorestock_playeruse( var_0, var_1 )
{
    ...
    foreach ( var_9 in var_2 )
    {
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_0 scripts\mp\gametypes\br_weapons::checkpoint_player_spawns_func( var_9, 2 );
            continue;
        }
...
checkifplayerrewardsareenabled( var_0 )
{
    ...
    foreach ( var_8 in var_3 )
    {
        ...
        if ( var_12 )
        {
            ...
            var_0 scripts\mp\gametypes\br_weapons::checkpoint_player_spawns_func( var_8, 2 );
            var_1 = 1;
        }
    }
