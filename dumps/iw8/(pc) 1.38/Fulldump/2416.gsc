...
incpersstat( var_0, var_1 )
{
    ...
    if ( isdefined( self.rocket_missile[var_0] ) )
        self.rocket_missile[var_0] = self.rocket_missile[var_0] + var_1;
...
setextrascore0( var_0 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" && level.cleanupswaploadoutflags.name == "rebirth" )
        return;
...
getplayerdataloadoutgroup()
{
    ...
    var_0 = istrue( level._id_12EC6 ) && getdvarint( "LNLMORMPTS" );
