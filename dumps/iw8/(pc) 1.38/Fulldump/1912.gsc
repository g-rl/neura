...
getspawnpoint( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( !istrue( level.give_player_juggernaut ) && !istrue( var_0.skipspawncamera ) && var_9.bucket >= 2 && var_9.threatsight < 300 )
        var_0._id_12000 = 1;
...
getspawnpointarray( var_0, var_1 )
{
    ...
    if ( istrue( var_1 ) )
    {
        level.spawnpointarray[var_0] = level._id_11D09[var_0];
        return level.spawnpointarray[var_0];
    }

    if ( isdefined( level._id_11D09 ) && isdefined( level._id_11D09[var_0] ) )
        var_8 = scripts\engine\utility::array_combine( var_8, level._id_11D09[var_0] );
...
finalizespawnpointchoice( var_0 )
{
    ...
    else
    {
        ...
        self finalizespawnpointchoiceforplayer( var_0.index, var_0.bucket, var_0._id_12BA7, var_0.threatsight, var_0.damagemod );
    }
...
force_teleport_downedplayer( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
amped_wid( var_0 )
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        if ( !isdefined( level._id_11D09[var_3] ) )
            level._id_11D09[var_3] = [];
        ...
        level._id_11D09[var_3][level._id_11D09[var_3].size] = var_8;
    }

    level thread _id_11D0A();
}
...
_id_11D0A()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_1 in level._id_11D09 )
        {
            foreach ( var_3 in var_1 )
            {
