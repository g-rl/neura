...
initconfig()
{
    ...
    if ( isdefined( level.ammobox_giverandomattachment ) )
        var_1 [[ level.ammobox_giverandomattachment ]]();
}
...
watchmarkeractivate( var_0 )
{
    ...
    else
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "juggernaut", "dropCrateFromScriptedHeli" ) && level.gametype != "br" )
        {
            ...
            var_2 thread scripts\cp_mp\killstreaks\airdrop::baloon_deposit_death_check( var_0, "airdrop" );
        ...
        {
            var_5 = 1;
            var_2 thread scripts\cp_mp\killstreaks\airdrop::_id_122D1( var_3, var_5 );
        }
    }
}
...
activatejugg( var_0 )
{
    ...
    thread _id_12F33( var_0 );
    thread watchforjuggernautend( var_0 );
    thread _id_12F32( var_0 );
...
onjuggernautend( var_0, var_1 )
{
    if ( level.gametype != "br" )
    {
        ...
        var_0.init_swivelroom_currsolution_marquee = 1;
        scripts\cp_mp\utility\killstreak_utility::x1loadout( var_0 );
    }
...
createjuggobjective()
{
    ...
    else
    {
        ...
        {
            var_1 = [[ var_0 ]]( 99 );
            self.juggcontext.juggobjid = var_1;
            scripts\mp\objidpoolmanager::objective_add_objective( var_1, "active", self.origin, "icon_minimap_juggernaut" );
            ...
            foreach ( var_3 in level.players )
            {
                if ( isdefined( var_3 ) )
                {
                    if ( var_3 != self )
                    {
                        scripts\mp\objidpoolmanager::objective_playermask_addshowplayer( var_1, var_3 );
                        continue;
                    }

                    scripts\mp\objidpoolmanager::objective_playermask_hidefrom( var_1, var_3 );
                }
            }
            ...
            if ( level.teambased )
                ...
                scripts\mp\objidpoolmanager::_id_12ACA( var_1, self );
        }
    }
}
...
watchjuggernautweaponswitch( var_0 )
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_12E3F( "manual_switch_from_minigun", "weapon_pickup" );
