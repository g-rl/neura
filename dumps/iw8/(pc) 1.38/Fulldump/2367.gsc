...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "allowPickupOfTurret", ::_id_11D9A );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "handleMovingPlatform", scripts\mp\killstreaks\manual_turret_mp::set_number_of_subway_cars_on_track );
}
