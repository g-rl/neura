...
ondeploystart( var_0 )
{
    ...
    var_0.owner scripts\common\utility::bhasthermitestucktoshield( 0 );
}
...
ondeployfinished( var_0, var_1 )
{
    ...
    var_0.owner scripts\common\utility::bhasthermitestucktoshield( 1 );
}
    ...
    for (;;)
    {
        ...
        if ( var_4 == var_2 )
        {
            if ( isdefined( var_3 ) )
            {
                ...
                {
                    if ( isdefined( level.remote_tank_think ) )
                        [[ level.remote_tank_think ]]();
...
watchdeployweaponanimtransition( var_0, var_1, var_2 )
{
    ...
    var_4 = scripts\engine\utility::_id_12E55( var_1, "death", "weapon_change", "cancel_all_killstreak_deployments" );
...
startweapontabletfadetransition( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\player_utility::_isalive() )
    {
        ...
        var_1 = scripts\engine\utility::_id_12E53( 0.7, "death" );
...
cleanupdeployweapon( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        var_6 = scripts\cp_mp\utility\killstreak_utility::radialmonitor( var_2.basename );
