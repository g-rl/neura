...
inititems()
{
    ...
    var_0.callbacks["equip_binoculars"]["onGive"] = _applysalesdiscount::buttonmashcount;
    var_0.callbacks["equip_binoculars"]["onTake"] = _applysalesdiscount::c130airdrop_dropcrates;
...
{
    if ( isdefined( level.equipment.table[var_0] ) )
        return istrue( level.equipment.table[var_0].raid_vindia_unload_func );
    else
        return 0;
}
...
updateuiammocount( var_0 )
{
    ...
    if ( var_0 == "primary" )
    {
        ...
        self setpowerammo( "primary", var_1 );
    }
    else if ( var_0 == "secondary" )
    {
        self setclientomnvar( "ui_power_secondary_num_charges", var_1 );
        self setpowerammo( "secondary", var_1 );
    }
...
executeoffhandfired( var_0 )
{
    foreach ( var_6, var_2 in self.equipment )
    {
        ...
        if ( isdefined( var_3.objweapon ) && var_0 == var_3.objweapon )
        {
            ...
            scripts\mp\damage::evaluatefobspawns( var_4 );
...
watchlethaldelay()
{
    ...
    var_0 = func_load_difficulty_table();
...
watchlethaldelayplayer( var_0, var_1 )
{
    ...
    if ( !isdefined( self.router_picked_up ) || !istrue( self.router_picked_up[var_1] ) )
    {
        if ( !isdefined( self.router_picked_up ) )
            self.router_picked_up = [];

        self.router_picked_up[var_1] = 1;
    ...
    if ( isdefined( self.router_picked_up ) && istrue( self.router_picked_up[var_1] ) )
    {
        self.router_picked_up[var_1] = undefined;

        if ( self.router_picked_up.size == 0 )
            self.router_picked_up = undefined;
...
watchlethaldelayfeedbackplayer( var_0, var_1 )
{
    ...
    var_3 = func_load_difficulty_table();
...
hackequipment( var_0 )
{
    ...
    var_0 scripts\cp\helicopter\chopper_boss::store_platform_models( self.equipmentref );
    changeowner( var_0 );
...
monitor_balloons( var_0, var_1, var_2 )
{
    foreach ( var_4 in var_0 )
    {
        ...
        var_4._id_11D2D = var_4 getcurrentequipment( var_1 );
        var_4._id_11D2C = getequipmentslotammo( var_1 );
...
_id_1261F( var_0, var_1, var_2, var_3 )
{
    foreach ( var_5 in var_0 )
    {
        ...
        var_7 = var_5._id_11D2D;
        var_8 = var_5._id_11D2C;

        if ( isdefined( var_7 ) )
        {
            var_5 giveequipment( var_7, var_1 );
            var_5._id_11D2D = undefined;

            if ( isdefined( var_8 ) )
            {
                var_5 setequipmentammo( var_7, var_8 );
                var_5._id_11D2C = undefined;
            }
        }
    }
}
...
playerteleportgulag()
{
    ...
    foreach ( var_2 in level.equipment.table )
    {
        if ( !var_2.raid_vindia_unload_func )
            continue;
        ...
        level.roundnumber[var_2.ref] = 1 << var_0;
        var_0++;
    }
}
