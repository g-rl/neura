...
starttankdropoff( var_0 )
{
    ...
    scripts\common\utility::_id_12965( level.set_ui_omnvar_for_relics, "pac_sentry", self.origin );
...
createtank( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_11 thread _id_1263C();
    var_11 thread _id_1263D();
...
_id_1263D()
{
    ...
    for (;;)
    {
        scripts\cp_mp\vehicles\vehicle::_id_12BE5( self );
        waitframe();
    }
}
...
tank_destroy( var_0, var_1 )
{
    ...
    self.streakinfo.init_swivelroom_currsolution_marquee = istrue( var_1 );
...
tank_driverexit( var_0 )
{
    ...
    if ( var_0 scripts\cp_mp\utility\player_utility::_isalive() )
    {
        ...
        level thread scripts\cp_mp\utility\killstreak_utility::_id_11ABD( var_0 );
    }
}
