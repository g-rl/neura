...
supportbox_playercanuse( var_0 )
{
    ...
    {
        if ( isdefined( self.owner ) && !scripts\engine\utility::array_contains( scripts\mp\gametypes\br_public::minshotstostage3acc( self.owner.team, self.owner.squadindex ), var_0 ) )
            return 0;
...
_id_125A5( var_0 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" && scripts\mp\menus::_id_1237A() && isdefined( self.owner ) )
        var_3 = scripts\engine\utility::array_contains( scripts\mp\gametypes\br_public::minshotstostage3acc( self.owner.team, self.owner.squadindex ), var_0 );
    else
    {
        if ( isdefined( self.owner ) )
