...
gettargetmarker( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            {
                if ( questrewardcirclepeek( var_3 ) )
                {
                ...
                else if ( scripts\mp\vehicles\little_bird_mg_mp::queue_spawn() )
                {
    ...
    if ( isdefined( var_3.location ) && isdefined( var_3.angles ) )
    {
        ...
        if ( isdefined( var_8["entity"] ) )
        {
            ...
            var_3.spawn_fake_digit_pool = ( var_11, var_12, var_13 );
            var_3.spawn_exfil_techo = combineangles( invertangles( var_9.angles ), var_3.angles );
        }
