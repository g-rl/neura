...
tacinsert_used( var_0 )
{
    ...
    if ( isdefined( var_18 ) && ( scripts\mp\vehicles\little_bird_mg_mp::pressure_overload_threshold( var_18 ) || scripts\mp\gametypes\br_gondola::postgamehitmarkerwaittime( var_18 ) ) )
    {
    ...
    if ( isdefined( var_6 ) )
    {
        if ( isdefined( var_6["hittype"] ) && var_6["hittype"] != "hittype_none" )
        {
            ...
            if ( isdefined( var_8 ) )
            {
                ...
                if ( !var_9 && ( scripts\mp\vehicles\little_bird_mg_mp::pressure_overload_threshold( var_8 ) || scripts\mp\gametypes\br_gondola::postgamehitmarkerwaittime( var_8 ) ) )
                    var_3 = 0;
