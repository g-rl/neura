...
execution_loadtable()
{
    ...
    for (;;)
    {
        ...
        var_3 = spawnstruct();
        var_3.ref = var_2;
        var_4 = tablelookupbyrow( "mp_cp/executiontable.csv", var_0, 0 );
        var_3.id = int( var_4 );
        var_5 = tablelookupbyrow( "mp_cp/executiontable.csv", var_0, 12 );

        if ( var_5 != "none" )
            var_3.execution = var_5;

        var_6 = tablelookupbyrow( "mp_cp/executiontable.csv", var_0, 13 );

        if ( var_6 != "none" )
        {
            var_3.propweapon = getcompleteweaponname( var_6 );

            if ( nullweapon( var_3.propweapon ) )
            {
                var_0++;
                continue;
            }
        ...
        level.execution.table[var_2] = var_3;
        var_0++;
    }
}
