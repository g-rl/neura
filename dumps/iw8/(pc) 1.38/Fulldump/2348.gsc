...
starthelicopter( var_0, var_1 )
{
    ...
    scripts\common\utility::_id_12965( level.set_ui_omnvar_for_relics, var_3, self.origin );
...
heli_existance()
{
    ...
    scripts\engine\utility::_id_12E40( "death", "crashing", "leaving" );
...
fireontarget( var_0 )
{
    ...
    scripts\engine\utility::_id_12E53( 4, "facing" );
    ...
    scripts\engine\utility::_id_12E53( 3, "near_goal" );
}
...
heli_leave( var_0 )
{
    ...
    if ( isdefined( self.helitype ) && self.helitype == "osprey" && isdefined( self.pathgoal ) )
    {
        ...
        scripts\engine\utility::_id_12E53( 5, "goal" );
    }
    ...
    scripts\engine\utility::_id_12E53( 12, "goal" );
    self notify( "gone" );
    self notify( "death" );
    waitframe();
