...
init()
{
    ...
    thread scripts\cp\laser_traps\cp_laser_traps::init();
}
...
look_at_heli( var_0 )
{
    if ( isdefined( level.ai_molotov_used ) )
        return level.ai_molotov_used[var_0];

    return "none";
}

look_for_more_leads_vo( var_0 )
{
    if ( isdefined( level.ai_offhandfiremanager ) )
        return level.ai_offhandfiremanager[var_0];
...
giveplayeraccessory( var_0, var_1, var_2 )
{
    ...
    var_3 = maxplunderdropinovertime( var_1 );
    ...
    if ( isdefined( var_2 ) )
    {
        switch ( var_2 )
        {
            ...
            case "pet_black":
                ...
                break;
            case "pet_go":
                scripts\cp\laser_traps\cp_laser_traps::initpet( 0 );
                break;
            case "heartbeat":
                break;
            case "thermometer":
                ...
                break;
            case "holo":
                scripts\cp_mp\gestures::_id_12485();
                break;
            case "holo2":
                scripts\cp_mp\gestures::_id_12486();
                break;
            case "holo3":
                scripts\cp_mp\gestures::startholowatchvfxred();
                break;
            default:
                break;
        }
...
maxplunderdropinovertime( var_0 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        {
            case "fem":
                var_4 = level.ai_molotov_swap[var_0];
                var_5 = level.ai_ignore_all_until_goal[var_0];
                ...
                break;
            case "big":
                var_6 = level.ai_is_juggernaut[var_0];
...
{
    if ( var_0 == 1 )
        scripts\cp_mp\gestures::_id_12476();
    else if ( var_0 == 2 )
...
playerzombiesupersprint()
{
    if ( !isdefined( self._id_126EF ) )
    {
        self._id_126EF = 1;
        var_0 = match1playeromnvarupdated();
        self setclientomnvar( "ui_pet_watch_state", var_0 );
    }
}

match1playeromnvarupdated()
{
