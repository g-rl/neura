...
resetstreakcount()
{
    ...
    setstreakcounttonext();
    self resetclientkillstreakindexes();
}
...
updatestreakcost( var_0 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        if ( var_0 <= mark_remaining_as_died_poorly() )
        {
...
updatekillstreakuislots()
{
    ...
    for ( var_1 = 0; var_1 <= mark_remaining_as_died_poorly(); var_1++ )
...
updatekillstreakuislot( var_0 )
{
    ...
    if ( isdefined( level.show_player_clip ) && ![[ level.show_player_clip ]]( var_0 ) )
        return;
    ...
    if ( isdefined( var_2 ) && isdefined( var_2.streakname ) )
    {
        ...
        addspawnlocation( var_0, var_3 );
        addselfrevivetoken( var_0, var_2.available );
    }
    else
    {
        self setclientomnvar( var_1.slotomnvars[var_0], 0 );
        self setclientomnvar( var_1.availableomnvars[var_0], 0 );
        addspawnlocation( var_0, 0 );
        addselfrevivetoken( var_0, 0 );
    }
}
...
triggerkillstreak( var_0, var_1 )
{
    ...
    if ( isdefined( level.shoulddeleteimmediately ) && !self [[ level.shoulddeleteimmediately ]]( var_0, var_1 ) )
    {
        scripts\mp\hud_message::showerrormessage( "KILLSTREAKS/CANNOT_BE_USED" );
        return 0;
    }
...
onsuccessfulstreakactivation( var_0, var_1 )
{
    ...
    if ( istrue( level._id_13039 ) && self.streaktype != "specialist" )
        var_0.available = -1;
    else
        var_0.available = -1;

    addselfrevivetoken( var_1, var_0.available );
    ...
    thread scripts\cp\helicopter\chopper_boss::usedkillstreak( var_2 );
    ...
    var_0.all_end_checkpoints_activated = var_6;
    scripts\mp\analyticslog::logevent_killstreakactivated( self, var_0._id_1252F, var_0.streakname, var_0.isgimme, var_6, self.origin );
    ...
    if ( isdefined( self.petwatch ) )
    {
        ...
        if ( var_2 == "nuke" )
            ...
            scripts\cp_mp\pet_watch::ammobox_getbufferedattachmentsourceweapon();
    }
}
...
createstreakitemstruct( var_0 )
{
    ...
    var_1.isspecialist = scripts\mp\perks\perks::randomstartindex( var_0 );
    var_1._id_12322 = scripts\mp\perks\perks::getspecialistperkforstreak( var_0 );
    return var_1;
}
...
makekillstreakavailable( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_5._id_12322 ) )
        var_6 = var_5._id_12322;
    ...
    var_5.available = 1;
    addselfrevivetoken( var_0, var_5.available );
    ...
    var_5._id_1252F = self.matchdatalifeindex;
    var_5.owner = self;
    var_5.target_pity_outline_think = self getxuid();

    if ( isdefined( var_2 ) )
        var_5.streaklifeid = var_2;

    if ( isdefined( var_3 ) )
        var_5._id_1252F = var_3;

    if ( isdefined( var_4 ) )
    {
        var_5.owner = var_4;
        var_5.target_pity_outline_think = var_4 getxuid();
    }

    scripts\cp\helicopter\chopper_boss::strafereverse_cleanup( var_5.streakname, var_1 );
    scripts\mp\analyticslog::logevent_killstreakavailable( self, var_5._id_1252F, var_6, var_5.isgimme, var_5.madeavailabletime, self.origin );

    if ( isdefined( self.petwatch ) && var_0 == mark_remaining_as_died_poorly() )
    {
        var_8 = 0;
        var_9 = 0;
        ...
        if ( var_8 && var_9 )
            scripts\cp_mp\pet_watch::ammo_crate_trial_think();
        else
            scripts\cp_mp\pet_watch::ammo_crate_think();
    }
}

addspawnlocation( var_0, var_1 )
{
    if ( var_0 > mark_remaining_as_died_poorly() )
        return;

    self setclientkillstreakindexes( var_0, var_1 );
}

addselfrevivetoken( var_0, var_1 )
{
    if ( var_0 > mark_remaining_as_died_poorly() )
        return;
...
killstreakselectionwatcher()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_12E47( "ks_select_up", "ks_select_down" );
...
selectfirstavailablekillstreak()
{
    ...
    {
        for ( var_1 = mark_remaining_as_died_poorly(); var_1 >= 0; var_1-- )
        {
...
{
    var_1 = var_0;
    var_2 = scripts\engine\utility::ter_op( var_0 >= mark_remaining_as_died_poorly(), 0, var_0 + 1 );
    var_3 = var_0;
    var_4 = var_2;
    ...
    while ( var_4 != var_3 )
    {
        ...
        if ( var_4 > mark_remaining_as_died_poorly() )
            var_4 = 0;
    }
...
{
    var_1 = var_0;
    var_2 = scripts\engine\utility::ter_op( var_0 <= 0, mark_remaining_as_died_poorly(), var_0 - 1 );
    var_3 = var_0;
    var_4 = var_2;
    ...
    while ( var_4 != var_3 )
    {
        ...
        if ( var_4 < 0 )
            var_4 = mark_remaining_as_died_poorly();
    }
...
selectmostexpensivekillstreak()
{
    ...
    for ( var_2 = mark_remaining_as_died_poorly(); var_2 >= 0; var_2-- )
    {
...
selectnextavailablekillstreak()
{
    ...
    for ( var_2 = 0; var_2 <= mark_remaining_as_died_poorly(); var_2++ )
    {
        var_3 = self.streakdata.streaks[var_2];
...
registerkillstreak( var_0, var_1, var_2, var_3 )
{
    ...
    var_4.getrandomweaponfromgroup = var_3;
}
...
checkstreakreward( var_0, var_1 )
{
    for ( var_2 = 1; var_2 <= 4; var_2++ )
    {
        ...
        if ( isdefined( var_3.lifeid ) && var_3.lifeid == self.lifeid && ( !istrue( level._id_13039 ) || istrue( level._id_13039 ) && self.streaktype == "specialist" ) || istrue( level._id_13039 ) && istrue( level.casualscorestreaks ) && self.streaktype != "specialist" && var_3.available == -1 )
            continue;
...
givestreakpoints( var_0, var_1, var_2 )
{
    ...
    if ( var_6 && !istrue( level.give_munition_currency ) && ( istrue( level.allowkillstreaks ) || isdefined( level.total_spawns ) ) )
    {
        var_7 = self.nukepoints + var_1;
        var_8 = calcstreakcost( "nuke" );

        if ( isdefined( level.total_spawns ) )
            var_8 = level.total_spawns;

        if ( var_7 >= var_8 )
        {
            self.nukepoints = var_8;

            if ( !istrue( self.helis_assault3_hangar ) )
            {
                thread scripts\mp\hud_message::showkillstreaksplash( "nuke", var_8 );
                awardkillstreak( "nuke", "earned" );
                self.helis_assault3_hangar = 1;
            }
        }
        else
        {
            ...
            if ( isdefined( self.petwatch ) )
                scripts\cp_mp\pet_watch::_id_12B11( self.nukepoints / var_8 );
        }
    }
...
resetstreakavailability( var_0 )
{
    ...
    for ( var_1 = 0; var_1 <= 4; var_1++ )
    {
        ...
        if ( isdefined( var_2 ) && isdefined( var_2.streakname ) )
        {
            ...
            addselfrevivetoken( var_1, var_2.available );
        }
    }
}
        ...
        foreach ( var_1 in level.players )
        {
            ...
            if ( isdefined( var_1.streakpoints ) )
            {
                if ( var_1 scripts\mp\utility\perk::_hasperk( "specialty_killstreak_to_scorestreak" ) )
                    var_2 = scripts\mp\perks\perkfunctions::remindermessage( var_1.streakpoints );
                else
...
_id_12B26( var_0, var_1 )
{
    if ( !isdefined( var_0 ) || !isdefined( self ) )
        return;

    if ( !isdefined( self._id_11CC0 ) )
        self._id_11CC0 = [];

    var_2 = var_0 getxuid();
    var_0.obj_room_fire_01 = 1;

    if ( !isdefined( self._id_11CC0[var_2] ) )
    {
        var_3 = spawnstruct();
        var_3.damage = 0;
        var_3.player = var_0;
        self._id_11CC0[var_2] = var_3;
    }

    self._id_11CC0[var_2].damage = self._id_11CC0[var_2].damage + var_1;
}

minigun_angles_offset( var_0 )
{
    if ( !isdefined( self._id_11CC0 ) )
        return [];
    ...
    foreach ( var_3 in self._id_11CC0 )
    {
        var_4 = var_3.damage;
        var_5 = var_3.player;
...
initridekillstreak_internal( var_0 )
{
    if ( isdefined( var_0 ) && islaptoptimeoutkillstreak( var_0 ) )
        ...
        var_1 = scripts\engine\utility::_id_12E55( 1.0, "death", "disconnect", "weapon_switch_started" );
    ...
    if ( !isdefined( var_0 ) || !issubstr( var_0, "pointSelect" ) )
    {
        if ( var_0 == "drone_hive" )
        {
            ...
            var_2 = scripts\engine\utility::_id_12E53( 0, "death_or_disconnect" );
        }
        else
        {
            ...
            var_2 = scripts\engine\utility::_id_12E53( 0.8, "death_or_disconnect" );
        }
    }
    else
        var_2 = scripts\engine\utility::_id_12E53( 1.0, "death_or_disconnect" );
...
checkcasualstreaksreset()
{
    ...
    if ( isdefined( self.streaktype ) && self.streaktype == "specialist" || isdefined( self.loadoutstreaktype ) && self.loadoutstreaktype == "specialist" || !istrue( level._id_13039 ) )
    {
