...
player_update_unresolved_collision( var_0, var_1 )
{
    ...
    if ( self.unresolved_collision_count >= var_2 )
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            {
                var_4 = isdefined( self.reset_wave_loadout ) && gettime() - self.reset_wave_loadout <= 250;

                if ( var_4 || var_0 scripts\cp_mp\vehicles\vehicle::isvehicle() && !scripts\cp_mp\vehicles\vehicle::_id_12C69( var_0, self ) )
                {
...
turret_fob_watcher( var_0 )
{
    ...
    if ( isdefined( var_0.destroyscoreevent ) )
        var_1 = 1;
...
unresolved_collision_nearest_node( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( level.exterior_goal_func ) )
    {
        var_3 = self [[ level.exterior_goal_func ]]( var_0, var_1, var_2 );
    ...
    if ( isdefined( var_2 ) )
    {
        if ( scripts\cp_mp\utility\game_utility::islargemap() )
        {
            ...
            else if ( isdefined( level.show_headicon_to ) && [[ level.show_headicon_to ]]( var_0, var_2 ) )
                return;
        }
        else
        {
...
handle_moving_platform_touch( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0.travelspeed ) && var_0.travelspeed )
        {
            if ( scripts\mp\equipment\claymore::pressure_overload_threshold( var_1 ) )
            {
                waitframe();
                continue;
            }
        ...
        if ( !istrue( var_0._id_120A7 ) )
            thread process_moving_platform_death( var_0, var_1 );

        self._id_12797 = 1;
        self.respawn_scriptible_carriable_wait = var_1;
        thread treerootnodesizebitcount();
        break;
    }
}
...
{
    self endon( "death" );
    self.respawn_scriptible_carriable_wait waittill( "death" );
    self.respawn_scriptible_carriable_wait = undefined;
}
...
handle_moving_platforms( var_0 )
{
    ...
    if ( isdefined( var_0.linkparent ) )
    {
        ...
        {
            if ( isdefined( var_0.safedestroy ) )
                self linkto( var_0.linkparent, "", var_0.safedestroy, var_0.angleoffset );
            else
