...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "juggernaut", "playOperatorUseLine", ::jugg_playoperatoruseline );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "juggernaut", "canReload", scripts\mp\juggernaut::regendelayspeedfunc );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "juggernaut", "canUseWeaponPickups", scripts\mp\juggernaut::regenhealthaddfunc );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "juggernaut", "getMinigunWeapon", scripts\mp\juggernaut::register_caves_spawners );
}
...
juggernautweaponpickedup( var_0, var_1 )
{
    ...
    self.trackriotshield_monitorshieldattach = 1;
