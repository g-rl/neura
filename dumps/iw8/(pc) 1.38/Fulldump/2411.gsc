...
giveunifiedpoints( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( isdefined( level.successful_vehicle_spawns ) )
        [[ level.successful_vehicle_spawns ]]( self, var_9, var_0, var_7 );
    ...
    if ( !istrue( var_3 ) )
    {
        ...
        if ( var_0 == "kill" )
        {
            var_21 = var_1 hasattachment( "gunperk_xp" ) || scripts\mp\utility\perk::_hasperk( "specialty_gunperk_xp" );
