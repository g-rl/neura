...
handlesplashqueue()
{
    ...
    {
        if ( scripts\mp\utility\game::getgametype() == "br" && ( scripts\mp\utility\game::missions_clearinappropriaterewards() == "dmz" || scripts\mp\utility\game::missions_clearinappropriaterewards() == "risk" || scripts\mp\utility\game::missions_clearinappropriaterewards() == "rumble" ) )
            scripts\engine\utility::_id_12E3F( "splash_list_cleared", "can_show_splashes" );
        else
            scripts\engine\utility::_id_12E3F( "splash_list_cleared", "spawned_player" );
