...
ammobox_init()
{
    level.battletracksmusicstatestandingonvehicle = [];
    scripts\common\interactive::interactive_addusedcallback( ::ammobox_usedcallback, "equip_ammo_box" );
    scripts\mp\utility\join_team_aggregator::registeronplayerjointeamcallback( ::blinking_light_thread );
    ...
    {
        biscodefunc( "weapon_sniper", var_0 );
        biscodefunc( "weapon_sniper", var_0 );
        biscodefunc( "weapon_sniper", var_0 );
        biscodefunc( "weapon_sniper", var_0 );
        biscodefunc( "weapon_sniper", var_0 );
    ...
    {
        biscodefunc( "weapon_assault", var_0 );
        biscodefunc( "weapon_assault", var_0 );
        biscodefunc( "weapon_smg", var_0 );
        biscodefunc( "weapon_smg", var_0 );
        biscodefunc( "weapon_lmg", var_0 );
        biscodefunc( "weapon_lmg", var_0 );
        biscodefunc( "weapon_sniper", var_0 );
        biscodefunc( "weapon_dmr", var_0 );
        biscodefunc( "weapon_shotgun", var_0 );
        biscodefunc( "weapon_pistol", var_0 );
...
biscodefunc( var_0, var_1 )
{
    var_2 = scripts\mp\utility\weapon::minecart_anim_node( var_0 );
    bisdeaf( var_2, var_1 );
}

blinking_light_thread( var_0 )
{
    foreach ( var_2 in level.battletracksmusicstatestandingonvehicle )
    {
        if ( isdefined( var_2 ) )
            var_2 scripts\mp\equipment\support_box::_id_125A5( var_0 );
    }
}
...
ammobox_settled( var_0 )
{
    ...
    level.battletracksmusicstatestandingonvehicle[var_0 getentitynumber()] = var_0;
...
ammobox_delete( var_0, var_1, var_2 )
{
    ...
    self.owner scripts\cp\helicopter\chopper_boss::stoppingpower_onweaponcreated( "super_weapon_drop", self.usedcount, var_0, var_2 );
...
ammobox_internalpreloadweapons( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_3 = [ var_2 ];
        bits( var_1 );
        var_4 = bleedout_heartbeat_sfx_logic( var_1 );
    ...
    foreach ( var_1 in self.playersused )
    {
        if ( isdefined( var_1 ) )
        {
            ...
            if ( !scripts\mp\utility\player::isreallyalive( var_1 ) && isdefined( self.playersused[var_2] ) )
            {
                ...
                scripts\mp\equipment\support_box::_id_125A5( var_1 );
            }
        }
    }
}
...
blend_movespeedscale_cpso( var_0 )
{
    ...
    if ( isdefined( level.suppress_spawn_vo ) )
        var_0 [[ level.suppress_spawn_vo ]]( var_2 );
...
{
    if ( !isdefined( var_0.crossbowusageloop ) )
    {
        var_1 = spawnstruct();
        var_1.buffered = undefined;
        var_1.last = undefined;
        var_1.br_getrandomlootweapon = undefined;
        var_1.br_iseliminated = undefined;
        var_1.br_is_allowed_armor_insert = undefined;
        var_0.crossbowusageloop = var_1;
    }

    return var_0.crossbowusageloop;
}
...
blade_trigger_think( var_0 )
{
    var_1 = ammobox_getbufferedplayerdata( var_0 );

    if ( !isdefined( var_1.br_getrandomlootweapon ) )
    {
        ...
        var_1.br_getrandomlootweapon = var_3;
    }

    return var_1.br_getrandomlootweapon;
}
...
blank_relic_func( var_0 )
{
    bisoverwatch( var_0 );
    var_1 = ammobox_getbufferedplayerdata( var_0 );
    return var_1.br_is_allowed_armor_insert;
}
...
bisoverwatch( var_0 )
{
    ...
    if ( !isdefined( var_1.br_iseliminated ) )
    {
        var_2 = blade_trigger_think( var_0 );
        ...
        if ( isdefined( var_4 ) )
        {
            var_1.br_is_allowed_armor_insert = var_3;
            var_1.br_iseliminated = var_4;
        }
    }
}
...
ammobox_onplayeruse( var_0 )
{
    ...
    var_2 = var_0 bleedout_logic( var_1 );
...
bisthread( var_0 )
{
    ...
    {
        if ( !scripts\mp\utility\weapon::br_give_starting_ammo( var_0, var_5 ) )
            continue;
...
bleedout_logic( var_0 )
{
    if ( !isdefined( var_0 ) )
        return 0;

    var_1 = blade_trigger_think( self );
    var_2 = bleedout_heartbeat_sfx_logic( self );

    if ( isdefined( var_2 ) )
    {
        black_screen_overlay( self );
        var_3 = undefined;
        var_4 = undefined;
        ...
        if ( !isdefined( var_17 ) )
        {
            ...
            thread blink_train_test( var_17 );
...
blink_train_test( var_0 )
{
    self endon( "disconnect" );
    var_1 = var_0 + 1;

    if ( istrue( self._id_12FEC ) )
    {
        self._id_12FEC = undefined;
        var_1 = var_1 * -1;
    }
    else
        self._id_12FEC = 1;
    ...
    scripts\engine\utility::_id_12E53( 1, "death" );
...
ammobox_addheadicon()
{
    self.occupied_rpg_trig = scripts\cp_mp\entityheadicons::setheadicon_singleimage( [], "hud_icon_fieldupgrade_weapon_drop", 20, 1, 1000, 100, undefined, 1 );
    self.oceanrock = scripts\cp_mp\entityheadicons::setheadicon_factionimage( 0, 20, undefined, undefined, undefined, undefined, 1 );
    scripts\mp\equipment\support_box::_id_125A6();
}

ammobox_removeheadicon()
{
    if ( isdefined( self.occupied_rpg_trig ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( self.occupied_rpg_trig );
        self.occupied_rpg_trig = undefined;
    }

    if ( isdefined( self.oceanrock ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( self.oceanrock );
        self.oceanrock = undefined;
    }
}
...
{
    thread blink_wheelson_chosen_spawn( var_0, var_1 );
}

blink_wheelson_chosen_spawn( var_0, var_1 )
{
    if ( istrue( var_1.rear_minigun_track_target_delay ) )
        return;

    var_1.rear_minigun_track_target_delay = 1;
    blinkblackoverlay( var_0, var_1 );

    if ( isdefined( var_1 ) )
        var_1.rear_minigun_track_target_delay = undefined;
}
...
blinkblackoverlay( var_0, var_1 )
{
    ...
    if ( var_3 )
        var_4 = var_0 blend_movespeedscale_cpso( var_1 );
    else
    ...
    if ( var_4 )
    {
        if ( isdefined( var_0.owner ) )
        {
            ...
            var_0.owner scripts\mp\supers::eventcallback( "super_weapon_drop" );
        }

        var_0.usedcount++;
        var_0.playersused[var_1 getentitynumber()] = var_1;
        var_0 scripts\mp\equipment\support_box::_id_125A5( var_1 );
