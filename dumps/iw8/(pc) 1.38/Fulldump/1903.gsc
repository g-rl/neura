...
setplayerscoreboardinfo()
{
    ...
    if ( var_0 < 200 )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_12 = scripts\mp\gametypes\br::damageskipburndownlow( self );
            ...
            if ( scripts\mp\utility\game::missions_clearinappropriaterewards() == "dmz" || scripts\mp\utility\game::missions_clearinappropriaterewards() == "risk" )
            {
                ...
                var_17 = scripts\mp\gametypes\br_gametype_dmz::target_show_damage();
            ...
            else if ( scripts\mp\utility\game::missions_clearinappropriaterewards() == "kingslayer" )
            {
                ...
                var_16 = var_15[self.team];
                setclientmatchdata( "players", self.clientmatchdataid, "placement", var_16 );
                var_17 = scripts\mp\gametypes\br_gametype_kingslayer::target_show_damage();
                setclientmatchdata( "players", self.clientmatchdataid, "extrascore4", var_17 );
                var_18 = 0;
            ...
            else if ( scripts\mp\utility\game::missions_clearinappropriaterewards() == "rebirth" )
            {
                ...
                var_17 = scripts\mp\gametypes\br_gametype_rebirth::cone();
                setclientmatchdata( "players", self.clientmatchdataid, "extrascore4", var_17 );
            }
