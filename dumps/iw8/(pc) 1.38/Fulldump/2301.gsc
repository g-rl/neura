...
at_mine_use( var_0 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        if ( isent( var_3 ) && pressure_overload_threshold( var_3 ) )
        {
...
at_mine_plant( var_0 )
{
    ...
    if ( istrue( var_0._id_12797 ) )
        var_0 thread br_circle_closing_music();
...
br_circle_closing_music()
{
    self endon( "mine_triggered" );
    self endon( "mine_destroyed" );
    self endon( "death" );
    self.br_ending_debugmode = ( 0, 0, 0 );
    var_0 = 0.2;
    ...
    for (;;)
    {
        var_1 = self.origin;
        wait( var_0 );
        self.br_ending_debugmode = 1 / var_0 * ( self.origin - var_1 );
    }
}

plunderrepositoryrestricted( var_0 )
{
    return isdefined( var_0 ) && isdefined( var_0.br_ending_debugmode ) && length2dsquared( var_0.br_ending_debugmode ) > 0.01;
}
...
at_mine_watch_flight()
{
    ...
    if ( var_0 > 0 )
    {
        ...
        if ( plunderrepositoryrestricted( self ) )
            var_2 = var_2 + self.br_ending_debugmode * var_0;
        ...
        if ( var_0 > 0 )
        {
            ...
            childthread scripts\mp\utility\equipment::_id_12ED2();
            scripts\engine\utility::_id_12E53( var_0, "collision_with_platform" );
