...
vehicle_spawn_getleveldataforvehicle( var_0, var_1 )
{
    ...
    if ( !isdefined( var_3 ) && istrue( var_1 ) )
    {
        ...
        var_3._id_1272D = undefined;
        var_3._id_11AA0 = undefined;
        var_3._id_1272E = undefined;
    }
...
vehicle_spawn_init()
{
    ...
    var_0._id_11AA1 = getdvarint( "scr_respawnVehicleDelayOverride", 0 );
    var_0.ai_goto_ascender_and_wait = getdvarint( "scr_abandonedVehicleTimeoutOverride", 0 );
    var_0._id_11AA0 = getdvarint( "scr_respawnVehicleDelay", 60 );
    var_0.ai_goal_update_population = getdvarint( "scr_abandonedVehicleTimeout", 30 );
...
_id_12CEC( var_0, var_1, var_2 )
{
    ...
    if ( var_4._id_11AA1 != 0 )
        var_5 = var_4._id_11AA1;
    else if ( isdefined( var_3._id_11AA0 ) )
        var_5 = var_3._id_11AA0;
    else
        var_5 = var_4._id_11AA0;
...
_id_12CED()
{
    ...
    if ( istrue( self.handlelaststandweapongivepipeline ) )
        return;
    ...
    if ( !isdefined( var_0.ai_goal_distribution_debug ) )
        return;
    ...
    if ( var_1.ai_goto_ascender_and_wait != 0 )
        var_2 = var_1.ai_goto_ascender_and_wait;
    else if ( isdefined( var_0.ai_goal_update_population ) )
        var_2 = var_0.ai_goal_update_population;
    else
        var_2 = var_1.ai_goal_update_population;
...
{
    _id_12CEB();
    self.handlelaststandweapongivepipeline = 1;
    var_0 = vehicle_spawn_getleveldataforvehicle( self.vehiclename );
    self thread [[ var_0.ai_goal_distribution_debug ]]();
}

_id_12CE3()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::_id_12C33();
    ...
    if ( var_0 != "heavy" )
    {
        ...
        scripts\cp_mp\vehicles\vehicle_damage::_id_12C56( "heavy", var_0 );
    }
}
