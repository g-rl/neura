...
callback_playerdisconnect( var_0 )
{
    ...
    else if ( self.sessionstate != "playing" && scripts\mp\utility\game::getgametype() == "br" && ( scripts\mp\gametypes\br_public::iswaitingtoentergulag( self ) || scripts\mp\gametypes\br_public::push_player_down( self ) || scripts\mp\gametypes\br_public::radiussq( self ) ) )
        removefromalivecount( 1 );
