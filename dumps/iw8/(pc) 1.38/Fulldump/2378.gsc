...
init()
{
    ...
    registerscriptperk( "specialty_specialist_bonus", scripts\mp\perks\perkfunctions::_id_11EFB, scripts\mp\perks\perkfunctions::_id_12A9E );
    ...
    registerscriptperk( "specialty_chain_killstreaks", scripts\mp\perks\perkfunctions::_id_11E91, scripts\mp\perks\perkfunctions::_id_12A9A );
    ...
    registerscriptperk( "specialty_reduce_regen_delay_on_kill", scripts\mp\perks\perkfunctions::_id_11EF2, scripts\mp\perks\perkfunctions::_id_12A9C );
    ...
    registerscriptperk( "specialty_br_better_mission_rewards", scripts\mp\perks\perkfunctions::_id_11E86, scripts\mp\perks\perkfunctions::_id_12A99 );
    ...
    registerscriptperk( "specialty_br_highalert", undefined, undefined, [ "specialty_sixth_sense" ] );
...
initspecialistkillstreaks()
{
    ...
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "specialist_perk_bonus", undefined, ::superfultonbeginuse );
}
...
analytics_lui_mission_end_dlog()
{
    ...
    {
        var_2 = scripts\engine\utility::ter_op( scripts\mp\utility\game::getgametype() == "br", istrue( var_1._id_12321 ), istrue( var_1.specialist ) );
...
giveperksafterspawn()
{
    ...
    if ( self.avoidkillstreakonspawntimer > 0 )
    {
        ...
        if ( istrue( self.inspawncamera ) )
            var_0 = var_0 + scripts\mp\spawncamera::minigun_start_locs();
...
updateactiveperks( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    {
        var_1.resettimeronkill = gettime();
