...
deadyellow( var_0, var_1 )
{
    ...
    var_2 thread achievement_id( var_5 );
    accuracy_bonus_factor( "Enemy switched to danger" );
}
...
achievement_id( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    if ( accessoryfem( var_0 ) )
    {
        ...
        if ( isdefined( var_6 ) )
        {
            ...
            if ( var_7 && absolutevelocity( var_6, var_3 ) )
            {
                if ( isdefined( level.select_top_roof_spawners ) && getdvar( "scr_br_gametype", "" ) == "kingslayer" && scripts\engine\utility::array_contains( level.select_top_roof_spawners, var_6 ) )
                ...
                var_5 = var_6;
                accuracy_bonus_factor( "Enemy tracked!" );

                if ( !istrue( var_2 ) )
                    var_6.push_player_clear_of_door_way = 1;
            }

            var_3 thread debug_chopper_boss( var_0, var_6 );
    ...
    else if ( var_0 == 0 )
    {
        if ( getdvarint( "scr_calloutmarkerping_navigation_proximity_cancel", 0 ) )
            var_3 thread death_info_func();
    }
    else if ( var_0 == 8 )
    {
        var_8 = var_3 calloutmarkerping_getent( var_0 );
        var_3 thread debug_chopper_boss( var_0, var_8 );
        var_3 thread deathsdoorsfx( var_0, var_8 );
    }
    else if ( var_0 == 7 )
    {
        ...
        {
            var_3 thread debug_display_veh_hit( var_0, var_9 );
            var_3 thread debug_display_track_tilts( var_0, var_9 );
        }
    }
    else if ( var_0 == 12 )
        var_3 thread debug_chopper_boss_combat( 12, var_1 );

    if ( !isdefined( var_5 ) )
        var_4 = var_3 deafen_ai( var_0 );

    accuracy_bonus_factor( "Timeout value before wait: " + var_4 + " | poolID: " + var_0 );
    wait( var_4 );

    if ( isdefined( var_5 ) && isdefined( var_3 ) )
    {
        if ( isdefined( var_5.push_player_clear_of_door_way ) )
            var_5.push_player_clear_of_door_way = undefined;

        var_3 thread deadyellow( var_0, var_5 );
    }
    else
    {
        accuracy_bonus_factor( "Pool timed out: " + var_0 );
...
accessreaderscriptableused()
{
    ...
    for (;;)
    {
        ...
        accuracy_bonus_factor( "Notification " + var_1 + " on pool " + var_2 );

        switch ( var_1 )
        {
            case "calloutmarkerping_added":
                var_0 abandonedtimeoutcallback( var_2 );
                break;
            case "calloutmarkerping_cleared":
                var_0 abandonedtimeoutoverride( var_2 );
                break;
            case "calloutmarkerping_acknowledged":
                var_0 _x1opsunassignnpcfromteam( var_2, var_3 );
                break;
            case "calloutmarkerping_acknowledged_cancel":
                var_0 abandonbrsquadleader( var_2 );
                break;
            case "calloutmarkerping_enemy_repinged":
                var_0 abilities( var_2 );
                break;
            case "map_ping_delete_marker":
                var_0 abilitykey();
                break;
            case "br_inventory_slot_request":
                var_0 abandonedtimeoutdelay( var_2 );
                break;
            default:
                break;
        }
...
calloutmarkerping_initplayer()
{
    ...
    if ( !isdefined( var_0.debug_run_helicopter_boss ) )
        var_0.debug_run_helicopter_boss = [];

    if ( !isdefined( var_0.debug_escape_silo ) )
        var_0.debug_escape_silo = [];

    var_0 thread accessreaderscriptableused();
}
...
deadmans_cash_pickup( var_0, var_1 )
{
...
maphint_cheese2scriptableused( var_0 )
{
    switch ( var_0 )
    {
        case 0:
...
deavtivate_destructible_cinderblock( var_0 )
{
    var_1 = self;

    if ( !deadmans_cash_pickup( var_1 ) )
        return;
    ...
    if ( var_2 )
    {
        ...
        if ( var_3 == var_0 )
        {
            var_1 death_killstreak_watcher( "br_ping_cancel", 12 );
            return;
        }
    }
    ...
    var_1 thread achievement_id( 12, var_0 );
    var_1 thread debug_reach_wind_room( var_0 );
}
...
debug_reach_wind_room( var_0 )
{
    ...
    var_2 = maphint_cheese2scriptableused( var_0 );

    if ( isdefined( var_2 ) && isdefined( var_1 ) )
        var_1 debug_pre_start_coop_escape( var_2, 12 );
}

_x1opsnpcpulsecheckteamnearby( var_0 )
{
    var_1 = self;
...
debug_gates( var_0 )
{
    ...
    if ( accessoryfemband( var_0 ) )
    {
        ...
        if ( isdefined( var_4 ) )
        {
            ...
            var_8 = achievementtrackerforkills( var_4 );
        }
        ...
        {
            if ( abshotfootlastposition( var_4.entity ) )
                var_3 = "ping_killstreaks_carepkg";
            else if ( istrue( var_4.entity.isjuggernaut ) )
                var_3 = "ping_killstreaks_juggernaut";
            else if ( accesscard( var_2 ) )
                var_3 = "ping_plunder_bank";
            else if ( abilityleft( var_4.entity ) )
                var_3 = "ping_vehicle_heavy";
            else if ( istrue( var_4.entity.raid_seq3_objectives_func ) )
                var_3 = "ping_pickup_generic";
        }
        else
            var_3 = var_1 debug_jugg_health( var_0, var_2 );
    }
    else if ( accessoryfem( var_0 ) )
        var_3 = var_1 debug_intro_start( var_0, var_2 );
    else if ( accessoryface( var_0 ) )
    ...
    else
    {
        switch ( var_0 )
        {
            case 0:
                ...
                {
                    if ( istrue( var_1.progression_main ) )
                ...
                break;
            case 8:
                var_3 = var_1 debug_jugg_maze( var_0, var_2 );
                break;
            case 7:
                var_3 = var_1 debug_kill_ent_after_time( var_0 );
                break;
            default:
                break;
        }
    ...
    var_1 debug_pre_start_coop_escape( var_3, var_0 );
}
...
accessorybig( var_0 )
{
    ...
    else if ( accessoryfem( var_0 ) )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            if ( absolutevelocity( var_1, self ) )
            {
...
debug_jugg_maze( var_0, var_1 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "ping", "ping_cp_getCPVehicleCallout" ) )
    {
        ...
        if ( isdefined( var_4 ) && istrue( var_4.crossbow ) )
            return var_4._id_12D97;
    }

    if ( !isdefined( var_3.vehiclename ) )
        return "ping_vehicle_concat_no_driver";

    var_5 = accessoryattachmentfem( var_3, var_2.team );
...
debug_kill_ent_after_time( var_0 )
{
    var_1 = self;
    ...
    switch ( var_8 )
    {
        ...
        case "blueprintextract":
            if ( var_1 debug_interaction_status( "ping_objective_contract" ) )
...
debug_jugg_health( var_0, var_1 )
{
    ...
    if ( !isdefined( var_6 ) )
    {
        ...
        {
            if ( var_2 debug_interaction_status( "ping_vehicle_cash_deposit_helo" ) )
    ...
    {
        if ( var_2 debug_interaction_status( "ping_pickup_fieldupgrade" ) )
    ...
    else if ( issubstr( var_6, "CONTRACT" ) )
    {
        ...
        if ( var_9 != "" && !var_2 debug_interaction_status( var_9 ) )
            var_9 = "";
    ...
    {
        if ( var_2 debug_interaction_status( "ping_gasmask" ) )
            var_9 = "ping_gasmask";
        else
            var_9 = "ping_pickup_generic";
    }
    ...
    {
        if ( var_2 debug_interaction_status( "ping_loot_accesscard" ) )
    ...
    {
        if ( var_2 debug_interaction_status( "ping_cash_deposit_balloon" ) )
...
debug_interaction_toggle( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    if ( !isdefined( var_7 ) )
    {
        ...
        {
            if ( var_2 debug_interaction_status( "ping_plunder_bank_confirm" ) )
    ...
    if ( issubstr( var_7, "CONTRACT" ) )
    {
        ...
        if ( var_10 != "" && !var_2 debug_interaction_status( var_10 ) )
            var_10 = "";
    ...
    {
        if ( var_2 debug_interaction_status( "ping_gasmask_confirm" ) )
            var_10 = "ping_gasmask_confirm";
    }
    else if ( issubstr( var_7, "ARMORY_KIOSK" ) )
    {
        if ( var_2 debug_interaction_status( "ping_plunder_vendor_confirm" ) )
            var_10 = "ping_plunder_vendor_confirm";
    }
    else if ( issubstr( var_7, "_PLUNDER_EXTRACT" ) )
    {
        if ( var_2 debug_interaction_status( "ping_cash_deposit_confirm" ) )
...
calloutmarkerping_removecallout( var_0 )
{
    ...
    accuracy_bonus_factor( "Remove Callout ID Start: " + var_0 );
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        accuracy_bonus_factor( "Remove Callout ID Notify: " + var_0 );
        var_1 notify( "predictiveCalloutClear_" + var_0 );
    }
}

debug_display_veh_hit( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        {
            accuracy_bonus_factor( "gscObjectiveStartedProgress: " + var_0 + " | gscObjID: " + var_1 );
            break;
        }
    }
...
debug_display_track_tilts( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_2 ) && var_2 == var_1 )
        {
            accuracy_bonus_factor( "gscObjectiveDeleted: " + var_0 + " | gscObjID: " + var_1 );
            break;
        }
    }
...
debug_chopper_boss( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    accuracy_bonus_factor( "Watch Entity Death or Enemy Disconnect: " + var_0 );
    ...
    if ( !isdefined( var_1 ) )
    {
        ...
        var_1 scripts\engine\utility::_id_12E40( "death", "pickup", "explode" );

    if ( isdefined( var_1.push_player_clear_of_door_way ) )
        var_1.push_player_clear_of_door_way = undefined;
...
{
    self endon( "predictiveCalloutClear_" + var_0 );
    accuracy_bonus_factor( "watchPlayerDeathOrDisconnect: " + var_0 );
    var_2 = mapedgeextractionlocs( var_1 );
    scripts\engine\utility::_id_12E3F( "death_or_disconnect", "self_pickedupitem_" + var_2 );
    calloutmarkerping_removecallout( var_0 );
}
...
calloutmarkerping_watchscriptabledeath( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    accuracy_bonus_factor( "Watch scriptable death ID: " + var_0 );
    ...
    else if ( var_1.type == "equip_fulton_mp" )
    {
        ...
        var_2 scripts\engine\utility::_id_12E3F( "death", "fulton_takeoff" );
    }
    else
        level scripts\engine\utility::_id_12E42( "pickedupweapon_kill_callout_" + var_1.type + var_1.origin, "lootcache_opened_kill_callout" + var_1.origin, "dropbag_kill_callout_" + var_1.origin, "tablethide_kill_callout_" + var_1.origin, "carriable_kill_callout_" + var_1.origin );

    accuracy_bonus_factor( "Watch scriptable death Remove ID: " + var_0 );
    calloutmarkerping_removecallout( var_0 );
}
...
deafen_ai( var_0 )
{
    ...
    if ( accesscardsspawned_red( var_0 ) )
        var_2 = getdvarfloat( "scr_calloutmarkerping_death_timeout_navigation", 120.0 );
    else if ( accessoryfemband( var_0 ) )
    {
        if ( access_card( var_0 ) )
            var_2 = getdvarfloat( "scr_calloutmarkerping_death_timeout_navigation", 120.0 );
        else if ( death_explode( var_0 ) )
...
debug_forest_combat( var_0, var_1 )
{
    var_2 = self;
...
debug_pipe_room( var_0 )
{
    ...
    if ( !isdefined( var_1.debug_run_helicopter_boss[var_0] ) )
        return 0;

    return 1;
}

debug_nuke_vault( var_0, var_1, var_2, var_3 )
{
    var_4 = self;
    var_5 = var_4.debug_run_helicopter_boss.size;

    if ( var_5 > 10 )
        return 0;

    var_6 = var_4 debug_forest_combat( var_0, var_3 );
    var_7 = var_6 + var_1;
    var_8 = spawnstruct();
    var_8._id_1217C = var_7;
    var_8.poolid = var_0;
    var_8.defenderflagbase = 0;
    var_4.debug_run_helicopter_boss[var_2] = var_8;
    return 1;
}

debug_freight_lift( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    if ( istrue( var_3.give_objective_xp_to_all_players ) )
        return 0;

    var_4 = gettime();
    var_5 = "pool" + var_0;
    var_6 = var_3 debug_pipe_room( var_5 );

    if ( var_6 )
    {
        var_7 = var_3.debug_run_helicopter_boss[var_5]._id_1217C;

        if ( var_4 >= var_7 )
        {
            var_8 = var_3 debug_nuke_vault( var_0, var_4, var_5, var_2 );
            return istrue( var_8 );
        }

        if ( var_1 == "ping_response_cancel" && var_3.debug_run_helicopter_boss[var_5].defenderflagbase == 0 )
        {
            var_3.debug_run_helicopter_boss[var_5].defenderflagbase = 1;
            return 1;
        }
...
debug_hintadjustmentthink()
{
    ...
    for (;;)
    {
        ...
        for ( var_1 = 0; var_1 < level.players.size; var_1++ )
        {
            ...
            if ( !isdefined( var_2 ) || !isdefined( var_2.debug_run_helicopter_boss ) )
                continue;

            foreach ( var_5, var_4 in var_2.debug_run_helicopter_boss )
            {
                if ( var_0 > var_4._id_1217C )
                    var_2.debug_run_helicopter_boss[var_5] = undefined;
            }
        }
    }
}

debug_mine_caves( var_0, var_1, var_2, var_3 )
{
    var_4 = 0;
...
death_killstreak_watcher( var_0, var_1 )
{
    var_2 = self;
    ...
    foreach ( var_7 in var_5 )
    {
        ...
        else if ( isdefined( var_3 ) )
        {
            ...
            var_8.rear_door_collision_brush = 1;
        }
        ...
        if ( isdefined( var_8.rear_door_collision_brush ) )
            var_8 delete();
    }
}

debug_interaction_status( var_0 )
{
    var_1 = self;
    var_2 = var_1 debug_kill_tromeo( var_0 );
    var_3 = var_1 debug_listing_helis( var_0 );
    var_4 = soundexists( var_2 );
    var_5 = soundexists( var_3 );
    return var_4 || var_5;
}

debug_kill_tromeo( var_0 )
{
    var_1 = self;
...
debug_pre_start_coop_escape( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    var_5 = var_4 debug_kill_tromeo( var_0 );
    var_6 = var_4 debug_listing_helis( var_0 );
    var_7 = soundexists( var_5 );
    var_8 = soundexists( var_6 );
    var_9 = debug_mine_caves( var_7, var_5, var_8, var_6 );
    var_10 = var_4 debug_freight_lift( var_1, var_0, var_9 );
...
death_info_func()
{
    ...
    for (;;)
    {
        ...
        if ( var_6 < var_3 )
        {
            death_killstreak_watcher( "br_ping_cancel", 0 );
...
debug_reach_pipe_room( var_0 )
{
    var_1 = self;
    var_1 notify( "calloutMarkerPingVO_playPredictivePingCleared" );
    var_1 endon( "calloutMarkerPingVO_playPredictivePingCleared" );
    var_1 death_killstreak_watcher( "br_ping_cancel", var_0 );
    wait( getdvarfloat( "scr_calloutmarkerping_delay_between_vo_and_sfx_secs_cleared", 0.5 ) );

    if ( isdefined( var_1 ) )
        var_1 debug_pre_start_coop_escape( "ping_response_cancel", var_0 );
}

debug_reach_exhaust_waste( var_0 )
{
    var_1 = self;
    var_1 debug_reach_pipe_room( var_0 );
}

debug_printcode( var_0, var_1 )
{
    var_2 = self;
    ...
    if ( accessoryfemband( var_0 ) )
    {
        ...
        var_4 = var_2 debug_interaction_toggle( var_0, var_3, var_1 );
    }
    else if ( accessoryfem( var_0 ) )
    ...
    else
    {
        ...
        {
            case 0:
                if ( var_1 debug_interaction_status( "ping_generic_ping_response" ) )
            ...
            case 7:
                ...
                break;
            case 8:
                if ( var_1 debug_interaction_status( "ping_vehicle_confirm" ) )
    ...
    if ( isplayer( var_1 ) )
        var_2 debug_pre_start_coop_escape( var_4, var_0, var_1 );
    else if ( isdefined( var_2 ) )
        var_2 debug_pre_start_coop_escape( var_4, var_0 );
}

debug_reach_icbm_launch( var_0 )
{
    var_1 = self;
...
death_explode( var_0 )
{
    ...
    if ( isdefined( var_2 ) && isdefined( var_2._id_125DE ) )
        return 1;
...
access_card( var_0 )
{
    ...
    if ( isdefined( var_2 ) && isdefined( var_2.classname ) && issubstr( var_2.classname, "scriptable" ) && !isdefined( var_2.entity ) && var_2 getscriptableisreserved() )
    {
        if ( var_2 _meth_87B7() )
        {
            ...
            return scripts\mp\vehicles\little_bird_mg_mp::postupdategameevents( var_3 );
        }
    }
...
deathsdoorsfx( var_0, var_1 )
{
    ...
    for (;;)
    {
        var_5 = activate_additional_ammo_crates( var_0, var_1, var_4 );
        ...
        var_6 = accessoryattachmentfem( var_1, var_4 );
...
activate_additional_ammo_crates( var_0, var_1, var_2 )
{
    var_3 = self;
    var_4 = 0;
...
accessoryattachmentfem( var_0, var_1 )
{
...
_x1opsnpcwaittilluse( var_0 )
{
    ...
    if ( !isdefined( var_1.debug_escape_silo ) )
        var_1.debug_escape_silo = [];

    if ( !isdefined( var_1.debug_escape_silo[var_0] ) )
        var_1.debug_escape_silo[var_0] = 0;
    else
        var_1.debug_escape_silo[var_0]++;

    var_2 = [];
    var_2[var_2.size] = "ping_id";
    var_2[var_2.size] = var_1.debug_escape_silo[var_0];
...
_x1opsplayerunredacttacmaplocation()
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        {
            if ( var_0 calloutmarkerping_getactive( var_1 ) )
                var_0 _x1opsplayerredactalltacmaplocation( var_1, "clear_all" );
        }
    }
}

_x1opsplayerredactalltacmaplocation( var_0, var_1 )
{
    var_2 = self;
    var_3 = [];
    var_3[var_3.size] = "ping_id";
    var_3[var_3.size] = var_2.debug_escape_silo[var_0];
...
{
    var_1 = self;
    var_1 _x1opsplayerredactalltacmaplocation( var_0, "clear_single" );
    var_1 notify( "predictiveCalloutClear_" + var_0 );
    var_1 thread debug_reach_pipe_room( var_0 );
}

_x1opsunassignnpcfromteam( var_0, var_1 )
{
    var_2 = self;
    var_2 thread achievement_id( var_0, 0, 1 );
    var_2 thread debug_printcode( var_0, var_1 );
...
{
    var_1 = self;
    var_1 thread debug_reach_exhaust_waste( var_0 );
}
...
abandonedtimeoutcallback( var_0 )
{
    ...
    if ( istrue( level.play_travel_vo ) && !istrue( var_1 istacmapactive() ) )
    {
        calloutmarkerping_removecallout( var_0 );
        return;
    }

    var_1 _x1opsnpcwaittilluse( var_0 );
    var_1 thread achievement_id( var_0 );
    var_1 _x1opsnpcpulsecheckteamnearby( var_0 );
    var_1 thread debug_reach_icbm_launch( var_0 );
    var_1 accessorybig( var_0 );
...
{
    var_1 = self;
    var_1 thread achievement_id( var_0, 0, 1 );
    var_1 death_killstreak_watcher( "br_ping_enemy", var_0 );
}

abilitykey()
{
    var_0 = self;
    var_1 = accessorylogicbyindex();

    if ( var_1 != -1 )
    {
        var_0 _x1opsplayerunredacttacmaplocation();
        var_0 death_killstreak_watcher( "br_ping_cancel", var_1 );
        var_0 debug_pre_start_coop_escape( "ping_response_cancel", var_1 );
    }
...
{
    var_1 = self;
    var_1 thread deavtivate_destructible_cinderblock( var_0 );
}
