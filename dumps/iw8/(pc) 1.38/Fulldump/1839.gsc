...
door_think()
{
    ...
    for (;;)
    {
        ...
        var_0 scripts\engine\utility::_id_12E3F( "door_state_done", "door_state_interrupted" );
...
disownalarmmonitor()
{
    ...
    for (;;)
    {
        self.dooralarmowner scripts\engine\utility::_id_12E40( "joined_team", "joined_spectators", "disconnect" );
...
{
    scripts\engine\utility::_id_12E3F( "remove_rig", "death_or_disconnect" );
}
