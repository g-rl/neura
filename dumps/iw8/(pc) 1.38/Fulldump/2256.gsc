...
f11scriptlighttoggle()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_12D33( "cop_car", 1 );
    var_0.id = 6;
...
f11scriptlightinit()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C4B( "cop_car", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "cop_car" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C1F( "cop_car" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C57( "cop_car", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C50( "cop_car", ::cop_car_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C5A( "cop_car_mp", 3 );
}
...
cop_car_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12C1A( var_2, "cop_car", var_0 );
