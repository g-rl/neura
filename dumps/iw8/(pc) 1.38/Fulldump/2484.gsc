...
boltsinflight( var_0, var_1, var_2 )
{
    scripts\asm\asm_mp::bot_pickup_origin();
...
bomb_case_detonator_control_think( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( var_4 ) )
        var_4 = "animscripted";
...
boltunlinkonnote( var_0, var_1, var_2, var_3 )
{
    scripts\asm\asm_mp::bot_pickup_origin();
