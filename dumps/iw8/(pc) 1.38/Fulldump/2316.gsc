...
_id_125E4( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        if ( scripts\mp\vehicles\little_bird_mg_mp::pressure_overload_threshold( var_0 ) || scripts\mp\vehicles\little_bird_mg_mp::prepare_mission_failed_text( var_0 ) || scripts\mp\gametypes\br_gondola::postgamehitmarkerwaittime( var_0 ) || scripts\mp\gametypes\br_soa_tower::position_ref( var_0 ) )
            return var_0;
    }
