...
_id_12BD0()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_12D33( "van", 1 );
    var_0.id = 13;
...
_id_12BCF()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C4B( "van", 1350 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "van" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C1F( "van" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C57( "van", 8 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C50( "van", ::van_deathcallback );
}
...
van_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12C1A( var_2, "van", var_0 );
