...
setreduceregendelayonkills()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_12D33( "medium_transport", 1 );
    var_0.id = 11;
...
setreduceregendelayonkill()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C4B( "medium_transport", 2000 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C1F( "medium_transport" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C57( "medium_transport", 13 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C50( "medium_transport", ::med_transport_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C5A( "med_transport_mp", 3 );
}
...
med_transport_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12C1A( var_2, "medium_transport", var_0 );
