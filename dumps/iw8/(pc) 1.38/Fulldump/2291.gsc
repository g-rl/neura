...
bot_loadout_choose_fallback_primary( var_0 )
{
    ...
    if ( isusingmatchrulesdata() )
    {
        ...
        {
            if ( scripts\mp\utility\game::getmatchrulesdatawithteamandindex( "defaultClasses", change_goal_radius_weapons_free_internal(), var_13, "class", "inUse" ) )
            {
                var_1 = change_goal_radius_weapons_free( var_13, "loadoutPrimary" );
...
change_goal_radius_weapons_free_internal()
{
...
carriable_fuse_ui()
{
    ...
    if ( isusingmatchrulesdata() )
    {
        ...
        {
            if ( scripts\mp\utility\game::getmatchrulesdatawithteamandindex( "defaultClasses", change_goal_radius_weapons_free_internal(), var_1, "class", "inUse" ) )
                var_0[var_1] = var_1;
        }
    }
    ...
    foreach ( var_5 in level.bot_loadout_fields )
    {
        ...
        var_3[var_5] = change_goal_radius_weapons_free( var_2, var_5 );
    }
...
bot_validate_weapon( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_8 = scripts\mp\utility\weapon::loot_boxes( var_0 );

    for ( var_9 = 0; var_9 < var_7.size; var_9++ )
    {
        if ( !bot_loadout_item_allowed( "attachment", var_7[var_9], undefined ) )
            return 0;

        if ( !scripts\engine\utility::array_contains( var_8, var_7[var_9] ) )
            return 0;
        ...
        {
            if ( var_7[var_9] == var_7[var_11] )
            {
                var_10++;

                if ( var_10 == 1 )
                {
                    if ( !isdefined( level.allowable_double_attachments[var_7[var_9]] ) )
                        return 0;
                }
                else if ( var_10 > 1 )
                    return 0;
            }
            else if ( isdefined( level.bot_invalid_attachment_combos[var_7[var_9]] ) )
            {
                if ( isdefined( level.bot_invalid_attachment_combos[var_7[var_9]][var_7[var_11]] ) )
                    return 0;
            }
        }
    }
...
init_bot_weap_statstable()
{
    ...
    for (;;)
    {
        ...
        {
            if ( !scripts\mp\weapons::rear_spotlight_turret_info( var_2 ) )
            {
                var_0++;
                continue;
            }
...
change_goal_radius_weapons_free( var_0, var_1 )
{
    var_2 = change_goal_radius_weapons_free_internal();
            ...
            for (;;)
            {
                ...
                if ( var_13 == var_12 )
                {
                    if ( tablelookupbyrow( var_10, var_1, var_11 ) != "no" )
                        level.allowable_double_attachments[var_13] = 1;

                    continue;
                }

                if ( tablelookupbyrow( var_10, var_1, var_11 ) == "no" )
                    level.bot_invalid_attachment_combos[var_12][var_13] = 1;
            }
        }
    }
}
...
bot_loadout_valid_choice( var_0, var_1, var_2, var_3 )
{
    ...
    switch ( var_2 )
    {
        ...
        case "loadoutPrimaryBuff":
            break;
        case "loadoutPrimaryCamo":
            var_4 = !isdefined( self.check_missiles_reloaded_vo ) || var_3 == self.check_missiles_reloaded_vo;
            break;
        case "loadoutSecondary":
        ...
        case "loadoutSecondaryBuff":
            break;
        case "loadoutSecondaryCamo":
            var_4 = !isdefined( self.check_player_used_tacmap ) || var_3 == self.check_player_used_tacmap;
            break;
        case "loadoutStreak3":
        case "loadoutStreak2":
        case "loadoutStreak1":
...
bot_loadout_choose_from_set( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( !isdefined( self.get_player_cumulative_damage ) )
            self.get_player_cumulative_damage = scripts\engine\utility::random( [ "class1", "class2", "class3", "class4", "class5" ] );

        var_0 = [ self.get_player_cumulative_damage ];
    }
...
bot_loadout_class_callback( var_0 )
{
    ...
    if ( !isdefined( self.change_apc_label ) )
        self.carriable_can_pickup = 0;

    self.change_apc_label = self.carriable_can_pickup;
    ...
    var_8 = !var_7 && cargo_truck_mg_creategunnerturret();
    ...
    self.chase_hvt_vo = undefined;

    if ( !var_7 )
    {
        var_12 = castrewardvalue();
        var_13 = undefined;
    ...
    if ( var_17 )
    {
        ...
        if ( change_keypad_display_digit( var_1 ) )
            var_17 = 0;
    }

    if ( !var_17 )
    {
        var_1 = carriable_fuse_ui();
    ...
    {
        if ( isdefined( var_1["loadoutPrimaryCamo"] ) && var_1["loadoutPrimaryCamo"] != "none" && !isdefined( self.check_missiles_reloaded_vo ) )
            self.check_missiles_reloaded_vo = var_1["loadoutPrimaryCamo"];

        if ( isdefined( var_1["loadoutSecondaryCamo"] ) && var_1["loadoutSecondaryCamo"] != "none" && !isdefined( self.check_player_used_tacmap ) )
            self.check_player_used_tacmap = var_1["loadoutSecondaryCamo"];
...
change_stealth_state_to_combat_warpper()
{
