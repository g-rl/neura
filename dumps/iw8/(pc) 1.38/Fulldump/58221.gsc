...
init()
{
    ...
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "plague_box", ::_id_12982, undefined, ::_id_1296A );
}

_id_12982( var_0, var_1 )
{
    ...
    var_4 = transitionplayersoutofac130cinematic( var_0 );
...
transitionplayersoutofac130cinematic( var_0 )
{
    var_1 = self;
    var_2 = spawnstruct();
