...
gas_createtrigger( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = kill_rate_too_slow( var_0, var_3 );

    if ( isdefined( var_5 ) )
        var_4 thread kill_off_all_escort_friendly_ai_riders( var_5, var_2 );
...
kill_rate_too_slow( var_0, var_1 )
{
...
gas_watchtriggerenter()
{
    ...
    for (;;)
    {
        ...
        if ( istrue( var_0.killstreaktoscorestreak_scoretokill ) )
            continue;
...
gas_applycough( var_0, var_1 )
{
    ...
    if ( istrue( self.killstreaktoscorestreak_scoretokill ) )
        return;
