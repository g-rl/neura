...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "airdrop", "applyImmediateJuggernaut", ::balloon_deposit_cash_vo_explanation );
}
...
airdrop_awardkillstreak( var_0, var_1, var_2 )
{
    ...
    else
    {
        ...
        var_4 = var_2.streakinfo.mpstreaksysteminfo._id_1252F;
...
balloon_deposit_cash_vo_explanation( var_0 )
{
    var_1 = "juggernaut";
    ...
    var_2._id_1252F = self.matchdatalifeindex;
    var_2.owner = self;
    var_2.target_pity_outline_think = self getxuid();
    var_2.all_end_checkpoints_activated = scripts\mp\matchdata::gettimefrommatchstart( gettime() );
    scripts\mp\analyticslog::logevent_killstreakactivated( self, var_2.streaklifeid, var_2.streakname, var_2.isgimme, var_2.all_end_checkpoints_activated, self.origin );
