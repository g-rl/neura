...
{
    if ( istrue( self.obj_hangar_bombs ) )
        return;

    self.obj_hangar_bombs = 1;
...
final_switch_think()
{
    if ( istrue( self.track_get_teleport_velocity ) )
        return;

    self.track_get_teleport_velocity = 1;
...
final_radius_think()
{
    ...
    self.track_get_teleport_velocity = undefined;
...
watchcrateimpact( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_9 ) && var_9 scripts\cp_mp\killstreaks\helper_drone::propwatchdeath() )
        ...
        if ( gettime() - var_1 >= 200 )
        {
            ...
            trophy_get_best_tag( var_6, var_7, var_8, var_11 );
        }
    }
}

trophy_get_best_tag( var_0, var_1, var_2, var_3 )
{
