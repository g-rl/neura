...
molotov_used( var_0 )
{
    ...
    if ( isdefined( level.keyboard_monitor_disable ) )
        [[ level.keyboard_monitor_disable ]]( var_0, self );

    var_5 = ( gettime() - var_2 ) / 1000;
    var_6 = var_3 + ( 0, 0, -800 * var_5 );

    if ( isdefined( var_4 ) && isplayer( var_4 ) )
        thread molotov_stuck_player( var_0, var_4, var_1, var_6 );
    else
        thread molotov_stuck( var_0, var_4, var_1, var_6 );
}
...
{
    if ( !scripts\mp\bots\bots_util::bot_bots_enabled_or_added() && !scripts\mp\utility\game::chopperexfil_sh060_start() )
        return;
...
molotov_create_pool( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( isdefined( var_4 ) && isdefined( var_4.weapon_name ) && var_4.weapon_name == "gas_can_mp" )
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_11 scriptablesetparententity( var_2, var_12, var_13 );
    }

    var_11 thread silo_door_jugg();
    return var_11;
}
...
molotov_pool_start()
{
    ...
    if ( isdefined( self ) )
        ...
        level thread signalomnvar( var_1, var_0 );
}
...
molotov_watch_pool()
{
    ...
    var_1 = randomfloatrange( 6.5, 6.75 );
    wait( var_1 );
    return var_0;
}
...
signalomnvar( var_0, var_1 )
{
    ...
    if ( !isdefined( var_0 ) )
        var_2.vehicleunlink = scripts\engine\utility::array_remove( var_2.vehicleunlink, var_1 );
}
...
molotov_watch_pool_trigger_enter()
{
    ...
    for (;;)
    {
        ...
        if ( !isplayer( var_0 ) && !istrue( var_0.binoculars_istargetinrange ) )
            continue;
...
{
    var_0 endon( "death" );
    scripts\engine\utility::_id_12E54( 7, "disconnect", "joined_team" );
    var_0 delete();
}
...
showteamlittlebirds( var_0, var_1 )
{
    ...
    if ( isdefined( var_0.shareddata ) )
    {
        if ( isdefined( var_0.shareddata.branches ) )
        {
            foreach ( var_3 in var_0.shareddata.branches )
                showteamlittlebirds( var_3, var_1 );
        }

        if ( isdefined( var_0.shareddata.stealth_alert_music ) )
        {
            foreach ( var_6 in var_0.shareddata.stealth_alert_music )
            {
                if ( isdefined( var_6 ) )
