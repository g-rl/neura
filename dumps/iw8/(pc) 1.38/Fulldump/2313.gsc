...
snapshot_grenade_watch_flight( var_0 )
{
    ...
    if ( istrue( var_1._id_12797 ) )
        var_1 thread infilvideopreload();
    ...
    if ( var_8 > 0 )
    {
        ...
        if ( isdefined( var_1.respawn_scriptible_carriable_wait ) )
        {
            var_5 = scripts\mp\vehicles\little_bird_mg_mp::postupdategameevents( var_1.respawn_scriptible_carriable_wait );

            if ( var_5 )
                var_4 linkto( var_1.respawn_scriptible_carriable_wait );
        }
        ...
        var_1 childthread scripts\mp\utility\equipment::_id_12ED2();
        var_1 scripts\engine\utility::_id_12E53( var_11, "collision_with_platform" );
    }
    else
    {
        var_4.angles = var_9;
...
snapshot_grenade_detect()
{
    ...
    var_6 = aq_targethudenabled( var_1, 540 );
...
_id_120F1( var_0, var_1, var_2 )
{
    ...
    if ( 1 )
    {
        ...
        var_2.endtimes[var_3] = gettime() + 2000;
        ...
        if ( !level.teambased )
            ...
            var_2.outlineids[var_3] = scripts\mp\utility\outline::outlineenableforsquad( var_0, var_1.team, var_1.squadindex, "snapshotgrenade", "equipment" );
        else
            var_2.outlineids[var_3] = scripts\mp\utility\outline::outlineenableforteam( var_0, var_1.team, "snapshotgrenade", "equipment" );
...
{
    var_2 = are_achievements_allowed( var_0, var_1 );
    var_3 = [];
    var_4 = var_1 * var_1;
...
are_achievements_allowed( var_0, var_1 )
{
