...
claymore_use( var_0 )
{
    ...
    if ( tv_station_infil_enemy_combat_logic() )
    {
        var_1.plantoffsetz = var_1.plantoffsetz + 2;
        var_1.contents = flagonrevive();
    }
...
{
    var_0 dodamage( 140, self.origin, self.owner, self, "MOD_EXPLOSIVE", getcompleteweaponname( "claymore_mp" ) );
...
claymore_explodeonnotify()
{
    ...
    self.getnumbersspawnpoint_late = var_1;
    thread claymore_explode( var_1 );
}
...
claymore_modifieddamage( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( isdefined( self.eggsetup ) )
        {
            foreach ( var_6 in self.eggsetup )
            {
    ...
    if ( isdefined( var_2.getnumbersspawnpoint_late ) )
    {
        var_14 = isdefined( var_2.owner ) && var_2.getnumbersspawnpoint_late == var_2.owner;
        var_15 = var_2.getnumbersspawnpoint_late == var_0;
...
earnednuke( var_0 )
{
    ...
    self.eggsetup[self.eggsetup.size] = var_0;
    waittillframeend;
    self.eggsetup = undefined;
}
