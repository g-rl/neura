...
update_personality_camper()
{
    if ( should_select_new_ambush_point() && !scripts\mp\bots\bots_util::bot_is_defending() && !scripts\mp\bots\bots_util::bot_is_remote_or_linked() )
    {
        ...
        if ( isdefined( var_1 ) && var_1 )
        {
            ...
            var_4 = scripts\mp\bots\bots_strategy::bot_get_ambush_trap_item( "trap_directional", "trap", "c4" );
            ...
            {
                var_6 = self botsetscriptgoalnode( self.node_ambushing_from, "camp", self.ambush_yaw );
...
update_personality_default()
{
    ...
    if ( !scripts\mp\bots\bots_strategy::bot_has_tactical_goal() && !scripts\mp\bots\bots_util::bot_is_remote_or_linked() )
    {
        ...
        if ( !var_1 || var_2 < var_3 * var_3 )
        {
            ...
            {
                var_10 = scripts\mp\bots\bots_strategy::bot_get_ambush_trap_item( "trap_directional", "trap" );
...
clear_script_goal_on( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    while ( var_6 )
    {
        var_7 = scripts\engine\utility::_id_12E4B( var_0, var_1, var_2, var_3, var_4, "script_goal_changed" );
        var_6 = 0;
        var_8 = 1;
