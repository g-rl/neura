...
scriptable_door_scriptable_used_callback( var_0, var_1, var_2, var_3 )
{
    if ( var_1 == "door" )
    {
        ...
        {
            var_4 = getentitylessscriptablearrayinradius( var_0.target, "targetname" );

            foreach ( var_6 in var_4 )
            {
                if ( var_6 getscriptablehaspart( "door" ) )
                    var_6 thread scriptable_door_hinge_progression( var_3, "use" );
            }
        }
    }
}
...
scriptable_door_postinit()
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        var_2.closedcenter = var_4;
        var_2.closedangles = var_2.angles;
    }
}
...
system_init()
{
    ...
    scripts\engine\scriptable::scriptable_addusedcallback( ::scriptable_door_scriptable_used_callback );
