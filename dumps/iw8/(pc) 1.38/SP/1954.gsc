...
dof_default( var_0, var_1 )
{
    ...
    var_6 = 500;
    var_7 = 0.05;
    dof_set_generic( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, 1.0 );
}
...
dof_process_ads()
{
    ...
    var_14 = scripts\engine\trace::_bullet_trace( var_10, var_10 + var_13 * var_1, 1, self, 1, 0, 0, 0, 0 );
    ...
    {
        [[ level.special_weapon_dof_funcs[var_17] ]]( var_14, var_15, var_10, var_13, var_0 );
        return;
    }
    ...
    foreach ( var_21 in var_15 )
    {
        ...
        var_23 = var_21 hasenemybeenseen( var_3 );

        if ( !var_22 && !var_23 )
            continue;

        var_24 = vectornormalize( var_21.origin - var_10 );
        var_25 = vectordot( var_13, var_24 );

        if ( var_25 < 0.923 )
            continue;

        var_26 = distance( var_10, var_21.origin );

        if ( var_26 - 30 < var_18 )
            var_18 = var_26 - 30;

        var_27 = min( var_26, var_2 );
    ...
    var_29 = var_18 * var_4;
    var_30 = var_19 * var_7;
    dof_enable_ads( var_29, var_18, var_8, var_19, var_30, var_9, var_0 );
}

setdoftracerange( var_0 )
{
    if ( !isdefined( var_0 ) )
        var_0 = 4096;
...
dof_process_physical_ads( var_0 )
{
    ...
    if ( var_4 > 0 )
    {
        ...
        {
            case "mount_left":
                var_5 = var_5 + anglestoright( var_6 ) * -3;
                break;
            case "mount_right":
                var_5 = var_5 + anglestoright( var_6 ) * 3;
                break;
            case "mount_top":
                var_5 = var_5 + anglestoup( var_6 ) * 3;
                break;
        }
    }
    ...
    var_9 = scripts\engine\trace::_bullet_trace( var_5, var_5 + var_8 * var_1, 1, self, 0, 1, 0, 0, 0 );
    var_10 = getaiarray( "axis" );
    var_11 = self getcurrentweapon();
    var_12["start"] = distance( var_5, var_9["position"] );
    var_12["end"] = var_12["start"];

    foreach ( var_14 in var_10 )
    {
        var_15 = var_14 isenemyaware();
        var_16 = var_14 hasenemybeenseen( var_3 );

        if ( !var_15 && !var_16 )
            continue;

        var_17 = vectornormalize( var_14.origin - var_5 );
        var_18 = vectordot( var_8, var_17 );

        if ( var_18 < 0.923 )
            continue;

        var_19 = distance( var_5, var_14.origin );

        if ( var_19 < var_12["start"] )
            var_12["start"] = var_19;

        var_20 = min( var_19, var_2 );

        if ( var_20 > var_12["end"] )
            var_12["end"] = var_20;
    }
