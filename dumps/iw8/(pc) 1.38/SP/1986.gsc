...
evasive_startmaneuvers( var_0, var_1 )
{
    ...
    for ( var_3 = 1; var_3 < var_1.size; var_3++ )
    {
        ...
        if ( getdvar( "cobrapilot_debug" ) == "1" )
            thread scripts\engine\sp\utility::draw_line_until_notify( var_1[var_3]["pos"], var_1[var_3]["pos"] + anglestoforward( ( 0, var_5, 0 ) ) * 250, 1.0, 1.0, 0.2, var_0, "evasive_action_done" );
...
evasive_drawpoints( var_0 )
{
    for ( var_1 = 1; var_1 < var_0.size; var_1++ )
        thread scripts\engine\sp\utility::draw_line_until_notify( var_0[var_1 - 1]["pos"], var_0[var_1]["pos"], 1.0, 0.2, 0.2, self, "evasive_action_done" );
}
