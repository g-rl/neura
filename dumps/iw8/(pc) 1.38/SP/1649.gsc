...
wasdamagedbyexplosive()
{
    if ( isdefined( self.damagemod ) )
    {
        ...
        if ( isdefined( self.damageweapon ) && self.damageweapon.basename == "molotov" )
            return 1;
...
allow_supers( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( isdefined( level.setsuperweapondisabled ) )
            self [[ level.setsuperweapondisabled ]]( var_0 );
    }
}
...
playersincylinder( var_0, var_1 )
{
    var_2 = physics_createcontents( [ "physicscontents_player" ] );
    var_3 = ( var_1, var_1, 1000 );
    var_4 = var_0 - var_3;
    var_5 = var_0 + var_3;
    var_6 = physics_aabbbroadphasequery( var_4, var_5, var_2, [] );
    var_7 = [];
    ...
    {
        var_12 = distance2dsquared( var_10.origin, var_0 );
