...
tac_cover_init()
{
    ...
    level._id_125F0 = getentarray( "dcover_blocker", "targetname" );
    level._id_125EF = getdvarfloat( "scr_tacCover_timeoutOverride", 150.0 );
}
...
tac_cover_on_fired( var_0, var_1, var_2, var_3 )
{
    ...
    var_8 = scripts\mp\trials\trial_utility::_id_11CE5( var_7, 140, 20 );
    var_9 = undefined;
    var_10 = 0;
    ...
    if ( scripts\cp_mp\auto_ascender::race_calculate_stars( var_7 ) )
        return 0;

    if ( scripts\cp\equipment\cp_adrenaline::race_dogtag_init( var_7 ) )
        return 0;

    var_4 = scripts\engine\trace::first_bleedout();
    ...
    if ( isdefined( var_9 ) )
    {
        ...
        {
            if ( var_9 scripts\mp\trials\trial_utility::_id_11CE6( var_26 ) )
            {
                var_24 = var_26;
                break;
            }
        ...
        {
            var_30 = _id_125E6( var_9 );

            if ( isdefined( var_24 ) )
                var_30 = var_30 | _id_125E6( var_24 );
            ...
            var_32 = var_9.enemy_respawn_manager + ( 0, 0, 24 );
            ...
            var_9.processscrapassist = 1;
            self.taccoverrefund = undefined;
            thread _id_125E8( var_9, var_24, var_3, var_4 );
    ...
    if ( isdefined( var_45 ) && !_id_125E3( var_45 ) )
    {
        tac_cover_fire_failed();
        return 0;
    }
...
_id_125E4( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        if ( scripts\mp\vehicles\little_bird_mg_mp::pressure_overload_threshold( var_0 ) || scripts\mp\vehicles\little_bird_mg_mp::prepare_mission_failed_text( var_0 ) || scripts\mp\gametypes\br_gondola.gsc::postgamehitmarkerwaittime( var_0 ) || scripts\mp\gametypes\br_soa_tower.gsc::position_ref( var_0 ) )
            return var_0;
    }
...
tac_cover_adjust_for_player_space( var_0, var_1, var_2 )
{
    ...
    foreach ( var_9 in level._id_125F0 )
    {
...
_id_125E8( var_0, var_1, var_2, var_3 )
{
    ...
    var_0 scripts\mp\trials\trial_utility::handlesoloexclusionils( 1, "tac_cover_door" );

    if ( isdefined( var_1 ) )
        var_1 scripts\mp\trials\trial_utility::handlesoloexclusionils( 1, "tac_cover_door" );
...
tac_cover_spawn( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_8.deathoverridecallback = ::_id_125E7;
...
tac_cover_destroy( var_0, var_1, var_2 )
{
    ...
    self.owner scripts\cp\helicopter\chopper_boss::stoppingpower_onweaponcreated( "super_tac_cover", int( var_4 ), var_0, var_2 );
...
tac_cover_destroy_internal( var_0 )
{
    ...
    {
        self.called90percentprogress scripts\mp\trials\trial_utility::handlesoloexclusionils( 0, "tac_cover_door" );
    ...
    {
        self.calloutmarkerping_canplayerping scripts\mp\trials\trial_utility::handlesoloexclusionils( 0, "tac_cover_door" );
...
{
    var_1 = _id_125E0( var_0 );

    if ( isdefined( self.owner ) )
    {
        var_2 = max( self.maxhealth - self.damagetaken, 0 );
        var_3 = int( min( var_2, var_1 ) );
        self.owner scripts\mp\supers::eventcallback( "super_tac_cover", var_3 );
    }
...
_id_125E0( var_0 )
{
    ...
    if ( scripts\mp\damage::randomize_stealth_alert_music_array( var_0.objweapon ) )
        return 0;
