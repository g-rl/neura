...
init_spawn_factors()
{
    ...
    registerfactor( "avoidCloseToDefenderFlag", ::brexfilanimname, 1, [ "activeCarrierPosition", "defenderFlagPosition", "avoidDefenderFlagDeadZoneDistSq" ] );
    registerfactor( "avoidCloseToDefenderFlagSpawn", ::brgametype, 1, [ "avoidDefenderFlagDeadZoneDistSq" ] );
    initfrontline();
}
...
brgametype( var_0, var_1 )
{
    var_2 = var_0.scriptdata.goliath_init;
