...
init()
{
    ...
    registerbcsoundtype( "ges_mtx_t9_yawn", "mtx_gst_emote_tired", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_devil_horns", "mtx_gst_emote_cheer", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_taunt_death_grip", "mtx_gst_taunt_wave_crush_you", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_blow_kiss", "mtx_gst_emote_kiss", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_finger_frame", "mtx_gst_social_clip_it", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_heart", "mtx_gst_emote_happy_sigh", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_taunt_slit_throat", "mtx_gst_taunt_point_ill_make_quick", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_taunt_all", "mtx_gst_taunt_all", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_tiny_violin", "mtx_gst_emote_cry", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_taunt_watching_you", "mtx_gst_taunt_point_lets_go", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_finger_guns", "mtx_gst_social_pew", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_taunt_watching_you", "mtx_gst_taunt_point_lets_go", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_cigar", "mtx_execute_fire_flamethrower", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_taunt_crank_finger", "mtx_gst_taunt_point_think_take_me", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_scheming_hands", "mtx_gst_emote_approval", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_scorpion_shot", "mtx_gst_emote_drink", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_taunt_red_card", "mtx_gst_taunt_point_done", 1.0, 1.0, 3, 5, 0 );
    registerbcsoundtype( "ges_mtx_t9_sparkler", "mtx_gst_emote_cheer", 1.0, 1.0, 3, 5, 0 );

    if ( !scripts\mp\utility\game::propwaitminigamehudinit() )
    {
    ...
    level.reachhistorydestination = 0;

    if ( var_3 == "sd" || var_3 == "cyber" || var_3 == "arena" )
        level.reachhistorydestination = 1;
...
onplayerspawned()
{
    ...
    if ( !level.teambased || level.reachhistorydestination || istrue( level.disablebattlechatter ) || scripts\mp\utility\game::isanymlgmatch() )
        self.bcdisabled = 1;
    else
    {
        if ( !scripts\mp\utility\game::runleanthreadmode() || istrue( level.chopper_boss_loc ) )
        {
...
dosound( var_0, var_1 )
{
    ...
    {
        if ( isdefined( self.operatorcustomization.init_placed_equipment ) && self.operatorcustomization.init_placed_equipment != "" )
            var_2 = self.operatorcustomization.init_placed_equipment;
        else
        {
    ...
    var_4 = "dx_mpb_" + self.operatorcustomization.voice + "_" + var_2;

    if ( getsubstr( var_2, var_2.size - 2, var_2.size ) == "_o" )
        var_2 = getsubstr( var_2, 0, var_2.size - 2 );

    var_5 = "dx_mpp_" + self.operatorcustomization.voice + "_" + var_2;
    ...
    if ( !scripts\mp\utility\game::lpcfeaturegated() )
        triggerrespawnoverlay( var_6, var_7, var_0, var_5, var_4 );
    else if ( self issplitscreenplayer() )
        triggersafearea( var_6, var_7, var_0, var_5, var_4 );
    else
        triggerremoveobjectivetext( var_6, var_7, var_0, var_5, var_4 );

    if ( isdefined( level.bcinfo["additional_local_vo"][var_0] ) && isdefined( self.squadindex ) )
    {
        var_10 = "dx_mpb_" + self.operatorcustomization.voice + "_" + level.bcinfo["additional_local_vo"][var_0];

        if ( soundexists( var_10 ) )
        {
            var_11 = level.bcinfo["additional_local_vo"][var_0];
            var_12 = level.squaddata[self.team][self.squadindex].players;

            if ( !scripts\mp\utility\game::lpcfeaturegated() )
                triggerrespawnoverlay( 1, 1, var_11, undefined, var_10, var_12 );
            else if ( self issplitscreenplayer() )
                triggersafearea( 1, 1, var_11, undefined, var_10, var_12 );
            else
                triggerremoveobjectivetext( 1, 1, var_11, undefined, var_10, var_12 );
        }
    }
    ...
    var_13 = level.bcinfo["priority"][var_0];
    var_14 = self.team;
    level addspeaker( self, var_14, var_4, var_0, var_13 );
    updatechatter( var_0 );
    var_15 = max( var_8, var_9 ) / 1000;
    thread timehack( var_4, var_15 );
    scripts\engine\utility::_id_12E3F( var_4, "death_or_disconnect" );
    level removespeaker( self, var_14 );
    return 1;
}

triggerremoveobjectivetext( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_5 ) )
        var_5 = [];
...
triggerrespawnoverlay( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_5 ) )
        var_5 = [];
...
triggersafearea( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = self getothersplitscreenplayer();
...
location_add_last_callout_time( var_0, var_1 )
{
    ...
    if ( !isdefined( level.residuallight ) )
        level.residuallight = [];

    level.residuallight[var_1] = var_2;
}
...
left_control( var_0 )
{
    if ( isdefined( level.residuallight ) && isdefined( level.residuallight[var_0] ) )
        return level.residuallight[var_0];
...
trysaylocalsound( var_0, var_1, var_2, var_3 )
{
    ...
    if ( istrue( var_0.bcdisabled ) && var_1 != "flavor_execution" )
        return;
    ...
    if ( level.bcinfo["req_friendly"][var_1] && !var_0 friendly_nearby( 4840000 ) && !istrue( level.chopper_boss_loc ) )
        return;
    ...
    if ( gettime() > var_0.brtdm_config + level.bcinfo["max_wait_time"] + var_3 * 1000 )
    {
        var_0.bcinfoqueued = "none";
        var_0.brtdm_config = 0;
    }

    if ( comparesoundpriorities( var_1, var_0.bcinfoqueued ) )
    {
        var_0.bcinfoqueued = var_1;
        var_0.brtdm_config = gettime();
    }
    else
        return;
...
getbcwaittime( var_0, var_1 )
{
    ...
    if ( isdefined( level.bcinfo["last_say_time"] ) && isdefined( level.bcinfo["last_say_time"][var_0] ) )
    {
        ...
        else if ( isdefined( level.bcinfo["last_say_pos"][var_0][self.operatorcustomization.voice] ) )
        {
            var_2 = level.bcinfo["last_say_time"][var_0][self.operatorcustomization.voice] + level.bcinfo["timeout"][var_0];
            var_3 = distancesquared( level.bcinfo["last_say_pos"][var_0][self.operatorcustomization.voice], self.origin ) < 1048576;
        }
    }
    ...
    var_13 = self.bcinfolastsaytimes[var_0] + level.bcinfo["timeout_player"][var_0];
