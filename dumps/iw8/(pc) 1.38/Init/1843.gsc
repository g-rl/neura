...
_id_12B00( var_0, var_1, var_2 )
{
    ...
    scripts\mp\gametypes\br_challenges.gsc::dialog_wait_ready( "br_mastery_travelogue", var_3 );
    scripts\mp\gametypes\br_challenges.gsc::dialog_wait_ready( "br_mastery_c4VehicleMultKill", var_3 );
    scripts\mp\gametypes\br_challenges.gsc::dialog_wait_ready( "br_mastery_ghostRideWhip", var_3 );
}
...
revivedplayer( var_0, var_1 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        scripts\mp\gametypes\br_analytics.gsc::branalytics_revive( var_0, var_1 );
...
disablepersupdates( var_0 )
{
    ...
    if ( level.gameended )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_2 = spawnstruct();
            var_2.player = self;
            scripts\mp\gametypes\br_challenges.gsc::dialog_wait_ready( "br_mastery_roundKillExecute", var_2 );
        }
    }
