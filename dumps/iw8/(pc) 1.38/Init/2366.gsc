...
tryuseremoteuav( var_0, var_1 )
{
    ...
    if ( var_3 )
    {
        scripts\common\utility::_id_12965( level.set_ui_omnvar_for_relics, var_1, self.origin );
...
createcarryremoteuav( var_0, var_1 )
{
    ...
    {
        var_4 = scripts\cp_mp\utility\killstreak_utility::mark_danger_timeout();
...
setcarryingremoteuav( var_0 )
{
    ...
    for (;;)
    {
        var_1 = screenent_d( "place_carryRemoteUAV", "cancel_carryRemoteUAV", "weapon_switch_started", "force_cancel_placement", "death_or_disconnect" );
...
screenent_d( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
carryremoteuav_handleexistence()
{
    ...
    self.owner scripts\engine\utility::_id_12E40( "death_or_disconnect", "joined_team", "joined_spectators" );
...
{
    level endon( "game_ended" );
    var_1 = scripts\engine\utility::_id_12E47( "death_or_disconnect", "remoteuav_unlock" );
...
remoteuav_track( var_0 )
{
    ...
    for (;;)
    {
        ...
        {
            var_9 = [];
            var_10 = scripts\mp\utility\teams::getenemyteams( self.team );

            foreach ( var_12 in level.teamnamelist )
            {
                foreach ( var_14 in level.uavmodels[var_12] )
        ...
        if ( isdefined( var_17 ) )
        {
            if ( !isdefined( self.lockedtarget ) || isdefined( self.lockedtarget ) && self.lockedtarget != var_17 )
            {
                self weaponlockfinalize( var_17 );
                self.lockedtarget = var_17;
...
{
    level endon( "game_ended" );
    var_1 = scripts\engine\utility::_id_12E48( "death_or_disconnect", "carried", "leaving" );
...
remoteuav_watch_distance()
{
    ...
    {
        var_0 = scripts\cp_mp\utility\killstreak_utility::mark_danger_timeout();
...
{
    self endon( "death" );
    self.owner scripts\engine\utility::_id_12E3F( "joined_team", "joined_spectators" );
    self notify( "death" );
}
