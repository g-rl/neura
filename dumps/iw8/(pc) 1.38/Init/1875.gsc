...
matchrecording_loggameendstats()
{
    ...
    {
        if ( isdefined( var_6._id_12072 ) )
            var_0 = var_6._id_12072;

        if ( isdefined( var_6.incrementalrespawnpunish ) )
            var_3 = var_6.incrementalrespawnpunish;

        if ( isdefined( var_6.incrementalrespawnpunishmax ) )
            var_4 = var_6.incrementalrespawnpunishmax;
    }
...
matchrecording_usereventthink()
{
    ...
    for (;;)
    {
        ...
        var_0 = scripts\engine\utility::_id_12E4E( "log_user_event_end", "log_user_event_generic_event" );
