...
atv_initomnvars( var_0 )
{
    if ( !isdefined( self._blackboard.atvoriginsarray ) )
    {
        self._blackboard.atvoriginsarray = 1;
        self._blackboard.atvanglesarray = var_0;
        return 1;
    }
...
atv_initdamage()
{
    if ( isdefined( self._blackboard.atvoriginsarray ) && self._blackboard.atvoriginsarray == 1 )
        self._blackboard.atvoriginsarray = 2;
}
...
atv_horn()
{
    if ( isdefined( self._blackboard.atvoriginsarray ) )
    {
        if ( self._blackboard.atvoriginsarray == 1 )
        {
            self._blackboard.atvoriginsarray = undefined;
            self._blackboard.atvanglesarray = undefined;
            return 1;
        }
        else if ( self._blackboard.atvoriginsarray == 2 )
        {
            self._blackboard.atvoriginsarray = 3;
            return 1;
        }
    }
...
atv_initcollision()
{
    if ( isdefined( self._blackboard.atvoriginsarray ) && self._blackboard.atvoriginsarray == 3 )
    {
        self._blackboard.atvoriginsarray = undefined;
        self._blackboard.atvanglesarray = undefined;
    }
...
assaultkill( var_0, var_1 )
{
    if ( !isdefined( var_0 ) || !isalive( var_0 ) )
        return;

    var_2 = var_0 atv_initomnvars( var_1 );
...
arenapickupattachments( var_0 )
{
    if ( !isdefined( var_0 ) || !isalive( var_0 ) )
        return;

    var_1 = var_0 atv_horn();
