...
atv_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12C7B( "atv", "single", [ "driver", "rear" ] );
}

br_should_continue_adding_armor()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_12D33( "atv", 1 );
    var_0.id = 4;
...
br_selectdropbagclass()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C4B( "atv", 500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "atv" );
    var_0.class = "super_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C1F( "atv" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C57( "atv", 4 );

    if ( level.gametype == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::_id_12C58( "atv", 6, "semtex_aalpha12_mp" );

    scripts\cp_mp\vehicles\vehicle_damage::_id_12C50( "atv", ::atv_deathcallback );
}

br_remove_player_commands()
{
    var_0 = _accessreaderscriptableused::_id_12BF1( "atv", 1 );
    ...
    var_1.get_random_station_names_on_track["atv"] = [];
    var_1.get_random_station_names_on_track["atv"]["cargo_truck"] = 2;
}
...
atv_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12C1A( var_2, "atv", var_0 );
