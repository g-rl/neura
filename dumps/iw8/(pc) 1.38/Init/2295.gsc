...
bot_choose_difficulty_for_default()
{
    ...
    if ( !isdefined( level.changesleft ) )
        level.changesleft = [];

    if ( !isdefined( level.changesleft["allies"] ) )
        level.changesleft["allies"] = 0;

    if ( !isdefined( level.changesleft["axis"] ) )
        level.changesleft["axis"] = 0;

    if ( !isdefined( level.changesleft["all"] ) )
        level.changesleft["all"] = 0;
    ...
    if ( !isdefined( self.pers["bot_chosen_difficulty"] ) )
    {
        ...
        var_0 = level.changesleft[var_1];
        var_2 = level.bot_difficulty_defaults[var_0];
        self.pers["bot_chosen_difficulty"] = lategame_buytimer_set( var_2 );
        level.changesleft[var_1] = ( level.changesleft[var_1] + 1 ) % level.bot_difficulty_defaults.size;
    }
...
bot_usebutton_wait( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\engine\utility::_id_12E56( var_0, var_1, var_2, "use_button_no_longer_pressed", "finished_use" );
...
bot_allowed_to_use_killstreaks()
{
    ...
    if ( istrue( self.check_maze_ai_state ) )
        return 0;
...
challengesdisabled( var_0, var_1 )
{
    switch ( var_0 )
    {
...
watch_nodes_aborted()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_12E53( 0.5, "still_watching_nodes" );
...
juggernaut_getavoidanceposition( var_0 )
{
...
check_if_frozen( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = level.getrandompointincirclewithindistance;
...
check_crate_unreachable( var_0, var_1, var_2 )
{
    if ( !isdefined( var_2 ) )
        var_2 = level.getrandompointincirclewithindistance;
