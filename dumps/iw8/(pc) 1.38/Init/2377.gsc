        ...
        if ( !self.perkpackagedata.isusing && scripts\mp\supers::issuperready() )
        {
            if ( self.perkpackagedata.istwomode )
            {
                ...
                if ( 1 )
                {
                    ...
                    if ( isdefined( level.toppercentagetoadjusteconomy ) )
                        [[ level.toppercentagetoadjusteconomy ]]();
                }
            }
...
perkpackage_getfirstfieldupgrade()
{
    ...
    if ( isdefined( self.tank_damage_hit_markers ) )
        var_0 = self.tank_damage_hit_markers;
...
perkpackagemenu_menuthink()
{
    ...
    wait 0.3;
    var_0 = scripts\engine\utility::_id_12E49( "perkPackageMenu_option1", "perkPackageMenu_option2", "perkPackageMenu_close", "death" );
    var_1 = 0;
...
topteam( var_0, var_1 )
{
    ...
    self.tank_damage_hit_markers = var_0;
    self.tank_death = var_1;
    perkpackage_updateifchanged();
}

topteamsever()
{
    self.tank_damage_hit_markers = undefined;
