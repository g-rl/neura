...
addtoteamlives( var_0, var_1, var_2 )
{
    ...
    _id_12BBA( "add", var_1, var_0 );

    if ( isdefined( level.should_wait_before_spawn_chopper_boss ) )
        [[ level.should_wait_before_spawn_chopper_boss ]]( var_0, var_1 );
...
removefromteamlives( var_0, var_1, var_2 )
{
    level.teamdata[var_1]["aliveCount"]--;
    level.teamdata[var_1]["alivePlayers"] = scripts\engine\utility::array_remove( level.teamdata[var_1]["alivePlayers"], var_0 );
    _id_12BBA( "remove", var_1, var_0 );

    if ( isdefined( level.shouldspawndropscommon ) )
        [[ level.shouldspawndropscommon ]]( var_0, var_1 );
    ...
    if ( istrue( var_2 ) && isgameplayteam( var_1 ) && !scripts\cp_mp\utility\game_utility::isrealismenabled() )
    {
        ...
        var_5 = scripts\mp\gametypes\br_public.gsc::minshotstostage3acc( var_1, var_0.squadindex );
...
_id_12BBA( var_0, var_1, var_2 )
{
    ...
    if ( var_0 == "disconnect" )
    {
        ...
        if ( var_4 && var_3 )
            var_2 scripts\mp\playerlogic::removefromalivecount( 1 );
    }
    else if ( var_0 == "add" )
    {
    ...
    if ( var_7 != var_8 || var_4 || var_5 )
    {
        ...
        scripts\mp\utility\script::getdropbagspawntypeenum( var_9 );
...
getenemyteams( var_0 )
{
    ...
    if ( isdefined( level._id_130BD ) || scripts\mp\utility\game::chopperexfil_sh060_start() )
