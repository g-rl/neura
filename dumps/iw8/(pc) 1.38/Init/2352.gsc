...
tryusehoverjetfromstruct( var_0 )
{
    ...
    var_4 = aggro_player_weight( var_0 );
    var_4 = istrue( var_4 );
    level.incomingallhoverjets--;
...
aggro_player_weight( var_0 )
{
    ...
    scripts\common\utility::_id_12965( level.set_ui_omnvar_for_relics, "hover_jet", self.origin );
...
starthoverjetairstrikepass( var_0, var_1, var_2 )
{
    ...
    var_19 thread perkpackage_checkifready_callback();
...
hoverjet_getbestgroundtarget()
{
    ...
    {
        if ( !scripts\cp_mp\killstreaks\chopper_support::dropbrequipment( var_5.player ) )
            continue;
