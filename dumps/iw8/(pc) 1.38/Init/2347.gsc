...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "gunship", "getBombingPoint", ::nag_player_remind_lore_vo );
...
nag_player_remind_lore_vo( var_0, var_1 )
{
    var_2 = scripts\cp_mp\killstreaks\toma_strike::_id_12776( var_0, var_1 );
    return var_2.point;
}
