...
watchforbasicplayerevents()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_12E51( "adjustedStance", "jumped", "weapon_fired", "reload_start", "spawned_player" );
...
scripted_laser_func( var_0, var_1 )
{
...
scriptablescleanupbatchsize( var_0, var_1, var_2, var_3 )
{
