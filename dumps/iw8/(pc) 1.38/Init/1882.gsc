...
default_on_damage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( isdefined( level.apply_common_combat_settings ) )
        var_13 [[ level.apply_common_combat_settings ]]( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, 0.0, var_10, var_11 );
...
{
    var_10 = attackfactormod( var_3, var_0 );
    ...
    if ( isdefined( self._blackboard.currentvehicle ) )
    {
        ...
        else
        {
            ...
            if ( isdefined( self._blackboard.vehicledeathwait ) )
                ...
                self.body thread watchwindowplayerexit( self._blackboard.currentvehicle );
        }
    }
