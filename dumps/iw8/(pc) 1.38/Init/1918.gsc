...
updaterevivetriggerspawnposition()
{
    ...
    if ( !istrue( scripts\mp\flags::gameflag( "prematch_done" ) ) )
    {
        ...
        {
            level scripts\engine\utility::_id_12E40( "prematch_done", "start_mode_setup", "infil_started" );
            var_0 = int( max( level.prematchperiodend - 5, 5 ) );
            wait( var_0 );
        }
        else
            level scripts\engine\utility::_id_12E40( "prematch_done", "start_mode_setup", "match_start_real_countdown" );
    }
...
lifelimitedallyonuse( var_0 )
{
    ...
    if ( isdefined( self.victim ) )
    {
        ...
        scripts\cp\helicopter\chopper_boss::onplayerteamrevive( var_0, self.victim );
    }
...
revivetriggerholdonusebegin( var_0, var_1 )
{
    ...
    var_2 scripts\mp\playerlogic::_id_11E85( 1 );
    ...
    var_2 scripts\mp\utility\player::wait_spawn_final_juggernaut( "teamrevive::reviveTriggerHoldOnUseBegin() Killcam SKIPPED" );
...
revivetriggerholdonuseend( var_0, var_1, var_2, var_3 )
{
    if ( isdefined( self.trigger.owner ) )
    {
        ...
        var_4 scripts\mp\playerlogic::_id_11E85( 0 );
