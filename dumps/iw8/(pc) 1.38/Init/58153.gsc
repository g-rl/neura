...
init()
{
    scripts\engine\scriptable::_id_11CDB( "military_ammo_restock", ::blockade_gate_explode_sequence );
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        if ( !istrue( level.useammorestocklocs ) || isdefined( scripts\cp_mp\utility\game_utility::getlocaleid() ) && isdefined( var_2.script_noteworthy ) && var_2.script_noteworthy != level.localeid )
        {
        ...
        var_2.timeplayerused = [];
        level.ammorestocklocs[level.ammorestocklocs.size] = var_2;
    }

    if ( isdefined( level.localeid ) && level.localeid == "locale_6" )
        blockade_barrier_clip();
}

blockade_gate_explode_sequence( var_0, var_1, var_2, var_3, var_4 )
{
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        if ( checkifplayerrewardsareenabled( var_3 ) )
        {
            if ( scripts\mp\flags::gameflag( "prematch_done" ) && ( getdvar( "scr_br_gametype", "" ) != "dmz" && getdvar( "scr_br_gametype", "" ) != "risk" && getdvar( "scr_br_gametype", "" ) != "rumble" ) )
                var_0 disablescriptableplayeruse( var_3 );
            else
                thread blockade_gate( var_0, var_3, 5 );
        }
        else
            thread blockade_gate( var_0, var_3, 0.1 );
    }
...
blockade_gate( var_0, var_1, var_2 )
{
...
ammorestock_playeruse( var_0, var_1 )
{
    ...
    foreach ( var_9 in var_2 )
    {
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_0 scripts\mp\gametypes\br_weapons.gsc::checkpoint_player_spawns_func( var_9, 2 );
            continue;
        }

        var_21 = scripts\mp\weapons::getammooverride( var_9 );

        if ( scripts\mp\utility\weapon::printcodechosen( var_9 ) )
        {
...
checkifplayerrewardsareenabled( var_0 )
{
    ...
    foreach ( var_8 in var_3 )
    {
        ...
        else if ( scripts\mp\utility\weapon::qm_intro_dialogue( var_8 ) )
        {
        ...
        if ( var_12 )
        {
            ...
            var_0 scripts\mp\gametypes\br_weapons.gsc::checkpoint_player_spawns_func( var_8, 2 );
            var_1 = 1;
        }
    }
