...
throwing_knife_used( var_0 )
{
    ...
    var_4 = isdefined( var_2 ) && var_2 == "j_riotshield_offset";
    var_5 = isdefined( var_2 ) && var_2 == "tag_weapon";
    var_6 = isdefined( var_1 ) && ( isplayer( var_1 ) || isagent( var_1 ) );
    var_7 = var_0.weapon_name == "throwingknife_fire_mp";
    var_8 = var_0.weapon_name == "throwingknife_electric_mp";
    var_9 = var_0.weapon_name == "throwingknife_drill_mp";
    ...
    if ( var_7 || var_8 || var_9 )
    {
        ...
        if ( var_6 && !var_4 )
        {
            ...
            if ( !isalive( var_1 ) && var_7 )
            {
                var_10 = make_building_ai_excluder( var_2 );

                if ( isdefined( var_10 ) )
                {
                    var_11 = var_1 getcorpseentity();
                    var_11 setscriptablepartstate( "burning", var_10, 0 );
                }
            }
        }
        else
...
make_building_ai_excluder( var_0 )
{
    switch ( var_0 )
    {
        case "j_helmet":
