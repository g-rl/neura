...
bot_conf_think()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 && self bothasscriptgoal() )
        {
            ...
            else if ( scripts\mp\bots\bots_strategy::bot_has_tactical_goal( "kill_tag" ) && self.tag_getting cargo_truck_mg_init( self.team ) )
            {
        ...
        if ( isdefined( self.tag_getting ) )
        {
            ...
            if ( !self.conf_camping_tag )
            {
                if ( !scripts\mp\bots\bots_strategy::bot_has_tactical_goal( "kill_tag" ) )
                {
                    ...
                    var_5._id_11FC0 = 1;
                    scripts\mp\bots\bots_strategy::bot_new_tactical_goal( "kill_tag", self.tag_getting.ground_pos, 25, var_5 );
                }
            }
        }
...
bot_watch_new_tags()
{
    for (;;)
    {
        ...
        level thread check_lbravo_hover_retreat( self, var_0 );
    }
}

check_lbravo_hover_retreat( var_0, var_1 )
{
...
bot_find_visible_tags( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && isdefined( level.dogtags ) )
    {
        ...
        {
            if ( var_7 cargo_truck_mg_init( self.team ) )
            {
                var_8 = 0;
...
bot_remove_invalid_tags( var_0 )
{
    ...
    {
        if ( var_3.tag cargo_truck_mg_init( self.team ) && scripts\mp\bots\bots_util::bot_vectors_are_equal( var_3.tag.curorigin, var_3.origin ) )
        {
