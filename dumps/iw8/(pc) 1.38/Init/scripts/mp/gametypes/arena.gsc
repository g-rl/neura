...
main()
{
    ...
    scripts\mp\utility\join_team_aggregator::registeronplayerjointeamcallback( ::strafe_minigun_manager );
    ...
    level.bot_ctf_player_always_attacker = mark_loot();

    if ( level.bot_ctf_player_always_attacker )
    {
        level.keycardlocs_chosen = 0.5;
        level.keypad_activate_func = 0.05;
    }

    if ( scripts\cp_mp\utility\game_utility::getmapname() == "mp_m_overwinter" )
    {
        level._id_120FA = 1;
        level.binoculars_settargetmarkerstate = getdvarint( "scr_always_snowfight", 0 );

        if ( level.binoculars_settargetmarkerstate )
    ...
    {
        level.bot_dd_ai_director_update = 1;
        level._id_1231C = 1;
    }
    else if ( getdvarint( "scr_arena_stpday" ) == 1 )
    {
        level.bot_cur_loadout_num = 1;
        level._id_1231C = 1;
    }
...
onstartgametype()
{
    ...
    {
        if ( !level.binoculars_settargetmarkerstate && game["roundsPlayed"] == 0 && istrue( game["practiceRound"] ) )
        {
            level.extratime = 30;
            game["didSnowFight"] = 1;
        ...
        else if ( level.binoculars_settargetmarkerstate )
        {
            level.arenaloadouts = 3;
            var_5 = 0;
        }

        level._id_120FD["vanish"] = loadfx( "vfx/core/impacts/small_snowhit" );
        level._id_120FD["screen"] = loadfx( "vfx/iw8/weap/_impact/snowball/vfx_imp_snowball_scrn.vfx" );
    ...
    if ( var_5 )
    {
        if ( israndomloadouts() || race_ui_show_record() || race_ui_critical_message_update() || race_ui_lap() )
        ...
        else if ( ispickuploadouts() )
        {
            ...
            if ( !isdefined( game["roundsPlayed"] ) || isdefined( game["roundsPlayed"] ) && game["roundsPlayed"] == 0 )
            {
                ...
                level.startweapon.variantid = lootid( level.startweapon.weapon );
                level.arenaweapont1.variantid = lootid( level.arenaweapont1.weapon );
                level.arenaweapont2.variantid = lootid( level.arenaweapont2.weapon );
                level.arenaweapont3.variantid = lootid( level.arenaweapont3.weapon );
                level.arenaweapont4.variantid = lootid( level.arenaweapont4.weapon );
                level.arenaweapont5.variantid = lootid( level.arenaweapont5.weapon );
                level.arenaweapont6.variantid = lootid( level.arenaweapont6.weapon );
                level.arenaweapont7.variantid = lootid( level.arenaweapont7.weapon );
                level.arenaweapont8.variantid = lootid( level.arenaweapont8.weapon );
            }
...
updategametypedvars()
{
    ...
    level.bot_ctf_recover_flag = getdvarint( "scr_arena_arenaAttachments", 0 );
    level.bot_custom_classes_allowed = getdvar( "scr_arena_arenaSuper", "none" );

    if ( level.bot_custom_classes_allowed == "none" )
        ...
        if ( !isdefined( var_0 ) )
        {
            ...
            if ( !isdefined( var_0 ) )
            {
                ...
                if ( var_4 > 3 )
                {
                    ...
                    foreach ( var_6 in scripts\mp\utility\teams::getteamdata( self.pers["team"], "players" ) )
                    {
                        if ( istrue( var_6.crossbowimpactwatcher ) )
                        {
                            var_9++;
                            continue;
                        }
                    ...
                    if ( isdefined( var_8 ) )
                    {
                        ...
                        if ( isdefined( var_8._id_122E6 ) )
                            var_0.angles = var_8._id_122E6;
                    }
                }
            }
    ...
    if ( !isnormalloadouts() )
    {
        ...
        foreach ( var_2 in level.teamnamelist )
        {
            if ( isdefined( var_0.pers["team"] ) && game["roundWinStreak"][var_2] > 0 && var_0.pers["team"] == var_2 )
            {
                ...
                var_0.pers["gamemodeLoadout"]["roundWinStreakPrimaryCamo"] = _id_11EF6();
                var_0.pers["gamemodeLoadout"]["roundWinStreakecondaryCamoTeam"] = var_2;
                var_0.pers["gamemodeLoadout"]["roundWinStreakSecondaryCamo"] = _id_11EF6();
            }
        }
    }
...
onjoinedteam()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_12E3F( "joined_team", "joined_spectators" );
        _id_11F03();
    }
}
...
onspawnfinished()
{
    ...
    if ( istrue( game["practiceRound"] ) || istrue( level.binoculars_settargetmarkerstate ) )
        thread _id_120FC();
    ...
    if ( !scripts\mp\flags::gameflag( "prematch_done" ) && game["roundsPlayed"] == 0 )
    {
        ...
        level scripts\engine\utility::_id_12E3F( "prematch_done", "removeArenaOutlines" );
    }
...
onplayerdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13 )
{
    ...
    {
        if ( istrue( level._id_120FA ) && ( var_6.basename == "snowball_mp" || var_6.basename == "pball_mp" ) )
            playfxontagforclients( level._id_120FD["screen"], var_2, "tag_eye", var_2 );
...
arena_endgame( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    scripts\cp_mp\pet_watch::_id_12AA4();
...
runarenaloadoutrulesonplayer()
{
    if ( israndomloadouts() || israndompreviewloadouts() || race_ui_critical_message_update() || race_ui_lap() )
    {
        if ( israndompreviewloadouts() )
        {
...
buildloadoutsforweaponstreaming()
{
    ...
    if ( ispickuploadouts() )
    {
        ...
        else
        {
            ...
            else if ( istrue( level.ninetypercent_music ) )
            {
                var_4 = game["arenaRandomLoadout"][0]["loadoutPrimaryCamo"];
                var_8 = game["arenaRandomLoadout"][0]["loadoutPrimaryCosmeticAttachment"];
                var_9[0] = game["arenaRandomLoadout"][0]["loadoutPrimarySticker"];
            ...
            if ( questpointgetradius() )
                var_1 = scripts\mp\class::current_anim_ref( var_2, var_4, var_5, level.startweapon.variantid, var_7, var_8, var_9 );
            else
...
buildprimaries( var_0, var_1, var_2 )
{
    ...
    if ( istrue( level._id_1231C ) && istrue( var_2 ) )
    {
        var_8 = minigun_tag();
...
buildsecondaries( var_0, var_1, var_2 )
{
    ...
    else if ( istrue( level.ninetypercent_music ) && istrue( var_2 ) )
    {
        var_7 = minigun_tag();
        game["arenaRandomLoadout"][game["arenaRandomLoadoutIndex"]]["loadoutSecondaryCamo"] = var_7;
...
_id_11F8C()
{
    level.arenaweapont1 = cur_wave_start_time( level.arenaweapont1 );
    level.arenaweapont2 = cur_wave_start_time( level.arenaweapont2 );
    level.arenaweapont3 = cur_wave_start_time( level.arenaweapont3 );
    level.arenaweapont4 = cur_wave_start_time( level.arenaweapont4 );
    level.arenaweapont5 = cur_wave_start_time( level.arenaweapont5 );
    level.arenaweapont6 = cur_wave_start_time( level.arenaweapont6 );
    level.arenaweapont7 = cur_wave_start_time( level.arenaweapont7 );
    level.arenaweapont8 = cur_wave_start_time( level.arenaweapont8 );
}
...
cur_wave_start_time( var_0 )
{
    ...
    if ( !issubstr( var_0.weapon, "equip" ) && var_0.weapon != "none" )
    {
        ...
        var_2 = minigun_tag();
        var_0.decoy_clearaithreatbiasgroup = var_2;

        if ( _id_12BC6( var_0.weapon ) )
        {
            var_6 = minigun_track_target();
            var_0.fadeoutoverlay = var_6;
        }

        if ( _id_12BC7( var_0.weapon ) )
        {
            var_7 = minigun_track_target_delay();
            var_0._id_124D3[0] = var_7[0];
            var_0._id_124D3[1] = var_7[1];
            var_0._id_124D3[2] = var_7[2];
            var_0._id_124D3[3] = var_7[3];
        }
...
_id_11F4E()
{
    level.arenaweapont1 = cs_add_to_struct_array( level.arenaweapont1 );
    level.arenaweapont2 = cs_add_to_struct_array( level.arenaweapont2 );
    level.arenaweapont3 = cs_add_to_struct_array( level.arenaweapont3 );
    level.arenaweapont4 = cs_add_to_struct_array( level.arenaweapont4 );
    level.arenaweapont5 = cs_add_to_struct_array( level.arenaweapont5 );
    level.arenaweapont6 = cs_add_to_struct_array( level.arenaweapont6 );
    level.arenaweapont7 = cs_add_to_struct_array( level.arenaweapont7 );
    level.arenaweapont8 = cs_add_to_struct_array( level.arenaweapont8 );
}
...
cs_add_to_struct_array( var_0 )
{
    ...
    if ( !issubstr( var_0.weapon, "equip" ) && var_0.weapon != "none" )
    {
        ...
        var_7[3] = "none";
        var_8 = scripts\mp\utility\weapon::getweaponrootname( var_0.weapon );
        var_0.weaponobj = scripts\mp\class::current_anim_ref( var_8, undefined, undefined, var_4, undefined, undefined, scripts\cp_mp\utility\game_utility::isnightmap() );
    }
...
_id_11F8E()
{
    level.startweapon = _id_11F97( level.startweapon );
    level.arenaweapont1 = _id_11F97( level.arenaweapont1 );
    level.arenaweapont2 = _id_11F97( level.arenaweapont2 );
    level.arenaweapont3 = _id_11F97( level.arenaweapont3 );
    level.arenaweapont4 = _id_11F97( level.arenaweapont4 );
    level.arenaweapont5 = _id_11F97( level.arenaweapont5 );
    level.arenaweapont6 = _id_11F97( level.arenaweapont6 );
    level.arenaweapont7 = _id_11F97( level.arenaweapont7 );
    level.arenaweapont8 = _id_11F97( level.arenaweapont8 );
}
...
_id_11F97( var_0 )
{
    ...
    if ( !issubstr( var_0.weapon, "equip" ) && var_0.weapon != "none" )
    {
        ...
        var_1 = lootbunkersactive( var_5 + "_mp" );
...
{
    var_1 = scripts\mp\utility\weapon::getweaponrootname( var_0 );
    var_2 = lootbunkersactive( var_1 + "_mp" );
    return var_2;
}
...
defineplayerloadout( var_0 )
{
    ...
    if ( isdefined( level.startweapon.weapon ) && level.startweapon.weapon != "none" && !issubstr( level.startweapon.weapon, "equip" ) )
    {
        ...
        if ( istrue( level._id_1231C ) )
        {
            ...
            if ( _id_12BC6( level.startweapon.weapon ) )
            {
                var_6 = minigun_track_target();
                game["arenaRandomLoadout"][0]["loadoutPrimaryCosmeticAttachment"] = var_6;
            }

            if ( _id_12BC7( level.startweapon.weapon ) )
            {
                var_7 = minigun_track_target_delay();
        ...
        else if ( istrue( level.ninetypercent_music ) )
        {
            ...
            var_1 = lootchopper_getspawnlocations( level.startweapon.weapon );
    }
    else
    {
        var_11 = "none";
        ...
        {
            if ( rear_minigun( level.startweapon.weapon ) )
            {
                ...
                if ( level.bot_ctf_player_always_attacker )
                {
                    ...
                    if ( level.bot_ctf_player_always_attacker == 2 )
                    {
                        var_12 = scripts\engine\utility::ter_op( race_ui_critical_message_update(), "mp/classtable_arena_blueprints.csv", "mp/classTable_arena.csv" );
                        var_4 = int( scripts\mp\gametypes\gun.gsc::managevehiclehealthui( "iw8_knife" ) );
    ...
    if ( level.allowsupers )
    {
        ...
        if ( issubstr( var_14, "mp_m_" ) && var_14 != "mp_m_speed" )
            level.bot_custom_classes_allowed = isbunkeraltenabled();
    }
    else
    {
        level.bot_custom_classes_allowed = "none";
        setomnvar( "ui_disable_fieldupgrades", 1 );
    }
    ...
    level.arena_loadouts["default"]["loadoutFieldUpgrade1"] = level.bot_custom_classes_allowed;
    ...
    if ( !istrue( level._id_1231C ) && !istrue( level.ninetypercent_music ) )
    {
        foreach ( var_16 in level.teamnamelist )
        {
            level.arena_loadouts[var_16]["loadoutPrimaryCamo"] = _id_11EF6();
            level.arena_loadouts[var_16]["loadoutSecondaryCamo"] = _id_11EF6();
        }
    }
}
...
cacherandomloadouts()
{
    ...
    var_0 = [];
    var_1 = 0;
    var_2 = scripts\engine\utility::ter_op( race_ui_critical_message_update(), "mp/classtable_arena_blueprints.csv", "mp/classTable_arena.csv" );
    ...
    if ( israndompreviewloadouts() )
        var_1 = 144;
    else if ( race_ui_critical_message_timer() )
        var_1 = 0;
    else if ( race_wait_for_current_checkpoint() )
        var_1 = 57;
    else if ( race_ui_show_record_end() )
        var_1 = 93;
    else if ( race_update_stars() )
        var_1 = 123;
    else if ( races() )
        var_1 = 146;
    else if ( race_ui_remove_critical_message() )
        var_1 = 188;
    ...
    if ( var_5 != "" && var_6 > 0.0 )
    {
        ...
        foreach ( var_9 in var_7 )
        {
            ...
            if ( var_10.size == 2 )
            {
                var_11 = var_10[0];
                var_12 = int( var_10[1] );
                var_13 = scripts\mp\utility\weapon::_id_12FE8( var_11, var_12 );
...
updateloadoutarray( var_0, var_1 )
{
    ...
    if ( race_ui_critical_message_update() || race_ui_lap() )
    ...
    if ( race_ui_critical_message_update() || race_ui_lap() )
        var_2["loadoutSecondaryVariantID"] = scripts\mp\class::_id_125D9( var_0, var_1, 1, var_2["loadoutSecondary"] );
    else
    ...
    if ( level.allowsupers )
    {
        ...
        var_2["loadoutFieldUpgrade1"] = level.bot_custom_classes_allowed;
...
arenaloadouts_select( var_0, var_1, var_2, var_3 )
{
    ...
    for ( var_6 = 0; var_6 < var_1 && var_0.size > 0; var_6++ )
    {
        ...
        if ( isdefined( var_2 ) && isdefined( var_3 ) )
        {
            ...
            var_10 = bot_ctf_player_has_flag( var_2, var_9 );
            ...
            if ( var_10.size > 0 )
            {
                if ( randomfloat( 1.0 ) < var_3 )
                {
                    ...
                    var_7["loadoutPrimary"] = var_12._id_11B7C;
...
bot_ctf_player_has_flag( var_0, var_1 )
{
    var_2 = [];

    foreach ( var_4 in var_0 )
    {
        if ( arenaloadouts_getweapongroup( var_4._id_11B7C ) == var_1 )
...
lootid( var_0 )
{
    if ( questpointgetradius() && !issubstr( var_0, "equip" ) && var_0 != "none" )
    {
        ...
        if ( var_4 != "" )
        {
            var_5 = scripts\mp\class::_id_125D9( "mp/classtable_arena_blueprints.csv", var_2, 0, var_4 );
            return var_5;
        }
...
lootbunkersactive( var_0 )
{
    var_1 = [];

    if ( level.bot_ctf_recover_flag == 1 )
    {
...
spawnweapon( var_0, var_1, var_2 )
{
    ...
    if ( var_9 != "" )
    {
        if ( istrue( level._id_120FA ) && var_3 == "equip_snowball" )
        {
            if ( isplayer( var_0 ) )
                var_8 = "single";
            ...
            if ( !isplayer( var_0 ) && var_0.script_label == "6" && !level.tracknonoobplayerlocation )
            {
                if ( distance( var_0.origin, ( 0, 0, 138 ) ) < 10 )
                {
                    level.tracknonoobplayerlocation = 1;
                    var_3 = "equip_pball";
                    var_8 = "single";
                }
            }
            else if ( !isplayer( var_0 ) && var_0.script_label == "8" && !level.tracknonoobplayerlocation )
            {
        ...
        if ( isdefined( var_0.angles ) )
        {
            ...
            {
                if ( isdefined( var_0.script_noteworthy ) && var_0.script_noteworthy == "wall" || isdefined( var_0._id_11CD3 ) && var_0._id_11CD3 == "wall" )
        ...
        var_10.waittill_unload_complete = spawn( "trigger_radius", var_10.origin, 0, 32, 32 );
        var_10 thread recondrone_watchsuperinternal();

        if ( istrue( level._id_120FA ) )
        {
            var_10 thread _id_12F5F( var_0, var_8 );
    ...
    else
    {
        ...
        if ( istrue( level._id_1231C ) || istrue( level.ninetypercent_music ) || questpointgetradius() )
            var_17 = var_1.weaponobj;
        else
        {
            var_16 = lootbunkersactive( var_15 + "_mp" );
        ...
        if ( isdefined( var_0.script_noteworthy ) && var_0.script_noteworthy == "wall" )
        {
            ...
            var_19.check_bonus_leads_xp = var_22;
        }
...
recondrone_watchsuperinternal()
{
    ...
    {
        wait 0.05;
        self.waittill_unload_complete waittill( "trigger", var_1 );
...
spawngameendflagzone( var_0 )
{
    ...
    var_1.onuncontested = ::bot_choose_defend_zone;
    var_1.isarena = 1;
...
deleteotpreview()
{
    level scripts\engine\utility::_id_12E3F( "prematch_done", "start_mode_setup" );
    disableotflag();
}
...
giveflagcapturexp( var_0, var_1 )
{
    ...
    if ( isplayer( var_2 ) )
    {
        ...
        var_2 thread scripts\common\utility::_id_12965( level.set_trap_flag, "capture", var_2.origin );
    }
...
_id_1200F()
{
    ...
    if ( istrue( level.arenaflag.vehicle_collision ) )
        return;
...
getoutlineasset( var_0, var_1 )
{
    ...
    if ( istrue( level._id_120FA ) && isdefined( var_1 ) && var_1 == "equip_pball" )
        var_2 = "outline_depth_yellow";
...
race_ui_critical_message_timer()
{
    return level.arenaloadouts == 7;
}

race_wait_for_current_checkpoint()
{
    return level.arenaloadouts == 8;
}

race_ui_show_record_end()
{
...
race_ui_remove_critical_message()
{
    return level.arenaloadouts == 12;
}

race_ui_critical_message_update()
{
...
_id_11F88()
{
    ...
    if ( !istrue( level.binoculars_settargetmarkerstate ) && !istrue( game["practiceRound"] ) )
    {
    ...
    level.tracknonoobplayerlocation = 0;
    var_0 = scripts\engine\utility::getstructarray( "weapon_pickup", "targetname" );

    foreach ( var_2 in var_0 )
    {
        if ( istrue( level.binoculars_settargetmarkerstate ) || istrue( game["practiceRound"] ) || level.arenaloadouts != 3 )
        {
            spawnweapon( var_2, level.arenaweapont1 );
            continue;
        }
...
_id_12F5F( var_0, var_1 )
{
    ...
    else
    {
        ...
        playfx( level._id_120FD["vanish"], self.origin );
        clearweaponoutlines();

        if ( !isplayer( var_0 ) )
            level thread _id_12E32( var_0 );
...
_id_12E32( var_0 )
{
    level endon( "game_ended" );
    wait 15;
    playfx( level._id_120FD["vanish"], var_0.origin );
...
mark_loot()
{
    ...
    else if ( rear_minigun( level.arenaweapont1.weapon ) && rear_minigun( level.arenaweapont2.weapon ) && rear_minigun( level.arenaweapont3.weapon ) && rear_minigun( level.arenaweapont4.weapon ) && rear_minigun( level.arenaweapont5.weapon ) && rear_minigun( level.arenaweapont6.weapon ) && rear_minigun( level.arenaweapont7.weapon ) && rear_minigun( level.arenaweapont8.weapon ) )
    {
        if ( rear_minigun( level.startweapon.weapon ) )
            return 2;
        else
...
isbunkeraltenabled()
{
    switch ( level.bot_custom_classes_allowed )
    {
        case "super_weapon_drop":
        case "super_emp_drone":
        case "super_recon_drone":
            level.bot_custom_classes_allowed = "super_ammo_drop";
            break;
        default:
            break;
    }

    return level.bot_custom_classes_allowed;
}
