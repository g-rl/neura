...
brvehiclesinit()
{
    ...
    level.chopper_kill_person = getdvarint( "scr_br_truck_max", -1 );
...
setupvehiclespawnvolumes()
{
    ...
    foreach ( var_14, var_6 in var_4.databyref )
    {
        ...
        if ( isdefined( level.is_done_speaking ) )
            var_7 = [[ level.is_done_speaking ]]( var_7 );

        _id_12967( var_7 );
        extractquest_missionitem( var_7, "atv_spawn", "atv", "motorcycle_spawn", "motorcycle", "motorcycle_spawn_percent" );
        level.br_vehicleallspawns = scripts\engine\utility::array_combine_unique( level.br_vehicleallspawns, var_7 );

        foreach ( var_9 in var_7 )
        {
            if ( isdefined( var_9.script_priority ) && var_9.script_priority > 0 && ( level.chopper_kill_person < 0 || !projectiledeletethread( var_9 ) ) )
            {
            ...
            if ( level.chopper_kill_person >= 0 && projectiledeletethread( var_9 ) )
            {
                level.chopper_kill_vehicle[level.chopper_kill_vehicle.size] = var_9;
                continue;
            }
...
emptyallvehicles()
{
    ...
    foreach ( var_5, var_1 in level.vehicle.instances )
    {
        ...
        {
            if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_12CB6( var_3 ) )
...
deleteextantvehicles( var_0 )
{
    ...
    scripts\cp_mp\vehicles\vehicle_spawn::_id_12CE4();
    ...
    foreach ( var_7, var_2 in level.vehicle.instances )
    {
        ...
        foreach ( var_5 in var_2 )
        {
            ...
            scripts\cp_mp\vehicles\vehicle_spawn::_id_12CEA( var_5 );
...
{
    if ( scripts\mp\gametypes\br_gametypes.gsc::propsetclonesleft( "vehicleSpawns" ) )
        return;

    if ( ( var_0 == "little_bird" || var_0 == "little_bird_mg" ) && scripts\mp\gametypes\br_gametypes.gsc::propsetclonesleft( "littleBirdSpawns" ) )
        return;
...
spawnavehicle( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_6 ) )
        scripts\mp\gametypes\br_analytics.gsc::civilians_killed_stat_row( var_6, var_0 );
...
spawninitialvehicles()
{
    ...
    if ( level.chopper_kill_person > 0 && level.br_totalvehiclesspawned < level.br_totalvehiclesmax )
    {
        var_30 = 0;
        var_31 = scripts\engine\utility::array_randomize( level.chopper_kill_vehicle );
        ...
        foreach ( var_6 in var_31 )
        {
            ...
            if ( isdefined( var_9 ) )
            {
                ...
                if ( var_30 >= level.chopper_kill_person )
                    break;
    ...
    if ( level.chopper_kill_person >= 0 )
        var_3 = scripts\engine\utility::array_remove_array( var_3, level.chopper_kill_vehicle );
...
waitforvehiclestodeletethenspawninitial()
{
    ...
    if ( scripts\mp\gametypes\br_gametypes.gsc::progress_obj( "spawnInitialVehicles" ) )
        scripts\mp\gametypes\br_gametypes.gsc::_id_11BE4( "spawnInitialVehicles" );
    else
        spawninitialvehicles();
}
...
extractquest_missionitem( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        if ( rear_spotlight_speed( var_9, var_1, var_2 ) )
...
rear_spotlight_speed( var_0, var_1, var_2 )
{
...
_id_12967( var_0 )
{
    ...
    {
        if ( pursue_players_after_awhile( var_4 ) )
...
pursue_players_after_awhile( var_0 )
{
