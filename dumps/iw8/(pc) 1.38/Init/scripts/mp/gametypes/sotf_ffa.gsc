...
playerjoinwatcher()
{
    for (;;)
    {
        ...
        if ( isdefined( self.crateiconid ) )
            scripts\cp_mp\entityheadicons::_id_11EAF( self.crateiconid, var_0 );
    }
}
...
getrandomattachments( var_0 )
{
    ...
    var_5 = scripts\mp\utility\weapon::loot_boxes( var_4 );
...
attachmentcheck( var_0, var_1 )
{
    ...
    {
        if ( var_0 == var_1[var_2] || !scripts\mp\utility\weapon::attachmentscompatible( var_0, var_1[var_2] ) )
            return 0;
    }
