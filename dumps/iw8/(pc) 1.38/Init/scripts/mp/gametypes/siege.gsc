...
onstartgametype()
{
    ...
    if ( level.propwaitminigamerun )
    {
        ...
        scripts\mp\gametypes\arm.gsc::_id_11F6F();
...
runobjectives( var_0 )
{
    ...
    if ( level.precappoints )
        scripts\mp\gametypes\obj_dom.gsc::precap( level.start_coop_escort_protect_hvi == 5 );

    scripts\mp\gametypes\dom.gsc::flagsetup();
    level thread objective_manageobjectivesintrovisibility();
    level thread scripts\mp\gametypes\arm.gsc::binoculars_iswithinprojectiondistance_compute();
}
