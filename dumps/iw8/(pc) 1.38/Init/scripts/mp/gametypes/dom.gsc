...
initspawns()
{
    ...
    else if ( istrue( level.announcedomplatespawns ) )
...
_id_12B38()
{
    ...
    while ( !level.gameended )
    {
        foreach ( var_1 in level.players )
        {
            ...
            if ( !isdefined( var_1.should_take_damage_from_trigger_hurt ) || var_1.should_take_damage_from_trigger_hurt != var_2 )
            {
                var_1 setmlgdominationpoint( var_2 );
                var_1.should_take_damage_from_trigger_hurt = var_2;
