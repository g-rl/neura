...
clonesleft()
{
    ...
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "onPlayerConnect", ::closenukecrate );
...
{
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "createC130PathStruct", ::clipleft );
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "addToC130Infil", ::clip_ent );
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "playerWelcomeSplashes", ::closepos );
    waittillframeend;
...
cloned_collision()
{
    ...
    {
        var_7 = scripts\mp\gametypes\br_gulag.gsc::unset_relic_headbullets();
        ...
        if ( isdefined( var_7 ) )
        {
            ...
            if ( isdefined( var_0 ) )
            {
                ...
                var_1 = scripts\mp\gametypes\br_gulag.gsc::loot_getitemcountlefthand( var_0, var_7.origin );
            }
        }
    }
    ...
    if ( !isdefined( var_0 ) )
    {
        if ( isdefined( level.br_circle ) && isdefined( level.br_circle.safecircleent ) )
        {
            ...
            var_1 = scripts\mp\gametypes\br_gulag.gsc::loot_getitemcountlefthand( var_0, var_11 );
        }
    ...
    if ( var_3 )
    {
        ...
        if ( isdefined( level.br_circle ) )
        {
            ...
            var_22 = scripts\mp\gametypes\br_gulag.gsc::manned_turret_createhintobject();
...
clipleft()
{
    ...
    level.br_level.checkpoint_create_carepackage[0] = scripts\mp\gametypes\br_circle.gsc::getrandompointincircle( level.br_level.checkpoint_create_carepackage[0], var_0 );
...
heli_rpg_enemy_run_away( var_0, var_1 )
{
    ...
    if ( scripts\cp_mp\utility\game_utility::radialairstrike() )
        var_2 = scripts\mp\gametypes\br_circle.gsc::getrandompointincircle( var_0.origin, var_0.helidrivablethink );
    else
        var_2 = scripts\mp\gametypes\br_circle.gsc::mine_caves_vo( var_0.origin, var_0.helidrivablethink );

    if ( istrue( level._id_12B74 ) )
        var_2 = scripts\mp\gametypes\br_rewards.gsc::midpoint_music( var_2 );
    ...
    var_7 scripts\mp\gametypes\br_c130airdrop.gsc::cypher_id_pool( 1, "battle_royale_c130_loot", "kingslayer_world", var_0 );
}
...
binoculars_processtargetlos()
{
    ...
    if ( istrue( level.remove_prohibited_weapons ) )
    {
        ...
        scripts\mp\gametypes\br_circle.gsc::init_unlock_silo( var_0, var_1, var_2, var_3 );
    }
    else
        ...
        if ( var_4 == 1 )
        {
            foreach ( var_6 in level.select_top_roof_spawners )
            {
                ...
                if ( var_9 )
                {
                    ...
                    var_11 = clone( var_0 );
                    var_0 scripts\mp\gametypes\br_pickups.gsc::isspecialistbonus( var_11, var_10, 1 );
...
_id_12B08( var_0, var_1, var_2, var_3 )
{
    ...
    if ( level.select_players_in_killzone_only.size < level.select_patrol_two_spawners )
    {
        for ( var_4 = 0; var_4 < level.select_patrol_two_spawners; var_4++ )
        {
            var_15 = spawnstruct();
            var_15.hidden = 0;
            var_15 scripts\mp\gametypes\br_quest_util.gsc::force_bleedout_all_downed_players( "ui_mp_br_mapmenu_icon_assassin_objective_enemy", "active" );
...
closedpos( var_0 )
{
    ...
    {
        var_6 = scripts\mp\gametypes\br_circle.gsc::mine_caves_vo( var_1, var_2, 0.8, 1.0, 1, 0, 1 );
        var_5 = var_6 - var_1;
    }

    var_5 = vectornormalize( var_5 ) * var_2;
    var_7 = var_1 + var_5;
    var_8 = !scripts\mp\gametypes\br_circle.gsc::rear_spotlight_model( var_7, 1 );
...
{
    var_2 = clipright();
    return scripts\mp\gametypes\br_circle.gsc::getrandompointincircle( var_2, level.remove_reduce_recoil, var_0, var_1 );
}
