...
ball_carrier_touched_goal( var_0 )
{
    ...
    {
        var_0 scripts\mp\utility\stats::setextrascore0( var_0.pers["touchdowns"] );
        var_0 thread scripts\common\utility::_id_12965( level.set_trap_flag, "dunk", var_0.origin );
    }
...
ball_touched_goal( var_0 )
{
    ...
    if ( isdefined( self.lastcarrier ) )
    {
        ...
        if ( isplayer( self.lastcarrier ) )
        {
            ...
            self.lastcarrier thread scripts\common\utility::_id_12965( level.set_trap_flag, "fieldgoal", self.lastcarrier.origin );
        }
    }
...
dogoalreset()
{
    ...
    level scripts\engine\utility::_id_12E53( 10, "goal_ready" );
