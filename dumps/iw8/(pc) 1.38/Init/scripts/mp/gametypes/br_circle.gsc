...
initcircle()
{
    if ( scripts\mp\gametypes\br_gametypes.gsc::propsetclonesleft( "circle" ) )
    ...
    else
    {
        ...
        if ( scripts\mp\gametypes\br_gametypes.gsc::progress_obj( "getFinalCircleCenter" ) )
            level.br_circle.br_finalcircleoverride = scripts\mp\gametypes\br_gametypes.gsc::_id_11BE4( "getFinalCircleCenter" );
...
players_in_correct_volume( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( level.dropoff_sound_playerwm_handler ) )
    {
        ...
        scripts\mp\gametypes\br_quest_util.gsc::_id_11F5B();
    }
...
{
    return isalive( var_0 ) && var_0 uiobjectivesetlootid() && !istrue( var_0.gulag ) && !istrue( var_0.inrespawnc130 ) && !var_0 scripts\mp\gametypes\br_public.gsc::update_timer_for_bomb_vest_detonator_holder();
}
...
_id_12972()
{
    ...
    var_2 = scripts\mp\gametypes\br_public.gsc::clear_and_give_killstreak_loadout_support( var_0 );
...
circledamagetick()
{
    ...
    if ( scripts\mp\gametypes\br_gametypes.gsc::propsetflashesleft( "circleEarlyStart" ) )
        ...
        if ( isdefined( level.br_circle.dangercircleent ) )
        {
            ...
            if ( var_4 > 0 )
            {
                ...
                foreach ( var_8 in level.players )
                {
                    ...
                    if ( scripts\mp\gametypes\br_gametypes.gsc::propsetflashesleft( "circleEarlyStart" ) && istrue( var_8.plotarmor ) )
                    {
                        var_8 _id_11A7D();
                        continue;
                    }
                    ...
                    if ( distance2dsquared( var_5, var_8.origin ) > var_6 * var_6 )
                    {
                        if ( var_8 cancircledamageplayer( var_8 ) )
                        {
                            ...
                            {
                                var_8 scripts\mp\gametypes\br_pickups.gsc::kiosk_spent_total( "br_circle" );
                            ...
                            else
                            {
                                ...
                                if ( var_8 scripts\mp\utility\killstreak::isjuggernaut() )
                                    var_10 = scripts\mp\gametypes\br_jugg_common.gsc::showdebugresult( var_10 );
                    ...
                    else
                    {
                        ...
                        if ( scripts\cp_mp\gasmask::hasgasmask( var_8 ) )
                            var_8 scripts\mp\gametypes\br_pickups.gsc::kingslayerkills( "br_circle" );
                    }
                ...
                scripts\mp\gametypes\br_gametypes.gsc::_id_11BE4( "dangerCircleTick", var_5, var_12 );
...
_id_12AFE( var_0 )
{
    ...
    if ( self.protect_jammer != var_0 )
    {
        ...
        if ( var_0 )
        {
            ...
            scripts\mp\gametypes\br_analytics.gsc::chopperexfil_skip_ascend0( self, var_1 - self.resetdangercircleorigin );
        }
        else
        {
            scripts\cp\helicopter\chopper_boss::_id_124F9( "alive_in_gas" );
            scripts\mp\gametypes\br_analytics.gsc::chopperexfil_skip_ascend1( self, var_1 - self.resetdangercircleorigin );
        }
...
startuiclosetimer( var_0, var_1, var_2, var_3 )
{
    ...
    if ( istrue( scripts\mp\gametypes\br_gametypes.gsc::_id_11BE6( "startUICloseTimer", var_0, var_1, var_2, var_3 ) ) )
        return;
...
{
    var_3 = scripts\engine\utility::array_randomize( scripts\mp\gametypes\br_public.gsc::minigunbackup( var_0.team, var_0.squadindex ) );
    var_4 = undefined;
...
additionalrecondronetargets( var_0, var_1 )
{
    ...
    if ( scripts\mp\gametypes\br_gametypes.gsc::progress_obj( "mapCenterFinalCircle" ) )
        var_2 = scripts\mp\gametypes\br_gametypes.gsc::_id_11BE4( "mapCenterFinalCircle" );
    ...
    if ( !var_26 && scripts\mp\gametypes\br_gametypes.gsc::propsetflashesleft( "circleSnapToNavMesh" ) )
        var_26 = 1;
    ...
    scripts\mp\gametypes\br_gametypes.gsc::_id_11BE4( "preCalcSafeCircleCenters" );
...
_id_11BE8( var_0 )
{
    ...
    if ( istrue( var_0 ) && !scripts\mp\gametypes\br_gametypes.gsc::propsetflashesleft( "circleEarlyStart" ) )
        level waittill( "infils_ready" );
...
circletimer( var_0 )
{
    ...
    if ( istrue( scripts\mp\gametypes\br_gametypes.gsc::_id_11BE4( "circleTimer", var_0 ) ) )
        return;
    ...
    scripts\mp\gametypes\br_gametypes.gsc::_id_11BE4( "circleTimerNext", var_0 );
...
bonus_target_domage()
{
    if ( !getdvarint( "scr_br_moving_circle_enabled", 1 ) || scripts\mp\gametypes\br_gametypes.gsc::propsetclonesleft( "movingCircle" ) )
    {
...
claymoreshitby( var_0 )
{
    ...
    {
        var_4 = scripts\mp\gametypes\br_public.gsc::minplunderextractions( var_3 );
...
has_relic_amped_victim_survived_time( var_0, var_1 )
{
    var_2 = getsafecircleorigin();
    var_3 = getsafecircleradius();
    var_4 = scripts\mp\gametypes\br_public.gsc::minigunbackup( var_0, var_1 );
