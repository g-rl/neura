...
createflagsandhud()
{
    ...
    scripts\mp\objidpoolmanager::start_trap_room_combat( level.capzones[game["defenders"]].objidnum, 1 );
    scripts\mp\objidpoolmanager::start_trap_room_combat( level.capzones[game["attackers"]].objidnum, 1 );
}
...
createteamflag( var_0, var_1 )
{
    ...
    var_9 scripts\mp\gameobjects::_id_11ECA( level.iconescort, level.iconkill, level.should_start_cautious_approach_koth );
    ...
    var_9 scripts\mp\gameobjects::zombienumtoconsume( ::isdmzbotpracticematch );
    var_9.allowweapons = 1;
    var_9.tacinsert_destroyongameended = var_8;
    var_9.onpickup = ::onpickup;
    var_9.onpickupfailed = ::onpickup;
    var_9.ondrop = ::ondrop;
    var_9.onreset = ::onreset;
    var_9.projectileimpactthermite = 1;
    ...
    if ( isdefined( level.showenemycarrier ) )
    {
        ...
        var_9 scripts\mp\gameobjects::_id_11ECA( level.iconescort, level.iconkill, level.should_start_cautious_approach_koth, var_10 );
    }
    else
    {
        var_9.objidpingfriendly = 1;
...
createcapzone( var_0, var_1 )
{
    ...
    var_6 scripts\mp\gameobjects::_id_11ECA( level.icondefendflag, level.iconcaptureflag, level.should_start_cautious_approach_koth );
...
onpickup( var_0, var_1, var_2 )
{
    ...
    if ( var_4 != var_3 )
    {
        ...
        if ( level.codcasterenabled )
            level.capzones[var_0.team] scripts\mp\gameobjects::_id_11A79();

        thread returnflag();
        var_0 thread scripts\common\utility::_id_12965( level.set_trap_flag, "obj_return", var_0.origin );
        ...
        if ( self.tacinsert_destroyongameended == "allies" )
            setomnvar( "ui_ctf_flag_axis", -2 );
        else
            setomnvar( "ui_ctf_flag_allies", -2 );
    }
    else
    {
        ...
        level.capzones[var_5] scripts\mp\gameobjects::_id_11EC1( level.should_start_cautious_approach_hq );
...
ondrop( var_0 )
{
    if ( isdefined( var_0.leaving_team ) )
    {
        ...
        self.droppedteam = self.tacinsert_destroyongameended;
    else
    ...
    if ( level.returntime >= 0 )
        scripts\mp\gameobjects::_id_11ECA( level.iconreturnflag, level.iconcaptureflag, level.should_start_cautious_approach_koth );
    else
    {
        scripts\mp\gameobjects::_id_11ECA( level.icondefendflag, level.iconcaptureflag, level.should_start_cautious_approach_koth );
    ...
    scripts\mp\utility\dialog::leaderdialog( "enemy_flag_dropped", self.tacinsert_destroyongameended, "status" );
    scripts\mp\utility\dialog::leaderdialog( "flag_dropped", scripts\mp\utility\game::getotherteam( self.tacinsert_destroyongameended )[0], "status" );
...
onreset()
{
    ...
    level.capzones[var_1] scripts\mp\gameobjects::_id_11ECA( level.icondefendflag, level.iconcaptureflag, level.should_start_cautious_approach_koth );
...
onuse( var_0 )
{
    if ( !level.gameended )
    {
        ...
        var_0 thread scripts\common\utility::_id_12965( level.set_trap_flag, "capture", var_0.origin );
        ...
        if ( level.codcasterenabled )
            level.capzones[var_2] scripts\mp\gameobjects::_id_11A79();
...
superabilitywatcher()
{
    ...
    for (;;)
    {
        ...
        {
            case "super_rewind":
                scripts\engine\utility::_id_12E3F( "teleport_success", "rewind_success" );
...
placeflag()
{
    ...
    for (;;)
    {
        if ( getdvar( "scr_devPlaceDomFlag", "" ) != "" )
        {
            ...
            var_12 scripts\mp\gameobjects::_id_11ECA( level.icondefendflag, level.iconcaptureflag, level.should_start_cautious_approach_koth );
