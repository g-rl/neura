...
init()
{
    ...
    scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "scavenger" )._id_11D1C = getdvarint( "scr_br_scavenger_searchCircleSize", 1000 );
    scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "scavenger" ).should_do_vo_call = getdvarint( "scr_br_scavenger_missionTimeBase", 300 );
    scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "scavenger" ).should_drop_grenade_pickup = getdvarint( "scr_br_scavenger_missionTimeBonus", 60 );
    scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "scavenger" )._id_11A86 = getdvarint( "scr_br_scavenger_resetTimerOnPickup", 1 );
    scripts\mp\gametypes\br_quest_util.gsc::_id_1195C( "scavenger", ::_id_12377 );
    scripts\mp\gametypes\br_quest_util.gsc::registerremovequestinstance( "scavenger", ::sq_removequestinstance );
    scripts\mp\gametypes\br_quest_util.gsc::_id_1194E( "scavenger", ::_id_1236D );
    ...
    scripts\mp\gametypes\br_quest_util.gsc::zoneislocked( "scavenger_locale", ::_id_12367 );
    ...
    scripts\mp\gametypes\br_quest_util.gsc::zvelscale( "scavenger_locale", ::_id_12364 );
    scripts\mp\gametypes\br_quest_util.gsc::_id_11950( "scavenger_locale", ::_id_12374 );
    scripts\mp\gametypes\br_quest_util.gsc::watch_for_player_going_belowmap_or_oob( "scavenger", 1 );
    scripts\mp\gametypes\br_quest_util.gsc::_id_11951( "scavenger", ::_id_1236A );
    var_1 = [];
...
sq_createquestlocale( var_0 )
{
    ...
    var_1 scripts\mp\gametypes\br_quest_util.gsc::force_bleedout_all_downed_players( "ui_mp_br_mapmenu_icon_scavengerhunt_objective", "current" );
...
_id_12367( var_0 )
{
    ...
    if ( var_1 )
    {
        ...
        if ( istrue( scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "scavenger" )._id_11A86 ) )
            self.subscribedinstances[0] scripts\mp\gametypes\br_quest_util.gsc::watch_for_player_in_gulag( scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "scavenger" ).should_do_vo_call, 1 );
        else
            self.subscribedinstances[0] scripts\mp\gametypes\br_quest_util.gsc::watch_for_player_entered_trap_room( scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "scavenger" ).should_drop_grenade_pickup );
    }
}
...
takequestitem( var_0 )
{
    ...
    var_1 scripts\mp\gametypes\br_quest_util.gsc::watch_for_player_in_gulag( scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "scavenger" ).should_do_vo_call, 4 );
    scripts\mp\gametypes\br_quest_util.gsc::addquestinstance( "scavenger", var_1 );
    scripts\mp\gametypes\br_quest_util.gsc::_id_124A9( "scavenger", self, self.team );
    var_6 = spawnstruct();
    var_6.excludedplayers = [];
    var_6.excludedplayers[0] = self;
    var_6.vehicleoutline = scripts\mp\gametypes\br_quest_util.gsc::min_z( "scavenger", scripts\mp\gametypes\br_quest_util.gsc::mine_caves_cell_support_internal( self.team ) );
    ...
    scripts\mp\gametypes\br_quest_util.gsc::global_stealth_broken_func( var_1.team, self, 6, scripts\mp\gametypes\br_quest_util.gsc::getquestindex( "scavenger" ) );
    level thread scripts\mp\gametypes\br_public.gsc::cloudanimfx( "mission_scav_accept", var_1.team, 1 );
}
...
{
    var_0 = 0;
    var_1 = scripts\mp\gametypes\br_gametypes.gsc::_id_11BE4( "overrideQuestSearchParams", "scavenger" );
...
completescavengerquest( var_0, var_1 )
{
    ...
    var_5 = scripts\mp\gametypes\br_quest_util.gsc::mine_caves_ambush( scripts\mp\gametypes\br_quest_util.gsc::mine_cave_turrets( "scavenger" ) );
    ...
    if ( !scripts\mp\gametypes\br_public.gsc::rear_minigun_model() )
    {
        ...
        level thread scripts\mp\gametypes\br_public.gsc::cloudanimfx( "mission_scav_success", self.team, 1, 1 );
    }
...
_id_11C7C( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_2 == "scavenger_closed" && isdefined( var_0.entity ) )
    {
        ...
        if ( var_0.entity.questlocale.tr_respawn == 2 )
        {
            ...
            scripts\mp\gametypes\br_quest_util.gsc::global_stealth_broken_func( var_5.team, var_3, 8, scripts\mp\gametypes\br_quest_util.gsc::getquestindex( "scavenger" ) );
            var_5 completescavengerquest( var_0.entity, var_3 );
        }
        else
        {
            scripts\mp\gametypes\br_quest_util.gsc::global_stealth_broken_func( var_5.team, var_3, 7, scripts\mp\gametypes\br_quest_util.gsc::getquestindex( "scavenger" ) );
            var_7 = select_bridge_two_spawners( var_0.origin, var_5._id_11A51[var_0.entity.questlocale.tr_respawn + 1] );
            var_0.entity.questlocale scripts\mp\gametypes\br_quest_util.gsc::spawn_ending_individual_guys( "scavenger_locale", var_7 );
        }
...
_id_12377()
{
    ...
    for ( var_1 = 0; var_1 < 3; var_1++ )
    {
        ...
        var_3 = scripts\mp\gametypes\br_quest_util.gsc::is_point_in_cylinder( "scavenger", var_2 );
