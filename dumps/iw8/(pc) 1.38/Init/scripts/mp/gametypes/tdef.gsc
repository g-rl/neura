...
main()
{
    ...
    level.get_random_circle_direction = [];
    var_0 = getentarray( "cyber_emp_pickup_trig", "targetname" );

    foreach ( var_2 in var_0 )
        level.get_random_circle_direction[level.get_random_circle_direction.size] = var_2.origin;

    level.get_push_force_direction = ( 0, 0, 0 );
    ...
    foreach ( var_6 in var_4 )
    {
        ...
        {
            level.get_push_force_direction = var_6.origin;
            break;
        }
    }
    ...
    level.get_random_impact_point_on_line = [];
    level.scorefrozenuntil = 0;
    level.get_random_leftover_letter = 0;
...
updategametypedvars()
{
    ...
    level.vo_do_loudspeaker = scripts\mp\utility\dvars::dvarintvalue( "ppkTeamNoFlag", 50, 0, 250 );
    level.vo_enemy_armor = scripts\mp\utility\dvars::dvarintvalue( "ppkTeamWithFlag", 100, 0, 250 );
    level.vo_death_drop_and_cash_protection = scripts\mp\utility\dvars::dvarintvalue( "ppkFlagCarrier", 250, 0, 250 );
    ...
    level.iscrossbowdamage = scripts\mp\utility\dvars::dvarfloatvalue( "flagActivationDelay", 10, 0, 30 );
...
initspawns()
{
    ...
    foreach ( var_3 in level.spawnpoints )
        dangernotifyplayersinrange( var_3 );
}

dangernotifyplayersinrange( var_0 )
{
    var_0.scriptdata.goodjobplayer = undefined;
    var_1 = getpathdist( var_0.origin, level.get_random_circle_direction[0], 1000 );

    if ( var_1 < 0 )
        var_1 = scripts\engine\utility::distance_2d_squared( var_0.origin, level.get_random_circle_direction[0] );
    else
        var_1 = var_1 * var_1;

    var_0.scriptdata.goodjobplayer = var_1;
}
...
getspawnpoint()
{
    ...
    {
        var_3 = [];
        var_3["defenderFlagPosition"] = level.get_proximity_alias.visuals[0].origin;

        if ( isdefined( level.get_proximity_alias.carrier ) )
            var_3["activeCarrierPosition"] = level.get_proximity_alias.carrier.origin;
        else
...
tdef()
{
    ...
    level.should_start_cautious_approach_hq = "waypoint_mlg_empty_flag";
    level.should_start_cautious_approach_koth = "waypoint_mlg_full_flag";
...
flytime()
{
    level.get_random_circle_direction = scripts\engine\utility::array_randomize( level.get_random_circle_direction );
    var_0 = level.get_random_circle_direction[0] + ( 0, 0, 64 );
    var_1 = level.get_random_circle_direction[0] + ( 0, 0, -64 );
    var_2 = scripts\engine\trace::ray_trace( var_0, var_1, undefined, scripts\engine\trace::create_default_contents( 1 ) );
    level.get_random_circle_direction[0] = var_2["position"];
    level.get_proximity_alias = forced_laststand_weapon( "allies" );
    level thread isdevbuild();
}
...
isdevbuild()
{
    ...
    {
        level.get_random_impact_point.start_vault_assault_retrieve_saw scripts\mp\gameobjects::setvisibleteam( "none" );
        level scripts\engine\utility::_id_12E3F( "prematch_done", "start_mode_setup" );
        level.get_random_impact_point.start_vault_assault_retrieve_saw scripts\mp\gameobjects::setvisibleteam( "any" );
    }

    if ( level.iscrossbowdamage )
    {
        scripts\mp\flags::gameflagwait( "prematch_done" );
        level.get_random_impact_point.start_vault_assault_retrieve_saw thread scripts\mp\gametypes\obj_zonecapture.gsc::scriptable_callback( level.iscrossbowdamage, level.get_proximity_alias.curorigin + level.get_proximity_alias.offset3d );
        wait( level.iscrossbowdamage );
        level.get_random_impact_point.start_vault_assault_retrieve_saw scripts\mp\gameobjects::_id_11ECA( level.iconcaptureflag, level.iconcaptureflag, level.should_start_cautious_approach_koth );
        level.get_proximity_alias.trigger scripts\engine\utility::trigger_on();
...
forced_laststand_weapon( var_0 )
{
    ...
    level.returntime = 0;
    var_1 = 32;
    var_2 = spawn( "trigger_radius", level.get_random_circle_direction[0], 0, var_1, 128 );
    var_3 = [];
    var_3[0] = spawn( "script_model", level.get_random_circle_direction[0] );
    ...
    var_5 scripts\mp\gameobjects::_id_11ECA( level.iconescort, level.iconkill, level.should_start_cautious_approach_koth );
    ...
    var_5 scripts\mp\gameobjects::zombienumtoconsume( ::isdmzbotpracticematch );
    ...
    if ( isdefined( level.showenemycarrier ) )
    {
        ...
        var_5 scripts\mp\gameobjects::_id_11ECA( level.iconescort, level.iconkill, level.should_start_cautious_approach_koth, var_6 );
    }
    else
    {
        var_5.objidpingfriendly = 1;
    ...
    level.get_random_impact_point = forced_revive( var_0, var_5 );
    return var_5;
}
...
forced_revive( var_0, var_1 )
{
    ...
    var_3.start_vault_assault_retrieve_saw = scripts\mp\gameobjects::createobjidobject( var_2, "neutral", ( 0, 0, 85 ), undefined, "any", 0 );
    var_3.start_vault_assault_retrieve_saw scripts\mp\gameobjects::setvisibleteam( "any" );

    if ( level.iscrossbowdamage )
    {
        var_1.trigger scripts\engine\utility::trigger_off();
        var_3.start_vault_assault_retrieve_saw scripts\mp\gameobjects::_id_11ECA( level.icontarget, level.icontarget, level.should_start_cautious_approach_koth );
    }
    else
        var_3.start_vault_assault_retrieve_saw scripts\mp\gameobjects::_id_11ECA( level.iconcaptureflag, level.iconcaptureflag, level.should_start_cautious_approach_koth );
...
onpickup( var_0, var_1, var_2 )
{
    ...
    level.get_random_impact_point.start_vault_assault_retrieve_saw scripts\mp\gameobjects::setvisibleteam( "none" );
    level.get_proximity_alias.fulton_planted = var_0;
    var_0 thread brgetoperatorteam();
    var_0 thread iscrossbowspecial();
    ...
    if ( isdefined( level.showenemycarrier ) )
    {
        ...
        else
        {
            ...
            scripts\mp\objidpoolmanager::start_static_plane_lights( self.pingobjidnum, 1 );
    ...
    scripts\mp\gameobjects::_id_11ECA( level.iconescort, level.iconkill, level.should_start_cautious_approach_koth );
    ...
    var_0 thread scripts\common\utility::_id_12965( level.set_trap_flag, "pickup", var_0.origin );
...
ondrop( var_0 )
{
    ...
    level.get_proximity_alias.fulton_planted = undefined;
    ...
    if ( level.returntime >= 0 )
        scripts\mp\gameobjects::_id_11ECA( level.iconreturnflag, level.iconreturnflag, level.should_start_cautious_approach_koth );
    else
    {
        scripts\mp\gameobjects::_id_11ECA( level.iconreturnflag, level.iconreturnflag, level.should_start_cautious_approach_koth );
        scripts\mp\objidpoolmanager::start_static_plane_lights( self.objidnum, 1 );
    }
...
onreset()
{
    ...
    if ( isdefined( level.get_proximity_alias.vehomn_controlsarefadedoutorhidden ) )
    {
        level.get_proximity_alias.vehomn_controlsarefadedoutorhidden clearportableradar();
        level.get_proximity_alias.vehomn_controlsarefadedoutorhidden delete();
    }
...
brgetoperatorteam( var_0 )
{
    ...
    level.get_proximity_alias endon( "dropped" );
    level.get_proximity_alias endon( "reset" );
    ...
    while ( !level.gameended )
    {
        ...
        if ( !level.gameended )
        {
            level.get_proximity_alias.carrier scripts\mp\utility\stats::incpersstat( "objTime", 1 );
            level.get_proximity_alias.carrier scripts\mp\persistence::statsetchild( "round", "objTime", level.get_proximity_alias.carrier.pers["objTime"] );
            level.get_proximity_alias.carrier scripts\mp\utility\stats::setextrascore0( level.get_proximity_alias.carrier.pers["objTime"] );
            level.get_proximity_alias.carrier scripts\mp\gamescore::giveplayerscore( "tdef_hold_obj", 10 );
        }
    }
}

iscrossbowspecial( var_0 )
{
    level endon( "game_ended" );
    level.get_proximity_alias endon( "dropped" );
    level.get_proximity_alias endon( "reset" );
    ...
    var_1 = makenukeweapon( var_0 );
    var_2 = spawn( "script_model", level.get_proximity_alias.visuals[0].origin );
    var_2.team = scripts\mp\utility\game::getotherteam( var_0 )[0];
    var_2.owner = var_1;
    var_2 makeportableradar( var_1 );
    level.get_proximity_alias.vehomn_controlsarefadedoutorhidden = var_2;
    level.get_proximity_alias thread isdmztutorial();
    level.get_proximity_alias thread isdonetskmap();
}
...
isdmztutorial()
{
    level endon( "game_ended" );
    self endon( "dropped" );
    self.vehomn_controlsarefadedoutorhidden endon( "death" );
    level endon( "portableRadarRunning" );

    for (;;)
    {
        self.vehomn_controlsarefadedoutorhidden moveto( self.fulton_planted.origin, 0.05 );
        wait 0.05;
    }
}
...
isdonetskmap()
{
    level endon( "game_ended" );
    self endon( "dropped" );
    var_0 = self.vehomn_controlsarefadedoutorhidden.team;
    var_0 = scripts\mp\utility\game::getotherteam( var_0 )[0];
    self.vehomn_controlsarefadedoutorhidden.owner scripts\engine\utility::_id_12E40( "disconnect", "joined_team", "joined_spectators" );
    self.vehomn_controlsarefadedoutorhidden clearportableradar();
    self.vehomn_controlsarefadedoutorhidden = undefined;
    iscrossbowspecial( var_0 );
}

getrespawndelay()
{
    var_0 = level.get_proximity_alias scripts\mp\gameobjects::getownerteam();
...
onplayerkilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    var_10 = level.vo_do_loudspeaker;

    if ( isdefined( level.get_proximity_alias ) && level.get_proximity_alias scripts\mp\gameobjects::getownerteam() == var_1.pers["team"] )
    {
        if ( isdefined( level.get_proximity_alias.carrier ) && var_1 != level.get_proximity_alias.carrier )
        {
            level.get_proximity_alias.carrier thread scripts\mp\rank::scoreeventpopup( "carrier_bonus" );
            var_11 = scripts\mp\rank::getscoreinfovalue( "carrier_bonus" );
            scripts\mp\gamescore::giveplayerscore( "carrier_bonus", var_11, self );
            level.get_proximity_alias.carrier thread scripts\mp\rank::giverankxp( "carrier_bonus", var_11 );
        ...
        var_10 = level.vo_enemy_armor;
    }
    else if ( isdefined( self.carryflag ) )
        var_10 = level.vo_death_drop_and_cash_protection;
    ...
    if ( isdefined( var_1 ) && isplayer( var_1 ) && var_1.pers["team"] != self.pers["team"] )
    {
        ...
        if ( isdefined( self.carryflag ) )
        {
            ...
            thread scripts\common\utility::_id_12965( level.set_up_pilots, var_9, "carrying" );
        ...
        if ( !var_12 )
        {
            var_15 = 0;
            var_16 = 0;
            var_17 = distsquaredcheck( var_13, self.origin, level.get_proximity_alias.curorigin );

            if ( var_17 )
            {
                if ( level.get_proximity_alias.ownerteam == self.team )
                    var_15 = 1;
                else
                    var_16 = 1;
            }
            ...
            if ( var_15 )
            {
                ...
                thread scripts\common\utility::_id_12965( level.set_up_pilots, var_9, "defending" );
            ...
            else if ( var_16 )
            {
                ...
                var_1 scripts\mp\utility\stats::incpersstat( "defends", 1 );
                var_1 scripts\mp\persistence::statsetchild( "round", "defends", var_1.pers["defends"] );
                thread scripts\common\utility::_id_12965( level.set_up_pilots, var_9, "assaulting" );
            }
        }
    }
