...
init()
{
    ...
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "restartCircleElimination", ::_id_11AB7 );
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "lootUsedIgnore", ::semtex_stuckplayer );
    ...
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "playerNakedDropLoadout", ::_id_11ADF );
    ...
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "modifyVehicleDamage", ::showintelinstancetoplayer );
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "allowMeleeVehicleDamage", ::binoculars_isads );
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "playerGetZombieSpawnLocation", ::unset_relic_vampire );
    ...
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "shouldLastStandDamageScale", scripts\mp\gametypes\br_gametype_zxp.gsc::_id_12006 );
...
_id_12720()
{
    ...
    foreach ( var_1 in level.players )
    {
        ...
        if ( scripts\mp\utility\player::isreallyalive( var_1 ) && !var_1 scripts\mp\gametypes\br_public.gsc::update_timer_for_bomb_vest_detonator_holder() )
    ...
    scripts\mp\gametypes\br_containmentprotocol.gsc::colorise_warnings( 5 );
    wait 6;
    thread _id_11BE1();
    scripts\mp\gametypes\br_publicevent_juggernaut.gsc::all_gas_trap_structs();
    wait 10;
...
_id_12722()
{
    ...
    scripts\mp\gametypes\br_containmentprotocol.gsc::colorise_warnings( 4 );
    wait 6;
    ...
    scripts\mp\gametypes\br_containmentprotocol.gsc::colorise_warnings( 3.5 );
}
...
_id_12724()
{
    ...
    foreach ( var_1 in level.players )
    {
        if ( !var_1 scripts\mp\gametypes\br_public.gsc::update_timer_for_bomb_vest_detonator_holder() )
            scripts\mp\gametypes\br_public.gsc::cloud_cover( "plague_no_exfil", var_1, 0 );
    }
    ...
    scripts\mp\gametypes\br_containmentprotocol.gsc::colorise_warnings( 14 );
    wait 6;
    ...
    scripts\mp\gametypes\br_containmentprotocol.gsc::colorise_toggle_onto();
}
...
isspawningstopped()
{
    ...
    while ( var_0 )
    {
        ...
        {
            if ( scripts\mp\gametypes\br_alt_mode_zxp.gsc::_id_119D9( var_3 ) > 0 )
            {
                var_0 = 1;
                break;
            }
...
_id_11AE0()
{
    foreach ( var_1 in level.players )
    {
        ...
        waitframe();
        scripts\mp\gametypes\br.gsc::_id_12AED( var_1 );
        waitframe();
    }
}
...
_id_11AE8( var_0 )
{
    ...
    {
        if ( var_7 scripts\mp\gametypes\br_public.gsc::update_timer_for_bomb_vest_detonator_holder() )
...
_id_11ADF()
{
    ...
    var_0 scripts\mp\gametypes\br.gsc::monitor_traversal_watcher( 0, 1, 0 );
    scripts\mp\gametypes\br_pickups.gsc::br_forcegivecustompickupitem( var_0, "brloot_equip_gasmask", 1 );
    var_0 scripts\mp\gametypes\br_weapons.gsc::checkforsubgametypeoverrides();
    var_0 scripts\mp\gametypes\br_pickups.gsc::_id_11A84();
    var_0 scripts\mp\gametypes\br_pickups.gsc::forcegivesuper( "super_ammo_drop", 0 );
    var_0 scripts\mp\gametypes\br.gsc::monitor_game_end_on_front_truck_death( var_0 );
...
_id_11AE4( var_0 )
{
    level endon( "game_ended" );
    wait( var_0 );
    level.wait_for_player_gulag_respawn = scripts\mp\gametypes\br.gsc::comparescore;
    level.shouldmodelognotify = scripts\mp\gametypes\br.gsc::codenumber;
...
_id_11AE5()
{
    ...
    scripts\mp\gametypes\br_alt_mode_zxp.gsc::phfrozen();
}
...
_id_11AF0()
{
    ...
    scripts\mp\gametypes\br_circle.gsc::add_rider_to_decho();
...
setincomingcallback( var_0 )
{
    ...
    return scripts\mp\gametypes\br_alt_mode_zxp.gsc::setincomingcallback( var_0, var_1 );
}
...
comparescore( var_0 )
{
    ...
    if ( !isdefined( self.playerstartjailsetcontrols ) && !( isdefined( level._id_11AFA ) && level._id_11AFA == 2 ) )
    {
        ...
        var_4 = scripts\mp\gametypes\br_public.gsc::vandalize_attack_nodes( self.wait_display_pavelow_boss_health_bar.origin, self.wait_display_pavelow_boss_health_bar.height );
        var_5 = getdvarint( "scr_br_drop_prespawn_timeout_ms", 9000 );
        scripts\mp\gametypes\br_public.gsc::vandalize_internal( var_4, var_5, 1, 0, var_3 );
        ...
        if ( var_2 )
        {
            ...
            wait( var_9 );
            scripts\mp\gametypes\br.gsc::spawnintermission( var_4, self.wait_display_pavelow_boss_health_bar.angles );
...
unset_relic_vampire()
{
    ...
    if ( isdefined( var_1 ) )
        ...
        return scripts\mp\gametypes\br_alt_mode_zxp.gsc::unset_relic_vampire();
}
...
unset_slow_healthregen()
{
    ...
    [var_0, var_1] = scripts\mp\gametypes\br_alt_mode_zxp.gsc::vehicle_damage_applytabletovehicle();
    return [ var_0, var_1 ];
}
...
unset_stay_at_spawn_flag_on_entering_combat()
{
    ...
    for ( var_14 = 0; var_14 < var_13.size; var_14++ )
    {
        ...
        [var_0, var_1] = scripts\mp\gametypes\br_alt_mode_zxp.gsc::modetype( var_5, var_15, var_6 );

        if ( isdefined( var_0 ) )
        {
            var_0 = scripts\mp\gametypes\br_public.gsc::helihint_deposit( var_0, var_3 );
            break;
        }
    }
...
ontimelimit()
{
    ...
    thread scripts\mp\gametypes\br.gsc::brendgame( level.cleanupswaploadoutflags.isassaultdrone, game["end_reason"]["objective_completed"] );
}
...
onplayerkilled( var_0 )
{
    ...
    if ( isdefined( var_0.victim ) && isplayer( var_0.victim ) && !istrue( level.stack_patch_thread ) )
    {
        ...
        var_0.victim scripts\mp\gametypes\br_containmentprotocol.gsc::colorise_warnings_clear();
    }
...
playerzombieapplyemp()
{
    if ( level.script == "mp_br_mechanics" )
    {
        scripts\mp\gametypes\br_zones.gsc::player_respawn( "a", ( 0, 0, 0 ), 500, 20, 0, 2 );
        scripts\mp\gametypes\br_zones.gsc::player_respawn( "b", ( 1000, 1000, 0 ), 500, 20, 0, 2 );
        scripts\mp\gametypes\br_zones.gsc::player_respawn( "c", ( 1000, -1000, 0 ), 500, 20, 0, 2 );
        var_0 = "a,b,c";
    }
    else
        var_0 = "dam,stadium,hospital,super,tv,quarry,bank";

    scripts\mp\gametypes\br_zones.gsc::player_respawn_struct( "scr_br_reveal_plague_zone_locations", var_0 );
...
triage_ai_campers()
{
    ...
    foreach ( var_2 in level.chopperexfil_sh050_start.zones )
    {
        if ( var_2.type == "plague" )
            var_2 thread scripts\mp\gametypes\br_zones.gsc::_id_1314F( undefined, 50.0, var_0 );
    }
    ...
    {
        if ( var_2.type == "plague" )
            var_2 scripts\mp\gametypes\br_zones.gsc::_id_13148();
    }
}
...
modifyplayerdamage( var_0 )
{
    ...
    {
        var_1 = var_0.victim scripts\mp\gametypes\br_public.gsc::update_timer_for_bomb_vest_detonator_holder();
...
showintelinstancetoplayer( var_0 )
{
    ...
    return scripts\mp\gametypes\br_alt_mode_zxp.gsc::showintelinstancetoplayer( var_0 );
}
...
_id_12284( var_0 )
{
    ...
    var_0 = scripts\mp\gametypes\br.gsc::maxelderrank( var_0, ( 0, 0, 10000 ) );
    ...
    var_5.tell_player_to_pick_up_intel = scripts\mp\gametypes\br_lootchopper.gsc::select_lobby_door_one_spawners;
    var_5.enable_lbravo_player_infil = scripts\mp\gametypes\br_lootchopper.gsc::select_bunker_interior_groups;
    var_5.reading = ::reading;

    if ( getdvarint( "scr_br_reveal_attack_objective", 0 ) )
        var_5 scripts\mp\gametypes\br_lootchopper.gsc::select_bunker_interior_one_spawners();
