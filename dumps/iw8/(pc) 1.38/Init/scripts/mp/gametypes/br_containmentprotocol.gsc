...
_playerwaittillcinematiccompleteinternal()
{
    ...
    {
        if ( var_6 scripts\mp\gametypes\br_public.gsc::questtypes() )
            continue;
...
_utilflare_isvalidflaretype( var_0, var_1, var_2, var_3 )
{
    ...
    foreach ( var_8 in var_6 )
    {
        ...
        if ( !istrue( var_8 scripts\mp\gametypes\br_public.gsc::update_timer_for_bomb_vest_detonator_holder() ) || istrue( var_3 ) )
...
_tryusehoverjetfromstructinternal( var_0 )
{
    ...
    var_2 = var_0 scripts\mp\gametypes\br_public.gsc::update_timer_for_bomb_vest_detonator_holder();
    var_3 = var_0 scripts\mp\gametypes\br_public.gsc::questtypes();
