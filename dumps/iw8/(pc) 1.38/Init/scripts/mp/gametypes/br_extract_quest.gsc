...
init()
{
    ...
    scripts\mp\gametypes\br_quest_util.gsc::_id_1195C( "blueprintextract", ::initializerocketfuelreadings );
    scripts\mp\gametypes\br_quest_util.gsc::registerremovequestinstance( "blueprintextract", ::initialize_registered_create_script_files );
    scripts\mp\gametypes\br_quest_util.gsc::registerquestlocale( "blueprintextract_locale" );
    scripts\mp\gametypes\br_quest_util.gsc::registercreatequestlocale( "blueprintextract_locale", ::initevents );
    scripts\mp\gametypes\br_quest_util.gsc::registercheckiflocaleisavailable( "blueprintextract_locale", ::initdroplocations );
    scripts\mp\gametypes\br_quest_util.gsc::registerremovequestinstance( "blueprintextract_locale", ::inithelipropanims );
    scripts\mp\gametypes\br_quest_util.gsc::registerquestcircletick( "blueprintextract_locale", ::initendcameralocations );
    scripts\mp\gametypes\br_quest_util.gsc::zvelscale( "blueprintextract_locale", ::initheadlessoperatorcustomization );
    scripts\mp\gametypes\br_quest_util.gsc::_id_11950( "blueprintextract_locale", ::initheliextractanims );
    scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "blueprintextract_locale" ).nextid = 0;
    scripts\mp\gametypes\br_quest_util.gsc::watch_for_player_going_belowmap_or_oob( "blueprintextract", 1 );
    scripts\mp\gametypes\br_quest_util.gsc::_id_11951( "blueprintextract", ::initbunker );
...
initializerocketfuelreadings()
{
    ...
    var_1 = scripts\mp\gametypes\br_quest_util.gsc::is_point_in_cylinder( "blueprintextract", var_0 );
...
initextractionlocations( var_0 )
{
    ...
    var_3 = scripts\mp\gametypes\br_quest_util.gsc::is_point_in_cylinder( "blueprintextract", var_2 );
...
takequestitem( var_0 )
{
    ...
    scripts\mp\gametypes\br_quest_util.gsc::_id_124A9( "blueprintextract", self, self.team );
    ...
    var_12.vehicleoutline = scripts\mp\gametypes\br_quest_util.gsc::min_z( "blueprintextract", scripts\mp\gametypes\br_quest_util.gsc::mine_caves_cell_support_internal( self.team ) );
    ...
    scripts\mp\gametypes\br_quest_util.gsc::global_stealth_broken_func( var_5.team, self, 6, scripts\mp\gametypes\br_quest_util.gsc::getquestindex( "blueprintextract" ) );
...
glintfx( var_0 )
{
    ...
    var_5 = scripts\mp\gametypes\br_quest_util.gsc::mine_caves_ambush( scripts\mp\gametypes\br_quest_util.gsc::mine_cave_turrets( "blueprintextract" ) );
