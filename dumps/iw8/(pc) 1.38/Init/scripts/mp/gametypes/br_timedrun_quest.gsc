...
init()
{
    ...
    scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "timedrun" ).should_do_vo_call = getdvarint( "scr_br_tr_missionTimeBase", 120 );
    scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "timedrun" ).remove_hunter_class = getdvarint( "scr_br_tr_kioskSearchRadiusMax", 23000 );
    scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "timedrun" ).remove_invulnerability = getdvarint( "scr_br_tr_kioskSearchRadiusMin", 10000 );
    scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "timedrun" ).remove_group_from_combined_module_counters = getdvarint( "scr_br_tr_kioskSearchRadiusIdealMax", 23000 );
    scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "timedrun" ).remove_hover_direction_and_try_issue_retreat = getdvarint( "scr_br_tr_kioskSearchRadiusIdealMin", 17000 );
    scripts\mp\gametypes\br_quest_util.gsc::registerremovequestinstance( "timedrun", ::_id_127B7 );
    scripts\mp\gametypes\br_quest_util.gsc::_id_1194E( "timedrun", ::_id_127B5 );

    if ( !var_0 )
        return;

    scripts\mp\gametypes\br_quest_util.gsc::_id_1195C( "timedrun", ::_id_1293F );
    scripts\mp\gametypes\br_quest_util.gsc::registerquestlocale( "timedrun_locale" );
    scripts\mp\gametypes\br_quest_util.gsc::registercreatequestlocale( "timedrun_locale", ::_id_127AF );
    scripts\mp\gametypes\br_quest_util.gsc::registerremovequestinstance( "timedrun_locale", ::_id_127B6 );
    scripts\mp\gametypes\br_quest_util.gsc::zvelscale( "timedrun_locale", ::_id_127B1 );
    scripts\mp\gametypes\br_quest_util.gsc::_id_11950( "timedrun_locale", ::_id_127B8 );
    scripts\mp\gametypes\br_quest_util.gsc::registerquestcircletick( "timedrun_locale", ::_id_127AE );
    scripts\mp\gametypes\br_quest_util.gsc::registerquestthink( "timedrun_locale", ::_id_127B0, 0.1 );
...
_id_1293F()
{
    ...
    var_1 = scripts\mp\gametypes\br_quest_util.gsc::is_point_in_cylinder( "timedrun", var_0 );
...
takequestitem( var_0 )
{
    ...
    scripts\mp\gametypes\br_quest_util.gsc::watch_for_player_going_belowmap_or_oob( "timedrun", 1 );
    scripts\mp\gametypes\br_quest_util.gsc::_id_11951( "timedrun", ::_id_127B4 );
    var_1 scripts\mp\gametypes\br_quest_util.gsc::watch_for_player_in_gulag( getdvarint( "scr_br_timedrun_questTimeBase", getdvarint( "scr_br_tr_missionTimeBase", 120 ) ), 4 );
    scripts\mp\gametypes\br_quest_util.gsc::addquestinstance( "timedrun", var_1 );
    scripts\mp\gametypes\br_quest_util.gsc::_id_124A9( "timedrun", self, self.team );
    var_4 = spawnstruct();
    var_4.excludedplayers = [];
    var_4.excludedplayers[0] = self;
    var_4.vehicleoutline = scripts\mp\gametypes\br_quest_util.gsc::min_z( "timedrun", scripts\mp\gametypes\br_quest_util.gsc::mine_caves_cell_support_internal( self.team ) );
    ...
    level thread scripts\mp\gametypes\br_public.gsc::cloudanimfx( "mission_timedrun_accept", var_1.team, 1, 1 );
}
...
_id_127B3( var_0 )
{
    ...
    var_1._id_11D22 = scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "timedrun" ).remove_hunter_class;
    var_1._id_11D23 = scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "timedrun" ).remove_invulnerability;
    var_1._id_11D20 = scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "timedrun" ).remove_group_from_combined_module_counters;
    var_1._id_11D21 = scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "timedrun" ).remove_hover_direction_and_try_issue_retreat;
    var_1._id_11D1D = 1;
...
_id_127AF( var_0 )
{
    ...
    var_1 scripts\mp\gametypes\br_quest_util.gsc::force_bleedout_all_downed_players( "ui_mp_br_mapmenu_icon_timedrun_objective", "current", var_1.curorigin + ( 0, 0, 65 ) );
...
exitvehicledelay( var_0, var_1 )
{
    ...
    var_5 = scripts\mp\gametypes\br_quest_util.gsc::mine_caves_ambush( scripts\mp\gametypes\br_quest_util.gsc::mine_cave_turrets( "timedrun" ) );
    ...
    foreach ( var_8 in var_6 )
    {
        if ( isdefined( var_8 ) && !istrue( var_8.checkpointstruct ) )
            scripts\mp\gametypes\br_armory_kiosk.gsc::remove_last_used_node( var_0, var_8 );
    }
...
intel_location_vo()
{
    ...
    level thread scripts\mp\gametypes\br_public.gsc::cloudanimfx( "mission_obj_circle_fail", self.team, 1, 1 );
    self.result = "fail";
    scripts\mp\gametypes\br_quest_util.gsc::removequestinstance();
}
...
_id_127B4()
{
    ...
    level thread scripts\mp\gametypes\br_public.gsc::cloudanimfx( "mission_timedrun_fail", self.team, 1, 1 );
}
