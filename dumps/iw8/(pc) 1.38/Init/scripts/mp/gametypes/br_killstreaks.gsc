...
get_ai_hearing_bomb_plant_sound( var_0, var_1, var_2, var_3 )
{
    ...
    foreach ( var_6 in var_4 )
    {
        if ( isdefined( var_6 ) && scripts\mp\utility\player::isreallyalive( var_6 ) && var_6.team != self.team )
            get_actual_grenade_name( var_6, var_2, var_3 );
    }
}

get_actual_grenade_name( var_0, var_1, var_2, var_3 )
{
    if ( isdefined( level.get_active_station_names ) && isdefined( level.get_actor_stance ) )
    {
        if ( isdefined( level.get_actor_stance[var_1] ) && isdefined( level.get_actor_stance[var_1][var_0.guid] ) && gettime() < level.get_actor_stance[var_1][var_0.guid] )
            var_2 = 0;
        else
            level.get_actor_stance[var_1][var_0.guid] = gettime() + level.get_active_station_names * 1000;
    }

    if ( istrue( var_2 ) && scripts\mp\utility\killstreak::getkillstreakenemyusedialogue( var_1 ) )
    {
        var_4 = scripts\mp\gametypes\br_public.gsc::clear_and_give_killstreak_loadout_support( self );
    ...
    if ( var_1 > 0 )
    {
        ...
        get_ai_spawner( var_0, var_3 );
    }

    var_6 = spawnstruct();
    var_6.truck_03_node = istrue( var_2 );
    var_6.spectatingthisplayer = var_1;
    var_0 scripts\mp\gametypes\br_gametypes.gsc::_id_11BE4( "onKillstreakDanger", var_6 );
}

get_ai_spawner( var_0, var_1 )
{
    var_2 = var_0 getxuid();
    ...
    level thread _id_12F1D( var_0, var_2, "death_or_disconnect" );
    level thread _id_12F1D( var_0, var_2, undefined, var_1 );
}

_id_12F1D( var_0, var_1, var_2, var_3 )
{
