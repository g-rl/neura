...
spawndogtags( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( level.dogtags[var_0.guid] ) )
    {
        if ( istrue( level.keypad_increase_failnum ) )
            ...
            playfx( level.pindia_headlights["vanish_hw_fr"], level.dogtags[var_0.guid].curorigin );
        else
...
removetags( var_0, var_1, var_2 )
{
    if ( isdefined( level.dogtags[var_0] ) )
    {
        ...
        if ( istrue( level.keypad_increase_failnum ) )
        {
            if ( isdefined( level._id_1231E ) )
                level [[ level._id_1231E ]]( level.dogtags[var_0], var_2 );
        }
        else if ( istrue( level.ninetypercent_music ) )
        {
            if ( isdefined( var_2 ) && var_2.team == level.dogtags[var_0].ownerteam )
            {
                ...
                playfx( level.pindia_headlights["vanish_hw_fr"], level.dogtags[var_0].curorigin + ( 0, 0, 45 ) );
            }
            else
            {
                playfx( level.conf_fx["vanish"], level.dogtags[var_0].curorigin );
                playfx( level.pindia_headlights["vanish_hw_en"], level.dogtags[var_0].curorigin + ( 0, 0, 45 ) );
            }
        }
        else
            playfx( level.conf_fx["vanish"], level.dogtags[var_0].curorigin );
...
_id_1231D( var_0, var_1 )
{
    ...
    {
        playfx( level.conf_fx["vanish_gos"], var_0.curorigin );
        playfx( level.move_hvt_from_under_heli["gos_fireworks"], var_0.curorigin );
        level thread scripts\mp\gametypes\common.gsc::_id_12E31( var_0.curorigin );
    }
}
