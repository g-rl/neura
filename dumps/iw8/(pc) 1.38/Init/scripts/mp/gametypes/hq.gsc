...
main()
{
    ...
    level.delay_put_vehicles_on_compass = ::delay_put_vehicles_on_compass;
...
hqmainloop()
{
    ...
    if ( level.firstzoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture.gsc::scriptable_callback( level.firstzoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
getnextzone()
{
    ...
    else if ( isdefined( level._id_119DD ) )
    {
        level.prevzoneindex++;
...
hqactivatenextzone( var_0, var_1 )
{
    ...
    else if ( level.zoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture.gsc::scriptable_callback( level.zoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
setupzones()
{
    ...
    var_0 = iscacprimaryweapongroup( var_0 );
    var_1 = [];
    var_2 = 0;
...
give_capture_credit( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5.assisttouchlist ) )
    {
        ...
        if ( var_5.assisttouchlist[var_2].size > 0 )
            var_5 thread monitor_fronttruck_death( var_2 );
    }
}

monitor_fronttruck_death( var_0 )
{
    level endon( "game_ended" );
...
awardcapturepoints()
{
    ...
    while ( !level.gameended )
    {
        ...
        if ( !level.usehprules )
        {
            ...
            if ( !istrue( level._id_11CB2 ) )
                animscripted_single_earlyend( var_3 );
...
animscripted_single_earlyend( var_0 )
{
    if ( !level.test_offset_positions )
        return;
