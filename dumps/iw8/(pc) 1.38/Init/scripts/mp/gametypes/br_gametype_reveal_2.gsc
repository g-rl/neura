...
init()
{
    ...
    scripts\mp\gametypes\br_gametypes.gsc::give_fists( "giveStartFieldUpgrade" );
    scripts\mp\gametypes\br_gametypes.gsc::hostdamagepercentmedium( "prematchBlueprints" );
    ...
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "getFinalCircleCenter", ::_id_11AE9 );
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "mapCenterFinalCircle", ::_id_11AE9 );
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "onKillstreakBeginUseFunc", ::streakdeploy_playtabletdeploydialog );
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "dropBRKillstreak", ::heli_fire_at_players );
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "createC130PathStruct", ::_id_11AE3 );
    scripts\mp\gametypes\br_gametypes.gsc::zombienumhitshuman( "addToC130Infil", ::_id_11AE1 );
...
_id_12720()
{
    ...
    scripts\mp\gametypes\br_gametypes.gsc::hostdamagepercentmedium( "doFirstUnusedPrematchSpawnOrigin" );
    level notify( "cancel_watch_parachuters_overhead" );
    _id_122D4();
    level thread scripts\mp\gametypes\br_gametype_reveal.gsc::_id_11B04( 6, 4, 0, 1 );
    setomnvar( "ui_br_circle_state", 4 );

    foreach ( var_1 in level.players )
        var_1 scripts\mp\gametypes\br_armor.gsc::monitor_truck();
...
stack_patch_waittill_stack( var_0 )
{
    ...
    {
        level thread scripts\mp\gametypes\br_public.gsc::brleaderdialog( "destroyer_you_are", 0, level._id_11ADD.getkeypadomnvarbitpackinginfo );
...
stadium_one_death_func()
{
    ...
    foreach ( var_7 in var_3 )
    {
        ...
        level thread scripts\mp\gametypes\br_public.gsc::cloud_cover( "flavor_thought", var_7, 1, 1 );
    }
    ...
    foreach ( var_7 in var_3 )
    {
        ...
        var_7 thread _id_11CBE( 3 );
        level thread scripts\mp\gametypes\br_public.gsc::cloud_cover( "flavor_turn_off", var_7, 1, 1 );
    }
    ...
    foreach ( var_7 in var_3 )
    {
        ...
        var_7 thread _id_11CBE( 3 );
        level thread scripts\mp\gametypes\br_public.gsc::cloud_cover( "flavor_history", var_7, 1, 1 );
    }
    ...
    foreach ( var_7 in var_3 )
    {
        ...
        var_7 thread _id_11CBE( 3 );
        level thread scripts\mp\gametypes\br_public.gsc::cloud_cover( "flavor_not_last", var_7, 1, 1 );
    }
}
...
_id_11AEA()
{
    ...
    foreach ( var_1 in level.players )
        scripts\mp\gametypes\br.gsc::monitor_game_end_on_front_truck_death( var_1 );
}
...
adjustzoneactivationdelayforlargemaps( var_0 )
{
    ...
    var_3 = scripts\mp\gametypes\br_pickups.gsc::getitemdroporiginandangles( var_1, level._id_11ADD.getoverridedvarexceptmatchrulesvalues, ( 0, 0, 0 ), var_2, 0, 0, 35 );
...
adjustshipmentspawns( var_0 )
{
    ...
    level._id_11ADD._id_12607 scripts\mp\gametypes\br_quest_util.gsc::force_ai_to_drop_thermites( 4, 11, 1, var_1 );
    level._id_11ADD._id_12607 scripts\mp\gametypes\br_quest_util.gsc::_id_11EBE( 1000 );
    ...
    foreach ( var_3 in level.players )
    {
        ...
        level._id_11ADD._id_12607 scripts\mp\gametypes\br_quest_util.gsc::_id_12056( var_3 );
    }
}
...
adjustmatchtimerpausedstatefromscore()
{
    ...
    level._id_11ADD._id_12607 scripts\mp\gametypes\br_quest_util.gsc::overrideviewkickscalek98();
}
...
monitor_molotov_throws()
{
    ...
    var_0 scripts\mp\gametypes\br_pickups.gsc::isspecialistbonus( "nuke", 1 );
    level waittill( "dov2_device_used" );
    level._id_11ADD.getkeypadomnvarbitpackinginfo = scripts\mp\utility\teams::getteamdata( var_0.team, "alivePlayers" );
    level thread scripts\mp\gametypes\br_public.gsc::brleaderdialog( "thank_you_soldiers", 0, level._id_11ADD.getkeypadomnvarbitpackinginfo );
    _id_12608();
...
unpause_wave_hud()
{
    ...
    var_1 = 5;
    var_2 = 2;
    thread scripts\mp\gametypes\br_gametype_dmz.gsc::initusage( var_2 );
    wait 1;
    ...
    var_7 = ( 0, 0, var_5 );
    self.wait_display_pavelow_boss_health_bar.origin = scripts\mp\gametypes\br.gsc::getoffsetspawnorigin( var_6, var_7 );
...
validatefunc( var_0 )
{
    ...
    var_3 = ( 0, 0, var_1 );
    self.wait_display_pavelow_boss_health_bar.origin = scripts\mp\gametypes\br.gsc::getoffsetspawnorigin( var_2, var_3 );
...
_id_122D4()
{
    ...
    level.chopper_boss_player_monitor = [ scripts\mp\gametypes\br.gsc::createspawnlocation( ( -3589, 672, 2169 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -435, 6921, 1807 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -4721, 4432, 675 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -3928, -9, 820 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -577, -9128, 265 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( 3953, -5968, 502 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( 3702, -1636, 1214 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -25, -1305, 1970 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -330, 3351, 1900 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( 3839, 167, 610 ), 0, 900 ) ];
...
_id_122D5()
{
    ...
    level.voting = [];
    level.prematchspawnoriginsforteams = undefined;
    level.chopper_boss_player_monitor = [ scripts\mp\gametypes\br.gsc::createspawnlocation( ( 1302, 1719, 2013 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -229, 785, 2061 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( 2137, -2813, 2076 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( 833, 4426, 1825 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -1775, -3274, 2337 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( 3702, -1636, 1214 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -25, -1305, 1970 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -3260, 309, 2087 ), 0, 900 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -1510, -3522, 1888 ), 0, 900 ) ];
    level.prematchspawnorigins = scripts\mp\gametypes\br.gsc::getprematchlocationspawnorigins();
