...
callbacksoldieragentdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( var_24 )
    {
        ...
        if ( var_30 )
        {
            ...
            if ( scripts\engine\utility::array_contains( var_35, var_1.vehiclename ) )
    ...
    {
        if ( _id_11FEF( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 ) )
            return;
    ...
    if ( var_22 )
    {
        ...
        {
            if ( var_24 )
                var_2 = animscripted_loop( var_2, var_5, var_17, var_4, var_1 );
        }
        ...
        if ( var_26 )
        {
            ...
            if ( isdefined( level.explosivedamagemod ) )
                var_36 = var_36 * level.explosivedamagemod;
        ...
        {
            var_37 = isdefined( var_12 ) && scripts\mp\utility\weapon::iskillstreakweapon( var_12.basename );
            var_38 = scripts\mp\damage::cac_modified_damage( var_13, var_1, var_2, var_4, var_12, var_6, var_7, var_8, var_0, 0, var_3, var_37 );
            var_2 = var_38[0];
            var_33 = var_38[1];
            var_34 = var_38[2];

            if ( scripts\mp\damage::armorvest_washit( var_1 ) || scripts\mp\damage::helmet_washit( var_1 ) )
                var_3 = var_3 | level.play_alarms_onto;

            if ( scripts\mp\damage::armorvest_wasbroke( var_1 ) || scripts\mp\damage::helmet_wasbroke( var_1 ) )
                var_3 = var_3 | level.play_airstrike_sequence;
        }
    }
    ...
    if ( var_22 || var_23 || var_30 )
    {
        if ( isdefined( var_12 ) )
        {
            ...
            apc_rus_postmoddamagecallback( self, var_1, var_0, var_12, var_2, var_6, var_7, var_8, var_9, var_4 );
        }
        ...
        if ( var_2 >= var_13.health )
        {
            ...
            var_39 = spawnstruct();
            var_39.einflictor = var_0;
            var_39.eattacker = var_1;
            var_39.idamage = var_2;
            var_39.idflags = var_3;
            var_39.smeansofdeath = var_4;
            var_39.sweapon = var_5;
            var_39.vpoint = var_6;
            var_39.vdir = var_7;
            var_39.shitloc = var_8;
            var_39.timeoffset = var_9;
            var_39.modelindex = var_10;
            var_39.partname = var_11;
            var_39.objweapon = var_12;
        }
    }
    ...
    if ( isdefined( var_13.unittype ) && isdefined( level.agent_funcs[var_13.unittype] ) && isdefined( level.agent_funcs[var_13.unittype]["on_damaged_finished"] ) )
        var_13 [[ level.agent_funcs[var_13.unittype]["on_damaged_finished"] ]]( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, 0.0, var_10, var_11, var_33, var_34 );
    else
        var_13 [[ level.agent_funcs[var_13.agent_type]["on_damaged_finished"] ]]( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, 0.0, var_10, var_11, var_33, var_34 );
}
...
apc_rus_postmoddamagecallback( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
...
_id_11FEF( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
