...
killstreak_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "updateScrapAssistDataForceCredit", scripts\mp\killstreaks\killstreaks::_id_12B27 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "updateScrapAssistData", scripts\mp\killstreaks\killstreaks::_id_12B26 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "processScrapAssist", scripts\mp\events::waitandgetnewspawnpoint );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "dangerNotifyPlayersInRange", scripts\mp\gametypes\br_killstreaks.gsc::get_ai_hearing_bomb_plant_sound );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "dangerNotifyPlayer", scripts\mp\gametypes\br_killstreaks.gsc::get_actual_grenade_name );
}
...
entity_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "entity", "isGondolaBrush", scripts\mp\gametypes\br_gondola.gsc::postgamehitmarkerwaittime );
}
...
player_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "freezeControlsDebug", scripts\mp\utility\player::activestate );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "getStanceTop", scripts\mp\utility\player::missing_window_blockers );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "loadout_finalizeWeapons", scripts\mp\class::scn_infil_hackney_heli_npc2 );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "isInLastStand", scripts\mp\utility\player::proxtrigger );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "isPlayerOnIntelChallenge", scripts\mp\gametypes\br_maphints.gsc::quickdropcleanupcache );
}
...
game_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "getSubGameType", scripts\mp\utility\game::missions_clearinappropriaterewards );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "brGetOperatorTeam", scripts\mp\gametypes\br_public.gsc::clear_and_give_killstreak_loadout_support );
...
weapons_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "getDefaultWeaponBaseName", scripts\mp\utility\weapon::make_focus_fire_icon_anchor );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "attachmentIsSelectable", scripts\mp\utility\weapon::br_give_starting_ammo );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "remapAttachmentParentName", scripts\mp\utility\weapon::_id_119DA );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "getWeaponMenuCategory", scripts\mp\utility\weapon::modifycrushdamage );
}
...
sound_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sound", "playKillstreakDeployDialog", scripts\mp\battlechatter_mp::vehicle_damage_updatestatemaxhealthvalues );
...
rank_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "rank", "getBattlePassXPultiplierTotal", scripts\mp\rank::lootchopper_premodifydamage );
}
...
supers_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "supers", "combatRecordSuperMisc", scripts\mp\supers::eventcallback );
}
...
dialog_wait_think()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onVehicleKilled", scripts\cp\helicopter\chopper_boss::vehiclekilled );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onFieldUpgradeEnd", scripts\cp\helicopter\chopper_boss::stoppingpower_onweaponcreated );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onKillStreakEnd", scripts\cp\helicopter\chopper_boss::stream_hit_location_for_players_inside );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "resetChallengeTimer", scripts\cp\helicopter\chopper_boss::_id_11A73 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "startChallengeTimer", scripts\cp\helicopter\chopper_boss::_id_12478 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "stopChallengeTimer", scripts\cp\helicopter\chopper_boss::_id_124F9 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onPing", scripts\cp\helicopter\chopper_boss::subscribedlocale );
}

_id_12676()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "team_utility", "init", scripts\mp\utility\teams::_id_12677 );
}
