...
advanced_supply_drop_marker_used( var_0 )
{
    ...
    var_3 = scripts\mp\gametypes\br_rewards.gsc::make_javelin_model( 0, 1, 0, 0, 0 );
    var_1 scripts\mp\gametypes\br_rewards.gsc::_id_122AB( var_2, var_3 );
...
apachepilotpool( var_0 )
{
    ...
    var_8 = scripts\mp\gametypes\br_gametype_truckwar.gsc::_id_12D1F( var_3 );

    if ( isdefined( var_8 ) )
    {
        if ( getdvar( "scr_br_gametype", "" ) == "truckwar" )
            scripts\mp\gametypes\br_gametype_truckwar.gsc::playerstartbesttimetracking( var_8, var_1.team, 1 );

        level thread scripts\mp\gametypes\br_gametype_truckwar.gsc::_id_12943( var_8, var_7, var_8.angles, 1 );
    }
