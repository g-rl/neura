...
init()
{
    ...
    level.helperdronesettings["radar_drone_recon"].set_relic_team_proximity = 1;
    level.helperdronesettings["radar_drone_recon"].set_relic_thirdperson = 1;
    level.helperdronesettings["radar_drone_recon"].set_start_cash = 3062500;
    level.helperdronesettings["radar_drone_recon"].set_station_track_available_time = 6250000;
    ...
    level.helperdronesettings["assault_drone"].primarymodefunc = ::_id_11E84;
    ...
    level.helperdronesettings["assault_drone"].set_relic_team_proximity = 0;
    level.helperdronesettings["assault_drone"].set_relic_thirdperson = 0;
    level.helperdronesettings["assault_drone"].set_start_cash = 73984;
    level.helperdronesettings["assault_drone"].set_station_track_available_time = 73984;
    level.helperdronesettings["assault_drone"].getnextsafecircleradius = 1;
    level.helperdronesettings["assault_drone"].getnextsafecircleorigin = undefined;
    level.helperdronesettings["assault_drone"].getnextspectatecandidatefromchain = 1;
    level.helperdronesettings["assault_drone"].tank_check_player_firing = undefined;
    var_0 = "br";
    ...
    level.bot_thanks = getdvarfloat( "scr_assault_drone_enemy_notify_dist", 3000.0 );
    level.bot_tdef_think = getdvarint( "scr_assault_drone_freeze_debug", 0 );
    level.headlessopindex = getdvarint( "scr_drone_freeze_switch_debug", 1 );
}
...
tryusehelperdronefromstruct( var_0 )
{
    ...
    var_5 = self.play_players_arrive_at_exfil;
    self.play_players_arrive_at_exfil = undefined;
    ...
    {
        if ( istrue( level.headlessopindex ) )
        ...
        var_10 = 0.6;
        var_11 = 2;
        var_12 = scripts\engine\utility::_id_12E54( var_10, "death", "weapon_switch_started" );
        ...
        var_12 = scripts\engine\utility::_id_12E53( var_11 - var_10, "death" );
    ...
    else if ( var_6 == "scrambler_drone_guard" )
    {
        ...
        if ( isdefined( level._id_127C2 ) )
        {
            var_15 = [[ level._id_127C2 ]]( self.origin );
    ...
    if ( level.gametype == "br" )
    {
        if ( var_6 == "scrambler_drone_guard" )
            scripts\cp_mp\killstreaks\uav::_id_12A1C( self.team, 15000, "scrambler_drone_guard" );
    }
...
tryusehelperdroneearlyout( var_0, var_1 )
{
    ...
    if ( ( var_0.streakname == "radar_drone_recon" || var_0.streakname == "assault_drone" ) && ( !self isonground() && !self isonladder() || scripts\mp\vehicles\little_bird_mg_mp::queue_spawn() ) )
    {
        if ( var_1 )
        {
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
    ...
    if ( isdefined( level.disabledebugdialogue ) )
    {
        if ( ![[ level.disabledebugdialogue ]]( self ) )
        {
            if ( var_1 )
            {
                if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
    ...
    self.play_players_arrive_at_exfil = 1;
    return 0;
}
    ...
    else
    {
        ...
        switch ( var_2 )
        {
            ...
            case "scrambler_drone_guard":
                if ( istrue( level.set_corpse_detect_ranges ) )
                {
...
helperdrone_endscramblereffect()
{
    ...
    if ( isdefined( self.hvtlist ) && self.hvtlist.size > 0 )
    {
        foreach ( var_1 in self.hvtlist )
        {
            if ( isdefined( var_1 ) )
            {
                var_2 = var_1;
...
original_meleechargedistvsplayer( var_0 )
{
    self endon( "death" );
    self endon( "leaving" );
    self endon( "explode" );
...
{
    scripts\engine\utility::_id_12E3F( "death_or_disconnect", "scramble_off" );
...
helperdrone_setscramblerjammed( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_0 ) )
    {
        ...
        if ( !scripts\engine\utility::array_contains( var_1.hvtlist, var_3 ) )
            var_1.hvtlist[var_1.hvtlist.size] = var_3;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_12E3F( "death", "scramble_off" );

    if ( isdefined( self ) )
    {
        helperdrone_setscramblerjammed( 0, var_0, var_1 );

        if ( isdefined( var_0 ) && isdefined( var_0.hvtlist ) )
            var_0.hvtlist = scripts\engine\utility::array_remove( var_0.hvtlist, self );
    }
    else if ( isdefined( var_0 ) && isdefined( var_0.hvtlist ) )
        var_0.hvtlist = scripts\engine\utility::array_removeundefined( var_0.hvtlist );
}
...
starthelperdrone( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
    {
        ...
        if ( var_2 == "br" )
            var_0 thread organizeproplist( self );
    }
...
helperdrone_overwatchplayer()
{
    ...
    for (;;)
    {
        ...
        scripts\engine\utility::_id_12E3F( "goal", "begin_evasive_maneuvers" );
...
helperdrone_pingnearbyenemies()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_4 in var_2 )
        {
            ...
            if ( var_4 operatorsfxalias( self ) )
                continue;
...
helperdrone_watchpingedstatus( var_0, var_1 )
{
    ...
    self.train_initcollision[self.train_initcollision.size] = var_0;
    var_0 scripts\engine\utility::_id_12E53( 3, "death" );
    self.train_initcollision = scripts\engine\utility::array_remove( self.train_initcollision, var_0 );
}
...
operatorsfxalias( var_0 )
{
    ...
    foreach ( var_3 in var_0.train_initcollision )
    {
...
setreconmodesettings( var_0 )
{
    ...
    scripts\cp_mp\utility\killstreak_utility::spawn_fake_number( self.owner );

    if ( !istrue( var_1 ) )
    {
        self.owner _id_11EF1( 1, self );
    ...
    thread origin_delta( var_0 );
    thread helperdrone_handlethermalswitch();
    thread order_path_data( var_0 );
    return 1;
}
...
_id_11E84( var_0 )
{
    ...
    if ( !istrue( var_1 ) )
    {
        ...
        scripts\cp_mp\utility\weapon_utility::setlockedonremovedcallback( self, ::helperdrone_lockedonremovedcallback );
        thread helperdrone_watchouterreticletargets( var_0 );
        thread original_health( var_0 );
        thread optional_params( var_0 );
    }
    ...
    if ( istrue( level.bot_tdef_think ) )
        thread operator_unlock_ids( 2 );
...
setguardmode( var_0 )
{
    ...
    thread original_meleechargedistvsplayer();
    return 1;
}
...
helperdrone_watchearlyexit( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "allowRideKillstreakPlayerExit" ) )
        self thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "killstreak", "allowRideKillstreakPlayerExit" ) ]]( "death", var_0.tank_check_player_firing );

    self waittill( "killstreakExit" );
    thread helperdroneexplode( 0, istrue( var_0.getnextsafecircleorigin ) );
}
...
order_path_data( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( var_1 scripts\cp_mp\vehicles\vehicle::isvehicle() )
            ...
            var_2 = var_1.vehicle;
        else if ( istrue( var_1.relic_grounded_reload_monitor ) )
            var_2 = var_1;
...
operator_unlock_ids( var_0 )
{
    self.owner endon( "disconnect" );
    self endon( "death" );
    wait( var_0 );
    self.owner thread scripts\cp_mp\utility\player_utility::activestate();
}
...
helperdrone_markplayers( var_0 )
{
    ...
    for (;;)
    {
        ...
        self.bomb_vest_timer_remaining_num_of_frame = 0;
        ...
        foreach ( var_5 in var_3 )
        {
            ...
            var_2++;
            _id_11F01( self.targetmarkergroup, var_5, 1 );
            ...
            if ( var_8 )
                self.bomb_vest_timer_remaining_num_of_frame = 1;

            if ( var_9 )
            {
                _id_11F01( self.targetmarkergroup, var_5, 3 );
                continue;
            }

            if ( !var_8 || !var_6 )
            {
                _id_11F01( self.targetmarkergroup, var_5, 0 );
                continue;
            }
...
optional_params( var_0 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_6 in var_3 )
        {
            ...
            var_2++;
            _id_11F01( self.targetmarkergroup, var_6, 1 );
            var_7 = canseetarget( var_6 );
            var_8 = isinmarkingrange( var_6 );

            if ( !var_8 || !var_7 )
            {
                _id_11F01( self.targetmarkergroup, var_6, 0 );
                continue;
            }

            var_4 = 1;
            _id_11F01( self.targetmarkergroup, var_6, 2 );
        }

        self._id_12661 = var_4;
        var_2 = 0;
        waitframe();
    }
}
...
original_health( var_0 )
{
    ...
    for (;;)
    {
        if ( istrue( self._id_12661 ) && var_1 == 0 )
        {
            self.owner setclientomnvar( "ui_rcd_outer_ring", 1 );
            var_1 = 1;
        }
        else if ( !istrue( self._id_12661 ) && var_1 == 1 )
        {
            self.owner setclientomnvar( "ui_rcd_outer_ring", 0 );
            var_1 = 0;
        }
...
helperdrone_watchnotificationstate( var_0 )
{
    ...
    for (;;)
    {
        ...
        else if ( !istrue( self.bomb_vest_timer_remaining_num_of_frame ) )
...
helperdrone_watchouterreticletargets( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.ammobox_getbufferedattachment ) )
        {
            ...
            {
                if ( isdefined( var_6.get_alive_nonspecating_players ) )
                {
                    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "gameFlag" ) )
                    {
                        if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "gameFlag" ) ]]( "prematch_done" ) )
                        {
                            ...
                            {
                                if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "player", "isPlayerOnIntelChallenge" ) ]]( self.owner, var_6.get_alive_nonspecating_players ) )
        ...
        foreach ( var_10 in var_8 )
        {
            if ( isplayer( var_10 ) )
            {
                ...
                if ( !istrue( var_0.set_relic_team_proximity ) )
                {
                    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "perk", "hasPerk" ) )
                    {
            ...
            if ( istrue( var_0.set_relic_thirdperson ) && !self.owner helperdrone_istargetinreticle( var_10, 70, 300 ) )
                continue;
...
canseetarget( var_0 )
{
    ...
    if ( isdefined( var_0.x1fin_ontimerexpired ) )
        var_2 = var_0.x1fin_ontimerexpired;
    else
        var_2 = scripts\engine\trace::create_contents( 0, 1, 0, 1, 1, 1, 0, 1 );

    var_3 = var_0.origin;

    if ( isdefined( var_0.x1fin_playerdisconnect ) )
        var_3 = var_3 + var_0.x1fin_playerdisconnect;
...
startmarkingpassivetarget( var_0 )
{
    ...
    _id_11F01( self.targetmarkergroup, var_0, 0 );
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        if ( istrue( var_2.set_relic_thirdperson ) && !self.owner helperdrone_istargetinreticle( var_0, 70, 300 ) )
            break;
...
startmarkingtarget( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_0.x1airstrikemanager ) )
        [[ var_0.x1airstrikemanager ]]( var_4, var_0 );
    ...
    self.owner stoplocalsound( "recon_drone_marking_owner" );
    self.owner _id_11EF1( 4, self );
    _id_11F01( self.targetmarkergroup, var_0, 2 );
...
isinmarkingrange( var_0 )
{
    ...
    var_3 = scripts\engine\utility::ter_op( var_2, var_1.set_station_track_available_time, var_1.set_start_cash );

    if ( isdefined( var_0.set_relic_trex ) )
        var_3 = var_0.set_relic_trex;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_12E54( var_2, "death", "explode" );
...
helperdrone_watchforgoal()
{
    ...
    var_0 = scripts\engine\utility::_id_12E48( "goal", "near_goal", "hit_goal" );
    self.intransit = 0;
    self.inactive = 0;
...
helperdrone_watchownerloss()
{
    ...
    self endon( "leaving" );
    self endon( "explode" );
    var_0 = scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) && [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "getGameType" ) ]]() == "br";
...
removehelperdrone( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self.owner ) )
    {
        ...
        self.streakinfo.init_swivelroom_currsolution_marquee = istrue( var_2 );
...
helperdrone_returnplayer( var_0 )
{
    ...
    var_0 thread operatorsfx();
    var_0 cameraunlink( self );
    var_0 remotecontrolvehicleoff();
    scripts\cp_mp\utility\killstreak_utility::spawn_field_ai_manager_middle( var_0 );
...
helperdrone_istargetinreticle( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.x1fin_playerdisconnect ) )
        var_4 = var_4 + var_0.x1fin_playerdisconnect;

    var_5 = [ var_4 ];

    if ( isplayer( var_0 ) )
    {
        var_6 = var_0 scripts\mp\utility\player::missing_window_blockers();
