...
infil_init()
{
    ...
    if ( game["roundsPlayed"] > 0 || getdvarint( "scr_skip_infils", 0 ) == 1 || getdvarint( "scr_game_infilSkip", 0 ) == 1 || scripts\mp\utility\game::getgametype() == "br" || getdvarint( "scr_game_matchstarttime" ) < 15 || scripts\mp\utility\game::getgametype() == "war" && scripts\cp_mp\utility\game_utility::prophidetime() )
    {
        game["infil"] = undefined;
    ...
    if ( scripts\mp\gamelogic::_id_12008() )
    ...
    var_0 = undefined;
    level.playanim_aioperateturret = 0;
    ...
    foreach ( var_2 in get_all_infils() )
    {
        ...
        if ( var_2 infil_is_type( var_3 ) && var_2 infil_is_subtype( var_4 ) && scripts\mp\utility\teams::isgameplayteam( var_2.script_team ) )
        {
            ...
            var_9.players = [];
            var_9.type = var_3;
            var_9.tacinsert_destroyuselistener = var_7;
            var_9.subtype = var_8;
...
player_join_infil()
{
    ...
    thread endgame_finitewaves_music();
    player_ai_fill();
}

endgame_finitewaves_music()
{
    self endon( "disconnect" );
...
_id_12E06()
{
    ...
    while ( level.playanim_aioperateturret != 0 )
        waitframe();
