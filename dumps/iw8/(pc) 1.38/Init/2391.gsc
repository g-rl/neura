...
{
    if ( istrue( var_2 ) && propspectate( var_0, var_1 ) )
        return 1;
...
propspectate( var_0, var_1 )
{
    return var_0 _meth_87B4();
}
...
islethalmeleeweapon( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\utility\weapon::putinlaststand( var_2 ) )
        return 1;
...
attackerishittingteam( var_0, var_1 )
{
    ...
    if ( !level.teambased )
        ...
        return 0;
    else if ( isagent( var_0 ) && istrue( var_0._id_120AE ) )
        return 0;
