...
onjuggernaut()
{
    ...
    {
        self.carryobject thread setdropped();
        self switchtoweapon( scripts\mp\juggernaut::register_caves_spawners() );
    }
}
...
createcarryobject( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_6.train_attach_models_to_assembly = [];
...
zombienumtoconsume( var_0 )
{
    self.train_attach_models_to_assembly[self.train_attach_models_to_assembly.size] = var_0;
}
...
disablefeature( var_0 )
{
    ...
    foreach ( var_3 in self.train_attach_models_to_assembly )
...
carryobjectusethink()
{
    ...
    for (;;)
    {
        ...
        if ( !propspawnorigin() && var_0 scripts\mp\utility\weapon::grenadeinpullback() )
        {
...
setpickedup( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.carryobject ) || isdefined( self.carryweapon ) && !var_0 scripts\common\utility::is_weapon_allowed() || !disablefeature( var_0 ) )
    {
...
updatecarryobjectorigin()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( self.carrier ) )
        {
            ...
            scripts\engine\utility::_id_12E5A( self.objpingdelay, "dropped", "reset" );
            continue;
        }
...
createuseobject( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( istrue( var_1.rear_minigun_tag ) )
        var_7 = var_1;
    else
        var_7 = spawnstruct();

    var_7.type = "useObject";
    var_7.curorigin = var_1.origin;
    var_7.ownerteam = var_0;
    var_7.entnum = var_1 getentitynumber();
    var_7.keyobject = undefined;

    if ( issubstr( var_1.classname, "use" ) || istrue( var_1.usetype ) )
        var_7.triggertype = "use";
    else
        var_7.triggertype = "proximity";

    var_1.gameobject = var_7;
    var_7.trigger = var_1;

    for ( var_8 = 0; var_8 < var_2.size; var_8++ )
    {
        var_2[var_8].baseorigin = var_2[var_8].origin;
        var_2[var_8].baseangles = var_2[var_8].angles;
    }
    ...
    var_7.offset3d = var_3;
    var_7.compassicons = [];

    if ( !istrue( var_5 ) )
        var_7 requestid( 1, 1, var_4, var_6 );

    var_7.interactteam = "none";
    var_7.visibleteam = "none";
    var_7.onuse = undefined;
    var_7.oncantuse = undefined;
    var_7.usetext = "default";
    var_7.usetime = 10000;
    var_7.curprogress = 0;
    var_7.majoritycapprogress = 0;
    var_7.wasmajoritycapprogress = 0;
    var_7.stalemate = 0;
    var_7.wasstalemate = 0;
    var_7.exclusiveuse = 1;
    var_7.teamprogress = [];
    var_7.teamprogress["none"] = 0;

    if ( var_7.triggertype == "proximity" )
    {
        var_7.teamusetimes = [];
        var_7.teamusetexts = [];
        var_7.numtouching["neutral"] = 0;
        var_7.touchlist["neutral"] = [];
        var_7.numtouching["none"] = 0;
        var_7.touchlist["none"] = [];

        foreach ( var_10 in level.teamnamelist )
        {
            var_7.teamprogress[var_10] = 0;
            var_7.numtouching[var_10] = 0;
            var_7.touchlist[var_10] = [];
            var_7.assisttouchlist[var_10] = [];
        }

        var_7.userate = 0;
        var_7.useratemultiplier = 1.0;
        var_7.claimteam = "none";
        var_7.claimplayer = undefined;
        var_7.lastclaimteam = "none";
        var_7.lastclaimtime = 0;
        var_7.mustmaintainclaim = 0;
        var_7.cancontestclaim = 0;
        var_7 thread useobjectproxthink();
    }
    else
    {
        foreach ( var_13 in level.teamnamelist )
            var_7.teamprogress[var_13] = 0;

        var_7.userate = 1;
        var_7.useratemultiplier = 1.0;
        var_7 thread useobjectusethink();
    }
...
useobjectusethink()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.show_label ) )
        {
            if ( ![[ level.show_label ]]( var_0 ) )
                continue;
        }
...
getearliestclaimplayer()
{
    ...
    if ( isdefined( self.juggernautchallengedone ) && istrue( self.dismount_after_accum_damage ) )
    {
        if ( self.juggernautchallengedone[var_0].size > 0 )
        {
            var_2 = undefined;
            var_3 = getarraykeys( self.juggernautchallengedone[var_0] );

            for ( var_4 = 0; var_4 < var_3.size; var_4++ )
            {
                var_5 = self.juggernautchallengedone[var_0][var_3[var_4]];
        ...
        self.dismount_after_accum_damage = 0;
...
{
    if ( isdefined( self._id_124D9 ) )
        self [[ self._id_124D9 ]]( var_0 );
            ...
            if ( self.usetime )
            {
                if ( !self.stalemate )
                {
                    ...
                    if ( isdefined( self.permcapturethresholds ) )
                    {
                        ...
                        self.curprogress = self.curprogress - 0.1 * level.frameduration;
                }
...
proxtriggerthink()
{
    ...
    for (;;)
    {
        ...
        if ( istrue( self.projectileimpactthermite ) && ( var_1 scripts\mp\utility\player::isusingremote() || isdefined( var_1.spawningafterremotedeath ) ) )
            continue;

        if ( istrue( var_1.inlaststand ) && !istrue( self.trigger.binoculars_hidetargetmarker ) )
            continue;
...
triggertouchthink( var_0 )
{
    ...
    while ( scripts\mp\utility\player::isreallyalive( self ) && isdefined( var_0.trigger ) && self istouching( var_0.trigger ) && !level.gameended )
    {
        ...
        if ( istrue( self.inlaststand ) && !istrue( var_0.trigger.binoculars_hidetargetmarker ) )
            break;
        ...
        if ( istrue( var_0.docustommusicloopafternuke ) && isdefined( var_0.usecondition ) && !var_0 [[ var_0.usecondition ]]( self ) )
            break;
    ...
    if ( !isdefined( level.hostmigrationtimer ) )
    {
        ...
        else
        {
            ...
            if ( ( scripts\mp\utility\game::getgametype() == "ctf" || scripts\mp\utility\game::getgametype() == "tdef" || scripts\mp\utility\game::getgametype() == "blitz" ) && !isdefined( var_0.id ) )
            {
                ...
                if ( var_3 != 0 )
                {
                    scripts\mp\objidpoolmanager::objective_set_progress_team( var_2, self.team );
                    scripts\mp\objidpoolmanager::objective_show_progress( var_2, 1 );
                    scripts\mp\objidpoolmanager::objective_set_progress( var_2, var_3 );
                }
            }
            ...
            if ( hasdomflags() && isdefined( var_0.id ) && ( var_0.id == "domFlag" || var_0.id == "hardpoint" || var_0.id == "bomb_site" || var_0.id == "rugby_jugg" ) )
            {
                ...
                else if ( var_1 && isdefined( self.ui_dom_securing ) && ( isdefined( var_0.stalemate ) && !var_0.stalemate && !istrue( var_0.majoritycapprogress ) ) && var_0.ownerteam != self.team )
                {
                    ...
                    if ( scripts\mp\utility\game::getgametype() == "hq" )
                    {
                        ...
                        self setclientomnvar( "ui_objective_state", var_0 scripts\mp\gametypes\obj_dom.gsc::make_heli_blade_patch_clip() );
                    else
                        self setclientomnvar( "ui_objective_state", 1 );
                }
                else
                {
                    if ( !var_1 && isdefined( self.ui_dom_stalemate ) )
                    {
                        if ( isdefined( var_0.overrideprogressteam ) )
                            scripts\mp\objidpoolmanager::objective_set_progress_team( var_2, var_0.overrideprogressteam );
                        else if ( isdefined( var_0.lastprogressteam ) && var_0.lastprogressteam != var_0.claimteam )
                            scripts\mp\objidpoolmanager::objective_set_progress_team( var_2, var_0.lastprogressteam );
                        else if ( var_0.claimteam != "none" )
                            scripts\mp\objidpoolmanager::objective_set_progress_team( var_2, var_0.claimteam );
                    ...
                    else if ( scripts\mp\utility\game::getgametype() == "rugby" )
                    {
                        ...
                        if ( var_1 )
                        {
                            if ( var_0.claimteam != "none" )
                            {
                                ...
                                scripts\mp\objidpoolmanager::objective_set_progress_team( var_2, var_0.claimteam );
                                scripts\mp\objidpoolmanager::objective_show_progress( var_2, 1 );
                                scripts\mp\objidpoolmanager::objective_set_progress( var_0.objidnum, var_3 );
                            }
                        }
                        else
                ...
                if ( var_3 != 0 )
                {
                    if ( showspecificteamprogress( var_0 ) )
                        scripts\mp\objidpoolmanager::objective_show_team_progress( var_2, var_0.claimteam );
                    else
                        scripts\mp\objidpoolmanager::objective_show_progress( var_2, 1 );
                    ...
                    if ( level.teambased && isdefined( var_0.teamprogress ) && isdefined( var_0.claimteam ) && var_1 )
                    {
                        if ( !var_0.stalemate )
                        {
                            if ( isdefined( var_0.overrideprogressteam ) )
                            {
                                ...
                                scripts\mp\objidpoolmanager::objective_set_progress( var_0.objidnum, var_0.teamprogress[var_0.overrideprogressteam] / var_0.usetime );
                            }
                            else
                            {
                        ...
                        else if ( var_0.stalemate && istrue( var_0.majoritycapprogress ) )
                        {
                            ...
                            scripts\mp\objidpoolmanager::objective_set_progress_team( var_2, undefined );
                    }
                    else if ( !level.teambased )
                        scripts\mp\objidpoolmanager::objective_set_progress_client( var_2, self );
                }
            }
            else
            {
                if ( isbombmode() && isdefined( var_0.id ) && ( var_0.id == "bomb_zone" || var_0.id == "defuse_object" ) )
                {
                    if ( isdefined( self ) )
                    {
                        ...
                        if ( var_3 != 0 )
                        {
                            ...
                            {
                                scripts\mp\objidpoolmanager::objective_set_progress_team( var_2, self.team );
                                scripts\mp\objidpoolmanager::objective_show_team_progress( var_2, self.team );
...
updateuisecuring( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_1 )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" && var_3.id == "laststand_reviver" )
        {
            ...
            scripts\mp\gametypes\br.gsc::_id_12B2D( var_6, self, var_0 );
        }
    }
    else
    {
    ...
    else if ( !var_1 )
    {
        if ( isdefined( self.trigger ) && self.trigger isrevivetrigger() || isdefined( self.id ) && self.id == "rugby_jugg" )
        {
            if ( !var_0 scripts\mp\utility\perk::_hasperk( "specialty_revive_use_weapon" ) )
            {
                ...
                {
                    var_0 thread isteamvoplaying( 1 );
        ...
        if ( !isdefined( var_2 ) && !var_1 )
        {
            if ( isdefined( self.trigger ) && self.trigger isrevivetrigger() || isdefined( self.id ) && self.id == "rugby_jugg" )
            {
                if ( istrue( var_0.weaponsdisabledwhilereviving ) )
                {
                    ...
                    if ( !level.allowreviveweapons )
                    {
                        var_0 thread isteamvoplaying( 0 );
...
usetest( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( self.trigger ) && isdefined( self.trigger._id_12B8D ) && distance2dsquared( self.trigger.origin, var_0.origin ) >= self.trigger._id_12B8D )
        return 0;
    ...
    if ( istrue( self.docustommusicloopafternuke ) && isdefined( self.usecondition ) && !self [[ self.usecondition ]]( var_0 ) )
        return 0;
...
_id_11ECA( var_0, var_1, var_2, var_3, var_4 )
{
        ...
        if ( var_1 != -1 )
        {
            if ( level.codcasterenabled )
            {
                if ( isdefined( self.compassicons["codcaster"] ) )
                {
                    ...
                    scripts\mp\objidpoolmanager::_id_12AC8( var_1, var_12 );
                }
                else
                    scripts\mp\objidpoolmanager::_id_12AC9( var_1 );
            }
            ...
            if ( !var_7 )
            {
                ...
                if ( level.codcasterenabled && isdefined( self.compassicons["codcaster"] ) )
                {
                    ...
                    scripts\mp\objidpoolmanager::_id_12ACB( var_1, var_20 );
                }
