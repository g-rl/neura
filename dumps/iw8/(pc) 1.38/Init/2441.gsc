...
vehicle_occupancy_mp_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "takeRiotShield", ::_id_12CC8 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "giveRiotShield", ::_id_12CC5 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "updateRiotShield", ::_id_12CCA );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "hideCashBag", ::_id_12CC6 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "showCashBag", ::_id_12CC7 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "changedSeats", ::_id_12CC4 );
    ...
    level.vehicle._id_12D10 = getdvarint( "scr_vehicle_lights", 1 );
}
...
vehicle_occupancy_mp_onentervehicle( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !var_4 || scripts\cp_mp\vehicles\vehicle_occupancy::_id_12CB7( var_0, var_1 ) )
    ...
    if ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "risk" )
        scripts\mp\gametypes\br_plunder.gsc::vehicle_occupancy_errormessage( var_2, 0, 1 );
    ...
    if ( isdefined( var_2.team ) && isdefined( var_2.squadindex ) && istrue( var_0.israllypointvehicle ) )
        thread scripts\mp\spawnselection::x1opsspawnnpc( var_2.team, var_2.squadindex );
...
vehicle_occupancy_mp_onexitvehicle( var_0, var_1, var_2, var_3 )
{
    if ( !istrue( var_3.playerdisconnect ) && isdefined( var_2 ) )
    {
        if ( !istrue( var_3.playerdeath ) )
        {
            ...
            if ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "risk" )
                scripts\mp\gametypes\br_plunder.gsc::vehicle_occupancy_errormessage( var_2, 1, 1 );
        ...
        _id_12CC5( var_2, var_3.playerdeath, var_3.playerlaststand );

        if ( isdefined( var_2.team ) && isdefined( var_2.squadindex ) && istrue( var_0.israllypointvehicle ) )
            thread scripts\mp\spawnselection::x1opsspawnnpc( var_3.team, var_3.squadindex );
...
_id_12CC4( var_0, var_1, var_2, var_3 )
{
    var_4 = level.gametype == "br";
    ...
    if ( var_4 && isdefined( var_2 ) && isdefined( var_3 ) )
    {
        ...
        else if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_12CB7( var_1, var_3 ) )
        {
...
vehicle_occupancy_mp_updatemarkfilter( var_0 )
{
    ...
    if ( !isdefined( var_0.set_stealth_enabled ) )
        var_0.set_stealth_enabled = 1;

    var_1 = var_0.set_stealth_enabled;
    var_2 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getalloccupants( var_0 );
    var_0.set_stealth_enabled = var_2.size > 0;

    if ( var_1 && !var_0.set_stealth_enabled )
        var_0 disableplayermarks( "killstreak" );
    else if ( !var_1 && var_0.set_stealth_enabled )
        var_0 enableplayermarks( "killstreak" );

    if ( var_0.set_stealth_enabled )
    {
        if ( level.teambased )
        {
            var_3 = [];
...
_id_12CC6( var_0, var_1, var_2, var_3 )
{
    var_4 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( var_0.vehiclename, var_1 );

    if ( istrue( var_4._id_1203A ) )
        return;

    if ( isdefined( level.select_top_roof_spawners ) && scripts\engine\utility::array_contains( level.select_top_roof_spawners, var_2 ) )
    {
        if ( isdefined( var_2.br_endgamesplashcallback ) )
        {
...
_id_12CC7( var_0, var_1, var_2, var_3 )
{
    var_4 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( var_0.vehiclename, var_1 );
...
_id_12CC5( var_0, var_1, var_2 )
{
    if ( isdefined( var_0._id_11B3E ) )
    {
        if ( !istrue( var_1 ) && !istrue( var_2 ) )
        {
            ...
            var_0 scripts\mp\class::_id_127E7();
