...
_id_11FF0( var_0 )
{
    if ( var_0.basename == "molotov" || var_0.basename == "molotov_mp" || istrue( var_0.propkilledend ) )
        return 1;
...
wasdamagedbyexplosive()
{
    if ( isdefined( self.damagemod ) )
    {
        ...
        if ( isdefined( self.damageweapon ) && _id_11FF0( self.damageweapon ) )
            return 1;
...
allow_init()
{
    ...
    allow_add( "usability_auto_use", ::binoculars_endadslogic );
    ...
    allow_add( "offhand_throwback", ::binoculars_checkexpirationtimer );
    ...
    allow_add( "cp_munitions", ::bigtimer );
    allow_add( "nvg", ::binoculars_cansee );
    allow_add( "ascender_use", ::bhasthermitestucktoshield );
}
...
binoculars_endadslogic( var_0, var_1 )
{
    var_2 = scripts\common\input_allow::allow_input_internal( "usability", var_0, var_1 );
...
binoculars_checkexpirationtimer( var_0, var_1 )
{
...
binoculars_cansee( var_0, var_1, var_2 )
{
    var_3 = 2;
...
bhasthermitestucktoshield( var_0, var_1 )
{
...
_id_12965( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( !isdefined( var_0 ) )
        return;
