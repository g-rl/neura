...
giveplayerscore( var_0, var_1, var_2 )
{
    ...
    var_5 scripts\common\utility::_id_12965( level.set_up_minigun, var_0 );
...
giveteamscoreforobjective( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    else if ( level.roundscorelimit > 1 && !istrue( level.dontendonscore ) )
    {
        ...
        {
            if ( level scripts\mp\utility\game::recharge_equipment_update_state( var_7 ) )
                continue;
    ...
    if ( isdefined( var_5 ) )
        ...
        var_9 = deactivate_battle_station( var_2 );

    if ( !istrue( var_4 ) )
        vehicle_is_ambient( var_9, var_2, level.waswinning );
...
vehicle_is_ambient( var_0, var_1, var_2 )
{
...
playleadtakendialog( var_0 )
{
    ...
    level.lastscorestatustime = gettime();
    var_1 = deactivate_battle_station( var_0 );
...
updateteamscore( var_0 )
{
    if ( scripts\mp\utility\game::recharge_equipment_update_state( var_0 ) )
        return;
...
processassist_regularmp( var_0, var_1, var_2 )
{
    ...
    thread scripts\cp\helicopter\chopper_boss::onplayerkillassist( var_0 );
}
