...
{
    level.useobjs = [];
    scripts\engine\scriptable::_id_11CDB( "hack_usable", ::init_cardprinter );
    thread _updateuseobjs();
}

init_cardprinter( var_0, var_1, var_2, var_3, var_4 )
{
    init_carepackages( var_0.entity, var_3 );
}

init_carepackages( var_0, var_1 )
{
    var_2 = var_0;
    var_2.isbeingused = 1;
...
_deployhacktablet( var_0, var_1 )
{
    ...
    var_4 = scripts\cp_mp\killstreaks\killstreakdeploy::switchtodeployweapon( var_2, var_3, ::_waituntilinteractfinished, ::addallkillstreaksunlockedinonelife, undefined, undefined, ::_ontabletputaway );
...
addallkillstreaksunlockedinonelife( var_0, var_1 )
{
    _toggletabletallows( 1 );
    thread activate_destructible_cinderblocks();
    thread activate_all_targets( var_0 );
    return 1;
}
...
activate_destructible_cinderblocks()
{
    level endon( "game_ended" );
    self endon( "disconnect" );
    scripts\engine\utility::_id_12E3F( "death", "tabletPutAway" );
