...
onenteroob( var_0 )
{
    ...
    if ( isplayer( var_0 ) )
    {
        if ( isdefined( level.shouldrecorddamagestats ) )
            var_1 = level.shouldrecorddamagestats;
        else
    ...
    else
    {
        ...
        var_5 = getoutofboundstime( var_3, var_0._id_11AC3 );
...
onexitoob( var_0, var_1, var_2 )
{
    ...
    if ( isplayer( var_0 ) )
    {
        if ( isdefined( level.shouldreflect ) )
            var_3 = level.shouldreflect;
        else
...
watchoobtriggerenter( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isplayer( var_1 ) && scripts\mp\utility\game::questtimerupdate( var_1 ) )
            continue;
...
{
    if ( istrue( var_1 ) )
        return scripts\mp\utility\game::matchdata_logmultikill();

    if ( isdefined( var_1 ) && !var_1 )
        return scripts\mp\utility\game::matchdata_logkillstreakevent();
    ...
    switch ( var_0 )
    {
        ...
        case "br":
            return scripts\mp\utility\game::matchdata_loggameevent();
        case "default":
