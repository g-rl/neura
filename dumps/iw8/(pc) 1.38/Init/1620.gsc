...
asm_init( var_0, var_1 )
{
    ...
    self.fnasm_playfacialanim = ::bot_pick_new_loadout_next_spawn;
    ...
    level.ismortartargeted = ::body0;
    level.ismountconfigenabled = ::boardroomopen;
    level.isminigunweapon = ::boardroomopen;
    hack_setup_a_struct();
    var_2 = var_0;
...
{
    bot_pick_dd_zone_with_fewer_defenders( var_0, var_1, var_2, var_3, "end" );
}
...
doorneedstoclose( var_0 )
{
    ...
    var_4 = angleclamp180( var_3 - var_0.enemy_push_players_logic[1] );
    var_5 = angleclamp180( var_0.angles[1] - var_0.enemy_push_players_logic[1] );
...
bot_pick_new_loadout_next_spawn( var_0, var_1, var_2 )
{
    self setfacialindexfromasm( var_0, var_1, var_2 );
}

bot_pick_new_zone( var_0, var_1 )
{
    if ( !scripts\asm\shared\utility::isfacialstateallowed( "asm" ) )
        return;

    if ( isdefined( var_0 ) && bot_parachute_into_map( var_0 ) )
        return;
