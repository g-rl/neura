...
_id_12C42()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_damage", "giveScore", ::_id_12C35 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_damage", "giveAward", ::_id_12C34 );
}

_id_12C35( var_0, var_1, var_2 )
{
    if ( istrue( var_2 ) )
