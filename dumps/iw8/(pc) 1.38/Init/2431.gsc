...
light_tank_mp_initspawning()
{
    ...
    var_0.ai_goal_distribution_debug = scripts\cp_mp\vehicles\light_tank::light_tank_timeout;

    if ( scripts\mp\utility\game::getgametype() == "arm" )
    {
        var_0.ai_goal_update_population = 105;
        var_0._id_11AA0 = level._id_12644;
    }
    else
        var_0.ai_goal_update_population = 40;
}
...
light_tank_mp_createownercaptureobject( var_0, var_1 )
{
    var_2 = scripts\cp_mp\vehicles\vehicle::_id_12C70( var_0, "tur_bradley_mp" );
...
light_tank_mp_createothercaptureobject( var_0 )
{
    var_1 = scripts\cp_mp\vehicles\vehicle::_id_12C70( var_0, "tur_bradley_mp" );
...
light_tank_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::_id_12CEC( "light_tank", var_1, var_2 );
    ...
    if ( isdefined( var_3 ) )
    {
        if ( scripts\mp\utility\game::getgametype() == "arm" )
        {
            ...
            if ( istrue( level._id_12061 ) )
                scripts\mp\gametypes\arm.gsc::_id_12C1D( var_3, var_3.team );
