...
adddeathicon( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_2.resetmlgobjectivestatusicon ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( var_2.resetmlgobjectivestatusicon );
        var_2.resetmlgobjectivestatusicon = undefined;
    }
    ...
    var_13 = var_5;
    var_14 = var_5;
    var_2.resetmlgobjectivestatusicon = var_2 scripts\cp_mp\entityheadicons::setheadicon_singleimage( var_10, var_9, undefined, 1, 0, 0, undefined, undefined, var_13, var_12, var_14 );

    if ( isdefined( var_2.resetmlgobjectivestatusicon ) )
    {
        if ( var_5 || var_6 )
            var_2 thread nuke_vault_riotshield_internal( var_7 );
        else
            var_2 thread destroyslowly( var_4 );
    }
}

nuke_vault_riotshield_internal( var_0 )
{
    self endon( "removed_death_icon" );
    var_1 = self.team;
    var_2 = self.resetmlgobjectivestatusicon;

    if ( !var_0 )
        nuke_explposstruct( var_2, var_1 );
    ...
    if ( isdefined( self ) )
        self.resetmlgobjectivestatusicon = undefined;
}

nuke_explposstruct( var_0, var_1 )
{
    ...
    foreach ( var_6 in var_4 )
    {
        ...
        scripts\cp_mp\entityheadicons::_id_11EB0( var_0, var_6 );
    }
...
destroyslowly( var_0 )
{
    ...
    if ( isdefined( var_1 ) )
        var_1.resetmlgobjectivestatusicon = undefined;
}

outofboundstriggersspawned( var_0 )
{
    if ( !isdefined( var_0 ) || !isdefined( var_0.resetmlgobjectivestatusicon ) )
        return;

    scripts\cp_mp\entityheadicons::_id_11EB0( var_0.resetmlgobjectivestatusicon, var_0 );
}
...
_id_11A19( var_0 )
{
    ...
    scripts\cp_mp\entityheadicons::setheadicon_deleteicon( var_0.resetmlgobjectivestatusicon );
    var_0.resetmlgobjectivestatusicon = undefined;
...
addenemydeathicon( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_1.resetpetstats ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( var_1.resetpetstats );
        var_1.resetpetstats = undefined;
    }
    ...
    var_10 = var_1.origin;
    var_1.resetpetstats = var_1 scripts\cp_mp\entityheadicons::setheadicon_singleimage( var_2, var_6, undefined, var_7, var_8, var_9, undefined, undefined, undefined, var_10 );
