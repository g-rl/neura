...
updatesharpfocus()
{
    ...
    var_1 = undefined;
    var_2 = scripts\mp\utility\weapon::_id_12FE2( var_0 );
...
updatedefaultflinchreduction()
{
    ...
    var_0 = undefined;
    var_1 = scripts\mp\utility\weapon::_id_12FE2( self.currentweapon );
...
ammodisabling_run( var_0 )
{
    ...
    scripts\engine\utility::_id_12E53( 0.8, "death" );
...
applystunresistence( var_0, var_1, var_2 )
{
    if ( var_1 scripts\mp\utility\perk::_hasperk( "specialty_stun_resistance" ) && var_0 != var_1 )
    {
        ...
        if ( istrue( scripts\cp_mp\utility\player_utility::playersareenemies( var_3, var_4 ) ) )
            var_1 scripts\cp\helicopter\chopper_boss::resistedstun( var_3 );
    }
...
watchpainted( var_0, var_1 )
{
    ...
    self endon( "disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_12E53( var_1, "death" );
    self.painted = 0;
...
watchpaintedagain( var_0 )
{
    self endon( "disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_12E3F( "painted_again", "painted_end" );
    scripts\mp\utility\outline::outlinedisable( var_0, self );
}
...
boomtrackplayerdeath( var_0, var_1 )
{
    ...
    var_2 = scripts\engine\utility::_id_12E53( 7.0, "death" );
...
unsetcustomjuicedondeath()
{
    self endon( "disconnect" );
    self endon( "unset_custom_juiced" );
    scripts\engine\utility::_id_12E3F( "death", "faux_spawn" );
...
unsetcustomjuicedonmatchend()
{
    self endon( "disconnect" );
    self endon( "unset_custom_juiced" );
    level scripts\engine\utility::_id_12E3F( "round_end_finished", "game_ended" );
    thread unsetcustomjuiced();
}
...
setextraammo()
{
    ...
    foreach ( var_2 in var_0 )
    {
        if ( isdefined( var_2 ) && !nullweapon( var_2 ) && var_2 hasattachment( "maxammo" ) && !istrue( var_2.first_equipped ) )
        {
...
watchlifepackoutlinestate( var_0 )
{
    ...
    for (;;)
    {
        var_0 scripts\engine\utility::_id_12E3F( "enabled_life_pack_boost", "disabled_life_pack_boost" );
        setlifepackoutlinestate( var_0 );
    }
}
...
{
    self endon( "death" );
    var_0 scripts\engine\utility::_id_12E3F( "death_or_disconnect", "toughen_up_end" );
...
_id_1208E( var_0, var_1, var_2, var_3 )
{
    var_4 = var_1 - var_2;
    ...
    var_8 = scripts\engine\math::get_request_backup_alias( var_7 );
    ...
    foreach ( var_28, var_8 in level.sixth_sense_players )
    {
        ...
        if ( var_2 && !isbot( var_8 ) )
        {
            ...
            foreach ( var_13 in var_11 )
            {
                ...
                if ( !var_8 _id_1208E( var_13, var_10, var_14, var_15 ) )
                    continue;

                var_9 = var_9 | var_8 minigun_shots_per_round( var_13 );
            }
        }
        else
        {
            ...
            foreach ( var_13 in level.players )
            {
                ...
                if ( _id_1208F( var_18, var_10, var_14 ) )
                {
                    var_3 = var_3 + 2;
                    var_20 = [ var_8 ];
...
setovercharge()
{
    thread scripts\mp\trials\trial_target_utility::_id_11E97( "ui_overcharge", 1 );
}

unsetovercharge()
{
    thread scripts\mp\trials\trial_target_utility::_id_11E97( "ui_overcharge", 0 );
}
...
outlinekillstreaks_enablemarksafterprematch()
{
    ...
    if ( isdefined( self ) )
    {
        ...
        _applydvarstosettings::_id_12C12( self );
    }
}
...
{
    self giveweapon( self._id_1270A );
    self assignweaponmeleeslot( self._id_1270A );
    thread watchthrowingknifescavenge();

    if ( self._id_1270A == "iw8_throwingknife_fire_melee_mp" )
        thread _id_12F68();
    else if ( self._id_1270A == "iw8_throwingknife_electric_melee_mp" )
        thread _id_12F67();
}

unsetthrowingknifemelee()
{
    if ( isdefined( self._id_1270A ) && self hasweapon( self._id_1270A ) )
        self takeweapon( self._id_1270A );

    self notify( "specialty_equip_throwingKnife_end" );

    if ( isdefined( self._id_1270A ) && self._id_1270A == "iw8_throwingknife_fire_melee_mp" )
        remove_bank_lbravos();
    else if ( isdefined( self._id_1270A ) && self._id_1270A == "iw8_throwingknife_electric_melee_mp" )
...
{
    self.player scripts\engine\utility::_id_12E3F( "disconnect", "unsetBulletOutline" );
...
markempsignatures( var_0, var_1 )
{
    ...
    var_0 scripts\engine\utility::_id_12E3F( "death", "cloak_end" );
...
startgpsjammer()
{
    ...
    for (;;)
    {
        ...
        if ( scripts\mp\class::reason_stealth_broken( var_0 ) )
            continue;
...
ghostadvanceduavwatcher()
{
    ...
    for (;;)
    {
        if ( level.teambased )
        {
            var_0 = level.allassassin_initteamlist - level.activeadvanceduavs[self.team] > 0;
        ...
        else
        {
            foreach ( var_2 in level.players )
            {
                ...
                if ( istrue( level.activeadvanceduavs[var_2.guid] ) && level.activeadvanceduavs[var_2.guid] > 0 )
                {
                    self setplayeradvanceduavdot( 1 );
                    self setplayerghost( 0 );

                    while ( istrue( level.activeadvanceduavs[var_2.guid] ) && level.activeadvanceduavs[var_2.guid] > 0 )
...
{
    self endon( "groundPoundShield_deleteShield" );
    scripts\engine\utility::_id_12E3F( "death_or_disconnect", "groundPound_unset" );
    thread groundpoundshield_deleteshield( var_0 );
}
...
{
    var_0 endon( "death" );
    scripts\engine\utility::_id_12E3F( "death_or_disconnect", "battleSlide_unset" );
    var_0 delete();
}
...
thrusterstopfx()
{
    self endon( "death_or_disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_12E3F( "doubleJumpBoostEnd", "thruster_unset" );
    waitframe();
}
...
{
    scripts\engine\utility::_id_12E3F( "ADSTargetMarkUnset", "death_or_disconnect" );
...
setkillstreaktoscorestreak()
{
    ...
    if ( isdefined( self.pers["killstreakToScorestreak_lifeId"] ) && self.pers["killstreakToScorestreak_lifeId"] == self.lifeid )
    {
        ...
        var_0 = remappedhpzoneorder( self.streakpoints );
...
unsetkillstreaktoscorestreak()
{
    ...
    var_0 = remindermessage( self.streakpoints );
    scripts\mp\killstreaks\killstreaks::updatestreakcosts();
    scripts\mp\killstreaks\killstreaks::setstreakpoints( var_0 );
    scripts\mp\killstreaks\killstreaks::checkstreakreward( self.streakpoints, 1 );
    scripts\mp\killstreaks\killstreaks::updatestreakmeterui();
...
proximityrevivethink()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_7 in var_5 )
        {
            if ( istrue( var_7.inlaststand ) && !istrue( var_7.stuckinlaststand ) && !istrue( var_7.laststandhealisactive ) && !istrue( var_7 scripts\mp\playerlogic::lootchopper_setupdamagefunctionality() ) && !isdefined( var_0.owner ) )
        ...
        if ( isdefined( level.revivetriggers ) )
        {
            foreach ( var_10 in level.revivetriggers )
            {
                ...
                {
                    if ( !istrue( var_10.trigger.owner scripts\mp\playerlogic::lootchopper_setupdamagefunctionality() ) && !isdefined( var_0.owner ) )
                    {
...
proximityrevive( var_0, var_1, var_2 )
{
    ...
    var_0 scripts\mp\playerlogic::_id_11E85( 1 );
    var_1.owner = var_0;
...
watchproximityrevivefail( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_0 scripts\mp\playerlogic::_id_11E85( 0 );
        var_0 scripts\mp\gameobjects::updateuiprogress( var_1, 0 );
        var_0 scripts\mp\utility\player::_freezecontrols( 0, undefined, "proximityRevive" );
...
regendelayreduce_onkill()
{
    ...
    thread x1playerspawnoverride();
}

x1playerspawnoverride()
{
    level endon( "game_ended" );
    self endon( "death_or_disconnect" );
...
_id_11EF2()
{
    if ( isdefined( self.resettimeronkill ) && self.resettimeronkill == gettime() )
        regendelayreduce_onkill();
}
...
rechargeequipment_updateslot( var_0, var_1 )
{
    ...
    if ( isdefined( level.keypad_activate_func ) )
        var_7 = level.keypad_activate_func;
    else
        var_7 = scripts\engine\utility::ter_op( scripts\mp\utility\game::getgametype() == "br", 0.01, 0.02 );

    if ( var_1 == "secondary" && var_4 < var_5 && var_6 > 1 )
        var_2.progress[var_1] = var_2.progress[var_1] + var_7 * 2;
    else if ( var_4 < var_5 )
        var_2.progress[var_1] = var_2.progress[var_1] + var_7;
    else
        var_2.progress[var_1] = 0;
...
rechargeequipment_updateui( var_0 )
{
    ...
    var_0 setpowerprogress( "primary", var_1 );
    var_0 setpowerprogress( "secondary", var_2 );
}
    ...
    while ( isdefined( self.markequipmentstate.markingent ) && !istrue( self.ishacking ) )
    {
        ...
        if ( !scripts\engine\utility::array_contains( self.markequipmentstate.markedents, self.markequipmentstate.markingent ) )
        {
            if ( scripts\mp\utility\player::isplayerads() )
            {
                ...
                if ( level.teambased && _applydvarstosettings::_id_12C08( self.markequipmentstate.markingent ) )
                {
                    self.markequipmentstate.markingent._id_12687 = self.team;
                    var_7 = scripts\mp\utility\player::getteamarray( self.markequipmentstate.markingent._id_12687 );

                    foreach ( var_9 in var_7 )
                        _applydvarstosettings::_id_12C14( self.markequipmentstate.markingent, var_9 );
                }
...
unmarkafterduration( var_0 )
{
    ...
    scripts\engine\utility::_id_12E59( var_1, "disconnect" );
    unmarkent( var_0 );
}
...
unmarkent( var_0 )
{
    ...
    if ( isdefined( var_0._id_12687 ) )
    {
        if ( level.teambased && _applydvarstosettings::_id_12C08( var_0 ) )
        {
            var_1 = scripts\mp\utility\player::getteamarray( var_0._id_12687 );

            foreach ( var_3 in var_1 )
                _applydvarstosettings::_id_12C14( var_0, var_3 );
        }

        var_0._id_12687 = undefined;
    }
...
_id_11E86()
{
    ...
    self.obj_caches_threaded_nags_vo = 1;
    _id_12B2F( self.team );
    thread get_turret_target_pos();
}
...
get_turret_target_pos()
{
    var_0 = self.team;
    self endon( "cancel_better_mission_rewards_unset" );
    scripts\engine\utility::_id_12E3F( "spawned_player", "disconnect" );

    if ( isdefined( self ) )
        self.obj_caches_threaded_nags_vo = undefined;
...
_id_12B2F( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_quest_util.gsc::min_y( var_0 );

    if ( !isdefined( level.building_roof_jugg_protect_roof_then_chase ) )
        level.building_roof_jugg_protect_roof_then_chase = [];

    var_2 = 0;

    if ( isdefined( level.building_roof_jugg_protect_roof_then_chase[var_0] ) )
        var_2 = level.building_roof_jugg_protect_roof_then_chase[var_0];

    var_3 = var_1 - var_2;

    if ( var_3 != 0 )
        scripts\mp\gametypes\br_quest_util.gsc::amounttotal( var_0, var_3 );

    level.building_roof_jugg_protect_roof_then_chase[var_0] = var_1;
}

_id_11EFB()
{
    self sethasspecialistbonus( 1 );
