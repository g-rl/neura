...
prematchperiod()
{
    ...
    if ( getdvarint( "scr_live_lobby", 0 ) == 1 && !istrue( level._id_120B6 ) )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            ...
            level thread scripts\mp\gametypes\br_public.gsc::checkpoint_fx();
...
teamstarttimer( var_0, var_1, var_2 )
{
    ...
    if ( !level.gameended )
    {
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            thread scripts\mp\gametypes\br_public.gsc::votes( var_0 );
            thread scripts\mp\gametypes\br_public.gsc::vo_two_remain( var_0 );
            thread scripts\mp\gametypes\br_public.gsc::bonus_target_hit();
        }
...
trigger_water_fx( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        foreach ( var_2 in level.players )
        {
            ...
            {
                if ( scripts\mp\utility\game::getgametype() == "br" )
                    var_4 = scripts\mp\gametypes\br_public.gsc::minshotstostage3acc( var_2.team, var_2.squadindex );
                else
...
nuke_vault_alarm_on()
{
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        if ( !scripts\mp\utility\game::privatematch() && !scripts\mp\gametypes\br_public.gsc::processvoqueue() )
        {
            var_0 = [];
            ...
            foreach ( var_2 in level.players )
            {
                ...
                if ( isdefined( var_2.triggeraddobjectivetext ) && var_2.triggeraddobjectivetext )
                {
                    ...
                    {
                        var_0[var_5] = var_3;
                        var_7 = scripts\mp\gametypes\br_public.gsc::minshotstostage3acc( var_2.team, var_2.squadindex );
                        var_8 = [];
...
endgame_endgame( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\gametypes\br_public.gsc::processvoqueue() && !level.forcedend )
    {
    ...
    var_4 = scripts\mp\gametypes\br_gametypes.gsc::propsetflashesleft( "endGameIntermission" );
    ...
    if ( !level.doingbroshot )
    {
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            scripts\mp\gametypes\br_circle.gsc::outofboundstriggersplanetrace();
    ...
    if ( scripts\mp\gametypes\br_public.gsc::processvoqueue() && isdefined( level.add_to_spawn_count_from_group ) && level.add_to_spawn_count_from_group == 2 )
    {
