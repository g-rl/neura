...
light_tank_initoccupancy()
{
    ...
    var_4._id_129D5 = getcompleteweaponname( "tur_bradley_mp" );
    ...
    var_4._id_129D5 = getcompleteweaponname( "tur_gun_lighttank_mp" );
    var_4.stoppingpower_clearhcrongameended = "ping_vehicle_gunner";
}

run_lbravo_spawner()
{
    var_0 = _accessreaderscriptableused::_id_12BF1( "light_tank", 1 );
    var_0.br_onvehicledeath = 2.5;
    var_0.get_random_station_names_on_track = 0.625;
    var_0.gate_closes = 350;
    var_0.gate_flares_think = 525;
    var_0.gasvfxstructs = 875;
    var_0.gcd = 1.25;
    var_0.generate_achievementid = 5;
    var_0.gatherstadiumlocs = 10;
...
light_tank_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12C7B( "light_tank", "single", [ "driver", "gunner" ] );
}

run_maze_ai_common_function_stealth()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_12D33( "light_tank", 1 );
    var_0.id = 1;
    var_0.seatids["driver"] = 0;
    var_0.seatids["gunner"] = 1;
    var_0.blockade_barbwires["turret"] = 0;
    var_0.blockade_barbwires["missile"] = 1;
    var_0.blockade_barbwires["smoke"] = 2;
    var_0._id_11B87[0] = 0;
    var_0._id_11B87[1] = 1;
    var_0._id_11B88["driver"]["lighttank_mp"] = 0;
    var_0._id_11B88["driver"]["tur_gun_lighttank_mp"] = 1;
    var_0._id_11B88["driver"]["tur_gun_lighttank_ks_mp"] = 1;
    var_0._id_11B88["gunner"]["tur_bradley_mp"] = 0;
    var_0._id_11B88["gunner"]["tur_bradley_ks_mp"] = 0;
    var_0._id_11B88["gunner"]["tur_gun_lighttank_mp"] = 1;
    var_0._id_11B88["driver"]["tur_gun_lighttank_ks_mp"] = 1;
}

run_lbravos_safehouse()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C4B( "light_tank", 3000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "light_tank" );
    var_0.class = "super_heavy";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C1F( "light_tank" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C57( "light_tank", 15 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C55( "light_tank", ::light_tank_premoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C54( "light_tank", ::light_tank_postmoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C50( "light_tank", ::light_tank_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C5A( "lighttank_tur_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C5A( "lighttank_tur_ks_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C5A( "bradley_tow_proj_mp", 7 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C5A( "bradley_tow_proj_ks_mp", 7 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C5A( "lighttank_mp", 5 );
}
...
light_tank_create( var_0, var_1 )
{
    ...
    var_2.propspeedscale = var_0.spawntype == "KILLSTREAK";
    var_3 = light_tank_createdriverturret( var_2, var_0 );
    var_3.missilesleft = 2;
    var_3.lastmissilefired = 0;
    scripts\cp_mp\vehicles\vehicle::_id_12CDB( var_2, var_3, getcompleteweaponname( "tur_bradley_mp" ), 1 );
    var_3 = light_tank_creategunnerturret( var_2, var_0 );
    scripts\cp_mp\vehicles\vehicle::_id_12CDB( var_2, var_3, getcompleteweaponname( "tur_gun_lighttank_mp" ) );
    scripts\cp_mp\vehicles\vehicle::_id_12C1A( var_2, "light_tank", var_0 );
    var_2.objweapon = getcompleteweaponname( "lighttank_mp" );
    var_2 light_tank_updateheadicon();
    var_4 = scripts\cp_mp\vehicles\vehicle_damage::_id_12C2D( var_2, 1 );
    var_4.getknivesoutsetting = "none";
    ...
    var_2 thread run_module_pause_funcs();
    var_2 thread run_module_unpause_funcs();
...
{
    var_2 = light_tank_getleveldata();
    var_3 = scripts\cp_mp\vehicles\vehicle::_id_12C70( var_0, "tur_bradley_mp" );
    var_4 = undefined;
...
light_tank_explode( var_0, var_1, var_2 )
{
    ...
    {
        self.streakinfo.init_swivelroom_currsolution_marquee = 1;
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        if ( run_spawnfuncs( self.spawndata ) )
...
light_tank_airdrop( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_8 hide();
    var_9 = scripts\cp_mp\vehicles\vehicle::_id_12C71( var_8 );
...
light_tank_airdropinternal()
{
    ...
    {
        self.vehicle show();
        var_0 = scripts\cp_mp\vehicles\vehicle::_id_12C71( self.vehicle );
...
run_spawn_module_till_kill_trig( var_0 )
{
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::_id_12C70( self, "tur_bradley_mp" );
    var_0 endon( "death" );
    var_0.shotsleft = 8;
    ...
    for (;;)
    {
        var_1 = var_0 scripts\engine\utility::_id_12E47( "turret_fire", "turret_reload" );
...
run_module_pause_funcs()
{
    ...
    for (;;)
    {
        ...
        var_2 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getseatoccupant( self, "driver" );
        var_1 thread run_techo_spawner( var_2 );
...
{
    self endon( "death" );
    var_1 = scripts\cp_mp\vehicles\vehicle::_id_12C70( self, "tur_bradley_mp" );
...
run_suppression_logic()
{
    ...
    for (;;)
    {
        var_0 = run_kill_watcher();
        self notifyonplayercommand( "light_tank_missile", var_0 );
        var_1 = scripts\engine\utility::_id_12E4E( "input_type_changed", "missile_handling_ended" );
...
{
    wait 0.33;
    var_2 = scripts\cp_mp\vehicles\vehicle::_id_12C70( self, "tur_bradley_mp" );
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::_id_12C70( self, "tur_gun_lighttank_mp" );
...
light_tank_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_1 == "driver" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::_id_12C70( var_0, "tur_bradley_mp" );
        var_5.owner = var_3;
        ...
        var_3 thread run_suppression_logic();
    ...
    else if ( var_1 == "gunner" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::_id_12C70( var_0, "tur_gun_lighttank_mp" );
        var_5.owner = var_3;
        var_5 setotherent( var_3 );
        var_5 setentityowner( var_3 );
        var_5 setsentryowner( var_3 );
...
run_juggheli_extraction( var_0 )
{
    ...
    var_0 scripts\cp_mp\utility\damage_utility::adddamagemodifier( "ltGunnerMissileRedux", 0.4, 0, ::run_laser_vfx_loop );
}
...
run_laser_vfx_loop( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
run_stealth_funcs( var_0 )
{
    ...
    self.owner scripts\cp_mp\utility\killstreak_utility::x1loadout( var_0 );
}
...
light_tank_premoddamagecallback( var_0 )
{
    ...
    if ( vectordot( var_5, var_6 ) < -0.83 )
        var_0.radar_sweeps = canweapondealcriticaldamage( var_0 );
...
light_tank_updateheadiconforplayer( var_0 )
{
    ...
    if ( isdefined( var_1 ) && var_1 == self )
        scripts\cp_mp\entityheadicons::_id_11EB0( self.headicon, var_0 );
    else
    {
        var_2 = undefined;
        ...
        if ( level.teambased )
        {
            if ( var_3 == "neutral" )
            {
                ...
                {
                    if ( 1 )
                        scripts\cp_mp\entityheadicons::_id_11EAF( self.headicon, var_0 );
                    else
                        scripts\cp_mp\entityheadicons::_id_11EB0( self.headicon, var_0 );
...
light_tank_tryusefromstruct( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_6 = scripts\cp_mp\vehicles\vehicle::_id_12C71( var_5 );

        foreach ( var_8 in var_6 )
            var_8.streakinfo = var_0;

        var_5 thread run_stealth_funcs( var_0 );
    }
...
{
    var_3 = scripts\cp_mp\vehicles\vehicle::_id_12C71( var_0 );
