...
updateweaponbufferedstats( var_0 )
{
    ...
    var_6 = getweaponvariantindex( var_1 );
    persincrement_weaponstats( var_2, var_6 );
    ...
    if ( !scripts\mp\utility\weapon::ispickedupweapon( var_1 ) || istrue( level.delay_end_soldiers_spawns ) )
        perslog_weaponstats( var_2, var_6, var_0 );

    var_7 = getweaponattachments( var_1 );

    foreach ( var_3 in var_7 )
    {
        var_9 = scripts\mp\utility\weapon::attachmentmap_tobase( var_3 );

        if ( !scripts\mp\utility\weapon::attachmentlogsstats( var_9, var_1 ) )
            continue;
        ...
        perslog_attachmentstats( var_9, var_1 );
    }
...
{
    if ( self.trackingweaponshots > 0 )
        scripts\common\utility::_id_12965( level.set_up_rear_minigun, var_0, "shots", self.trackingweaponshots, var_1, var_2 );

    if ( self.trackingweaponkills > 0 )
        scripts\common\utility::_id_12965( level.set_up_rear_minigun, var_0, "kills", self.trackingweaponkills, var_1, var_2 );

    if ( self.trackingweaponhits > 0 )
        scripts\common\utility::_id_12965( level.set_up_rear_minigun, var_0, "hits", self.trackingweaponhits, var_1, var_2 );

    if ( self.trackingweaponheadshots > 0 )
        scripts\common\utility::_id_12965( level.set_up_rear_minigun, var_0, "headshots", self.trackingweaponheadshots, var_1, var_2 );

    if ( self.trackingweapondeaths > 0 )
        scripts\common\utility::_id_12965( level.set_up_rear_minigun, var_0, "deaths", self.trackingweapondeaths, var_1, var_2 );
}
...
perslog_attachmentstats( var_0, var_1 )
{
    ...
    if ( self.trackingweaponshots > 0 && var_0 != "tactical" )
    {
        ...
        scripts\common\utility::_id_12965( level.set_tier_lights, var_0, "shots", self.trackingweaponshots, var_1 );
    }

    if ( self.trackingweaponkills > 0 && var_0 != "tactical" )
    {
        incrementattachmentstat( var_0, "kills", self.trackingweaponkills, var_1 );
        scripts\common\utility::_id_12965( level.set_tier_lights, var_0, "kills", self.trackingweaponkills, var_1 );
    }

    if ( self.trackingweaponhits > 0 && var_0 != "tactical" )
    {
        incrementattachmentstat( var_0, "hits", self.trackingweaponhits, var_1 );
        scripts\common\utility::_id_12965( level.set_tier_lights, var_0, "hits", self.trackingweaponhits, var_1 );
    }
    ...
    if ( self.trackingweaponheadshots > 0 && var_0 != "tactical" )
    {
        ...
        scripts\common\utility::_id_12965( level.set_tier_lights, var_0, "headShots", self.trackingweaponheadshots, var_1 );
    }

    if ( self.trackingweapondeaths > 0 )
    {
        incrementattachmentstat( var_0, "deaths", self.trackingweapondeaths, var_1 );
        scripts\common\utility::_id_12965( level.set_tier_lights, var_0, "deaths", self.trackingweapondeaths, var_1 );
    }
}
