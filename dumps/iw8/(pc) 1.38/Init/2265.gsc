...
tac_rover_initoccupancy()
{
    ...
    var_3.stoppingpower_clearhcrongameended = "ping_vehicle_driver";
    var_2 = "fr_passenger";
    var_3 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( "tac_rover", var_2, 1 );
    var_3.seatswitcharray = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_generateseatswitcharray( var_2, var_1 );
    ...
    var_3.stoppingpower_clearhcrongameended = "ping_vehicle_rider";
    var_2 = "bl_passenger";
    var_3 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( "tac_rover", var_2, 1 );
    var_3.seatswitcharray = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_generateseatswitcharray( var_2, var_1 );
...
tac_rover_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12C7B( "tac_rover", "single", [ "driver", "fr_passenger", "bl_passenger", "br_passenger" ] );
}

_id_125ED()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_12D33( "tac_rover", 1 );
    var_0.id = 3;
...
_id_125EC()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C4B( "tac_rover", 750 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "tac_rover" );
    var_0.class = "light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C1F( "tac_rover" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12C57( "tac_rover", 5 );

    if ( level.gametype == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::_id_12C58( "tac_rover", 8, "semtex_aalpha12_mp" );

    scripts\cp_mp\vehicles\vehicle_damage::_id_12C50( "tac_rover", ::tac_rover_deathcallback );
}

_id_125EB()
{
    var_0 = _accessreaderscriptableused::_id_12BF1( "tac_rover", 1 );
    var_0.br_onvehicledeath = 1.83333;
    var_0.get_random_station_names_on_track = 0.79166;
    var_0.gate_closes = 350;
    var_0.gate_flares_think = 525;
    var_0.gasvfxstructs = 875;
    var_0.gcd = 6.25;
    var_0.generate_achievementid = 25;
    var_0.gatherstadiumlocs = 50;
...
tac_rover_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12C1A( var_2, "tac_rover", var_0 );
