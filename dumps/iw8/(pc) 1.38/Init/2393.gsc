...
leaderdialogonplayer_internal( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( level.shouldrespawn ) && self [[ level.shouldrespawn ]]( var_0 ) )
        return;
    ...
    if ( level.gametype == "br" )
        var_5 = scripts\mp\gametypes\br_public.gsc::clear_and_give_killstreak_loadout_support( self );
    ...
    if ( isdefined( var_5 ) && scripts\mp\utility\teams::isgameplayteam( var_5 ) )
    {
        ...
        if ( level.gametype == "br" && progression_deadzone( var_0 ) )
            var_7 = "dx_bra_";
...
playkillstreakusedialog( var_0 )
{
    ...
    if ( level.gametype == "br" )
        var_3 = scripts\mp\gametypes\br_public.gsc::clear_and_give_killstreak_loadout_support( self );
    ...
    if ( level.teambased )
    {
        var_5 = delay_end_common_combat( var_0, 1 );
        var_6 = delay_end_common_combat( var_0 );
