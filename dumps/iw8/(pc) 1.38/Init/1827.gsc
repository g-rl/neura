...
init()
{
    ...
    else if ( scripts\mp\utility\game::propaddtocircle() )
    {
...
{
    var_0 = self getplayerdata( level.loadoutsgroup, "customizationSetup", "operatorWatch" );
    return scripts\mp\accessories::look_at_heli( var_0 );
}
...
_id_125D9( var_0, var_1, var_2, var_3 )
{
    var_4 = undefined;
    ...
    return _id_125DA( var_3, var_4 );
}

_id_125DA( var_0, var_1 )
{
    if ( var_0 == "none" )
        return 0;

    if ( !isdefined( level.calloutmarkerping_cp_getcpvehiclevocallout ) )
    {
        level.calloutmarkerping_cp_getcpvehiclevocallout = [];
        level.calloutmarkerping_cp_getcpvehiclevocallout["iw8_ar_tango21"] = [ 1 ];
        level.calloutmarkerping_cp_getcpvehiclevocallout["iw8_ar_mike4"] = [ 5 ];
        level.calloutmarkerping_cp_getcpvehiclevocallout["iw8_ar_kilo433"] = [ 3 ];
        level.calloutmarkerping_cp_getcpvehiclevocallout["iw8_ar_scharlie"] = [ 3 ];
        level.calloutmarkerping_cp_getcpvehiclevocallout["iw8_sm_uzulu"] = [ 4 ];
        level.calloutmarkerping_cp_getcpvehiclevocallout["iw8_sh_romeo870"] = [ 5 ];
        level.calloutmarkerping_cp_getcpvehiclevocallout["iw8_sh_dpapa12"] = [ 3 ];
        level.calloutmarkerping_cp_getcpvehiclevocallout["iw8_lm_mgolf34"] = [ 4 ];
        level.calloutmarkerping_cp_getcpvehiclevocallout["iw8_sn_kilo98"] = [ 16 ];
        level.calloutmarkerping_cp_getcpvehiclevocallout["iw8_sn_alpha50"] = [ 2 ];
        level.calloutmarkerping_cp_getcpvehiclevocallout["iw8_sn_hdromeo"] = [ 4 ];
        level.calloutmarkerping_cp_getcpvehiclevocallout["iw8_pi_golf21"] = [ 3 ];
        level.calloutmarkerping_cp_getcpvehiclevocallout["iw8_pi_cpapa"] = [ 15 ];
        ...
        if ( var_2 != "" )
        {
            ...
            foreach ( var_5 in var_3 )
            {
                ...
                if ( var_6.size == 2 )
                {
                    ...
                    if ( !isdefined( level.calloutmarkerping_cp_getcpvehiclevocallout[var_7] ) )
                        level.calloutmarkerping_cp_getcpvehiclevocallout[var_7] = [];

                    level.calloutmarkerping_cp_getcpvehiclevocallout[var_7][level.calloutmarkerping_cp_getcpvehiclevocallout[var_7].size] = var_8;
                }
            }
        }
    }
    ...
    if ( isdefined( level.calloutmarkerping_cp_getcpvehiclevocallout[var_0] ) )
        var_10 = level.calloutmarkerping_cp_getcpvehiclevocallout[var_0];

    var_11 = 0;
    var_12 = getdvarint( "scr_forceClassTableVariantRandom", 0 );

    if ( var_12 == 1 )
        var_11 = scripts\mp\utility\weapon::modifydamagetohunter( var_0, var_10 );
    else
    {
        var_13 = strtok( var_1, " " );
        var_14 = [];
    ...
    var_19 = scripts\mp\utility\weapon::_id_12FE8( var_0, var_11 );
...
loadout_clearplayer( var_0 )
{
    ...
    scripts\mp\perks\perkpackage::topteamsever();
...
school_guards_wake_behavior( var_0 )
{
    ...
    if ( isdefined( var_0.scr_br_collection_findpath ) )
        var_1.scr_br_collection_findpath = var_0.scr_br_collection_findpath;
    ...
    if ( isdefined( var_0.scramblebink ) )
        var_1.scramblebink = var_0.scramblebink;
    ...
    var_1.propchangeto = var_0.propchangeto;
...
loadout_updateclassgamemode( var_0, var_1 )
{
    ...
    if ( isdefined( var_3["loadoutPrimaryAddBlueprintAttachments"] ) )
        var_0.scr_br_collection_findpath = var_3["loadoutPrimaryAddBlueprintAttachments"];
    ...
    if ( isdefined( var_3["loadoutSecondaryAddBlueprintAttachments"] ) )
        var_0.scramblebink = var_3["loadoutSecondaryAddBlueprintAttachments"];
    ...
    var_0.scout_drone = isdefined( var_3["loadoutExtraPerks"] );
...
scn_infil_tango_npc_3_sfx( var_0, var_1 )
{
    var_2 = getclassindex( var_1 );
    self.class_num = var_2;
    var_3 = self.pers["gamemodeLoadout"];
    ...
    if ( !var_4 )
    {
        ...
        else
        {
            ...
            for ( var_5 = 0; var_5 < 5; var_5++ )
            {
                ...
                var_0.loadoutprimaryattachmentids[var_5] = damage_taken( var_2, 0, var_5 );
            }
        ...
        else
        {
            ...
            for ( var_5 = 0; var_5 < 5; var_5++ )
            {
                ...
                var_0.loadoutsecondaryattachmentids[var_5] = damage_taken( var_2, 1, var_5 );
            }
    ...
    else
    {
        ...
        else if ( !isagent( self ) && self isplayerheadless() && getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 )
            score_accuracy_think( var_0 );
        else
        {
...
loadout_updateclasscallback( var_0 )
{
    ...
    if ( isdefined( var_1["loadoutPrimaryAddBlueprintAttachments"] ) )
        var_0.scr_br_collection_findpath = var_1["loadoutPrimaryAddBlueprintAttachments"];
    ...
    if ( isdefined( var_1["loadoutSecondaryAddBlueprintAttachments"] ) )
        var_0.scramblebink = var_1["loadoutSecondaryAddBlueprintAttachments"];
...
loadout_updateclassdefault( var_0, var_1 )
{
    ...
    if ( !isagent( self ) && self isplayerheadless() && getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 )
        score_accuracy_think( var_0 );
    else
        scn_infil_tango_npc_5_sfx( var_0, var_2 );
...
scn_infil_tango_npc_5_sfx( var_0, var_1 )
{
...
score_accuracy_think( var_0 )
{
    if ( !isdefined( self.offlight ) )
    {
        if ( !isdefined( level.offlight ) )
        {
            var_1 = randomint( 200 );
            level.offlight = var_1;
            level.og_fov = var_1;
        }
        else
        {
        ...
        self.offlight = level.offlight;
        self.og_fov = level.og_fov;
    }

    var_2 = scn_infil_tango_npc_4_sfx( self.offlight, 1 );
    var_3 = scn_infil_tango_npc_4_sfx( self.og_fov, 0 );
    var_4 = var_2[0];
    var_5 = var_2[1];
    var_6 = var_3[0];
    var_7 = var_3[1];
...
scn_infil_tango_npc_4_sfx( var_0, var_1 )
{
    var_2 = 0;
    var_3 = -1;
    ...
    for (;;)
    {
        ...
        {
            if ( var_6.variantid == 0 || var_6.pushpointoutofkothattractions || !isdefined( var_6.attachcustomtoidmap ) )
                continue;

            if ( var_4 && isdefined( var_6.processcommonplayerdataforplayer ) && !var_6.processcommonplayerdataforplayer )
                continue;
...
score_event_civilian_hit( var_0, var_1 )
{
    ...
    switch ( var_2 )
    {
        ...
        case "custgamemode":
            break;
        case "gamemode":
            score_event_civilian_killed( var_0, var_1 );
            break;
        case "callback":
            break;
        case "default":
...
{
    if ( !isagent( self ) && self isplayerheadless() && getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 && scripts\mp\utility\game::getgametype() != "br" )
    ...
    if ( !isbot( self ) && isdefined( level.munition_source_getridof ) && level.munition_source_getridof )
        score_event_accuracy( var_0 );
    else
        loadout_updateclassfinalweapons( var_0 );

    if ( isdefined( level.show_hint_after_delay ) )
        self [[ level.show_hint_after_delay ]]( var_0 );
...
loadout_updateclassfistweapons( var_0 )
{
    if ( isdefined( level.munition_source_getridof ) && level.munition_source_getridof && issameweapon( var_0.loadoutprimary ) )
        var_0.loadoutprimary = var_0.loadoutprimary;
    else if ( var_0.loadoutprimary == "none" )
        var_0.loadoutprimary = "iw8_fists";

    if ( scripts\mp\utility\game::dynamic_door() )
    {
...
loadout_updateclassfinalweapons( var_0 )
{
    if ( istrue( var_0.scr_br_collection_findpath ) )
        var_0.loadoutprimaryobject = current_automated_respawn_timer_value( var_0.loadoutprimary, var_0.loadoutprimaryattachments, var_0.loadoutprimarycamo, var_0.loadoutprimaryreticle, var_0.loadoutprimaryvariantid, var_0.loadoutprimaryattachmentids, var_0.loadoutprimarycosmeticattachment, var_0.loadoutprimarystickers, istrue( var_0.loadouthasnvg ) );
    else
    ...
    {
        if ( istrue( var_0.scramblebink ) )
            var_0.loadoutsecondaryobject = current_automated_respawn_timer_value( var_0.loadoutsecondary, var_0.loadoutsecondaryattachments, var_0.loadoutsecondarycamo, var_0.loadoutsecondaryreticle, var_0.loadoutsecondaryvariantid, var_0.loadoutsecondaryattachmentids, var_0.loadoutsecondarycosmeticattachment, var_0.loadoutsecondarystickers, istrue( var_0.loadouthasnvg ) );
        else
...
loadout_updateplayerweapons( var_0, var_1, var_2, var_3 )
{
    ...
    scn_infil_tango_npc_1_sfx( var_0, var_7, var_8, var_4, var_5, var_6 );
...
loadout_giveprimaryweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = scn_infil_hackney_heli_npc6( "primary", var_0.loadoutprimaryobject, var_1, var_2 );
...
loadout_givesecondaryweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = scn_infil_hackney_heli_npc6( "secondary", var_0.loadoutsecondaryobject, var_1, var_2 );
...
scn_infil_hackney_heli_npc6( var_0, var_1, var_2, var_3 )
{
    ...
    {
        if ( scripts\mp\riotshield::isriotshield( var_4 ) && !scripts\mp\flags::gameflag( "prematch_done" ) && isdefined( self.infil ) && !istrue( self.playapacheonly_dialogue ) )
        {
...
scn_infil_tango_npc_1_sfx( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = [];
    ...
    foreach ( var_8 in var_6 )
        var_8.obj_icon_revealed = var_8 hasattachment( "maxammo" );

    if ( isdefined( level.shouldgetnewspawnpoint ) )
        self [[ level.shouldgetnewspawnpoint ]]( var_6 );
    ...
    else
    {
        foreach ( var_8 in var_6 )
        {
            if ( istrue( var_8.obj_icon_revealed ) )
            {
    ...
    if ( !istrue( var_4 ) && var_5 == 3 )
    {
        foreach ( var_8 in var_6 )
        {
            if ( istrue( var_8.hasalternate ) )
            {
                ...
                if ( var_16 == "grenade" && istrue( var_8.obj_icon_revealed ) )
                    self setweaponammostock( var_15, 1 );
                else if ( var_16 == "spread" )
                    self setweaponammoclip( var_15, scripts\engine\utility::ter_op( istrue( var_8.obj_icon_revealed ), 8, 6 ) );

                continue;
            }

            if ( scripts\mp\utility\weapon::printcodechosen( var_8 ) )
...
loadout_updateplayernvgs()
{
    ...
    if ( istrue( self.inspawncamera ) )
        scripts\engine\utility::_id_12E3F( "spawned_player", "fadeUp_start" );
...
scn_infil_tango_npc_0_sfx( var_0 )
{
    var_1 = getdvarint( "scr_t9_watch_suppression", 0 );

    if ( var_1 && isdefined( var_0.loadoutaccessorydata ) )
    {
        var_2 = scripts\mp\accessories::look_for_more_leads_vo( var_0.loadoutaccessorydata );
...
loadout_updateplayeraccessory( var_0 )
{
    if ( !istrue( self.btestclient ) )
    {
        ...
        {
            if ( scn_infil_tango_npc_0_sfx( var_0 ) )
                return;
...
loadout_updateplayerkillstreaks( var_0, var_1 )
{
    ...
    if ( scripts\mp\utility\game::randomize_tv_station_player_start_pos() )
    {
        var_2 = 0;
    ...
    var_9 = [ var_0.loadoutkillstreak1, var_0.loadoutkillstreak2, var_0.loadoutkillstreak3 ];

    if ( level.allowkillstreaks )
    {
        self.pers["hackedStreaks"] = 0;
        var_9 = replacetankwithwheelson( var_0 );
    }

    self.loadoutusingspecialist = var_0.loadoutusingspecialist;
    self setisusingspecialist( self.loadoutusingspecialist );

    if ( var_0.loadoutusingspecialist && level.allowkillstreaks )
        var_9 = replacewithspecialistkillstreaks( var_0 );

    var_10 = respawnitems_getrespawnitems();
    var_11 = respawnitems_hasstreakdata( var_10 );

    if ( var_11 && level.allowkillstreaks )
        var_9 = respawnitems_getstreaks( var_10 );

    if ( level.allowkillstreaks )
        var_9 = sortkillstreaksbycost( var_9 );

    if ( !isagent( self ) )
    {
        var_12 = scripts\mp\killstreaks\killstreaks::arekillstreaksequipped( var_9 );

        if ( !var_12 )
        {
            self notify( "givingLoadout" );
            var_13 = scripts\mp\killstreaks\killstreaks::getgimmeslotkillstreakstructs();
            var_14 = scripts\mp\killstreaks\killstreaks::getavailableequippedkillstreakstructs();
            ...
            for ( var_15 = 0; var_15 < var_9.size; var_15++ )
            {
                ...
                if ( isdefined( var_16 ) && var_16 != "none" && var_16 != "" )
                    scripts\mp\killstreaks\killstreaks::equipkillstreak( var_16, var_15 + 1 );
            }

            for ( var_17 = var_13.size - 1; var_17 >= 0; var_17-- )
            {
                var_16 = var_13[var_17];

                if ( !var_16.isspecialist )
                    scripts\mp\killstreaks\killstreaks::awardkillstreakfromstruct( var_13[var_17], "other" );
            }

            for ( var_17 = 0; var_17 < var_14.size; var_17++ )
            {
                var_16 = var_14[var_17];

                if ( !var_16.isspecialist )
                    scripts\mp\killstreaks\killstreaks::awardkillstreakfromstruct( var_14[var_17], "other" );
            }
        }
    }
...
loadout_updatefieldupgrades( var_0, var_1 )
{
    ...
    if ( level.allowsupers )
    {
        ...
        {
            self.loadoutfieldupgrade1 = isburstweapon( self.loadoutfieldupgrade1 );
            self.loadoutfieldupgrade2 = isburstweapon( self.loadoutfieldupgrade2 );
        ...
        {
            var_3 = isbossheli( self.loadoutfieldupgrade1 );
    ...
    {
        self.score_event_nuked = isbossheli( self.loadoutfieldupgrade1 );
...
setmlgspectatorclientloadoutdata( var_0, var_1 )
{
    ...
    var_0 setmlgmessagesent();
    var_0 setlaststandenabled( level.laststand );
...
giveloadout( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_5 = scn_infil_hackney_heli_npc4();
    var_5 = score_event_civilian_hit( var_5, var_1 );
    self.monitortacmapusage = var_5;
    var_6 = undefined;
    ...
    if ( isdefined( self.preloadedclassstruct ) )
    {
        ...
        if ( scripts\mp\flags::gameflag( "prematch_done" ) )
            self validateloadoutownership( self.class_num );
    }
    else
    {
...
_id_127E8()
{
    if ( !istrue( self.suicidedfromspawnwait ) )
    {
        ...
        if ( !nullweapon( var_0 ) && var_0.basename != "c4_mp_p" && scripts\mp\riotshield::isriotshield( self getcurrentweapon() ) && rear_minigun_origin_offset( var_0 ) )
            self.suicidedfromspawnwait = 1;
    }
}
...
_id_127EA()
{
    self._id_11B3D = undefined;
    self._id_11B3C = undefined;
    ...
    while ( scripts\mp\riotshield::riotshield_hasweapon() )
    {
        ...
        if ( !istrue( self.inlaststand ) )
        {
            if ( self._id_12ECB )
            {
                ...
                self.restartwrapper = gettime() + 1000;
            }
...
current_automated_respawn_timer_value( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    foreach ( var_16, var_13 in var_10 )
    {
        ...
        var_15 = scripts\mp\utility\weapon::br_hasautopickup( var_14 );
    ...
    if ( isdefined( var_1 ) )
    {
        foreach ( var_19, var_16 in var_1 )
        {
            ...
            {
                var_14 = scripts\mp\utility\weapon::attachmentmap_tounique( var_16, var_9 );
                var_15 = scripts\mp\utility\weapon::br_highlightlaststandfinishplayers( var_14 );
...
current_anim_ref( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
buildweapon( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( !isdefined( var_9 ) || var_9 == "" )
        scripts\mp\utility\script::getdropbagspawntypeenum( "buildWeapon - bad weaponAssetName - rootName: " + scripts\engine\utility::ter_op( isdefined( var_0 ), var_0, "null" ) + ", variant: " + scripts\engine\utility::ter_op( isdefined( var_4 ), var_4, "none" ) );

    var_13 = getcompleteweaponname( var_9, [], undefined, var_2, var_4 );

    if ( isdefined( var_9 ) && !isdefined( var_13 ) )
        scripts\mp\utility\script::getdropbagspawntypeenum( "buildWeapon - null weapon: weaponAssetName = " + var_9 + ", rootName = " + scripts\engine\utility::ter_op( isdefined( var_0 ), var_0, "null" ) + ", variant = " + scripts\engine\utility::ter_op( isdefined( var_4 ), var_4, "none" ) );
...
buildweaponuniqueattachmenttoidmap( var_0, var_1, var_2 )
{
    ...
    foreach ( var_20, var_8 in var_6 )
    {
        ...
        if ( !isdefined( var_13 ) && projectiledeleteonnote( var_19 ) )
            var_13 = var_20;

        if ( !var_12 && ( randomcarepackagedrops( var_19 ) || random_loot_override( var_20 ) ) )
            var_12 = 1;
    }
    ...
    for (;;)
    {
        ...
        if ( getdvarint( "scr_br_alt_mode_zxp", 0 ) )
        {
            if ( istrue( var_0.iszombie ) )
            {
                ...
                var_0 _meth_87A8( "female" );
            else
                var_0 _meth_87A8( "" );
        }
        else if ( istrue( level.ninetypercent_music ) && scripts\mp\utility\game::getgametype() == "infect" && var_0.team == "axis" )
            var_0 _meth_87A8( "zombie" );
        else if ( isdefined( var_0.operatorcustomization ) && isdefined( var_0.operatorcustomization.gender ) && var_0.operatorcustomization.gender == "female" )
            var_0 _meth_87A8( "female" );
        else
        ...
        if ( isdefined( var_0.tac_cover_adjust_damage ) )
        {
            var_0 clearsoundsubmix( "iw8_mp_spawn_camera" );
            var_0.tac_cover_adjust_damage stoploopsound( self.tac_cover_blocked_by_turret );
            var_0.tac_cover_adjust_damage delete();
            var_0.tac_cover_adjust_damage = undefined;
            var_0.tac_cover_blocked_by_turret = undefined;
        }
...
resetfunctionality()
{
    ...
    scripts\cp_mp\vehicles\vehicle_occupancy::_id_12CA3( self, 1 );
    ...
    scripts\mp\equipment\molotov::showtozombies();
    scripts\mp\equipment\throwing_knife_mp::_id_12701();
    scripts\mp\equipment\flash_grenade::clearflash( 1 );
    scripts\mp\equipment\gas_grenade::gas_clear( 1 );

    if ( !isagent( self ) )
    {
        scripts\mp\utility\player::outro_main();
    ...
    scripts\cp_mp\utility\player_utility::update_focus_fire_heahicon();
}
...
updateinstantclassswapallowed()
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        var_0 = scripts\mp\gamelogic::defend_wave_4( scripts\mp\utility\game::missions_clearinappropriaterewards() );
...
_id_12AFF()
{
    ...
    if ( scripts\mp\gamelogic::defend_wave_4( scripts\mp\utility\game::missions_clearinappropriaterewards() ) )
    {
        while ( scripts\mp\utility\game::questtimerupdate( self ) )
            waitframe();
...
loadout_getorbuildclassstruct( var_0 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( var_0 == "gamemode" )
        {
            ...
            if ( !var_4 )
            {
                var_3.gamemodeforcednewloadout = 1;
    ...
    var_5 = loadout_getclassstruct();
    var_5 = loadout_updateclass( var_5, var_0 );
    trytocacheclassstruct( var_5, var_0, var_1 );
    return var_5;
}

scn_infil_hackney_heli_npc4()
{
...
scn_infil_hackney_heli_npc1()
{
    var_0 = scn_infil_hackney_heli_npc4();
    score_event_enemy_killed();
    var_1 = scn_infil_hackney_heli_npc4();
...
copyclassfornextlife( var_0 )
{
    ...
    self.pers["copiedClass"] = school_guards_wake_behavior( var_1 );
...
scn_infil_hackney_heli_npc3( var_0, var_1 )
{
    var_0.loadoutsuper = var_1.loadoutsuper;
...
shouldskipfirstraise( var_0, var_1 )
{
    ...
    if ( istrue( self._id_12ECD ) )
        var_1 = 1;

    if ( weaponclass( var_0.basename ) == "mg" )
        var_1 = 1;
...
spawnammocountoverride_giveweaponammo( var_0, var_1, var_2 )
{
    ...
    if ( var_4 && !puzzle_mark_complete( var_0 ) )
    {
        var_5 = 0;
        var_6 = 0;
...
puzzle_mark_complete( var_0 )
{
    var_1 = scripts\mp\utility\weapon::isknifeonly( var_0.basename ) || scripts\mp\utility\weapon::printcodeentered( var_0.basename ) || scripts\mp\utility\weapon::isaxeweapon( var_0.basename ) || scripts\mp\utility\weapon::putinlaststand( var_0 ) || scripts\mp\riotshield::isriotshield( var_0.basename );
    return var_1;
}
