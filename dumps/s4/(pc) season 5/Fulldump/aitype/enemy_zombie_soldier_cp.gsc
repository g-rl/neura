...
main()
{
    ...
    self _meth_8311( 0.0 );
    self._id_001D = 0.1;
    var_0 = "s4_ar_stango44_mp, [ none, none, none, none, none, none ], none, none";
...
_id_0340()
{
    var_0 = "actor_enemy_zombie_soldier_cp";
...
setup_weapons()
{
    ...
    if ( !isdefined( level.cachedagentweapons[var_0] ) )
        level.cachedagentweapons[var_0] = scripts\cp\cp_weapon::_id_2D13( "s4_ar_stango44_mp", [ "none", "none", "none", "none", "none", "none" ], "none", "none" );
}
