...
_id_D7EB( var_0 )
{
    character\character_zombie_trickster_ai::_id_9967();
}

_id_0340()
{
    var_0 = "actor_enemy_zombie_trickster_cp";
    ...
    if ( !isdefined( level._id_11ED[var_0] ) )
    {
        ...
        level._id_11ED[var_0]["health"] = 3000;
        level._id_11ED[var_0]["xp"] = 50;
        level._id_11ED[var_0]["reward"] = 300;
        level._id_11ED[var_0]["asm"] = "zombie_trickster";
        level._id_11ED[var_0]["radius"] = 15;
        level._id_11ED[var_0]["height"] = 70;
        level._id_11ED[var_0]["behaviorTree"] = "zombie_trickster";
        level._id_11ED[var_0]["team"] = "axis";
        level._id_11ED[var_0]["setup_func"] = ::main;
        level._id_11ED[var_0]["setup_model_func"] = ::_id_D7EB;
        character\character_zombie_trickster_ai::_id_BB60( var_0 );
    }

    _id_0008::init();
    behaviortree\zombie_trickster::_id_C241();
    aiasm\zombie_trickster_mp::_id_1C99();
    _id_09A6::_id_11F4();
