...
_id_1D41()
{
    var_0 = _id_09E2::_id_10143( "equip_at_mine", 1 );
    var_0._id_0359 = 100;
...
_id_1D44( var_0 )
{
    ...
    scripts\mp\weapons::_id_AACF( var_0, "equip_at_mine", ::_id_1D3A );
...
_id_1D3F( var_0 )
{
    ...
    var_1 = var_0 _id_0A8B::_id_A5A1( self.owner, makeweapon( "at_mine_mp" ), self, "MOD_EXPLOSIVE" );
    thread _id_1D40();
    waitframe();
...
_id_1D45( var_0 )
{
    ...
    var_1 = scripts\mp\utility\weapon::_id_0C48( "at_mine_ap_mp", self.origin, ( 0, 0, 0 ), 100, 1 );
    var_1 linkto( self );
    thread _id_1D36( var_1 );
    var_1._id_10D0C = makeweapon( "at_mine_ap_mp" );
    self._id_4341 = var_1;
    scripts\mp\weapons::_id_57EC( var_0, 0.1 );
    thread _id_1D4D();
}
