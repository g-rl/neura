...
{
    level._id_15EE = [];
    scripts\common\interactive::_id_8397( ::_id_E82A, "equip_steelBibCrate" );
    _id_0A97::_id_C28A( ::_id_E826 );
...
_id_E826( var_0 )
{
    foreach ( var_2 in level._id_15EE )
    {
        if ( isdefined( var_2 ) )
            var_2 _id_E824( var_0 );
    }
}
...
{
    var_0 endon( "death" );
    var_0 thread _id_E82C();
    var_0 thread _id_E817();
    var_0 waittill( "missile_stuck", var_1 );
    var_0 _id_E816( var_1 );
    ...
    scripts\mp\weapons::_id_AACF( var_0, "equip_steelBibCrate", ::_id_E80B );
    level._id_15EE[var_0 getentitynumber()] = var_0;
    var_0 _id_078D::_id_D15E( ::_id_E80C );
...
_id_E823()
{
    if ( 0 )
    {
        ...
        {
            if ( var_1._id_5562 == "equip_steelBibCrate" )
            {
                var_1 thread _id_E80B();
...
_id_E81B()
{
    scripts\common\interactive::_id_8398( "equip_steelBibCrate" );
    self._id_B7E9 = [];
    self._id_FE46 = 0;
    self makeuseable();
    self _meth_83A1( -1 );
...
_id_E819()
{
    thread _id_07C3::_id_A0FF( 100, "hitequip", ::_id_E815, ::_id_E814 );
}
...
_id_E815( var_0 )
{
    _id_E812( var_0.attacker );
    thread _id_E80D( var_0.attacker, 1 );
}

_id_E809( var_0, var_1 )
{
