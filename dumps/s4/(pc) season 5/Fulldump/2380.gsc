...
_id_A06C()
{
    ...
    _id_A06D();
    _id_A06E();
    level._id_60A1["vfx_burn_med_low"] = loadfx( "vfx/iw8/weap/_fire/molotov/vfx_mtov_ontag_med_low.vfx" );
    level._id_60A1["vfx_burn_sml_low"] = loadfx( "vfx/iw8/weap/_fire/molotov/vfx_mtov_ontag_sml_low.vfx" );
    level._id_60A1["vfx_burn_sml_head_low"] = loadfx( "vfx/iw8/weap/_fire/molotov/vfx_mtov_ontag_head_low.vfx" );
}
...
_id_A098( var_0 )
{
    ...
    var_0.molotovkills = 0;

    if ( isdefined( self._id_A94F ) )
        self._id_A94F._id_90B6 = 0;
    ...
    if ( isdefined( var_5 ) && ( isplayer( var_5 ) || isagent( var_5 ) ) )
        thread _id_A08F( var_0, var_5, var_1, var_7 );
    else
        thread _id_A08E( var_0, var_5, var_1, var_7 );
}

_id_12B2( var_0, var_1 )
{
    var_2 = gettime();
    var_3 = var_0.origin;
    var_4 = var_0.angles;
    var_1 waittill( "missile_stuck", var_5, var_6, var_7, var_8, var_9, var_10 );
    var_11 = _id_6AFA( var_3, var_4, var_9 );
    var_12 = var_8;
    ...
    if ( isdefined( var_5 ) && ( isplayer( var_5 ) || isagent( var_5 ) ) )
        level thread _id_A08F( var_1, var_5, var_11, var_14 );
    else
        level thread _id_A08E( var_1, var_5, var_11, var_14 );
}
...
_id_A08E( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( abs( vectordot( var_6, var_7 ) ) >= 0.9848 )
        var_5 = _id_A07B( var_7, var_8 );
    else
        var_5 = _id_A07A( var_7, var_6 );
    ...
    var_9 = var_0.origin;
    var_10 = scripts\engine\trace::_bullet_trace( var_0.origin + ( 0, 0, 50 ), var_0.origin, 0, var_0 );

    if ( var_10["surfacetype"] == "surftype_water" )
        var_9 = var_10["position"];

    _id_A087( var_0, var_9, var_5, var_1, var_3, gettime() );
}

_id_A08F( var_0, var_1, var_2, var_3 )
{
    scripts\cp\cp_weapon::_id_717C( var_0, var_1 );
    var_4 = 1;
    ...
    var_10 = _id_A060();
    var_11 = _func_02C1( var_7, var_9, var_10, var_0, 0, "physicsquery_closest", 1 );
    ...
    if ( isdefined( var_11 ) && var_11.size > 0 )
    {
        ...
        var_15 = _func_0218( 2 * var_14 / 800 );
        var_16 = var_12;
        var_17 = anglestoright( var_2 );
        var_18 = _id_A07B( var_16, var_17 );
        thread _id_A087( var_0, var_9, var_18, var_13, var_3, gettime() + var_15 * 1000 );
        return;
    }
...
{
    self endon( "death" );
    self._id_EA6A.attacker endon( "disconnect" );
    self._id_EA6A.attacker endon( "joined_team" );

    if ( isdefined( self._id_EA6A._id_EA93 ) )
    {
        var_0 = self._id_EA6A._id_EA93;
...
_id_A08A( var_0, var_1, var_2, var_3 )
{
    ...
    {
        thread _id_A097();
        _id_070F::createignitezombieevent( var_0, self );
    }
}
...
_id_A046( var_0 )
{
    ...
    if ( !isplayer( self ) && isalive( self ) && self _meth_8679( "burning" ) )
...
_id_A097()
{
    ...
    for (;;)
    {
        ...
        if ( !isplayer( self ) && isdefined( self._id_0B67 ) )
        {
            self._id_0B67._id_8796 = undefined;
            self._id_2D8A = undefined;
        }

        foreach ( var_4 in var_0._id_E070 )
        {
            if ( var_4 _id_A03A() )
            {
                if ( !isdefined( var_2 ) || var_4._id_7C8C > var_2 )
                    var_2 = var_4._id_7C8C;

                continue;
            }

            var_0._id_E070[var_4._id_7C8C] = undefined;
        }
        ...
        if ( isdefined( var_2 ) )
        {
            ...
            var_4 = var_0._id_E070[var_2];
            var_6 = getdvarint( "#x3dee089cb49164e4e", 0 ) && isdefined( var_4.inflictor );
            var_7 = 9;

            if ( var_0._id_F223 > 0.5 )
            {
                var_7 = 9;

                if ( var_6 && var_4.inflictor scripts\engine\utility::_id_546E( "molotov_stage_2" ) )
                {
                    var_4.inflictor scripts\engine\utility::_id_5470( "molotov_stage_2" );
                    var_4.inflictor scripts\engine\utility::_id_5474( "molotov_stage_3" );
                }
            }
            else if ( var_0._id_F223 > 0.5 )
            {
                ...
                if ( var_6 && var_4.inflictor scripts\engine\utility::_id_546E( "molotov_stage_1" ) )
                {
                    var_4.inflictor scripts\engine\utility::_id_5470( "molotov_stage_1" );
                    var_4.inflictor scripts\engine\utility::_id_5474( "molotov_stage_2" );
                }
            }
            else if ( var_6 && !var_4.inflictor scripts\engine\utility::_id_5472( "molotov_stage_1" ) )
                var_4.inflictor scripts\engine\utility::_id_5474( "molotov_stage_1" );

            if ( isagent( self ) )
            {
                if ( !istrue( self._id_EDCA ) )
                {
                    if ( isplayer( var_4.attacker ) && var_4.attacker _id_A0A7() )
                    {
                        if ( !istrue( var_4.attacker._id_6FBC ) )
                            var_4.attacker._id_A02B = var_4.attacker._id_A02B + 1;
            ...
            var_8 = var_4.attacker.origin;

            if ( isdefined( var_4.inflictor ) )
                var_8 = var_4.inflictor.origin;
            else
            ...
            if ( var_0._id_F27F <= 0 )
            {
                var_11 = "MOD_EXPLOSIVE";

                if ( isagent( self ) )
                    var_11 = "MOD_FIRE";

                self dodamage( var_7, var_8, var_4.attacker, var_4.inflictor, var_11, "s4_molotov_zm", "none" );
                var_0._id_5BCC = 1;
                var_0._id_F27F = 0.25;
            }
            else
            {
                ...
                if ( !var_0._id_5BCC )
                {
                    ...
                    if ( !isplayer( self ) && self _meth_8679( "burning" ) )
                        self setscriptablepartstate( "burning", "active", 0 );

                    var_0._id_5BCC = 1;
                    _id_072A::addplayereffects( "molotov", self, var_4.attacker, 10 );
                }
...
_id_A0A7()
{
    if ( isdefined( self._id_8F3F ) && gettime() - self._id_8F3F < 4000 )
        return 1;
    else
        return 0;
}
...
_id_A03A()
{
    ...
    if ( !scripts\cp\utility\player::isreallyalive( self._id_7E9E._id_103C2 ) )
        return 0;
...
_id_A074( var_0 )
{
    ...
    var_0._id_103C2 thread _id_0777::_id_523C( 0.5 );
    return 1;
}
...
_id_A09B()
{
    ...
    for (;;)
    {
        ...
        if ( !isnullweapon( var_2 ) && var_2.basename == "s4_molotov_zm" )
            var_1 = 1;
...
_id_A043( var_0 )
{
    if ( isdefined( var_0._id_D9B6 ) )
    {
        ...
        {
            foreach ( var_2 in var_0._id_D9B6._id_2B0E )
                _id_A03D( var_2 );
        }

        if ( isdefined( var_0._id_D9B6._id_AA28 ) )
        {
            foreach ( var_5 in var_0._id_D9B6._id_AA28 )
            {
                if ( isdefined( var_5 ) )
                    var_5 thread _id_A077();
            }
        }
    }
}
