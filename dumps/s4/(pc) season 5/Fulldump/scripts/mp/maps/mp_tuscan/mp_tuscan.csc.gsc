...
main()
{
    ...
    thread scripts\common\fx_zones::fx_zone_watcher( "ruins", "msg_fx_zone_ruins" );
    thread scripts\common\fx_zones::fx_zone_watcher( "mansion", "msg_fx_zone_mansion" );
    thread scripts\common\fx_zones::fx_zone_watcher( "church", "msg_fx_zone_church" );
