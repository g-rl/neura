...
_id_D795()
{
    level._id_11EF["player"]["think"] = ::_id_11FF;
}

_id_11FF()
{
    thread scripts\mp\bots\bots_gametype_mugger::_id_2861();
}
...
_id_120C()
{
    ...
    if ( gettime() > self._id_A487 )
    {
        ...
        if ( isbot( self.owner ) )
            var_0 = self _meth_8032();

        var_1 = self.owner _meth_815E();

        if ( isdefined( var_1 ) )
        {
            var_2 = self.owner scripts\mp\bots\bots_gametype_mugger::_id_2797( var_1, var_0 );
