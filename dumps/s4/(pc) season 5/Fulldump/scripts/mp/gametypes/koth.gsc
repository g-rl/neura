...
main()
{
    ...
    game["dialog"]["gametype"] = "mp_glob_hard_bchr_in05";

    if ( getdvarint( "#x3af383f37c3a10748" ) )
        game["dialog"]["gametype"] = "mp_glob_hard_bchr_in06";
    ...
    game["dialog"]["hp_first"] = "mp_glob_hard_bchr_z101";
    game["dialog"]["hp_neutral"] = "mp_glob_hard_bchr_z102";
    game["dialog"]["hp_new_location"] = "mp_glob_hard_bchr_z103";
    game["dialog"]["hp_captured_enemy"] = "mp_glob_hard_bchr_z099";
    game["dialog"]["hp_captured_friendly"] = "mp_glob_hard_bchr_z104";
    game["dialog"]["hp_contested"] = "mp_glob_hard_bchr_z100";
    game["dialog"]["hp_move_soon"] = "hp_move_soon";
    game["dialog"]["hp_next"] = "mp_glob_hard_bchr_z101";
    game["dialog"]["hp_capturing_enemy"] = "mp_glob_gene_bchr_z255";
    game["dialog"]["hp_capturing_friendly"] = "mp_glob_gene_bchr_z258";
    level._id_A5E0 = 1;
    thread _id_10FC8();
}
...
_id_81E5()
{
    ...
    setdynamicdvar( "#x39f971ed5a0d7af11", getmatchrulesdata( "kothData", "zoneLifetime" ) );
    setdynamicdvar( "#x3d926d7da460efc57", getmatchrulesdata( "kothData", "zonePreviewTime" ) );
    setdynamicdvar( "#x3471f3b84be78a3a9", getmatchrulesdata( "kothData", "zoneCaptureTime" ) );
    setdynamicdvar( "#x367d23ed8dc16fd8b", getmatchrulesdata( "kothData", "firstZoneActivationDelay" ) );
    setdynamicdvar( "#x3244a2cb627cc7a45", getmatchrulesdata( "kothData", "zoneActivationDelay" ) );
    setdynamicdvar( "#x3a96cb7fc26021464", getmatchrulesdata( "kothData", "randomLocationOrder" ) );
    setdynamicdvar( "#x3e33ef2b48d162835", getmatchrulesdata( "kothData", "additiveScoring" ) );
    setdynamicdvar( "#x3e4096af5b0259387", getmatchrulesdata( "kothData", "pauseTime" ) );
    setdynamicdvar( "#x37f182f404e891e82", getmatchrulesdata( "kothData", "delayPlayer" ) );
    setdynamicdvar( "#x353ee0060b2dca01a", getmatchrulesdata( "kothData", "spawnDelay" ) );
    setdynamicdvar( "#x335e5ea25e6a47763", getmatchrulesdata( "kothData", "useHQRules" ) );
...
_id_74C8()
{
    ...
    if ( level._id_5BE6 )
    {
        ...
        level._id_110E5 = 1;
        level thread scripts\mp\hud_message::_id_FCBF( undefined, 36, 36 );
        ...
        wait( level._id_5BE6 );
        level._id_110E5 = 0;
        level thread scripts\mp\hud_message::_id_FCBF( undefined, 35, 35 );

        foreach ( var_3 in level._id_EF89 )
            _id_0A8D::_id_E775( "hp_new_location", var_3, "hp", undefined, undefined, undefined, 1, 0 );
...
_id_1086A()
{
    ...
    foreach ( var_1 in level._id_EF89 )
        _id_0A8D::_id_E775( "hp_first", var_1, "hp", undefined, undefined, undefined, 1 );
}
...
_id_7B1A( var_0 )
{
    if ( level.waitingfirstzone )
    {
        foreach ( var_2 in level._id_EF89 )
            _id_0A8D::_id_E775( "obj_generic_capture", var_2 );
    }
    else
    {
        foreach ( var_2 in level._id_EF89 )
            _id_0A8D::_id_E775( "hp_new_location", var_2, "hp", undefined, undefined, undefined, 1, 0 );
    }
...
playneutralvo()
{
    ...
    foreach ( var_1 in level._id_EF89 )
        _id_0A8D::_id_E775( "hp_neutral", var_1, "hp", undefined, undefined, undefined, 1 );
}
...
_id_6EA6( var_0 )
{
    ...
    if ( level.mapname == "mp_winter" && var_0 == "hardpoint_zone" )
    {
        foreach ( var_3 in var_1 )
        {
            if ( isdefined( var_3.classname ) && var_3.classname == "trigger_multiple" && ( isdefined( var_3._id_CD99 ) && var_3._id_CD99 == "2" ) )
        ...
        if ( isdefined( var_5 ) )
        {
            ...
            var_5.target = "control_vis_b";
            var_5._id_CD69 = "control";
            var_5._id_CD99 = "2";
            var_5._id_0398 = "2";
    ...
    for ( var_10 = var_1.size; var_9; var_10-- )
    {
        var_9 = 0;

        for ( var_11 = 0; var_11 < var_10 - 1; var_11++ )
        {
            if ( _id_3B05( var_1[var_11], var_1[var_11 + 1] ) )
            {
                var_12 = var_1[var_11];
                var_1[var_11] = var_1[var_11 + 1];
                var_1[var_11 + 1] = var_12;
                var_9 = 1;
            }
        }
    }
...
_id_DCD8()
{
    ...
    foreach ( var_2 in level._id_EF89 )
        _id_0A8D::_id_E775( "hp_next", var_2, "hp", undefined, undefined, undefined, 1, 0 );
}
...
_id_1FC4()
{
    ...
    while ( !level.gameended )
    {
        ...
        else if ( !level._id_110CF._id_E57B && !level.gameended )
        {
            if ( level._id_110DF )
                var_1 = level._id_110CF._id_F396[var_3].size;
        ...
        if ( istrue( level.koth_mlg_overtime_next_point_wins ) )
...
ontimelimitmlg()
{
    ...
    scripts\mp\hud_message::_id_DCA4( "MP_INGAME_ONLY/KOTH_OVERTIME_WARNING" );
    level.koth_mlg_overtime_next_point_wins = 1;
}
