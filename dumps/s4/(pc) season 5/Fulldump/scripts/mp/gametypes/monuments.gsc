...
_id_81E5()
{
    ...
    setdynamicdvar( "#x3103dd776961e8302", 0 );
    scripts\mp\utility\game::_id_C2AA( "monuments", 0, 0, 9 );
    setdynamicdvar( "#x3a614d5f19f02bce9", 1 );
    scripts\mp\utility\game::_id_C2A9( "monuments", 1 );
    setdynamicdvar( "#x386a80dbdfe35584f", 1 );
    scripts\mp\utility\game::_id_C2D0( "monuments", 1 );
    setdynamicdvar( "#x399febe5935a83166", 0 );
    scripts\mp\utility\game::_id_C25D( "monuments", 0 );
    setdynamicdvar( "#x3dd9113b8835d9b9e", 0 );
}
...
_id_ABAD()
{
    ...
    {
        scripts\mp\utility\game::_id_D61C( var_3, &"OBJECTIVES/MONUMENTS" );

        if ( level.splitscreen )
            scripts\mp\utility\game::_id_D61A( var_3, &"OBJECTIVES/MONUMENTS" );
        else
            scripts\mp\utility\game::_id_D61A( var_3, &"OBJECTIVES/MONUMENTS" );

        scripts\mp\utility\game::_id_D615( var_3, &"OBJECTIVES/MONUMENTS_HINT" );
    }
