...
main()
{
    ...
    foreach ( var_2 in getentarray( "mendotaloc", "targetname" ) )
        var_2 setmodel( "s4_greenbay_device_01" );
}

on_team_claimed_zone( var_0 )
{
    level notify( "mendota_next_zone" );
    var_1 = _func_00DB( var_0 );
    var_2 = int( 33.3333 );
...
mendota_register( var_0, var_1, var_2 )
{
    if ( !isdefined( level.mendota_orientation_data ) )
        level.mendota_orientation_data = [];

    if ( !isdefined( level.mendota_orientation_data[var_0] ) )
        level.mendota_orientation_data[var_0] = spawnstruct();

    level.mendota_orientation_data[var_0].origin = var_1;
    level.mendota_orientation_data[var_0].angles = var_2;
}

mendota_register_recenter_script( var_0, var_1 )
{
    var_2 = level.player scripts\engine\utility::spawn_tag_origin();
    var_2.origin = _func_0016( [ level.mendota_orientation_data["greenbay"].origin, level.mendota_orientation_data["kenosha"].origin ] );
    var_2 show();
...
copy_positions_to_clipboard()
{
    for (;;)
    {
        ...
        var_0 = "greenbay: " + level.mendota_orientation_data["greenbay"]._id_5469.origin + " " + level.mendota_orientation_data["greenbay"]._id_5469.angles + " kenosha: " + level.mendota_orientation_data["kenosha"]._id_5469.origin + " " + level.mendota_orientation_data["kenosha"]._id_5469.angles;
        scripts\engine\utility::_id_90F3( var_0 );
        wait 0.5;
    }
}
...
{
    if ( !isdefined( level.mendota_care_package_drop_overrides ) )
        level.mendota_care_package_drop_overrides = [];
    ...
    level.mendota_care_package_drop_overrides[var_0] = var_5;
}

_id_81E5()
{
    scripts\mp\utility\game::_id_D4E0();
    setdynamicdvar( "#x32f039787f546aecb", getmatchrulesdata( "mendotaData", "zoneLifetime" ) );
    setdynamicdvar( "#x31d69513f92582e1d", getmatchrulesdata( "mendotaData", "zonePreviewTime" ) );
    setdynamicdvar( "#x3e6dbe52da248f8cb", getmatchrulesdata( "mendotaData", "zoneCaptureTime" ) );
    setdynamicdvar( "#x37c69b48b09873f35", getmatchrulesdata( "mendotaData", "firstZoneActivationDelay" ) );
    setdynamicdvar( "#x34d9bf7f9df3a7b77", getmatchrulesdata( "mendotaData", "zoneActivationDelay" ) );
    setdynamicdvar( "#x353f565277d6b262", getmatchrulesdata( "mendotaData", "randomLocationOrder" ) );
    setdynamicdvar( "#x3b857981b4971c5d7", getmatchrulesdata( "mendotaData", "additiveScoring" ) );
    setdynamicdvar( "#x35986bddfcd2f39d9", getmatchrulesdata( "mendotaData", "pauseTime" ) );
    setdynamicdvar( "#x392e58f593a811624", getmatchrulesdata( "mendotaData", "delayPlayer" ) );
    setdynamicdvar( "#x3b0b7de064c964b88", getmatchrulesdata( "mendotaData", "spawnDelay" ) );
    setdynamicdvar( "#x36aee074ae59a88d1", getmatchrulesdata( "mendotaData", "useHQRules" ) );
    setdynamicdvar( "#x3ec9b49d07748537a", 0 );
...
_id_ABAD()
{
    ...
    level thread spawn_mendota_models();
...
spawn_mendota_models()
{
    if ( !isdefined( level.mendota_orientation_data ) )
        return;

    foreach ( var_3, var_1 in level.mendota_orientation_data )
    {
        var_2 = spawn( "script_model", var_1.origin );
        var_2 setmodel( "s4_kenosha_scale_01" );
        var_2.angles = var_1.angles;
        level.mendota_orientation_data[var_3]._id_5469 = var_2;
    }
}
...
_id_FC7D()
{
    ...
    level._id_3236 = scripts\mp\utility\dvars::_id_509C( "captureType", 2, 0, 3 );
}
...
_id_8294()
{
    ...
    foreach ( var_8 in level._id_E34D )
    {
        ...
        var_13 = 0;
        var_14 = var_8.classname == "mp_koth_spawn_allies_start" || var_8.classname == "mp_mendota_spawn_axis_start";
...
_id_D8CC()
{
    ...
    foreach ( var_4 in var_1 )
    {
        ...
        var_5 _id_07D6::_id_D4B2( "neutralize" );
...
_id_A27F( var_0 )
{
    ...
    level._id_110E2 = 0;
    level waittill( "mendota_next_zone" );
    level._id_110E2 = 1;
