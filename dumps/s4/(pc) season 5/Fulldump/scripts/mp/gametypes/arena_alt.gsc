...
main()
{
    ...
    switch ( game["launchChunkRuleSet"] )
    {
        case 0:
            ...
            scripts\mp\utility\dvars::_id_D633( "timelimit", 180 );
            scripts\mp\utility\dvars::_id_D633( "numlives", 0 );
            scripts\mp\utility\dvars::_id_D633( "roundlimit", 1 );
            scripts\mp\utility\dvars::_id_D633( "winlimit", 1 );
            scripts\mp\utility\dvars::_id_D633( "scorelimit", 15 );
            _id_1086C( 6 );
            setdvar( _func_0483( "#x3ecead486797add6d", scripts\mp\utility\game::getgametype(), "_pointsPerKill" ), 1 );
            setdvar( _func_0483( "#x3ecead486797add6d", scripts\mp\utility\game::getgametype(), "_dogtags" ), 0 );
            setdvar( _func_0483( "#x3ecead486797add6d", scripts\mp\utility\game::getgametype(), "_lethalDelay" ), 0 );
            level._id_CBF7 = 0;
            level._id_CBF8 = 0;
            break;
        case 1:
            ...
            scripts\mp\utility\dvars::_id_D633( "timelimit", 40 );
            scripts\mp\utility\dvars::_id_D633( "numlives", 1 );
            scripts\mp\utility\dvars::_id_D633( "roundlimit", 0 );
            scripts\mp\utility\dvars::_id_D633( "winlimit", 6 );
            scripts\mp\utility\dvars::_id_D633( "scorelimit", 6 );
            _id_1086C( 0 );
            setdvar( _func_0483( "#x3ecead486797add6d", scripts\mp\utility\game::getgametype(), "_pointsPerKill" ), 0 );
            setdvar( _func_0483( "#x3ecead486797add6d", scripts\mp\utility\game::getgametype(), "_dogtags" ), 0 );
            setdvar( _func_0483( "#x3ecead486797add6d", scripts\mp\utility\game::getgametype(), "_lethalDelay" ), 5 );
            level._id_AD61 = 10;
            level._id_D5BA = 0;
            break;
        case 2:
        ...
        case 3:
            ...
            scripts\mp\utility\dvars::_id_D633( "roundlimit", 1 );
            scripts\mp\utility\dvars::_id_D633( "winlimit", 1 );
            scripts\mp\utility\dvars::_id_D633( "scorelimit", 20 );
            _id_1086C( 6 );
            setdvar( _func_0483( "#x3ecead486797add6d", scripts\mp\utility\game::getgametype(), "_pointsPerKill" ), 0 );
            setdvar( _func_0483( "#x3ecead486797add6d", scripts\mp\utility\game::getgametype(), "_dogtags" ), 1 );
            setdvar( _func_0483( "#x3ecead486797add6d", scripts\mp\utility\game::getgametype(), "_lethalDelay" ), 0 );
            level._id_CBF7 = 1;
            level._id_CBF8 = 0;
            break;
...
_id_ABAD()
{
    ...
    level thread scripts\mp\gametypes\arena::_id_E2F3( var_5 );
...
_id_503B()
{
    if ( istrue( game["chunkBotsSpawned"] ) )
    {
        ...
        scripts\mp\bots\bots::_id_4FE1( 1, "allies" );
        scripts\mp\bots\bots::_id_4FE1( 1, "axis" );
    }
}
...
_id_FC7D()
{
    ...
    if ( game["launchChunkRuleSet"] == 3 )
    {
        level._id_4CE2 = ::_id_4CE3;
        level._id_4CE6 = ::_id_4CE7;
    }
    else if ( level._id_4CE9 )
    {
    ...
    level._id_1B00 = getdvar( "#x3b80abb81116e7914", "s4_pi_mike1911" );
    level._id_1B01 = getdvar( "#x3b80abe81116e7fad", "s4_ar_stango44" );
    level._id_1B02 = getdvar( "#x3b80abd81116e7d7a", "s4_ar_stango44" );
    level._id_1B03 = getdvar( "#x3b80ab881116e727b", "s4_ar_stango44" );
    level._id_1B04 = getdvar( "#x3b80ab781116e7048", "s4_ar_stango44" );
    level._id_1B05 = getdvar( "#x3b80aba81116e76e1", "equip_frag" );
    level._id_1B06 = getdvar( "#x3b80ab981116e74ae", "equip_concussion" );
    level._id_1B07 = getdvar( "#x3b80ab481116e69af", "equip_adrenaline" );
    ...
    if ( game["launchChunkRuleSet"] == 2 )
    {
        ...
        level._id_9661 = 3;
        level._id_E73D = "none";
        level._id_1B00 = "rand_pistol";
        level._id_1B01 = "random";
        level._id_1B02 = "rand_smg";
        level._id_1B03 = "rand_assault";
        level._id_1B04 = "rand_sniper";
        level._id_1B05 = "rand_lethal";
        level._id_1B06 = "rand_tactical";
        level._id_1B07 = "random";
        level thread _id_293D();
    }
    ...
    if ( _id_897F() )
    {
        ...
        if ( !isdefined( game["roundsPlayed"] ) || isdefined( game["roundsPlayed"] ) && game["roundsPlayed"] == 0 )
        {
            ...
            level._id_1B00 = _id_6CD3( level._id_1B00 );
            level._id_1B01 = _id_6CD3( level._id_1B01 );
            level._id_1B02 = _id_6CD3( level._id_1B02 );
            level._id_1B03 = _id_6CD3( level._id_1B03 );
            level._id_1B04 = _id_6CD3( level._id_1B04 );
            level._id_1B05 = _id_6CD3( level._id_1B05 );
            level._id_1B06 = _id_6CD3( level._id_1B06 );
            level._id_1B07 = _id_6CD3( level._id_1B07 );
        }
        else if ( level._id_9661 == 0 || game["roundsPlayed"] % level._id_9661 != 0 )
        {
            level._id_E73D = game["startWeapon"];
            level._id_1B00 = game["arenaWeaponT1"];
            level._id_1B01 = game["arenaWeaponT2"];
            level._id_1B02 = game["arenaWeaponT3"];
            level._id_1B03 = game["arenaWeaponT4"];
            level._id_1B04 = game["arenaWeaponT5"];
            level._id_1B05 = game["arenaWeaponT6"];
            level._id_1B06 = game["arenaWeaponT7"];
            level._id_1B07 = game["arenaWeaponT8"];
        }
        ...
        game["arenaWeaponT1"] = level._id_1B00;
        game["arenaWeaponT2"] = level._id_1B01;
        game["arenaWeaponT3"] = level._id_1B02;
        game["arenaWeaponT4"] = level._id_1B03;
        game["arenaWeaponT5"] = level._id_1B04;
        game["arenaWeaponT6"] = level._id_1B05;
        game["arenaWeaponT7"] = level._id_1B06;
        game["arenaWeaponT8"] = level._id_1B07;
    }
}
...
_id_8294()
{
    ...
    _id_0817::_id_D461( "LaunchChunk", "Crit_Default" );
    ...
    if ( !istrue( level._id_1660 ) )
    {
        _id_0817::_id_C2B9( "normal", level.spawntype );
        _id_0817::_id_C2B9( "fallback", level.spawntype );
    }
...
_id_6D4A()
{
    ...
    {
        var_4 = _id_0817::_id_6D4E( var_1 );

        if ( istrue( level._id_EC35 ) && game["roundsPlayed"] > 0 )
        {
            var_5 = scripts\mp\utility\teams::_id_6DC9( self.pers["team"] );

            if ( var_5 > 3 )
            {
                foreach ( var_7 in scripts\mp\utility\teams::_id_6DCA( self.pers["team"], "players" ) )
                {
        ...
        if ( istrue( level._id_EC35 ) && game["roundsPlayed"] > 0 && !var_3 )
        {
            ...
            var_0 = _id_6DAB( var_4, self.pers["arena_spawn_pos"] );
        }
            ...
            if ( !isdefined( var_0 ) )
            {
                ...
                if ( var_5 > 3 )
                {
                    ...
                    foreach ( var_7 in scripts\mp\utility\teams::_id_6DCA( self.pers["team"], "players" ) )
                    {
                        if ( isdefined( var_7.pers["arena_spawn_pos"] ) )
                        {
                            if ( level._id_FE59 == 1 && level._id_FE59 == 1 && level._id_FE5A == 1 )
                            {
                                level._id_FE59 = 0;
                                level._id_FE5B = 0;
                                level._id_FE5A = 0;
                            ...
                            if ( var_7.pers["arena_spawn_pos"] == "1" && level._id_FE59 == 0 )
                            {
                                level._id_FE59++;
                                var_9 = var_7;
                                break;
                            }
                            else if ( var_7.pers["arena_spawn_pos"] == "2" && level._id_FE5B == 0 )
                            {
                                level._id_FE5B++;
                                var_9 = var_7;
                                break;
                            }
                            else if ( var_7.pers["arena_spawn_pos"] == "3" && level._id_FE5A == 0 )
                            {
                                level._id_FE5A++;
                                var_9 = var_7;
                                break;
...
onplayerconnect( var_0 )
{
    ...
    {
        var_0.pers["gamemodeLoadout"] = level._id_36FE[3];
        game["chunkFirstAssigned"] = 1;
    }
    else if ( _id_89E3() || _id_89E5() || _id_89DD() )
...
_id_AB05()
{
    ...
    for (;;)
    {
        ...
        var_0 = getdvarint( "#x3479ab28f2a947c0b", 100 );

        if ( isbot( self ) )
            wait 0.1;

        var_1 = scripts\mp\utility\teams::_id_6DCA( "allies", "teamCount" );

        if ( var_1 )
        {
            level._id_1514 = scripts\mp\utility\teams::_id_6DCA( "allies", "teamCount" ) * var_0;
            setomnvar( "ui_arena_allies_health_max", level._id_1514 );

            if ( !scripts\mp\utility\player::isreallyalive( self ) && scripts\mp\playerlogic::_id_9CCD() )
                self waittill( "spawned_player" );

            var_2 = 0;

            foreach ( var_4 in scripts\mp\utility\teams::_id_6DCA( "allies", "players" ) )
                var_2 = var_2 + var_4.health;

            level._id_1511 = var_2;
        ...
        var_6 = scripts\mp\utility\teams::_id_6DCA( "axis", "teamCount" );

        if ( var_6 )
        {
            level._id_1FE9 = scripts\mp\utility\teams::_id_6DCA( "axis", "teamCount" ) * var_0;
            ...
            foreach ( var_4 in scripts\mp\utility\teams::_id_6DCA( "axis", "players" ) )
                var_7 = var_7 + var_4.health;

            level._id_1FE6 = var_7;
...
_id_ABA1()
{
    ...
    if ( game["matchStartRequiresInput"] && !isbot( self ) )
    {
        ...
        _id_0A8D::_id_9137( "lc_intro", "lc_intro" );
    }
    ...
    if ( isbot( self ) )
    {
        ...
        else
        {
            ...
            if ( isdefined( game["chunkBotsDifficulty"] ) )
            {
                ...
                if ( !level._id_D5BA && ( game["launchChunkRuleSet"] == 1 || game["launchChunkRuleSet"] == 2 ) )
                {
                    if ( !isbot( self ) )
                    {
        ...
        self _meth_8052( game["chunkBotsDifficulty"] );
        scripts\mp\bots\bots_util::_id_28C8( var_5 );
    }
...
_id_AB3F( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( game["launchChunkRuleSet"] == 0 || game["launchChunkRuleSet"] == 3 )
    {
        if ( isbot( var_1 ) )
        {
            if ( var_1._id_0267 % 4 == 0 || !isbot( var_0 ) )
            {
                var_6 = [ "recruit", "regular", "hardened", "veteran" ];
                var_7 = 0;
                var_8 = var_1 _meth_802F();
        ...
        if ( isbot( var_0 ) )
        {
            if ( var_0._id_0157 % 2 == 0 )
            {
                var_6 = [ "recruit", "regular", "hardened", "veteran" ];
                var_7 = 0;
                var_8 = var_0 _meth_802F();
                ...
                var_0 _meth_8052( var_6[var_7] );
                game["chunkBotsDifficulty"] = var_6[var_7];
            }
        }

        if ( var_0._id_0157 % 3 == 0 )
        {
...
_id_ABC0()
{
    ...
    if ( game["launchChunkRuleSet"] == 0 || game["launchChunkRuleSet"] == 3 )
        scripts\mp\gamelogic::_id_4580();
    else if ( level._id_10E23 == 1 )
        _id_3527();
...
_id_2D03()
{
    ...
    else
    {
        ...
        if ( var_7 != "none" )
            var_4[var_4.size] = _id_2D07( var_7, var_6 );

        if ( var_8 != "none" )
            var_5[var_5.size] = _id_2D0B( var_8, var_6 );
        ...
        if ( level._id_9661 != 0 )
        {
            ...
            if ( var_11 != "none" )
                var_4[var_4.size] = _id_2D07( var_11, var_10 );

            if ( var_12 != "none" )
                var_5[var_5.size] = _id_2D0B( var_12, var_10 );
        }

        level._id_96AE = scripts\engine\utility::array_combine( var_4, var_5 );
    }
}
...
_id_4636()
{
    if ( isdefined( level._id_E73D ) && level._id_E73D != "none" && !issubstr( level._id_E73D, "equip" ) )
        var_0 = scripts\mp\utility\weapon::getweaponrootname( level._id_E73D );
    else
        var_0 = "none";

    level._id_1A9B["default"]["loadoutArchetype"] = "archetype_assault";
    level._id_1A9B["default"]["loadoutPrimary"] = var_0;
    level._id_1A9B["default"]["loadoutPrimaryAttachment"] = "none";
    level._id_1A9B["default"]["loadoutPrimaryAttachment2"] = "none";
    level._id_1A9B["default"]["loadoutPrimaryCamo"] = "none";
    level._id_1A9B["default"]["loadoutPrimaryReticle"] = "none";
    ...
    level._id_1A9B["default"]["loadoutMeleeSlot"] = "s4_me_fists";
...
_id_2EAB()
{
    ...
    for ( var_1 = "mp/classTable_arena_alt.csv"; scripts\mp\class::_id_EC68( var_1, var_0 ) != ""; var_0++ )
        level._id_36FE[level._id_36FE.size] = _id_FCAC( var_1, var_0 );

    var_2 = level._id_36FE;
    var_2 = _id_1ABC( var_2, 99 );
...
_id_2D09()
{
    ...
    for (;;)
    {
        ...
        level._id_10D69[var_2][level._id_10D69[var_2].size] = var_3;
        level._id_15F3[level._id_15F3.size] = var_3;
        var_0++;
    }
}
...
{
    level._id_2327 = [];
    level._id_2327[level._id_1B00] = 0;
    level._id_2327[level._id_1B01] = 1;
    level._id_2327[level._id_1B02] = 2;
    level._id_2327[level._id_1B03] = 3;
    level._id_2327[level._id_1B04] = 4;
    level._id_2327[level._id_1B05] = 5;
    level._id_2327[level._id_1B06] = 6;
    level._id_2327[level._id_1B07] = 0;
}
    ...
    if ( isdefined( var_0 ) && var_0.size > 0 )
    {
        ...
        for (;;)
        {
            ...
            if ( var_3 > var_0.size )
            {
                ...
                {
                    if ( level._id_15F3[var_6]["weapon"] == var_1 )
                        break;
                }
...
_id_E3A7( var_0, var_1 )
{
    ...
    if ( var_6 != "" )
    {
        ...
        var_8 = 128;
        var_9 = var_7 _id_6A11( var_1 );
        var_10 = var_7 _id_6A10( var_1 );
        ...
        var_7 thread _id_ACD9( var_6, var_1 );
        var_7 thread _id_10ADE();
    }
    else
    {
        var_11 = undefined;
        ...
        var_15 _meth_84D4( var_8 );
        var_15 setuserange( var_8 );
        _id_9A37( var_15, var_14 );
        ...
        var_15 thread _id_AD06();
        var_15 thread _id_10BCF();
    }
}
...
_id_E2F3( var_0 )
{
    ...
    if ( istrue( var_0 ) )
    {
        ...
        level._id_1AA6 thread scripts\mp\gametypes\arena::_id_4780();
    ...
    if ( var_1 > 0.05 && var_2 && !self._id_497A )
    {
        if ( var_4 == "neutral" )
        {
            if ( level._id_5C3B > 0.05 )
            {
                ...
                _id_0A8D::_id_E775( "losing" + self._id_A8E1, var_5 );
            }
        }
...
_id_D868()
{
    ...
    level._id_A8E8 = [];
    level._id_A8E8[level._id_A8E8.size] = level._id_1DD5;
    level._id_A8E8[level._id_A8E8.size] = level._id_461C;
}
...
_id_E707()
{
    ...
    foreach ( var_4 in level.players )
    {
        ...
        var_4 _id_0A8D::_id_9137( "overtime" );
    }

    level._id_1AA6._id_5C3F playsound( "flag_spawned" );
    level thread _id_DCA9();
}
...
_id_D8C5()
{
    scripts\mp\gamelogic::_id_D8E5( "waypoint_taking_endzone", 0, "contest", "MP_INGAME_ONLY/OBJ_TAKING_CAPS", "icon_waypoint_flag", 0 );
    scripts\mp\gamelogic::_id_D8E5( "waypoint_losing_endzone", 0, "contest", "MP_INGAME_ONLY/OBJ_LOSING_CAPS", "icon_waypoint_flag", 0 );
...
_id_293D()
{
    ...
    for (;;)
    {
        foreach ( var_1 in level.players )
        {
            if ( isbot( var_1 ) )
            {
                var_2 = scripts\mp\utility\weapon::getweaponrootname( level._id_1B00 );
                var_3 = [];
...
_id_5951()
{
    for (;;)
    {
        ...
        if ( self._id_0132.basename != "s4_pi_mike1911" && self._id_0132.basename != "s4_pi_mike1911_mp" && self._id_0132.basename != "s4_me_fists_mp" && self._id_0132.basename != "none" )
            wait 3;
...
_id_26BE()
{
    ...
    for (;;)
    {
        var_0 = getdvarint( "#x32889850c5a6292a9" );
