...
_id_D795()
{
    level._id_279D["gametype_think"] = ::_id_273C;
}
...
_id_273C()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 && self _meth_8042() )
        {
            ...
            if ( scripts\mp\bots\bots_util::_id_2916( self._id_ED39._id_71A9, var_2 ) )
            {
                if ( self _meth_804F() )
                    var_1 = 1;
            }
            else if ( _id_09F9::_id_27ED( "kill_tag" ) && self._id_ED39 _id_271F( self.team ) )
            {
        ...
        if ( isdefined( self._id_ED39 ) )
        {
            ...
            if ( self._id_B023 == "camper" && self._id_3B6F )
            {
                ...
                {
                    if ( _id_09F7::_id_5AB1( self._id_ED39._id_71A9, 1000 ) )
            ...
            if ( !self._id_3B70 )
            {
                if ( !_id_09F9::_id_27ED( "kill_tag" ) )
                {
                    ...
                    var_5._id_DA40 = 1;
                    _id_09F9::_id_2862( "kill_tag", self._id_ED39._id_71A9, 25, var_5 );
                }
            }
        }
...
_id_271F( var_0 )
{
    return _id_07D6::_id_318C( var_0 );
}
...
_id_2810( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && ( var_4 || var_0._id_AA5C ) )
    {
        ...
        if ( var_5 )
        {
            var_6 = scripts\engine\utility::_id_10E76( self.origin, self getplayerangles(), var_0._id_4140, var_2 );
...
_id_2796( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && isdefined( level._id_4CE8 ) )
    {
        ...
        {
            if ( var_7 _id_271F( self.team ) )
            {
                var_8 = 0;

                if ( !var_0 || isdefined( var_7.attacker ) && var_7.attacker == self || isdefined( var_7._id_103C2 ) && var_7._id_103C2 == self )
                {
...
_id_2ED7( var_0 )
{
    var_0 endon( "reset" );
    var_0._id_2F09 = 1;
    var_0._id_AA5C = scripts\mp\bots\bots_util::_id_2891( var_0._id_4140, 16, level._id_28F2 + 55 );

    if ( var_0._id_AA5C )
    {
        var_0._id_71A9 = getgroundposition( var_0._id_4140, 0, 256, 32 );

        if ( !isdefined( var_0._id_71A9 ) )
            var_0._id_AA5C = 0;
    }

    var_0._id_2F09 = undefined;
}
...
_id_278D( var_0, var_1 )
{
    ...
    if ( var_0.size > 0 )
    {
        ...
        foreach ( var_5 in var_0 )
        {
            ...
            if ( !var_1 || var_6 < 2 )
            {
                var_7 = distancesquared( var_5._id_0427._id_71A9, self.origin );
...
_id_28A7( var_0 )
{
    ...
    {
        if ( var_3._id_0427 _id_271F( self.team ) && scripts\mp\bots\bots_util::_id_2916( var_3._id_0427._id_4140, var_3.origin ) )
        {
