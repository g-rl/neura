...
{
    loadweaponranktable();
    var_0 = getdvarfloat( "#x368f3566080d645df", 1 );
    var_1 = getdvarint( "#x3d4b34b03f860fb63", 1 );
    addglobalweaponrankxpmultiplier( var_1, "online_mp_weapon_xpscale" );
    addglobalweaponrankxpmultiplier( var_0, "online_zm_weapon_xpscale" );
    ...
    for (;;)
    {
        ...
        if ( !isai( var_0 ) )
        {
            if ( level.weaponxpenabled )
            {
                ...
                var_3 = getdvarint( "#x3f92a4d8892fe3de1", 40000 );
                var_0._id_9CC0 = var_3;
                var_0._id_F388 = 0;
                var_0._id_10FD8 = [];

                foreach ( var_5, var_3 in level._id_10DC3._id_9CBF )
                    var_0._id_10FD8[var_5 + "_mp"] = 0;
            }
        }
    }
}
...
_id_6FD1( var_0, var_1, var_2 )
{
    ...
    {
        var_1 = var_4;
        var_2 = _id_0756::getscoreinfovalue( var_1 );
    }
    ...
    _id_0705::_id_976B( var_0, var_15, var_16, var_2, var_1 );
    ...
    if ( var_9 < var_16 )
    {
        ...
        var_18 = _id_0756::getscoreinfovalue( var_17 );
        _id_0756::giverankxp( var_17, var_18 );
    }
...
_id_6E87()
{
    ...
    var_4 = 1.0;
    var_5 = _func_047A( self, 1 );

    if ( _func_0107( var_5 ) && isdefined( scripts\engine\utility::_id_1BAB( var_5, self ) ) && var_5.size > 1 )
        var_4 = var_4 * 1.25;

    var_6 = var_0 * var_1 * var_2 * var_4 * var_3;
    return var_6;
}
...
_id_6A67()
{
    if ( !isdefined( level._id_60FB ) )
        level._id_60FB = float( tablelookup( "mp/gametypesTable.csv", 0, scripts\cp\utility::getgametype(), 19 ) );
...
_id_6A63()
{
    if ( !isdefined( level._id_60F4 ) )
        level._id_60F4 = int( tablelookup( "mp/gametypesTable.csv", 0, scripts\cp\utility::getgametype(), 20 ) );
...
_id_6A64()
{
    ...
    {
        var_0 = getdvarint( _func_0483( "#x3ecead486797add6d", scripts\cp\utility::getgametype(), "_timelimit" ) );

        if ( var_0 == 0 )
            var_0 = 900;

        var_1 = getdvarint( _func_0483( "#x3ecead486797add6d", scripts\cp\utility::getgametype(), "_winlimit" ) );
