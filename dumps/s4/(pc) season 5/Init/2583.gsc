...
{
    level._id_15EF = [];
    scripts\common\interactive::_id_8397( ::_id_EB8D, "equip_supportBox" );
    _id_0A97::_id_C28A( ::_id_EB89 );
...
_id_EB89( var_0 )
{
    foreach ( var_2 in level._id_15EF )
    {
        if ( isdefined( var_2 ) )
            var_2 _id_EB87( var_0 );
    }
}
...
{
    var_0 endon( "death" );
    var_0 thread _id_EB92();
    var_0 thread _id_EB71();
    var_0 waittill( "missile_stuck", var_1 );
    var_0 _id_EB70( var_1 );
    ...
    scripts\mp\weapons::_id_AACF( var_0, "equip_supportBox", ::_id_EB62 );
    level._id_15EF[var_0 getentitynumber()] = var_0;
    var_0 _id_078D::_id_D15E( ::_id_EB63 );
...
_id_EB86()
{
    if ( 0 )
    {
        ...
        {
            if ( var_1._id_5562 == "equip_supportBox" )
            {
...
_id_EB77()
{
    scripts\common\interactive::_id_8398( "equip_supportBox" );
    self._id_B7E9 = [];
    self._id_FE46 = 0;
    self makeuseable();
    self _meth_83A1( -1 );
...
_id_EB73()
{
    thread _id_07C3::_id_A0FF( 100, "hitequip", ::_id_EB6F, ::_id_EB6D );
}
...
_id_EB6F( var_0 )
{
    _id_EB69( var_0.attacker );
    thread _id_EB64( var_0.attacker, 1 );
}

_id_EB5F( var_0, var_1 )
{
