...
_id_81E5()
{
    ...
    setdynamicdvar( "#x3e99a29ac0851dcc8", 0 );
    scripts\mp\utility\game::_id_C25D( scripts\mp\utility\game::getgametype(), 0 );
    setdynamicdvar( "#x3858d5e5517ba99fc", 0 );
}
...
_id_ABAD()
{
    ...
    {
        scripts\mp\utility\game::_id_D61C( var_3, &"OBJECTIVES/MINES" );

        if ( level.splitscreen )
            scripts\mp\utility\game::_id_D61A( var_3, &"OBJECTIVES/MINES" );
        else
            scripts\mp\utility\game::_id_D61A( var_3, &"OBJECTIVES/MINES_SCORE" );

        scripts\mp\utility\game::_id_D615( var_3, &"OBJECTIVES/MINES_HINT" );
    }
