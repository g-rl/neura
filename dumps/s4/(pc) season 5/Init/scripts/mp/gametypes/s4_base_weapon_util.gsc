...
s4_base_get_weapon_level( var_0 )
{
    var_1 = self;
...
s4_base_get_weapon_rarity_from_level( var_0, var_1 )
{
...
s4_base_get_weapon_level_from_object( var_0 )
{
    var_1 = getcompleteweaponname( var_0 );
    return s4_base_get_weapon_level_from_name( var_1 );
}

s4_base_get_weapon_level_from_name( var_0 )
{
    var_1 = strtok( var_0, "+" );
...
s4_base_player_has_weapon( var_0 )
{
