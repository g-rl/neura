...
{
    level._id_15EA = [];
    scripts\common\interactive::_id_8397( ::_id_BBE6, "equip_preserveKillstreakBox" );
    _id_0A97::_id_C28A( ::_id_BBE2 );
...
_id_BBE2( var_0 )
{
    foreach ( var_2 in level._id_15EA )
    {
        if ( isdefined( var_2 ) )
            var_2 _id_BBE0( var_0 );
    }
}
...
{
    var_0 endon( "death" );
    var_0 thread _id_BBE8();
    var_0 thread _id_BBD3();
    var_0 waittill( "missile_stuck", var_1 );
    var_0 _id_BBD2( var_1 );
    var_0._id_ADB6 = self getentitynumber();
    ...
    scripts\mp\weapons::_id_AACF( var_0, "equip_preserveKillstreakBox", ::_id_BBC7 );
    level._id_15EA[var_0 getentitynumber()] = var_0;
    var_0 _id_078D::_id_D15E( ::_id_BBC8 );
...
_id_BBDF()
{
    if ( 0 )
    {
        ...
        {
            if ( var_1._id_5562 == "equip_preserveKillstreakBox" )
            {
                var_1 thread _id_BBC7();
...
_id_BBC6( var_0, var_1 )
{
    ...
    scripts\mp\killstreaks\killstreaks::_id_C63D();
    wait( var_0 );
    self delete();
}
...
_id_BBD7()
{
    scripts\common\interactive::_id_8398( "equip_preserveKillstreakBox" );
    self._id_B7E9 = [];
    self._id_FE46 = 0;
    self makeuseable();
    self _meth_83A1( -1 );
...
_id_BBDB( var_0 )
{
    ...
    if ( self._id_ADB6 != var_0 getentitynumber() )
        return 0;
...
_id_BBD9( var_0 )
{
    var_0 scripts\mp\killstreaks\killstreaks::_id_96A9();
    _id_BBDC( var_0 );
    thread _id_BBDA();
    thread _id_BBC7();
    return 1;
...
_id_BBD5()
{
    thread _id_07C3::_id_A0FF( 100, "hitequip", ::_id_BBD1, ::_id_BBD0 );
}
...
_id_BBD1( var_0 )
{
    ...
    thread _id_BBC9( var_0.attacker, 1 );
}

_id_BBC5( var_0, var_1 )
{
...
_id_BBC3()
{
    self._id_75EC = _id_078F::_id_D59B( [], "v_ui_icon_fieldupgrade_fieldupgrade03", 20, 1, 1000, 100, undefined, 1 );
