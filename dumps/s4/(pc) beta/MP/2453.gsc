...
_id_F7A5()
{
    var_0 = scripts\cp_mp\utility\killstreak_utility::_id_4034( "white_phosphorus", self );
...
_id_10F61()
{
    ...
    playfx( level._id_F8FF["uav"]._id_6071, self.origin, var_0 );
...
_id_10F70( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    {
        var_15 = length( var_1 - var_12 ) / self._id_03C7;
...
_id_10F6A( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\cp_mp\utility\game_utility::_id_88E4() && level.gametype != "arm" )
        var_4 = 0;
    ...
    if ( var_9 )
        var_10 = _func_03C0( "ks_white_phosphorus_mp_p", var_6, self.angles );
    else
    {
    ...
    if ( istrue( var_4 ) )
    {
        ...
        if ( istrue( var_11 ) )
        {
            ...
            self._id_B7A6 = scripts\common\utility::_id_B7A3( var_6, 2000 );
            self._id_B7B6 = scripts\engine\utility::_id_1B7E( level.players, self._id_B7A6 );
...
_id_10F68( var_0, var_1, var_2, var_3 )
{
    ...
    if ( istrue( var_10 ) )
    {
        ...
        level._id_10E08.owner = var_4;
        level._id_10E08.team = var_5;
    ...
    foreach ( var_14 in var_12 )
    {
        ...
        {
            var_16 = spawn( "script_model", var_14._id_5C51 );
...
_id_10F7A( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) && var_2 != "surftype_water" )
    {
        if ( isdefined( var_1 ) )
        {
            ...
            {
                scripts\cp_mp\utility\killstreak_utility::_id_8D95( self.origin, 300, 300, var_0, self.owner, self.team );
                thread _id_10F5F();
            }
        }
