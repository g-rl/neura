...
_id_A5C6( var_0, var_1, var_2, var_3, var_4 )
{
...
_id_A5C7( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( level._id_5FF7 ) )
        return undefined;
...
_id_D06D( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( level._id_5FF7[var_0] ) )
        return;
...
_id_CD54( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( level._id_5FF7[var_0] ) )
        return;
...
_id_C00B( var_0 )
{
    return ( _func_008C( var_0 ) - var_0 * 0.5, _func_008C( var_0 ) - var_0 * 0.5, _func_008C( var_0 ) - var_0 * 0.5 );
}

_id_C00C( var_0, var_1 )
{
    var_2 = _func_008D( var_0, var_1 );

    if ( _func_008E( 2 ) == 0 )
        var_2 = var_2 * -1;

    var_3 = _func_008D( var_0, var_1 );

    if ( _func_008E( 2 ) == 0 )
        var_3 = var_3 * -1;

    var_4 = _func_008D( var_0, var_1 );
...
_id_C005()
{
    var_0 = _func_008C( 180 );
    var_1 = _func_008C( 360 );
    var_2 = _func_0014( var_1 ) * _func_0014( var_0 );
    var_3 = _func_0014( var_1 ) * _func_0043( var_0 );
    var_4 = _func_0043( var_1 );
    return ( var_2, var_3, var_4 );
}
...
{
    var_2 = _func_008E( var_1[var_1.size - 1] + 1 );
...
waittill_any_return( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5 ) )
        childthread _id_10925( var_5, var_6 );
...
_id_036D()
{
    ...
    {
        wait( _func_008D( self._id_CCF0, self._id_CCEE ) );
        return 1;
    }
...
_id_4773( var_0 )
{
    ...
    {
        var_2 = level._id_EA6D["script_linkname"][var_1];
    ...
    {
        var_5 = level._id_EA6D["script_noteworthy"][var_1];
    ...
    {
        var_6 = level._id_EA6D["target"][var_1];
    ...
    {
        var_7 = level._id_EA6D["targetname"][var_1];
...
_id_1B94( var_0 )
{
    ...
    {
        var_2 = getdvar( var_1, var_0.size );
        var_3 = var_0[var_1];
...
random( var_0 )
{
    ...
    return var_1[_func_008E( var_1.size )];
}
...
_id_BFE4( var_0 )
{
    ...
    var_5 = _func_008E( var_1.size * var_1.size );
    return var_1[var_1.size - 1 - _func_002C( _func_0046( var_5 ) )];
}
...
_id_5CBB( var_0, var_1 )
{
    ...
    var_2 = _func_005B( var_0 - distance2d( var_1, var_0 ) * var_1 );
    return var_2;
}
...
{
    var_4 = _func_005B( var_2 - var_0 );
    var_5 = _func_0007( var_1 );
    var_6 = distance2d( var_5, var_4 );
    return var_6 >= var_3;
}
...
_id_46C3( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    thread _id_46C4( var_1, var_0, var_2, var_3, var_4, var_5, var_6, var_7 );
}

_id_46C4( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    self endon( "death" );
...
_id_39CA( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = var_3 - var_2;
    var_6 = var_0 - var_2;
    var_7 = distance2d( var_4, var_4 );
    var_8 = distance2d( var_4, var_5 );
    var_9 = distance2d( var_5, var_5 );
    var_10 = distance2d( var_4, var_6 );
    var_11 = distance2d( var_5, var_6 );
...
{
    var_0 = _func_0055( var_0 );
    _func_00DE( var_0, var_1 );
}
