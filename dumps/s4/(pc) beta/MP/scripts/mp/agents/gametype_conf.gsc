...
_id_D78A()
{
    level._id_11C6["player"]["think"] = ::_id_11D4;
}

_id_11D4()
{
    thread scripts\mp\bots\bots_gametype_conf::_id_2716();
}
...
_id_11E1()
{
    ...
    if ( gettime() > self._id_A474 )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            var_2 = self.owner scripts\mp\bots\bots_gametype_conf::_id_2770( 1, var_1, var_0 );
