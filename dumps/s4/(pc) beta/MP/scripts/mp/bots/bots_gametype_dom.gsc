...
main()
{
    if ( scripts\common\utility::_id_8615() )
        return;
...
_id_A0BA()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 != "neutral" )
        {
            var_1 = _func_00F5( self._id_047A.origin );
...
_id_D765( var_0, var_1 )
{
    ...
    if ( var_2.size > 3 )
    {
        ...
        foreach ( var_5 in var_2 )
        {
            ...
            var_3[var_5._id_F032] = scripts\engine\utility::array_add( var_3[var_5._id_F032], var_5 );
        }
...
_id_26EF( var_0 )
{
    ...
    for ( var_2 = 0; var_2 < var_1.size - 1; var_2++ )
    {
        ...
        {
            var_7 = distance( var_1[var_2]._id_047A.origin, var_1[var_6]._id_047A.origin );
...
_id_DAD7( var_0 )
{
    if ( var_0 )
    {
        ...
        {
            var_1 = _id_63BB( self._id_9035.origin );
            ...
            else
            {
                ...
                var_3 = distancesquared( var_1._id_047A.origin, self._id_414D._id_047A.origin );
                var_4 = distancesquared( var_2._id_047A.origin, self._id_414D._id_047A.origin );
    ...
    for (;;)
    {
        ...
        if ( var_0 > self._id_A439 || self._id_5E3B )
        {
            ...
            else
            {
                self._id_5E3B = 0;
                _id_270D();
                self._id_A439 = var_0 + randomintrange( 30000, 45000 );
            }
        }

        scripts\engine\utility::_id_108F3( "needs_new_flag_goal", 1.0 );
    }
}
...
_id_DA7C()
{
    ...
    if ( self._id_414D scripts\mp\gametypes\dom::_id_6A26() == self.team )
        return 0;

    var_0 = _id_6488();

    if ( distancesquared( self.origin, self._id_414D._id_047A.origin ) < var_0 * 2 * ( var_0 * 2 ) )
    {
        var_1 = _id_6324( self.team );

        if ( var_1.size == 2 && !scripts\engine\utility::array_contains( var_1, self._id_414D ) && !_id_26D3() )
            return 0;
...
_id_6612()
{
    return level._id_2756[self.team];
}
...
_id_270D()
{
    ...
    else if ( var_1.size == 2 )
    {
        if ( var_2.size == 1 )
        {
            ...
            if ( _id_09D1::_id_27A3( self.team ) == 1 )
                var_9 = 1;
        }
    ...
    if ( var_9 )
    {
        if ( var_1.size > 1 )
        {
            ...
            var_14 = scripts\engine\utility::_id_634A( self.origin, var_10 );
            var_15 = [];
        ...
        if ( var_14.size == 1 )
            var_0 = var_14[0];
        else if ( distancesquared( var_14[0]._id_047A.origin, self.origin ) < 102400 )
            var_0 = var_14[0];
        else
        {
            var_29 = [];
            ...
            {
                var_32 = distance( var_14[var_31]._id_047A.origin, self.origin );
    ...
    else
    {
        if ( var_2.size > 1 )
        {
            ...
            var_40 = scripts\engine\utility::_id_634A( self.origin, var_10 );
            var_15 = [];
        ...
        if ( !isdefined( var_0 ) )
        {
            ...
            else if ( var_40.size == 2 )
            {
                ...
                var_52 = scripts\engine\utility::_id_634A( var_48._id_047A.origin, var_10 );
                var_15 = [];
...
_id_9E8B()
{
    var_0 = _id_09D1::_id_27A3( self.team );
...
_id_26D3()
{
    ...
    var_1 = scripts\mp\gamescore::_id_0BE6( scripts\engine\utility::_id_6460( self.team ) );
    var_2 = scripts\mp\gamescore::_id_0BE6( self.team );
    var_3 = 200 - var_1;
    var_4 = 200 - var_2;
...
_id_31FB( var_0, var_1, var_2 )
{
    ...
    if ( _id_2753() )
    {
        ...
        _id_09D0::_id_2873( var_0._id_047A.origin, _id_648A(), var_3 );
    }
    else
    {
        var_3["override_goal_type"] = var_1;
        var_3["entrance_points_index"] = _id_6489( var_0 );
        _id_09D0::_id_2704( var_0._id_047A.origin, var_0._id_A565, var_0._id_047A, var_3 );
    }
...
_id_45BB( var_0 )
{
    ...
    else
    {
        ...
        _id_09D0::_id_2873( var_0._id_047A.origin, _id_648A(), var_1 );
    }
...
_id_648A()
{
    if ( !isdefined( level._id_BDB1 ) )
    {
        ...
        level._id_BDB1 = min( 1000, var_1 / 3.5 );
    }
...
_id_2755( var_0, var_1 )
{
    if ( issubstr( var_0, "losing" ) && var_0 != "losing_score" && var_0 != "losing_time" && var_0 != "gamestate_domlosing" )
    {
        ...
        {
            self _meth_8045( "known_enemy", undefined, var_3._id_047A.origin );

            if ( !isdefined( self._id_8F23 ) || gettime() - self._id_8F23 > 10000 )
            {
                if ( _id_09D1::_id_27E5() )
                {
                    var_4 = distancesquared( self.origin, var_3._id_047A.origin ) < 490000;
    ...
    else if ( issubstr( var_0, "secured" ) )
    {
        ...
        var_6._id_8F58[self.team] = gettime();
    }
...
_id_A0BC( var_0 )
{
    ...
    while ( var_4 )
    {
        ...
        var_7 = _id_65D8( self.team );
        var_8 = _id_6457( self.team );

        if ( _id_09D1::_id_27DB() )
        {
            if ( var_6 == self.team && var_0._id_37D2 == "none" )
            {
                if ( !_id_2752() )
                    var_5 = 1;
            }

            if ( var_7 == 2 && var_6 != self.team && !_id_26D3() )
            {
                if ( distancesquared( self.origin, var_0._id_047A.origin ) > var_2 )
                    var_5 = 1;
            }
            ...
            foreach ( var_10 in var_8 )
            {
                ...
                {
                    if ( distancesquared( self.origin, var_10._id_047A.origin ) < var_3 )
                        var_5 = 1;
                }
            }
            ...
            if ( self _meth_81EF( var_0._id_047A ) && var_0._id_FEAF <= 0 )
            {
                if ( self _meth_8041() )
                {
                    ...
                    if ( distancesquared( self.origin, var_12 ) < _func_0214( var_13 ) )
                    {
        ...
        var_19 = level scripts\engine\utility::_id_108F5( "flag_changed_ownership", 1 + randomfloatrange( 0, 2 ) );
        var_20 = isdefined( var_19 ) && var_19 == "timeout";

        if ( !var_20 )
        {
            var_21 = max( ( 3 - self._id_E9F9 ) * 1.0 + randomfloatrange( -0.5, 0.5 ), 0 );
            wait( var_21 );
        }
    }
}
...
_id_63BB( var_0 )
{
    ...
    {
        var_5 = distancesquared( var_4._id_047A.origin, var_0 );
...
_id_65D6( var_0, var_1 )
{
    ...
    foreach ( var_5 in level._id_AE69 )
    {
        ...
        if ( var_5.team == self.team && var_5 != self && _id_0A67::_id_8A7B( var_5 ) )
        {
            if ( isai( var_5 ) )
            {
...
_id_6457( var_0 )
{
    ...
    foreach ( var_3 in level._id_A8D5 )
    {
        ...
        if ( var_4 == scripts\engine\utility::_id_6460( var_0 ) )
...
_id_6570( var_0 )
{
    var_1 = _id_09D1::_id_27A3( self.team );
...
_id_6682( var_0 )
{
    ...
    foreach ( var_4 in level._id_AE69 )
    {
        ...
        if ( var_4.team == self.team && var_4 != self && _id_0A67::_id_8A7B( var_4 ) )
        {
            if ( isai( var_4 ) )
            {
            ...
            var_5 = gettime() - var_0._id_8F58[self.team];

            if ( var_5 < 10000 )
                continue;

            if ( distancesquared( var_0._id_047A.origin, var_4.origin ) < var_1 * var_1 )
                var_2 = scripts\engine\utility::array_add( var_2, var_4 );
        }
    }
