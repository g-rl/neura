...
_id_2716()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 && self _meth_8041() )
        {
            ...
            if ( _id_09D1::_id_28F0( self._id_ED36._id_718C, var_2 ) )
            {
                if ( self _meth_804E() )
                    var_1 = 1;
            }
            else if ( _id_09D0::_id_27C7( "kill_tag" ) && self._id_ED36 _id_26F9( self.team ) )
            {
        ...
        if ( isdefined( self._id_ED36 ) )
        {
            ...
            if ( self._id_B010 == "camper" && self._id_3B4B )
            {
                ...
                {
                    if ( _id_09CE::_id_5A91( self._id_ED36._id_718C, 1000 ) )
            ...
            if ( !self._id_3B4C )
            {
                if ( !_id_09D0::_id_27C7( "kill_tag" ) )
                {
                    ...
                    var_5._id_DA3B = 1;
                    _id_09D0::_id_283C( "kill_tag", self._id_ED36._id_718C, 25, var_5 );
                }
            }
        }
...
_id_26F9( var_0 )
{
    return _id_07AD::_id_3166( var_0 );
}
...
_id_27EA( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && ( var_4 || var_0._id_AA49 ) )
    {
        ...
        if ( var_5 )
        {
            var_6 = scripts\engine\utility::_id_10E74( self.origin, self getplayerangles(), var_0._id_411F, var_2 );
...
_id_2770( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && isdefined( level._id_4CC7 ) )
    {
        ...
        {
            if ( var_7 _id_26F9( self.team ) )
            {
                var_8 = 0;

                if ( !var_0 || isdefined( var_7.attacker ) && var_7.attacker == self || isdefined( var_7._id_103C0 ) && var_7._id_103C0 == self )
                {
...
_id_2EB1( var_0 )
{
    var_0 endon( "reset" );
    var_0._id_2EE3 = 1;
    var_0._id_AA49 = _id_09D1::_id_286B( var_0._id_411F, 16, level._id_28CC + 55 );

    if ( var_0._id_AA49 )
    {
        var_0._id_718C = getgroundposition( var_0._id_411F, 0, 256, 32 );

        if ( !isdefined( var_0._id_718C ) )
            var_0._id_AA49 = 0;
    }

    var_0._id_2EE3 = undefined;
}
...
_id_2767( var_0, var_1 )
{
    ...
    if ( var_0.size > 0 )
    {
        ...
        foreach ( var_5 in var_0 )
        {
            ...
            if ( !var_1 || var_6 < 2 )
            {
                var_7 = distancesquared( var_5._id_0400._id_718C, self.origin );
...
_id_2881( var_0 )
{
    ...
    {
        if ( var_3._id_0400 _id_26F9( self.team ) && _id_09D1::_id_28F0( var_3._id_0400._id_411F, var_3.origin ) )
        {
