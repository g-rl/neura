...
_id_81CB()
{
    ...
    scripts\mp\utility\game::_id_C24F( "blitz", 0 );
...
_id_AB9A()
{
    ...
    scripts\mp\utility\game::_id_D610( game["attackers"], &"OBJECTIVES/BLITZ" );
    scripts\mp\utility\game::_id_D610( game["defenders"], &"OBJECTIVES/BLITZ" );
...
_id_5BE8()
{
    ...
    foreach ( var_3 in level._id_01AF )
    {
        switch ( var_3._id_CD8C )
        {
            case "_a":
                if ( istrue( game["switchedsides"] ) )
                    level._id_4549[game["defenders"]] = var_3.origin;
                else
                    level._id_4549[game["attackers"]] = var_3.origin;
    ...
    {
        if ( istrue( game["switchedsides"] ) )
            level._id_4549[game["attackers"]] = var_5.origin;
        else
            level._id_4549[game["defenders"]] = var_5.origin;
    }
...
_id_403C( var_0, var_1 )
{
    ...
    var_4 = spawn( "trigger_radius", var_3.origin - ( 0, 0, var_3._id_0333 / 2 ), 0, var_3._id_0333, 80 );
    var_4._id_A509 = 1;
    var_4._id_94FD = 1;
    var_4._id_22FB = var_4.origin;
    var_2 = 1;
    ...
    {
        var_8._id_A6B1 = 1;
        var_8._id_37CF = max( level._id_B0A0 * 1000, level._id_C792 * 1000 );
    ...
    var_11 = scripts\engine\trace::_id_3EC3( 1, 1, 1, 1, 0, 1, 1 );
    var_12 = [];
    var_13 = scripts\engine\trace::ray_trace( var_9, var_10, var_12, var_11 );
    var_8._id_228F = var_8._id_1042E[0].origin;
    var_14 = anglestoup( var_8._id_1042E[0].angles );
...
_id_AB3A( var_0, var_1, var_2 )
{
    ...
    if ( var_3 != _id_07AD::_id_6BE3() )
    {
        ...
        _id_0A79::_id_B8DE( "mp_obj_returned", scripts\mp\utility\game::_id_6BC3( var_3 )[0] );
...
_id_ABB8( var_0 )
{
    if ( !level._id_609B )
    {
        ...
        _id_0A79::_id_B8DE( "mp_enemy_obj_captured", scripts\mp\utility\game::_id_6BC3( var_1 )[0] );
        ...
        if ( level._id_EF6F[scripts\mp\utility\game::_id_6BC3( var_1 )[0]]._id_1D2C )
            level scripts\mp\gamescore::_id_6FE4( var_1, 2, 0 );
        else
