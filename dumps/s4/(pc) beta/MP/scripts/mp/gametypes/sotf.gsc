...
_id_81CB()
{
    ...
    _func_01D2( "scr_sotf_crateamount", getmatchrulesdata( "sotfData", "crateAmount" ) );
    _func_01D2( "scr_sotf_crategunamount", getmatchrulesdata( "sotfData", "crateGunAmount" ) );
    _func_01D2( "scr_sotf_cratetimer", getmatchrulesdata( "sotfData", "crateDropTimer" ) );
    _func_01D2( "scr_sotf_roundlimit", 1 );
    scripts\mp\utility\game::_id_C29B( "sotf", 1 );
    _func_01D2( "scr_sotf_winlimit", 1 );
    scripts\mp\utility\game::_id_C2C2( "sotf", 1 );
    _func_01D2( "scr_sotf_halftime", 0 );
    scripts\mp\utility\game::_id_C24F( "sotf", 0 );
    _func_01D2( "scr_sotf_promode", 0 );
}
        ...
        else
        {
            while ( isalive( var_2 ) )
            {
                if ( level._id_51AB )
                {
                    ...
                    level thread _id_DC90( "sotf_crate_incoming" );
                    wait( var_1 );
                    continue;
                }
...
_id_E045( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_7 = getcompleteweaponname( var_5._id_8FAB );
        ...
        if ( self._id_3E7E == "sotf_weapon" && var_3 == getdvarint( "scr_sotf_crategunamount", 6 ) )
