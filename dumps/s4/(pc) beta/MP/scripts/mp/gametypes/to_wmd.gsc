...
_id_9964()
{
    level._id_ED1F = "to_wmd";
    level._id_41B1 = "to_wmd";
...
_id_9965()
{
    ...
    {
        scripts\mp\utility\game::_id_C29C( "to_wmd", 0, 0, 9 );
        scripts\mp\utility\game::_id_C2B3( "to_wmd", 10 );
        scripts\mp\utility\game::_id_C29F( "to_wmd", 65 );
        scripts\mp\utility\game::_id_C29B( "to_wmd", 1 );
        scripts\mp\utility\game::_id_C2C2( "to_wmd", 1 );
        scripts\mp\utility\game::_id_C270( "to_wmd", 0 );
        scripts\mp\utility\game::_id_C24F( "to_wmd", 0 );
        scripts\mp\utility\game::_id_C242( "to_wmd", 0 );
        level._id_9BD4 = 0;
    }
...
{
    scripts\mp\utility\game::_id_D4D3();
    _func_01D2( "scr_to_wmd_waverespawndelay", 5 );
...
_id_827A()
{
    ...
    _id_07EE::_id_110D( "allies", "mp_towmd_spawn_allies", 1 );
    _id_07EE::_id_110D( "axis", "mp_towmd_spawn_axis", 1 );
    var_0._id_F2AE = [];
    var_0._id_F2AE["allies"] = _id_07EE::_id_6D30( "mp_towmd_spawn_allies" );
    var_0._id_F2AE["axis"] = _id_07EE::_id_6D30( "mp_towmd_spawn_axis" );

    if ( var_0._id_F2AE["allies"].size <= 0 )
    {
        _id_07EE::_id_110D( "allies", "mp_front_spawn_allies" );
        var_0._id_F2AE["allies"] = _id_07EE::_id_6D30( "mp_front_spawn_allies" );
    }

    if ( var_0._id_F2AE["axis"].size <= 0 )
    {
        _id_07EE::_id_110D( "axis", "mp_front_spawn_axis" );
        var_0._id_F2AE["axis"] = _id_07EE::_id_6D30( "mp_front_spawn_axis" );
    }
}
...
_id_6D2C()
{
    ...
    var_2 = _id_07F3::_id_5A34( var_0._id_F2AE[var_1] );
    var_3 = undefined;
    return var_3;
}
...
_id_0ED5()
{
    ...
    _id_07F3::_id_D452( "to_wmd", "allies" );
    _id_07F3::_id_D452( "to_wmd", "axis" );
