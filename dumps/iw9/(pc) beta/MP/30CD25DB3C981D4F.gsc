...
{
    self playlocalsound( "iw9_smoke_airdrop_tablet_raise" );
...
{
    scripts\mp\killstreaks\mapselect::_id_90F093CA8576232F( 0, 1, "short_arrow" );
    return 1;
}
...
_id_5E73F80DAA45F50C()
{
    ...
    self playlocalsound( "iw9_smoke_airdrop_tablet_press" );
    thread _id_5EA4C63126AD14FC( _id_19163E14365D9264, mappointinfo );
    scripts\cp_mp\challenges::_id_BD59AA7E8CECE1AB( "super_smoke_airdrop", 0 );
    return 1;
}
...
_id_645FF6D87A68EB7E( _id_76A22C18960F72AF, _id_A4521BB88F4EB389, streakinfo )
{
    ...
    for ( _id_AC0E594AC96AA3A8 = 0; _id_AC0E594AC96AA3A8 < _id_C622144D94AE6D95; _id_AC0E594AC96AA3A8++ )
    {
        ...
        if ( !_id_409CF6F9FE71F7D2 )
        {
            ...
            _id_E767D0CB155A0E85[index] = spawn( "script_model", _id_265AC1F6B1F28744 + anglestoup( _id_EC85ED3E96DAE633 ) * _id_ECB39C9EECBD70AD );
            _id_E767D0CB155A0E85[index] setmodel( "misc_wm_smoke_airdrop_drone_v0" );
            _id_E767D0CB155A0E85[index].angles = _id_EC85ED3E96DAE633;
            _id_E767D0CB155A0E85[index]._id_BFC217EF9A050627 = 1;
            _id_4C1FC889585F5DF5[index] = _id_265AC1F6B1F28744;
            _id_E767D0CB155A0E85[index].index = index + 1;
            _id_E767D0CB155A0E85[index].animname = "super_smoke_airdrop";
            _id_E767D0CB155A0E85[index] scripts\common\anim::setanimtree();
            _id_E767D0CB155A0E85[index] setscriptablepartstate( "smokeDeploy", "deployStart", 0 );
            _id_E767D0CB155A0E85[index] thread scripts\mp\damage::monitordamage( 100, "hitequip", ::_id_9353AA49397987C8 );
        }
