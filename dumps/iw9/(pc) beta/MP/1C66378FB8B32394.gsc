            ...
            if ( isdefined( seatid ) )
            {
                ...
                if ( istrue( _id_DF653126C71EF4CA ) )
                {
                    if ( isdefined( player.vehiclecustomization ) )
                    {
                        ...
                        if ( !isdefined( vehicle._id_35FD13041DDE93E8 ) )
                        {
...
_id_C5819749DB1604F5( player, vehicle, seatid, data )
{
    ...
    if ( _id_2E7B44E2B456F504._id_C08D88C04569A00B == "animated" )
    {
        ...
        vehicle endon( "death" );
        player _id_3B64EB40368C1450::_id_59C053B89257BC95( "vehicle_occupant_common", [ "script_weapon_switch", "weapon_switch", "melee", "vehicle_seat_switch", "allow_movement" ], 0 );
