...
_id_183BC29D2DAB9FDF( _id_0889F3D7E1C1EA6B, bot, position, _id_FDE6CF296EB26748, _id_EA742470751D2E85 )
{
    ...
    _id_09A590D62A7E6BD9::_id_9A0A24DE119B078A( "Traversal", _id_444A5451F436094A );
}
...
_id_35671B7B1A04BF58( bot )
{
    ...
    _id_0D22FDCA158E266E = 15;
    _id_07D2294C58A5C346 = 50;
    _id_FC77E2B383D17EC9 = bot _id_09A590D62A7E6BD9::_id_721588AE374756B5( bot._id_3C59090EE220AB3D._id_A0F72E651FD6A385[0].origin, _id_0D22FDCA158E266E, _id_07D2294C58A5C346 );
    ...
    _id_F3F364499C3A6ECC( bot, bot._id_3C59090EE220AB3D._id_A0F72E651FD6A385 );
}
...
_id_F3F364499C3A6ECC( bot, _id_A0F72E651FD6A385 )
{
    _id_4112BB19CC3C6A26 = 60;
    starttime = gettime();
    dist = distance( _id_A0F72E651FD6A385[0].origin, _id_A0F72E651FD6A385[1].origin );
    _id_068291B1086BFF85 = ( dist / _id_4112BB19CC3C6A26 + 2 ) * 1000;
    _id_172FFC4A18F645A9 = 15000;
    _id_CBEF341A3AEEF001 = 32;
    bot _id_40E63DD222434655::_id_9E400058EF021B03( _id_A0F72E651FD6A385[1].origin, _id_CBEF341A3AEEF001 );

    for (;;)
    {
        result = _id_09A590D62A7E6BD9::_id_B564050A363F08EC( bot, 0.25 );

        if ( result == "goal" )
        {
            _id_23B90B34FECC58CD = gettime() - starttime;
        ...
        else if ( result == "timeout" )
        {
            ...
            {
                _id_A38DF45AB16839F3( "timeout", bot );
                break;
            }
        }
        else
...
{
    return _id_481B7172FB4EC991::_id_FF35A4D756374EDE( "Auto Test Traversal", undefined, "main", "", ::_id_35671B7B1A04BF58, self, ::_id_F4CAAE7E8AF9D32C );
}
