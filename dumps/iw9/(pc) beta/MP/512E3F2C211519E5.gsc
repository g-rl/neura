...
_id_E3D9D27A30E4D693( bot )
{
    ...
    return _id_481B7172FB4EC991::_id_FF35A4D756374EDE( "Auto Test Wander", target, "main", "", ::_id_35671B7B1A04BF58, self, ::_id_F4CAAE7E8AF9D32C );
}
...
_id_35671B7B1A04BF58( bot )
{
    ...
    for (;;)
    {
        result = _id_09A590D62A7E6BD9::_id_B564050A363F08EC( bot, _id_99DC4BF78AE2B370 );
...
_id_183BC29D2DAB9FDF( _id_0889F3D7E1C1EA6B, bot, position, target, path, _id_D478708F077A4A52 )
{
    ...
    _id_09A590D62A7E6BD9::_id_9A0A24DE119B078A( "Wander", _id_444A5451F436094A );
...
_id_ACC026B91A4D7E73( _id_0889F3D7E1C1EA6B, bot, position, target, path, _id_D478708F077A4A52 )
{
    ...
    if ( _id_444A5451F436094A != "" )
        _id_09A590D62A7E6BD9::_id_9A0A24DE119B078A( "Wander_Bug", _id_444A5451F436094A );
}
