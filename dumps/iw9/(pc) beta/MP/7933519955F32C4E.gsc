...
beginbrc130playeraniminfilsequence( c130pathstruct, infil_anim_type, players )
{
    ...
    _id_7E87B4177E5FC529 = level.script == "mp_don3_mobile";

    if ( _id_7E87B4177E5FC529 && !_id_28EE4F41E0D3BA3F )
...
transitionplayerstoac130cinematic( players, infil_anim_type, c130 )
{
    ...
    foreach ( player in players )
    {
        ...
        player _meth_8B338BF92F461E6C( c130.origin, 1 );
    }
...
playac130animinternal( animstruct, players )
{
    ...
    animstruct.cameraent scriptmodelplayanim( "sdr_mp_infil_ac130_redux_players_cam", "camera" );

    if ( isdefined( animstruct.cameraentmoving ) )
        animstruct.cameraentmoving scriptmodelplayanim( "sdr_mp_infil_ac130_redux_players_cam", "camera" );
