...
init_airstrike_params()
{
    ...
    deployweaponname = scripts\engine\utility::ter_op( getdvarint( "dvar_39C3947A2E4F5F9E" ) != 0, "iw9_spotter_scope_mp_mgl", "iw9_spotter_scope_mp" );
    ...
    level.airstrikesettings["precision_airstrike"].deployweaponobj = scripts\cp_mp\utility\weapon_utility::_id_EEAA22F0CD1FF845( deployweaponname );
...
airstrike_startmapselectsequence( _id_FB5BCF10CCC2C5DF, _id_EDC5BB5A4B3DD2FF, _id_7426E996C9EB34D3 )
{
