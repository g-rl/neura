...
player_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "isInGulagCheck", _id_2CEDCC356F1B9FC8::isplayeringulag );
}
...
_id_550BCD278C30275E()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "agents", "canActivateAgent", _id_371B4C2AB5861E62::_id_B894B8689A6055F3 );
