...
bombzone_onenduse( team, player, result )
{
    ...
    else if ( isdefined( level.sdbombmodel ) && !result )
    {
        if ( self.bombplanted )
...
bombzone_onbombplanted( _id_2810BD61A09D19F5, player )
{
    ...
    else if ( scripts\mp\utility\game::getgametype() == "dd" || scripts\mp\utility\game::getgametype() == "btm" )
    {
        ...
        level.ddbombmodel[_id_2810BD61A09D19F5.objectivekey] setmodel( getbombmodel() );
    ...
    if ( getdvarint( "dvar_9CF963B64E1223E7", 0 ) == 1 )
    {
        ...
        level.sdbombmodel.scriptable = spawnscriptable( "offhand_wm_briefcase_bomb", _id_FF7F197ECB7A2B90.trigger.origin + ( 0, 0, 2 ), ( 0, 0, 0 ) );
        level.sdbombmodel.scriptable setscriptablepartstate( "bomb", "plantedAllies" );
    }
    else if ( scripts\mp\utility\game::getgametype() == "gwbomb" )
    {
...
bombzone_setupbombcase( _id_C7FAB14D7179F1FE )
{
    ...
    else
    {
        ...
        if ( getdvarint( "dvar_9CF963B64E1223E7", 0 ) == 1 )
        {
            visuals[0].scriptable = spawnscriptable( "offhand_wm_briefcase_bomb", trigger.origin + ( 0, 0, 2 ), ( 0, 0, 0 ) );
            ...
            visuals[0] setmodel( getbombmodel() );
