...
ondeploystart( streakinfo )
{
    ...
    streakinfo.owner thread _id_44D17DBE4DB72EA9();
...
watchdeployweaponanimtransition( streakinfo, animlength, _id_67A06B4EA269058E )
{
    ...
    switch ( streakinfo.streakname )
    {
        ...
        case "nuke":
            ...
            break;
        case "chopper_gunner":
            alias = "iw9_chopper_gunner_tablet";
            break;
        case "cruise_predator":
            alias = "iw9_cruise_missile_tablet";
            break;
        case "gunship":
            alias = "iw9_gunship_tablet";
            break;
        case "pac_sentry":
            alias = "iw9_wheelson_tablet";
            break;
    }
