...
_id_C08668FE290FC31A()
{
    ...
    if ( istrue( level._id_6DF475909FFB403D ) && isdefined( level._id_CBA912D9C95F382C ) )
        [[ level._id_CBA912D9C95F382C ]]();
...
_id_24D78167783C535F()
{
    ents = scripts\engine\utility::array_combine( getentarray( "trigger_multiple", "classname" ), _func_F159C10D5CF8F0B4( "noent_volume_trigger", "classname" ) );
