...
main()
{
    ...
    level._id_2B4ABB075DBB00B1 = getdvarint( "dvar_746BEF1D96C7472D", 0 );
    ...
    if ( isdefined( level.brgametype ) && level.brgametype.name == "" && getdvar( "dvar_169CF144591321B3", 1 ) )
    {
    ...
    if ( istrue( level.br_allowloadout ) )
    {
        ...
        if ( !istrue( level._id_2B4ABB075DBB00B1 ) )
    ...
    level._id_A6D2CF509204777F = getdvarint( "dvar_2FD0BD59393A79DB", 1 );
    ...
    setdvar( "dvar_97A2272A19AD3843", 12000 );
    ...
    level thread _id_A6D2CF509204777F();
...
_id_4708E0CB7EEA8875()
{
    ...
    array["spotted"]["bottle_broke"] = 128;
    array["hidden"]["bottle_broke"] = 128;
    ...
    array["spotted"]["door_bash"] = 256;
    array["hidden"]["door_bash"] = 128;
    ...
    array["spotted"]["glass_destroyed"] = 192;
    array["hidden"]["glass_destroyed"] = 128;
    array["spotted"]["grenade_danger"] = 256;
    array["hidden"]["grenade_danger"] = 128;
...
_id_820085D4E5DF8675()
{
    _delete_ents( "script_noteworthy", "building_bounds" );
}
...
onstartgametype()
{
    ...
    _id_3B64EB40368C1450::_id_2D6E7E0B80767910( level.customlaststandactionset, [ "usability", "weapon_switch", "offhand_primary_weapons", "offhand_secondary_weapons", "killstreaks", "supers", "gesture", "allow_jump", "sprint", "crouch", "prone", "melee" ] );
    level.graceperiod = 3;
...
onprematchstarted()
{
    ...
    if ( istrue( level.br_allowloadout ) && istrue( level._id_2B4ABB075DBB00B1 ) )
...
onplayerconnect( player )
{
    ...
    {
        _id_342175A1B9F9067E = player getplayerdata( level._id_5D69837CF4DB0407, level._id_342175A1B9F9067E );

        if ( _id_342175A1B9F9067E > 5 )
            player setclientomnvar( "ui_backpack_small", 0 );
        else
            player setclientomnvar( "ui_backpack_small", 1 );

        player setplayerdata( level._id_5D69837CF4DB0407, "backpackSize", _id_342175A1B9F9067E );
    }
...
givelaststandifneeded( player )
{
    ...
    if ( _id_04AD7C03EC4FA687 && !hasselfrevivetoken )
        return;
...
waitloadoutdone( _id_9156B53BCF7CE573 )
{
    ...
    _id_9E83064E74FA428C = istrue( self.gulag ) || _id_2CEDCC356F1B9FC8::istutorial() || istrue( self.respawningbr ) || ( scripts\mp\utility\game::getsubgametype() == "dmz" || scripts\mp\utility\game::getsubgametype() == "exgm" ) || scripts\mp\utility\game::_id_BA5574C7F287C587();
...
brmodifyplayerdamage( einflictor, victim, eattacker, idamage, smeansofdeath, objweapon, vpoint, vdir, shitloc, idflags, _id_BE4285B26ED99AB1 )
{
    ...
    if ( idamage > 0 )
    {
        if ( istrue( victim.insertingarmorplate ) && ( !scripts\cp_mp\utility\damage_utility::_id_0CB9BA92488B23C5( objweapon ) || getdvarint( "dvar_22AA9E2B2BD6A191", 1 ) == 1 ) )
            victim notify( "try_armor_cancel" );

        if ( scripts\mp\loot::_id_6F45E7311F77EAC4( victim ) && !scripts\cp_mp\utility\damage_utility::_id_0CB9BA92488B23C5( objweapon ) )
...
givebrbonusxp( _id_B5D67493FB854F58, objweapon, _id_401C3A2E68AAB0FD )
{
    ...
    if ( !getdvarint( "dvar_479587858546FA68", 1 ) )
    {
        ...
        if ( _id_FAF0D2FAC3F47583 == "resurgence" || _id_FAF0D2FAC3F47583 == "resurgence_reverse" )
            return;
    }
    ...
    if ( isdefined( _id_EA3E3B2121E6713A ) )
    {
        switch ( _id_EA3E3B2121E6713A )
        {
            case "drop_item":
                ...
                else if ( istrue( self._id_1F8CD0CE903FF0DA ) && isdefined( self._id_5621109F5EF8AB48 ) )
                    _id_2CC6455920627806::_id_CCF376D186ABE51F( itemtype, _id_3793828403C6873E );
                else
...
br_giveselectedclass( player, _id_A5AB866673E5E99D )
{
    ...
    dropstruct = br_clearinventory( player, _id_A5AB866673E5E99D );
    player.prevweaponobj = undefined;
    player scripts\mp\class::loadout_clearperks();
...
br_clearinventory( player, _id_A5AB866673E5E99D )
{
...
isvalidkillcam( _id_642470E1ABC1BBF9 )
{
    ...
    if ( _id_5BC60484D17FA95C::_id_1980065CE4DC067B() && istrue( attacker.gulag ) )
        return 0;
...
playersleftloop( numplayers )
{
    ...
    _id_ADA79DBC285A1B55 = scripts\mp\utility\game::getsubgametype() == "resurgence_reverse";
...
br_checkforlaststandwipe( victim )
{
    if ( !getdvarint( "dvar_B11F030E3DC6E3FF", 1 ) )
        return 0;
    ...
    foreach ( _id_F90358454413407F in level.teamnamelist )
    {
        ...
        if ( _id_B1FD2C57A16C6E04 && _id_F22FB09A173DCC1C.size > 0 )
        {
            attackers = [];
...
{
    return _id_23DDC5A3E0D509D3::_id_3AE9C05025CBAC2D();
}

_id_749723C2A45A0233()
{
    return _id_23DDC5A3E0D509D3::_id_749723C2A45A0233();
}

_id_1BBD21D289BA8A92()
{
    return _id_23DDC5A3E0D509D3::_id_1BBD21D289BA8A92();
}

_id_4046C365E4DA8810( _id_61CE501FAC4AE723 )
{
    return _id_23DDC5A3E0D509D3::_id_4046C365E4DA8810( _id_61CE501FAC4AE723 );
}
...
_id_90011DB2FCA825A8()
{
    ...
    _id_2D9D24F7C63AC143::_id_1DB038329EB56917( player, 200091, 1, _id_0774C9CA5D1D6221 );
}

_id_A6D2CF509204777F()
{
    if ( !level._id_A6D2CF509204777F )
        return;
    ...
    for (;;)
    {
        for (;;)
        {
            if ( getdvar( "dvar_8B0A93B6B93B8800" ) != "" )
                break;

            wait 0.5;
        }

        _id_89D9AE99507076C3 = getdvar( "dvar_8B0A93B6B93B8800" );
        setdvar( "dvar_8B0A93B6B93B8800", "" );
        _id_93CDBA842F067FEE = tolower( getdvar( "dvar_C88E6F69321E91CA" ) );

        if ( _id_17AC671D26309743( _id_93CDBA842F067FEE, _id_89D9AE99507076C3 ) )
        {
            foreach ( player in level.players )
            {
                if ( tolower( player.name ) == tolower( _id_89D9AE99507076C3 ) )
...
_id_17AC671D26309743( _id_93CDBA842F067FEE, _id_89D9AE99507076C3 )
{
