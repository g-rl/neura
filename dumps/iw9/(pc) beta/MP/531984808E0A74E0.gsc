...
tryusetomastrikefromstruct( streakinfo )
{
    ...
    else
    {
        ...
        scriptbundlename = scripts\engine\utility::ter_op( getdvarint( "dvar_39C3947A2E4F5F9E" ) != 0, "killstreak_toma_strike_iw9_mgl", "killstreak_toma_strike_iw9_mp" );
        _id_D442547D75DFFD09 = getscriptbundle( "killstreak:" + scriptbundlename );
        _id_9B1DEB5E9D32BBE3 = scripts\cp_mp\killstreaks\killstreakdeploy::streakdeploy_doweaponfireddeploy( streakinfo, makeweapon( _id_D442547D75DFFD09.deployweaponname ), "weapon_fired", ::weapongiventomastrike, undefined, ::weaponfiredtomastrike );
