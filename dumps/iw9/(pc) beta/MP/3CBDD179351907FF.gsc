...
initcratedropdata()
{
    ...
    if ( isdefined( _id_D8D1344707480943 ) )
    {
        ...
        if ( issubstr( level.mapname, "aniyah" ) )
            _id_962A30A9BB8C0F09.heliheight = _id_D8D1344707480943.origin[2] + 500;

        if ( issubstr( level.mapname, "luxury" ) )
            _id_962A30A9BB8C0F09.heliheight = _id_D8D1344707480943.origin[2] - 350;
    }
    else
        _id_962A30A9BB8C0F09.heliheight = 2500;
...
dropcratefromscriptedheli( owner, team, cratetype, position, angles, destination, data, streakinfo )
{
    ...
    if ( !isdefined( destination ) )
    {
        destination = getcratedropdestination( _id_EBB5C644A3F5CFBC, getcratedropcastend( _id_EBB5C644A3F5CFBC, 1 ) );
...
{
    return caststart + ( 0, 0, -1 * scripts\engine\utility::ter_op( istrue( _id_5E43D97DFC3D0419 ), 8000, 8000 ) );
}

getcratedropdestination( caststart, castend )
{
    destination = undefined;
    contents = physics_createcontents( [ "physicscontents_itemclip", "physicscontents_glass", "physicscontents_water", "physicscontents_item" ] );
    ...
    if ( isdefined( _id_AA517194E54F048B ) && _id_AA517194E54F048B.size > 0 )
        destination = _id_AA517194E54F048B[0]["position"];
...
createheli( owner, team, position, angles, vehicleisreserved, streakinfo )
{
    ...
    setdvarifuninitialized( "dvar_FF472A2ED54960F7", "1" );
    _id_B514D5120067A18A = "veh_airdrop_mp";

    if ( getdvarint( "dvar_FF472A2ED54960F7" ) > 0 )
    {
        ...
        heli = scripts\cp_mp\vehicles\vehicle_tracking::_spawnhelicopter( owner, position, angles, _id_B514D5120067A18A, _id_F98416D816CEEC66 );
    else
        heli = scripts\cp_mp\vehicles\vehicle_tracking::_spawnhelicopter( level.players[randomint( level.players.size )], position, angles, _id_B514D5120067A18A, _id_F98416D816CEEC66 );
...
watchcrateuseinternal( player, useobject )
{
    ...
    _id_EF5D5141FDB51174.id = "care_package";
...
_createheadicon()
{
    ...
    if ( isdefined( self.headicon ) )
    {
        ...
        else if ( isdefined( self.owner ) )
        {
            ...
            scripts\cp_mp\entityheadicons::setheadicon_singleimage( level.teamnamelist, self.headicon, headiconoffset, 1, _id_962A30A9BB8C0F09.headicondrawrange, _id_962A30A9BB8C0F09.headiconnaturalrange );
    }
...
airdropmarkeractivate( droptype, lifeid, streakinfo, _id_4B0C1A8C50D15340 )
{
    ...
    foreach ( _id_F9567F37DB523F7A in _id_F74F18C717B149E2 )
    {
        ...
        _id_C45BBEB56DF09B5D = targetpos + ( 0, 0, _id_359711DD322783EC );
