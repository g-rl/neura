...
init()
{
    enabled = _id_3ACF1C0EBAF602F2::registerquestcategory( "timedrun_legacy", 1 );

    if ( !enabled )
        return;

    _id_3ACF1C0EBAF602F2::getquestdata( "timedrun_legacy" ).missionbasetimer = getdvarint( "dvar_73B9A21075D1C16F", 120 );
    _id_3ACF1C0EBAF602F2::getquestdata( "timedrun_legacy" ).kiosksearchradiusmax = getdvarint( "dvar_D2B0F83481549836", 23000 );
    _id_3ACF1C0EBAF602F2::getquestdata( "timedrun_legacy" ).kiosksearchradiusmin = getdvarint( "dvar_D28D0A34812C4514", 10000 );
    _id_3ACF1C0EBAF602F2::getquestdata( "timedrun_legacy" ).kiosksearchradiusidealmax = getdvarint( "dvar_E87E65B835A44C31", 23000 );
    _id_3ACF1C0EBAF602F2::getquestdata( "timedrun_legacy" ).kiosksearchradiusidealmin = getdvarint( "dvar_E8A257B835CCA81F", 17000 );
    _id_3ACF1C0EBAF602F2::registerremovequestinstance( "timedrun_legacy", ::tr_removequestinstance );
    _id_3ACF1C0EBAF602F2::registeronplayerdisconnect( "timedrun_legacy", ::tr_playerdisconnect );

    if ( !enabled )
        return;

    _id_3ACF1C0EBAF602F2::registertabletinit( "timedrun_legacy", ::trtablet_init );
...
trtablet_init()
{
    ...
    placement = _id_3ACF1C0EBAF602F2::findquestplacement( "timedrun_legacy", _id_354D1457278B342C );
...
{
    instance = _id_3ACF1C0EBAF602F2::createquestinstance( "timedrun_legacy", self.team, pickupent.index, pickupent );
    ...
    _id_3ACF1C0EBAF602F2::questtimerinit( "timedrun_legacy", 1 );
    _id_3ACF1C0EBAF602F2::registerontimerexpired( "timedrun_legacy", ::tr_ontimerexpired );
    instance _id_3ACF1C0EBAF602F2::questtimerset( getdvarint( "dvar_7DE6F07B99F49585", getdvarint( "dvar_73B9A21075D1C16F", 120 ) ), 4 );
    _id_3ACF1C0EBAF602F2::addquestinstance( "timedrun_legacy", instance );
    _id_3ACF1C0EBAF602F2::startteamcontractchallenge( "timedrun_legacy", self, self.team );
    params = spawnstruct();
    params.excludedplayers = [];
    params.excludedplayers[0] = self;
    params.plundervar = _id_3ACF1C0EBAF602F2::getquestplunderreward( "timedrun_legacy", _id_3ACF1C0EBAF602F2::getquestrewardtier( self.team ) );
...
tr_kiosksearchparams( tablet )
{
    ...
    _id_354D1457278B342C.searchradiusmax = _id_3ACF1C0EBAF602F2::getquestdata( "timedrun_legacy" ).kiosksearchradiusmax;
    _id_354D1457278B342C.searchradiusmin = _id_3ACF1C0EBAF602F2::getquestdata( "timedrun_legacy" ).kiosksearchradiusmin;
    _id_354D1457278B342C.searchradiusidealmax = _id_3ACF1C0EBAF602F2::getquestdata( "timedrun_legacy" ).kiosksearchradiusidealmax;
    _id_354D1457278B342C.searchradiusidealmin = _id_3ACF1C0EBAF602F2::getquestdata( "timedrun_legacy" ).kiosksearchradiusidealmin;
...
{
    locale = _id_3ACF1C0EBAF602F2::createlocaleinstance( "timedrun_locale", "timedrun_legacy", self.team );
...
completetimedrunquest( _id_15B89FF206500554 )
{
    ...
    missionid = _id_3ACF1C0EBAF602F2::getquestindex( "timedrun_legacy" );
    _id_11D65784F0B6AFA2 = _id_3ACF1C0EBAF602F2::getquestrewardgroupindex( _id_3ACF1C0EBAF602F2::getquestrewardbuildgroupref( "timedrun_legacy" ) );
...
tr_respawn( player )
{
    ...
    player _id_3ACF1C0EBAF602F2::uiobjectiveshow( "timedrun_legacy" );
