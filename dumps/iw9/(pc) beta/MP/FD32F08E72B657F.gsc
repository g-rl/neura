...
onspawnplayercommon( _id_9156B53BCF7CE573 )
{
    ...
    if ( scripts\mp\spectating::_id_8FD589760902B617() )
        self _meth_454124A429FFEC99();
    else
        self _meth_264939BEF33BD833();
}
...
_id_52343D5C1B190CF0()
{
    ...
    if ( scripts\cp_mp\utility\game_utility::_id_0B2C4B42F9236924() )
    {
        ...
        if ( !isusingmatchrulesdata() )
        {
            ...
            setdvar( "dvar_A4D532F42D919827", 1 );
            setdvar( "dvar_D75D5638785F3B09", 50 );
            setdvar( "dvar_08AD1AB9436BCCCA", 1 );
            setdvar( "dvar_28D450F7F28644B7", 1 );
            setdvar( "dvar_8A1945C94D5092C2", 1 );
        }
