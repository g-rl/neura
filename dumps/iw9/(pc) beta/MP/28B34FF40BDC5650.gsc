...
getkillstreakgameweapons( streakname )
{
    ...
    {
        case "juggernaut":
            _id_010008C3679D9645 = [ "iw9_minigunksjugg_mp", "iw9_minigunksjugg_reload_mp", "iw8_lm_dblmg_mp" ];
            break;
        case "manual_turret":
...
movingplatform_playerlink( player )
{
    ...
    if ( isdefined( _id_A2731E6D9AF15254 ) && scripts\cp_mp\utility\train_utility::is_moving_platform_train( _id_A2731E6D9AF15254 ) )
    {
