...
{
    _id_45B2B4A889E633FA::spawnc130( level.infilstruct._id_FD05DC031A2E7283, level.infilstruct._id_30E653E12F358438, level.infilstruct.c130pathstruct, level.infilstruct._id_A6547E85663B3BC2 );
...
_id_38F6E236E493C28B()
{
    ...
    self _meth_8B338BF92F461E6C( level.infilstruct.c130.origin, 1 );
...
watchinfiljumpanim()
{
    ...
    if ( _id_A2117EA816A8B7F1 )
    {
        ...
        _id_9B145EB55513DBB5["parent"] = spawn( "script_model", level.infilstruct.c130.origin );
        ...
        _id_9B145EB55513DBB5["parent"] linkto( level.infilstruct.c130, "tag_body", ( 0, 0, 0 ), ( 0, 0, 0 ) );
...
_id_BDA88F27A0337EAA( player, _id_E45F1CD8436C9AA9 )
{
    ...
    if ( _id_FF03E352A5746185() )
    {
        ...
        {
            player cameraunlink();
            player _meth_0CEBD47970F60E9B( self._id_2336099A20080602._id_437B6BB41D98DF26, 0, cameraent, _id_1EDD840D40B43222 );
        }
    }
    else
    {
    ...
    foreach ( pack in self.packs )
    {
        ...
        foreach ( _id_460F06FB83940B20 in pack._id_6F8E05E25EB697A4 )
        {
            if ( isdefined( _id_460F06FB83940B20.ent ) )
                _id_460F06FB83940B20.ent delete();
        }
