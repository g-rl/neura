...
_id_ECF124F447CED0AA()
{
    ...
    foreach ( arena in level.gulag.arenas )
    {
        ...
        foreach ( _id_BDF25D8A73FF7DAD in _id_BB81957D1AE1CF3A )
        {
            ...
            if ( _id_BDF25D8A73FF7DAD.script_noteworthy == "gulag_twotwo_legendary_loot_structs" && level._id_43307855F189EB31._id_CDDD2B80C91E5CAB != 0 )
            {
...
{
    return getdvarfloat( "dvar_8BE34599DFA102B8", 55.0 );
}
...
{
    return getdvarint( "dvar_1FF83F4F24656C5B", 25.0 );
}

_id_F12807F1BED9E2CB()
{
    return getdvarint( "dvar_0FB05C5F6825931D", 5 );
}
...
{
    return getdvarint( "dvar_78B34F0755FAE527", 45 );
}
...
{
    arena._id_82A83448E190754E = 1;
}

_id_DF994A817536AE7B( arena )
{
    if ( isdefined( arena._id_82A83448E190754E ) )
        arena._id_82A83448E190754E = undefined;
}

_id_CF70188E00C433C4( arena )
{
    if ( istrue( arena._id_82A83448E190754E ) )
        return 1;
    else
        return 0;
}
...
_id_90B1506EBCEED929()
{
    ...
    {
        arena._id_801CDCFADC4D465C[arena._id_801CDCFADC4D465C.size] = arena.arenaplayers[0];
        arena._id_801CDCFADC4D465C[arena._id_801CDCFADC4D465C.size] = arena.arenaplayers[1];
        arena.arenaplayers[0]._id_6D34BF5491AD7588 = 1;
        arena.arenaplayers[1]._id_6D34BF5491AD7588 = 1;
        _id_3EDA0EF65C9478AC = arena.id * 2 + 1;
        arena.arenaplayers[0]._id_B5091EFEFE8E436B = level.allteamnamelist[_id_3EDA0EF65C9478AC];
        arena.arenaplayers[1]._id_B5091EFEFE8E436B = level.allteamnamelist[_id_3EDA0EF65C9478AC];
    }
...
_id_EF6CE7FD02518720( _id_E4C8A8DCD301EE41 )
{
    ...
    foreach ( _id_AC0E424AC96A7113 in _id_E4C8A8DCD301EE41 )
    {
        ...
        if ( _id_AC0E424AC96A7113.health == 0 || !istrue( _id_AC0E424AC96A7113.gulag ) )
        {
            fightover = 1;
            continue;
        }
...
_id_556E62498EC825C5( fightover, arena )
{
    ...
    foreach ( _id_02B6C9E57C112F30 in _id_04560E1F068A68F0 )
    {
        ...
        if ( fightover )
        {
            _id_02B6C9E57C112F30 _id_0DC0A56E258889CB( arena, "br_gulag_winner" );
            continue;
        }
...
_id_B5EC51AC542C7638()
{
    ...
    if ( isdefined( _id_1F058C408F19EDDB ) )
    {
        foreach ( _id_AC0E424AC96A7113 in _id_1F058C408F19EDDB )
        {
            ...
            {
                _id_AC0E424AC96A7113 thread scripts\mp\hud_message::showsplash( "br_large_gulag_got_key_self" );
                continue;
            }
...
_id_BCA70E305FB00F25( arena )
{
    ...
    _id_C1057221E17F180B _id_3583FF375AB3A91E::_id_080658D002F64199( _id_3CCB8742D21B61D7._id_9A86491B9A098194 );
    wait( level._id_43307855F189EB31._id_4304A1E29279A798 );
    _id_C1057221E17F180B thread _id_3583FF375AB3A91E::_id_51B0F4B8CBCE83AD( _id_3CCB8742D21B61D7 );
...
_id_7C296B84F3F04CB5( arena )
{
    ...
    level thread _id_67708F418B1FAC79::handleendarena( arena );
}
...
_id_669067932A658A0B( arena, _id_B6ACF0C07C4311E6 )
{
    ...
    scripts\mp\objidpoolmanager::objective_playermask_hidefrom( arena._id_587DA60B01F9FD42, player );
    player setclientomnvar( "ui_br_special_item_acquired", 0 );
...
_id_1FC65FF42AFBB7FC( arena, player )
{
    ...
    wait( _id_B628764AB30B26CE() );
    player thread _id_67708F418B1FAC79::gulagvictory( arena, self, 1, 0, "timeout" );
}
...
_id_C525D1DF15D88A84( agent, _id_6181DE250AFA5BB6 )
{
    ...
    if ( _id_CF70188E00C433C4( arena ) )
    {
        foreach ( player in arena.arenaplayers )
        {
            ...
            player _id_0DC0A56E258889CB( arena, "br_two_v_jailer_win" );
        }

        return;
    }

    if ( istrue( level._id_43307855F189EB31._id_6EFB9D0AFA7EFCB2 ) && !istrue( agent._id_73AA5C7A9DD2BE3E ) )
    {
        agent._id_73AA5C7A9DD2BE3E = 1;
...
_id_7873119D67C51A6D()
{
    ...
    {
        foreach ( _id_AC0E424AC96A7113 in arena.arenaplayers )
            _id_AC0E424AC96A7113 thread _id_67708F418B1FAC79::gulagplayerlost( arena );
    ...
    else
    {
        ...
        if ( level._id_43307855F189EB31._id_789D529318E2DF1B == 1 )
        {
            ...
            {
                if ( !istrue( agent._id_73AA5C7A9DD2BE3E ) )
                {
                    agent thread _id_7E52B56769FA7774::_id_55463A3679678E2F( dropstruct, arena );
                    agent._id_73AA5C7A9DD2BE3E = 1;
                }
        ...
        {
            if ( level._id_43307855F189EB31._id_789D529318E2DF1B == 2 )
            {
                dropstruct = _id_7E52B56769FA7774::_id_7B9F3966A7A42003();
            ...
            if ( level._id_43307855F189EB31._id_789D529318E2DF1B == 3 )
            {
...
_id_5BA567C942854194( arena )
{
    for ( _id_9BE70D6D4FF253A1 = 0; _id_9BE70D6D4FF253A1 < 100; _id_9BE70D6D4FF253A1++ )
        arena._id_067CFDE2459CFC4A[arena._id_067CFDE2459CFC4A.size] = getscriptcachecontents( "sc_gulag_weapons", _id_9BE70D6D4FF253A1 );
}

_id_144FC7F54908932F( arena )
{
    for ( _id_9BE70D6D4FF253A1 = 0; _id_9BE70D6D4FF253A1 < 25; _id_9BE70D6D4FF253A1++ )
        arena._id_49E6D5114201A22B[arena._id_49E6D5114201A22B.size] = getscriptcachecontents( "sc_gulag_items", _id_9BE70D6D4FF253A1 );
}
...
_id_379BC2063FBFACBB( arena, _id_B91D23696A1CD54C )
{
    ...
    while ( _id_D82CD94A7BA2E30F < level._id_F684D37D5503EEBA._id_DBA1D88A40269D08 )
    {
        ...
        {
            _id_D8CD9C1941A88194 = spawnscriptable( arena._id_067CFDE2459CFC4A[_id_D6A189DEAFCB31FD][0], _id_A29AC4899ACD2C08[_id_8B591B0BC361AB3D].origin );
            _id_7E52B56769FA7774::registerscriptableinstance( _id_D8CD9C1941A88194 );
            weaponname = _id_7E52B56769FA7774::getfullweaponobjfromscriptablename( _id_D8CD9C1941A88194.type ).basename;
            _id_7E52B56769FA7774::loot_setitemcount( _id_D8CD9C1941A88194, weaponclipsize( weaponname ) );
...
_id_FCC8620F60CA604C( arena, _id_0F3BCC2386C81142 )
{
    ...
    while ( _id_C68EE1A747F552E2 < level._id_F684D37D5503EEBA._id_1D8A378E37A1B6E5 )
    {
        _id_9AE625E33B2FC5F6 = _id_A29AC4899ACD2C08.size;
        _id_8B591B0BC361AB3D = randomint( _id_9AE625E33B2FC5F6 );
        ...
        if ( !issubstr( arena._id_49E6D5114201A22B[_id_D6A189DEAFCB31FD][0], "brloot_weapon" ) )
        {
            ...
            _id_D8CD9C1941A88194 = spawnscriptable( arena._id_49E6D5114201A22B[_id_D6A189DEAFCB31FD][0], _id_A29AC4899ACD2C08[_id_8B591B0BC361AB3D].origin );
            _id_7E52B56769FA7774::registerscriptableinstance( _id_D8CD9C1941A88194 );
            _id_39CE9039C3660D76 = _id_A29AC4899ACD2C08[_id_8B591B0BC361AB3D].script_noteworthy;
            _id_A29AC4899ACD2C08 = scripts\engine\utility::array_remove( _id_A29AC4899ACD2C08, _id_A29AC4899ACD2C08[_id_8B591B0BC361AB3D] );
...
_id_7F32923C29BCF243( itemlist, _id_A29AC4899ACD2C08, _id_3793828403C6873E, _id_39CE9039C3660D76 )
{
    for ( _id_9BD4297F76B63747 = 0; _id_9BD4297F76B63747 < _id_A29AC4899ACD2C08.size; _id_9BD4297F76B63747++ )
    {
        ...
        {
            _id_D8CD9C1941A88194 = spawnscriptable( itemlist[_id_3793828403C6873E][0], _id_A29AC4899ACD2C08[_id_9BD4297F76B63747].origin );
            _id_7E52B56769FA7774::registerscriptableinstance( _id_D8CD9C1941A88194 );
