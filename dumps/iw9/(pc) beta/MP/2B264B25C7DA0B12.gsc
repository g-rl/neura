...
init()
{
    ...
    level._id_CCF76D87061DE768 = getdvarfloat( "dvar_9F647AA84D08A764", 1.5 );
...
updateusablebyteam( team )
{
    ...
    {
        if ( ( istrue( level._id_D9A236C9A5AC921E ) || team == player.team ) && player != self.owner && !istrue( player scripts\mp\utility\perk::_hasperk( "specialty_revive_use_weapon" ) ) )
...
useholdthinkcleanup( reviver, _id_93DA003F4F870AF4, interrogation )
{
    ...
    if ( _id_4930CBCE302555B1 == "use_hold_think_success" )
    {
        ...
        _id_EE08B1F41E7C2444 = _id_FAF0D2FAC3F47583 == "vanilla" || _id_FAF0D2FAC3F47583 == "mini_mgl";
