...
turretinitshared( _id_F15DC6DD1EC8F7DE )
{
    ...
    turret setmodel( _id_F15DC6DD1EC8F7DE.model );
...
_id_B1AAB60676C543FE( _id_12E26F9F13300310, position )
{
    ...
    classname = get_vehicle_classname();
    _id_523FD8BC6867293E = undefined;

    switch ( _id_12E26F9F13300310 )
    {
        case "fl":
            _id_523FD8BC6867293E = "tag_wheel_center_front_left";
            break;
        case "fr":
            _id_523FD8BC6867293E = "tag_wheel_center_front_right";
            break;
        case "ml":
            _id_523FD8BC6867293E = "tag_wheel_center_middle_left";
            break;
        case "mr":
            _id_523FD8BC6867293E = "tag_wheel_center_middle_right";
            break;
        case "bl":
            _id_523FD8BC6867293E = "tag_wheel_center_back_left";
            break;
        case "br":
            _id_523FD8BC6867293E = "tag_wheel_center_back_right";
            break;
    }
    ...
    if ( !scripts\engine\utility::array_contains( self._id_0C3DB265FEFDB8D4, position ) )
    {
        ...
        if ( isdefined( _id_523FD8BC6867293E ) )
            scripts\common\utility::_id_3677F2BE30FDD581( _id_523FD8BC6867293E, "death" );
    }
}
...
_id_FD3542824F9C1BD2()
{
    ...
    for (;;)
    {
        ...
        if ( !scripts\common\vehicle::_id_D7FE44FFB08B499A() && _id_D71630B8BAF84FA8 >= 0.15 )
        {
            ...
            if ( !scripts\common\vehicle::_id_9E9DFC6F77569F4D() && !scripts\common\vehicle::_id_B7148A3BFC4DEFB2() )
            {
