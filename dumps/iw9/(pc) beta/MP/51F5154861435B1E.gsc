...
_id_C778DFBE6301129A( grenade, superid )
{
    ...
    camera thread _id_1311C5C284DD1537::_id_5E8B74F5E3DC4C60( _id_4A2FE2F78500ABD6 );
    return camera;
}
...
_id_84AB622261B746E3()
{
    ...
    self.owner scripts\cp_mp\challenges::_id_BD59AA7E8CECE1AB( "super_tac_camera", 0 );
...
{
    self setclientomnvar( "ui_killstreak_health", camera.maxhealth );
}
...
{
    _id_1311C5C284DD1537::_id_EB1F8C19D4194AC3( objweapon, ::_id_7ACC5AA2B73FE93B );
}
...
_id_A10D1D70759F9E83( camera, _id_BB7199406CFB48D8 )
{
    ...
    thread _id_1311C5C284DD1537::_id_9BFC1BCB64A896DA( camera );
