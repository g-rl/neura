...
_id_878EBCC241B54505( _id_F7B6CC6C062A7A43, _id_D4FC3B4E84704775, _id_501265B5FE210821, team )
{
...
_id_D212A5E7A40D7C8D( _id_05A4D4A174EA2EAC, team )
{
    ...
    if ( isdefined( _id_2F0B8C1F978FD835 ) && _id_2F0B8C1F978FD835 != "" )
        return _id_6DDD1EECBE562ACF( _id_2F0B8C1F978FD835, team );
}

_id_6DDD1EECBE562ACF( _id_2F0B8C1F978FD835, team )
{
    plunder = tablelookup( "mp/brmission_reward_groups.csv", 0, _id_2F0B8C1F978FD835, 2 );
    _id_5746D9F038B58234 = tablelookup( "mp/brmission_reward_groups.csv", 0, _id_2F0B8C1F978FD835, 4 );
    _id_CC603E175ABFEF2D = tablelookup( "mp/brmission_reward_groups.csv", 0, _id_2F0B8C1F978FD835, 6 );

    if ( isdefined( plunder ) && isdefined( _id_5746D9F038B58234 ) && isdefined( _id_CC603E175ABFEF2D ) && plunder != "" && _id_5746D9F038B58234 != "" && _id_CC603E175ABFEF2D != "" )
        return _id_82B799F238CBF0BD( plunder, _id_5746D9F038B58234, _id_CC603E175ABFEF2D, team );
}

_id_82B799F238CBF0BD( _id_B9BEDB4DD98CB472, _id_E33DCB1F5D4E77E9, _id_3C2125105C151B1A, team )
{
    plunder = tablelookup( "mp/brmission_rewards.csv", 0, _id_B9BEDB4DD98CB472, 7 );
    _id_5746D9F038B58234 = tablelookup( "mp/brmission_rewards.csv", 0, _id_E33DCB1F5D4E77E9, 7 );
    _id_CC603E175ABFEF2D = tablelookup( "mp/brmission_rewards.csv", 0, _id_3C2125105C151B1A, 7 );

    foreach ( player in scripts\mp\utility\teams::getteamdata( team, "players" ) )
    {
        if ( isdefined( plunder ) && plunder != "" )
        {
            plunder = int( plunder );
            player _id_6AFF3948CF4CCA03::playerplunderpickup( plunder );
        }

        if ( isdefined( _id_5746D9F038B58234 ) && _id_5746D9F038B58234 != "" )
        {
            _id_5746D9F038B58234 = int( _id_5746D9F038B58234 );
            player scripts\mp\rank::giverankxp( "stat_607CD099425B81C7", _id_5746D9F038B58234 );
        }

        if ( isdefined( _id_CC603E175ABFEF2D ) && _id_CC603E175ABFEF2D != "" )
        {
            lastweaponobj = player.lastnormalweaponobj;
            _id_CC603E175ABFEF2D = int( _id_CC603E175ABFEF2D );
            player _id_1E4A61DB11011446::givebrweaponxp( "stat_0000000000000000", _id_CC603E175ABFEF2D, lastweaponobj, 0, 0 );
        }

        return [ plunder, _id_5746D9F038B58234, _id_CC603E175ABFEF2D ];
    }
}
