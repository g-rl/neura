...
perkpackage_awardperkpackageupgrade()
{
    ...
    {
        _id_19163E14365D9264 = scripts\mp\supers::getcurrentsuper();
        _id_E5DA01E1954B6734 = undefined;
...
perkpackage_forceusesuper()
{
    ...
    {
        self giveandfireoffhand( _id_354F8655B711B4B1 );
        _id_25DB3863F345443E = perkpackage_waitforsupercanceled( _id_354F8655B711B4B1 );
    }
...
perkpackage_giveimmediate( _id_EBEC497FF8B18A45 )
{
    ...
    {
        self.perkpackagedata.istwomode = 1;
        perkpackage_giveoverridefieldupgrades( "super_deadsilence", "super_tac_camera" );
    }
    else
    {
