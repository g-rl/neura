...
_id_13C5106712EE80F6( statename, params )
{
    ...
    _id_7E45B149BD28CC07 = 40;
    _id_3177D6E303A7327A = self pathdisttogoal() - _id_7E45B149BD28CC07;
    self _meth_6159961E81BBC8ED( _id_3177D6E303A7327A, 2 );

    if ( !isdefined( _id_CEB886EB060AED49 ) )
        _id_2D7FA1F11C70AD04();

    _id_C104EF9B1CAEF15D = _id_CEB886EB060AED49.origin;
    _id_55DCC55529DF5AF1 = self.pathgoalpos;

    if ( !isdefined( _id_55DCC55529DF5AF1 ) )
    {
        if ( distancesquared( self.origin, _id_CEB886EB060AED49.origin ) > _id_D891FE3D8B76A26B * _id_D891FE3D8B76A26B )
            _id_2D7FA1F11C70AD04();

        _id_55DCC55529DF5AF1 = self.origin;
    }

    angles = ( 0, vectortoyaw( _id_C104EF9B1CAEF15D - _id_55DCC55529DF5AF1 ), 0 );
