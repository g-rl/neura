...
isparachutegametype()
{
    return isdefined( level.gametype ) && ( scripts\cp_mp\utility\game_utility::_id_0BEFF479639E6508() || level.gametype == "arm" || level.gametype == "risk" || level.gametype == "war" || level.gametype == "war_mgl" || level.gametype == "cp_survival" || level.gametype == "trial" || level.gametype == "brtdm" );
}
...
updateparachutestreamhint()
{
    ...
    player _meth_BA3E37BE1AC8B95C( player.origin + ( _id_CBC44AA5555239A3[0], _id_CBC44AA5555239A3[1], _id_81F6DDA3FD92E0B4 ), 0, _id_B20B88EBDFC7194F );
}
...
{
    if ( getdvarint( "dvar_FE5686B5FC4463D4", 0 ) )
