...
_id_905B7BADA6FD91CB()
{
    ...
    thread _id_E0457147D4924CE6();
    return 1;
}

_id_E0457147D4924CE6()
{
    wait 15;
    thread _id_739A5F064C7DEBDF();
}
...
_id_B1CD853639E4AC23()
{
    ...
    thread _id_56EF8D52FE1B48A1::drain_super_meter( 15 );
    ...
    thread _id_F0DD3D086C2D739D();
    thread _id_70AF5B7AAF9FC4F8( 0.5, 0.2 );
    _id_0372301AF73968CB::_id_5457F0107A845374( "battleRage_beginSuper", 0.8 );
...
{
    _id_8C34F6AD9A062CC8 = getdvarint( "dvar_25F7326C9FB11C5B", 160 );
...
_id_C01286A01FDF16C1()
{
    ...
    if ( _id_F1E8A376D1B8A918 || _id_8D21991EA863707D )
    {
        ...
        _id_56EF8D52FE1B48A1::_id_7C67C8E12DB38300( _id_66BF0BAD2A84CD3C );
    }
    else
    {
        ...
        _id_56EF8D52FE1B48A1::_id_7C67C8E12DB38300( _id_F3AD0A5016CB1AAE );
    }
}
...
_id_A47DB0CCE0BD80F4( _id_3B080DDA61799F72, _id_6D7F1BCB37532496 )
{
    ...
    if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "player", "isReallyAlive" ) ]]( self ) && _id_6D7F1BCB37532496 )
...
_id_6458A8552104DC8B()
{
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "givePerk" ) ]]( "specialty_fastreload" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "givePerk" ) ]]( "specialty_fastoffhand" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "givePerk" ) ]]( "specialty_falldamage" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "givePerk" ) ]]( "specialty_quickswap" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "givePerk" ) ]]( "specialty_quickdraw" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "givePerk" ) ]]( "specialty_fastcrouchmovement" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "givePerk" ) ]]( "specialty_fastsprintrecovery" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "givePerk" ) ]]( "specialty_tracker" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "givePerk" ) ]]( "specialty_fast_health_regen" );
}

_id_564391EAB6880A70()
{
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "removePerk" ) ]]( "specialty_fastreload" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "removePerk" ) ]]( "specialty_fastoffhand" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "removePerk" ) ]]( "specialty_falldamage" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "removePerk" ) ]]( "specialty_quickswap" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "removePerk" ) ]]( "specialty_quickdraw" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "removePerk" ) ]]( "specialty_fastcrouchmovement" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "removePerk" ) ]]( "specialty_fastsprintrecovery" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "removePerk" ) ]]( "specialty_tracker" );
    self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "removePerk" ) ]]( "specialty_fast_health_regen" );
}
