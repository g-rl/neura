...
tryusehelperdronefromstruct( streakinfo )
{
    ...
    else
    {
        ...
        _id_FAF0D2FAC3F47583 = getdvar( "dvar_7611A2790A0BF7FE", "br" );

        if ( _id_FAF0D2FAC3F47583 == "vanilla" || _id_FAF0D2FAC3F47583 == "mini_mgl" )
...
helperdrone_setscramblerjammed( _id_28E6DF0414CB4897, _id_479E3F358A1F244E, _id_04EFAF0D84225539 )
{
    ...
    if ( istrue( _id_28E6DF0414CB4897 ) )
    {
        ...
        _id_682BF17FA458886C thread helperdrone_managescramblereffect( _id_479E3F358A1F244E, _id_04EFAF0D84225539 );
        _id_682BF17FA458886C thread helperdrone_watchscramblestrength( _id_479E3F358A1F244E );
    }
    else if ( isdefined( _id_682BF17FA458886C ) )
    {
        _id_682BF17FA458886C.scrambledby = undefined;
        _id_682BF17FA458886C scripts\cp_mp\emp_debuff::stop_emp_scramble( _id_682BF17FA458886C.currentscramblerstrength );
        _id_682BF17FA458886C.previousscramblerstrength = undefined;
        _id_682BF17FA458886C.currentscramblerstrength = undefined;
    }
}

helperdrone_managescramblereffect( _id_479E3F358A1F244E, _id_04EFAF0D84225539 )
{
    level endon( "game_ended" );
    ...
    if ( isdefined( self ) )
    {
        helperdrone_setscramblerjammed( 0, _id_479E3F358A1F244E, _id_04EFAF0D84225539 );
...
helperdrone_watchscramblestrength( _id_479E3F358A1F244E )
{
    self endon( "death" );
...
helperdrone_watchearlyexit( config )
{
    ...
    self endon( "death" );
    self endon( "explode" );
    self notify( "earlyExit" );
    self endon( "earlyExit" );
    holdtime = 0.75;

    if ( isdefined( config._id_F98C8FDE8EAC7558 ) )
        holdtime = config._id_F98C8FDE8EAC7558;
