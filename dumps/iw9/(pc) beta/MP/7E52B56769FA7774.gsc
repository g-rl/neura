...
_id_E6CABC9F20DCBC23()
{
    ...
    {
        level._id_EA84A0518343879C["primary"] = _id_78AD8EB4CC92F407( "Primary" );
        level._id_EA84A0518343879C["secondary"] = _id_78AD8EB4CC92F407( "Secondary" );
    }
}

_id_78AD8EB4CC92F407( _id_E38B4E99059A1F48 )
{
    ...
    for ( _id_DF6D8E005B4B8020 = 0; _id_DF6D8E005B4B8020 < _id_BA38574234720011; _id_DF6D8E005B4B8020++ )
    {
        ...
        if ( isdefined( level.br_standard_loadout[_id_6D728BAE3E54774A] ) )
        {
            weaponattachments[_id_DF6D8E005B4B8020] = level.br_standard_loadout[_id_6D728BAE3E54774A];
            _id_E7CC1946FB89AFAA[_id_DF6D8E005B4B8020] = 0;
        }
    }

    return _id_2669878CF5A1B6BC::buildweapon( level.br_standard_loadout[_id_048743AAB19552FD], weaponattachments, level.br_standard_loadout[_id_048743AAB19552FD + "Camo"], level.br_standard_loadout[_id_048743AAB19552FD + "Reticle"], level.br_standard_loadout[_id_048743AAB19552FD + "VariantID"], _id_E7CC1946FB89AFAA );
}
...
{
    lootused( instance, part, state, player, _id_A5B2C541413AA895, _id_CC38472E36BE1B61, 1 );
}
...
_id_B5F5576A0017C089( pickup, state, player, _id_A5B2C541413AA895, instance, _id_2861E2EEEB7AF5DA )
{
    ...
    if ( _id_724736FCF0FB6604::_id_B1DD9DCAE2F63965() && istrue( _id_A5B2C541413AA895 ) && player _id_724736FCF0FB6604::_id_AC3EC31BE7AAD7A7( instance ) )
        return 0;
...
spawndebugpickupfromdevgui( scriptablename )
{
    foreach ( player in level.players )
    {
        if ( !isbot( player ) && isalive( player ) )
        {
            ...
            if ( _id_288CF9DDBF5959A1( scriptablename ) )
                _id_4480C6CE37B2BDF3::_id_ADC4B70D6126F200( item );
...
forcegivekillstreak( _id_A4E8372932B8612C, _id_A5AB866673E5E99D, _id_7F437A5779C8787C, _id_1E736A37C3737585, _id_DB943473454F6EA6 )
{
...
takekillstreakpickup( pickupent, _id_7F437A5779C8787C, _id_DB943473454F6EA6 )
{
    ...
    if ( _id_A7CC24F3A189746A( _id_A4E8372932B8612C ) )
        ...
        forcegivekillstreak( _id_A4E8372932B8612C, 1, _id_7F437A5779C8787C, 0, _id_DB943473454F6EA6 );
}
...
takesuperpickup( pickupent, _id_7F437A5779C8787C, _id_DB943473454F6EA6 )
{
    ...
    if ( isdefined( self.equipment["super"] ) && ( scripts\mp\equipment::getequipmentslotammo( "super" ) > 0 || _id_D539AF51A08B192D ) )
    {
        ...
        _id_2D9D24F7C63AC143::_id_B4E3D555D6D737BB( self, _id_DB943473454F6EA6, 4 );
...
{
    player = self;
    invehicle = player scripts\cp_mp\utility\player_utility::isinvehicle( 1 );
    infreefall = player isinfreefall();
    isparachuting = player isparachuting();
    _id_80ACB2262757E8BA = player isbasejumpavailable();
    return !( invehicle || infreefall || isparachuting || _id_80ACB2262757E8BA );
}
...
{
    return isdefined( lootid ) && lootid == 200047;
}
...
_id_288CF9DDBF5959A1( scriptablename )
{
    return isdefined( level.br_pickups.br_itemtype[scriptablename] ) && level.br_pickups.br_itemtype[scriptablename] == "engram";
}
...
_id_F8A3FF0A73FA0C1D( pickup, _id_FB40D5954B4F6792 )
{
    ...
    if ( istrue( result ) || _id_2CA75F603DE25B76 && _id_FB40D5954B4F6792 )
        return 20;
...
cantakepickup( pickup )
{
    ...
    if ( _id_2CEDCC356F1B9FC8::isequipment( pickup.scriptablename ) )
    {
        ...
        if ( isautouse && ( slot == "primary" || slot == "secondary" ) )
        {
            ...
            if ( !_id_2D9D24F7C63AC143::_id_8B121DD10A442DD2() )
            {
                if ( self _meth_C6CB3E654225077A() && ( !isdefined( self.equipment[slot] ) || scripts\mp\equipment::getequipmentslotammo( slot ) == 0 ) )
                    return 1;
    ...
    if ( isgasmask( pickup.scriptablename ) )
    {
        ...
        if ( scripts\cp_mp\gasmask::hasgasmask( self ) && pickup.count <= self.gasmaskhealth )
        {
            _id_60227BFF1E9478CC = spawnstruct();
    ...
    if ( issuperpickup( pickup.scriptablename ) )
    {
        ...
        if ( !scripts\mp\supers::issuperinuse() )
        {
            ...
            if ( self _meth_C6CB3E654225077A() && isautouse && isdefined( _id_0C89F07DA007FF0D ) && _id_0C89F07DA007FF0D != 0 )
                return 12;
            else if ( scripts\mp\utility\game::getsubgametype() != "dmz" && scripts\mp\utility\game::getsubgametype() != "exgm" || ( !isdefined( _id_0C89F07DA007FF0D ) || _id_0C89F07DA007FF0D == 0 ) )
                return 1;
        }
    ...
    if ( _id_EC7064081654489C( pickup.scriptablename ) )
    {
        if ( pickup _id_024E8AFC4332EFA8::_id_9AA794660EA085D4( self ) )
        {
            ...
            {
                if ( !pickup _id_024E8AFC4332EFA8::_id_AA9EB0AC23F21DF7() )
                    return 33;
    ...
    if ( _id_7E2F2A69FC0C022B( pickup.scriptablename ) || _id_EAC097CE4C683AB9( pickup.scriptablename ) || _id_CB1E30930C35F2E2( pickup.scriptablename ) || _id_5449DA9D3D0358A4( pickup.scriptablename ) )
    {
        if ( _id_2D9D24F7C63AC143::_id_8B121DD10A442DD2() )
            return _id_CBBF9BF3544DC456( pickup );
    ...
    if ( _id_288CF9DDBF5959A1( pickup.scriptablename ) )
    {
        if ( _id_2D9D24F7C63AC143::_id_8B121DD10A442DD2() )
            return _id_CBBF9BF3544DC456( pickup );
...
onusecompleted( pickupent, _id_43FB3D97ABB79854, _id_A5B2C541413AA895, _id_7F437A5779C8787C, _id_DB943473454F6EA6, instance, _id_44EE85DCF52B4001, _id_830B2A6A83BA12EB, _id_5756AA71087F3439 )
{
    ...
    else if ( _id_2CEDCC356F1B9FC8::_id_4AA12E0ED3F6B745( pickupent.scriptablename ) )
    {
        ...
        else
        {
            ...
            if ( _id_364D691B501CD27F < self._id_BED158A6DFAC230D )
    ...
    {
        success = scripts\cp_mp\vehicles\vehicle_interact::_id_10C80ADF381F8C20();
    ...
    else if ( _id_B1E944A2B3E15E9D( pickupent.scriptablename ) )
    {
        ...
        {
            self setclientomnvar( "ui_backpack_small", 0 );
            self setplayerdata( level._id_5D69837CF4DB0407, level._id_342175A1B9F9067E, _id_DB02EDBAC967FB02 );
            self setplayerdata( level._id_5D69837CF4DB0407, "backpackSize", _id_DB02EDBAC967FB02 );
            _id_8F24A28261FB9DA3 = _id_2D9D24F7C63AC143::_id_2FD4216F3F691579( _id_DB02EDBAC967FB02 );
...
droponplayerdeath( attacker )
{
    ...
    {
        if ( scripts\mp\loot::_id_8306D72EA2E8889C() )
        {
            dropstruct = _id_7B9F3966A7A42003();
...
_id_D3204A974CEC837B()
{
    ...
    if ( player _id_2CEDCC356F1B9FC8::isplayerinorgoingtogulag() && _id_5BC60484D17FA95C::_id_1980065CE4DC067B() )
        return 0;
...
dropbrkillstreak( dropstruct, _id_7F437A5779C8787C, _id_DB943473454F6EA6, _id_4C6EBA41707C461F )
{
    if ( hasanykillstreak() )
    {
        ...
        item = spawnpickup( scriptable, _id_CB4FAD49263E20C4, undefined, undefined, undefined, _id_1AD2DB70C8D01F51 );
        _id_2F4E0022C686DBE6( item );
        scripts\mp\killstreaks\killstreaks::removekillstreak( 1 );
        ...
        _id_2D9D24F7C63AC143::_id_B4E3D555D6D737BB( self, _id_DB943473454F6EA6, 5 );
}
...
dropitemfrominventory( slot )
{
    if ( isdefined( self.br_inventory_slots[slot] ) )
    {
        ...
        if ( _id_288CF9DDBF5959A1( item.scriptablename ) )
            _id_4480C6CE37B2BDF3::_id_749BB2A59834B482( pickupent, self, _id_CB4FAD49263E20C4.origin );
...
quickdropnewitem( itemtype, scriptablename, _id_9BE70D6D4FF253A1, _id_59BD51AFC73DF2CD, _id_DAB81EAD77442A10, weaponobj )
{
    ...
    if ( !_id_EC7DED352736C3B1 )
    {
        ...
        if ( _id_288CF9DDBF5959A1( scriptablename ) )
            _id_4480C6CE37B2BDF3::_id_749BB2A59834B482( _id_0E14905A4CDF3B12, self, _id_CB4FAD49263E20C4.origin );
...
_id_D8CD9C1941A88194( lootid, quantity, weaponref )
{
...
_id_E44C2D69DB881894( _id_A1093166DE09E6B8 )
{
    ...
    if ( _id_B989EDD9AF4F42C7( _id_A1093166DE09E6B8 ) && !self _meth_C6CB3E654225077A() )
    {
        equipname = level.br_pickups.br_equipname[_id_A1093166DE09E6B8];
        slot = level.equipment.table[equipname].defaultslot;
    ...
    if ( _id_D7C5786A0C42EF6C( _id_A1093166DE09E6B8 ) && !self _meth_C6CB3E654225077A() )
    {
        equipname = level.br_pickups.br_equipname[_id_A1093166DE09E6B8];
        slot = level.equipment.table[equipname].defaultslot;
        return pickupissameasequipmentslot( equipname, slot ) && equipmentslothasroom( _id_A1093166DE09E6B8, slot );
