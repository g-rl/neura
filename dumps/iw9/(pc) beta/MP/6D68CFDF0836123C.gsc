...
_id_50DFDF2D06587791( target, _id_9E3A8D7DC51A2CAE, drone, timeout )
{
    ...
    if ( 1 )
        _id_161E86C260D6864C.headicon = _id_6E2944C35C23A948 thread scripts\cp_mp\entityheadicons::setheadicon_singleimage( showto, "icon_navbar_enemy", 15, 1, 5000, 500, undefined, 1, 1 );
