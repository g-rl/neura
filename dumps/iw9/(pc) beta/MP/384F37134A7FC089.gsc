...
trophy_used( grenade )
{
    ...
    grenade thread trophy_watch_flight( self );
...
trophy_delete( _id_CBF7BE4F62A0DDB2, _id_4FAC8B8CE36E09F1 )
{
    ...
    self.owner scripts\cp_mp\challenges::_id_BD59AA7E8CECE1AB( "super_trophy", self.usedcount );
...
trophy_getdeployanimtime()
{
    if ( scripts\mp\utility\game::_id_BA5574C7F287C587() )
        animlength = getanimlength( %wm_trophy_system_deploy_landing );
    else
        animlength = getanimlength( %wm_trophy_system_deploy );
