...
onplayerconnect()
{
    for (;;)
    {
        ...
        if ( !isdefined( player.pers["startedMapSelect"] ) )
            player.pers["startedMapSelect"] = 0;
...
{
    scripts\mp\codcasterclientmatchdata::_id_7EE466E81B1AFC12( 23, _id_B20A008833190858 );
}
...
givestreakpoints( type, _id_A29FE2801F117AE6, _id_17DF47994982B4D2 )
{
    ...
    _id_CE5497EF5AA384F5 = type == "stat_EF9582D72160F199";
    level.disablepersonalnuke = 1;
    level.personalnukecostoverride = undefined;

    if ( _id_CE5497EF5AA384F5 && !istrue( level.disablepersonalnuke ) && ( istrue( level.allowkillstreaks ) || isdefined( level.personalnukecostoverride ) ) )
    {
        ...
        if ( _id_F3ADC82C7B8B4249 > 0 )
        {
            if ( _id_44C59A12E6465947 >= _id_F3ADC82C7B8B4249 )
            {
                ...
                {
                    thread scripts\mp\hud_message::showkillstreaksplash( "nuke", _id_F3ADC82C7B8B4249 );
