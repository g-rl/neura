...
_id_4594E9DCEBF2C645()
{
    ...
    self clearsoundsubmix( "player_swimming_underwater", 0.5 );
    self clearsoundsubmix( "iw9_player_drowning", 0 );
    self setentitysoundcontext( "atmosphere", "water_surface", 1 );
...
_id_9A01935A05B613E4()
{
    ...
    self setsoundsubmix( "player_swimming_underwater", 0.75 );
    self setentitysoundcontext( "atmosphere", "underwater" );
    self setclienttriggeraudiozone( "underwater", 0.5 );
}
...
{
    _id_7C46F7B208766211 = [ "iw9_oxygenmask", "ks_remote_map_mp", "ks_remote_nuke_mp", "ks_remote_drone_mp", "ks_assault_drone_mp" ];
    currentweapon = self getcurrentweapon();

    for ( _id_AC0E594AC96AA3A8 = 0; _id_AC0E594AC96AA3A8 < _id_7C46F7B208766211.size; _id_AC0E594AC96AA3A8++ )
    {
        if ( isdefined( currentweapon ) && currentweapon.basename == _id_7C46F7B208766211[_id_AC0E594AC96AA3A8] )
            return 1;
    }
