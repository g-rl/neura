...
spawnrevivetrigger( victim, attacker, _id_1202C39784B176E2, meansofdeath )
{
    ...
    victim scripts\mp\playerlogic::setbeingrevivedinternal( 0 );
...
_id_9CDCE27AF3D1224C( team, _id_E4E6FA072697205D, _id_6B8279C8C2796CD4 )
{
    foreach ( player in level.players )
    {
        ...
        if ( player.team == team && player.numrevives && !istrue( player scripts\mp\utility\perk::_hasperk( "specialty_revive_use_weapon" ) ) )
        {
...
revivetriggerholdonusebegin( player, _id_F5A0530CE8D587B1 )
{
    ...
    self.reviver = player;
    _id_F99D56BCB582A8BA scripts\mp\playerlogic::setbeingrevivedinternal( 1 );
    self.reviver setlaststandreviving( 1 );
...
revivetriggerholdonuseend( team, player, success, _id_F5A0530CE8D587B1 )
{
    ...
    if ( isdefined( self._id_F99D56BCB582A8BA ) && isdefined( level.revivetriggers ) && isdefined( level.revivetriggers[self._id_F99D56BCB582A8BA.guid] ) )
    {
        ...
        _id_F99D56BCB582A8BA scripts\mp\playerlogic::setbeingrevivedinternal( 0 );
...
_id_9341574D596E9D36( player, contents, _id_46A3A8565AC0C17C, _id_846A20D8E6F30B8E, _id_04F6CDE716E0C3D7, _id_6FB67C8525B1D79E, _id_3EF503345DC57957, _id_86B32AFF94B5714E, _id_275F4441AB7920C8, _id_42A945A3EE5EFEEB )
{
    ...
    if ( istrue( _id_42A945A3EE5EFEEB ) )
        _id_4480C6CE37B2BDF3::_id_E56488187B0D5405( corpse, player );
