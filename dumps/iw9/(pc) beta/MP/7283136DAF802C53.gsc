...
incrementweaponstat( weaponname, _id_D0F001B1761FBF53, _id_A1D4E7D5EF9DA660 )
{
    ...
    if ( scripts\mp\utility\game::onlinestatsenabled() )
    {
        ...
        if ( _id_D0F001B1761FBF53 == "kills" )
        {
            ...
            if ( self hasplayerdata( level._id_5D69837CF4DB0407, "playerStats", "lifetimeStats", "weaponStats", scripts\mp\utility\game::_id_F6BAD1D33AD22078(), "kills", weaponname ) )
            {
                _id_9DD650BC2F7C8A01 = self getplayerdata( level._id_5D69837CF4DB0407, "playerStats", "lifetimeStats", "weaponStats", scripts\mp\utility\game::_id_F6BAD1D33AD22078(), "kills", weaponname );
                self setplayerdata( level._id_5D69837CF4DB0407, "playerStats", "lifetimeStats", "weaponStats", scripts\mp\utility\game::_id_F6BAD1D33AD22078(), "kills", weaponname, _id_9DD650BC2F7C8A01 + _id_A1D4E7D5EF9DA660 );
            }

            _id_9DD650BC2F7C8A01 = 0;

            if ( self hasplayerdata( level._id_5D69837CF4DB0407, "playerStats", "seasonalStats", "weaponStats", scripts\mp\utility\game::_id_F6BAD1D33AD22078(), "kills", weaponname ) )
            {
                _id_9DD650BC2F7C8A01 = self getplayerdata( level._id_5D69837CF4DB0407, "playerStats", "seasonalStats", "weaponStats", scripts\mp\utility\game::_id_F6BAD1D33AD22078(), "kills", weaponname );
                self setplayerdata( level._id_5D69837CF4DB0407, "playerStats", "seasonalStats", "weaponStats", scripts\mp\utility\game::_id_F6BAD1D33AD22078(), "kills", weaponname, _id_9DD650BC2F7C8A01 + _id_A1D4E7D5EF9DA660 );
            }
        }
    }
}
