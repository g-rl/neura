...
updatelauncherusage()
{
    ...
    if ( !scripts\mp\flags::gameflag( "prematch_done" ) && scripts\cp_mp\utility\weapon_utility::islockonlauncher( weapon ) )
    ...
    switch ( _id_AB501F397D3CD312 )
    {
        ...
        case "iw9_dm_crossbow":
            if ( getdvarint( "dvar_42FABEED76C8E1CB", 0 ) == 1 )
...
{
    if ( isnullweapon( weapon ) || !isdefined( weapon.scope ) || weaponclass( weapon ) == "rocketlauncher" || weaponclass( weapon ) == "smg" )
        return 0;
    ...
    for (;;)
    {
        ...
        if ( _id_280079773A9459A5 )
        {
            ...
            if ( weapons.size > 2 )
            {
                ...
                {
                    if ( weapon.basename == "iw8_cyberemp_mp" )
                ...
                if ( isdefined( player.primaryweapon ) && player.primaryweapon != "iw8_cyberemp_mp" )
                    _id_17372FFC28DC7D78 = player.primaryweaponobj;
                else if ( isdefined( player.secondaryweapon ) && player.secondaryweapon != "iw8_cyberemp_mp" )
...
checkhit( objweapon, victim )
{
    ...
    thread scripts\mp\events::_id_2FCA19675EB69F1A( victim );
...
_id_3FCE58C2642EBECC( grenade )
{
    ...
    if ( isplayer( self ) )
    {
        setweaponstat( grenade.weapon_name, 1, "shots" );
    ...
    switch ( _id_49E6EF3EDADD524E )
    {
        ...
        case "advanced_supply_drop_marker":
            ...
            break;
        case "advanced_vehicle_drop_marker":
            thread scripts\mp\equipment\advanced_supply_drop::_id_F3E74468F0E5F521( grenade );
            break;
        ...
        case "deploy_loadout_drop":
            ...
            break;
        case "iodine_pills":
            thread _id_156835EF9924856A::_id_7430B01F931D7E4E( grenade );
            break;
        default:
