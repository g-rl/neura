...
giverankxp( type, value, objweapon, _id_719B93858D7B1C94, _id_8197B2CE199B9025 )
{
    self endon( "disconnect" );

    if ( isdefined( self.owner ) && !isbot( self ) )
    {
        self.owner giverankxp( type, value, objweapon );
        return;
    }
    ...
    thread waitandapplyxp( type, value, _id_E07CC288C1153C7F, _id_68EB858FD6EA5428, objweapon, _id_8197B2CE199B9025 );
}

waitandapplyxp( type, _id_A40A13BC564139BF, _id_E07CC288C1153C7F, _id_68EB858FD6EA5428, objweapon, _id_8197B2CE199B9025 )
{
    self endon( "disconnect" );
...
incrankxp( amount, objweapon, _id_DE29895DCA8987CE, type )
{
    ...
    self _meth_DB073176839D77FB( "216172782113783852", _id_EDFAF8A1EE65E5B1 );
