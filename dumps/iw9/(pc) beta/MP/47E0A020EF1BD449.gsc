...
{
    self _meth_8B338BF92F461E6C( moveto.origin );
    ...
    if ( isdefined( _id_F69BA8D7B96E8326 ) )
    {
        ...
        thread scripts\mp\utility\game::setuipostgamefade( _id_F69BA8D7B96E8326 );
    }
}
...
makebrowinner( _id_02A6356DE634D45B, _id_7A8CEFA1BB50F856 )
{
    ...
    if ( istrue( level.nukegameover ) && _id_02A6356DE634D45B == 0 )
