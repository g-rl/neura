...
rockable_cars_init()
{
    ...
    foreach ( car in scriptables )
    {
        ...
        if ( !isdefined( car getscriptablepartstate( "Anim_Explosion", 1 ) ) && !isdefined( car getscriptablepartstate( "Anim_PlayerStandRock", 1 ) ) )
            continue;
        ...
        if ( !scripts\common\utility::issp() )
        {
            ...
            car.toppoint = car getpointinbounds( 0, 0, 0.25 );
