...
_id_62F068CEC343A111( player, itemtype, _id_3793828403C6873E, _id_9BE70D6D4FF253A1, _id_53AAAE2C915F815B, _id_180513E5B195F19A )
{
    ...
    if ( !isdefined( _id_0EC22A950F210E39 ) || _id_0D3C77884D93D850( _id_0EC22A950F210E39 ) )
        return;
...
quickdropnewitem( itemtype, scriptablename, _id_9BE70D6D4FF253A1, _id_59BD51AFC73DF2CD, _id_DAB81EAD77442A10, weaponobj )
{
    ...
    quickdropplaysound( itemtype, _id_CB4FAD49263E20C4.origin, scriptablename );
}
...
quickdropaddtoexisting( itemtype, scriptablename, _id_9BE70D6D4FF253A1, _id_59BD51AFC73DF2CD, _id_DAB81EAD77442A10, weaponobj )
{
    ...
    if ( isdefined( _id_9DC4EDEE6E76287A ) )
    {
        ...
        quickdropplaysound( itemtype, _id_E5D77BF46A926594, _id_CB3339ECE72DBDEB );
...
quickdropplaysound( itemtype, droporigin, scriptablename )
{
    aliasname = undefined;
    ...
    switch ( itemtype )
    {
        ...
        case 0:
            if ( scriptablename == "brloot_plunder_cash_uncommon_1" )
                ...
                aliasname = "br_inventory_drop_plunder";
    ...
    if ( isdefined( aliasname ) && soundexists( aliasname ) )
...
_id_B130392812B25580( player, _id_3793828403C6873E, itemtype, _id_53AAAE2C915F815B, _id_180513E5B195F19A )
{
    ...
    {
        player scripts\cp\cp_hud_message::showerrormessage( "WEAPON/CANNOT_DROP_EQUIPMENT" );
        return 0;
    }
    ...
    if ( !istrue( _id_180513E5B195F19A ) )
        player _id_66122A002AFF5D57::dropequipmentinslot( slot, 0, undefined, _id_9BE70D6D4FF253A1, undefined, 0, itemtype );
