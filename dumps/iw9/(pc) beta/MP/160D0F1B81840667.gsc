...
_id_3766066EF89F53F5( time )
{
    ...
    params = spawnstruct();
    params.intvar = 0;
    rewards = _id_64ACB6CE534155B7::_id_D212A5E7A40D7C8D( "vip", self.teams[0] );

    if ( isdefined( rewards ) && isdefined( rewards[0] ) )
        _id_64ACB6CE534155B7::_id_878EBCC241B54505( "br_vip_quest_complete", _id_64ACB6CE534155B7::_id_3D262D56274BD22E( "vip" ), rewards[0], self.teams[0] );
