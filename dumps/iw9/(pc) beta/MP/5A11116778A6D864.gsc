...
unresolved_collision_nearest_node( player, _id_4258FB168FB20BA6, mover )
{
    ...
    if ( isdefined( mover ) )
    {
        if ( scripts\cp_mp\utility\game_utility::islargemap() )
        {
            ...
            {
                seatid = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getdriverseat( mover, 1 );

                if ( isdefined( seatid ) )
                {
                    _id_AA8EFEC6248A879F = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getexitpositionandangles( mover, player, seatid, 1 );
