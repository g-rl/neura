...
weapongivenhoverjet( streakinfo )
{
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "startMapSelectSequence" ) )
        self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "killstreak", "startMapSelectSequence" ) ]]();
...
starthoverjetairstrikepass( owner, streakinfo, mappointinfo )
{
    ...
    if ( getdvarint( "dvar_7239E1695F448E7E", 1 ) > 0 )
        ...
        _id_28F8F60414DFB888 = scripts\cp_mp\vehicles\vehicle_tracking::_spawnhelicopter( owner, pathstart, direction, "veh_hover_jet_mp", _id_2ED1737D09C74B75 );
...
hoverjet_watchforreposition()
{
    ...
    while ( isdefined( self.useobj ) )
    {
        ...
        self.useobj waittill( "trigger_progress", player );

        while ( player usebuttonpressed() )
        {
            _id_23B90B34FECC58CD = _id_23B90B34FECC58CD + _id_038FC7BD1495C4B2;

            if ( _id_23B90B34FECC58CD >= activatetime )
                break;
