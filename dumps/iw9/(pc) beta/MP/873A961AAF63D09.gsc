...
vehicle_collision_updateinstance( vehicle )
{
    ...
    while ( isdefined( vehicle ) )
    {
        ...
        if ( isdefined( ent ) && isdefined( ent getentitynumber() ) && ent scripts\cp_mp\vehicles\vehicle::isvehicle() )
        ...
        if ( isdefined( ent ) && isent( ent ) && ent scripts\cp_mp\vehicles\vehicle::isvehicle() )
        {
...
_id_10D733624BFDA604( vehicle, _id_AE9ACDDA1C693FA6, body0, body1, flag0, flag1, position, normal, normalspeed, partenum )
{
    ...
    else
    {
        ...
        _id_EA0C87DA6BD69881 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getdriver( _id_8EAD01B30F68F7AB );
