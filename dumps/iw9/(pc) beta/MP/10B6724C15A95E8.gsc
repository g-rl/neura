...
_id_E85F29F7EB1C5529( scriptednode, _id_3E38EE41DC326FDC, animset, _id_26B7B68BEE5A2349 )
{
    ...
    if ( self.arriving )
        scripts\engine\utility::waittill_any( "cap_custom_arrival", "stand_strafe_arrival_finished" );

    if ( !self.arriving && goalpos != scriptednode.origin )
        thread _id_C1754C51B6A54C56();
...
_id_C1754C51B6A54C56( statename, params )
{
    ...
    if ( !isdefined( self._id_718D80100704CC82 ) )
        return;
    ...
    while ( gettime() < endtime )
    {
        ...
        if ( self.origin == self._id_718D80100704CC82 )
            break;

        alpha = ( gettime() - endtime + interval ) / interval;
        _id_6C53D859D582A421 = vectorlerp( startorigin, self._id_718D80100704CC82, alpha );
