    ...
    for ( _id_AC0E594AC96AA3A8 = _id_2F55781AF96F22F9; _id_AC0E594AC96AA3A8 < _id_4F9EB3B7488639DB.size - 1; _id_AC0E594AC96AA3A8++ )
    {
        if ( _id_AC0E594AC96AA3A8 == 2 )
        {
            if ( !( isdefined( level.isstandardsandbox ) && !level.isstandardsandbox ) )
                thread scripts\mp\music_and_dialog::br_circle_closing_music( _id_F007CE073DC3C519, _id_6B890E6BE7982EFB );
        }
...
_id_BF5F4D7A498988A8( player, _id_498E4E279FB8ED85, timeoffset )
{
    ...
    _id_C36DE2EA5FC9F896 = level.br_circle.starttime / 1000;
    _id_11CFB434F06BCA84 = _id_498E4E279FB8ED85 + gettime() / 1000 + timeoffset;
    _id_C0FC062071351CDA = max( _id_11CFB434F06BCA84 - _id_C36DE2EA5FC9F896 - level.br_level.br_circledelaytimes[_id_046BA883294ABD43], 0 );
...
circletimer( circleindex )
{
    ...
    _id_FC0F865DDCF551AD = scripts\mp\utility\game::getsubgametype() == "mini" || scripts\mp\utility\game::getsubgametype() == "mini_mgl";
