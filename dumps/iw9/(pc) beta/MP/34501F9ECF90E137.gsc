...
ammobox_delete( _id_CBF7BE4F62A0DDB2, _id_4FAC8B8CE36E09F1 )
{
    ...
    self.owner scripts\cp_mp\challenges::_id_BD59AA7E8CECE1AB( "super_weapon_drop", self.usedcount );
...
ammobox_onplayerholduse( player )
{
    ...
    if ( _id_DD515FCF025B2E79.basename != "iw8_lm_dblmg_mp" && player.lastweaponobj.basename != "iw8_cyberemp_mp" )
    {
    ...
    if ( player.lastweaponobj.basename == "iw8_cyberemp_mp" )
    {
