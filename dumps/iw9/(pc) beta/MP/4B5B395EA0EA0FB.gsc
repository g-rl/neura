...
_id_F8C926CDEB59F116()
{
    ...
    foreach ( trigger in _id_6085A8DF9C0E33EB )
    {
        ...
        hostage.pickupchecks = [ ::_id_6201C84E805AB787 ];
...
_id_83DFC273B8E7EFED( player )
{
    ...
    {
        if ( scripts\mp\utility\weapon::getweapongroup( _id_DE88CD14114C1E24 ) == "weapon_pistol" )
        {
...
ondeadevent( team )
{
    ...
    else if ( team == game["attackers"] )
    {
        ...
        if ( isdefined( level._id_7FCC5417218AD4C8 ) && level._id_7FCC5417218AD4C8.size > 0 )
        {
            ...
            score = int( clamp( _id_C538365EE9199F8C, 50, level._id_974E9F26A695CD24 ) );
        }

        if ( istrue( level._id_3CF50BAE86B4BEAE ) )
        {
            score = 0;
            level._id_3CF50BAE86B4BEAE = undefined;
        }
