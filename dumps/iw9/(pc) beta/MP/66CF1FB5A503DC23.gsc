...
_id_C5F7E38F739B35A1( victim )
{
    ...
    struct._id_05BC3FC581D33D22 = self.currentweapon.basename;
...
_id_0F0C7425BD5A7050( victim )
{
    foreach ( instance in self._id_8A3630D09E62CCB3 )
    {
        if ( instance._id_48B7B944A7A02B2C == victim.clientid )
        {
            ...
            self dlog_recordplayerevent( "dlog_event_mp_combat_instance", [ "victim", victim, "combat_duration", _id_5D0716264ABD2B2D, "attacker_weapon", instance._id_05BC3FC581D33D22, "attacker_accuracy", _id_5813D1E9FE8E86E4, "victim_weapon", instance._id_2B2DBB6B26A12A45, "distance_start", instance._id_5983E1858F15E19E, "distance_final", _id_F3096708AA63946F( self.origin, victim.origin ) ] );
