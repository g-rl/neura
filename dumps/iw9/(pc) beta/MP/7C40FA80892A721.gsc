...
init()
{
    ...
    {
        level._id_4B78859BACC88808 = getdvarint( "dvar_EA4FD87F53EC4456", 60 );
    ...
    level._id_C80A85CC077D04F5 = getdvarint( "dvar_8D792A74EEC93CB3", -1 );
    level._id_D5E85AE5D6D9DE3A = getdvarint( "dvar_4D8EF220EA87F9E8", -1 );
    level._id_92390A26E2CA2AC0 = getdvarint( "dvar_FAAC441FC1437CB6", -1 );
    level._id_77385A15417D54F9 = getdvarint( "dvar_84004CA51AECAAB3", 200 );
...
initarmor()
{
    ...
    if ( scripts\common\utility::iscp() )
    {
        _id_407C627FC7915153 = getdvarint( "dvar_9C790ECB6CCEF79A", 180 );
    ...
    else
    {
        ...
        {
            _id_2E1D1AF8AFE39BA8 = getdvarint( "dvar_FDE1113CE9981D91", 1 );
    ...
    if ( !istrue( _id_3773B3D5CCE15DCE ) )
    {
        if ( self.armorhealth == 0 && _id_787585D4E82E1E58 > 0 )
        {
            if ( isplayer( self ) )
            {
                ...
                self playsoundtoplayer( "hit_marker_armor_break_plr", attacker );
        }
    }
...
_id_1240021A9C87BCDB()
{
    ...
    for (;;)
    {
        msg = scripts\engine\utility::waittill_any_return_7( "death", "mantle_start", "last_stand_start", "scr_change_swim_state", "special_weapon_fired", "try_armor_cancel", "armor_plate_done" );

        if ( msg == "try_armor_cancel" && self _meth_96F814CC20CBF3D5() )
        {
...
_id_E71F062243EA8827( damage, _id_3773B3D5CCE15DCE, attacker )
{
    ...
    if ( self.helmethealth == 0 )
    {
        ...
        if ( !istrue( _id_3773B3D5CCE15DCE ) )
        {
            ...
            {
                attacker playlocalsound( "bullet_plr_helmet_impact" );
                self playsoundtoplayer( "bullet_npc_helmet_break", attacker, self );
            }
            else
...
_id_90CE8EB3DDAA4943( attacker, inflictor, victim, idamage, objweapon, smeansofdeath, shitloc, idflags, _id_BE4285B26ED99AB1, _id_E93A0355B918AAD5 )
{
    ...
    if ( _id_7820F81EE1ADF7B9 )
    {
        ...
        if ( !istrue( _id_94974807C7DC3ACF ) && !istrue( victim.inlaststand ) && !_id_E13E382321A8580B )
        {
            ...
            _id_24DF708F286B0562 = _id_BE4285B26ED99AB1;

            if ( !istrue( _id_E93A0355B918AAD5 ) )
                _id_24DF708F286B0562 = _id_BDB257C83AE70586( attacker, idflags, weapontype, _id_49E6EF3EDADD524E, shitloc, _id_BE4285B26ED99AB1, idamage, objweapon, smeansofdeath );
            ...
            if ( istrue( level._id_FB2B3C3DB6061DF5 ) && isdefined( victim._id_BED158A6DFAC230D ) && victim._id_BED158A6DFAC230D >= 3 && _id_AE0F808555C671F9 > 100 )
                _id_702BFC08FABD86CB = int( clamp( _id_702BFC08FABD86CB, 0, victim.maxhealth - 10 ) );
        }
    }
...
_id_BDB257C83AE70586( attacker, idflags, weapontype, _id_49E6EF3EDADD524E, shitloc, _id_BE4285B26ED99AB1, idamage, objweapon, smeansofdeath )
{
    _id_1646FE11681A5388 = isbulletpenetration( idflags );

    if ( !_id_1646FE11681A5388 )
    {
        _id_29CC598D75EE3C42 = level.clampstepbulletdamage;
        _id_E93A0355B918AAD5 = 0;

        switch ( weapontype )
        {
            case "rifle":
                _id_29CC598D75EE3C42 = 2;

                if ( getweaponammopoolname( objweapon ) == "enum_6AA606A18241AD16" && level._id_C80A85CC077D04F5 >= 0 )
                {
                    _id_B79930868F410231 = idamage / _id_BE4285B26ED99AB1;
                    idamage = min( idamage, level._id_C80A85CC077D04F5 );
                    idamage = int( _id_B79930868F410231 * idamage );
                    _id_E93A0355B918AAD5 = 1;
                }
            ...
            case "sniper":
                ...
                {
                    _id_B79930868F410231 = idamage / _id_BE4285B26ED99AB1;
                    idamage = max( _id_B79930868F410231 * level._id_77385A15417D54F9, level._id_77385A15417D54F9 );
                    _id_E93A0355B918AAD5 = 1;
                }
            ...
            case "smg":
                ...
                break;
            case "spread":
                if ( level._id_D5E85AE5D6D9DE3A >= 0 )
                {
                    if ( _id_49E6EF3EDADD524E == "iw9_sh_mike1014" && level._id_92390A26E2CA2AC0 >= 0 )
                        _id_65A460BBD41D8D09 = level._id_92390A26E2CA2AC0;
                    else
                        _id_65A460BBD41D8D09 = level._id_D5E85AE5D6D9DE3A;
        ...
        if ( !_id_E93A0355B918AAD5 )
            idamage = _id_42571FC3D7667EA7( idamage, _id_BE4285B26ED99AB1, _id_29CC598D75EE3C42, objweapon );
    }
...
_id_42571FC3D7667EA7( idamage, _id_BE4285B26ED99AB1, _id_29CC598D75EE3C42, objweapon )
{
    _id_B79930868F410231 = idamage / _id_BE4285B26ED99AB1;
    idamage = _id_58A4D5ED666352EF( _id_BE4285B26ED99AB1, objweapon, _id_29CC598D75EE3C42 );
    idamage = int( _id_B79930868F410231 * idamage );
    return idamage;
}
