...
buildweapon( _id_AB501F397D3CD312, attachments, camo, reticle, variantid, _id_F3464D71F01F614E, cosmeticattachment, stickers, _id_11A1FA68AEB971C0, _id_21DE0872BE9361B5 )
{
    ...
    _id_DE230719CECF1C95 = _id_C7CB2EBF3712DC6C( _id_AB501F397D3CD312, _id_91BBF8D2294A656E, variantid );
...
_id_C7CB2EBF3712DC6C( _id_AB501F397D3CD312, _id_91BBF8D2294A656E, variantid )
{
    if ( !isdefined( _id_91BBF8D2294A656E ) )
        _id_91BBF8D2294A656E = [];
    ...
    if ( _id_71DAF4388D8CC783.size > 0 )
        _id_71DAF4388D8CC783 = filterattachmenttoidmap( _id_71DAF4388D8CC783, _id_AB501F397D3CD312 );

    return _id_71DAF4388D8CC783;
}

filterattachmenttoidmap( _id_91BBF8D2294A656E, weaponname )
{
                    ...
                    foreach ( attachment in _id_63A235C3E361A6C3 )
                    {
                        ...
                        if ( isdefined( _id_25EA48876F86D21E ) )
                        {
                            ...
                            if ( isdefined( _id_25EA48876F86D21E.category ) && _id_25EA48876F86D21E.category != "NONE" && !isdefined( level.weaponattachments[attachment] ) )
                                level.weaponattachments[attachment] = 1;
                        }
                    }
                }
            }
...
buildweaponmap()
{
    ...
    if ( isdefined( _id_0D2CA933F911B449 ) )
    {
        for ( _id_FE4048AD22C35D73 = 0; _id_FE4048AD22C35D73 < _id_0D2CA933F911B449.size; _id_FE4048AD22C35D73++ )
        {
            ...
            _id_255E0DF33FAE6D5A = _id_8477D8595E0364A7( _id_0D2CA933F911B449[_id_FE4048AD22C35D73].ref, [ "stat_89E9C01960F4C582", "stat_DC57E42946F6E08C", "stat_E4FB3C98AEEAB347", "stat_C93B8EBCC208569B", "stat_C4BCADBA8E631B86", "stat_DFC4700DD7103CFD", "stat_BAA7982E38A124A2" ] );
...
isminigunweapon( weapon )
{
    ...
    return _id_C27E2A04BAB78C1F == "iw9_minigunksjugg_mp" || _id_C27E2A04BAB78C1F == "iw9_minigunksjugg_reload_mp" || _id_C27E2A04BAB78C1F == "iw8_lm_dblmg_mp" || _id_C27E2A04BAB78C1F == "iw9_lm_dblmg_mp";
}
...
_id_C471A035D22DF5EB()
{
    if ( !isdefined( level._id_C7008CFF883CD615 ) )
    {
        ...
        level._id_C7008CFF883CD615[0] = "receiver";
        level._id_C7008CFF883CD615[1] = "frontpiece";
        level._id_C7008CFF883CD615[2] = "backpiece";
        level._id_C7008CFF883CD615[3] = "magazine";
        level._id_C7008CFF883CD615[4] = "override";
        level._id_C7008CFF883CD615[5] = "muzzle";
        level._id_C7008CFF883CD615[6] = "reargrip";
        level._id_C7008CFF883CD615[7] = "trigger";
        level._id_C7008CFF883CD615[8] = "extra";
        level._id_C7008CFF883CD615[9] = "scope";
        level._id_C7008CFF883CD615[10] = "underbarrel";
        level._id_C7008CFF883CD615[11] = "modifier";
        level._id_C7008CFF883CD615[12] = "visual";
        level._id_C7008CFF883CD615[13] = "other";
    }
