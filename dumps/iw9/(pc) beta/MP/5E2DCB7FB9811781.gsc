...
_id_75BAA17A54260F6F( _id_E60552DD6ABCC4AA )
{
    ...
    {
        self setclientomnvar( "ui_ddos_on_give_widget", 1 );
        thread _id_0A985F47623D10AC();
    }
    else
    {
        self notify( "empPulse_disableOnGiveWidget" );
        self setclientomnvar( "ui_ddos_on_give_widget", 0 );
    }
}
...
_id_0A985F47623D10AC()
{
    ...
    for (;;)
    {
        _id_397FDD12E82BA4DD = _id_63973975CEEE9DDA( scripts\cp_mp\emp_debuff::get_emp_ents(), self.origin, anglestoforward( self.angles ) ).size;
        _id_397FDD12E82BA4DD = int( clamp( _id_397FDD12E82BA4DD, 0, 4 ) );
        _id_00E160DD6D9F67A8 = _id_397FDD12E82BA4DD + 1;
        self setclientomnvar( "ui_ddos_on_give_widget", _id_00E160DD6D9F67A8 );
        wait 0.05;
    }
}
...
{
    self endon( "disconnect" );
    _id_B04567CAB26E6830 = anglestoforward( self.angles );
    ...
    _id_DBEE2266E7253DCD = _id_65EB2204DB38221A( _id_AFC2F18CDAA6C9CC, _id_5DA234812450B0D7, _id_B04567CAB26E6830 );
    _id_9B64BCBED677462B = _id_63973975CEEE9DDA( _id_6F0350C82FC94C38, _id_5DA234812450B0D7, _id_B04567CAB26E6830, 1 );

    while ( _id_556B31282ABCB132 <= maxdist )
    {
        _id_4EB801042B324702 = _id_556B31282ABCB132 * _id_556B31282ABCB132;
        ...
        for ( _id_AC0E594AC96AA3A8 = 0; _id_AC0E594AC96AA3A8 < _id_DBEE2266E7253DCD.size; _id_AC0E594AC96AA3A8++ )
        {
            ...
            if ( _id_DBEE2266E7253DCD[_id_AC0E594AC96AA3A8]["distanceSq"] <= _id_4EB801042B324702 )
            {
        ...
        for ( _id_AC0E5C4AC96AAA41 = 0; _id_AC0E5C4AC96AAA41 < _id_9B64BCBED677462B.size; _id_AC0E5C4AC96AAA41++ )
        {
            ...
            if ( _id_9B64BCBED677462B[_id_AC0E5C4AC96AAA41]["distanceSq"] <= _id_4EB801042B324702 )
            {
...
_id_65EB2204DB38221A( _id_55C733BB252489E1, _id_2C3A1BF3BFD80420, _id_422307E970FBCF74 )
{
    ...
    foreach ( player in _id_55C733BB252489E1 )
    {
        ...
        _id_457471485336C961 = distancesquared( _id_2C3A1BF3BFD80420, player.origin );

        if ( _id_457471485336C961 > 1000000 )
            continue;

        _id_426ACA92D85B305C = scripts\engine\utility::flatten_vector( player.origin - _id_2C3A1BF3BFD80420 );
        _id_077B9E4B599269EB = scripts\engine\math::anglebetweenvectorssigned( _id_422307E970FBCF74, _id_426ACA92D85B305C, ( 0, 0, 1 ) );
        ...
        _id_67E54DC8917A5918[index]["distanceSq"] = _id_457471485336C961;
...
_id_63973975CEEE9DDA( _id_55C733BB252489E1, _id_2C3A1BF3BFD80420, _id_422307E970FBCF74, sort )
{
    ...
    foreach ( ent in _id_55C733BB252489E1 )
    {
        ...
        _id_457471485336C961 = distancesquared( _id_2C3A1BF3BFD80420, ent.origin );

        if ( _id_457471485336C961 > 1000000 )
            continue;

        _id_426ACA92D85B305C = scripts\engine\utility::flatten_vector( ent.origin - _id_2C3A1BF3BFD80420 );
        _id_077B9E4B599269EB = scripts\engine\math::anglebetweenvectorssigned( _id_422307E970FBCF74, _id_426ACA92D85B305C, ( 0, 0, 1 ) );

        if ( abs( _id_077B9E4B599269EB ) > 110.0 )
        {
            if ( _id_457471485336C961 > 400 )
                continue;
        }

        index = _id_B5C65D27DFC53F84.size;
        _id_B5C65D27DFC53F84[index]["entity"] = ent;
        _id_B5C65D27DFC53F84[index]["distanceSq"] = _id_457471485336C961;
...
_id_25310643899068A8( data )
{
    ...
    if ( getdvarint( "dvar_10320E52E3E9AB5C", 1 ) )
...
{
    scripts\cp_mp\challenges::_id_BD59AA7E8CECE1AB( "super_emp_pulse", 0 );
