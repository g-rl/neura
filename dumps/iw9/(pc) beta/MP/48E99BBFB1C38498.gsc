...
playmoveloop( asmname, statename, params )
{
    ...
    thread waitfordooropen( asmname, statename, 0 );
    rate = 1.0;
...
{
    thread waitfordooropen( asmname, statename, 1 );
...
waitfordooropen( asmname, statename, _id_D6E02014CB6C5B06 )
{
    self endon( statename + "_finished" );
    self endon( "death" );
    ...
    for (;;)
    {
        if ( isdefined( self._blackboard.doortoopen ) )
        {
            ...
            if ( !istrue( _id_D6E02014CB6C5B06 ) )
            {
                ...
                if ( isdefined( _id_7F980E69DEF745B8 ) )
                {
                    _id_9605CBCCA5366F66 = scripts\asm\asm::asm_getxanim( doorstate, _id_7F980E69DEF745B8 );
                    _id_9F5284E7925797FD = getnotetracktimes( _id_9605CBCCA5366F66, "door_touch" );
                    _id_EB1C18BB49D8770C = ( _id_9F5284E7925797FD[0] * getanimlength( _id_9605CBCCA5366F66 ) + 2 * level.framedurationseconds ) * _id_543020482C67892F;
            ...
            if ( _id_8A2D1A3F463DFFAC < _id_76C751E661FC569F )
            {
                ...
                if ( istrue( _id_D6E02014CB6C5B06 ) || _id_8A2D1A3F463DFFAC < _id_76C751E661FC569F - _id_543020482C67892F * 2 * level.framedurationseconds )
                {
                    t = opendooratreasonabletime();
