...
_id_9CAC3AF67EE6B40A( vehicle, player, idamage )
{
...
_id_577BB0F5A3FCC2BC( target )
{
    ...
    if ( isplayer( target.owner ) )
        target.owner _id_5762AC2F22202BA2::updatedamagefeedback( "hittrophysystem" );
...
_id_000770F9F7300665( vehicle, scriptable, part, _id_13223604B8FCEA0C, player, _id_2B5043846177FBC9 )
{
    ...
    if ( isdefined( player ) )
        player forceplaygestureviewmodel( "ges_movement_mantle_32_over" );
...
_id_47663E092B38D6DE( _id_7731ADEF63E19B0C, tagname )
{
    _id_E2818AD39A3341B4 = vehicle_damage_getleveldataforvehicle( _id_7731ADEF63E19B0C );
    return istrue( _id_E2818AD39A3341B4._id_AAB9695C92B0ED96[tagname]._id_978F152F814862CE );
}
...
{
    return _id_47663E092B38D6DE( _id_7731ADEF63E19B0C, _id_151B23F6C7D09CF8 ) || randomint( 3 ) == 0;
}
...
_id_D0DF49DE517DED03()
{
    ...
    self radiusdamage( _id_240A4F3D560753FF, _id_F48D20DFEF6AF564.radius, _id_F48D20DFEF6AF564.maxdamage, _id_F48D20DFEF6AF564.mindamage, attacker, "MOD_EXPLOSIVE", _id_C094DB262CE4DFA0 );
    ...
    {
        _id_FD1B8EFDE6ACAF63 = spawnscriptable( _id_F48D20DFEF6AF564.scriptable, _id_240A4F3D560753FF, self.angles );
...
vehicle_damage_givescoreandxpatframeend( _id_F0FA3B7B27926553, _id_A773025016ED337A, data, vehicle )
{
    ...
    waittillframeend;
    thread vehicle_damage_givescoreandxp( _id_F0FA3B7B27926553, _id_A773025016ED337A, vehicle, _id_9D9017E622FDF70B );
}
