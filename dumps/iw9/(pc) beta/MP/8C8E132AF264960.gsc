...
init()
{
    ...
    setdvarifuninitialized( "dvar_3C56D9EF17112CDD", 0 );
    setdvarifuninitialized( "dvar_C1469BE98181753D", 9.0 );
    setdvarifuninitialized( "dvar_DE39BEF0E704C70B", 1 );
...
onenter()
{
    ...
    level thread scripts\mp\battlechatter_mp::trysaylocalsound( self, "stat_1C1A3EBE5F3A23AF", 0.25 );
    self._id_B24E609023CE8208 = _id_556B8AEAA691317F::_id_A35FFF2FF233592A();

    if ( isdefined( self._id_4945D0D82DD3964B ) && scripts\mp\utility\perk::_hasperk( "specialty_survivor" ) )
...
onexitcommon( _id_22F7E2F7E3607528 )
{
    ...
    {
        if ( istrue( self._id_B24E609023CE8208 ) )
            thread _id_556B8AEAA691317F::_id_31AFE9D7B373900F();
    }
...
_id_6B9549A69DC6A346( reviveent )
{
    ...
    if ( _id_2A3C9A91BF1D3911() )
    {
        reviveent._id_121A99ED77D25F87 = scripts\cp_mp\entityheadicons::setheadicon_singleimage( [], "ui_mp_br_icon_interrogation_inprogress", 25, 0, 800, 100, undefined, 1, 1 );
        reviveent._id_A2BC763E8380844B = scripts\cp_mp\entityheadicons::setheadicon_singleimage( [], "hud_ability_disabled_x", 25, 0, 800, 100, undefined, 1, 1 );
    }
}
...
updateusablebyteam( team )
{
    ...
    {
        if ( team == player.team && player != self.owner && !istrue( player scripts\mp\utility\perk::_hasperk( "specialty_revive_use_weapon" ) ) )
        {
            self enableplayeruse( player );

            if ( istrue( player scripts\mp\utility\perk::_hasperk( "specialty_revive_use_weapon" ) ) )
...
revivetriggerthink( team )
{
    ...
    for (;;)
    {
        ...
        if ( istrue( self.owner scripts\mp\playerlogic::getbeingrevivedinternal() ) )
            continue;

        while ( !reviver isonground() && !reviver _meth_E40102956C887F7C() && ( reviver usebuttonpressed() || istrue( reviver._id_7F59448717B5AA63 ) ) )
            waitframe();

        if ( istrue( reviver.insertingarmorplate ) )
        {
            reviver notify( "try_armor_cancel" );

            while ( istrue( reviver.insertingarmorplate ) && ( reviver usebuttonpressed() || istrue( reviver._id_7F59448717B5AA63 ) ) )
                waitframe();
        }

        if ( !reviver usebuttonpressed() && !istrue( reviver._id_7F59448717B5AA63 ) )
            continue;
...
_id_56E47961499CA06C( team )
{
    ...
    for (;;)
    {
        ...
        if ( istrue( _id_5BEBD2013B0F01EC scripts\mp\playerlogic::getbeingrevivedinternal() ) )
        {
            if ( istrue( _id_5BEBD2013B0F01EC.isselfreviving ) )
            {
                _id_5BEBD2013B0F01EC._id_FA3003648B3C8EAC = 1;
                _id_5BEBD2013B0F01EC scripts\mp\playerlogic::setbeingrevivedinternal( 0 );
                waitframe();
        ...
        while ( !interrogator isonground() && !interrogator _meth_E40102956C887F7C() && ( interrogator usebuttonpressed() || istrue( interrogator._id_7F59448717B5AA63 ) ) )
            waitframe();

        if ( interrogator getstance() == "prone" )
        {
        ...
        {
            interrogator notify( "try_armor_cancel" );

            while ( istrue( interrogator.insertingarmorplate ) && ( interrogator usebuttonpressed() || istrue( interrogator._id_7F59448717B5AA63 ) ) )
                waitframe();
        }

        if ( !interrogator usebuttonpressed() && !istrue( interrogator._id_7F59448717B5AA63 ) )
            continue;
        ...
        _id_5BEBD2013B0F01EC scripts\mp\playerlogic::setbeingrevivedinternal( 1 );
        ...
        if ( _id_18D0BF9A1F307A7A == 5 )
        {
            ...
            interrogator thread scripts\mp\teamrevive::_id_C86CF00D5859CE10( self.owner.origin );
    ...
    if ( _id_22F7E2F7E3607528 )
    {
        ...
        if ( scripts\cp_mp\utility\game_utility::_id_0BEFF479639E6508() )
        {
            if ( !istrue( level.gameended ) )
            {
                ...
                _id_22F7E3F7E360775B stoplocalsound( "deaths_door_in" );
                _id_22F7E3F7E360775B playlocalsound( "deaths_door_out" );
                _id_22F7E3F7E360775B clearsoundsubmix( "deaths_door_mp" );
                _id_22F7E3F7E360775B playlocalsound( scripts\engine\utility::ter_op( scripts\mp\utility\player::isfemale(), "Fem_breathing_better", "breathing_better" ) );
                _id_22F7E3F7E360775B enableplayerbreathsystem( 1 );
            }
...
_id_70F1DBC7125939B8( _id_70687E0CC558A009, interrogator, team )
{
    ...
    if ( _id_5BEBD3013B0F041F )
    {
        ...
        foreach ( _id_F0EA4030349A33D5 in level.teamdata[interrogator.team]["alivePlayers"] )
        {
            ...
            _id_F0EA4030349A33D5 thread scripts\mp\hud_message::showsplash( "br_enemy_interrogated", undefined, interrogator );
        }
        ...
        foreach ( _id_F0EA4030349A33D5 in level.teamdata[_id_5BEBD2013B0F01EC.team]["alivePlayers"] )
        {
            ...
            _id_F0EA4030349A33D5 thread scripts\mp\hud_message::showsplash( "br_teammate_interrogated_center", undefined, _id_5BEBD2013B0F01EC );
            _id_F0EA4030349A33D5 thread scripts\mp\hud_message::showsplash( "br_teammate_interrogated", undefined, interrogator );
        }

        if ( level._id_A9978096255CD8ED == 1 )
        {
...
_id_1B56D7C4FE15B79C( interrogator, victim )
{
    ...
    scripts\mp\analyticslog::_id_B4E1D087442647EF( _id_4EC493E39340A7CE, _id_48B7B944A7A02B2C, _id_26568FED2B866C11.size, _id_6562C7C3C91A0C6A, _id_126C5BA5E88A23B7, _id_F67D2E6165B4028A );
}
...
_id_59DB0668402EF9D0( interrogator, victim )
{
    ...
    {
        duration = int( getdvarint( "dvar_D4284FF806F6B697", 9.0 ) * 1000 );
...
_id_A5C6DC149AFB51C9( interrogator, outlinetime )
{
    ...
    if ( isplayer( victim ) )
    {
        ...
        while ( _id_1F6DF6FD9A4A3EA0 < level._id_3908273E5522E91D )
        {
            ...
            triggerportableradarpingteam( victim.origin, interrogator.team, level._id_0575CB25B5D41B53, _id_5283D6ED761E8022 );
...
_id_452247E0CEEC0A3B( reviver, _id_22F7E3F7E360775B, mintime, _id_0E2C5C56BB79DE4B )
{
    ...
    if ( ( !reviver usebuttonpressed() || isdefined( reviver._id_7F59448717B5AA63 ) && !istrue( reviver._id_7F59448717B5AA63 ) ) && !istrue( _id_0E2C5C56BB79DE4B ) && !( gettime() < mintime ) )
        return 0;

    if ( distancesquared( reviver.origin, self.origin ) > 65536 )
        return 0;
...
suicidesetup()
{
    ...
    for (;;)
    {
            ...
            if ( _id_2A3C9A91BF1D3911() )
            {
                ...
                foreach ( player in players )
                {
                    if ( player.team != self.team )
                    {
                        ...
                        if ( !selfrevivebuttonpressed( self ) )
                            self setclientomnvar( "ui_securing", 0 );
        ...
        if ( !selfrevivebuttonpressed( self ) && !istrue( self.beingrevived ) )
            self setclientomnvar( "ui_securing", 0 );
    }
...
_id_4AA5CC0D5AAF5E13( dir, attacker, _id_EE2753C1176F5C7E )
{
    ...
    _id_F4EC18F455B87D6F = getdvarfloat( "dvar_46685B5A7AB844EB", 0.25 );
    wait( _id_F4EC18F455B87D6F );
...
_id_D0010FDBCDAEAF0A( attacker )
{
    _id_74C33A61490F2AF7 = _id_ACC5EA9379317664( attacker, "offhand1h_vm_smartphone_v0", "tag_accessory_left", 1 );
    _id_213ABE1DBC252ACA = _id_ACC5EA9379317664( attacker, "offhand1h_wm_smartphone_v0", "tag_accessory_left", 0 );
    _id_63254B5552422209 = _id_ACC5EA9379317664( attacker, "att_vm_p33_me_tac_knife01_v0", "j_gun", 1 );
...
_id_2BC915DA80C90AA0( dir, attacker, _id_EE2753C1176F5C7E, _id_D5CC8B378F09BD04, _id_E830F42670718693, _id_7A26E48FE2AEE716 )
{
    ...
    _id_FD346D58D905A11B = _id_55C419DC46DFAA4B( dir, _id_D5CC8B378F09BD04, 1 );
    _id_C125143A1B692A67 = _id_55C419DC46DFAA4B( dir, _id_D5CC8B378F09BD04, 0 );
...
_id_55C419DC46DFAA4B( dir, _id_D5CC8B378F09BD04, isattacker )
{
    if ( istrue( isattacker ) )
        return "interrogate_" + dir + "_attacker_" + _id_D5CC8B378F09BD04;
    else
        return "interrogate_" + dir + "_defender_" + _id_D5CC8B378F09BD04;
}
...
_id_ACC5EA9379317664( player, _id_7F6D36CC641739D9, animtag, _id_64FC43B788AFAE69, _id_1E2F2224127D2990, anglesoffset )
{
    ...
    if ( istrue( _id_64FC43B788AFAE69 ) )
    {
        ...
        _id_6728B8AC11978BB2 linkto( player.player_rig, animtag, _id_1E2F2224127D2990, anglesoffset );
    }
    else
    {
...
{
    _id_F76D3D3A7B65CE13 = max( getdvarfloat( "dvar_15E9B25B07A2BBB6", 0.3 ), 0.3 );
    ...
    self playerlinktoblend( self.player_rig, "tag_player", _id_F76D3D3A7B65CE13, 0.1, 0.1 );
...
_id_FA005DEA3B675DD4( dir, _id_D5CC8B378F09BD04 )
{
    ...
    animname = _id_55C419DC46DFAA4B( dir, _id_D5CC8B378F09BD04, 1 );
    animlength = getanimlength( level.scr_anim["player"][animname] );

    if ( isdefined( animlength ) )
        return animlength;

    animname = _id_55C419DC46DFAA4B( dir, _id_D5CC8B378F09BD04, 0 );
    animlength = getanimlength( level.scr_anim["player"][animname] );
...
_id_B3F5EEDE669E7182( attacker, victim )
{
    ...
    for (;;)
    {
        ...
        {
            victim scripts\mp\utility\sound::playdeathsound( "MOD_FALLING" );
