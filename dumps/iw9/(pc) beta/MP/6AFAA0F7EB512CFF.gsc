...
_id_F588087BF9D7FEFB()
{
    ...
    foreach ( _id_C75620CA74D2E522 in scripts\engine\utility::getstructarray( "gas_station", "targetname" ) )
    {
        ...
        _id_C75620CA74D2E522 = _id_52BA5A6617B2C059( _id_C75620CA74D2E522.origin, radius, 0 );

        if ( isdefined( _id_C75620CA74D2E522 ) )
            _id_354F6E3EEBCE5123[_id_354F6E3EEBCE5123.size] = _id_C75620CA74D2E522;
    }

    foreach ( _id_C75620CA74D2E522 in scripts\engine\utility::getstructarray( "gas_station_marine", "targetname" ) )
    {
        _id_C75620CA74D2E522 = _id_52BA5A6617B2C059( _id_C75620CA74D2E522.origin, 650, 1 );
    ...
    {
        if ( !isdefined( _id_C75620CA74D2E522.target ) )
        {
            _id_ECE1CE8D6ABCD4AE[_id_ECE1CE8D6ABCD4AE.size] = _id_C75620CA74D2E522;
            continue;
        }

        triggers = _func_F159C10D5CF8F0B4( _id_C75620CA74D2E522.target, "targetname" );
    ...
    if ( _id_ECE1CE8D6ABCD4AE.size == 0 )
        return;
    ...
    for (;;)
    {
        ...
        {
            foreach ( _id_2D71D4D55573B1C8 in level.vehicle._id_2B6807C7DF9A2B2D scripts\engine\utility::_id_0DF633F460888A47( _id_C75620CA74D2E522.origin ) )
            {
                foreach ( vehicle in _id_2D71D4D55573B1C8 )
                {
                    ...
                    if ( vehicle.origin[2] > _id_C75620CA74D2E522.maxheight || vehicle.origin[2] < _id_C75620CA74D2E522._id_F3F4EB55AED6E784 )
                        continue;

                    if ( distance2dsquared( vehicle.origin, _id_C75620CA74D2E522.origin ) > _id_C75620CA74D2E522._id_8FA87D2C8780E014 )
                        continue;

                    driver = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getdriver( vehicle );
                    _id_C75620CA74D2E522 thread _id_518F884FC150D957( vehicle, _id_C75620CA74D2E522.origin, _id_C75620CA74D2E522._id_8FA87D2C8780E014, driver );
                }
            }
        }
    }
...
_id_518F884FC150D957( vehicle, point, _id_8FA87D2C8780E014, driver )
{
    ...
    _id_29F1EA79ED2B40DD = vehicle_interact_getleveldataforvehicle( vehicle.vehiclename )._id_29F1EA79ED2B40DD;
    vehicle._id_90C69F8BA6618910 = vehicle._id_CF9BA498AF4E41E9 / _id_29F1EA79ED2B40DD;
    wait 1;
    ...
    _id_CFB86C8EC12B2D6C = getdvarint( "dvar_BA30D0E6C532C1F4", 30 );
    ...
    if ( vehicle._id_CF9BA498AF4E41E9 / _id_29F1EA79ED2B40DD < 0.99 )
    {
        ...
        foreach ( _id_F85572CD5F6117C6 in _id_8F9EFDC9FB55D586 )
            vehicle _id_3BFF37824A58EF7A( _id_F85572CD5F6117C6, vehicle.objidnum );
    }
    ...
    while ( isdefined( vehicle ) && isdefined( vehicle.origin ) && distancesquared( vehicle.origin, point ) < _id_8FA87D2C8780E014 * 2.25 )
    {
        ...
        if ( _id_9BB26C1FF415A7A3 && vehicle._id_90C69F8BA6618910 >= 0.99 )
        {
            ...
            foreach ( _id_F85572CD5F6117C6 in vehicle.occupants )
                vehicle _id_D051E5F825B704AB( _id_F85572CD5F6117C6, vehicle.objidnum );
        }
    ...
    {
        foreach ( _id_F85572CD5F6117C6 in _id_8F9EFDC9FB55D586 )
            vehicle _id_BD48158D51404989( _id_F85572CD5F6117C6 );
    }
...
_id_C5FE005F06FE5684( vehicle, player )
{
    if ( isdefined( vehicle._id_90C69F8BA6618910 ) && vehicle._id_90C69F8BA6618910 < 0.99 )
        vehicle _id_3BFF37824A58EF7A( player, vehicle.objidnum );
}

_id_DEB83798A724A77E( vehicle, player )
{
    if ( isdefined( vehicle._id_90C69F8BA6618910 ) && vehicle._id_90C69F8BA6618910 < 0.99 )
        vehicle _id_D051E5F825B704AB( player, vehicle.objidnum );
}

_id_3BFF37824A58EF7A( player, objidnum )
{
    if ( isdefined( objidnum ) && objidnum != -1 )
    {
        ...
        _id_82A1C76DA877F6A3( player );
    }
}

_id_D051E5F825B704AB( player, objidnum )
{
    if ( isdefined( objidnum ) && objidnum != -1 )
    {
...
_id_82A1C76DA877F6A3( player )
{
    if ( isdefined( player ) )
    {
        ...
        if ( scripts\cp_mp\vehicles\vehicle::_id_D93EC4635290FEBD() == "veh9_hummer" )
...
_id_10C80ADF381F8C20()
{
    ...
    _id_29F1EA79ED2B40DD = vehicle_interact_getleveldataforvehicle( vehicle scripts\cp_mp\vehicles\vehicle::_id_D93EC4635290FEBD() )._id_29F1EA79ED2B40DD;
    vehicle._id_CF9BA498AF4E41E9 = _id_29F1EA79ED2B40DD;
    vehicle scripts\cp_mp\utility\vehicle_omnvar_utility::_id_9DA76B0BE4B2A2D4( vehicle._id_CF9BA498AF4E41E9, _id_29F1EA79ED2B40DD );
    return 1;
}
