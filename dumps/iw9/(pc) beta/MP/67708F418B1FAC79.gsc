...
initgulag()
{
    ...
    level.gulag._id_3FDEDDA393E951F9 = getdvarint( "dvar_ADEA9F7A92CA117D", 1 );
...
dojailbreak( arena )
{
    ...
    playsoundatpos( arena.center, "iw8_mp_snatch_fight_start" );
    arena.fightover = 0;
...
beginnewfight( arena )
{
    ...
    {
        _id_AA9F4C033D62BC8A = [];

        for ( _id_AC0E594AC96AA3A8 = 0; _id_AC0E594AC96AA3A8 < level._id_43307855F189EB31._id_0BD9294679812B88; _id_AC0E594AC96AA3A8++ )
            _id_AA9F4C033D62BC8A = scripts\engine\utility::array_add( _id_AA9F4C033D62BC8A, arena._id_654C981854394718[_id_AC0E594AC96AA3A8] );

        arena.arenaplayers = _id_AA9F4C033D62BC8A;
        arena._id_654C981854394718 = scripts\engine\utility::array_remove_array( arena._id_654C981854394718, _id_AA9F4C033D62BC8A );
        ...
        if ( arena.time <= 0 )
        {
            ...
            if ( istrue( _id_1A93CF0BA17E0DC0 ) )
            {
                foreach ( player in arena.arenaplayers )
                {
                    ...
                    player playsoundtoplayer( "gulag_crowd_boo_loser", player );
...
handleendarena( arena, _id_4B434533D3624BEC, _id_88EF856FAEFB28D6, _id_BF7470006675932E, _id_DF2FBB13C226BE75, _id_4AC881E2A39322A5 )
{
    ...
    foreach ( player in arena.arenaplayers )
    {
        ...
        if ( isalive( player ) )
        {
            ...
            if ( !_id_46FDF7B12C5F5620::_id_7EFFA8A355DDC886() || !_id_46FDF7B12C5F5620::_id_6A7FE34AFAA1A01D() )
            {
...
gulagstreamlocationstart( _id_11F3B4465C8B637B )
{
    ...
    self _meth_BA3E37BE1AC8B95C( _id_11F3B4465C8B637B, 1 );
...
playerjailtimeout( arena )
{
    ...
    self.jailtimeoutend = gettime() + _id_74B5B12BB6514385 * 1000;
...
getnextarenaspawn( arena )
{
    ...
    else
    {
        ...
        {
            _id_8F5D6F42D8464DE0 = arena._id_EF9A0B82CE1A505A[arena.arenaspawncounter];
            _id_AAF901DC990498C5 = arena._id_EF9A0B82CE1A505A.size;
        }
        else
        {
...
gulagvictory( arena, winner, _id_5B9A9B8346074883, _id_5A5A690371917543, _id_DF2FBB13C226BE75, _id_FB551788DA0FC531, _id_4AC881E2A39322A5, _id_BF7470006675932E, _id_7B73D3F227CBD0F1, _id_0BE9140F1DFFFE7A )
{
    level endon( "game_ended" );
    ...
    if ( !istrue( _id_5A5A690371917543 ) && !istrue( _id_FB551788DA0FC531 ) && !istrue( _id_BF7470006675932E ) )
        winner thread triggerrespawnoverlay( 3, _id_0BE9140F1DFFFE7A );
    ...
    winner playsoundtoplayer( "gulag_crowd_cheer_winner", winner );
    ...
    winner gulagwinnerrespawn( _id_FB551788DA0FC531, _id_DF2FBB13C226BE75, spawnpoint, 1, _id_11F3B4465C8B637B, undefined, _id_4AC881E2A39322A5, _id_5A5A690371917543, _id_BF7470006675932E, undefined, _id_0BE9140F1DFFFE7A );
}
...
playergulaggetrespawnpoint( _id_447913206D1F7916, timeuntilspawn, _id_F9A785628F97EEC6 )
{
    ...
    if ( !isdefined( spawnorigin ) )
    {
        if ( isdefined( level.br_circle ) && isdefined( level.br_circle.safecircleent ) )
        {
            ...
            if ( getdvarint( "dvar_89FD9A93B31A5CF2", 1 ) && !istrue( _id_A26567D70B7326AE ) )
            {
...
gulagwinnerrespawn( _id_FB551788DA0FC531, _id_DF2FBB13C226BE75, spawnpoint, skipsplash, _id_11F3B4465C8B637B, _id_03BD8653773757C7, _id_4AC881E2A39322A5, _id_74AF5908127B6729, _id_BF7470006675932E, _id_491D9866301A91D1, _id_0BE9140F1DFFFE7A )
{
    ...
    if ( getdvarint( "dvar_635AB3702B4E2AEA", 0 ) != 0 && _id_DF2FBB13C226BE75 == "winner" )
        self._id_AD99A0C87D805AEE = 1;
...
gulagwinnerloadout()
{
    ...
    else if ( isdefined( level.br_standard_loadout ) || getdvarint( "dvar_F97D261E2F377AD9", 1 ) != 0 && getdvarint( "dvar_943F7C30BD8B86E8", -1 ) > -1 )
...
gulagwinnerrestoreloadout()
{
    ...
    if ( _id_5BC60484D17FA95C::_id_1980065CE4DC067B() || getdvarint( "dvar_7AD0617CFA893A28", 0 ) != 0 || istrue( self._id_AD99A0C87D805AEE ) )
        result = gulagwinnerrestoregunandammo();
    else if ( isdefined( level.br_standard_loadout ) || getdvarint( "dvar_F97D261E2F377AD9", 1 ) != 0 && getdvarint( "dvar_943F7C30BD8B86E8", -1 ) > -1 )
        result = gulagwinnertableloadout();

    self._id_AD99A0C87D805AEE = undefined;
    return result;
}
...
playergulagautowin( _id_4AC881E2A39322A5, _id_57D71760971F748F, _id_5806C4765695A2F4, _id_74AF5908127B6729 )
{
    player = self;
    level endon( "game_ended" );
    player endon( "disconnect" );
    ...
    [_id_84E2123AACA9A965, _id_DF2FBB13C226BE75] = player playerhandlesponsor( _id_4AC881E2A39322A5, _id_57D71760971F748F, _id_74AF5908127B6729 );
...
playerhandlesponsor( _id_4AC881E2A39322A5, _id_57D71760971F748F, _id_74AF5908127B6729, _id_899BEB1FC66D0EC6 )
{
    player = self;
...
updatearenaomnvarplayers( arena )
{
    ...
    foreach ( player in _id_087B2BE9FEF844DE )
    {
        ...
        foreach ( _id_FE8F7703F6313ED4, _id_AA9F4C033D62BC8A in arena.matches )
        {
            if ( isdefined( _id_AA9F4C033D62BC8A[0] ) && player == _id_AA9F4C033D62BC8A[0] || isdefined( _id_AA9F4C033D62BC8A[1] ) && player == _id_AA9F4C033D62BC8A[1] )
            {
                _id_793C4E46C0425BD2 = !isplayermatched( arena, player );
                _id_A55AB0DDAB9125FF = _id_FE8F7703F6313ED4 + 1;
...
playerplayintrocinematic()
{
    if ( level.gulag.introcinematic && !isbot( self ) )
    {
        ...
        if ( level._id_43307855F189EB31.name == "gulag_twotwo" )
            self playcinematicforplayer( "gulag_enter" );
        else
            self playcinematicforplayer( "mp_donetsk_gulag_intro" );
...
_playerwaittillcinematiccompleteinternal( starttime )
{
    ...
    while ( gettime() - starttime < 17000 && !self crouchbuttonpressed() && !self usebuttonpressed() && !self jumpbuttonpressed() )
        waitframe();
}
