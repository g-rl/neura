...
{
    return _id_358E8D9068997399 >= 1 && _id_358E8D9068997399 <= 9999;
}

iskillstreakitem( _id_358E8D9068997399 )
{
    return _id_358E8D9068997399 >= 10000 && _id_358E8D9068997399 <= 19999;
}

ispoweritem( _id_358E8D9068997399 )
{
    return _id_358E8D9068997399 >= 20000 && _id_358E8D9068997399 <= 29999;
}

isconsumableitem( _id_358E8D9068997399 )
{
    return _id_358E8D9068997399 >= 30000 && _id_358E8D9068997399 <= 39999;
}

iscosmeticitem( _id_358E8D9068997399 )
{
    return _id_358E8D9068997399 >= 40000 && _id_358E8D9068997399 <= 49999;
}
...
{
    if ( isdefined( _id_69E96A4CAA72D794._id_46A3A8565AC0C17C ) && _id_69E96A4CAA72D794._id_46A3A8565AC0C17C == 9 )
        _id_69E96A4CAA72D794.contents = opener._id_3EEDB8574BAE470A.contents;

    if ( isdefined( _id_69E96A4CAA72D794._id_46A3A8565AC0C17C ) && _id_69E96A4CAA72D794._id_46A3A8565AC0C17C == 11 )
    ...
    if ( istrue( level._id_A101059DEA76957C ) && !istrue( _id_69E96A4CAA72D794._id_4E6E38A1603F22EE ) && _id_69E96A4CAA72D794._id_46A3A8565AC0C17C != 9 && _id_69E96A4CAA72D794._id_46A3A8565AC0C17C != 11 )
    {
        _id_69E96A4CAA72D794._id_4E6E38A1603F22EE = 1;
        thread _id_86D77B1DBD44B06E( opener, _id_69E96A4CAA72D794 );
    }
...
_id_68085C72D7B628EC( _id_69E96A4CAA72D794, opener )
{
    ...
    else if ( !_id_532EAC3C428E5B9B( _id_69E96A4CAA72D794 ) )
    {
        if ( _id_69E96A4CAA72D794 getscriptableparthasstate( partname, "partially_open_usable" ) )
        {
            ...
            else if ( state != "partially_open_usable" )
            {
    ...
    if ( isdefined( opener ) && istrue( opener._id_1F8CD0CE903FF0DA ) )
    {
        _id_69E96A4CAA72D794 _id_2CC6455920627806::_id_B5399746EAA8316C();
...
{
    if ( isdefined( _id_69E96A4CAA72D794._id_46A3A8565AC0C17C ) && ( _id_69E96A4CAA72D794._id_46A3A8565AC0C17C == 9 || _id_69E96A4CAA72D794._id_46A3A8565AC0C17C == 11 ) )
        return 0;
...
_id_60D2295CCC45D8C0( player, lootid, quantity, _id_46A3A8565AC0C17C, scriptablename )
{
...
_id_86D77B1DBD44B06E( opener, _id_69E96A4CAA72D794 )
{
    level endon( "game_ended" );
    opener endon( "death_or_disconnect" );
    _id_69E96A4CAA72D794 endon( "death" );
...
_id_1791C1E8974E9BD7( player, lootid, quantity, weaponref )
{
    ...
    {
        _id_7E52B56769FA7774::_id_37BE6E543436F3B3( lootid );
        success = 1;
    }
    else if ( _id_2CEDCC356F1B9FC8::isammo( ref ) )
        success = player _id_7E52B56769FA7774::_id_54DAC56D15DD3D93( ref, lootid, quantity );
    else
        success = _id_7E52B56769FA7774::_id_D8CD9C1941A88194( lootid, quantity, weaponref );
...
_id_A335AA664CAA37C9( player, _id_69E96A4CAA72D794 )
{
    ...
    {
        _id_60D2295CCC45D8C0( player, lootid, 1, _id_46A3A8565AC0C17C, _id_69E96A4CAA72D794.type );
        ...
        _id_2D9D24F7C63AC143::_id_E35A7CB7E7C8C17E( player, _id_69E96A4CAA72D794._id_6FB67C8525B1D79E );
        _id_724736FCF0FB6604::_id_AE30366A2D519A57( player, 2, _id_69E96A4CAA72D794._id_275F4441AB7920C8 );
        ...
        if ( istrue( player._id_1F8CD0CE903FF0DA ) )
        {
...
_id_2F00CA0526F3EDC6( player, index, quantity, _id_69E96A4CAA72D794 )
{
    ...
    if ( isdefined( _id_69E96A4CAA72D794 ) && isdefined( _id_69E96A4CAA72D794.contents[index]["ref"] ) )
    {
    ...
    if ( success || istrue( _id_609578472524B507 ) )
    {
        ...
        _id_60D2295CCC45D8C0( player, _id_699DE62155C8C832, quantity, _id_69E96A4CAA72D794._id_46A3A8565AC0C17C, _id_69E96A4CAA72D794.type );

        if ( istrue( player._id_1F8CD0CE903FF0DA ) )
            player._id_5621109F5EF8AB48.contents[index]["quantity"] = _id_A28BD7F30254C8A0;
        ...
        if ( _id_A28BD7F30254C8A0 <= 0 )
        {
            ...
            if ( istrue( player._id_1F8CD0CE903FF0DA ) )
                player._id_5621109F5EF8AB48.contents[index]["lootID"] = _id_699DE62155C8C832;
        }
...
_id_67BE8D119FA22135( player, _id_DFF481F07E235198, weaponobj, lootid, itemtype, _id_3793828403C6873E )
{
...
_id_A92926D5B02CF6ED( player, _id_69E96A4CAA72D794 )
{
    ...
    weapon = _id_69E96A4CAA72D794._id_6FB67C8525B1D79E;
    ...
    _id_7E52B56769FA7774::_id_E5845FF9B61AC5D7( weapon, 1, undefined, undefined, undefined, undefined );
    ...
    else if ( istrue( player._id_1F8CD0CE903FF0DA ) )
    {
        player._id_5621109F5EF8AB48._id_04F6CDE716E0C3D7 = 0;
        player._id_5621109F5EF8AB48._id_6FB67C8525B1D79E = undefined;
        player._id_5621109F5EF8AB48._id_275F4441AB7920C8 = undefined;
    }
...
_id_3AE3712FE76D0C6A( player, index, loadoutindex, _id_69E96A4CAA72D794 )
{
    ...
    if ( isdefined( _id_69E96A4CAA72D794.contents[index]["ref"] ) )
        ref = _id_69E96A4CAA72D794.contents[index]["ref"];
    ...
    else if ( isdefined( _id_69E96A4CAA72D794.contents[index]["ref"] ) )
    {
        if ( loadoutindex > 0 )
    ...
    {
        player._id_5621109F5EF8AB48.contents[index]["quantity"] = 0;
        player._id_5621109F5EF8AB48.contents[index]["lootID"] = 0;
    }
...
_id_F0617AD70B7E7792( _id_8817E4FBE0F63228, _id_EBBCB5A184F5C67B, _id_69E96A4CAA72D794 )
{
    ...
    if ( _id_EBBCB5A184F5C67B == 100 )
    {
        ...
        _id_724736FCF0FB6604::_id_AE30366A2D519A57( self, 2, _id_69E96A4CAA72D794._id_275F4441AB7920C8 );
        ...
        else if ( istrue( self._id_1F8CD0CE903FF0DA ) )
        {
            self._id_5621109F5EF8AB48.contents[_id_8817E4FBE0F63228]["quantity"] = 0;
            self._id_5621109F5EF8AB48.contents[_id_8817E4FBE0F63228]["lootID"] = 0;
        }
    ...
    if ( !getdvarint( "dvar_8B40BEE5A7E0FC04", 1 ) || _id_F3557CAF4562BFF7( _id_69E96A4CAA72D794 ) )
    {
        _id_69E96A4CAA72D794.contents[_id_8817E4FBE0F63228]["lootID"] = 0;
        _id_69E96A4CAA72D794.contents[_id_8817E4FBE0F63228]["quantity"] = 0;
    ...
    else
    {
        ...
        {
            self._id_5621109F5EF8AB48.contents[_id_8817E4FBE0F63228]["quantity"] = _id_F27898E4AFD922B4;
            self._id_5621109F5EF8AB48.contents[_id_8817E4FBE0F63228]["lootID"] = _id_DFAB44D4D8D10B36;
        }
...
_id_E183B2E94298BB75( loadoutindex, player, _id_69E96A4CAA72D794 )
{
    _id_7E52B56769FA7774::_id_62F068CEC343A111( player, 1, loadoutindex - 1, undefined, 0, 0 );
    _id_45D3E9C928EE2A64 = getcompleteweaponname( _id_69E96A4CAA72D794._id_6FB67C8525B1D79E );
    _id_0D8AEA6BBFACDFF1 = undefined;

    if ( isdefined( _id_69E96A4CAA72D794._id_6FB67C8525B1D79E.basename ) )
        _id_0D8AEA6BBFACDFF1 = _id_69E96A4CAA72D794._id_6FB67C8525B1D79E.basename;
    else
        _id_0D8AEA6BBFACDFF1 = getweaponbasename( _id_69E96A4CAA72D794._id_6FB67C8525B1D79E );

    success = _id_724736FCF0FB6604::br_forcegivecustomweapon( player, _id_69E96A4CAA72D794._id_6FB67C8525B1D79E, _id_45D3E9C928EE2A64, _id_0D8AEA6BBFACDFF1 );

    if ( success )
    {
        weaponslot = scripts\engine\utility::ter_op( player.primaryweaponobj == _id_69E96A4CAA72D794._id_6FB67C8525B1D79E, 0, 1 );
        _id_0B7A9CE0A2282B79::_id_5D94B2DFABBC4CCE( player, _id_69E96A4CAA72D794._id_6FB67C8525B1D79E, weaponslot, 1 );
        player setclientomnvar( "loot_container_weapon", 0 );
        _id_69E96A4CAA72D794._id_04F6CDE716E0C3D7 = 0;
        _id_69E96A4CAA72D794._id_6FB67C8525B1D79E = undefined;
    ...
    if ( isdefined( _id_EA3E3B2121E6713A ) )
    {
        ...
        switch ( _id_EA3E3B2121E6713A )
        {
            ...
            case "equip_loot_container":
                ...
                if ( itemtype == 3 && loadoutindex != 0 )
                    _id_E183B2E94298BB75( loadoutindex, self, _id_69E96A4CAA72D794 );
                else if ( _id_E1D097C517C3AF5B == 100 )
                    _id_A92926D5B02CF6ED( self, _id_69E96A4CAA72D794 );
                else
                {
                    _id_9D924AEA120C2693( self, itemtype );
            ...
            case "loot_to_specific_slot":
                ...
                if ( _id_6F45E7311F77EAC4( self ) && isdefined( _id_69E96A4CAA72D794 ) && isdefined( _id_69E96A4CAA72D794.contents ) )
                    _id_F0617AD70B7E7792( _id_8817E4FBE0F63228, _id_EBBCB5A184F5C67B, _id_69E96A4CAA72D794 );
