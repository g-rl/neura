...
_id_FAD21382D44834E8( instance )
{
    ...
    if ( _id_C284C09EF7780E64.health > 0 )
    {
        ...
        if ( _id_C284C09EF7780E64.health <= 0 )
        {
            ...
            instance.attacker _id_4263BFD08219620D::trial_updatehitmarker( "standard", 1, isheadshot, 0 );
            ...
            instance.attacker _id_4263BFD08219620D::trial_updatehitmarker( "standard", 0, isheadshot, 0 );
    }
}
