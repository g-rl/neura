...
nuke_killplayer( _id_7DC3241E7F3C6B24 )
{
    if ( isplayer( _id_7DC3241E7F3C6B24 ) )
    {
        ...
        _id_3BE1B771648E3C2D = vectornormalize( _id_7DC3241E7F3C6B24.origin + ( 0, 0, 1000 ) - level.nuke_inflictor.origin );
        _id_7DC3241E7F3C6B24 thread scripts\mp\damage::finishplayerdamagewrapper( level.nuke_inflictor, level.nukeinfo.player, 999999, 0, "MOD_EXPLOSIVE", objweapon, _id_7DC3241E7F3C6B24.origin, _id_3BE1B771648E3C2D, "none", 0, 0, undefined, undefined );
    }
}
...
nuke_killplayerwithattacker( _id_7DC3241E7F3C6B24 )
{
    ...
    objweapon = makeweapon( "nuke_mp" );
    _id_7DC3241E7F3C6B24 dodamage( 999999, level.nuke_inflictor.origin, _id_705CC2040029EDB7, level.nuke_inflictor, "MOD_EXPLOSIVE", objweapon, "none" );
}
