        ...
        foreach ( data in _id_C2C1AB2C183FF85B )
        {
            ...
            switch ( category )
            {
                ...
                case "last_known_position":
                    ...
                    break;
                case "hunt":
                    if ( data._id_1C9CB43BCF3EB16D == "combat_hunt" )
                ...
                case "combat_state_change":
                    if ( data._id_1C9CB43BCF3EB16D == "combat_unaware" )
                        data.entity _id_D54E84A9513B0E45( "combat_unaware", "react_unaware", 0, 2, 5 );
...
_id_1AC4F948BB0D1255( previousstate, currentstate )
{
    ...
    {
        case 0:
            return _id_50EEB9595C6D6E1B::_id_E64DBAAAE396FBB8();
        case 1:
...
_id_58D2ED1E4ECAE7BB( _id_D93390A0D7E03633, _id_9144967162969CD7 )
{
...
_id_161BD3732C0AFBCE( name, duration )
{
    if ( !_id_EAD4BED232D015ED( name ) )
        return 0;

    _id_E23B0906B02CD179( name, duration );
    return 1;
}
...
_id_573B9FF9ED152518( guy, _id_F9D07E5FA610B560 )
{
    ...
    if ( !isdefined( guy.voice ) || !isdefined( guy.battlechatter ) || !isdefined( guy.battlechatter.npcid ) )
        return;
    ...
    else
    {
        ...
        {
            if ( _id_CF9DFCA32AF33B39.npcid != guy.battlechatter.npcid )
...
_id_45F570789FF9A0FD( time, _id_877945E6D268BA99 )
{
    ...
    if ( _id_877945E6D268BA99 && !self seerecently( self.enemy, time ) )
        return 0;
