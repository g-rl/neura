...
showsplashwithkillcheckhack( ref, optionalnumber, playerforplayercard, altdisplayindex, _id_EF4849B4CB3AC7E2 )
{
    ...
    showsplash( ref, optionalnumber, playerforplayercard, altdisplayindex, 1 );
}

showsplash( ref, optionalnumber, playerforplayercard, altdisplayindex, _id_EF4849B4CB3AC7E2 )
{
    ...
    {
        thread showsplashwithkillcheckhack( ref, optionalnumber, playerforplayercard, altdisplayindex, _id_EF4849B4CB3AC7E2 );
        return;
    }
    ...
    {
        queuesplash( ref, optionalnumber, playerforplayercard, playernumforplayercard, altdisplayindex );
        return;
    }
    ...
    showsplashinternal( ref, optionalnumber, playerforplayercard, playernumforplayercard, altdisplayindex );
}
...
showsplashinternal( ref, optionalnumber, playerforplayercard, playernumforplayercard, altdisplayindex )
{
    ...
    {
        _id_83AFA1BB13298AC7 = _id_73BAF095C3B9CCE6( ref );
...
handlesplashqueue()
{
    ...
    while ( isdefined( self.splashqueuehead ) )
    {
        ...
        for ( _id_2ACA94DD41D845F8 = 0; _id_2ACA94DD41D845F8 < 6; _id_2ACA94DD41D845F8++ )
        {
            ...
            showsplashinternal( struct.ref, struct.optionalnumber, struct.playerforplayercard, struct.playernumforplayercard, struct.altdisplayindex );
...
_id_73BAF095C3B9CCE6( _id_F7B6CC6C062A7A43 )
{
