...
{
    _id_3B64EB40368C1450::_id_2D6E7E0B80767910( "chopperGunnerUse", [ "fire", "weapon_switch", "melee", "usability", "shellshock", "allow_jump", "offhand_weapons" ] );
}
...
startchoppergunnerintro( owner, streakinfo, _id_EB86A5CD1650B4AF )
{
    ...
    if ( isdefined( level.heli_structs_entrances ) && level.heli_structs_entrances.size > 0 )
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "chopper_gunner", "findTargetStruct" ) )
        {
            ...
            if ( isdefined( goalstruct ) )
            {
                ...
                pathgoal = _id_C32E33B4D51BE12F + _id_8577D255D1A9BD14 * 100;
    ...
    _id_D166C9B268E88725 = "veh_apache_mp";
    ...
    _id_E29C89AE4C29E698 = getdvarint( "dvar_804B68F93E7911BA", 1 );

    if ( _id_E29C89AE4C29E698 > 0 )
    {
        if ( getdvarint( "dvar_DD6C524502ACC3A5", 0 ) > 0 )
        {
            _id_D166C9B268E88725 = "veh_apache_mp_phys_beta_fix";
