...
init()
{
    if ( getdvarint( "dvar_AC8DFA3636C6E111", 0 ) == 0 )
        return;

    level._id_B19067B41FD5CFE8 = 1;
    level._id_BF269015710DE2DD = getdvarint( "dvar_A6B52F16F3853A9A", 1 );
...
_id_2DA74CF301F9FAA5( ref )
{
    ...
    if ( isdefined( self._id_453B42F68499E7FC ) && gettime() - self._id_453B42F68499E7FC <= 9000 )
        return 0;
    ...
    _id_0AD3658A1088AF24 = _id_F7754D7AD59B2F8B();
    tier = _id_DF45AD64B9DC074B( ref );

    if ( !istrue( level._id_BF269015710DE2DD ) && tier == 1 )
        return 0;
...
_id_D42AFC6EF83AAFCA( ref, mask, _id_428B69AA429BFF26 )
{
    ...
    if ( istrue( level._id_B19067B41FD5CFE8 ) )
    {
        ...
        _id_3FA1BF21E3FC7B80::_id_233461F36BB50EF9( ref );
