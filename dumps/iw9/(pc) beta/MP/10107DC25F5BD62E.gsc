...
init()
{
    ...
    level._id_A265803F42D3EC61 = getdvarint( "dvar_6082FF30B557BEE0", 0 ) == 0;
}
...
_id_8FD589760902B617()
{
    return istrue( level._id_A265803F42D3EC61 ) && !istrue( level._id_DC65C33DFDD9EFE8 ) && !istrue( level.spectate3rdallowed ) && getdvarint( "dvar_C00E244EA59D530E" ) == 0;
}
