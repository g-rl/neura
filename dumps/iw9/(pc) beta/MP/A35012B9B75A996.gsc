...
_id_0C44B639F5005AFA()
{
    ...
    thread _id_C5852887BDEA3EFB( 0.25 );
}
...
_id_374B1ABF46319E21( grenade )
{
    ...
    if ( isdefined( _id_A681B7890CD017C7.stuckto ) && isplayer( _id_A681B7890CD017C7.stuckto ) )
    {
...
_id_C927FD013FC6E502( victim )
{
    ...
    if ( victim isgestureplaying( "vm_ges_shockstick_react_out" ) )
        victim stopgestureviewmodel( "vm_ges_shockstick_react_out", 0.1, 1 );
