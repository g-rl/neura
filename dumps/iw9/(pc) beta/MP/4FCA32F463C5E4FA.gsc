...
registersupers()
{
    ...
    _id_53110A12409D01DA( "super_chopper_gunner", undefined, undefined, ::choppergunnerbeginuse, undefined, undefined, undefined, undefined );
    _id_53110A12409D01DA( "super_cruise_predator", undefined, undefined, ::cruisepredatorbeginuse, undefined, undefined, undefined, undefined );
    _id_53110A12409D01DA( "super_precision_airstrike", undefined, undefined, ::precisionairstrikebeginuse, undefined, undefined, undefined, undefined );
    _id_53110A12409D01DA( "super_toma_strike", undefined, undefined, ::tomastrikebeginuse, undefined, undefined, undefined, undefined );
    _id_53110A12409D01DA( "super_pac_sentry", undefined, undefined, ::pacsentrybeginuse, undefined, undefined, undefined, undefined );
    _id_53110A12409D01DA( "super_br_extract", undefined, undefined, ::brcircleextract, undefined, undefined, undefined, undefined );
    _id_53110A12409D01DA( "super_uav", undefined, undefined, ::uavbeginuse, undefined, undefined, undefined, undefined );
    ...
    _id_53110A12409D01DA( "super_emp_drone", undefined, undefined, ::empdronebeginuse, undefined, undefined, undefined, undefined );
    ...
    _id_53110A12409D01DA( "super_laststand_heal", ::laststandhealonset, ::laststandhealunset, ::laststandhealbeginuse, undefined, undefined, undefined, undefined );
    _id_53110A12409D01DA( "super_remote_detonate", ::remotedetonateonset, undefined, ::remotedetonatebeginuse, undefined, undefined, undefined, undefined );
    ...
    _id_53110A12409D01DA( "super_select", ::superselectonset, ::superselectonunset, ::superselectbeginuse, undefined, undefined, undefined, undefined );
    ...
    _id_53110A12409D01DA( "super_stimpistol", undefined, ::_id_90A74A57A43C9808, ::_id_53025970EB68A86B, ::_id_FDFAE98BCFBF8C7F, undefined, undefined, undefined );
    ...
    for (;;)
    {
        ...
        for ( startplayer = 0; startplayer < _id_D12A341B40354143; startplayer = startplayer + 15 )
        {
            for ( _id_82555C709FBE7CCC = 0; _id_82555C709FBE7CCC < 15; _id_82555C709FBE7CCC++ )
            {
                ...
                if ( isdefined( player getcurrentsuper() ) && !player getcurrentsuper().isinuse && !isdefined( player._id_D0C1F5BBF172F9D9 ) && ( isdefined( player._id_678855513F5076CA ) || isdefined( level.allowsupers ) ) )
...
_id_50F445936B3DDD9E( _id_D220971FFE40C601 )
{
    ...
    if ( _id_D220971FFE40C601 == self.perkpackagedata._id_E5DA01E1954B6734 )
        return 0;
    else
        superonunset( self.perkpackagedata._id_E5DA01E1954B6734 );
...
clearsuper( _id_6C70BF5AD211F464, _id_D220971FFE40C601 )
{
    ...
    if ( isdefined( self._id_D0C1F5BBF172F9D9 ) )
        self._id_D0C1F5BBF172F9D9 = undefined;
...
givesuperpoints( points, _id_F0FA3B7B27926553, _id_B4B593FACAA83AF7, _id_53E3AF3B2C8752BD, _id_2569EC7D8016F67F )
{
    ...
    {
        if ( isdefined( self._id_A68B289A82138067 ) && scripts\mp\utility\perk::_hasperk( "specialty_overcharge_field_upgrade" ) && !isdefined( self._id_678855513F5076CA ) )
        {
            self._id_A68B289A82138067 = self._id_A68B289A82138067 + _id_2BC440C7D6A315D9;
            _id_B3D636936EC98AA0();
            _id_E20AB7A8971EE3F2();
        }
...
_id_E20AB7A8971EE3F2()
{
    ...
    {
        _id_9CF33E852E0E768A = ( progress + _id_F52E8A5ADD0F7FF8 ) / self._id_491F93D0219D8D44;
        self setplayersupermeterprogress( _id_9CF33E852E0E768A );
    }

    if ( !isdefined( self._id_6B4B4C0692F7BF67 ) || self._id_491F93D0219D8D44 != self._id_6B4B4C0692F7BF67 )
        self setclientomnvar( "ui_codcaster_fieldupgrade_max_count", self._id_491F93D0219D8D44 );
...
_id_B3D636936EC98AA0()
{
    ...
    pointsneeded = getsuperpointsneeded();
    progress = clamp( self._id_A68B289A82138067 / pointsneeded, 0.0, 1.0 );
...
_id_E16C077503BBB00F()
{
    ...
    {
        _id_19163E14365D9264 = getcurrentsuper();
        _id_19163E14365D9264._id_510E0D2ABEAB7513 = undefined;
        ...
        if ( isdefined( msg ) && msg == "superWeaponHoldSucceed" )
        {
            ...
            if ( self _meth_5304F90E15C214D2() || istrue( _id_19163E14365D9264._id_510E0D2ABEAB7513 ) )
            {
...
_id_BAD0AA1C878DA781( _id_19163E14365D9264 )
{
    ...
    while ( self _meth_5304F90E15C214D2() )
    {
        if ( counter >= 0.75 )
        {
            _id_19163E14365D9264._id_510E0D2ABEAB7513 = 1;
            break;
        }
