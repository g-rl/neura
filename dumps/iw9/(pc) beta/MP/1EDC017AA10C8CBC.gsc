...
onplayerdamaged( data )
{
    ...
    if ( data.victim scripts\mp\utility\perk::_hasperk( "specialty_stun_resistance" ) && data.attacker != data.victim )
    {
        ...
        data.victim thread applyflash( data.attacker, 3.6 );
    }
    else
    {
        ...
        _id_5F651E1139EF776F = scripts\engine\utility::_id_53C4C53197386572( data.inflictor._id_D442547D75DFFD09._id_2C74F60C630718A3, 4 );
        _id_6B7054210E5DF55D = scripts\engine\utility::_id_53C4C53197386572( data.inflictor._id_D442547D75DFFD09._id_BD11A6EC2CACBBCD, 6 );
...
applyflash( attacker, duration )
{
    ...
    {
        attacker scripts\cp_mp\challenges::_id_B0F754C8A379154E( "equip_flash", attacker );
