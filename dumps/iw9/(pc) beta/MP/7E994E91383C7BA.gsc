...
_id_E384066B8CC15BE4( owner, team, position, _id_4361065C62F16C21, streakinfo )
{
    ...
    _id_E46635AE3E71D45B = getdvarint( "dvar_8209BC6652B0B926", 1 );

    if ( istrue( _id_E46635AE3E71D45B ) )
        ...
        escortheli = scripts\cp_mp\vehicles\vehicle_tracking::_spawnhelicopter( owner, pathstart, _id_098309FE48684A69, "veh_airdrop_escort_mp", "veh9_mil_air_heli_hind_mp" );
    else
        escortheli = scripts\cp_mp\vehicles\vehicle_tracking::_spawnhelicopter( level.players[randomint( level.players.size )], pathstart, _id_098309FE48684A69, "veh_airdrop_escort_mp", "veh9_mil_air_heli_hind_mp" );
