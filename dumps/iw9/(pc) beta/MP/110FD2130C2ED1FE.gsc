...
init()
{
    enabled = _id_3ACF1C0EBAF602F2::registerquestcategory( "assassination_legacy", 1 );

    if ( !enabled )
        return;

    _id_3ACF1C0EBAF602F2::registerquestcategorytablevalues( "assassination_legacy_all" );
    _id_3ACF1C0EBAF602F2::registerquestcategorytablevalues( "assassination_legacy_all_timed" );
    level.br_leaderbystreak = getdvarint( "dvar_22C4C1F9EFB1DE0A", 0 ) != 0;
    _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).questbasetimer = getdvarint( "dvar_2F9CD2B10D05E2B3", 180 );
    _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).questbonustimer = getdvarint( "dvar_23B6F8F2AF592FC1", 60 );
    _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).resettimeronkill = getdvarint( "dvar_B18C855819438FDE", 1 );
    _id_3ACF1C0EBAF602F2::registerquestthink( "assassination_legacy", ::aq_questthink_circleposition, 10 );
    _id_3ACF1C0EBAF602F2::registerquestthink( "assassination_legacy", ::aq_questthink_objectivevisibility, 0.2 );
    _id_3ACF1C0EBAF602F2::registerremovequestinstance( "assassination_legacy", ::aq_removequestinstance );
    _id_3ACF1C0EBAF602F2::registeronplayerkilled( "assassination_legacy", ::aq_playerdied );
    _id_3ACF1C0EBAF602F2::registeronplayerdisconnect( "assassination_legacy", ::aq_playerdisconnect );
    ...
    _id_3ACF1C0EBAF602F2::registerplayerfilter( "assassination_legacy", _id_2E06828EC179F5BE, 0 );
    _id_3ACF1C0EBAF602F2::questtimerinit( "assassination_legacy", 1 );
    _id_3ACF1C0EBAF602F2::registerontimerupdate( "assassination_legacy", ::aq_ontimerupdate );
    _id_3ACF1C0EBAF602F2::registerontimerexpired( "assassination_legacy", ::aq_ontimerexpired );
    _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).alltrackedplayers = [];
    allassassin_init();
...
givequestsplash( _id_6006E8173093C1E4 )
{
    ...
    if ( isdefined( _id_6006E8173093C1E4 ) )
    {
        ...
        _id_3ACF1C0EBAF602F2::displaysquadmessagetoteam( self.hunterteam, _id_6006E8173093C1E4, 6, _id_3ACF1C0EBAF602F2::getquestindex( "assassination_legacy" ) );
    }
}

givequest( hunterteam, targetteam, id, player, modifier, rewardscriptable )
{
    instance = _id_3ACF1C0EBAF602F2::createquestinstance( "assassination_legacy", hunterteam, id, rewardscriptable );
    ...
    if ( instance.modifier != "_all" )
        instance _id_3ACF1C0EBAF602F2::questtimerset( _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).questbasetimer, 4 );
    ...
    _id_3ACF1C0EBAF602F2::addquestinstance( "assassination_legacy", instance );
    _id_3ACF1C0EBAF602F2::startteamcontractchallenge( "assassination_legacy", player, hunterteam );
    return instance;
}
...
determinetargetteam( player )
{
    ...
    _id_EA7CD2B67D803BC4 = _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).alltrackedplayers;
    ...
    _id_18176E8F61BB2E83 = level.questinfo.quests["assassination_legacy"].filters[0];
    ...
    if ( isdefined( _id_3B8219D206004DFA ) )
        _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).alltrackedplayers = scripts\engine\utility::array_combine( _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).alltrackedplayers, scripts\mp\utility\teams::getteamdata( _id_3B8219D206004DFA, "players" ) );
...
aq_ontimerexpired()
{
    ...
    else
    {
        ...
        reward = _id_3ACF1C0EBAF602F2::getquestplunderreward( "assassination_legacy", rewardtier );
        self.rewardmodifier = "_averted";
        params = spawnstruct();
        missionid = _id_3ACF1C0EBAF602F2::getquestindex( "assassination_legacy" );
        _id_11D65784F0B6AFA2 = _id_3ACF1C0EBAF602F2::getquestrewardgroupindex( _id_3ACF1C0EBAF602F2::getquestrewardbuildgroupref( "assassination_legacy", self.rewardmodifier, self.modifier ) );
    ...
    if ( _id_A1A07F4BC10BF84C.team == self.targetteam )
    {
        if ( _id_A1A07F4BC10BF84C == self.targetplayer )
        {
            ...
            if ( isdefined( attacker ) && isdefined( attacker.team ) && attacker.team == self.hunterteam )
            {
                ...
                _id_3ACF1C0EBAF602F2::displaysquadmessagetoteam( self.hunterteam, attacker, 8, _id_3ACF1C0EBAF602F2::getquestindex( "assassination_legacy" ) );
...
showassassinationhud( instance )
{
    ...
    _id_3ACF1C0EBAF602F2::uiobjectiveshow( "assassination_legacy" + instance.modifier );
...
allassassin_update_timed()
{
    ...
    {
        if ( !isdefined( level.questinfo.quests["assassination_legacy"].instances[team] ) )
...
disableteamkillrewards()
{
    _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).disableteamrewards = 1;
}

disableplayerkillrewards()
{
    _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).disableplayerrewards = 1;
}

checkifteamrewardsareenabled()
{
    return isdefined( _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).disableteamrewards ) && _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).disableteamrewards;
}

checkifplayerrewardsareenabled()
{
    return isdefined( _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).disableplayerrewards ) && _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).disableplayerrewards;
}

getquesttimefrac()
{
    _id_89CAD6E3DA206570 = _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" ).questbasetimer;
...
{
    quests = _id_3ACF1C0EBAF602F2::getquestdata( "assassination_legacy" );
