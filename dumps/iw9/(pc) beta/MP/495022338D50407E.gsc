...
_id_D257C9925E2AFFD2()
{
    ...
    contents[0]["lootID"] = 200047;
    contents[1]["quantity"] = 125 - _id_8EDB49ADF90C641A;
    contents[1]["lootID"] = 200047;

    if ( randomint( 2 ) > 0 )
    {
        contents[2]["quantity"] = 1;
        contents[2]["lootID"] = 280019;
    }
    else
    {
        contents[2]["quantity"] = 1;
        contents[2]["lootID"] = 280024;
    }
    ...
    if ( randomint == 0 )
    {
        ...
        contents[3]["lootID"] = 50011;
    }
    else if ( randomint == 1 )
    {
        contents[3]["quantity"] = 1;
        contents[3]["lootID"] = 200065;
        contents[4]["quantity"] = 1;
        contents[4]["lootID"] = 200065;
    }
    else
    {
        contents[3]["quantity"] = 5;
        contents[3]["lootID"] = 200048;
    }
    ...
    if ( randomfloat( 1 ) < 0.2 )
    {
        ...
        if ( randomint == 0 )
        {
            ...
            contents[index]["lootID"] = 1090;
        }
        else if ( randomint == 1 )
        {
            contents[index]["quantity"] = 1;
            contents[index]["lootID"] = 1096;
        }
        else
        {
            contents[index]["quantity"] = 1;
            contents[index]["lootID"] = 1102;
        }
    }
