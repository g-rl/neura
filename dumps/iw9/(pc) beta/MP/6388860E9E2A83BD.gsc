...
init()
{
    enabled = _id_3ACF1C0EBAF602F2::registerquestcategory( "vip_legacy", 1 );

    if ( !enabled )
        return;

    _id_3ACF1C0EBAF602F2::registerremovequestinstance( "vip_legacy", ::vip_removequestinstance );
    _id_3ACF1C0EBAF602F2::registeronplayerkilled( "vip_legacy", ::vip_playerdied );
    _id_3ACF1C0EBAF602F2::registeronplayerdisconnect( "vip_legacy", ::vip_playerdisconnect );
    _id_3ACF1C0EBAF602F2::registeronentergulag( "vip_legacy", ::vip_onentergulag );
    _id_3ACF1C0EBAF602F2::registeronrespawn( "vip_legacy", ::vip_onrespawn );
    _id_3ACF1C0EBAF602F2::registerquestthink( "vip_legacy", ::vip_questthink_iconposition, 2 );
    ...
    _id_3ACF1C0EBAF602F2::questtimerinit( "vip_legacy", 1 );
    _id_3ACF1C0EBAF602F2::registerontimerexpired( "vip_legacy", ::vip_ontimerexpired );
}

takequestitem( pickupent )
{
    instance = _id_3ACF1C0EBAF602F2::createquestinstance( "vip_legacy", self.team, pickupent.index, pickupent );
    ...
    _id_3ACF1C0EBAF602F2::addquestinstance( "vip_legacy", instance );
    _id_3ACF1C0EBAF602F2::startteamcontractchallenge( "vip_legacy", self, self.team );
    params = spawnstruct();
    params.excludedplayers = [];
    params.excludedplayers[0] = instance.vip;
    params.excludedteams = [];
    params.excludedteams[0] = instance.team;
    params.plundervar = _id_3ACF1C0EBAF602F2::getquestplunderreward( "vip_legacy", _id_3ACF1C0EBAF602F2::getquestrewardtier( self.team ) );
...
viphud_showtoplayer( player )
{
    player _id_3ACF1C0EBAF602F2::uiobjectiveshow( "vip_legacy" );
...
vip_completequest()
{
    ...
    missionid = _id_3ACF1C0EBAF602F2::getquestindex( "vip_legacy" );
    _id_11D65784F0B6AFA2 = _id_3ACF1C0EBAF602F2::getquestrewardgroupindex( _id_3ACF1C0EBAF602F2::getquestrewardbuildgroupref( "vip_legacy" ) );
...
vip_failquest( attacker )
{
    if ( isdefined( attacker ) && isplayer( attacker ) && attacker.team != self.team )
    {
        ...
        _id_11D65784F0B6AFA2 = _id_3ACF1C0EBAF602F2::getquestrewardgroupindex( _id_3ACF1C0EBAF602F2::getquestrewardbuildgroupref( "vip_legacy", self.rewardmodifier, self.modifier ) );
        params.packedbits = _id_3ACF1C0EBAF602F2::packsplashparambits( missionid, rewardtier, _id_11D65784F0B6AFA2 );
...
{
    quests = _id_3ACF1C0EBAF602F2::getquestdata( "vip_legacy" );
