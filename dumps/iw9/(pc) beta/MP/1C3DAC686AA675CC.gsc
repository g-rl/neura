...
init()
{
    ...
    enabled = _id_3ACF1C0EBAF602F2::registerquestcategory( "scavenger_legacy", 1 );

    if ( !enabled )
        return;

    _id_3ACF1C0EBAF602F2::getquestdata( "scavenger_legacy" ).searchcirclesize = getdvarint( "dvar_57CE0DF3D7742AC0", 1000 );
    _id_3ACF1C0EBAF602F2::getquestdata( "scavenger_legacy" ).missionbasetimer = getdvarint( "dvar_7328883E8F0CDD91", 300 );
    _id_3ACF1C0EBAF602F2::getquestdata( "scavenger_legacy" ).missionbonustimer = getdvarint( "dvar_EC09897DE5581DCB", 60 );
    _id_3ACF1C0EBAF602F2::getquestdata( "scavenger_legacy" ).resettimeronpickup = getdvarint( "dvar_33443F180A916464", 1 );
    _id_3ACF1C0EBAF602F2::registertabletinit( "scavenger_legacy", ::sqtablet_init );
    _id_3ACF1C0EBAF602F2::registerremovequestinstance( "scavenger_legacy", ::sq_removequestinstance );
    _id_3ACF1C0EBAF602F2::registeronplayerdisconnect( "scavenger_legacy", ::sq_playerdisconnect );
    ...
    _id_3ACF1C0EBAF602F2::questtimerinit( "scavenger_legacy", 1 );
    _id_3ACF1C0EBAF602F2::registerontimerexpired( "scavenger_legacy", ::sq_ontimerexpired );
    _id_2E06828EC179F5BE = [];
    _id_2E06828EC179F5BE[0] = _id_3ACF1C0EBAF602F2::filtercondition_isdead;
    _id_3ACF1C0EBAF602F2::registerplayerfilter( "scavenger_legacy", _id_2E06828EC179F5BE );
...
sq_respawn( player )
{
    ...
    player _id_3ACF1C0EBAF602F2::uiobjectiveshow( "scavenger_legacy" );
...
{
    locale = _id_3ACF1C0EBAF602F2::createlocaleinstance( "scavenger_locale", "scavenger_legacy", self.team );
...
sq_movequestlocale( _id_D8E9FE11ED726936 )
{
    ...
    if ( result )
    {
        ...
        if ( istrue( _id_3ACF1C0EBAF602F2::getquestdata( "scavenger_legacy" ).resettimeronpickup ) )
            self.subscribedinstances[0] _id_3ACF1C0EBAF602F2::questtimerset( _id_3ACF1C0EBAF602F2::getquestdata( "scavenger_legacy" ).missionbasetimer, 1 );
        else
            self.subscribedinstances[0] _id_3ACF1C0EBAF602F2::questtimeradd( _id_3ACF1C0EBAF602F2::getquestdata( "scavenger_legacy" ).missionbonustimer );
    }
}
...
{
    instance = _id_3ACF1C0EBAF602F2::createquestinstance( "scavenger_legacy", self.team, pickupent.index, pickupent );
    ...
    _id_3ACF1C0EBAF602F2::uiobjectiveshowtoteam( "scavenger_legacy", self.team );
    instance.totalscavengeditems = 0;
    instance _id_3ACF1C0EBAF602F2::questtimerset( _id_3ACF1C0EBAF602F2::getquestdata( "scavenger_legacy" ).missionbasetimer, 4 );
    _id_3ACF1C0EBAF602F2::addquestinstance( "scavenger_legacy", instance );
    _id_3ACF1C0EBAF602F2::startteamcontractchallenge( "scavenger_legacy", self, self.team );
    params = spawnstruct();
    params.excludedplayers = [];
    params.excludedplayers[0] = self;
    params.plundervar = _id_3ACF1C0EBAF602F2::getquestplunderreward( "scavenger_legacy", _id_3ACF1C0EBAF602F2::getquestrewardtier( self.team ) );
    ...
    _id_3ACF1C0EBAF602F2::displaysquadmessagetoteam( instance.team, self, 6, _id_3ACF1C0EBAF602F2::getquestindex( "scavenger_legacy" ) );
...
completescavengerquest( chest )
{
    ...
    missionid = _id_3ACF1C0EBAF602F2::getquestindex( "scavenger_legacy" );
    _id_11D65784F0B6AFA2 = _id_3ACF1C0EBAF602F2::getquestrewardgroupindex( _id_3ACF1C0EBAF602F2::getquestrewardbuildgroupref( "scavenger_legacy" ) );
...
scavengerlootcacheused( instance, part, state, player, _id_A5B2C541413AA895, _id_CC38472E36BE1B61 )
{
    ...
    if ( state == "scavenger_closed" && isdefined( instance.entity ) )
    {
        ...
        if ( instance.entity.questlocale.phaseindex == 2 )
        {
            ...
            _id_3ACF1C0EBAF602F2::displaysquadmessagetoteam( questinstance.team, player, 8, _id_3ACF1C0EBAF602F2::getquestindex( "scavenger_legacy" ) );
            questinstance completescavengerquest( instance.entity );
        }
        else
        {
            _id_3ACF1C0EBAF602F2::displaysquadmessagetoteam( questinstance.team, player, 7, _id_3ACF1C0EBAF602F2::getquestindex( "scavenger_legacy" ) );
...
sqtablet_init()
{
    ...
    for ( _id_AC0E594AC96AA3A8 = 0; _id_AC0E594AC96AA3A8 < 3; _id_AC0E594AC96AA3A8++ )
    {
        ...
        placement = _id_3ACF1C0EBAF602F2::findquestplacement( "scavenger_legacy", _id_354D1457278B342C );
