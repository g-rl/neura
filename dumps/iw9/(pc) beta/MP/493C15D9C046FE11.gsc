...
{
    _id_3B64EB40368C1450::_id_2D6E7E0B80767910( "cruisePredator", [ "fire", "weapon_switch", "melee", "usability", "shellshock", "offhand_weapons" ] );
}
...
runcruisepredator( streakname, streakinfo, _id_EB86A5CD1650B4AF )
{
    ...
    if ( isdefined( _id_5FA1E1697A302583 ) )
        heightoffset = _id_5FA1E1697A302583.origin[2] + 6000;
...
cruisepredator_watchmissileexplosion( missile, rider, killcament, _id_EB86A5CD1650B4AF, enemytargetmarkergroup, friendlytargetmarkergroup )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "createObjective" ) )
        minimapid = missile [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "createObjective" ) ]]( "icon_minimap_cruisemissile", self.team, undefined, 1, undefined, "icon_large" );
