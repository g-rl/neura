...
gettargetmarker( streakinfo, _id_281C85042194C88F )
{
    ...
    if ( isdefined( _id_E7DB3D4387BC5207.location ) && isdefined( _id_E7DB3D4387BC5207.angles ) )
    {
        ...
        _id_E7DB3D4387BC5207.visual = spawn( "script_model", _id_E7DB3D4387BC5207.location + _id_E7DB3D4387BC5207.fxoffset );
        _id_E7DB3D4387BC5207.visual.angles = _id_E7DB3D4387BC5207.angles;

        if ( streakinfo.streakname == "toma_strike" )
            _id_E7DB3D4387BC5207.visual setmodel( "ks_toma_strike_marker_mp" );

        if ( isdefined( _id_E7DB3D4387BC5207.visual.model ) && _id_E7DB3D4387BC5207.visual.model != "" )
        {
            _id_E7DB3D4387BC5207.visual setotherent( self );
            _id_E7DB3D4387BC5207.visual setscriptablepartstate( "target", "placed", 0 );
        }
    }
