...
initspawns()
{
    ...
    scripts\mp\spawnlogic::addspawnpoints( game["attackers"], "mp_tdm_spawn_allies_start", undefined, undefined, "scrapyard_tdm" );
    scripts\mp\spawnlogic::addspawnpoints( game["defenders"], "mp_tdm_spawn_axis_start", undefined, undefined, "scrapyard_tdm" );
    attackers = scripts\mp\spawnlogic::getspawnpointarray( "mp_tdm_spawn_allies_start", undefined, "scrapyard_tdm" );
    _id_2FD93EA689E77097 = scripts\mp\spawnlogic::getspawnpointarray( "mp_tdm_spawn_axis_start", undefined, "scrapyard_tdm" );
    scripts\mp\spawnlogic::registerspawnset( "start_attackers", attackers );
    scripts\mp\spawnlogic::registerspawnset( "start_defenders", _id_2FD93EA689E77097 );
    scripts\mp\spawnlogic::addspawnpoints( "allies", "mp_tdm_spawn", undefined, undefined, "scrapyard_tdm" );
    scripts\mp\spawnlogic::addspawnpoints( "axis", "mp_tdm_spawn", undefined, undefined, "scrapyard_tdm" );
    scripts\mp\spawnlogic::addspawnpoints( "allies", "mp_tdm_spawn_secondary", 1, 1, "scrapyard_tdm" );
    scripts\mp\spawnlogic::addspawnpoints( "axis", "mp_tdm_spawn_secondary", 1, 1, "scrapyard_tdm" );
    _id_29D9D2428185616D = scripts\mp\spawnlogic::getspawnpointarray( "mp_tdm_spawn", undefined, "scrapyard_tdm" );
    _id_3A5288F40C8BE099 = scripts\mp\spawnlogic::getspawnpointarray( "mp_tdm_spawn_secondary", undefined, "scrapyard_tdm" );
...
_id_E8F8910B67CD2156()
{
    _id_1824A4F7D2E41E23 = getentarray( "war_mgl_obstacles", "script_noteworthy" );

    if ( isdefined( _id_1824A4F7D2E41E23 ) )
    {
        foreach ( obstacle in _id_1824A4F7D2E41E23 )
        {
            obstacle.origin = obstacle.origin + ( 0, 0, 2000 );

            if ( obstacle.classname == "script_brushmodel" )
                obstacle disconnectpaths();
        }
    }
}
