...
getequipmentmaxammo( ref )
{
    ...
    if ( !scripts\cp_mp\utility\game_utility::_id_0BEFF479639E6508() )
    {
        ...
        if ( !isdefined( maxammo ) )
        {
            ...
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "perk", "hasPerk" ) )
            {
                if ( self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "hasPerk" ) ]]( "specialty_extra_deadly" ) && slot == "primary" )
                    maxammo++;

                if ( self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "hasPerk" ) ]]( "specialty_extra_tactical" ) && slot == "secondary" )
                    maxammo++;
            }
        }
    }
