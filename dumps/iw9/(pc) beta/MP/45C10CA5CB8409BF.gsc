...
_id_053B79C2279DC402( _id_4FAC8B8CE36E09F1 )
{
    ...
    {
        self.owner scripts\cp_mp\challenges::_id_BD59AA7E8CECE1AB( "super_sound_veil", self.usedcount );
...
_id_20E0E81CCC2160E7( _id_8483C4E961406C32, _id_CFF38BAE1F51BBBF )
{
    ...
    while ( isdefined( _id_8483C4E961406C32 ) )
    {
        ...
        if ( isdefined( self.owner ) )
            _id_8483C4E961406C32 dodamage( 1, self.origin, self.owner, self, "MOD_EXPLOSIVE", self.weapon_object );
...
_id_A8B8C5877FC13197( _id_8483C4E961406C32, _id_CFF38BAE1F51BBBF )
{
    level endon( "game_ended" );
    _id_4A6A11A4F1E2C293 = 0;
    scripts\cp_mp\utility\player_utility::_id_F7348E400B4A608D( _id_8483C4E961406C32, "player_soundveil_shake_mp", 0, 1 );
