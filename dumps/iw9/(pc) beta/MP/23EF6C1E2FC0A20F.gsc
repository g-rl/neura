...
weaponattachremoveextraattachments( attachments, weapon )
{
    ...
    foreach ( attachment in attachments )
    {
        ...
        {
            for ( _id_AC0E594AC96AA3A8 = 0; _id_AC0E594AC96AA3A8 < _id_D76A3E9A51BB0F30.size; _id_AC0E594AC96AA3A8++ )
            {
                if ( attachment == _id_D76A3E9A51BB0F30[_id_AC0E594AC96AA3A8]._id_C509A2E8A9D5D422 )
                {
...
{
    return objweapon.basename == "iw8_cyberemp_mp" || objweapon.basename == "iw7_tdefball_mp";
}
