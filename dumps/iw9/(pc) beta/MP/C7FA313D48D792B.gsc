...
asm_generichandler( _id_2264872EE8A7D354, asmname, param1, param2, param3 )
{
    switch ( _id_2264872EE8A7D354 )
    {
        ...
        case "waitfordooropen":
            thread scripts\asm\shared\utility::waitfordooropen( asmname, param1, param2 );
            break;
        default:
            break;
    }
...
asm_getroot()
{
    _id_2C8936D08F85C5C1 = asm_lookupanimfromalias( "knobs", "root" );
    return asm_getxanim( "knobs", _id_2C8936D08F85C5C1 );
}

asm_getbodyknob()
{
    _id_2C8936D08F85C5C1 = asm_lookupanimfromalias( "knobs", "body" );
    return asm_getxanim( "knobs", _id_2C8936D08F85C5C1 );
}
