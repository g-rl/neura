...
watchmarkeractivate( streakinfo )
{
    ...
    else
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "juggernaut", "dropCrateFromScriptedHeli" ) && !scripts\cp_mp\utility\game_utility::_id_0BEFF479639E6508() )
        {
            ...
            scenenode = [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "juggernaut", "dropCrateFromScriptedHeli" ) ]]( owner, owner.team, "juggernaut", position, _id_811F337EFD111E98, _id_811F337EFD111E98 + ( 0, 180, 0 ), streakinfo );
