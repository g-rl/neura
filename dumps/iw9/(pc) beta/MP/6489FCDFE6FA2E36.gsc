...
_id_FC61E429C331CA42( state )
{
    if ( getdvarint( "dvar_309A1A6A28AD6554", 0 ) == 1 )
        self setclientomnvar( "ui_requestRedeployButton_state", int( state ) );
}
...
setbuybackpingmessage()
{
    ...
    if ( scripts\mp\utility\game::getgametype() != "plunder" )
    {
        ...
        for (;;)
        {
            ...
            scripts\mp\utility\lower_message::setlowermessageomnvar( "br_ping_nearest_supply" );
            _id_FC61E429C331CA42( 0 );
            msg = scripts\engine\utility::waittill_any_return_4( "buybackRequested", "br_spectator_end_forced_spectator", "playertospectate_set", "spectating_cycle" );
            ...
            if ( msg == "buybackRequested" )
            {
                ...
                if ( getdvarint( "dvar_309A1A6A28AD6554", 0 ) == 1 )
                {
                    ...
                    _id_FC61E429C331CA42( max( int( endtime ), 0 ) );
                }
...
forceplayerspectatetarget( playertospectate )
{
    ...
    if ( !player isadditionalstreamposready() )
    ...
    if ( isdefined( playertospectate.streampoint ) )
    {
        ...
        player _meth_BA3E37BE1AC8B95C( _id_11F3B4465C8B637B, 1 );
    }
    else
        player _meth_BA3E37BE1AC8B95C( _id_11F3B4465C8B637B, 1, 0, playertospectate );
    ...
    while ( ( isdefined( playertospectate.streampoint ) || !isalive( playertospectate ) ) && gettime() < timeout )
    {
