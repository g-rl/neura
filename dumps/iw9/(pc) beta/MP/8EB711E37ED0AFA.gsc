...
setdropped( _id_F2F5B1863E65433F, _id_055D7A145D6897D3, _id_74435D86CB84BE29 )
{
    ...
    if ( isdefined( trace ) )
    {
        ...
        if ( isdefined( _id_8B39D5984DA1DC7F ) && istrue( _id_8B39D5984DA1DC7F.issuper ) )
        {
            for ( index = 0; index < self.visuals.size; index++ )
                self.visuals[index] linkto( _id_8B39D5984DA1DC7F );

            thread _id_CA7C06EF832ACA23( _id_8B39D5984DA1DC7F );
        }
...
useholdthink( player )
{
    ...
    if ( isdefined( useweapon ) )
    {
        ...
        if ( lastweapon.basename == "iw8_cyberemp_mp" )
    ...
    else if ( !_id_D9842C97BADABA31 )
    {
        ...
        {
            if ( !player scripts\mp\utility\perk::_hasperk( "specialty_revive_use_weapon" ) )
            {
...
usetest( player, _id_F4B4020BAA4A83E3, _id_DD9707A466EFA528, _id_3DAFA337A7EED569 )
{
    ...
    if ( isdefined( self.trigger ) && isdefined( self.trigger._id_B9ABE6BDF97E9A79 ) && distance2dsquared( self.trigger.origin, player.origin ) >= self.trigger._id_B9ABE6BDF97E9A79 )
        return 0;
