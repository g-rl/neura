...
getspawncamera()
{
    ...
    if ( istrue( level.usestaticspawnselectioncamera ) )
    {
        ...
        _id_0DC51DE4E8CBD07B = level.spawncameras[level.currentcamera[self.team]][self.team];
    ...
    else if ( isdefined( self.forcedspawncameraref ) )
    {
        if ( isdefined( level.spawncameras[self.forcedspawncameraref] ) )
            _id_0DC51DE4E8CBD07B = level.spawncameras[self.forcedspawncameraref][self.team];
        else if ( issubstr( self.forcedspawncameraref, "squad" ) )
        {
            ...
            if ( isdefined( _id_356A015AA1975023 ) )
            {
                ...
                _id_2F38DABD01860335 = _id_2F38DABD01860335 + _id_3BA4F32E41F63B36::calculatecameraoffset( self.team, _id_356A015AA1975023.origin );
        ...
        else if ( issubstr( self.forcedspawncameraref, "vehicle" ) )
        {
            ...
            if ( isdefined( level.spawnselectionlocations[ref] ) && isdefined( level.spawnselectionlocations[ref][self.team] ) )
            ...
            if ( isdefined( _id_A5D118F040F60DB0 ) && !istrue( _id_A5D118F040F60DB0.isdestroyed ) )
            {
                ...
                _id_2F38DABD01860335 = _id_2F38DABD01860335 + _id_3BA4F32E41F63B36::calculatecameraoffset( self.team, groundpos );
                _id_0DC51DE4E8CBD07B = spawnstruct();
                _id_0DC51DE4E8CBD07B.origin = _id_2F38DABD01860335;
                _id_0DC51DE4E8CBD07B.angles = _id_8003B0D4F9FBEE0E;
            }
    ...
    else if ( istrue( level.evaluatespawnforcameraselection ) && isdefined( level.lastspawnpos ) && isdefined( level.lastspawnpos[self.team] ) )
    {
        _id_90128D0639A1315D = level.lastspawnpos[self.team];
        _id_84D4866087B00608 = undefined;
        _id_EFC4986F445EB28F = undefined;

        foreach ( team, cam in level.spawncameras[level.currentcamera[self.team]] )
        {
    ...
    else if ( istrue( level.evaluatefrontline ) )
    {
        ...
        foreach ( team, cam in level.spawncameras[level.currentcamera[self.team]] )
        {
            _id_11A0B195B1442008 = distancesquared( cam.origin, frontlineinfo.teamavg[self.team] );
    ...
    else
    {
        ...
        {
            _id_0DC51DE4E8CBD07B = spawnstruct();
            _id_0DC51DE4E8CBD07B.origin = level.currentcamera[self.team].origin;
            _id_0DC51DE4E8CBD07B.angles = level.currentcamera[self.team].angles;
    ...
    if ( !isdefined( _id_0DC51DE4E8CBD07B ) )
    {
        ...
        _id_0DC51DE4E8CBD07B = level.spawncameras["default"][self.team];
    }
...
snaptospawncamera()
{
    ...
    {
        _id_CAD22375DBD06E7C = scripts\engine\utility::ter_op( isdefined( _id_0DC51DE4E8CBD07B._id_6930961C8A8D33FC ), _id_0DC51DE4E8CBD07B._id_6930961C8A8D33FC, _id_0DC51DE4E8CBD07B.origin );
        thread _id_2CEDCC356F1B9FC8::playerstreamhintlocation( _id_CAD22375DBD06E7C, undefined, undefined, undefined, -1 );
        self notify( "spawn_cam_pos_predicted" );
    }
...
streamforslamzoomonspawn()
{
    ...
    self _meth_8B338BF92F461E6C( self geteye() );
