...
registerbcsoundtype( _id_FD2287F1DB15A3E0, _id_4F632C1568AF9FC0, priority, _id_302E82DA1A1989AD, _id_5451DCA91A942C16, _id_C3924093B71EC9DD, _id_3910458D599E5E01 )
{
    ...
    if ( !isdefined( _id_302E82DA1A1989AD ) )
        _id_302E82DA1A1989AD = 0.0;

    if ( !isdefined( _id_5451DCA91A942C16 ) )
        _id_5451DCA91A942C16 = 1.0;

    if ( !isdefined( _id_C3924093B71EC9DD ) )
        _id_C3924093B71EC9DD = 1.0;

    if ( !isdefined( _id_3910458D599E5E01 ) )
        _id_3910458D599E5E01 = 0;
    ...
    level.bcinfo["timeout_pos"][_id_FD2287F1DB15A3E0] = _id_5451DCA91A942C16 * 1000;
    level.bcinfo["timeout_player"][_id_FD2287F1DB15A3E0] = _id_C3924093B71EC9DD * 1000;
...
reloadtracking()
{
    ...
    for (;;)
    {
        ...
        if ( _id_3483795B0A68EB95 <= weaponclipsize( objweapon ) || _id_EF3BE25D24D4F062 && _id_3483795B0A68EB95 <= weaponclipsize( objweapon ) * 2 )
        {
            ...
            {
                if ( _id_CF4209C200F8BBF4 == "weapon_projectile" )
...
threatcallouttracking()
{
    ...
    for (;;)
    {
        ...
        cancalloutlocation = !isdefined( _id_5486190C6B06A3C9 ) || _id_5486190C6B06A3C9 + level.bcinfo["timeout_pos"]["stat_40D708EB58419C23"] < gettime();
...
dosound( _id_FD2287F1DB15A3E0, targetent, location )
{
    ...
    priority = level.bcinfo["priority"][_id_FD2287F1DB15A3E0];
...
cleanuplastsaytimes( _id_FD2287F1DB15A3E0, time )
{
    ...
    {
        timeout = level.bcinfo["timeout_player"][_id_0743AEDAB468ADBB] + timestamp;
    ...
    {
        if ( time < event.time + level.bcinfo["timeout_pos"][_id_FD2287F1DB15A3E0] )
...
trysaylocalsound( player, _id_FD2287F1DB15A3E0, targetent, delay, location )
{
    ...
    if ( !isdefined( level.bcinfo["priority"][_id_FD2287F1DB15A3E0] ) )
        return;
    ...
    if ( scripts\mp\utility\game::_id_BA5574C7F287C587() && 0 != getdvarint( "dvar_25AD2925D6075C8F", 0 ) && !isdefined( player.bcinfolastsaytimes ) )
        return;

    if ( level.bcinfo["req_friendly"][_id_FD2287F1DB15A3E0] && !player friendly_nearby( 4840000 ) && !istrue( level.br_practice_match ) )
        return;

    if ( randomfloat( 1 ) > level.bcinfo["chance"][_id_FD2287F1DB15A3E0] )
        return;
...
saylocalsound( waittime, _id_FD2287F1DB15A3E0, targetent, delay, location )
{
    ...
    {
        _id_7AC6C541E01DAE06 = getspeakerinfo( self, level.bcinfo["priority"][_id_FD2287F1DB15A3E0] );
...
getbcwaittime( _id_FD2287F1DB15A3E0, delay )
{
    ...
    if ( isdefined( level.bcinfo["soundEventHistory"][_id_FD2287F1DB15A3E0] ) )
    {
        if ( _id_FD2287F1DB15A3E0 == "stat_52B2ADECC602D95C" || _id_FD2287F1DB15A3E0 == "stat_0CD1D2547E61FB1E" || _id_FD2287F1DB15A3E0 == "stat_14F86AF7D651B93F" )
        {
            ...
            foreach ( _id_F90358454413407F in _id_B53830FF2A079E80 )
            {
                ...
                foreach ( event in level.bcinfo["soundEventHistory"][_id_F90358454413407F] )
                {
                    ...
                    {
                        _id_C4AC6795E14927D0 = event.time + level.bcinfo["timeout_pos"][_id_F90358454413407F];
        ...
        else if ( _id_FD2287F1DB15A3E0 == "stat_213C1CF2E5154626" )
        {
            foreach ( event in level.bcinfo["soundEventHistory"][_id_FD2287F1DB15A3E0] )
            {
                ...
                {
                    _id_C4AC6795E14927D0 = event.time + level.bcinfo["timeout_pos"][_id_FD2287F1DB15A3E0];
    ...
    _id_DCBB8C92238F7098 = self.bcinfolastsaytimes[_id_FD2287F1DB15A3E0] + level.bcinfo["timeout_player"][_id_FD2287F1DB15A3E0];
...
comparesoundpriorities( _id_CDD17478F51BEEB5, _id_CDD17178F51BE81C )
{
    ...
    _id_D2BFC86B6D21E9DE = level.bcinfo["priority"][_id_CDD17178F51BE81C] < level.bcinfo["priority"][_id_CDD17478F51BEEB5];
    _id_35470D4859F3E586 = level.bcinfo["priority"][_id_CDD17178F51BE81C] == level.bcinfo["priority"][_id_CDD17478F51BEEB5] && scripts\engine\utility::cointoss();
