...
_id_A955D908F57B75CF()
{
    ...
    for (;;)
    {
        _id_D012729EAC1E7053 = _id_23DDC5A3E0D509D3::_id_D012729EAC1E7053();
        ...
        if ( _id_D012729EAC1E7053 )
        {
            ...
            {
                _id_5CAD1E6F9D962133 = _id_7E816FA0720D38A1::bot_is_in_gas() || _id_4AC3ACC613E8BC24::_id_0296623D26E11725() || isdefined( _id_0BA5E7C3CFB3546A ) && _id_0BA5E7C3CFB3546A < gettime();
        ...
        if ( msg == "off_navmesh" )
        {
            success = _id_23DDC5A3E0D509D3::_id_64432AF189B8A177( 4, 0 );
...
deactivate()
{
    if ( !_id_23DDC5A3E0D509D3::_id_D012729EAC1E7053() )
    {
        ...
        _id_481B7172FB4EC991::_id_05E44C9968544264( 0, [ "Wander", "EscapeGas" ] );
...
_id_7CAE93055DAE77EC()
{
    if ( _id_23DDC5A3E0D509D3::_id_D012729EAC1E7053() )
    {
        ...
        _id_481B7172FB4EC991::_id_05E44C9968544264( 1 );
...
_id_395064CE6C6B6619()
{
    ...
    while ( !_id_1E4A61DB11011446::_id_72CE5F47DA0F5661() )
    {
        ...
        point = _id_23DDC5A3E0D509D3::_id_0F7D87293D8DDA36();

        if ( isdefined( point ) )
            _id_C4B11F08034979A4 = _id_23DDC5A3E0D509D3::_id_E3B7C7A52E05AC10( point );
        ...
        {
            success = _id_1EB2430B08B932A2::_id_0D3638CF9A2DA76A( "dormant recycle to ui bot" );
...
{
    if ( _id_4AC3ACC613E8BC24::_id_0296623D26E11725() )
        return 0;
