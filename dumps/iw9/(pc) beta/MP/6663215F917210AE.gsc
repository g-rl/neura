        ...
        if ( _id_4A021F1EDE7E0C69 )
        {
            foreach ( struct in self.touchlist[team] )
            {
                if ( self._id_AE9B09D28693B763 != level._id_DA41C55843E26237 )
                {
                    ...
                    if ( isdefined( player.pers["objective_tiers_contributed"] ) )
                        player scripts\mp\utility\stats::incpersstat( "objective_tiers_contributed", 1 );
                }
            }
            ...
            if ( self._id_AE9B09D28693B763 != level._id_DA41C55843E26237 )
            {
                _id_19A7B065E8F6E759 = 2;

                if ( self.objectivekey == "_a" )
                    _id_19A7B065E8F6E759 = 1;
            }
