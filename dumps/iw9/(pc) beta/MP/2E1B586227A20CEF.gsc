...
{
    _id_164740B6CEA745E1 = scripts\cp_mp\vehicles\vehicle::_id_AD78B75541987FCC( vehicle scripts\cp_mp\vehicles\vehicle::_id_D93EC4635290FEBD() );

    if ( isdefined( _id_164740B6CEA745E1 ) )
    {
        _id_0534056C7A3B8C64 = player getplayerdata( level.loadoutsgroup, "customizationSetup", "vehicleCustomization", _id_164740B6CEA745E1, "tracks", _id_109EBF347B2F2ECE );
