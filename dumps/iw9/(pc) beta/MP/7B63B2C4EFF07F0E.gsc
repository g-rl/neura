...
{
    _id_3B64EB40368C1450::_id_2D6E7E0B80767910( "gunshipIntro", [ "usability", "killstreaks", "supers", "gesture", "fire", "weapon_switch", "allow_movement", "offhand_weapons", "shellshock" ] );
...
gunship_playintro( player, streakinfo, angle, _id_DE9C77C124D1FFAB, _id_2136B63785EE0579 )
{
    ...
    if ( level._id_FAF1ABA229E3E2A9 == 1 )
    {
        ...
        if ( !_id_C8823E8C933EF356 )
        {
            ...
            _id_744FF9937DEC4EA7 thread gunship_playdofintroeffects( _id_258B660F7DB9ABA6, player );
        }
    ...
    {
        _id_C458EDAC96D58B16 = player.origin + anglestoforward( player.angles ) * 100 + ( 0, 0, 20000 );
...
gunship_playdofintroeffects( animlength, owner, introsequence )
{
    self endon( "death" );
    owner endon( "disconnect" );
    ...
    if ( isdefined( introsequence ) )
    {
        if ( introsequence == "intro_gunship_exterior" )
        {
            ...
            _id_F2C9960FABE10533 = animlength * 0.4;
            wait( _id_F2C9960FABE10533 );
            owner setphysicaldepthoffield( 2.2, 87, 50, 50 );
            wait( _id_F2C9960FABE10533 );
            owner setphysicaldepthoffield( 4.0, 350, 1, 1 );
        }
        else if ( introsequence == "intro" )
        {
            owner setphysicaldepthoffield( 1.4, 21, 1000, 1000 );
            _id_31D8A5FD4175DCF4 = animlength * 0.8;
            wait( _id_31D8A5FD4175DCF4 );
            owner setphysicaldepthoffield( 1.4, 43, 50, 50 );
        }
        else
        {
            ...
            wait( _id_31D8A5FD4175DCF4 );
            owner setphysicaldepthoffield( 1.4, 500, 50, 50 );
        }
    }
}
...
gunship_spawn( owner, streakinfo, angle, _id_DE9C77C124D1FFAB, _id_744FF9937DEC4EA7, _id_2136B63785EE0579 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "createObjective" ) )
        minimapid = gunship [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "createObjective" ) ]]( "hud_icon_minimap_killstreak_gunship", gunship.team, 1, 1, 1 );
...
gunship_watchchangeweapons( gunner )
{
    ...
    if ( !isai( gunner ) )
    {
        gunner notifyonplayercommand( "gunship_switch_weapon", "+weapnext" );
        gunner notifyonplayercommand( "gunship_switch_weapon", "+weapprev" );
    ...
    for (;;)
    {
        gunner waittill( "gunship_switch_weapon" );
...
gunship_movetocrashpos()
{
    ...
    self.leftwingfxent setscriptablepartstate( "engine_blowout", "on" );
    self.rightwingfxent setscriptablepartstate( "engine_blowout", "on" );
    self.owner scripts\cp_mp\utility\killstreak_utility::playkillstreakoperatordialog( "gunship", "gunship_crash", 1, undefined, "pilot" );
    self.owner scripts\cp_mp\utility\killstreak_utility::playkillstreakoperatordialog( "gunship", "gunship_crash", 1, undefined, "nav" );
    self.owner scripts\cp_mp\utility\killstreak_utility::playkillstreakoperatordialog( "gunship", "gunship_crash", 1, undefined );
    self unlink();
    ...
    thread gunship_crashexplosionradiostatic( _id_F7380E0BA9C6762F );
...
{
    level endon( "game_ended" );
    _id_849B0D6D79487D19 = _id_74B5B12BB6514385 - 3;
    scripts\cp_mp\hostmigration::hostmigration_waitlongdurationwithpause( _id_849B0D6D79487D19 );
    scripts\cp_mp\utility\killstreak_utility::_id_5A9772411551E56E( "gunship" );
}
...
_id_FA9987DE43A6169B( _id_744FF9937DEC4EA7, _id_927B3199642B75FC )
{
    ...
    if ( isdefined( _id_744FF9937DEC4EA7 ) && isdefined( _id_927B3199642B75FC ) )
    {
        ...
        if ( _id_927B3199642B75FC == "intro_gunship_exterior" )
        {
            ...
            _id_D0B97BE6DC1A3EBA thread gunship_playdofintroeffects( _id_258B660F7DB9ABA6, self, _id_927B3199642B75FC );
                ...
                foreach ( modelindex, _id_B2A3F9ABCEE9D071 in _id_744FF9937DEC4EA7._id_5CB1F0F95E16878E )
                {
                    if ( isdefined( _id_B2A3F9ABCEE9D071 ) )
                    {
                        ...
                        if ( !_id_C8823E8C933EF356 && modelindex == "gunner" )
                        {
                            ...
                            _id_B2A3F9ABCEE9D071 thread gunship_playdofintroeffects( _id_9ADC9E34BC4E0C77, self, _id_927B3199642B75FC );
                        }
                    }
                }
