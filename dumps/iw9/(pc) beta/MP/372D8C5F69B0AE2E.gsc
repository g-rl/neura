...
precache()
{
    ...
    if ( scripts\common\utility::issp() )
        scripts\engine\sp\utility::add_hint_string( "scripted_melee_takedown", &"SCRIPTED_MELEE/TAKEDOWN", ::_id_0EC9009FA379356C );
...
{
    if ( _id_E3108E412AFB3811 && !self isscriptedmeleeactive() )
    {
...
_id_56E9E1D5FDD332D8( victim, direction )
{
    ...
    if ( _id_5ABF35EBA9E29A41.size > 0 )
    {
        ...
        _id_FABF3A6FDD01A7B2 = scripts\engine\utility::array_randomize( _id_FABF3A6FDD01A7B2 );
...
_id_497214B31D3BC138( attacker, _id_56E57B64F9AC67C4 )
{
    ...
    _id_2FE1D1A5E6E2B591 = _id_2FE1D1A5E6E2B591( _id_56E57B64F9AC67C4 );
    ...
    _id_FB8F407964E90B58 = _id_C52BBCAF5686CFE1( _id_56E57B64F9AC67C4 );
    _id_B728A0A492AFF957 = _id_9A787E5F1371B0CC( _id_56E57B64F9AC67C4 );
    _id_587D102C235C401A = _id_9232CBCAAF33D60F( _id_56E57B64F9AC67C4 );
    ...
    if ( isdefined( self ) || isalive( self ) )
    {
        ...
        waitframe();
        _id_122D342799919CAF = _id_B9063E2BAEB9F696( _id_56E57B64F9AC67C4 );
        ...
        _id_F5C48C59E172E0CB = _id_2D06346EAD46F1BC( _id_56E57B64F9AC67C4 );
...
{
    rules = [ ::_id_BA9CF1DCE2684E06, ::_id_F2042B6B16526371, ::_id_F9BE8D51B4D903A7, ::_id_8AFEADEA083EAB3B, ::_id_1905DF1811CA29EC, ::_id_1B73B9DDA428E8EC, ::_id_A99C9E98B8C36ED0, ::_id_D3C20C23028BA3EA, ::_id_7383BAAF0F1F2A19, ::_id_1213C4AF15671C7B, ::_id_3F33052FAF524462 ];
    return rules;
}
...
_id_0DC5BFB7CE71C284( player, victim )
{
    ...
    foreach ( weapon in weapons )
    {
        if ( isdefined( weapon.classname ) && weapon.classname == "pistol" && issubstr( weapon.basename, "_pi_" ) && _id_8205EEF398B56D03( weapon ) )
        {
...
_id_C52BBCAF5686CFE1( _id_56E57B64F9AC67C4 )
{
...
_id_9A787E5F1371B0CC( _id_56E57B64F9AC67C4 )
{
    if ( isdefined( level._id_74A171505D979CBC._id_5E0A4F882198A116 ) )
    {
        foreach ( key in getarraykeys( level._id_74A171505D979CBC._id_5E0A4F882198A116 ) )
...
_id_9232CBCAAF33D60F( _id_56E57B64F9AC67C4 )
{
    if ( isdefined( level._id_74A171505D979CBC._id_5E0A4F882198A116 ) )
    {
        foreach ( key in getarraykeys( level._id_74A171505D979CBC._id_5E0A4F882198A116 ) )
...
_id_B9063E2BAEB9F696( _id_56E57B64F9AC67C4 )
{
    if ( isdefined( level._id_74A171505D979CBC._id_5E0A4F882198A116 ) )
    {
        foreach ( key in getarraykeys( level._id_74A171505D979CBC._id_5E0A4F882198A116 ) )
...
_id_2D06346EAD46F1BC( _id_56E57B64F9AC67C4 )
{
    if ( isdefined( level._id_74A171505D979CBC._id_5E0A4F882198A116 ) )
    {
        foreach ( key in getarraykeys( level._id_74A171505D979CBC._id_5E0A4F882198A116 ) )
...
_id_2FE1D1A5E6E2B591( _id_56E57B64F9AC67C4 )
{
    if ( isdefined( level._id_74A171505D979CBC._id_5E0A4F882198A116 ) )
    {
        foreach ( key in getarraykeys( level._id_74A171505D979CBC._id_5E0A4F882198A116 ) )
