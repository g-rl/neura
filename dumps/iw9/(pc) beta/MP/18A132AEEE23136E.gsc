...
checkforafk()
{
    ...
    timeplayed = int( max( timeplayed - self.timeplayed["timeDead"], 0 ) );
    ...
    _id_1AA1F0FB85AA2F76 = self.pers["downs"];
    _id_80A323CFC33BD9E2 = kills == 0 && assists == 0 && ( !isdefined( _id_1AA1F0FB85AA2F76 ) || isdefined( _id_1AA1F0FB85AA2F76 ) && _id_1AA1F0FB85AA2F76 == 0 );
    _id_7BBF1788273C3885 = isdefined( self.lastdamagetime ) && self.lastdamagetime + 60000 < gettime();
    _id_A43EC6B633EF93CD = timeplayed - _id_61C36317DFBAFB1F;
    _id_A43EC6B633EF93CD = _id_A43EC6B633EF93CD - self.pers["afkResetTime"];
    _id_9D2ECE84BD70F3F7 = 60;

    if ( scripts\mp\utility\game::getgametype() == "arena" )
        _id_9D2ECE84BD70F3F7 = 15;

    if ( scripts\cp_mp\utility\game_utility::_id_0BEFF479639E6508() && istrue( self.brkickedfromplane ) )
    {
        self.brkickedfromplane = undefined;
        _id_9D2ECE84BD70F3F7 = 30;
    }
...
setjuggernautmodel()
{
    bodymodelname = "body_opforce_juggernaut_mp_lod1";
    headmodelname = "head_opforce_juggernaut";
    _id_41BD2EEDA1C033D2 = "viewhands_opforce_juggernaut";
    self setcustomization( bodymodelname, headmodelname );
    setcharactermodels( bodymodelname, headmodelname, _id_41BD2EEDA1C033D2 );
}
