...
_id_36F1BD0F5D72054A()
{
    ...
    level thread _id_2C5F56B2625FDA9D();
    level thread _id_D12DDEB7AB58B058();
...
_id_D12DDEB7AB58B058()
{
    ...
    if ( getdvarint( "dvar_A4617FB891CA21CB", 0 ) == 1 )
        _id_0FA41506CCE024E8 = "dmz_squadExfilPoint_GL";
    else if ( level._id_68CDDDBBE057395D == 1 )
    ...
    foreach ( node in scripts\engine\utility::getstructarray( _id_0FA41506CCE024E8, "script_noteworthy" ) )
    {
        ...
        else
        {
            ...
            _id_3064FA24DBBD5BBF.origin = ( 0, 0, -10 ) + scripts\engine\utility::ter_op( _id_56EA112138F55047 == 1, scripts\engine\utility::drop_to_ground( getclosestpointonnavmesh( node.origin ) ), node.origin );
...
_id_A3F113DC69814771()
{
    ...
    timer = ( level._id_06FC3398B5A13400 - gettime() ) / 1000;
...
_id_309C0A11484CC0DB( players )
{
    _id_4480C6CE37B2BDF3::_id_D701BEC10A449F2B( players );

    foreach ( player in players )
        player thread _id_AC298C756F30AEA6();
}

_id_AC298C756F30AEA6()
{
    level endon( "game_ended" );
    ...
    if ( isdefined( self ) )
    {
        ...
        _id_6FC415FF6A905DC1::_id_5332E1C0F06B0245();
...
_id_9A7567A2D46B857A()
{
    ...
    if ( level._id_858DBA9DA8DC5419 != 0 )
    {
        ...
        else
        {
            ...
            _id_449A83B6455A0F37 = scripts\engine\utility::getstructarray( "dmz_hostage_exfil", "script_noteworthy" );
            ...
            foreach ( exfil in _id_449A83B6455A0F37 )
            {
            ...
            _id_DEE7A3B516180A52 = getdvarint( "dvar_F24F686449931240", 4 );
            ...
            {
                for ( _id_AC0E5C4AC96AAA41 = _id_9A6BA9F5A0E705C7; _id_AC0E5C4AC96AAA41 < _id_F5AA0AAC262FBF0B.size; _id_AC0E5C4AC96AAA41++ )
                {
                    point = _id_F5AA0AAC262FBF0B[_id_AC0E5C4AC96AAA41];
                    ...
                    _id_9A6BA9F5A0E705C7 = _id_AC0E5C4AC96AAA41 + 1;
                    break;
                }
            }
...
_id_D92380BFC792A6A9()
{
    ...
    for (;;)
    {
        if ( getdvarint( "dvar_4401F5AC115ADED5", 0 ) == 1 )
        {
            setdvar( "dvar_4401F5AC115ADED5", 0 );
...
_id_5BC15F36914E63C7( ent, part, state, player, waittime, _id_292D5D91FB6427FF, _id_27144879B0C7BEED )
{
    ...
    _id_309C0A11484CC0DB( heli._id_9AB1B62A59F15DE7 );
    wait 15;
...
_id_F17FFD5A114ACA37()
{
    ...
    {
        foreach ( ent in self.pilot.linkedents )
            ent delete();
...
_id_D99E1EB9CCB97BFF( ent, endpos )
{
    ...
    if ( isdefined( level._id_82A4581D137DDED4[ent getentitynumber()] ) )
    ...
    startstruct.origin = endpos + ( 0, 0, 600 );
    ...
    _id_9E4E5282CB41521F = _id_1BE7A96CD1B1329F( startstruct.origin + _id_D30D83160ADFA539 * 100 + ( 0, 0, level._id_BBF4A84349D0FDEB ), startstruct, startstruct.targetname, 10, 1, exitangles );
...
_id_3C841844A3299BFF( ent, endpos )
{
    ...
    _id_9E4E5482CB415685 = _id_1BE7A96CD1B1329F( _id_9F481255F2C41D46 - ( 0, 0, 300 ), _id_9E4E5382CB415452, startstruct.targetname, 10, 3, exitangles );
    _id_9E4E4D82CB414720 = _id_1BE7A96CD1B1329F( _id_B9FC106959C06C4F, _id_9E4E5482CB415685, startstruct.targetname, 10, 4 );
...
_id_BA916FD4711C53E2( owner, pos, angles, _id_292D5D91FB6427FF )
{
    ...
    heli thread _id_53AAC5AE7D2AC1B4::_id_C31B39E6BB1BCD42();
