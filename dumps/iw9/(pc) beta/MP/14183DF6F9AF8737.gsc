...
_id_277C5D414A129608( _id_642470E1ABC1BBF9 )
{
    ...
    _id_642470E1ABC1BBF9.attacker thread _id_B365BFDB0A040336( _id_642470E1ABC1BBF9.attacker.team, _id_642470E1ABC1BBF9.victim );
}
...
_id_B365BFDB0A040336( team, _id_3E59C6682B60D27E )
{
    level endon( "game_ended" );
...
_id_EB172B91A9FDF684()
{
    ...
    if ( player _id_67708F418B1FAC79::_id_4A25D64251FAB1B7() )
    {
        ...
        _id_0A34750D17473C49::unmarkplayeraseliminated( player, "resurgence1" );
...
_id_7CB9398C136B6A50( _id_CB5BA4C3282C39C1, _id_54EBFC906D9A55E7 )
{
    ...
    _id_0A34750D17473C49::unmarkplayeraseliminated( player, "resurgence2" );
