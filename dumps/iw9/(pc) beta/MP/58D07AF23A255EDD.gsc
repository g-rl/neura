...
_id_BE0C3A067DA1E72D( equipment )
{
    ...
    {
        index = scripts\mp\utility\killstreak::getkillstreakindex( equipment.streakinfo.streakname );
        index = index + 100;
    }
...
{
    scripts\mp\utility\player::_freezelookcontrols( _id_DA3010AF8F6BE463 );
