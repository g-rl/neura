...
_id_675AFF24F4E37138()
{
    ...
    {
        _id_3B8219D206004DFA = _id_287623BBB15154BE();
...
_id_93B1902DC83D81D2( einflictor, attacker, idamage, smeansofdeath, objweapon, vdir, shitloc, psoffsettime, deathanimduration, _id_61B5D0250B328F00 )
{
    if ( isdefined( attacker ) && isplayer( attacker ) && attacker != self && attacker.team != self.team )
    {
        ...
        foreach ( zone in level.objectives )
        {
            ...
            if ( isattacker )
            {
                if ( _id_229449CFD54FDC5B )
                    attacker scripts\mp\codcasterclientmatchdata::_id_D16498B27251DA56( 11, 1 );
        ...
        if ( isattacker )
            attacker scripts\mp\codcasterclientmatchdata::_id_D16498B27251DA56( 10, 1 );
        else
            attacker scripts\mp\codcasterclientmatchdata::_id_D16498B27251DA56( 9, 1 );
...
_id_90EE8E359D6D3323( team, _id_4B22E50E504339FE, _id_1F7FD473E2E3E8AA )
{
    ...
    _id_4B22E50E504339FE scripts\mp\codcasterclientmatchdata::_id_D16498B27251DA56( 8, 1 );
