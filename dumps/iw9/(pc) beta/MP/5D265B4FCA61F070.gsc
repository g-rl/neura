...
_id_5510C489D7F09128( _id_79D89AFD147F1EB1, _id_8BA39402D5530250 )
{
    ...
    _id_93FA9B11F85EC1A9 notify( "dialogue_done" );
...
_id_C616A96AFE9E57BC( _id_7D2852D02216C876, alias, priority, timeout, _id_F6E387B9F5A2B39C, delay, scope )
{
    ...
    if ( !istrue( cancelled ) && !scripts\engine\utility::is_dead_or_dying( _id_7D2852D02216C876 ) && !istrue( _id_7D2852D02216C876._id_88E1B2F9582E6283 ) )
    {
        ...
        if ( isdefined( cancelled ) && !cancelled )
            self._id_6170366B0D0ED9EA = _id_7D2852D02216C876 _id_7B52F05DA542C2FF( alias, _id_F6E387B9F5A2B39C, _id_9A4096E3A9B92412[scope] );
...
_id_9A5AD53E35891FD4()
{
    ...
    if ( istrue( self._id_0F5E6316C2383F5F ) && isdefined( self._id_0D33B713A010187C ) )
        self thread [[ self._id_0D33B713A010187C ]]();

    if ( !istrue( self._id_0F5E6316C2383F5F ) && isdefined( self._id_7731E4E561FE4D38 ) )
    {
...
_id_2F5F29DA6F0F73E6()
{
    ...
    foreach ( _id_AC1CDDFBB55B0E81 in self._id_BA7E8AD2868EF874 )
    {
        self._id_7D2852D02216C876 endon( _id_AC1CDDFBB55B0E81 );
...
_id_0F2A79001721945A( _id_5564A66C3EC1C07B, timeout, _id_BA7E8AD2868EF874 )
{
    ...
    if ( !_id_5564A66C3EC1C07B _id_6CF6A58C99522E20( self._id_261AAF24A09D231D ) || isdefined( timeout ) )
    {
...
_id_F983CE9B3755F759( timeout, _id_BA7E8AD2868EF874 )
{
    ...
    if ( isdefined( _id_BA7E8AD2868EF874 ) )
    {
        ...
        foreach ( _id_AC1CDDFBB55B0E81 in _id_BA7E8AD2868EF874 )
        {
...
_id_E7C1C9DEE13137AA( alias, _id_5C1322185369EFCD )
{
    ...
    if ( isdefined( _id_5C1322185369EFCD ) )
        thread _id_804E00E53AC0C7DF( alias, _id_5C1322185369EFCD );

    if ( istrue( self._id_ED56B39B72558E56 ) )
    {
        _id_A5A643290A902DE7 = get_radio_alias( alias );

        if ( soundexists( _id_A5A643290A902DE7 ) )
            alias = _id_A5A643290A902DE7;
    }

    self [[ level._id_9A62261B5B534B06 ]]( alias );
    return 1;
}

_id_804E00E53AC0C7DF( alias, _id_5C1322185369EFCD )
{
    _id_A5A643290A902DE7 = get_radio_alias( alias );
    ...
    foreach ( guy in _id_5C1322185369EFCD )
    {
        if ( guy == self )
            continue;

        radio = guy _id_52846CD9B5EFEAFE();
        radio [[ level._id_9A62261B5B534B06 ]]( alias );
    }
}
...
_id_3E5D12EB11D543A2( _id_93FA9B11F85EC1A9 )
{
    ...
    if ( !isdefined( self._id_E5CF232129F9EC01 ) )
...
_id_690CCAE4E694F51E( _id_93FA9B11F85EC1A9 )
{
    ...
    self endon( "cancel_emitter_delete" );
    _id_93FA9B11F85EC1A9 endon( "entitydeleted" );

    if ( istrue( _id_93FA9B11F85EC1A9._id_87D26AB52F61FA8B ) )
    {
        waitframe();
