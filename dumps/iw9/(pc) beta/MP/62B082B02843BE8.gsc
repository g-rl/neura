...
loadout_updateclassgamemode( struct, class )
{
    ...
    {
        if ( isbot( self ) )
            struct.loadoutarchetype = "archetype_" + tolower( _id_3800B8F9E799AE2C["loadoutArchetype"] );
        else
            struct.loadoutarchetype = cac_getcharacterarchetype();
    }
    else
...
_id_2DAD855D27735128( struct )
{
    ...
    {
        if ( scripts\mp\utility\game::getsubgametype() == "dmz" || scripts\mp\utility\game::getsubgametype() == "exgm" || scripts\mp\utility\game::getsubgametype() == "plunder" || scripts\mp\utility\game::getsubgametype() == "br" || scripts\mp\utility\game::_id_BA5574C7F287C587() )
...
{
    if ( !istrue( level._id_D040719163E20394 ) && ( !isdefined( _id_EBEC497FF8B18A45 ) || _id_EBEC497FF8B18A45 == "none" ) )
...
onplayerspawned()
{
    ...
    for (;;)
    {
        ...
        player clearsoundsubmix( "player_swimming_underwater", 2.2 );
