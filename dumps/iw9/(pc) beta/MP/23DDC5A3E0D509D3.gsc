...
initialize( _id_9F4A3632D9F75D32 )
{
    ...
    level _id_4AC3ACC613E8BC24::_id_0360128EC8C9D243();
...
_id_5B2B7905D2D6B349()
{
    ...
    while ( !_id_1E4A61DB11011446::_id_72CE5F47DA0F5661() )
    {
        ...
        if ( isdefined( _id_A6121510E4825C70 ) && !isbot( _id_A6121510E4825C70 ) )
        {
            ...
            {
                _id_1EB2430B08B932A2::_id_966AB6FFD873EC11( 1, 1 );
                wait 5;
            }
        }
...
_id_64432AF189B8A177( _id_1A645E724209AC4A, _id_2BA509F4D1261BA7 )
{
    ...
    switch ( _id_1A645E724209AC4A )
    {
        case 0:
            ...
            if ( _id_42658285A14F703B::_id_B2502F3345564ABF( _id_72FDE5447014F573, height, 0 ) )
            {
                ...
                _id_42658285A14F703B::_id_89B861AA78808ED8();
            }
        ...
        case 3:
            ...
            {
                if ( !_id_1EB2430B08B932A2::_id_B2502F3345564ABF() )
                {
    ...
    if ( isdefined( _id_CC9D656EFB786A8B ) && !_id_40E63DD222434655::_id_5F352FB76C54705C() )
    {
        ...
        if ( _id_CC9D656EFB786A8B )
            return _id_1EB2430B08B932A2::_id_0D3638CF9A2DA76A( _id_C2AD339C4E95C7FE );
        else
            return _id_42658285A14F703B::_id_0D3638CF9A2DA76A( _id_C2AD339C4E95C7FE );
    }
    else
        return 0;
}
    ...
    for (;;)
    {
        ...
        if ( isdefined( player ) )
        {
            if ( isbot( player ) )
            {
                ...
                player thread _id_42658285A14F703B::_id_A955D908F57B75CF();
                continue;
            }
...
_id_BCEF157DFCF2C5F3()
{
    ...
    while ( scripts\mp\gamelogic::_id_1147BBC93EA9B83C() )
    {
        ...
        _id_1EB2430B08B932A2::_id_E81D83CFE1AB45FC( _id_9FA0DDC57B0F35B0, "Skydive" );
        wait 1;
    }
    ...
    if ( _id_E88F02AC1F526A32 < 0 )
    {
        foreach ( player in level.players )
        {
            ...
            {
                success = player _id_1EB2430B08B932A2::_id_0D3638CF9A2DA76A( "infil active bot count limit" );
        ...
        _id_1EB2430B08B932A2::_id_E81D83CFE1AB45FC( _id_E88F02AC1F526A32, "Skydive" );
}
...
_id_5CB1C8EC264FBDBD( _id_F5720CAC60CA8410 )
{
    ...
    _id_9FA0DDC57B0F35B0 = getdvarint( "dvar_E82992EEC48CF830", 20 ) - _id_4F705E7659D183F9;
...
_id_05982992426CF092( _id_99E8FCB28E160694, _id_C5452D63F815C7E9, _id_00DFC67EAAF62BC0 )
{
    foreach ( player in _id_99E8FCB28E160694 )
    {
        ...
        {
            _id_44F4FB2FDD683FFA._id_96BE2FBD0AC6A848 = 0;
            player thread _id_1EB2430B08B932A2::_id_947B37D99674B59C();
        }
    }
...
_id_70535EB0C22FEB50( _id_DC018E6C9C8DC7D4 )
{
    ...
    if ( _id_DC018E6C9C8DC7D4 )
    {
        while ( level._id_7B37B2193F163B9B._id_156F390A5362BC55.size > 0 )
        {
            ...
            {
                _id_89A675C5BDE8848F = _id_1EB2430B08B932A2::_id_32EC26AB4915F882();

                if ( !isdefined( _id_89A675C5BDE8848F ) )
                    break;

                bot = _id_89A675C5BDE8848F _id_1EB2430B08B932A2::_id_7CAE93055DAE77EC( "Combat" );
...
_id_E79F454A81696E11()
{
    ...
    while ( level._id_7B37B2193F163B9B._id_156F390A5362BC55.size > 0 )
    {
        ...
        for ( _id_AC0E594AC96AA3A8 = 0; _id_AC0E594AC96AA3A8 < count; _id_AC0E594AC96AA3A8++ )
        {
            ...
            bot = _id_89A675C5BDE8848F _id_1EB2430B08B932A2::_id_7CAE93055DAE77EC( "Combat", "DeployAllUIBotsThread" );
...
_id_494150569261C828()
{
    ...
    for (;;)
    {
        ...
        if ( _id_78C6F95A3C5B0462 != 0 )
        {
            ...
            {
                _id_629C48F843740B97 _id_42658285A14F703B::_id_7CAE93055DAE77EC();
...
_id_A0E0C0E1E94630F6()
{
    ...
    if ( _id_CB2737353AD087DA && isdefined( level.br_level ) && isdefined( level.br_level.br_circledelaytimes ) )
    {
        ...
        for ( circleindex = 0; circleindex < level.br_level.br_circledelaytimes.size; circleindex++ )
        {
            ...
            _id_E39D8E5A89E12A3E[_id_E39D8E5A89E12A3E.size] = time;
        ...
        for ( _id_CB89110314447B2F = 0; _id_CB89110314447B2F < _id_09DD5D9E57E7E36D; _id_CB89110314447B2F++ )
        {
            ...
            maxplayers = int( tablelookupbyrow( _id_00CEBA6EC7E8CA50, _id_CB89110314447B2F, 1 ) );

            if ( name == mapname && maxplayers == _id_9E93F969D16D924B )
            {
                _id_678958B6C61E482B = 1;
                circleindex = int( tablelookupbyrow( _id_00CEBA6EC7E8CA50, _id_CB89110314447B2F, 2 ) );
                starttime = int( tablelookupbyrow( _id_00CEBA6EC7E8CA50, _id_CB89110314447B2F, 3 ) );
                ...
                points[points.size] = ( _id_E39D8E5A89E12A3E[circleindex] + starttime, int( _id_37749FA4A24BFE71 * _id_9E93F969D16D924B ), int( _id_71EA6E5E5CC30C2F * _id_9E93F969D16D924B ) * 100 + threshold );
                continue;
            }
...
_id_C596173D88D8446E()
{
    ...
    for (;;)
    {
        ...
        _id_1EB2430B08B932A2::_id_966AB6FFD873EC11( 1 );
        wait( interval );
    }
}
...
_id_FB4771E79218146B( bot )
{
    ...
    {
        if ( !bot _id_1EB2430B08B932A2::_id_B2502F3345564ABF() )
            return undefined;
...
_id_6E4F25CE6AAFC2A8()
{
    ...
    result = _id_1EB2430B08B932A2::_id_0D3638CF9A2DA76A( "SurvivalCurve recycle after killed" );
