...
_id_5FF2C834CA229322()
{
    for (;;)
    {
        ...
        {
            if ( isdefined( _id_F35BC3914DD968E3 ) && _id_F35BC3914DD968E3 _id_2A503318E000E11D() )
                continue;
...
vehicle_create( vehicle, _id_7731ADEF63E19B0C, spawndata )
{
    ...
    {
        vehicle scripts\common\utility::_id_3677F2BE30FDD581( "ddos", "neutral" );
    ...
    if ( scripts\common\utility::_id_A10967D736DC56E5() && !istrue( spawndata._id_F16652E1462A3739 ) )
    {
...
_id_1CD6D75165ECBC48()
{
    ...
    if ( _func_03CB5DA19764BAA3() == "JUP" )
        return vehiclecustomization;

    foreach ( ref, data in level._id_A0B2C978CA57FFC5 )
    {
        _id_B39E09B589ADDF95 = _id_AD78B75541987FCC( ref );

        if ( !isdefined( _id_B39E09B589ADDF95 ) )
            continue;

        vehiclecustomization._id_37DF38D20E12F77D[ref] = _id_4D5B0A0260555DCD( _id_B39E09B589ADDF95 );
        vehiclecustomization._id_94B01AC7CDDDF04D[ref] = getvehicleplayerhorn( _id_B39E09B589ADDF95 );
    }

    return vehiclecustomization;
}

_id_4D5B0A0260555DCD( _id_7731ADEF63E19B0C )
{
    data = _id_29B4292C92443328( _id_7731ADEF63E19B0C );
    ...
    id = self getplayerdata( level.loadoutsgroup, "customizationSetup", "vehicleCustomization", _id_7731ADEF63E19B0C, "camo" );
    id = id - 1;
...
getvehicleplayerhorn( _id_7731ADEF63E19B0C )
{
    data = _id_29B4292C92443328( _id_7731ADEF63E19B0C );
    ...
    id = self getplayerdata( level.loadoutsgroup, "customizationSetup", "vehicleCustomization", _id_7731ADEF63E19B0C, "horn" );
...
_id_AD78B75541987FCC( _id_7731ADEF63E19B0C )
{
    for ( data = _id_29B4292C92443328( _id_7731ADEF63E19B0C ); isdefined( data ) && isdefined( data._id_CD5AB16B94BC2745 ); data = _id_29B4292C92443328( _id_7731ADEF63E19B0C ) )
