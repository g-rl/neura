...
monitor_damage_thread( _id_448A418E975E9B01, _id_6A01DAAB475B44AB )
{
    ...
    while ( isalive( self ) )
    {
        ...
        if ( isalive( self ) )
        {
            _func_AAD7A0EA8AC4CA23( "ally_damaged", self, other, _id_448A418E975E9B01, _id_6A01DAAB475B44AB );
            continue;
        }
...
_id_D83F0E5272E07D8C( event )
{
    ...
    if ( isdefined( _id_3D816D7A91186FBB ) )
        return scripts\stealth\callbacks::stealth_call( "event_" + event.type, event );
...
event_handler_translate_severity( event )
{
    ...
    switch ( event.typeorig )
    {
        case "sight":
            ...
            break;
        case "grenade danger":
            if ( isdefined( event.entity ) && scripts\engine\utility::is_equal( event.entity.model, "offhand_wm_bottle" ) )
                event.type = "cover_blown";
