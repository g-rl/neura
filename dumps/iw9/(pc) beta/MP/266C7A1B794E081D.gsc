...
bot_connect_monitor()
{
    ...
    _id_29E1CB7568F77E66 = scripts\mp\utility\game::_id_BA5574C7F287C587();
...
bot_think_seek_dropped_weapons()
{
    ...
    for (;;)
    {
        ...
        if ( scripts\mp\bots\bots_util::bot_get_low_on_all_ammo( 0.33 ) )
        {
...
bot_think_revive()
{
    ...
    {
        waittime = 2.0;
        _id_6EF961EEA0A186A4 = getentarray( "revive_trigger", "targetname" );
        ...
        for ( _id_AC0E594AC96AA3A8 = 0; _id_AC0E594AC96AA3A8 < _id_6EF961EEA0A186A4.size; _id_AC0E594AC96AA3A8++ )
        {
            _id_DA4D3A039B5722BF = _id_6EF961EEA0A186A4[_id_AC0E594AC96AA3A8];
...
player_revived_or_dead( goal )
{
    ...
    else if ( !isdefined( goal.object.owner ) || goal.object.owner.health > 0 )
        return 1;
...
revive_player( goal )
{
    ...
    if ( distancesquared( self.origin, _id_E7072356F2FBFC24 ) > 4096 )
    {
