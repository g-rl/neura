...
init()
{
    enabled = _id_3ACF1C0EBAF602F2::registerquestcategory( "domination_legacy", 1 );

    if ( !enabled )
        return;

    _id_3ACF1C0EBAF602F2::registertabletinit( "domination_legacy", ::domtablet_init );
    _id_3ACF1C0EBAF602F2::registerremovequestinstance( "domination_legacy", ::domquest_removequestinstance );
    ...
    _id_3ACF1C0EBAF602F2::questtimerinit( "domination_legacy", 1 );
    _id_3ACF1C0EBAF602F2::registerontimerexpired( "domination_legacy", ::dom_ontimerexpired );
    setupdom();
...
domtablet_init()
{
    ...
    placement = _id_3ACF1C0EBAF602F2::findquestplacement( "domination_legacy", _id_354D1457278B342C );
...
domlocale_createquestlocale( placement )
{
    ...
    locale = _id_3ACF1C0EBAF602F2::createlocaleinstance( "dom_locale", "domination_legacy", "DomPoint:" + _id_3ACF1C0EBAF602F2::getquestdata( "dom_locale" ).nextid );
...
{
    instance = _id_3ACF1C0EBAF602F2::createquestinstance( "domination_legacy", self.team, pickupent.index, pickupent );
    ...
    _id_3ACF1C0EBAF602F2::uiobjectiveshowtoteam( "domination_legacy", self.team );
    _id_3ACF1C0EBAF602F2::addquestinstance( "domination_legacy", instance );
    _id_3ACF1C0EBAF602F2::startteamcontractchallenge( "domination_legacy", self, self.team );
    params = spawnstruct();
    params.excludedplayers = [];
    params.excludedplayers[0] = self;
    params.plundervar = _id_3ACF1C0EBAF602F2::getquestplunderreward( "domination_legacy", _id_3ACF1C0EBAF602F2::getquestrewardtier( self.team ) );
    ...
    _id_3ACF1C0EBAF602F2::displaysquadmessagetoteam( instance.team, self, 6, _id_3ACF1C0EBAF602F2::getquestindex( "domination_legacy" ) );
...
domflag_onuse( _id_22282E7D48CA3400 )
{
    foreach ( instance in self.locale.subscribedinstances )
    {
        if ( instance.team == _id_22282E7D48CA3400.team )
        {
            ...
            missionid = _id_3ACF1C0EBAF602F2::getquestindex( "domination_legacy" );
            _id_11D65784F0B6AFA2 = _id_3ACF1C0EBAF602F2::getquestrewardgroupindex( _id_3ACF1C0EBAF602F2::getquestrewardbuildgroupref( "domination_legacy" ) );
