...
_id_0DF48D309A8BC55A()
{
    ...
    if ( !istrue( self.failure ) )
    {
        path = _id_653FCE06CCCB812D( self._id_23D42B1195DDA679, self._id_23D42B1195DDA679.origin );
    ...
    self.heli _id_2BC0B0102F9B7751::_id_FC805EC1E7B08264( self.heli.currentnode );
...
_id_653FCE06CCCB812D( node, endpos )
{
    if ( !isdefined( node ) )
        return undefined;

    if ( !isdefined( level._id_C0A45FF26DF686ED ) )
        level._id_C0A45FF26DF686ED = 0;

    _id_2F58E7950B321302 = _id_0662CA8C888B5EB6( node, level._id_BBF4A84349D0FDEB, 1 );
    _id_D30D83160ADFA539 = _id_2F58E7950B321302 - node.origin;
    ...
    startstruct.angles = node.angles;
    startstruct.radius = 500;
    startstruct.speed = 10;
    startstruct.targetname = "hostage_exfil" + level._id_C0A45FF26DF686ED;
    startstruct.script_land = "1";
    level._id_C0A45FF26DF686ED++;
    _id_9E4E5282CB41521F = _id_3C3CB730537D64B5( startstruct.origin + _id_D30D83160ADFA539 * 100 + ( 0, 0, level._id_BBF4A84349D0FDEB ), startstruct, startstruct.targetname, 20, 1 );
    _id_9E4E5382CB415452 = _id_3C3CB730537D64B5( _id_9E4E5282CB41521F.origin + _id_D30D83160ADFA539 * 5000, _id_9E4E5282CB41521F, startstruct.targetname, 20, 2 );
    _id_9E4E5482CB415685 = _id_3C3CB730537D64B5( _id_9E4E5282CB41521F.origin + _id_D30D83160ADFA539 * 10000, _id_9E4E5382CB415452, startstruct.targetname, 85, 3 );
...
_id_3C3CB730537D64B5( pos, _id_C013CFD919A1A62D, _id_A95CF9509CE0D814, speed, num )
{
    struct = spawnstruct();
    struct.speed = speed;
    struct.origin = pos;
    struct.angles = _id_C013CFD919A1A62D.angles;
    struct.radius = 500;
    struct.targetname = "build_path_struct_" + _id_A95CF9509CE0D814 + num;
