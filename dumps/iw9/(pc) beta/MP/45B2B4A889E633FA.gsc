...
spawnc130( planemodel, _id_954A35001716E7CB, pathstruct, _id_58BB50874E340160 )
{
    dist = distance( pathstruct.startpt, pathstruct.endpt );
    time = dist / getc130speed();
    _id_8F56F6C6C54E17D9 = 1;
    level.br_ac130 = gunship_spawn( planemodel, _id_954A35001716E7CB, pathstruct.startpt, pathstruct.endpt, time, _id_8F56F6C6C54E17D9, _id_58BB50874E340160 );
...
parachute( c130, _id_1B89121EF11344D5, _id_E7EDB50A3E562402, _id_1BDAFC6465CF7E27 )
{
    ...
    thread scripts\cp_mp\parachute::startfreefall( 2.0, _id_1B89121EF11344D5, undefined, velocity );
}
...
infilfreefallparachuteaudio( c130 )
{
    ...
    if ( isdefined( c130 ) )
        c130 playsoundtoplayer( "br_ac130_flyby", player );

    if ( !istrue( level.isx1ops ) )
    {
        player setsoundsubmix( "mp_br_infil_music", 0.0 );
        _id_C92EC451B97310EF = game["music"]["br_plane_jump"].size;
        _id_7399C6A32B3F0EEF = randomint( _id_C92EC451B97310EF );
        player setplayermusicstate( game["music"]["br_plane_jump"][_id_7399C6A32B3F0EEF] );
        player.jump_music = 1;
    }
