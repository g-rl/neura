...
_id_753DBB93CBAA8966( _id_EFA8EF05B190D7D0, node )
{
    ...
    destinations = scripts\engine\utility::array_randomize( scripts\engine\utility::get_array_of_closest( _id_B8EBE3F71A08AB40.node.origin, level._id_8D5EA37EAFA7B186, undefined, undefined, 60000, 30000 ) );
...
{
    _id_B1673F16AB572566 = scripts\cp_mp\vehicles\vehicle::vehicle_spawn( "veh9_jltv_mg", node );
    payload = spawn( "script_model", _id_B1673F16AB572566.origin + ( 0, 0, 37 ) + anglestoforward( _id_B1673F16AB572566.angles ) * -84 );
    payload.angles = _id_B1673F16AB572566.angles;
    payload setmodel( "cargo_pallet_02_dmz_script" );
    payload linkto( _id_B1673F16AB572566 );
    _id_B1673F16AB572566.payload = payload;
    thread _id_CF8F787850F621F9( _id_B1673F16AB572566 );
    return _id_B1673F16AB572566;
}
