...
_id_04AAECA4295A600D( _id_1672C24528714D7D, _id_3B96D5666000C2E0, targetplayer, _id_E80F1EB2C1910AD4, _id_72CE9FA792FD31A1 )
{
...
_id_452C678D0120E4B4( player, _id_99BCF6BDF31A0E49 )
{
    ...
    {
        if ( targetplayer == player || targetplayer.team == player.team || !isplayer( targetplayer ) )
            continue;
        ...
        if ( !_id_04AAECA4295A600D( _id_1672C24528714D7D, _id_3B96D5666000C2E0, targetplayer, player, 1 ) )
            continue;
...
{
    _id_1672C24528714D7D = scripts\engine\utility::ter_op( istrue( player._id_4F8AFA3693E318D4 ), player.team, player._id_7F1423DF13BBB144.team );
    _id_43B043539F9C3CCF = scripts\engine\utility::ter_op( istrue( player._id_4F8AFA3693E318D4 ), player._id_0FF97225579DE16A, player._id_7F1423DF13BBB144._id_0FF97225579DE16A );
    _id_3B96D5666000C2E0 = scripts\engine\utility::ter_op( istrue( player._id_4F8AFA3693E318D4 ), player._id_7F1423DF13BBB144, player );

    if ( !_id_04AAECA4295A600D( _id_1672C24528714D7D, _id_3B96D5666000C2E0, player, player, 0 ) )
    {
    ...
    if ( _id_E3F7965361B1E757 )
    {
        ...
        _id_EB06B338608EF354 = _id_1672C24528714D7D;
        ...
        _id_3B96D5666000C2E0 thread scripts\mp\menus::addtoteam( _id_EB06B338608EF354, undefined, 1, 1 );
