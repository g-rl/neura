...
createfx()
{
    ...
    level.callbackplayeractive = scripts\engine\utility::void;
    ...
    level._id_42D9B617BBCA6A42 = scripts\engine\utility::void;
    level._id_935C97AA3757676F = scripts\engine\utility::void;
    level._id_CDA3AF1F73639C7C = scripts\engine\utility::void;
...
func_player_speed()
{
    ...
    setdvar( "dvar_11A6AAF18B50047B", level._createfx.player_speed );
}
