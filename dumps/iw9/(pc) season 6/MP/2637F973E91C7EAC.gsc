...
main()
{
    ...
    _id_9BBACB179DEA3237[0] = "conflict";
    ...
    level.getspawnpoint = ::_id_734D93E783570C3F;
    ...
    level._id_A98A9986264D0EFC = getdvarint( "dvar_B9C73F803A8467B1", 1 ) == 1;
    level.nukeselectactive = getdvarint( "dvar_5631915771C67329", 0 );
    level.killstoearnnukeselect = getdvarint( "dvar_44C9606DBF2BEB39", 7 );
    level.useobjectives = getdvarint( "dvar_07AFCAC366FA1DB1", 1 );
    level.userallypointvehicles = getdvarint( "dvar_1EBE3A2CB76A7469", 1 );
    level.hideenemyfobs = getdvarint( "dvar_CA5B2794617FEA12", 0 );
    level.completelyremovelittlebird = getdvarint( "dvar_0638544A176EF2E5", 0 );
    level.usec130spawn = getdvarint( "dvar_613F929CA3964C26", 0 );
    level.usec130spawnfirstonly = getdvarint( "dvar_159313A1389D1308", 0 );
    level.c130movementmethod = getdvarint( "dvar_9FB9E86B53963C38", 0 );
    level.c130flightdist = getdvarfloat( "dvar_FEF70CA9FF57630B", 4000 );
    level.c130distapart = getdvarfloat( "dvar_86C93EFA7364ED85", 5000 );
    level.c130alignedtolocale = getdvarfloat( "dvar_C586DA82C1082054", 1 );
    level._id_67A7732487FB9242 = getdvarint( "dvar_CAFBF2AAD85B6754", 1 ) == 1;
    level._id_90F4DC933B674184 = getdvarfloat( "dvar_FAAB1365416666E2", 60.0 );
    level._id_1A505675F3EF1197 = getdvarfloat( "dvar_6C809B64D624F435", 60.0 );
    level._id_8E9DABA162280A8E = getdvarint( "dvar_8305142A28C815EA", 0 ) == 1;
    level._id_EAA760F325371803 = getdvarint( "dvar_0A4382CFFFE7E47D", 0 ) == 1;
    level._id_7F5BE0207E7457B1 = getdvarint( "dvar_FEEF11F562A08503", 1 ) == 1;
    level._id_A6954A050D77D75C = getdvarint( "dvar_7194076AB4888F2B", 0 ) == 1 || getdvarint( "dvar_CD0AFDAD9EFC3953", 0 ) == 1;
    ...
    level.dropbrloot = getdvarint( "dvar_A7116E1E9E66B991", 0 );
    ...
    level._id_1E17E3480B1D264D = getdvarint( "dvar_2E98493F1EB2E7BB", 0 );
    level._id_1F42DAB41EFF5CB2 = getdvarint( "dvar_C0F6AE1586ADCC39", 0 );
    ...
    level.forcetopickafob = getdvarint( "dvar_12BD776EF64DC824", 0 );
    level.maxhqtanks = getdvarint( "dvar_1861929D5A838530", 2 );
    level.tankrespawntime = getdvarint( "dvar_03A650FB0CABA4D3", 120 );
    level.apcrespawntime = getdvarint( "dvar_E0FDDA13119EB76D", 120 );
    level.longdialoguecooldown = getdvarint( "dvar_C78509BEE793FB7B", 1 );
    level.mercymatchending_nuke = getdvarint( "dvar_7B339BD52EBE7F54", 1 );
    level.mercymatchending_time = getdvarint( "dvar_DE55296ED1CB18C8", 30 );
    level.numnonrallyvehicles = getdvarint( "dvar_FE211D43E809726A", 25 );
    level.disablepersonalnuke = getdvarint( "dvar_988F3C3A677F656F", 0 );
    level.personalnukecostoverride = getdvarint( "dvar_D9455F252FCCDB97", 30 );
    level.showteamtanks = getdvarint( "dvar_36639BC6E8032BC7", 1 );
    level.spawnselectionafktime = getdvarint( "dvar_E423C2996AE99972", 120 );
    level.manualadjustlittlebirdlocs = getdvarint( "dvar_403C015A374896C3", 1 );
    level._id_B307135DBCEF5A38 = getdvarint( "dvar_A350A6776C8513FE", 1 );
    ...
    if ( getdvarint( "dvar_F4855FF1931AA576", 1 ) )
    {
    ...
    if ( getdvarint( "dvar_73771045902918B8", 0 ) == 1 )
    ...
    _id_26508F2DE04C7A52::_id_DA8AF86F82F90504();
}

initializematchrules()
{
    scripts\mp\utility\game::setcommonrulesfrommatchrulesdata();
    setdynamicdvar( "dvar_F605D3028D2AFACF", getmatchrulesdata( "kothData", "zoneLifetime" ) );
    setdynamicdvar( "dvar_A4F106B3AB04F3B7", getmatchrulesdata( "kothData", "zoneCaptureTime" ) );
    setdynamicdvar( "dvar_B9D3066236F55CA3", getmatchrulesdata( "kothData", "zoneActivationDelay" ) );
    setdynamicdvar( "dvar_A7DDE3293346D086", getmatchrulesdata( "kothData", "randomLocationOrder" ) );
    setdynamicdvar( "dvar_6D4DC6B64349915B", getmatchrulesdata( "kothData", "additiveScoring" ) );
    setdynamicdvar( "dvar_3E620780DD3AD255", getmatchrulesdata( "kothData", "pauseTime" ) );
    setdynamicdvar( "dvar_E6CC8722A1FF59BC", getmatchrulesdata( "tdefData", "spawnDelay" ) );
...
onstartgametype()
{
    ...
    if ( level.br_plunder_enabled && getdvarint( "dvar_624CE1CEAE091263", 1 ) == 1 )
        level thread _id_1D4B01C1EC829364::_id_5A1699B27399A21E();

    if ( getdvarint( "dvar_C53237842F9C4EB8", 0 ) == 1 )
...
updategametypedvars()
{
    ...
    level._id_529F98217BAEA818 = scripts\mp\utility\dvars::dvarintvalue( "scoresPerFob", 100, 1, 500 );
}
...
_id_FDC846BD9557D48B()
{
    ...
    level._id_9E18EE9388EBE0B5 = scripts\engine\utility::array_combine( level.startingfobnames_allies, level.startingfobnames_axis, level.startingfobnames_neutral );
    level._id_A5CE88CE789C9A3E = [];
...
setupobjectives()
{
    ...
    foreach ( _id_D83E5FA8F6CE891F in level.startingfobnames_allies )
        level.gw_objstruct.startingfobs_allies[level.gw_objstruct.startingfobs_allies.size] = _id_F329994B054F4554( _id_D83E5FA8F6CE891F );

    foreach ( _id_D83E5FA8F6CE891F in level.startingfobnames_axis )
        level.gw_objstruct.startingfobs_axis[level.gw_objstruct.startingfobs_axis.size] = _id_F329994B054F4554( _id_D83E5FA8F6CE891F );
    ...
    foreach ( _id_D83E5FA8F6CE891F in level.startingfobnames_neutral )
    {
        ...
        if ( isdefined( trigger ) )
            level.gw_objstruct.startingfobs_neutral[level.gw_objstruct.startingfobs_neutral.size] = _id_F329994B054F4554( _id_D83E5FA8F6CE891F );
    }

    setomnvar( "ui_num_dom_flags", level.gw_objstruct.startingfobs_neutral.size );
}

_id_F329994B054F4554( _id_D83E5FA8F6CE891F )
{
    ...
    _id_1F2F362E189BF9C0 = _id_01802A784BB4C25D( _id_D83E5FA8F6CE891F );
    fob.trigger.objkey = _id_F6DDBB71B889A0BE[_id_1F2F362E189BF9C0];
    return fob;
}

_id_01802A784BB4C25D( _id_D83E5FA8F6CE891F )
{
    return int( _func_95C6391212A25F7C( _id_D83E5FA8F6CE891F, "gw_fob_" ) ) - 1;
}
...
runobjectives( _id_AA030029A5B16AE5 )
{
    ...
    if ( istrue( level.useobjectives ) )
    {
        foreach ( fob in level.gw_objstruct.startingfobs_axis )
        {
            ...
            _id_1F2F362E189BF9C0 = _id_01802A784BB4C25D( fob.name );
            fob.trigger.gameobject._id_1F2F362E189BF9C0 = _id_1F2F362E189BF9C0;
            level.allfobs[_id_1F2F362E189BF9C0] = fob;
            fob.trigger.gameobject dompoint_ondisableobjective();
            scripts\mp\gamescore::giveteamscoreforobjective( "axis", level._id_529F98217BAEA818, 1, undefined, 1 );
            level._id_A5CE88CE789C9A3E["axis"] = fob.trigger.gameobject;
        ...
        foreach ( fob in level.gw_objstruct.startingfobs_allies )
        {
            ...
            level.allfobs[_id_1F2F362E189BF9C0] = fob;
            fob.trigger.gameobject dompoint_ondisableobjective();
            scripts\mp\gamescore::giveteamscoreforobjective( "allies", level._id_529F98217BAEA818, 1, undefined, 1 );
            level._id_A5CE88CE789C9A3E["allies"] = fob.trigger.gameobject;
...
objective_onuse( _id_82236C155ECBEDC9 )
{
    ...
    _id_03DB3BE47D7A24A7();
    scripts\mp\gamescore::giveteamscoreforobjective( self.ownerteam, level._id_529F98217BAEA818, 1, undefined, 1 );
    scripts\mp\gamescore::giveteamscoreforobjective( self._id_8A04AA0E0755E7E3, -1 * level._id_529F98217BAEA818, 1, undefined, 1 );
}
...
_id_03DB3BE47D7A24A7()
{
    if ( self._id_1F2F362E189BF9C0 != 0 && self._id_1F2F362E189BF9C0 != level.allfobs.size )
    {
        _id_EEEE890B3695C28A( level.allfobs[self._id_1F2F362E189BF9C0 + 1].trigger.gameobject );
        _id_EEEE890B3695C28A( level.allfobs[self._id_1F2F362E189BF9C0 - 1].trigger.gameobject );
    }
}

_id_EEEE890B3695C28A( _id_B2BA0415306556B2 )
{
    if ( _id_B2BA0415306556B2.ownerteam != self.ownerteam )
    {
        _id_B2BA0415306556B2 [[ _id_B2BA0415306556B2.onenableobjective ]]();
        level._id_A5CE88CE789C9A3E[_id_B2BA0415306556B2.ownerteam] = _id_B2BA0415306556B2;
        level._id_A5CE88CE789C9A3E[self.ownerteam] = self;
    }
    else
        _id_B2BA0415306556B2 [[ _id_B2BA0415306556B2.ondisableobjective ]]();
}
...
_id_2EB29A513CADB980()
{
    foreach ( fob in level._id_9E18EE9388EBE0B5 )
    {
        foreach ( team in level.teamnamelist )
        {
            _id_65652ECF72D4B1C8 = _id_B1C38130E76DFC86( fob + "_safe_" + team );
            _id_29D9D2428185616D = _id_B1C38130E76DFC86( fob + "_" + team );
            scripts\mp\spawnlogic::registerspawnpoints( team, _id_65652ECF72D4B1C8 );
            scripts\mp\spawnlogic::registerspawnpoints( team, _id_29D9D2428185616D );
            scripts\mp\spawnlogic::registerspawnset( fob + "_safe_" + team, _id_65652ECF72D4B1C8 );
            scripts\mp\spawnlogic::registerspawnset( fob + "_" + team, _id_29D9D2428185616D );
        }
    }
}

_id_B1C38130E76DFC86( target )
{
    _id_FB1F805FFA028960 = [];
    _id_FC32063C5B6BD8A8 = getspawnarray( "mp_tdm_spawn" );
...
_id_734D93E783570C3F()
{
    ...
    {
        _id_64FF927F7B16A533 = level._id_A5CE88CE789C9A3E[spawnteam];
        _id_E7AB01869DAF1531 = level.allfobs[_id_64FF927F7B16A533._id_1F2F362E189BF9C0].name + "_" + spawnteam;

        if ( _id_64FF927F7B16A533 scripts\mp\gameobjects::getcaptureprogress() )
            _id_E7AB01869DAF1531 = level.allfobs[_id_64FF927F7B16A533._id_1F2F362E189BF9C0].name + "_safe_" + spawnteam;

        spawnpoint = scripts\mp\spawnlogic::getspawnpoint( self, spawnteam, _id_E7AB01869DAF1531 );
    }
    ...
    else
    {
        switch ( level.localeid )
        {
            ...
            case "locale_200":
                if ( team == "allies" )
                {
                    _id_B379BC48DC371726.startorigin = ( 7124, 11776, 2556 );
                    _id_B379BC48DC371726.startangles = ( 13.829, 335.3, 0 );
                    _id_B379BC48DC371726.endorigin = ( 9004, 10088, 1988 );
                    _id_B379BC48DC371726.endangles = ( 24.9985, 220.001, -0.000213426 );
                }
                else
                {
                    _id_B379BC48DC371726.startorigin = ( -15827.3, -133.42, 1550.86 );
                    _id_B379BC48DC371726.startangles = ( 13.829, 335.3, 0 );
                    _id_B379BC48DC371726.endorigin = ( -14335.3, -3621.42, 1550.86 );
                    _id_B379BC48DC371726.endangles = ( 8.53518, 55.9275, 2.37782 );
                }
