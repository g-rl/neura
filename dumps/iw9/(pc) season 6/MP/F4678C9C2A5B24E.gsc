...
_id_150E98CD3E09D279()
{
    ...
    self stoplocalsound( _id_4DE75E7F916838A0 );
    self stoplocalsound( _id_134AEA3CDF65B674 );
    self stoplocalsound( "br_exfil_end_part_lr" );
}
