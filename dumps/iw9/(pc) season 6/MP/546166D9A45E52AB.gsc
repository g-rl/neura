...
init()
{
    ...
    registertweakable( "game", "thirdperson", "dvar_C00E244EA59D530E", 0 );
    ...
    registertweakable( "game", "minfalldamageheight", "dvar_DE79E5C6B8A17221", 225 );
    registertweakable( "game", "herodrop", "dvar_F1B2BD0A1FA58A73", 0 );
    registertweakable( "game", "perkpackage", "dvar_B01050DA9B96D273", 1 );
    registertweakable( "game", "showperksonspawn", "dvar_5CB1A62BAF307905", 1 );
