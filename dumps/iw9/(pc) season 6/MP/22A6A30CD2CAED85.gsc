...
setcommonrulesfrommatchrulesdata( skipfriendlyfire )
{
    ...
    setdynamicdvar( _func_2EF675C13CA1C4AF( "dvar_D98C82B5A26DC973", getgametype(), "_ffPunishDamageLimit" ), getmatchrulesdata( "commonOption", "ffPunishDamageLimit" ) );
    setdynamicdvar( _func_2EF675C13CA1C4AF( "dvar_D98C82B5A26DC973", getgametype(), "_ffKickKillLimit" ), getmatchrulesdata( "commonOption", "ffKickKillLimit" ) );
    setdynamicdvar( _func_2EF675C13CA1C4AF( "dvar_D98C82B5A26DC973", getgametype(), "_ffKickDamageLimit" ), getmatchrulesdata( "commonOption", "ffKickDamageLimit" ) );
...
isanymlgmatch()
{
    ...
    return getdvarint( "dvar_9CC8C81329E0BDBF" );
}

ismlgsystemlink()
{
    if ( level.systemlink && getdvarint( "dvar_9CC8C81329E0BDBF" ) )
        return 1;
...
ismlgprivatematch()
{
    if ( privatematch() && getdvarint( "dvar_9CC8C81329E0BDBF" ) )
        return 1;
