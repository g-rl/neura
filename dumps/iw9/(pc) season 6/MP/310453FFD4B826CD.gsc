...
emp_update_ents()
{
    ...
    if ( isdefined( level._id_1FDD52A3D7E6715D ) )
    {
        foreach ( _id_83C22FCEBA5BCE5C in level._id_1FDD52A3D7E6715D )
        {
            if ( isdefined( _id_83C22FCEBA5BCE5C ) && _id_83C22FCEBA5BCE5C can_be_empd() )
                ents[ents.size] = _id_83C22FCEBA5BCE5C;
        }
    }
