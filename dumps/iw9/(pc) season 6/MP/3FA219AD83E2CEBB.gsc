...
init()
{
    ...
    level.playermaxhealth = getdvarint( "dvar_B1D561F9A9241E09" );
    level.splitscreen = issplitscreen();
    level.onlinegame = getdvarint( "dvar_962400405F9F3C0B" );
    level._id_FC96A942BE145B56 = getdvarint( "dvar_9C2D59C1962CAC50", 0 ) == 1;
    level.rankedmatch = level.onlinegame && !getdvarint( "dvar_485EF1ED1D39D3A3" ) || level._id_FC96A942BE145B56;
...
registerfalldamagedvars()
{
    if ( scripts\mp\utility\game::_id_E417D8EF1C70CBCB() )
    {
        if ( scripts\cp_mp\utility\game_utility::_id_0BEFF479639E6508() )
        {
            ...
            {
                setdvar( "dvar_DE79E5C6B8A17221", 100000000 );
                setdvar( "dvar_18E2DDA6AAF07DC3", 100000001 );
                setdvar( "dvar_180A6F432CFB6644", 100000000 );
                setdvar( "dvar_5DFBFD642E45B4B2", 100000001 );
            }
            else
            {
