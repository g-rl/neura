...
strike_setup_arrays( index, _id_9F279646ED66AB76 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "create_script", "cleanupFuncInit" ) )
    {
        _id_EA847593E957F2B0 = scripts\cp_mp\utility\script_utility::getsharedfunc( "create_script", "cleanupFuncInit" );
        [[ _id_EA847593E957F2B0 ]]( _id_9F279646ED66AB76, self );
    }
}
...
strike_additem( struct, index, _id_9F279646ED66AB76, origin, angles, targetname, target, script_noteworthy, script_linkto, script_linkname, _id_A1306EE53C20150F, _id_E3C2F7A7F3D4CCE6, radius, speed, spawnflags, script_unload )
{
    ...
    else
    {
        if ( isdefined( struct.is_cs_script_origin ) )
            struct.is_cs_script_origin = scripts\engine\utility::ter_op( struct.is_cs_script_origin == "1", 1, 0 );
