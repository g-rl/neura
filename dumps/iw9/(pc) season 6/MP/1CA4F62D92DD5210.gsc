...
go_to_node_wait( _id_E2A7566FB8A29355, node )
{
    ...
    if ( isdefined( node.interaction ) && !isdefined( node._id_F8D4ED108521E632 ) )
    {
        ...
        _id_67E98C7BA275F170 = strtok( node.interaction, "+" );
        interaction = scripts\engine\utility::random( _id_67E98C7BA275F170 );
        node._id_F8D4ED108521E632 = _func_72066AA981916ECC( interaction, node.origin, angles );
    }

    self [[ _id_E2A7566FB8A29355 ]]( node );

    if ( !isdefined( self _meth_92435C7A6AE85C3C() ) && isdefined( node._id_F8D4ED108521E632 ) )
    {
