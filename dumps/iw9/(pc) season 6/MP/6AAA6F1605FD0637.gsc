...
jumpout( truck )
{
    ...
    scripts\cp_mp\utility\player_utility::_id_985B0973F29DA4F8( "br_convoy::jumpOut()" );
...
orbitcam( truck )
{
    ...
    scripts\cp_mp\utility\player_utility::_id_379BB555405C16BB( "br_convoy::orbitCam()" );
