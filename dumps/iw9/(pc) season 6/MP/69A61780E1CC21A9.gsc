...
little_bird_init()
{
    ...
    level.lb_impulse_dmg_threshold_mid = getdvarfloat( "dvar_EEACED8FD62D7D31", 0.5 );
    level.lb_impulse_dmg_threshold_low = getdvarfloat( "dvar_FADA138FDE409535", 0.2 );
